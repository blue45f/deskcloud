...
export function ErrorState({
  ...
  return (
    <div
      role="alert"
      className={cn(
        'flex flex-col items-center justify-center rounded-lg border border-dashed border-danger/40 bg-danger-soft px-6 py-14 text-center',
        className
      )}
    >
      ...
      {onRetry ? (
        <Button variant="secondary" size="sm" className="mt-4" loading={retrying} onClick={onRetry}>
