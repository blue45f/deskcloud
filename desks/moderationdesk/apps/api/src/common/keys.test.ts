import { PUBLISHABLE_KEY_PREFIX, SECRET_KEY_PREFIX } from '@moderationdesk/shared'
import { describe, expect, it } from 'vitest'

import { generatePublishableKey, generateSecretKey, hashSecretKey, verifySecretKey } from './keys'
