...
const CHUNK_RETRY_KEY = 'moderationdesk-chunk-retry'
...
export const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      // 공개 위젯 데모 — 실제 신고 버튼 + 사전검사 배지를 띄워 체험.
      { path: 'demo', lazy: lazyRetry(() => import('@/pages/DemoPage')) },
      // 문의(Inquiry) 게시판 — desk-platform 공개 API로 접수·조회. 공개.
        ...
        children: [
          {
            ...
            children: [
              ...
              { path: 'reports', lazy: lazyRetry(() => import('@/pages/ReportsPage')) },
              { path: 'rules', lazy: lazyRetry(() => import('@/pages/RulesPage')) },
              { path: 'logs', lazy: lazyRetry(() => import('@/pages/LogsPage')) },
              { path: 'test', lazy: lazyRetry(() => import('@/pages/TestPage')) },
