...
const CHUNK_RETRY_KEY = 'changelogdesk-chunk-retry'
...
export const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      // 공개 위젯 데모 — 실제 위젯을 띄워 미읽음 배지·패널까지 체험.
      { path: 'demo', lazy: lazyRetry(() => import('@/pages/DemoPage')) },
      // 문의 게시판 — desk-platform 공개 API 로 등록·목록(전화·이메일 대체).
