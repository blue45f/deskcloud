...
const CHUNK_RETRY_KEY = 'surveydesk-chunk-retry'
...
export const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      // 공개 위젯 데모 — 실제 위젯을 띄워 제출까지 체험.
      { path: 'demo', lazy: lazyRetry(() => import('@/pages/DemoPage')) },
      // 문의(Inquiry) 게시판 — desk-platform 공개 API로 문의 등록·열람.
        ...
        children: [
          {
            ...
            children: [
              ...
              { path: 'editor', lazy: lazyRetry(() => import('@/pages/EditorPage')) },
