...
const UNSAFE_PROD_DEFAULTS: Readonly<Record<string, readonly string[]>> = {
  ...
  KEY_PEPPER: ['dev-pepper-change-me', 'change-me-in-production', 'pepper'],
}
