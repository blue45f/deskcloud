...
const t = globalThis,
  ...
  H = new WeakMap(),
  N = $.createTreeWalker($, 129);
function x(t, e) {
  if (!_(t) || !t.hasOwnProperty('raw')) throw Error('invalid template strings array');
...
const T = (t, e) => {
  ...
  for (let e = 0; e < s; e++) {
    ...
    let A,
      ...
      c = -1,
      m = 0;
    for (; m < s.length && ((l.lastIndex = m), (_ = l.exec(s)), null !== _); )
      ((m = l.lastIndex),
        l === a
          ? '!--' === _[1]
            ? (l = d)
          ...
          : l === u
            ? '>' === _[0]
              ...
              : void 0 === _[1]
                ? (c = -2)
                : ((c = l.lastIndex - _[2].length),
                  (A = _[1]),
                  (l = void 0 === _[3] ? u : '"' === _[3] ? f : g))
            : l === f || l === g
              ? (l = u)
              : l === d || l === p
                ? (l = a)
                : ((l = u), (h = void 0)));
    const y = l === u && t[e + 1].startsWith('/>') ? ' ' : '';
    $ +=
      l === a
        ? s + r
        : c >= 0
          ? (i.push(A), s.slice(0, c) + n + s.slice(c) + o + y)
          : s + o + (-2 === c ? e : y);
  }
  return [x(t, $ + (t[s] || '<?>') + (2 === e ? '</svg>' : 3 === e ? '</math>' : '')), i];
};
class C {
  constructor({ strings: t, _$litType$: e }, i) {
    ...
    const _ = t.length - 1,
      ...
      [a, d] = T(t, e);
    if (
      ((this.el = C.createElement(a, i)), (N.currentNode = this.el.content), 2 === e || 3 === e)
    ) {
      const t = this.el.content.firstChild;
      t.replaceWith(...t.childNodes);
    }
    for (; null !== (r = N.nextNode()) && c.length < _; ) {
      if (1 === r.nodeType) {
        if (r.hasAttributes())
          for (const t of r.getAttributeNames())
            if (t.endsWith(n)) {
              ...
              (c.push({
                ...
                name: i[2],
                strings: s,
                ctor: '.' === i[1] ? S : '?' === i[1] ? w : '@' === i[1] ? U : I,
              }),
                r.removeAttribute(t));
            } else t.startsWith(o) && (c.push({ type: 6, index: $ }), r.removeAttribute(t));
        if (v.test(r.tagName)) {
          ...
          if (e > 0) {
            ...
            for (let s = 0; s < e; s++)
              (r.append(t[s], l()), N.nextNode(), c.push({ type: 2, index: ++$ }));
            r.append(t[e], l());
          }
        }
      } else if (8 === r.nodeType)
        if (r.data === h) c.push({ type: 2, index: $ });
        else {
          let t = -1;
          for (; -1 !== (t = r.data.indexOf(o, t + 1)); )
            (c.push({ type: 7, index: $ }), (t += o.length - 1));
        }
      $++;
    }
  }
...
class b {
  ...
  u(t) {
    const {
      ...
      i = (t?.creationScope ?? $).importNode(e, !0);
    N.currentNode = i;
    let n = N.nextNode(),
      o = 0,
      h = 0,
      ...
      if (o === r.index) {
        ...
        (2 === r.type
          ...
          : 1 === r.type
            ...
            : 6 === r.type && (e = new O(n, this, t)),
          this._$AV.push(e),
          (r = s[++h]));
      }
      o !== r?.index && ((n = N.nextNode()), o++);
    }
    return ((N.currentNode = $), i);
  }
  p(t) {
    let e = 0;
...
class E {
    ...
    ((t = M(this, t, e)),
      A(t)
        ...
        : void 0 !== t._$litType$
          ...
          : void 0 !== t.nodeType
            ? this.T(t)
            : ((t) => _(t) || 'function' == typeof t?.[Symbol.iterator])(t)
              ? this.k(t)
              : this._(t));
  }
  O(t) {
  ...
  $(t) {
    const { values: e, _$litType$: s } = t,
      i =
        'number' == typeof s
          ? this._$AC(t)
          : (void 0 === s.el && (s.el = C.createElement(x(s.h, s.h[0]), this.options)), s);
  ...
  k(t) {
    ...
    for (const n of t)
      (i === e.length
        ? e.push((s = new E(this.O(l()), this.O(l()), this, this.options)))
        : (s = e[i]),
        s._$AI(n),
        i++);
...
class I {
  ...
  _$AI(t, e = this, s, i) {
    ...
    let o = !1;
    if (void 0 === n)
      ((t = M(this, t, e, 0)), (o = !A(t) || (t !== this._$AH && t !== m)), o && (this._$AH = t));
    else {
      const i = t;
      let h, r;
...
(R?.(C, E), (t.litHtmlVersions ??= []).push('3.3.2'));
/**
 * @license
...
function W(t) {
  void 0 !== this._$AN ? (k(this), (this._$AM = t), V(this)) : (this._$AM = t);
}
function j(t, e = !1, s = 0) {
  ...
  if (void 0 !== n && 0 !== n.size)
    if (e)
      if (Array.isArray(i)) for (let t = s; t < i.length; t++) (P(i[t], !1), k(i[t]));
      else null != i && (P(i, !1), k(i));
    else P(this, t);
}
const z = (t) => {
  t.type == B.CHILD && ((t._$AP ??= j), (t._$AQ ??= W));
};
class Z extends L {
  constructor() {
...
export { Z as AsyncDirective, L as Directive, B as PartType, D as directive };
