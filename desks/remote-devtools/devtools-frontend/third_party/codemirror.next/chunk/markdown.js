...
class B {
  ...
  constructor(e, t, r, s, i, o, a) {
    ((this.type = e),
      ...
      (this.children = o),
      (this.positions = a),
      (this.hashProp = [[n.contextHash, s]]));
  }
  addChild(e, t) {
    (e.prop(n.contextHash) != this.hash &&
      (e = new l(e.type, e.children, e.positions, e.length, this.hashProp)),
  ...
  toTree(e, n = this.end) {
    ...
    return (
      ...
      new l(e.types[this.type], this.children, this.positions, n - this.from).balance({
        makeTree: (e, n, r) => new l(t.none, e, n, r, this.hashProp),
      })
    );
  }
}
...
function v(e, t, n) {
  ...
  let r = (e.type == E.OrderedList ? q : F)(n, t, !1);
  return (
    r > 0 &&
    (e.type != E.BulletList || D(n, t, !1) < 0) &&
...
const P = {
  [E.Blockquote]: (e, t, n) =>
    62 == n.next &&
    (n.markers.push(ge(E.QuoteMark, t.lineStart + n.pos, t.lineStart + n.pos + 1)),
    n.moveBase(n.pos + (N(n.text.charCodeAt(n.pos + 1)) ? 2 : 1)),
...
function D(e, t, n) {
  ...
  return (n &&
    ...
    t.parser.leafBlockParsers.indexOf(ne.SetextHeading) > -1) ||
    r < 3
    ? -1
    : 1;
}
...
function F(e, t, n) {
  return (45 != e.next && 43 != e.next && 42 != e.next) ||
    (e.pos != e.text.length - 1 && !N(e.text.charCodeAt(e.pos + 1))) ||
    !(!n || $(t, E.BulletList) || e.skipSpace(e.pos + 2) < e.text.length)
    ? -1
    : 1;
}
function q(e, t, n) {
  ...
  return r == e.pos ||
    r > e.pos + 9 ||
    (46 != s && 41 != s) ||
    (r < e.text.length - 1 && !N(e.text.charCodeAt(r + 1))) ||
    (n &&
      !$(t, E.OrderedList) &&
      (e.skipSpace(r + 1) == e.text.length || r > e.pos + 1 || 49 != e.next))
    ? -1
    : r + 1 - e.pos;
}
function j(e) {
...
function U(e) {
  ...
  for (; t < e.text.length && e.text.charCodeAt(t) == e.next; ) t++;
  let n = t;
  for (; t < e.text.length && N(e.text.charCodeAt(t)); ) t++;
...
function V(e, t, n) {
  ...
  for (let e = 0, t = G.length - (n ? 1 : 0); e < t; e++) if (G[e][0].test(r)) return e;
  return -1;
}
function K(e, t) {
...
function J(e, t, n) {
  let r = e.length - 1;
  r >= 0 && e[r].to == t && e[r].type == E.CodeText ? (e[r].to = n) : e.push(ge(E.CodeText, t, n));
}
const W = {
  ...
  IndentedCode(e, t) {
    ...
    let r = t.findColumn(n),
      ...
      o = [],
      a = [];
    for (J(o, s, i); e.nextLine() && t.depth >= e.stack.length; )
      if (t.pos == t.text.length) {
        ...
        {
          if (a.length) {
            for (let e of a) e.type == E.CodeText ? J(o, e.from, e.to) : o.push(e);
            a = [];
          }
    ...
    return (
      a.length &&
        ((a = a.filter((e) => e.type != E.CodeText)),
        a.length && (t.markers = a.concat(t.markers))),
      e.addNode(e.buffer.writeElements(o, -s).finish(E.CodeBlock, i - s), s),
      !0
    );
  },
  FencedCode(e, t) {
    ...
    let r = e.lineStart + t.pos,
      ...
      i = n - t.pos,
      o = t.skipSpace(n),
      a = R(t.text, t.text.length, o),
      l = [ge(E.CodeMark, r, r + i)];
    o < a && l.push(ge(E.CodeInfo, e.lineStart + o, e.lineStart + a));
    for (let n = !0; e.nextLine() && t.depth >= e.stack.length; n = !1) {
      let r = t.pos;
      if (t.indent - t.baseIndent < 4) for (; r < t.text.length && t.text.charCodeAt(r) == s; ) r++;
      if (r - t.pos >= i && t.skipSpace(r) == t.text.length) {
        for (let e of t.markers) l.push(e);
        (l.push(ge(E.CodeMark, e.lineStart + t.pos, e.lineStart + r)), e.nextLine());
        break;
      }
      {
        n || J(l, e.lineStart - 1, e.lineStart);
        for (let e of t.markers) l.push(e);
    ...
    return (
      e.addNode(e.buffer.writeElements(l, -r).finish(E.FencedCode, e.prevLineEnd() - r), r),
      !0
    );
  },
  Blockquote(e, t) {
    ...
    return (
      !(n < 0) &&
      (e.startContext(E.Blockquote, t.pos),
      e.addNode(E.QuoteMark, e.lineStart + t.pos, e.lineStart + t.pos + 1),
      t.moveBase(t.pos + n),
      null)
    );
  },
  HorizontalRule(e, t) {
    ...
    return (e.nextLine(), e.addNode(E.HorizontalRule, n), !0);
  },
  BulletList(e, t) {
    let n = F(t, e, !1);
    if (n < 0) return !1;
    ...
    let r = K(t, t.pos + 1);
    return (
      e.startContext(E.ListItem, t.basePos, r - t.baseIndent),
      e.addNode(E.ListMark, e.lineStart + t.pos, e.lineStart + t.pos + n),
      t.moveBaseColumn(r),
      null
    );
  },
  OrderedList(e, t) {
    let n = q(t, e, !1);
    if (n < 0) return !1;
    e.block.type != E.OrderedList &&
      e.startContext(E.OrderedList, t.basePos, t.text.charCodeAt(t.pos + n - 1));
    let r = K(t, t.pos + n);
    return (
      e.startContext(E.ListItem, t.basePos, r - t.baseIndent),
      e.addNode(E.ListMark, e.lineStart + t.pos, e.lineStart + t.pos + n),
  ...
  ATXHeading(e, t) {
    ...
    let r = t.pos,
      s = e.lineStart + r,
      i = R(t.text, t.text.length, r),
      o = i;
    for (; o > r && t.text.charCodeAt(o - 1) == t.next; ) o--;
    (o != i && o != r && N(t.text.charCodeAt(o - 1))) || (o = t.text.length);
    let a = e.buffer
      .write(E.HeaderMark, 0, n)
      .writeElements(e.parser.parseInline(t.text.slice(r + n + 1, o), s + n + 1), -s);
    o < t.text.length && a.write(E.HeaderMark, o - r, i - r);
    let l = a.finish(E.ATXHeading1 - 1 + n, t.text.length - r);
  ...
  HTMLBlock(e, t) {
    ...
    o && e.nextLine();
    let a = s == Q ? E.CommentBlock : s == Z ? E.ProcessingInstructionBlock : E.HTMLBlock,
      l = e.prevLineEnd();
    return (e.addNode(e.buffer.writeElements(i, -r).finish(a, l - r), r), !0);
  },
...
class Y {
  ...
  finish(e, t) {
    return (
      ...
      O(t.content, this.pos) == t.content.length &&
  ...
  advance(e) {
    for (;;) {
      ...
      if (0 == this.stage) {
        ...
        (this.elts.push(ge(E.LinkMark, this.pos + this.start, this.pos + this.start + 1)),
          this.pos++);
      } else {
        if (1 != this.stage) {
          if (2 == this.stage) {
            let t = O(e, this.pos),
              n = 0;
            if (t > this.pos) {
              let r = Te(e, t, this.start);
              if (r) {
                let t = ee(e, r.to - this.start);
                t > 0 && (this.nextStage(r), (n = t));
              }
            }
            return (n || (n = ee(e, this.pos)), n > 0 && n < e.length ? n : -1);
          }
...
class te {
  nextLine(e, t, n) {
    let r = t.depth < e.stack.length ? -1 : U(t),
      s = t.next;
    if (r < 0) return !1;
    let i = ge(E.HeaderMark, e.lineStart + t.pos, e.lineStart + r);
    return (
      e.nextLine(),
      e.addLeafElement(
        n,
        ge(61 == s ? E.SetextHeading1 : E.SetextHeading2, n.start, e.prevLineEnd(), [
...
const ne = {
    LinkReference: (e, t) => (91 == t.content.charCodeAt(0) ? new Y(t) : null),
    SetextHeading: () => new te(),
  },
  re = [
    (e, t) => j(t) >= 0,
    (e, t) => X(t) >= 0,
...
class ie {
  constructor(e, t, n, r) {
    ((this.parser = e),
      ...
      (this.block = B.create(E.Document, 0, this.lineStart, 0, 0)),
      (this.stack = [this.block]),
      (this.fragments = n.length ? new ve(n, t) : null),
      this.readLine());
  }
  get parsedPos() {
  ...
  advance() {
    ...
    let t = new M(this.lineStart + e.pos, e.text.slice(e.pos));
  ...
  readLine() {
    ...
    for (this.absoluteLineEnd = n, e.reset(t); e.depth < this.stack.length; e.depth++) {
      ...
      if (!n) throw new Error('Unhandled block context ' + E[t.type]);
      if (!n(t, this, e)) break;
      e.forward();
    }
  }
  ...
  addNode(e, t, n) {
    ('number' == typeof e &&
      (e = new l(this.parser.nodeSet.types[e], ue, ue, (null != n ? n : this.prevLineEnd()) - t)),
  ...
  addLeafElement(e, t) {
    this.addNode(
      this.buffer.writeElements(Me(t.children, e.marks), -t.from).finish(t.type, t.to - t.from),
      t.from,
    );
  }
  finishContext() {
  ...
  addGaps(e) {
    return this.ranges.length > 1
      ? oe(this.ranges, 0, e.topNode, this.ranges[0].from, this.reusePlaceholders)
      : e;
  }
  finishLeaf(e) {
    for (let t of e.parsers) if (t.finish(this, e)) return;
    let t = Me(this.parser.parseInline(e.content, e.start), e.marks);
    this.addNode(
      this.buffer.writeElements(t, -e.start).finish(E.Paragraph, e.content.length),
      e.start,
    );
  }
  elt(e, t, n, r) {
...
function oe(e, t, n, r, s) {
  ...
  for (let l = n.firstChild; l; l = l.nextSibling) {
    ...
    let n,
      c = l.from + r,
      u = s.get(l.tree);
    (u ? (n = u) : l.to + r > i ? ((n = oe(e, t, l, r, s)), f(l.to + r, !1)) : (n = l.toTree()),
      o.push(n),
      a.push(c - h));
  }
  return (f(n.to + r, !1), new l(n.type, o, a, n.to + r - h, n.tree ? n.tree.propValues : void 0));
}
class ae extends e {
  ...
  configure(e) {
    ...
    if (le(o.defineNodes)) {
      ...
      let e,
        h = a.types.slice();
      for (let s of o.defineNodes) {
        let { name: i, block: o, composite: a, style: f } = 'string' == typeof s ? { name: s } : s;
        if (h.some((e) => e.name == i)) continue;
        a && (l[h.length] = (e, t, n) => a(t, n, e.value));
        let c = h.length,
          u = a
            ? ['Block', 'BlockContext']
            : o
              ? c >= E.ATXHeading1 && c <= E.SetextHeading2
                ? ['Block', 'LeafBlock', 'Heading']
                : ['Block', 'LeafBlock']
              : void 0;
        (h.push(t.define({ id: c, name: i, props: u && [[n.group, u]] })),
          f &&
            (e || (e = {}), Array.isArray(f) || f instanceof r ? (e[i] = f) : Object.assign(e, f)));
      }
      ((a = new s(h)), e && (a = a.extend(i(e))));
    }
    if ((le(o.props) && (a = a.extend(...o.props)), le(o.remove)))
      for (let e of o.remove) {
        let t = this.blockNames.indexOf(e),
          n = this.inlineNames.indexOf(e);
        (t > -1 && (h[t] = f[t] = void 0), n > -1 && (u[n] = void 0));
      }
    if (le(o.parseBlock))
      for (let e of o.parseBlock) {
        let t = c.indexOf(e.name);
        if (t > -1) ((h[t] = e.parse), (f[t] = e.leaf));
        else {
          let t = e.before ? fe(c, e.before) : e.after ? fe(c, e.after) + 1 : c.length - 1;
          (h.splice(t, 0, e.parse), f.splice(t, 0, e.leaf), c.splice(t, 0, e.name));
        }
        e.endLeaf && p.push(e.endLeaf);
      }
    if (le(o.parseInline))
      for (let e of o.parseInline) {
        let t = d.indexOf(e.name);
        if (t > -1) u[t] = e.parse;
        else {
          let t = e.before ? fe(d, e.before) : e.after ? fe(d, e.after) + 1 : d.length - 1;
          (u.splice(t, 0, e.parse), d.splice(t, 0, e.name));
        }
      }
    return (o.wrap && (m = m.concat(o.wrap)), new ae(a, h, f, c, p, l, u, d, m));
  }
  getNodeType(e) {
...
let ce = [t.none];
for (let e, r = 1; (e = E[r]); r++)
  ce[r] = t.define({
    id: r,
    name: e,
    props:
      r >= E.Escape ? [] : [[n.group, r in P ? ['Block', 'BlockContext'] : ['Block', 'LeafBlock']]],
    top: 'Document' == e,
  });
const ue = [];
class de {
...
const ke = { resolve: 'Emphasis', mark: 'EmphasisMark' },
  xe = { resolve: 'Emphasis', mark: 'EmphasisMark' },
  be = {},
  Le = {};
class Se {
  constructor(e, t, n, r) {
...
let we = /[!"#$%&'()*+,\-.\/:;<=>?@\[\\\]^_`{|}~\xA1\u2010-\u2027]/;
try {
  we = new RegExp('[\\p{S}|\\p{P}]', 'u');
} catch (e) {}
const ye = {
  Escape(e, t, n) {
    if (92 != t || n == e.end - 1) return -1;
    let r = e.char(n + 1);
    for (let t = 0; t < 32; t++) if (Ce.charCodeAt(t) == r) return e.append(ge(E.Escape, n, n + 2));
    return -1;
  },
  Entity(e, t, n) {
    if (38 != t) return -1;
    let r = /^(?:#\d+|#x[a-f\d]+|\w+);/i.exec(e.slice(n + 1, n + 31));
    return r ? e.append(ge(E.Entity, n, n + 1 + r[0].length)) : -1;
  },
  InlineCode(e, t, n) {
    ...
    for (; r < e.end; r++)
      if (96 == e.char(r)) {
        if ((i++, i == s && 96 != e.char(r + 1)))
          return e.append(
            ge(E.InlineCode, n, r + 1, [
              ge(E.CodeMark, n, n + s),
              ge(E.CodeMark, r + 1 - s, r + 1),
            ]),
          );
      } else i = 0;
    return -1;
  ...
  HTMLTag(e, t, n) {
    ...
    if (s)
      return e.append(
        ge(E.Autolink, n, n + 1 + s[0].length, [
          ge(E.LinkMark, n, n + 1),
          ge(E.URL, n + 1, n + s[0].length),
          ge(E.LinkMark, n + s[0].length, n + 1 + s[0].length),
        ]),
      );
    let i = /^!--[^>](?:-[^-]|[^-])*?-->/i.exec(r);
    if (i) return e.append(ge(E.Comment, n, n + 1 + i[0].length));
    let o = /^\?[^]*?\?>/.exec(r);
  ...
  Emphasis(e, t, n) {
    ...
    let s = e.slice(n - 1, n),
      ...
      u = f && (42 == t || !c || o),
      d = c && (42 == t || !f || a);
    return e.append(new Se(95 == t ? ke : xe, n, r, (u ? 1 : 0) | (d ? 2 : 0)));
  },
  HardBreak(e, t, n) {
    ...
    if (32 == t) {
      let t = n + 1;
      for (; 32 == e.char(t); ) t++;
      if (10 == e.char(t) && t >= n + 2) return e.append(ge(E.HardBreak, n, t + 1));
    }
    return -1;
  },
  Link: (e, t, n) => (91 == t ? e.append(new Se(be, n, n + 1, 1)) : -1),
  Image: (e, t, n) => (33 == t && 91 == e.char(n + 1) ? e.append(new Se(Le, n, n + 2, 1)) : -1),
  LinkEnd(e, t, n) {
    if (93 != t) return -1;
    for (let t = e.parts.length - 1; t >= 0; t--) {
      let r = e.parts[t];
      if (r instanceof Se && (r.type == be || r.type == Le)) {
        if (!r.side || (e.skipSpace(r.to) == n && !/[(\[]/.test(e.slice(n + 1, n + 2))))
          return ((e.parts[t] = null), -1);
        let s = e.takeContent(t),
          i = (e.parts[t] = Ae(e, s, r.type == be ? E.Link : E.Image, r.from, n + 1));
        if (r.type == be)
          for (let n = 0; n < t; n++) {
            let t = e.parts[n];
            t instanceof Se && t.type == be && (t.side = 0);
          }
        return i.to;
      }
    }
...
function Ae(e, t, n, r, s) {
  let { text: i } = e,
    ...
    a = s;
  if (
    (t.unshift(ge(E.LinkMark, r, r + (n == E.Image ? 2 : 1))),
    t.push(ge(E.LinkMark, s - 1, s)),
    40 == o)
  ) {
    let n,
      r = e.skipSpace(s + 1),
      o = Ie(i, r - e.offset, e.offset);
    (o &&
      ((r = e.skipSpace(o.to)),
      r != o.to && ((n = Te(i, r - e.offset, e.offset)), n && (r = e.skipSpace(n.to)))),
      41 == e.char(r) &&
        (t.push(ge(E.LinkMark, s, s + 1)),
        (a = r + 1),
        o && t.push(o),
        n && t.push(n),
        t.push(ge(E.LinkMark, r, a))));
  } else if (91 == o) {
    let n = Be(i, s - e.offset, e.offset, !1);
    n && (t.push(n), (a = n.to));
  }
  return ge(n, r, a, t);
}
function Ie(e, t, n) {
  if (60 == e.charCodeAt(t)) {
    for (let r = t + 1; r < e.length; r++) {
      ...
      if (62 == s) return ge(E.URL, t + n, r + 1 + n);
  ...
  }
  {
    ...
    return s > t ? ge(E.URL, t + n, s + n) : s == e.length && null;
  }
}
function Te(e, t, n) {
  ...
  let s = 40 == r ? 41 : r;
  for (let r = t + 1, i = !1; r < e.length; r++) {
    let o = e.charCodeAt(r);
    if (i) i = !1;
    else {
      if (o == s) return ge(E.LinkTitle, t + n, r + 1 + n);
      92 == o && (i = !0);
    }
  }
  return null;
...
function Be(e, t, n, r) {
  for (let s = !1, i = t + 1, o = Math.min(e.length, i + 999); i < o; i++) {
    ...
    if (s) s = !1;
      ...
      if (93 == o) return !r && ge(E.LinkLabel, t + n, i + 1 + n);
      if ((r && !N(o) && (r = !1), 91 == o)) return !1;
      92 == o && (s = !0);
    }
  }
  return null;
...
class Ee {
  ...
  get hasOpenLink() {
    for (let e = this.parts.length - 1; e >= 0; e--) {
      let t = this.parts[e];
      if (t instanceof Se && (t.type == be || t.type == Le)) return !0;
    }
    return !1;
  }
  addElement(e) {
  ...
  resolveMarkers(e) {
    for (let t = e; t < this.parts.length; t++) {
      let n = this.parts[t];
      if (!(n instanceof Se && n.type.resolve && 2 & n.side)) continue;
      let r,
        s = n.type == ke || n.type == xe,
        i = n.to - n.from,
        o = t - 1;
      for (; o >= e; o--) {
        let e = this.parts[o];
      ...
      for (let e = o + 1; e < t; e++)
        (this.parts[e] instanceof pe && l.push(this.parts[e]), (this.parts[e] = null));
      n.type.mark && l.push(this.elt(n.type.mark, n.from, f));
      let c = this.elt(a, h, f, l);
      ((this.parts[o] = s && r.from != h ? new Se(r.type, r.from, h, r.side) : null),
        (this.parts[t] = s && n.to != f ? new Se(n.type, f, n.to, n.side) : null)
  ...
  findOpeningDelimiter(e) {
    for (let t = this.parts.length - 1; t >= 0; t--) {
      let n = this.parts[t];
      if (n instanceof Se && n.type == e) return t;
    }
    return null;
  }
  takeContent(e) {
...
function Me(e, t) {
  ...
  for (let e of t) {
    ...
    if (r < n.length && n[r].from < e.from) {
      let t = n[r];
      t instanceof pe && (n[r] = new pe(t.type, t.from, t.to, Me(t.children, [e])));
    } else n.splice(r++, 0, e);
  }
  return n;
}
const He = [E.CodeBlock, E.ListItem, E.OrderedList, E.BulletList];
class ve {
  constructor(e, t) {
    ((this.fragments = e),
      (this.input = t),
  ...
  matches(e) {
    ...
    return t && t.prop(n.contextHash) == e;
  }
  takeNodes(e) {
    let t = this.cursor,
    ...
    for (;;) {
      ...
      if (t.to - n <= e.ranges[e.rangeI].to) e.addNode(t.tree, s);
      else {
        let n = new l(e.parser.nodeSet.types[E.Paragraph], [], [], 0, e.block.hashProp);
        (e.reusePlaceholders.set(n, t.tree), e.addNode(n, s));
      }
      if (
        (t.type.is('Block') &&
          (He.indexOf(t.type.id) < 0
            ? ((i = t.to - n), (o = e.block.children.length))
            : ((i = a), (o = h), (a = t.to - n), (h = e.block.children.length))),
        !t.nextSibling())
      )
        break;
    }
...
const Ne = i({
  ...
  Oe = new ae(
    new s(ce).extend(Ne),
    Object.keys(W).map((e) => W[e]),
    Object.keys(W).map((e) => ne[e]),
    Object.keys(W),
    re,
    P,
    Object.keys(ye).map((e) => ye[e]),
    Object.keys(ye),
    [],
  );
function Re(e, t, n) {
...
const Xe = { resolve: 'Strikethrough', mark: 'StrikethroughMark' },
  ze = {
    defineNodes: [
      { name: 'Strikethrough', style: { 'Strikethrough/...': a.strikethrough } },
      { name: 'StrikethroughMark', style: a.processingInstruction },
    ],
    parseInline: [
      {
        name: 'Strikethrough',
        parse(e, t, n) {
          ...
          let r = e.slice(n - 1, n),
            ...
            a = we.test(r),
            l = we.test(s);
          return e.addDelimiter(Xe, n, n + 2, !o && (!l || i || a), !i && (!a || o || l));
        },
        after: 'Emphasis',
      },
    ],
  };
function De(e, t, n = 0, r, s = 0) {
  let i = 0,
    o = !0,
    a = -1,
    l = -1,
  ...
  for (let c = n; c < t.length; c++) {
    ...
    (124 != n || h
      ? (h || (32 != n && 9 != n)) && (a < 0 && (a = c), (l = c + 1))
      : ((!o || a > -1) && i++,
        (o = !1),
        r && (a > -1 && f(), r.push(e.elt('TableDelimiter', c + s, c + s + 1))),
        (a = l = -1)),
      (h = !h && 92 == n));
  }
  return (a > -1 && (i++, r && f()), i);
...
class qe {
  ...
  nextLine(e, t, n) {
    if (null == this.rows) {
      ...
      if (
        ((this.rows = !1),
        (45 == t.next || 58 == t.next || 124 == t.next) && Fe.test((r = t.text.slice(t.pos))))
      ) {
        let s = [];
        De(e, n.content, 0, s, n.start) == De(e, r, t.pos) &&
          (this.rows = [
      ...
      let n = [];
      (De(e, t.text, t.pos, n, e.lineStart),
  ...
  finish(e, t) {
    return (
      !!this.rows &&
      (e.addLeafElement(t, e.elt('Table', t.start, t.start + t.content.length, this.rows)), !0)
    );
  }
}
const je = {
  defineNodes: [
    { name: 'Table', block: !0 },
    { name: 'TableHeader', style: { 'TableHeader/...': a.heading } },
    'TableRow',
    { name: 'TableCell', style: a.content },
    { name: 'TableDelimiter', style: a.processingInstruction },
  ],
  parseBlock: [
    {
      name: 'Table',
      leaf: (e, t) => ($e(t.content, 0) ? new qe() : null),
      endLeaf(e, t, n) {
        if (n.parsers.some((e) => e instanceof qe) || !$e(t.text, t.basePos)) return !1;
        let r = e.peekLine();
        return Fe.test(r) && De(e, t.text, t.basePos) == De(e, r, t.basePos);
      },
...
const _e = {
    defineNodes: [
      { name: 'Task', block: !0, style: a.list },
      { name: 'TaskMarker', style: a.atom },
    ],
    parseBlock: [
      {
        name: 'TaskList',
        leaf: (e, t) =>
          /^\[[ xX]\][ \t]/.test(t.content) && 'ListItem' == e.parentType().name ? new Ue() : null,
        after: 'SetextHeading',
      },
    ],
  },
  Qe = /(www\.)|(https?:\/\/)|([\w.+-]{1,100}@)|(mailto:|xmpp:)/gy,
  Ze = /[\w-]+(\.[\w-]+)+(\/[^\s<]*)?/gy,
  Ge = /[\w-]+\.[\w-]+($|\/)/,
  Ve = /[\w.+-]+@[\w-]+(\.[\w.-]+)+/gy,
  Ke = /\/[a-zA-Z\d@.]+/gy;
          ...
          if (s[1] || s[2]) {
            if (
              ((i = (function (e, t) {
                Ze.lastIndex = t;
                let n = Ze.exec(e);
                if (!n || Ge.exec(n[0])[0].indexOf('_') > -1) return -1;
                let r = t + n[0].length;
                for (;;) {
                  let n,
                    s = e[r - 1];
                  if (/[?!.,:*_~]/.test(s) || (')' == s && Je(e, t, r, ')') > Je(e, t, r, '(')))
                    r--;
                  else {
              ...
              i = r + /([^\[\]]|\[[^\]]*\])*/.exec(e.text.slice(r, i))[0].length;
            }
          } else
            s[3]
              ? (i = We(e.text, r))
              : ((i = We(e.text, r + s[0].length)),
                i > -1 &&
                  'xmpp:' == s[0] &&
                  ((Ke.lastIndex = i), (s = Ke.exec(e.text)), s && (i = s.index + s[0].length)));
...
function et(e, t, n) {
  return (r, s, i) => {
    ...
    for (let s = i + 1; s < r.end; s++) {
      ...
      if ((92 == a && o.push(r.elt('Escape', s, 2 + s++)), N(a))) break;
    }
    return -1;
  };
}
const tt = {
    defineNodes: [
      { name: 'Superscript', style: a.special(a.content) },
      { name: 'SuperscriptMark', style: a.processingInstruction },
    ],
    parseInline: [{ name: 'Superscript', parse: et(94, 'Superscript', 'SuperscriptMark') }],
  },
  nt = {
    defineNodes: [
      { name: 'Subscript', style: a.special(a.content) },
      { name: 'SubscriptMark', style: a.processingInstruction },
    ],
    parseInline: [{ name: 'Subscript', parse: et(126, 'Subscript', 'SubscriptMark') }],
  },
  rt = {
    defineNodes: [{ name: 'Emoji', style: a.character }],
    parseInline: [
      {
        name: 'Emoji',
        parse(e, t, n) {
          let r;
          return 58 == t && (r = /^[a-zA-Z_0-9]+:/.exec(e.slice(n + 1, e.end)))
  ...
  st = f({ commentTokens: { block: { open: '\x3c!--', close: '--\x3e' } } }),
  it = new n(),
  ot = Oe.configure({
    props: [
      L.add((e) =>
        !e.is('Block') || e.is('Document') || null != at(e)
          ? void 0
...
function lt(e, t) {
  ...
  for (;;) {
    let e,
      r = n.nextSibling;
    if (!r || (null != (e = at(r.type)) && e <= t)) break;
    n = r;
  }
  return n.to;
}
const ht = c.of((e, t, n) => {
  for (let r = u(e).resolveInner(n, -1); r && !(r.from < t); r = r.parent) {
    let e = r.type.prop(it);
    if (null == e) continue;
    let t = lt(r, e);
...
function ft(e) {
  return new h(st, e, [ht], 'markdown');
}
const ct = ft(ot),
  ut = ft(ot.configure([Ye, nt, tt, rt]));
class dt {
  ...
  marker(e, t) {
    let n = 'OrderedList' == this.node.name ? String(+mt(this.item, e)[2] + t) : '';
...
function pt(e, t) {
  ...
  for (let e = n.length - 1; e >= 0; e--) {
    let s,
      ...
      o = t.lineAt(i.from),
      a = i.from - o.from;
    if ('FencedCode' == i.name) r.push(new dt(i, a, a, '', '', '', null));
    else if ('Blockquote' == i.name && (s = /^ *>( ?)/.exec(o.text.slice(a))))
      r.push(new dt(i, a, a + s[0].length, '', s[1], '>', null));
    else if (
      'ListItem' == i.name &&
      'OrderedList' == i.parent.name &&
      (s = /^( *)\d+([.)])( *)/.exec(o.text.slice(a)))
    ) {
      let e = s[3],
        t = s[0].length;
      (e.length >= 4 && ((e = e.slice(0, e.length - 4)), (t -= 4)),
        r.push(new dt(i.parent, a, a + t, s[1], e, s[2], i)));
    } else if (
      'ListItem' == i.name &&
      'BulletList' == i.parent.name &&
      (s = /^( *)([-+*])( {1,4}\[[ xX]\])?( +)/.exec(o.text.slice(a)))
    ) {
      let e = s[4],
        t = s[0].length;
      e.length > 4 && ((e = e.slice(0, e.length - 4)), (t -= 4));
      let n = s[2];
      (s[3] && (n += s[3].replace(/[xX]/, ' ')), r.push(new dt(i.parent, a, a + t, s[1], e, n, i)));
    }
  }
  return r;
}
...
function kt(e, t) {
  ...
  if (!n || '\t' != t.facet(b)) return e;
  let r = '';
  for (let t = p(e, 4, n); t > 0; ) t >= 4 ? ((r += '\t'), (t -= 4)) : ((r += ' '), t--);
  return r + e.slice(n);
}
const xt = ({ state: e, dispatch: t }) => {
  let n = u(e),
    ...
    s = null,
    i = e.changeByRange((t) => {
      if (!t.empty || !ut.isActiveAt(e, t.from)) return (s = { range: t });
      let i = t.from,
        o = r.lineAt(i),
        a = pt(n.resolveInner(i, -1), r);
      ...
      if (l.item && h) {
        if (
          l.node.firstChild.to >= i ||
          (o.from > 0 && !/[^\s>]/.test(r.lineAt(o.from - 1).text))
        ) {
          let e,
            t = a.length > 1 ? a[a.length - 2] : null,
            n = '';
          t && t.item
            ? ((e = o.from + t.from), (n = t.marker(r, 1)))
            : (e = o.from + (t ? t.to : 0));
          let s = [{ from: e, to: i, insert: n }];
          return (
            'OrderedList' == l.node.name && gt(l.item, r, s, -2),
            t && 'OrderedList' == t.node.name && gt(t.item, r, s),
            { range: d.cursor(e + n.length), changes: s }
          );
        }
        {
          let t = '';
          for (let e = 0, n = a.length - 2; e <= n; e++)
            t += a[e].blank(e < n ? p(o.text, 4, a[e + 1].from) - t.length : null, e < n);
          return (
            (t = kt(t, e)),
            {
              range: d.cursor(i + t.length + 1),
      ...
      let f = [];
      'OrderedList' == l.node.name && gt(l.item, r, f);
      let c = l.item && l.item.from < o.from,
        u = '';
      if (!c || /^[\s\d.)\-+*>]*/.exec(o.text)[0].length >= l.to)
        for (let e = 0, t = a.length - 1; e <= t; e++)
          u +=
            e != t || c
              ? a[e].blank(e < t ? p(o.text, 4, a[e + 1].from) - u.length : null)
              : a[e].marker(r, 1);
      let m = i;
      for (; m > o.from && /\s/.test(o.text.charAt(m - o.from - 1)); ) m--;
      return (
        (u = kt(u, e)),
        f.push({ from: m, to: i, insert: e.lineBreak + u }),
        { range: d.cursor(m + u.length + 1), changes: f }
      );
    });
...
const Lt = ({ state: e, dispatch: t }) => {
    let n = u(e),
      ...
      s = e.changeByRange((t) => {
        let s = t.from,
          { doc: i } = e;
        if (t.empty && ut.isActiveAt(e, t.from)) {
          let t = i.lineAt(s),
            r = pt(
              (function (e, t) {
                let n = e.resolveInner(t, -1),
                  r = t;
                bt(n) && ((r = n.from), (n = n.parent));
          ...
          if (r.length) {
            let n = r[r.length - 1],
              i = n.to - n.spaceAfter.length + (n.spaceAfter ? 1 : 0);
            if (s - t.from > i && !/\S/.test(t.text.slice(i, s - t.from)))
              return { range: d.cursor(t.from + i), changes: { from: t.from + i, to: s } };
            if (
              s - t.from == i &&
              (!n.item || t.from <= n.item.from || !/\S/.test(t.text.slice(0, n.to)))
            ) {
              let r = t.from + n.from;
              if (n.item && n.node.from < n.item.from && /\S/.test(t.text.slice(n.from, n.to))) {
                let s = n.blank(p(t.text, 4, n.to) - p(t.text, 4, n.from));
                return (
                  r == t.from && (s = kt(s, e)),
                  {
                    range: d.cursor(r + s.length),
                    changes: { from: r, to: t.from + n.to, insert: s },
                  }
                );
              }
              if (r < s) return { range: d.cursor(r), changes: { from: r, to: s } };
            }
          }
        }
        return (r = { range: t });
      });
    return !r && (t(e.update(s, { scrollIntoView: !0, userEvent: 'delete' })), !0);
  },
  St = [
    { key: 'Enter', run: xt },
    { key: 'Backspace', run: Lt },
  ],
  Ct = m({ matchClosingTags: !1 });
function wt(e = {}) {
  let {
    codeLanguages: t,
  ...
  let a,
    ...
    h = [Ct.support];
  n instanceof g ? (h.push(n.support), (a = n.language)) : n && (a = n);
  let f =
    t || a
      ? ((c = t),
        (u = a),
        (e) => {
          if (e && c) {
            ...
            if (
              ((e = /\S*/.exec(e)[0]),
              (t = 'function' == typeof c ? c(e) : I.matchLanguageName(c, e, !0)),
              t instanceof I)
            )
              return t.support ? t.support.language.parser : T.getSkippingParser(t.load());
  ...
  (l.push(
    (function (e) {
      let { codeParser: t, htmlParser: n } = e,
        r = o((e, r) => {
          let s = e.type.id;
          if (!t || (s != E.CodeBlock && s != E.FencedCode)) {
            if (n && (s == E.HTMLBlock || s == E.HTMLTag || s == E.CommentBlock))
              return { parser: n, overlay: Re(e.node, e.from, e.to) };
          } else {
            let n = '';
            if (s == E.FencedCode) {
              let t = e.node.getChild(E.CodeInfo);
              t && (n = r.read(t.from, t.to));
            }
            let i = t(n);
            if (i) return { parser: i, overlay: (e) => e.type.id == E.CodeText };
          }
          return null;
        });
      return { wrap: r };
    })({ codeParser: f, htmlParser: Ct.language.parser }),
  ),
    r && h.push(k.high(x.of(St))));
  let d = ft(s.configure(l));
  return (i && h.push(d.data.of({ autocomplete: yt })), new g(d, h));
}
function yt(e) {
  let { state: t, pos: n } = e,
    r = /<[:\-\.\w\u00b7-\uffff]*$/.exec(t.sliceDoc(n - 25, n));
  if (!r) return null;
  let s = u(t).resolveInner(n, -1);
  for (; s && !s.type.isTop; ) {
    if (
      'CodeBlock' == s.name ||
      'FencedCode' == s.name ||
  ...
  return { from: n - r[0].length, to: n, options: It(), validFor: /^<[:\-\.\w\u00b7-\uffff]*$/ };
}
let At = null;
function It() {
  if (At) return At;
  let e = w(new y(A.create({ extensions: Ct }), 0, !0));
  return (At = e ? e.options : []);
}
export {
  ct as commonmarkLanguage,
  Lt as deleteMarkupBackward,
  xt as insertNewlineContinueMarkup,
  wt as markdown,
  St as markdownKeymap,
  ut as markdownLanguage,
};
