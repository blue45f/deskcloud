...
function Y(O, e) {
  ...
  for (; T(r); ) r = O.peek(++e);
  let t = '';
  for (; x(r); ) ((t += String.fromCharCode(r)), (r = O.peek(++e)));
  return ((y = O), (B = a), (U = t ? t.toLowerCase() : r == g || r == Z ? void 0 : null));
}
const g = 63,
  Z = 33;
function v(O, e) {
  ...
  for (let e = 0; e < O.length; e++)
    this.hash += (this.hash << 4) + O.charCodeAt(e) + (O.charCodeAt(e) << 8);
}
const _ = [4, 8, 5, 6, 7],
  d = new l({
    start: null,
    shift: (O, e, a, r) => (_.indexOf(e) > -1 ? new v(Y(r, 1) || '', O) : O),
    reduce: (O, e) => (67 == e && O ? O.parent : O),
    reuse(O, e, a, r) {
      let t = e.type.id;
      return 4 == t || 118 == t ? new v(Y(r, 1) || '', O) : O;
    },
    hash: (O) => (O ? O.hash : 0),
    strict: !1,
  }),
  m = new s(
    (O, e) => {
      ...
      let r = Y(O, 0);
      if (void 0 === r) return;
      if (!r) return O.acceptToken(a ? 12 : 4);
      let t = e.context ? e.context.name : null;
      if (a) {
        if (r == t) return O.acceptToken(9);
        if (t && f[t]) return O.acceptToken(148, -2);
        for (let O = e.context; O; O = O.parent) if (O.name == r) return;
        O.acceptToken(11);
      } else {
        if ('script' == r) return O.acceptToken(5);
        if ('style' == r) return O.acceptToken(6);
        if ('textarea' == r) return O.acceptToken(7);
        if (h.hasOwnProperty(r)) return O.acceptToken(8);
        t && V[t] && V[t][r] ? O.acceptToken(148, -1) : O.acceptToken(4);
      }
    },
    { contextual: !0 },
  );
  ...
  return new s((t) => {
    for (let $ = 0, q = 0, o = 0; ; o++) {
      ...
      if (
        (0 == $ && 60 == t.next) ||
        (1 == $ && 47 == t.next) ||
        ($ >= 2 && $ < r && t.next == O.charCodeAt($ - 2))
      )
        ($++, q++);
      else if ((2 != $ && $ != r) || !T(t.next)) {
        if ($ == r && 62 == t.next) {
          o > q ? t.acceptToken(e, -q) : t.acceptToken(a, -(q - 2));
          break;
        }
  ...
  return () =>
    e
      ? r
        ...
        : 92 === O.next
          ? ((r = !0), !0)
          : ('double' === a && 34 === O.next) || ('single' === a && 39 === O.next)
            ? ((e = !1), (a = null), !0)
            : 'template' !== a || 96 !== O.next || ((e = !1), (a = null), !0)
      : 34 === O.next
        ? ((e = !0), (a = 'double'), !0)
        : 39 === O.next
          ? ((e = !0), (a = 'single'), !0)
          : 96 === O.next && ((e = !0), (a = 'template'), !0);
}
function D(O) {
  let e = !1,
    a = !1;
  return () =>
    e
      ? 10 !== O.next || ((e = !1), !0)
      : a
        ? 42 !== O.next || 47 !== O.peek(1) || ((a = !1), !0)
        : 47 === O.next && 47 === O.peek(1)
          ? ((e = !0), !0)
          : 47 === O.next && 42 === O.peek(1) && ((a = !0), !0);
}
const R = new s((O) => {
    if (E.includes(O.next)) return;
    const e = D(O),
      a = K(O);
    let r = [];
    const t = (O) => {
      const e = r.lastIndexOf(O);
      if (-1 !== e) for (; r.length > e; ) r.pop();
    };
    for (let $ = 0; ; $++) {
      if (O.next < 0) {
        $ > 0 && O.acceptToken(13);
      ...
      if (e() || a()) O.advance();
        ...
        if (0 === r.length && (O.next === j || 41 === O.next || 93 === O.next)) {
          O.acceptToken(13);
          break;
        }
        switch (O.next) {
  ...
  I = new s((O) => {
    ...
    for (let $ = 0; ; $++) {
      ...
      if (e() || a()) O.advance();
        ...
        if (0 === r.length && (O.next === j || 41 === O.next || 93 === O.next || 44 === O.next)) {
          O.acceptToken(14);
          break;
        }
        switch (O.next) {
        ...
        if (0 !== $ && 0 === r.length && k.includes(O.next)) {
          O.acceptToken(14);
          break;
        }
        O.advance();
  ...
  G = Q({
    ...
    UnquotedAttributeValue: b.attributeValue,
    'DoubleQuote SingleQuote AttributeValueContent': b.attributeValue,
    ...
    SvelteElementNamespace: b.namespace,
    SvelteElementType: b.tagName,
    StyleAttributeName: b.propertyName,
    BlockType: b.controlKeyword,
    BlockPrefix: b.typeOperator,
    'UnknownBlock/BlockType': b.invalid,
    UnknownBlockContent: b.invalid,
    'if then catch': b.controlKeyword,
    as: b.definitionOperator,
    Variable: b.variableName,
    Modifier: b.modifier,
    DirectlyInterpolatedAttributeValue: b.attributeValue,
    'DirectiveOn/DirectiveName': b.controlKeyword,
    'DirectiveOn/DirectiveTarget': b.typeName,
    'DirectiveUse/DirectiveName': b.controlKeyword,
    'DirectiveUse/DirectiveTarget': b.function(b.variableName),
    'DirectiveBind/DirectiveName': b.controlKeyword,
    'DirectiveBind/DirectiveTarget': b.variableName,
    'DirectiveLet/DirectiveName': b.definitionKeyword,
    'DirectiveLet/DirectiveTarget': b.definition(b.variableName),
    'DirectiveTransition/DirectiveName': b.operatorKeyword,
    'DirectiveTransition/DirectiveTarget': b.function(b.variableName),
    'DirectiveIn/DirectiveName': b.operatorKeyword,
    'DirectiveIn/DirectiveTarget': b.function(b.variableName),
    'DirectiveOut/DirectiveName': b.operatorKeyword,
    'DirectiveOut/DirectiveTarget': b.function(b.variableName),
    'DirectiveAnimate/DirectiveName': b.operatorKeyword,
    'DirectiveAnimate/DirectiveTarget': b.function(b.variableName),
    'DirectiveClass/DirectiveName': b.attributeName,
    'DirectiveClass/DirectiveTarget': b.variableName,
    'DirectiveStyle/DirectiveName': b.attributeName,
    'DirectiveStyle/DirectiveTarget': b.propertyName,
  }),
  F = { __proto__: null, '#': 41, ':': 51, '/': 59, '@': 109 },
  J = {
    __proto__: null,
    if: 44,
    else: 52,
  ...
  C = { __proto__: null, if: 54, as: 66, then: 84, catch: 86 },
  L = {
    __proto__: null,
    on: 313,
    bind: 317,
...
function OO(O, e) {
  ...
  for (let r of O.firstChild.getChildren('Attribute')) {
    let O = r.getChild('AttributeName'),
      t = r.getChild('AttributeValue') || r.getChild('UnquotedAttributeValue');
    O &&
      (a[e.read(O.from, O.to)] = t
        ? 'AttributeValue' == t.name
          ? e.read(t.from + 1, t.to - 1)
          : e.read(t.from, t.to)
        : '');
  }
  return a;
...
function eO(O, e, a) {
  let r;
  for (let t of a)
    if (!t.attrs || t.attrs(r || (r = OO(O.node.parent, e)))) return { parser: t.parser };
  return null;
}
const aO = i.configure({ top: 'SingleExpression' });
function rO(O) {
  let e = [],
    a = [],
    r = [];
  for (let t of O) {
    let O = 'script' == t.tag ? e : 'style' == t.tag ? a : 'textarea' == t.tag ? r : null;
...
const tO = [
    {
      tag: 'script',
      attrs: (O) => 'text/typescript' === O.type || 'ts' === O.lang,
      parser: c.parser,
    },
    {
      tag: 'script',
      attrs: (O) =>
        !O.type || /^(?:text|application)\/(?:x-)?(?:java|ecma)script$|^module$|^$/i.test(O.type),
      parser: P.parser,
    },
    {
      tag: 'style',
      attrs: (O) =>
        (!O.lang || 'css' === O.lang || 'scss' === O.lang) &&
        (!O.type || /^(text\/)?(x-)?(stylesheet|css|scss)$/i.test(O.type)),
      parser: u.parser,
    },
  ],
  $O = O.define({
      ...
      props: [
        o.add({
          Element: (O) => {
            ...
            return O.node.to <= O.pos + e[0].length
              ? O.continue()
              : O.lineIndent(O.node.from) + (e[2] ? 0 : O.unit);
          },
          Block: (O) => {
            const e = O.node,
              a = O.textAfter.trim();
            if (a.startsWith('{/')) {
              const r = e.name;
              return ('IfBlock' === r && a.startsWith('{/if')) ||
                ('EachBlock' === r && a.startsWith('{/each')) ||
                ('AwaitBlock' === r && a.startsWith('{/await')) ||
                ('KeyBlock' === r && a.startsWith('{/key'))
                ? O.lineIndent(O.node.from)
                : null;
            }
            if ('IfBlock' === e.name || 'EachBlock' === e.name) {
              if (a.startsWith('{:else')) return O.lineIndent(e.from);
            } else if ('AwaitBlock' === e.name) {
              if (a.startsWith('{:then')) return O.lineIndent(e.from);
              if (a.startsWith('{:catch')) return O.lineIndent(e.from);
            }
            let r = /^(\s*)(<\/)?/.exec(O.textAfter);
            return O.node.to <= O.pos + r[0].length
              ? O.continue()
              : O.lineIndent(O.node.from) + (r[2] ? 0 : O.unit);
          },
          'BlockOpen BlockClose BlockInline': (O) => O.column(O.node.from) + O.unit,
          'OpenTag CloseTag SelfClosingTag': (O) => O.column(O.node.from) + O.unit,
          Document: (O) => {
            ...
            for (let e = O.node; ; ) {
              let O = e.lastChild;
              if (!O || 'Element' != O.name || O.to != e.to) break;
              a = e = O;
            }
            return a &&
              (!(e = a.lastChild) || ('CloseTag' !== e.name && 'SelfClosingTag' !== e.name))
              ? O.lineIndent(a.from) + O.unit
              : null;
          },
        }),
        n.add({
          Block: (O) => {
            const e = `${O.name}Open`,
              ...
              t = O.lastChild;
            return r && r.name === e
              ? { from: r.to, to: (null == t ? void 0 : t.name) === a ? t.from : O.to }
              : null;
          },
          Element: (O) => {
            let e = O.firstChild,
            ...
            return e && 'OpenTag' == e.name
              ? { from: e.to, to: 'CloseTag' === a.name ? a.from : O.to }
              : null;
          },
        }),
      ],
...
function qO() {
  return new a($O, [r().support, t().support, nO]);
}
function oO(O, e, a = O.length) {
  if (!e) return '';
  let r = e.firstChild,
    t =
      r &&
      (r.getChild('TagName') || r.getChild('ComponentName') || r.getChild('SvelteElementName'));
  return t ? O.sliceString(t.from, Math.min(t.to, a)) : '';
}
const nO = $.inputHandler.of((O, e, a, r) => {
  if (
    O.composing ||
    O.state.readOnly ||
    e != a ||
    ('>' != r && '/' != r) ||
    !$O.isActiveAt(O.state, e, -1)
  )
    return !1;
  let { state: t } = O,
    $ = t.changeByRange((e) => {
      ...
      let o,
        { head: n } = e,
        s = p(t).resolveInner(n, -1);
      if (
        (('TagName' !== s.name &&
          'ComponentName' !== s.name &&
          'SvelteElementName' !== s.name &&
          'StartTag' !== s.name) ||
          (s = s.parent),
        '>' === r && 'OpenTag' === s.name)
      ) {
        if (
          'CloseTag' !=
            (null === ($ = null === (a = s.parent) || void 0 === a ? void 0 : a.lastChild) ||
            void 0 === $
              ? void 0
              : $.name) &&
          (o = oO(t.doc, s.parent, n))
        ) {
          let e = '>' === O.state.doc.sliceString(n, n + 1),
            a = `${e ? '' : '>'}</${o}>`;
          return { range: w.cursor(n + 1), changes: { from: n + (e ? 1 : 0), insert: a } };
        }
      } else if ('/' === r && 'OpenTag' === s.name) {
        let e = s.parent,
          a = null == e ? void 0 : e.parent;
        if (
          e.from == n - 1 &&
          'CloseTag' != (null === (q = a.lastChild) || void 0 === q ? void 0 : q.name) &&
          (o = oO(t.doc, a, n))
        ) {
          let e = '>' === O.state.doc.sliceString(n, n + 1),
            a = `/${o}${e ? '' : '>'}`,
            r = n + a.length + (e ? 1 : 0);
          return { range: w.cursor(r), changes: { from: n, insert: a } };
        }
      }
      return { range: e };
    });
  return !$.changes.empty && (O.dispatch($, { userEvent: 'input.type', scrollIntoView: !0 }), !0);
});
export { qO as svelte, $O as svelteLanguage, z as svelteParser };
