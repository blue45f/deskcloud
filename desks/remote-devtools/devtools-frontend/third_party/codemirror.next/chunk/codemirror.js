...
class O {
  ...
  resolve(t, e = 0) {
    let i = p(l.get(this) || this.topNode, t, e, !1);
    return (l.set(this, i), i);
  }
  resolveInner(t, e = 0) {
    let i = p(h.get(this) || this.topNode, t, e, !0);
  ...
  resolveStack(t, e = 0) {
    return (function (t, e, i) {
      let n = t.resolveInner(e, i),
        r = null;
      for (let t = n instanceof g ? n : n.context.parent; t; t = t.parent)
        if (t.index < 0) {
          let s = t.parent;
          ...
          if (o && o.overlay && o.overlay[0].from <= e && o.overlay[o.overlay.length - 1].to >= e) {
            let s = new g(o.tree, o.overlay[0].from + t.from, -1, t);
            (r || (r = [n])).push(p(s, e, i, !1));
          }
        }
      return r ? v(r) : n;
    })(this, t, e);
  ...
  iterate(t) {
    let { enter: e, leave: i, from: n = 0, to: s = this.length } = t,
      r = t.mode || 0,
      o = (r & c.IncludeAnonymous) > 0;
    for (let t = this.cursor(r | c.IncludeAnonymous); ; ) {
      let r = !1;
      if (t.from <= s && t.to >= n && ((!o && t.type.isAnonymous) || !1 !== e(t))) {
  ...
  balance(t = {}) {
    return this.children.length <= 8
      ...
      : T(
          ...
          0,
          this.length,
          (t, e, i) => new O(this.type, t, e, i, this.propValues),
          t.makeTree || ((t, e, i) => new O(o.none, t, e, i)),
        );
  }
  static build(e) {
    return (function (e) {
      ...
      let {
        ...
        h = Array.isArray(s) ? new u(s, s.length) : s,
        c = r.types,
        d = 0,
        p = 0;
      function m(t, e, i, n, s, O) {
        let { id: u, start: y, end: x, size: k } = h,
          $ = p,
          P = d;
        for (; k < 0; ) {
          if ((h.next(), -1 == k)) {
            let e = a[u];
            return (i.push(e), void n.push(y - t));
          }
          if (-3 == k) return void (d = u);
          if (-4 == k) return void (p = u);
        ...
        let Z,
          ...
          A = c[u],
          C = y - t;
        if (x - y <= o && (X = S(h.pos - e, s))) {
          let e = new Uint16Array(X.size - X.skip),
            i = h.pos - X.size,
            n = e.length;
          for (; h.pos > i; ) n = v(X.start, e, n);
          ((Z = new f(e, x - X.start, r)), (C = X.start - t));
        } else {
          let t = h.pos - k;
          h.next();
          let e = [],
          ...
          for (; h.pos > t; )
            n >= 0 && h.id == n && h.size >= 0
              ? (h.end <= r - o && (w(e, i, y, s, h.end, r, n, $, P), (s = e.length), (r = h.end)),
                h.next())
              : O > 2500
                ? g(y, t, e, i)
                : m(y, t, e, i, n, O + 1);
          if (
            (n >= 0 && s > 0 && s < e.length && w(e, i, y, s, y, r, n, $, P),
            e.reverse(),
            i.reverse(),
            n > -1 && s > 0)
          ) {
            let t = Q(A, P);
            Z = T(A, e, i, 0, e.length, 0, x - y, t, t);
          } else Z = b(A, e, i, x - y, $ - x, P);
        }
        (i.push(Z), n.push(C));
      }
      function g(t, e, i, n) {
        ...
        for (; h.pos > e; ) {
          ...
          if (n > 4) h.next();
            ...
            if (l > -1 && e < l) break;
            (l < 0 && (l = i - o), s.push(t, e, i), a++, h.next());
          }
        }
        if (a) {
          let e = new Uint16Array(4 * a),
            o = s[s.length - 2];
          for (let t = s.length - 3, i = 0; t >= 0; t -= 3)
            ((e[i++] = s[t]), (e[i++] = s[t + 1] - o), (e[i++] = s[t + 2] - o), (e[i++] = i));
          (i.push(new f(e, s[2] - o, r)), n.push(o - t));
        }
      }
      function Q(t, e) {
        return (i, s, r) => {
          let o,
            ...
            l = 0,
            h = i.length - 1;
          if (h >= 0 && (o = i[h]) instanceof O) {
            if (!h && o.type == t && o.length == r) return o;
            (a = o.prop(n.lookAhead)) && (l = s[h] + o.length + a);
          }
          return b(t, i, s, r, l, e);
        };
      }
      function w(t, e, i, n, s, o, a, l, h) {
        let c = [],
          O = [];
        for (; t.length > n; ) (c.push(t.pop()), O.push(e.pop() + i - s));
        (t.push(b(r.types[a], c, O, o - s, l - o, h)), e.push(s - i));
      }
      function b(t, e, i, s, r, o, a) {
        if (o) {
          let t = [n.contextHash, o];
          a = a ? [t].concat(a) : [t];
        }
        if (r > 25) {
          let t = [n.lookAhead, r];
      ...
      function S(t, e) {
        ...
        return (
          (e < 0 || n == t) && ((c.size = n), (c.start = s), (c.skip = r)),
          c.size > 4 ? c : void 0
        );
      }
      function v(t, e, i) {
      ...
      let y = [],
        x = [];
      for (; h.pos > 0; ) m(e.start || 0, e.bufferStart || 0, y, x, -1, 0);
      let k = null !== (i = e.length) && void 0 !== i ? i : y.length ? x[0] + y[0].length : 0;
      return new O(c[e.topID], y.reverse(), x.reverse(), k);
    })(e);
  }
}
O.empty = new O(o.none, [], [], 0);
class u {
  constructor(t, e) {
  ...
  fork() {
    return new u(this.buffer, this.index);
  }
}
class f {
  constructor(t, e, i) {
  ...
  slice(t, e, i) {
    ...
    for (let o = t, a = 0; o < e; ) {
      ((s[a++] = n[o++]), (s[a++] = n[o++] - i));
      let e = (s[a++] = n[o++] - i);
      ((s[a++] = n[o++] - t), (r = Math.max(r, e)));
    }
    return new f(s, r, this.set);
  }
}
function d(t, e, i, n) {
  switch (t) {
...
function p(t, e, i, n) {
  for (
    var s;
    t.from == t.to || (i < 1 ? t.from >= e : t.from > e) || (i > -1 ? t.to <= e : t.to < e);
  ) {
    let e = !n && t instanceof g && t.index < 0 ? null : t.parent;
    if (!e) return t;
    t = e;
  }
...
class g extends m {
  ...
  nextChild(t, e, i, n, r = 0) {
    for (let o = this; ; ) {
      for (let { children: a, positions: l } = o._tree, h = e > 0 ? a.length : -1; t != h; t += e) {
        let h = a[t],
          O = l[t] + o.from;
        if (d(n, i, O, O + h.length))
          if (h instanceof f) {
            if (r & c.ExcludeBuffers) continue;
            let s = h.findChild(0, h.buffer.length, e, i - O, n);
            if (s > -1) return new S(new b(o, h, t, O), null, s);
          } else if (r & c.IncludeAnonymous || !h.type.isAnonymous || k(h)) {
            let a;
            if (!(r & c.IgnoreMounts) && (a = s.get(h)) && !a.overlay)
              return new g(a.tree, O, t, o);
            let l = new g(h, O, t, o);
      ...
      if (
        ((t = o.index >= 0 ? o.index + e : e < 0 ? -1 : o._parent._tree.children.length),
        (o = o._parent),
        !o)
      )
        return null;
  ...
  enter(t, e, i = 0) {
    let n;
    if (!(i & c.IgnoreOverlays) && (n = s.get(this._tree)) && n.overlay) {
      let i = t - this.from;
      for (let { from: t, to: s } of n.overlay)
        if ((e > 0 ? t <= i : t < i) && (e < 0 ? s >= i : s > i))
          return new g(n.tree, n.overlay[0].from + this.from, -1, this);
    }
...
class S extends m {
  ...
  child(t, e, i) {
    ...
    return s < 0 ? null : new S(this.context, this, s);
  }
  get firstChild() {
  ...
  get nextSibling() {
    ...
    return e < (this._parent ? t.buffer[this._parent.index + 3] : t.buffer.length)
      ? new S(this.context, this._parent, e)
  ...
  get prevSibling() {
    ...
    return this.index == e
      ? this.externalSibling(-1)
      : new S(this.context, this._parent, t.findChild(e, this.index, -1, 0, 4));
  }
  get tree() {
    return null;
  }
  toTree() {
    ...
    return new O(this.type, t, e, this.to - this.from);
  }
  toString() {
...
function v(t) {
  ...
  let n = i instanceof g && i.index < 0 ? null : i.parent,
    s = t.slice();
  return (n ? (s[e] = n) : s.splice(e, 1), new y(s, i));
}
class y {
  constructor(t, e) {
...
class x {
  ...
  enterChild(t, e, i) {
    if (!this.buffer)
      return this.yield(
        this._tree.nextChild(t < 0 ? this._tree._tree.children.length - 1 : 0, t, e, i, this.mode),
      );
  ...
  enter(t, e, i = this.mode) {
    return this.buffer
      ? !(i & c.ExcludeBuffers) && this.enterChild(1, t, e)
      : this.yield(this._tree.enter(t, e, i));
  }
  parent() {
    if (!this.buffer)
      return this.yieldNode(
        this.mode & c.IncludeAnonymous ? this._tree._parent : this._tree.parent,
      );
  ...
  sibling(t) {
    ...
    return (
      i < 0 && this.yield(this.buffer.parent.nextChild(this.buffer.index + t, t, 0, 4, this.mode))
    );
  }
  nextSibling() {
  ...
  atLastNode(t) {
    ...
    if (n) {
      if (t > 0) {
        ...
        for (let t = 0; t < this.index; t++) if (n.buffer.buffer[t + 3] < this.index) return !1;
      ({ index: e, parent: i } = n);
    ...
    for (; i; { index: e, _parent: i } = i)
      if (e > -1)
        for (let n = e + t, s = t < 0 ? -1 : i._tree.children.length; n != s; n += t) {
          ...
          if (this.mode & c.IncludeAnonymous || t instanceof f || !t.type.isAnonymous || k(t))
            return !1;
        }
    return !0;
  }
  ...
  matchContext(t) {
    if (!this.buffer) return w(this.node.parent, t);
    let { buffer: e } = this.buffer,
      { types: i } = e.set;
    for (let n = t.length - 1, s = this.stack.length - 1; n >= 0; s--) {
      if (s < 0) return w(this._tree, t, n);
...
function k(t) {
  return t.children.some((t) => t instanceof f || !t.type.isAnonymous || k(t));
}
const $ = new WeakMap();
function P(t, e) {
...
class Z {
  ...
  set(t, e) {
    t instanceof S
      ...
      : t instanceof g && this.map.set(t.tree, e);
  }
  get(t) {
...
class X {
  ...
  static addTree(t, e = [], i = !1) {
    let n = [new X(0, t.length, t, 0, !1, i)];
        ...
        for (; r && r.from < c; ) {
          ...
          if (a >= e.from || c <= e.to || l) {
            let t = Math.max(e.from, a) - l,
              i = Math.min(e.to, c) - l;
            e = t >= i ? null : new X(t, i, e.tree, e.offset + l, o > 0, !!h);
          }
...
class M {
  constructor(t, e, i, n, s) {
    ((this.parser = t), (this.parse = e), (this.overlay = i), (this.target = n), (this.from = s));
  }
}
function _(t) {
...
class V {
      ...
      return (
        null != this.stoppedAt &&
          (t = new O(
            ...
            t.positions,
            t.length,
            t.propValues.concat([[z, this.stoppedAt]]),
          )),
        t
      );
    }
  ...
  startInner() {
    let t = new j(this.fragments),
      e = null,
      n = null,
      s = new x(
        new g(this.baseTree, this.ranges[0].from, 0, null),
        c.IncludeAnonymous | c.IgnoreMounts,
      );
    t: for (let r, o; ; ) {
      let a,
        l = !0;
      if (null != this.stoppedAt && s.from >= this.stoppedAt) l = !1;
      else if (t.hasNode(s)) {
        if (e) {
          let t = e.mounts.find(
            (t) => t.frag.from <= s.from && t.frag.to >= s.to && t.mount.overlay,
          );
          if (t)
        ...
        l = !1;
      } else if (n && (o = q(n.ranges, s.from, s.to))) l = 2 != o;
      else if (
        !s.type.isAnonymous &&
        ...
        if ('function' == typeof r.overlay)
          e = new Y(r.parser, r.overlay, o, this.inner.length, s.from, s.tree, e);
        else {
          let t = L(this.ranges, r.overlay || (s.from < s.to ? [new i(s.from, s.to)] : []));
          (t.length && _(t),
            (!t.length && r.overlay) ||
              this.inner.push(
                new M(
                  r.parser,
                  t.length ? r.parser.startParse(this.input, B(o, t), t) : r.parser.startParse(''),
        ...
        e &&
        (a = e.predicate(s)) &&
        (!0 === a && (a = new i(s.from, s.to)), a.from < a.to)
      ) {
        let t = e.ranges.length - 1;
        t >= 0 && e.ranges[t].to == a.from
          ? (e.ranges[t] = { from: e.ranges[t].from, to: a.to })
          : e.ranges.push(a);
      }
          ...
          if (e && !--e.depth) {
            ...
            (t.length &&
              ...
              this.inner.splice(
                ...
                new M(
                  e.parser,
                  e.parser.startParse(this.input, B(e.mounts, t), t),
...
function D(t) {
  ...
  let s = t.tree,
    ...
    l = a.buffer,
    h = [r];
  s.children[r] = (function t(n, s, r, o, c, u) {
    let f = i[u],
      d = [],
      p = [];
    E(a, n, f, d, p, o);
    let m = l[f + 1],
      g = l[f + 2];
    h.push(d.length);
    let Q = u ? t(f + 4, l[f + 3], a.set.types[l[f]], m, g - m, u - 1) : e.toTree();
    return (d.push(Q), p.push(m - o), E(a, l[f + 3], s, d, p, o), new O(r, d, p, c));
  })(0, l.length, o.none, 0, a.length, i.length - 1);
  for (let e of h) {
    let i = t.tree.children[e],
      n = t.tree.positions[e];
    t.yield(new g(i, n + t.from, e, t._tree));
  }
}
class W {
  constructor(t, e) {
    ((this.offset = e),
      (this.done = !1),
      (this.cursor = t.cursor(c.IncludeAnonymous | c.IgnoreMounts)));
  }
  moveTo(t) {
    let { cursor: e } = this,
      i = t - this.offset;
    for (; !this.done && e.from < i; )
      (e.to >= t && e.enter(i, 1, c.IgnoreOverlays | c.ExcludeBuffers)) ||
        e.next(!1) ||
        (this.done = !0);
  }
  hasNode(t) {
    if (
      ...
      for (let e = this.cursor.tree; ; ) {
        ...
        if (!(e.children.length && 0 == e.positions[0] && e.children[0] instanceof O)) break;
        e = e.children[0];
      }
    return !1;
  }
...
let j = class {
  constructor(t) {
    ...
    if (((this.fragments = t), (this.curTo = 0), (this.fragI = 0), t.length)) {
      ...
      ((this.curTo = null !== (e = i.tree.prop(z)) && void 0 !== e ? e : i.to),
        (this.inner = new W(i.tree, -i.offset)));
    } else this.curFrag = this.inner = null;
  }
  hasNode(t) {
    for (; this.curFrag && t.from >= this.curTo; ) this.nextFrag();
    return (
      this.curFrag && this.curFrag.from <= t.from && this.curTo >= t.to && this.inner.hasNode(t)
    );
  }
  nextFrag() {
    var t;
    if ((this.fragI++, this.fragI == this.fragments.length)) this.curFrag = this.inner = null;
      ...
      ((this.curTo = null !== (t = e.tree.prop(z)) && void 0 !== t ? t : e.to),
        (this.inner = new W(e.tree, -e.offset)));
    }
  }
  findMounts(t, e) {
    var i;
...
function G(t, e, n, s) {
  let r = 0,
    ...
    c = [];
  for (;;) {
    let O = r == t.length ? 1e9 : a ? t[r].to : t[r].from,
      u = o == e.length ? 1e9 : l ? e[o].to : e[o].from;
    if (a != l) {
      let t = Math.max(h, n),
        e = Math.min(O, u, s);
      t < e && c.push(new i(t, e));
    }
    if (((h = Math.min(O, u)), 1e9 == h)) break;
    (O == h && (a ? ((a = !1), r++) : (a = !0)), u == h && (l ? ((l = !1), o++) : (l = !0)));
  }
  return c;
}
function B(t, e) {
  ...
  for (let { pos: s, mount: r, frag: o } of t) {
    ...
    if (r.overlay) {
      ...
      for (let e = 0, i = l; ; e++) {
        ...
        if (
          (l > i &&
            n.push(new X(i, l, r.tree, -t, o.from >= i || o.openStart, o.to <= l || o.openEnd)),
          s)
        )
          break;
        i = a[e].to;
      }
    } else n.push(new X(l, h, r.tree, -t, o.from >= t || o.openStart, o.to <= a || o.openEnd));
  }
  return n;
}
let I = [],
...
(() => {
  ...
  for (let e = 0, i = 0; e < t.length; e++) (e % 2 ? N : I).push((i += t[e]));
})();
function H(t, e, i = !0, n = !0) {
  return (i ? K : J)(t, e, n);
}
function K(t, e, i) {
  if (e == t.length) return e;
  e && et(t.charCodeAt(e)) && it(t.charCodeAt(e - 1)) && e--;
  let n = tt(t, e);
  for (e += nt(n); e < t.length; ) {
    let s = tt(t, e);
    if (8205 == n || 8205 == s || (i && U(s))) ((e += nt(s)), (n = s));
    else {
      if (!F(s)) break;
      {
        let i = 0,
          n = e - 2;
        for (; n >= 0 && F(tt(t, n)); ) (i++, (n -= 2));
        if (i % 2 == 0) break;
        e += 2;
      }
    }
...
function tt(t, e) {
  ...
  if (!it(i) || e + 1 == t.length) return i;
  let n = t.charCodeAt(e + 1);
  return et(n) ? n - 56320 + ((i - 55296) << 10) + 65536 : i;
}
function et(t) {
...
class st {
  ...
  replace(t, e, i) {
    ...
    return (
      ...
      ot.from(n, this.length - (e - t) + i.length)
    );
  }
  append(t) {
  ...
  slice(t, e = this.length) {
    [t, e] = ft(this, t, e);
    let i = [];
    return (this.decompose(t, e, i, 0), ot.from(i, e - t));
  }
  eq(t) {
    if (t == this) return !0;
  ...
  iterLines(t, e) {
    ...
    if (null == t) i = this.iter();
      ...
      i = this.iterRange(
        n,
        Math.max(n, e == this.lines + 1 ? this.length : e <= 1 ? 0 : this.line(e - 1).to),
      );
    }
    return new Ot(i);
  }
...
class rt extends st {
  ...
  lineInner(t, e, i, n) {
    for (let s = 0; ; s++) {
      let r = this.text[s],
        o = n + r.length;
      if ((e ? i : o) >= t) return new ut(n, o, i, r);
      ((n = o + 1), i++);
    }
  }
  decompose(t, e, i, n) {
    let s =
      t <= 0 && e >= this.length
        ? this
        : new rt(lt(this.text, t, e), Math.min(e, this.length) - Math.max(0, t));
    if (1 & n) {
      let t = i.pop(),
        e = at(s.text, t.text.slice(), 0, s.length);
      if (e.length <= 32) i.push(new rt(e, t.length + s.length));
      else {
        let t = e.length >> 1;
        i.push(new rt(e.slice(0, t)), new rt(e.slice(t)));
      }
    } else i.push(s);
  }
  replace(t, e, i) {
    ...
    [t, e] = ft(this, t, e);
    let n = at(this.text, at(i.text, lt(this.text, 0, t)), e),
      s = this.length + i.length - (e - t);
    return n.length <= 32 ? new rt(n, s) : ot.from(rt.split(n, []), s);
  }
  sliceString(t, e = this.length, i = '\n') {
    ...
    for (let s = 0, r = 0; s <= e && r < this.text.length; r++) {
      let o = this.text[r],
        a = s + o.length;
      (s > t && r && (n += i),
        t < a && e > s && (n += o.slice(Math.max(0, t - s), e - s)),
        (s = a + 1));
    }
    return n;
  }
  ...
  static split(t, e) {
    ...
    for (let s of t)
      (i.push(s),
        (n += s.length + 1),
        32 == i.length && (e.push(new rt(i, n)), (i = []), (n = -1)));
...
class ot extends st {
  ...
  replace(t, e, i) {
    if ((([t, e] = ft(this, t, e)), i.lines < this.lines))
      for (let n = 0, s = 0; n < this.children.length; n++) {
        ...
        if (t >= s && e <= o) {
          ...
          if (a.lines < l >> 4 && a.lines > l >> 6) {
            ...
            return ((s[n] = a), new ot(s, this.length - (e - t) + i.length));
          }
  ...
  sliceString(t, e = this.length, i = '\n') {
    ...
    for (let s = 0, r = 0; s < this.children.length && r <= e; s++) {
      let o = this.children[s],
        a = r + o.length;
      (r > t && s && (n += i),
        t < a && e > r && (n += o.sliceString(t - r, e - r, i)),
        (r = a + 1));
    }
    return n;
  }
  ...
  static from(t, e = t.reduce((t, e) => t + e.length + 1, -1)) {
    ...
    function c(t) {
      let e;
      if (t.lines > s && t instanceof ot) for (let e of t.children) c(e);
      else
        t.lines > r && (a > r || !a)
          ? (O(), o.push(t))
          : t instanceof rt && a && (e = h[h.length - 1]) instanceof rt && t.lines + e.lines <= 32
            ? ((a += t.lines),
              (l += t.length + 1),
              (h[h.length - 1] = new rt(e.text.concat(t.text), e.length + 1 + t.length)))
            : (a + t.lines > n && O(), (a += t.lines), (l += t.length + 1), h.push(t));
    }
    function O() {
      0 != a && (o.push(1 == h.length ? h[0] : ot.from(h, l)), (l = -1), (a = h.length = 0));
    }
    for (let e of t) c(e);
    return (O(), 1 == o.length ? o[0] : new ot(o, e));
  }
}
function at(t, e, i = 0, n = 1e9) {
...
class ht {
  constructor(t, e = 1) {
    ((this.dir = e),
      ...
      (this.value = ''),
      (this.nodes = [t]),
      (this.offsets = [e > 0 ? 1 : (t instanceof rt ? t.text.length : t.children.length) << 1]));
  }
  nextInner(t, e) {
    for (this.done = this.lineBreak = !1; ; ) {
      let i = this.nodes.length - 1,
        ...
        s = this.offsets[i],
        r = s >> 1,
        o = n instanceof rt ? n.text.length : n.children.length;
      if (r == (e > 0 ? o : 0)) {
        ...
        t > s.length
          ...
          : (e < 0 && this.offsets[i]--,
            this.nodes.push(s),
            this.offsets.push(
              e > 0 ? 1 : (s instanceof rt ? s.text.length : s.children.length) << 1,
            ));
      }
    }
  }
...
'undefined' != typeof Symbol &&
  ...
  (ht.prototype[Symbol.iterator] =
    ct.prototype[Symbol.iterator] =
    Ot.prototype[Symbol.iterator] =
      function () {
        return this;
      }));
class ut {
...
class bt {
  ...
  composeDesc(t) {
    return this.empty ? t : t.empty ? this : $t(this, t);
  }
  mapDesc(t, e = !1) {
    return t.empty ? this : kt(this, t, e);
  }
    ...
    for (let r = 0; r < this.sections.length; ) {
      ...
      if (a < 0) {
        ...
        if (
          i != wt.Simple &&
          l >= t &&
          ((i == wt.TrackDel && n < t && l > t) ||
            (i == wt.TrackBefore && n < t) ||
            (i == wt.TrackAfter && l > t))
        )
          return null;
...
class St extends bt {
  ...
  apply(t) {
    ...
    return (xt(this, (e, i, n, s, r) => (t = t.replace(n, n + (i - e), r)), !1), t);
  }
  mapDesc(t, e = !1) {
  ...
  invert(t) {
    ...
    for (let n = 0, s = 0; n < e.length; n += 2) {
      ...
      if (o >= 0) {
        ((e[n] = o), (e[n + 1] = r));
        let a = n >> 1;
        for (; i.length < a; ) i.push(st.empty);
        i.push(r ? t.slice(s, s + r) : st.empty);
      }
      s += r;
    }
    return new St(e, i);
  ...
  compose(t) {
    return this.empty ? t : t.empty ? this : $t(this, t, !0);
  }
  map(t, e = !1) {
    return t.empty ? this : kt(this, t, e, !0);
  }
  iterChanges(t, e = !1) {
    xt(this, t, e);
  }
  get desc() {
    return bt.create(this.sections);
  }
  filter(t) {
    let e = [],
      i = [],
    ...
    t: for (let r = 0, o = 0; ; ) {
      ...
      for (; o < a || (o == a && 0 == s.len); ) {
        ...
        (vt(e, t, r), r > 0 && yt(i, e, s.text), s.forward(t), (o += t));
      }
      let l = t[r++];
      for (; o < l; ) {
        if (s.done) break t;
        let t = Math.min(s.len, l - o);
        (vt(e, t, -1), vt(n, t, -1 == s.ins ? -1 : 0 == s.off ? s.ins : 0), s.forward(t), (o += t));
      }
    }
    return { changes: new St(e, i), filtered: bt.create(n) };
  }
  toJSON() {
    let t = [];
    for (let e = 0; e < this.sections.length; e += 2) {
    ...
    return (
      (function t(l) {
        if (Array.isArray(l)) for (let e of l) t(e);
          ...
          if (l.length != e)
            throw new RangeError(`Mismatched change set length (got ${l.length}, expected ${e})`);
          (a(), (o = o ? o.compose(l.map(o)) : l));
        } else {
          let { from: t, to: o = t, insert: h } = l;
          if (t > o || t < 0 || o > e)
            throw new RangeError(`Invalid change range ${t} to ${o} (in doc of length ${e})`);
          let c = h ? ('string' == typeof h ? st.of(h.split(i || Qt)) : h) : st.empty,
            O = c.length;
          if (t == o && 0 == O) return;
          (t < r && a(), t > r && vt(n, t - r, -1), vt(n, o - t, O), yt(s, n, c), (r = o));
        }
      })(t),
      a(!o),
      o
    ...
    for (let n = 0; n < t.length; n++) {
      ...
      if ('number' == typeof s) e.push(s, -1);
        ...
        if (1 == s.length) e.push(s[0], 0);
          ...
          ((i[n] = st.of(s.slice(1))), e.push(s[0], i[n].length));
        }
      }
    }
    return new St(e, i);
...
function yt(t, e, i) {
  ...
  if (n < t.length) t[t.length - 1] = t[t.length - 1].append(i);
    ...
    for (; t.length < n; ) t.push(st.empty);
    t.push(i);
  }
}
function xt(t, e, i) {
...
function kt(t, e, i, n = !1) {
  ...
  for (let t = -1; ; ) {
    ...
    if (-1 == o.ins && -1 == a.ins) {
      ...
      (vt(s, t, -1), o.forward(t), a.forward(t));
    } else if (
      a.ins >= 0 &&
      (o.ins < 0 || t == o.i || (0 == o.off && (a.len < o.len || (a.len == o.len && !i))))
    ) {
      let e = a.len;
      for (vt(s, a.ins, -1); e; ) {
        let i = Math.min(o.len, e);
        (o.ins >= 0 && t < o.i && o.len <= i && (vt(s, 0, o.ins), r && yt(r, s, o.text), (t = o.i)),
          o.forward(i),
          (e -= i));
      }
      a.next();
      ...
      if (!(o.ins >= 0)) {
        if (o.done && a.done) return r ? St.createSet(s, r) : bt.create(s);
      ...
      }
      {
        ...
        (vt(s, e, t < o.i ? o.ins : 0),
          r && t < o.i && yt(r, s, o.text),
          (t = o.i),
          o.forward(o.len - i));
      }
    }
...
function $t(t, e, i = !1) {
  let n = [],
    ...
    o = new Pt(e);
  for (let t = !1; ; ) {
    if (r.done && o.done) return s ? St.createSet(n, s) : bt.create(n);
    if (0 == r.ins) (vt(n, r.len, 0, t), r.next());
      ...
      if (r.done || o.done) throw new Error('Mismatched change set lengths');
      {
        ...
        if (-1 == r.ins) {
          ...
          (vt(n, e, i, t), s && i && yt(s, n, o.text));
        } else
          -1 == o.ins
            ? (vt(n, r.off ? 0 : r.len, e, t), s && yt(s, n, r.textBit(e)))
            : (vt(n, r.off ? 0 : r.len, o.off ? 0 : o.ins, t), s && !o.off && yt(s, n, o.text));
        ((t = (r.ins > e || (o.ins >= 0 && o.len > e)) && (t || n.length > i)),
          r.forward2(e),
          o.forward(e));
      }
    } else (vt(n, 0, o.ins, t), s && yt(s, n, o.text), o.next());
  }
}
class Pt {
  constructor(t) {
  ...
  textBit(t) {
    let { inserted: e } = this.set,
      i = (this.i - 2) >> 1;
    return i >= e.length && !t ? st.empty : e[i].slice(this.off, null == t ? void 0 : this.off + t);
  }
  forward(t) {
...
class Tt {
  ...
  map(t, e = -1) {
    ...
    return (
      ...
      i == this.from && n == this.to ? this : new Tt(i, n, this.flags)
    );
  }
  extend(t, e = t) {
    if (t <= this.anchor && e >= this.anchor) return Zt.range(t, e);
    let i = Math.abs(t - this.anchor) > Math.abs(e - this.anchor) ? t : e;
    return Zt.range(this.anchor, i);
  }
  eq(t, e = !1) {
    return !(
  ...
  static fromJSON(t) {
    ...
    return Zt.range(t.anchor, t.head);
  }
  static create(t, e, i) {
    return new Tt(t, e, i);
  }
...
class Zt {
  ...
  asSingle() {
    return 1 == this.ranges.length ? this : new Zt([this.main], 0);
  }
  addRange(t, e = !0) {
    return Zt.create([t].concat(this.ranges), e ? 0 : this.mainIndex + 1);
  }
  replaceRange(t, e = this.mainIndex) {
    let i = this.ranges.slice();
    return ((i[e] = t), Zt.create(i, this.mainIndex));
  }
  toJSON() {
  ...
  static fromJSON(t) {
    ...
    return new Zt(
      t.ranges.map((t) => Tt.fromJSON(t)),
      t.main,
    );
  }
  static single(t, e = t) {
    return new Zt([Zt.range(t, e)], 0);
  }
  static create(t, e = 0) {
    if (0 == t.length) throw new RangeError('A selection needs at least one range');
    for (let i = 0, n = 0; n < t.length; n++) {
      let s = t[n];
      if (s.empty ? s.from <= i : s.from < i) return Zt.normalized(t.slice(), e);
      i = s.to;
    }
    return new Zt(t, e);
  }
  ...
  static range(t, e, i, n) {
    let s = ((null != i ? i : 16777215) << 6) | (null == n ? 7 : Math.min(6, n));
    return e < t ? Tt.create(e, t, 48 | s) : Tt.create(t, e, (e > t ? 8 : 0) | s);
  }
  static normalized(t, e = 0) {
    ...
    for (let i = 1; i < t.length; i++) {
      ...
      if (n.empty ? n.from <= s.to : n.from < s.to) {
        ...
        (i <= e && e--, t.splice(--i, 2, n.anchor > n.head ? Zt.range(o, r) : Zt.range(r, o)));
      }
    }
    return new Zt(t, e);
  }
...
class Ct {
  ...
  static define(t = {}) {
    return new Ct(
      ...
      t.compare || (t.combine ? (t, e) => t === e : Rt),
      !!t.static,
      t.enables,
    );
  }
  of(t) {
    return new Mt([], this, 0, t);
  }
  compute(t, e) {
    if (this.isStatic) throw new Error("Can't compute a static facet");
    return new Mt(t, this, 1, e);
  }
  computeN(t, e) {
    if (this.isStatic) throw new Error("Can't compute a static facet");
    return new Mt(t, this, 2, e);
  }
  from(t, e) {
  ...
  dynamicSlot(t) {
    ...
    for (let i of this.dependencies)
      'doc' == i
        ...
        : 'selection' == i
          ? (l = !0)
          : 1 & (null !== (e = t[i.id]) && void 0 !== e ? e : 1) || h.push(t[i.id]);
    return {
      create: (t) => ((t.values[r] = i(t)), 1),
      update(t, e) {
        if ((a && e.docChanged) || (l && (e.docChanged || e.selection)) || Yt(t, h)) {
          let e = i(t);
          if (o ? !_t(e, t.values[r], n) : !n(e, t.values[r])) return ((t.values[r] = e), 1);
        }
        return 0;
      },
      reconfigure: (t, e) => {
        ...
        if (null != l) {
          ...
          if (
            this.dependencies.every((i) =>
              i instanceof Ct
                ? e.facet(i) === t.facet(i)
                : !(i instanceof qt) || e.field(i, !1) == t.field(i, !1),
            ) ||
            (o ? _t((a = i(t)), s, n) : n((a = i(t)), s))
          )
  ...
  return {
    ...
    reconfigure(t, s) {
      let r = Yt(t, n),
        ...
        h = s.facet(e);
      if (l && !r && Rt(i, l)) return ((t.values[o] = h), 0);
      let c = a(t);
      return e.compare(c, h) ? ((t.values[o] = h), 0) : ((t.values[o] = c), 1);
    },
  };
}
const Vt = Ct.define({ static: !0 });
class qt {
  constructor(t, e, i, n, s) {
    ((this.id = t),
      (this.createF = e),
  ...
  static define(t) {
    let e = new qt(At++, t.create, t.update, t.compare || ((t, e) => t === e), t);
    return (t.provide && (e.provides = t.provide(e)), e);
  }
  create(t) {
    let e = t.facet(Vt).find((t) => t.field == this);
    ...
    return {
      ...
      reconfigure: (t, i) => {
        let n,
          s = t.facet(Vt),
          r = i.facet(Vt);
        return (n = s.find((t) => t.field == this)) && n != r.find((t) => t.field == this)
  ...
  init(t) {
    return [this, Vt.of({ field: this, create: t })];
  }
  get extension() {
    return this;
  }
...
const Gt = { highest: Lt(0), high: Lt(jt), default: Lt(Wt), low: Lt(Dt), lowest: Lt(Et) };
class Bt {
  constructor(t, e) {
...
class It {
  ...
  reconfigure(t) {
    return It.reconfigure.of({ compartment: this, extension: t });
  }
  get(t) {
  ...
  static resolve(t, e, i) {
    ...
    for (let i of (function (t, e, i) {
      ...
      function r(t, o) {
        ...
        if (null != a) {
          if (a <= o) return;
          let e = n[a].indexOf(t);
          (e > -1 && n[a].splice(e, 1), t instanceof Nt && i.delete(t.compartment));
        }
        ...
        } else if (t instanceof Bt) r(t.inner, t.prec);
        else if (t instanceof qt) (n[o].push(t), t.provides && r(t.provides, o));
        else if (t instanceof Mt) (n[o].push(t), t.facet.extensions && r(t.facet.extensions, Wt));
        else {
          let e = t.extension;
          if (!e)
            throw new Error(
      ...
      return (r(t, Wt), n.reduce((t, e) => t.concat(e)));
    })(t, e, r))
      i instanceof qt ? n.push(i) : (s[i.facet.id] || (s[i.facet.id] = [])).push(i);
    ...
    for (let t in s) {
      ...
      if (e.every((t) => 0 == t.type))
        if (((o[n.id] = (a.length << 1) | 1), Rt(r, e))) a.push(i.facet(n));
        else {
        ...
        ((o[n.id] = l.length << 1), l.push((t) => zt(t, n, e)));
      }
    }
    let c = l.map((t) => t(o));
    return new Ut(t, r, c, o, a, s);
  }
}
function Ft(t, e) {
  if (1 & e) return 2;
...
const Kt = Ct.define(),
  Jt = Ct.define({ combine: (t) => t.some((t) => t), static: !0 }),
  te = Ct.define({ combine: (t) => (t.length ? t[0] : void 0), static: !0 }),
  ee = Ct.define(),
  ie = Ct.define(),
  ne = Ct.define(),
  se = Ct.define({ combine: (t) => !!t.length && t[0] });
class re {
  constructor(t, e) {
...
class le {
  ...
  map(t) {
    ...
    return void 0 === e ? void 0 : e == this.value ? this : new le(this.type, e);
  }
  is(t) {
    return this.type == t;
  }
...
((le.reconfigure = le.define()), (le.appendConfig = le.define()));
class he {
  constructor(t, e, i, n, s, r) {
    ((this.startState = t),
      (this.changes = e),
      ...
      (this._state = null),
      i && Xt(i, e.newLength),
      s.some((t) => t.type == he.time) || (this.annotations = s.concat(he.time.of(Date.now()))));
  }
  static create(t, e, i, n, s, r) {
    return new he(t, e, i, n, s, r);
  }
  get newDoc() {
  ...
  isUserEvent(t) {
    let e = this.annotation(he.userEvent);
    return !(
      !e || !(e == t || (e.length > t.length && e.slice(0, t.length) == t && '.' == e[t.length]))
    );
  }
}
function ce(t, e) {
...
function Oe(t, e, i) {
  ...
  return (
    i
      ? ((s = e.changes), (r = St.empty(e.changes.length)), (o = t.changes.compose(e.changes)))
        ...
        (o = t.changes.compose(s))),
    {
      ...
      selection: e.selection
        ...
        : null === (n = t.selection) || void 0 === n
          ? void 0
          : n.map(s),
      effects: le.mapEffects(t.effects, s).concat(le.mapEffects(e.effects, r)),
...
function ue(t, e, i) {
  ...
  return (
    ...
    {
      changes: e.changes instanceof St ? e.changes : St.of(e.changes || [], i, t.facet(te)),
      selection: n && (n instanceof Zt ? n : Zt.single(n.anchor, n.head)),
      effects: pe(e.effects),
      annotations: s,
...
function fe(t, e, i) {
  let n = ue(t, e.length ? e[0] : {}, t.doc.length);
  e.length && !1 === e[0].filter && (i = !1);
  for (let s = 1; s < e.length; s++) {
    !1 === e[s].filter && (i = !1);
    let r = !!e[s].sequential;
    n = Oe(n, ue(t, e[s], r ? n.changes.newLength : t.doc.length), r);
  }
  let s = he.create(t, n.changes, n.selection, n.effects, n.annotations, n.scrollIntoView);
  return (function (t) {
    let e = t.startState,
      i = e.facet(ne),
      n = t;
    for (let s = i.length - 1; s >= 0; s--) {
      let r = i[s](t);
      r && Object.keys(r).length && (n = Oe(n, ue(e, r, t.changes.newLength), !0));
    }
    return n == t
      ? t
      : he.create(e, t.changes, t.selection, n.effects, n.annotations, n.scrollIntoView);
  })(
    i
      ? (function (t) {
          let e = t.startState,
            i = !0;
          for (let n of e.facet(ee)) {
            let e = n(t);
            if (!1 === e) {
              i = !1;
              break;
            }
            Array.isArray(e) && (i = !0 === i ? e : ce(i, e));
          }
          if (!0 !== i) {
            let n, s;
            if (!1 === i) ((s = t.changes.invertedDesc), (n = St.empty(e.doc.length)));
            else {
          ...
          for (let i = n.length - 1; i >= 0; i--) {
            ...
            t =
              s instanceof he
                ? s
                : Array.isArray(s) && 1 == s.length && s[0] instanceof he
                  ? s[0]
                  : fe(e, pe(s), !1);
          }
          return t;
...
((he.time = re.define()),
  (he.userEvent = re.define()),
  (he.addToHistory = re.define()),
  (he.remote = re.define()));
const de = [];
function pe(t) {
  return null == t ? de : Array.isArray(t) ? t : [t];
}
var me = (function (t) {
  return (
    (t[(t.Word = 0)] = 'Word'),
...
function we(t) {
  return (e) => {
    ...
    if (
      (function (t) {
        if (Qe) return Qe.test(t);
        for (let e = 0; e < t.length; e++) {
          let i = t[e];
          if (/\w/.test(i) || (i > '' && (i.toUpperCase() != i.toLowerCase() || ge.test(i))))
            return !0;
        }
        return !1;
      })(e)
      ...
      return me.Word;
    for (let i = 0; i < t.length; i++) if (e.indexOf(t[i]) > -1) return me.Word;
    return me.Other;
  };
}
class be {
  constructor(t, e, i, n, s, r) {
    ((this.config = t),
      ...
      (this.computeSlot = s),
      r && (r._state = this));
    for (let t = 0; t < this.config.dynamicSlots.length; t++) Ft(this, t << 1);
    this.computeSlot = null;
  }
  field(t, e = !0) {
    let i = this.config.address[t.id];
    if (null != i) return (Ft(this, i), Ht(this, i));
  ...
  applyTransaction(t) {
    ...
    for (let e of t.effects)
      e.is(It.reconfigure)
        ...
        : e.is(le.reconfigure)
          ? ((i = null), (n = e.value))
          : e.is(le.appendConfig) && ((i = null), (n = pe(n).concat(e.value)));
    if (i) e = t.startState.values.slice();
    else {
      ((i = Ut.resolve(n, s, this)),
        (e = new be(
          i,
          this.doc,
          this.selection,
    ...
    let r = t.startState.facet(Jt) ? t.newSelection : t.newSelection.asSingle();
    new be(i, t.newDoc, r, e, (e, i) => i.update(e, t), t);
  }
  replaceSelection(t) {
    return (
      ...
      this.changeByRange((e) => ({
        ...
        range: Zt.cursor(e.from + t.length),
      }))
    );
  }
  changeByRange(t) {
    ...
    for (let i = 1; i < e.ranges.length; i++) {
      ...
      (s.push(o.range.map(h)),
        (n = n.compose(l)),
        (r = le.mapEffects(r, l).concat(le.mapEffects(pe(o.effects), h))));
    }
    return { changes: n, selection: Zt.create(s, e.mainIndex), effects: r };
  }
  changes(t = []) {
    return t instanceof St ? t : St.of(t, this.doc.length, this.facet(be.lineSeparator));
  }
  toText(t) {
    return st.of(t.split(this.facet(be.lineSeparator) || Qt));
  }
  ...
  facet(t) {
    ...
    return null == e ? t.default : (Ft(this, e), Ht(this, e));
  }
  toJSON(t) {
  ...
  static fromJSON(t, e = {}, i) {
    ...
    return be.create({
      doc: t.doc,
      selection: Zt.fromJSON(t.selection),
      extensions: e.extensions ? n.concat([e.extensions]) : n,
    });
  }
  static create(t = {}) {
    let e = Ut.resolve(t.extensions || [], new Map()),
      i =
        t.doc instanceof st
          ? t.doc
          : st.of((t.doc || '').split(e.staticFacet(be.lineSeparator) || Qt)),
      n = t.selection
        ? t.selection instanceof Zt
          ? t.selection
          : Zt.single(t.selection.anchor, t.selection.head)
        : Zt.single(0);
    return (
      Xt(n, i.length),
      e.staticFacet(Jt) || (n = n.asSingle()),
      new be(
        e,
        i,
        n,
  ...
  get readOnly() {
    return this.facet(se);
  }
  phrase(t, ...e) {
    for (let e of this.facet(be.phrases))
  ...
  wordAt(t) {
    ...
    for (; r > 0; ) {
      let t = dt(e, r, !1);
      if (s(e.slice(t, r)) != me.Word) break;
      r = t;
    }
    for (; o < n; ) {
      let t = dt(e, o);
      if (s(e.slice(o, t)) != me.Word) break;
      o = t;
    }
    return r == o ? null : Zt.range(r + i, o + i);
  }
}
function Se(t, e, i = {}) {
  let n = {};
...
((be.allowMultipleSelections = Jt),
  (be.tabSize = Ct.define({ combine: (t) => (t.length ? t[0] : 4) })),
  (be.lineSeparator = te),
  (be.readOnly = se),
  (be.phrases = Ct.define({
    compare(t, e) {
      let i = Object.keys(t),
        n = Object.keys(e);
  ...
  (be.languageData = Kt),
  (be.changeFilter = ee),
  (be.transactionFilter = ie),
  (be.transactionExtender = ne),
  (It.reconfigure = le.define()));
class ve {
  eq(t) {
    return this == t;
  }
  range(t, e = t) {
    return ye.create(t, e, this);
  }
}
((ve.prototype.startSide = ve.prototype.endSide = 0),
  (ve.prototype.point = !1),
  (ve.prototype.mapMode = wt.TrackDel));
class ye {
  constructor(t, e, i) {
  ...
  map(t, e) {
    ...
    for (let a = 0; a < this.value.length; a++) {
      ...
      if (O == u) {
        ...
        if (null == t) continue;
        if (((l = h = t), c.startSide != c.endSide && ((h = e.mapPos(O, c.endSide)), h < l)))
          continue;
      } else if (
    ...
    return { mapped: i.length ? new ke(n, s, i, o) : null, pos: r };
  }
}
class $e {
  constructor(t, e, i, n) {
  ...
  update(t) {
    ...
    if ((i && (e = e.slice().sort(xe)), this.isEmpty)) return e.length ? $e.of(e) : this;
    let o = new Ze(this, null, -1).goto(0),
      a = 0,
      l = [],
      h = new Pe();
      ...
      if (a < e.length && (o.from - e[a].from || o.startSide - e[a].value.startSide) >= 0) {
        ...
        h.addChunk(this.chunkPos[o.chunkIndex], this.chunk[o.chunkIndex])
          ...
          : ((!r || n > o.to || s < o.from || r(o.from, o.to, o.value)) &&
              (h.addInner(o.from, o.to, o.value) || l.push(ye.create(o.from, o.to, o.value))),
            o.next());
  ...
  map(t) {
    ...
    return 0 == e.length ? s : new $e(i, e, s || $e.empty, n);
  }
  between(t, e, i) {
    if (!this.isEmpty) {
  ...
  static compare(t, e, i, n, s = -1) {
    let r = t.filter((t) => t.maxPoint > 0 || (!t.isEmpty && t.maxPoint >= s)),
      ...
      l = new Ce(r, a, s),
      h = new Ce(o, a, s);
    (i.iterGaps((t, e, i) => Re(l, t, h, e, i, n)),
      i.empty && 0 == i.length && Re(l, 0, h, 0, 0, n));
  }
  static eq(t, e, i = 0, n) {
    null == n && (n = 999999999);
    ...
    let o = Te(s, r),
      a = new Ce(s, o, 0).goto(i),
      l = new Ce(r, o, 0).goto(i);
    for (;;) {
      if (
        a.to != l.to ||
        !Me(a.active, l.active) ||
          ...
          s =
            r.pointFrom < e
              ...
              : r.point.startSide < 0
                ? i.length
                : Math.min(i.length, a);
        (n.point(o, t, r.point, i, s, r.pointRank), (a = Math.min(r.openEnd(t), i.length)));
      } else t > o && (n.span(o, t, r.active, a), (a = r.openEnd(t)));
        ...
        ? (function (t) {
            if (t.length > 1)
              for (let e = t[0], i = 1; i < t.length; i++) {
                let n = t[i];
                if (xe(e, n) > 0) return t.slice().sort(xe);
                e = n;
              }
            return t;
          })(t)
...
(($e.empty = new $e([], [], null, -1)), ($e.empty.nextLayer = $e.empty));
class Pe {
  finishChunk(t) {
    (this.chunks.push(new ke(this.from, this.to, this.value, this.maxPoint)),
...
class Xe {
  ...
  static from(t, e = null, i = -1) {
    ...
    for (let s = 0; s < t.length; s++)
      for (let r = t[s]; !r.isEmpty; r = r.nextLayer) r.maxPoint >= i && n.push(new Ze(r, e, i, s));
  ...
  goto(t, e = -1e9) {
    ...
    for (let t = this.heap.length >> 1; t >= 0; t--) Ae(this.heap, t);
...
function Ae(t, e) {
  for (let i = t[e]; ; ) {
    ...
    if (n >= t.length) break;
    let s = t[n];
    if ((n + 1 < t.length && s.compare(t[n + 1]) >= 0 && ((s = t[n + 1]), n++), i.compare(s) < 0))
      break;
    ((t[n] = i), (t[e] = s), (e = n));
  }
}
class Ce {
  ...
  removeActive(t) {
    (_e(this.active, t),
      _e(this.activeTo, t),
      _e(this.activeRank, t),
      (this.minActive = ze(this.active, this.activeTo)));
  }
  addActive(t) {
    let e = 0,
    ...
    for (; e < this.activeRank.length && (s - this.activeRank[e] || n - this.activeTo[e]) > 0; )
      e++;
    (Ye(this.active, e, i),
      Ye(this.activeTo, e, n),
      Ye(this.activeRank, e, s),
  ...
  next() {
    ...
    for (;;) {
      ...
      if (
        n > -1 &&
        (this.activeTo[n] - this.cursor.from || this.active[n].endSide - this.cursor.startSide) < 0
      ) {
        if (this.activeTo[n] > t) {
          ((this.to = this.activeTo[n]), (this.endSide = this.active[n].endSide));
          break;
        }
        (this.removeActive(n), i && _e(i, n));
      } else {
  ...
  activeForPoint(t) {
    ...
    for (let i = this.active.length - 1; i >= 0 && !(this.activeRank[i] < this.pointRank); i--)
      (this.activeTo[i] > t ||
        (this.activeTo[i] == t && this.active[i].endSide >= this.point.endSide)) &&
    ...
    if (
      (t.point || i.point
        ? (t.point &&
            ...
            Me(t.activeForPoint(t.to), i.activeForPoint(i.to))) ||
          r.comparePoint(a, h, t.point, i.point)
        : h > a && !Me(t.active, i.active) && r.compareRange(a, h, t.active, i.active),
      s > o)
    )
      break;
...
function Ve(t, e, i = t.length) {
  let n = 0;
  for (let s = 0; s < i && s < t.length; )
    9 == t.charCodeAt(s) ? ((n += e - (n % e)), s++) : (n++, (s = dt(t, s)));
  return n;
}
const qe = 'undefined' == typeof Symbol ? '__ͼ' : Symbol.for('ͼ'),
  Ee =
    'undefined' == typeof Symbol
      ? '__styleSet' + Math.floor(1e8 * Math.random())
      : Symbol('styleSet'),
  De = 'undefined' != typeof globalThis ? globalThis : 'undefined' != typeof window ? window : {};
class We {
  constructor(t, e) {
    this.rules = [];
    let { finish: i } = e || {};
    ...
    function s(t, e, r, o) {
      ...
      for (let i in e) {
        ...
        if (/&/.test(i))
          ...
          null != o &&
            a.push(
              i.replace(/_.*/, '').replace(/[A-Z]/g, (t) => '-' + t.toLowerCase()) + ': ' + o + ';',
            );
      }
      (a.length || h) &&
        r.push((!i || l || o ? t : t.map(i)).join(', ') + ' {' + a.join(' ') + '}');
    }
  ...
  static newName() {
    let t = De[qe] || 1;
    return ((De[qe] = t + 1), 'ͼ' + t.toString(36));
  }
  static mount(t, e, i) {
    let n = t[Ee],
      s = i && i.nonce;
    (n ? s && n.setNonce(s) : (n = new Le(t, s)), n.mount(Array.isArray(e) ? e : [e]));
  }
}
let je = new Map();
class Le {
  constructor(t, e) {
    ...
    if (!t.head && t.adoptedStyleSheets && n.CSSStyleSheet) {
      let e = je.get(i);
      if (e) return ((t.adoptedStyleSheets = [e.sheet, ...t.adoptedStyleSheets]), (t[Ee] = e));
...
for (
  var Ge = {
    ...
    Ie = 'undefined' != typeof navigator && /Mac/.test(navigator.platform),
    Ne =
  ...
  Ge[48 + Ue] = Ge[96 + Ue] = String(Ue);
for (Ue = 1; Ue <= 24; Ue++) Ge[Ue + 111] = 'F' + Ue;
for (Ue = 65; Ue <= 90; Ue++)
  ((Ge[Ue] = String.fromCharCode(Ue + 32)), (Be[Ue] = String.fromCharCode(Ue)));
for (var Fe in Ge) Be.hasOwnProperty(Fe) || (Be[Fe] = Ge[Fe]);
function He(t) {
  let e;
...
function ti(t) {
  return 3 == t.nodeType
    ? ui(t, 0, t.nodeValue.length).getClientRects()
    : 1 == t.nodeType
      ? t.getClientRects()
      : [];
}
function ei(t, e, i, n) {
  return !!i && (ni(t, e, i, n, -1) || ni(t, e, i, n, 1));
}
function ii(t) {
...
function ni(t, e, i, n, s) {
  for (;;) {
    ...
    if (e == (s < 0 ? 0 : si(t))) {
      ...
      if (1 == (t = t.childNodes[e + (s < 0 ? -1 : 0)]).nodeType && 'false' == t.contentEditable)
        return !1;
      e = s < 0 ? si(t) : 0;
    }
  }
...
function ai(t, e) {
  ...
  return (
    ...
    ((n > 0.995 && n < 1.005) || !isFinite(n) || Math.abs(e.height - t.offsetHeight) < 1) &&
      (n = 1),
    { scaleX: i, scaleY: n }
  );
}
class li {
  ...
  setRange(t) {
    ...
    this.set(e, Math.min(t.anchorOffset, e ? si(e) : 0), i, Math.min(t.focusOffset, i ? si(i) : 0));
  }
  set(t, e, i, n) {
...
function ui(t, e, i = e) {
  let n = hi || (hi = document.createRange());
...
class mi {
  ...
  static before(t, e) {
    return new mi(t.parentNode, ii(t), e);
  }
  static after(t, e) {
    return new mi(t.parentNode, ii(t) + 1, e);
  }
}
const gi = [];
class Qi {
    ...
    if (2 & this.flags) {
      ...
      for (let r of this.children) {
        ...
        if (
          ...
          e && !e.written && e.node == n && i != r.dom && (e.written = !0),
          r.dom.parentNode == n)
        )
          for (; i && i != r.dom; ) i = wi(i);
        else n.insertBefore(r.dom, i);
        s = r.dom;
      }
      for (i = s ? s.nextSibling : n.firstChild, i && e && e.node == n && (e.written = !0); i; )
        i = wi(i);
  ...
  localPosFromDOM(t, e) {
    ...
    for (; i && !Qi.get(i); ) i = i.nextSibling;
  ...
  childCursor(t = this.length) {
    return new bi(this.children, t, this.children.length);
  }
  childPos(t, e = 1) {
...
class bi {
  ...
  findPos(t, e = 1) {
    for (;;) {
      if (
        t > this.pos ||
        (t == this.pos && (e > 0 || 0 == this.i || this.children[this.i - 1].breakAfter))
      )
...
function Si(t, e, i, n, s, r, o, a, l) {
  let { children: h } = t,
    c = h.length ? h[e] : null,
    O = r.length ? r[r.length - 1] : null,
    u = O ? O.breakAfter : o;
  if (
    !(e == n && c && !o && !u && r.length < 2 && c.merge(i, s, r.length ? O : null, 0 == i, a, l))
  ) {
    if (n < h.length) {
      let t = h[n];
      (t && (s < t.length || (t.breakAfter && (null == O ? void 0 : O.breakAfter)))
        ? (e == n && ((t = t.split(s)), (s = 0)),
          !u && O && t.merge(0, s, O, !0, 0, l)
            ? (r[r.length - 1] = t)
            : ((s || (t.children.length && !t.children[0].length)) && t.merge(0, s, null, !1, 0, l),
              r.push(t)))
        : (null == t ? void 0 : t.breakAfter) && (O ? (O.breakAfter = 1) : (o = 1)),
        n++);
    }
    for (
      c &&
      ...
      i > 0 &&
        (!o && r.length && c.merge(i, c.length, r[0], !1, a, 0)
          ...
          : (i < c.length ||
              (c.children.length && 0 == c.children[c.children.length - 1].length)) &&
...
function vi(t, e, i, n, s, r) {
  ...
  ((t.length += O), Si(t, h, c, a, l, n, 0, s, r));
}
let yi = 'undefined' != typeof navigator ? navigator : { userAgent: '', vendor: '', platform: '' },
  xi = 'undefined' != typeof document ? document : { documentElement: { style: {} } };
const ki = /Edge\/(\d+)/.exec(yi.userAgent),
  $i = /MSIE \d/.test(yi.userAgent),
  Pi = /Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(yi.userAgent),
  Ti = !!($i || Pi || ki),
  Zi = !Ti && /gecko\/(\d+)/i.test(yi.userAgent),
  Xi = !Ti && /Chrome\/(\d+)/.exec(yi.userAgent),
  Ai = 'webkitFontSmoothing' in xi.documentElement.style,
  Ci = !Ti && /Apple Computer/.test(yi.vendor),
  Ri = Ci && (/Mobile\/\w+/.test(yi.userAgent) || yi.maxTouchPoints > 2);
var Mi = {
  mac: Ri || /Mac/.test(yi.platform),
  windows: /Win/.test(yi.platform),
  linux: /Linux|X11/.test(yi.platform),
  ie: Ti,
  ie_version: $i ? xi.documentMode || 6 : Pi ? +Pi[1] : ki ? +ki[1] : 0,
  gecko: Zi,
  gecko_version: Zi ? +(/Firefox\/(\d+)/.exec(yi.userAgent) || [0, 0])[1] : 0,
  chrome: !!Xi,
  chrome_version: Xi ? +Xi[1] : 0,
  ios: Ri,
  android: /Android\b/.test(yi.userAgent),
  safari: Ci,
  webkit_version: Ai ? +(/\bAppleWebKit\/(\d+)/.exec(navigator.userAgent) || [0, 0])[1] : 0,
  tabSize: null != xi.documentElement.style.tabSize ? 'tab-size' : '-moz-tab-size',
};
class _i extends Qi {
  constructor(t) {
    (super(), (this.text = t));
  ...
  merge(t, e, i) {
    return (
      !(
        8 & this.flags ||
        (i && (!(i instanceof _i) || this.length - (e - t) + i.length > 256 || 8 & i.flags))
      ) &&
  ...
  split(t) {
    let e = new _i(this.text.slice(t));
  ...
  coordsAt(t, e) {
    return (function (t, e, i) {
      ...
      let s = e,
        ...
        o = 0;
      (0 == e && i < 0) || (e == n && i >= 0)
        ? Mi.chrome || Mi.gecko || (e ? (s--, (o = 1)) : r < n && (r++, (o = -1)))
        : i < 0
          ? s--
          : r < n && r++;
      let a = ui(t, s, r).getClientRects();
      if (!a.length) return null;
      let l = a[(o ? o < 0 : i >= 0) ? 0 : a.length - 1];
      Mi.safari && !o && 0 == l.width && (l = Array.prototype.find.call(a, (t) => t.width) || l);
      return o ? ri(l, o < 0) : l || null;
    })(this.dom, t, e);
  }
}
class Yi extends Qi {
  ...
  setAttrs(t) {
    if ((di(t), this.mark.class && (t.className = this.mark.class), this.mark.attrs))
  ...
  merge(t, e, i, n, s, r) {
    return (
      (!i ||
        !(
          !(i instanceof Yi && i.mark.eq(this.mark)) ||
          (t && s <= 0) ||
          (e < this.length && r <= 0)
        )) &&
      (vi(this, t, e, i ? i.children.slice() : [], s - 1, r - 1), this.markDirty(), !0)
    );
  }
  split(t) {
    let e = [],
...
class zi extends Qi {
  ...
  split(t) {
    let e = zi.create(this.widget, this.length - t, this.side);
  ...
  merge(t, e, i, n, s, r) {
    return (
      !(
        i &&
        (!(i instanceof zi && this.widget.compare(i.widget)) ||
          (t > 0 && s <= 0) ||
          (e < this.length && r <= 0))
  ...
  get overrideDOMText() {
    if (0 == this.length) return st.empty;
    let t = this;
    for (; t.parent; ) t = t.parent;
    let { view: e } = t,
      i = e && e.state.doc,
      n = this.posAtStart;
    return i ? i.slice(n, n + this.length) : st.empty;
  }
  domAtPos(t) {
    return (this.length ? 0 == t : this.side > 0)
      ? mi.before(this.dom)
      : mi.after(this.dom, t == this.length);
  }
  domBoundsAround() {
    return null;
  }
  coordsAt(t, e) {
    ...
    for (
      ...
      (s = n[e]), !(t > 0 ? 0 == e : e == n.length - 1 || s.top < s.bottom);
      e += r ? -1 : 1
    );
    return ri(s, !r);
  }
...
class Vi extends Qi {
  ...
  become(t) {
    return t instanceof Vi && t.side == this.side;
  }
  split() {
...
function qi(t, e) {
  ...
  for (let t = 0; s < n.length; s++) {
    let r = n[s],
      o = t + r.length;
    if (!(o == t && r.getSide() <= 0)) {
      if (e > t && e < o && r.dom.parentNode == i) return r.domAtPos(e - t);
      if (e <= t) break;
      t = o;
    }
  }
...
function Ei(t, e, i) {
  let n,
    { children: s } = t;
  (i > 0 && e instanceof Yi && s.length && (n = s[s.length - 1]) instanceof Yi && n.mark.eq(e.mark)
    ? Ei(n, e.children[0], i - 1)
  ...
  !(function t(e, a) {
    for (let l = 0, h = 0; l < e.children.length && h <= a; l++) {
      ...
      (O >= a &&
        (c.children.length
          ? t(c, a - h)
          : (!r || (r.isHidden && i > 0)) && (O > a || (h == O && c.getSide() > 0))
            ? ((r = c), (o = a - h))
            : (h < a || (h == O && c.getSide() < 0 && !c.isHidden)) && ((n = c), (s = a - h))),
        (h = O));
    }
  })(t, e);
  let a = (i < 0 ? n : r) || n || r;
  return a
    ? a.coordsAt(Math.max(0, a == n ? s : o), i)
    : (function (t) {
...
_i.prototype.children = zi.prototype.children = Vi.prototype.children = gi;
...
function Li(t, e, i) {
  ...
  let n = Object.keys(t),
    s = Object.keys(e);
  if (n.length - (i && n.indexOf(i) > -1 ? 1 : 0) != s.length - (i && s.indexOf(i) > -1 ? 1 : 0))
    return !1;
...
function Gi(t, e, i) {
  ...
  if (e)
    for (let s in e)
      (i && s in i) || ((n = !0), 'style' == s ? (t.style.cssText = '') : t.removeAttribute(s));
  if (i)
    for (let s in i)
      (e && e[s] == i[s]) ||
        ((n = !0), 'style' == s ? (t.style.cssText = i[s]) : t.setAttribute(s, i[s]));
  return n;
}
function Bi(t) {
  let e = Object.create(null);
...
class Ii extends Qi {
  ...
  merge(t, e, i, n, s, r) {
    if (i) {
      if (!(i instanceof Ii)) return !1;
      this.dom || i.transferDOM(this);
    }
    return (
      n && this.setDeco(i ? i.attrs : null),
      vi(this, t, e, i ? i.children.slice() : [], s, r),
      !0
    );
  }
  split(t) {
  ...
  setDeco(t) {
    Li(this.attrs, t) ||
      (this.dom && ((this.prevAttrs = this.attrs), this.markDirty()), (this.attrs = t));
  }
  append(t, e) {
    Ei(this, t, e);
  }
  addLineDeco(t) {
    let e = t.spec.attributes,
      i = t.spec.class;
    (e && (this.attrs = Wi(e, this.attrs || {})),
      i && (this.attrs = Wi({ class: i }, this.attrs || {})));
  }
  domAtPos(t) {
    return qi(this, t);
  }
  ...
  sync(t, e) {
    ...
    (this.dom
      ...
      void 0 !== this.prevAttrs &&
        (Gi(this.dom, this.prevAttrs, this.attrs),
        this.dom.classList.add('cm-line'),
        (this.prevAttrs = void 0)),
      super.sync(t, e));
    let n = this.dom.lastChild;
    for (; n && Qi.get(n) instanceof Yi; ) n = n.lastChild;
    if (
      !(
        n &&
        this.length &&
        ('BR' == n.nodeName ||
          0 != (null === (i = Qi.get(n)) || void 0 === i ? void 0 : i.isEditable) ||
          (Mi.ios && this.children.some((t) => t instanceof _i)))
      )
    ) {
  ...
  measureTextSize() {
    ...
    let t,
      e = 0;
    for (let i of this.children) {
      if (!(i instanceof _i) || /[^ -~]/.test(i.text)) return null;
      let n = ti(i.dom);
...
class Ni extends Qi {
  ...
  merge(t, e, i, n, s, r) {
    return (
      !(
        i &&
        (!(i instanceof Ni && this.widget.compare(i.widget)) ||
          (t > 0 && s <= 0) ||
          (e < this.length && r <= 0))
      ) && ((this.length = t + (i ? i.length : 0) + (this.length - e)), !0)
    );
  ...
  domAtPos(t) {
    return 0 == t ? mi.before(this.dom) : mi.after(this.dom, t == this.length);
  }
  split(t) {
    let e = this.length - t;
    this.length = t;
    let i = new Ni(this.widget, e, this.deco);
...
class Hi extends ve {
  ...
  static widget(t) {
    ...
    return (
      ...
      new tn(t, e, e, i, t.widget || null, !1)
    );
  }
  static replace(t) {
    let e,
    ...
    if (t.isBlockGap) ((e = -5e8), (i = 4e8));
      ...
      let { start: s, end: r } = en(t, n);
      ((e = (s ? (n ? -3e8 : -1) : 5e8) - 1), (i = 1 + (r ? (n ? 2e8 : 1) : -6e8)));
    }
    return new tn(t, e, i, n, t.widget || null, !0);
  }
  static line(t) {
    return new Ji(t);
  }
...
class Ji extends Hi {
  ...
  eq(t) {
    return (
      ...
      Li(this.spec.attributes, t.spec.attributes)
    );
  }
  range(t, e = t) {
...
((Ji.prototype.mapMode = wt.TrackBefore), (Ji.prototype.point = !0));
class tn extends Hi {
  constructor(t, e, i, n, s, r) {
    (super(e, i, s, t),
      (this.block = n),
      (this.isReplace = r),
      (this.mapMode = n ? (e <= 0 ? wt.TrackBefore : wt.TrackAfter) : wt.TrackDel));
  }
  get type() {
...
class sn {
  ...
  posCovered() {
    ...
    return !(t.breakAfter || (t instanceof Ni && t.deco.endSide < 0));
  }
  getLine() {
    return (
      this.curLine || (this.content.push((this.curLine = new Ii())), (this.atCursorPos = !0)),
      this.curLine
    );
  }
  flushBuffer(t = this.bufferMarks) {
    this.pendingBuffer &&
      (this.curLine.append(rn(new Vi(-1), t), t.length), (this.pendingBuffer = 0));
  }
  addBlockWidget(t) {
  ...
  finish(t) {
    (this.pendingBuffer && t <= this.bufferMarks.length
      ...
      : (this.pendingBuffer = 0),
      this.posCovered() ||
        (t && this.content.length && this.content[this.content.length - 1] instanceof Ni) ||
        this.getLine());
  }
  buildText(t, e, i) {
    for (; t > 0; ) {
      ...
      (this.flushBuffer(e.slice(e.length - i)),
        this.getLine().append(rn(new _i(this.text.slice(this.textOff, this.textOff + n)), e), i),
        (this.atCursorPos = !0),
        (this.textOff += n),
        (t -= n),
        (i = 0));
  ...
  point(t, e, i, n, s, r) {
    if (this.disallowBlockEffectsFor[r] && i instanceof tn) {
    ...
    if (i instanceof tn)
      if (i.block)
        (i.startSide > 0 && !this.posCovered() && this.getLine(),
          this.addBlockWidget(new Ni(i.widget || new on('div'), o, i)));
      else {
        let r = zi.create(i.widget || new on('span'), o, o ? 0 : i.startSide),
          a = this.atCursorPos && !r.isEditable && s <= n.length && (t < e || i.startSide > 0),
          l = !r.isEditable && (t < e || s > n.length || i.startSide <= 0),
          h = this.getLine();
        (2 != this.pendingBuffer || a || r.isEditable || (this.pendingBuffer = 0),
          this.flushBuffer(n),
          a && (h.append(rn(new Vi(1), n), s), (s = n.length + Math.max(0, s - n.length))),
          h.append(rn(r, n), s),
          (this.atCursorPos = l),
          (this.pendingBuffer = l ? (t < e || s > n.length ? 1 : 2) : 0),
  ...
  static build(t, e, i, n, s) {
    let r = new sn(t, e, i, s);
    return (
      (r.openEnd = $e.spans(n, e, i, r)),
...
function Qn(t, e) {
  ...
  for (let i = 0; i < t.length; i++) {
    let n = t[i],
      s = e[i];
    if (n.from != s.from || n.to != s.to || n.direction != s.direction || !Qn(n.inner, s.inner))
      return !1;
  }
  return !0;
}
const wn = [];
function bn(t, e, i, n, s, r, o) {
  let a = n % 2 ? 2 : 1;
  if (n % 2 == s % 2)
    for (let l = e, h = 0; l < i; ) {
      let e = !0,
      ...
      t: for (;;)
        if (h < r.length && f == r[h].from) {
          ...
          if ((h++, O)) O.push(d);
            ...
            (d.from > l && o.push(new gn(l, d.from, u)),
              Sn(t, (d.direction == ln) != !(u % 2) ? n + 1 : n, s, d.inner, d.from, d.to, o),
              (l = d.to));
          }
          f = d.to;
        } else {
          if (f == i || (e ? wn[f] != a : wn[f] == a)) break;
          f++;
        }
      (O ? bn(t, l, f, n + 1, s, O, o) : l < f && o.push(new gn(l, f, u)), (l = f));
    }
  else
    for (let l = i, h = r.length; l > e; ) {
      let i = !0,
        c = !1;
      if (!h || l > r[h - 1].to) {
        let t = wn[l - 1];
      ...
      t: for (;;)
        if (h && f == r[h - 1].to) {
          ...
          if (O) O.push(d);
            ...
            (d.to < l && o.push(new gn(d.to, l, u)),
              Sn(t, (d.direction == ln) != !(u % 2) ? n + 1 : n, s, d.inner, d.from, d.to, o),
              (l = d.from));
          }
          f = d.from;
        } else {
          if (f == e || (i ? wn[f - 1] != a : wn[f - 1] == a)) break;
          f--;
        }
      (O ? bn(t, f, l, n + 1, s, O, o) : f < l && o.push(new gn(f, l, u)), (l = f));
    }
}
function Sn(t, e, i, n, s, r, o) {
  let a = e % 2 ? 2 : 1;
  (!(function (t, e, i, n, s) {
    for (let r = 0; r <= n.length; r++) {
      let o = r ? n[r - 1].to : e,
        a = r < n.length ? n[r].from : i,
        l = r ? 256 : s;
      for (let e = o, i = l, n = l; e < a; e++) {
        let s = pn(t.charCodeAt(e));
      ...
      for (let t = o, e = l, n = l; t < a; t++) {
        let s = wn[t];
        if (128 == s) t < a - 1 && e == wn[t + 1] && 24 & e ? (s = wn[t] = e) : (wn[t] = 256);
        else if (64 == s) {
          let s = t + 1;
          for (; s < a && 64 == wn[s]; ) s++;
          let r = (t && 8 == e) || (s < i && 8 == wn[s]) ? (1 == n ? 1 : 8) : 256;
          for (let e = t; e < s; e++) wn[e] = r;
          t = s - 1;
        } else 8 == s && 1 == n && (wn[t] = 1);
        ((e = s), 7 & s && (n = s));
      }
    ...
    (function (t, e, i, n, s) {
      ...
      for (let o = 0, a = 0, l = 0; o <= n.length; o++) {
        ...
        for (let e, i, n, o = h; o < c; o++)
          if ((i = fn[(e = t.charCodeAt(o))]))
            if (i < 0) {
              for (let t = a - 3; t >= 0; t -= 3)
                if (dn[t + 1] == -i) {
                  let e = dn[t + 2],
                    i = 2 & e ? s : 4 & e ? (1 & e ? r : s) : 0;
                  (i && (wn[o] = wn[dn[t]] = i), (a = t));
                  break;
                }
            } else {
              if (189 == dn.length) break;
              ((dn[a++] = o), (dn[a++] = e), (dn[a++] = l));
            }
          else if (2 == (n = wn[o]) || 1 == n) {
            let t = n == s;
            l = t ? 0 : 1;
        ...
        for (let l = o; l < a; ) {
          ...
          if (256 == o) {
            ...
            for (;;)
              if (o == a) {
                if (s == i.length) break;
                ((o = i[s++].to), (a = s < i.length ? i[s].from : e));
              } else {
                if (256 != wn[o]) break;
                o++;
              }
            let h = 1 == r,
              c = h == (1 == (o < e ? wn[o] : n)) ? (h ? 1 : 2) : n;
            for (let e = o, n = s, r = n ? i[n - 1].to : t; e > l; )
              (e == r && ((e = i[--n].from), (r = n ? i[n - 1].to : t)), (wn[--e] = c));
            l = o;
          } else ((r = o), l++);
        }
      }
...
function xn(t, e, i, n, s) {
  var r;
  let o = n.head - t.from,
    a = gn.find(e, o, null !== (r = n.bidiLevel) && void 0 !== r ? r : -1, n.assoc),
    l = e[a],
    h = l.side(s, i);
  if (o == h) {
    let t = (a += s ? 1 : -1);
    if (t < 0 || t >= e.length) return null;
    ((l = e[(a = t)]), (o = l.side(!s, i)), (h = l.side(s, i)));
  }
  let c = dt(t.text, o, l.forward(s, i));
  ((c < l.from || c > l.to) && (c = h), (yn = t.text.slice(Math.min(o, c), Math.max(o, c))));
  let O = a == (s ? e.length - 1 : 0) ? null : e[a + (s ? 1 : -1)];
  return O && c == h && O.level + (s ? 0 : 1) < l.level
    ? Zt.cursor(O.side(!s, i) + t.from, O.forward(s, i) ? 1 : -1, O.level)
    : Zt.cursor(c + t.from, l.forward(s, i) ? -1 : 1, l.level);
}
function kn(t, e, i) {
  for (let n = e; n < i; n++) {
    let e = pn(t.charCodeAt(n));
    if (1 == e) return ln;
    if (2 == e || 4 == e) return hn;
  }
  return ln;
}
const $n = Ct.define(),
  ...
  An = Ct.define(),
  Cn = Ct.define(),
  Rn = Ct.define({ combine: (t) => t.some((t) => t) }),
  Mn = Ct.define({ combine: (t) => t.some((t) => t) });
class _n {
  ...
  map(t) {
    return t.empty
      ? this
      : new _n(this.range.map(t), this.y, this.x, this.yMargin, this.xMargin, this.isSnapshot);
  }
  clip(t) {
    return this.range.to <= t.doc.length
      ? this
      : new _n(
          Zt.cursor(t.doc.length),
          this.y,
          this.x,
          this.yMargin,
          this.xMargin,
...
const Yn = le.define({ map: (t, e) => t.map(e) });
function zn(t, e, i) {
  let n = t.facet(Zn);
  n.length
    ? n[0](e)
    : globalThis.onerror
      ? globalThis.onerror(String(e), i, void 0, void 0, e)
      : i
        ? console.error(i + ':', e)
        : console.error(e);
}
const Vn = Ct.define({ combine: (t) => !t.length || t[0] });
let qn = 0;
const En = Ct.define();
class Dn {
  constructor(t, e, i, n, s) {
  ...
  static define(t, e) {
    const { eventHandlers: i, eventObservers: n, provide: s, decorations: r } = e || {};
    return new Dn(qn++, t, i, n, (t) => {
      let e = [En.of(t)];
      return (
        r &&
          e.push(
  ...
  update(t) {
    if (this.value) {
      if (this.mustUpdate) {
        ...
        if (((this.mustUpdate = null), this.value.update))
          try {
            ...
            if ((zn(t.state, e, 'CodeMirror plugin crashed'), this.value.destroy))
              try {
                this.value.destroy();
              } catch (t) {}
            this.deactivate();
      ...
      try {
        ...
        (zn(t.state, e, 'CodeMirror plugin crashed'), this.deactivate());
      }
    return this;
  }
  destroy(t) {
    ...
    if (null === (e = this.value) || void 0 === e ? void 0 : e.destroy)
      try {
        ...
        zn(t.state, e, 'CodeMirror plugin crashed');
      }
  }
  deactivate() {
    ...
    $e.spans(n, e.from, e.to, {
      ...
      span(t, i, n, r) {
        ...
        for (let t = n.length - 1; t >= 0; t--, r--) {
          let i,
            s = n[t].spec.bidiIsolate;
          if (
            (null == s && (s = kn(e.text, o, a)),
            r > 0 && l.length && (i = l[l.length - 1]).to == o && i.direction == s)
          )
            ((i.to = a), (l = i.inner));
          else {
            let t = { from: o, to: a, direction: s, inner: [] };
            (l.push(t), (l = t.inner));
          }
        }
      },
    ...
    for (let n = 0, s = 0, r = 0, o = 0; ; n++) {
      ...
      for (; s < e.length && e[s] < h; ) {
        let t = e[s],
          ...
          r = Math.max(o, t),
          a = Math.min(h, n);
        if ((r <= a && new Jn(r + l, a + l, r, a).addToSet(i), n > h)) break;
        s += 2;
      }
      if (!a) return i;
      (new Jn(a.fromA, a.toA, a.fromB, a.toB).addToSet(i), (r = a.toA), (o = a.toB));
    }
  }
}
class ts {
  constructor(t, e, i) {
    ((this.view = t),
      ...
      (this.changes = St.empty(this.startState.doc.length)));
    for (let t of i) this.changes = this.changes.compose(t.changes);
    let n = [];
    (this.changes.iterChangedRanges((t, e, i, s) => n.push(new Jn(t, e, i, s))),
...
class es extends Qi {
  ...
  constructor(t) {
    (super(),
      ...
      this.updateDeco(),
      this.updateInner([new Jn(0, 0, 0, t.state.doc.length)], 0, null));
  }
  update(t) {
    var e;
      ...
      n > -1
        ? (function (t, e, i) {
            ...
            let l = e.invertedDesc,
              h = new Jn(l.mapPos(r), l.mapPos(o), r, o),
              c = [];
            for (let e = s.parentNode; ; e = e.parentNode) {
              let i = Qi.get(e);
              if (i instanceof Yi) c.push({ node: e, deco: i.mark });
              else {
                if (i instanceof Ii || ('DIV' == e.nodeName && e.parentNode == t.contentDOM))
                  return { range: h, text: s, marks: c, line: e };
    ...
    if (((this.domChanged = null), this.hasComposition)) {
      ...
      i = new Jn(e, n, t.changes.mapPos(e, -1), t.changes.mapPos(n, 1)).addToSet(i.slice());
    }
    ...
    let r = (function (t, e, i) {
      let n = new rs();
      return ($e.compare(t, e, i, n), n.changes);
    })(this.decorations, this.updateDeco(), t.changes);
    return (
      (i = Jn.extendWithRanges(i, r)),
      !!(7 & this.flags || 0 != i.length) &&
        (this.updateInner(i, t.startState.doc.length, s),
  ...
  updateInner(t, e, i) {
    ...
    (n.ignore(() => {
      ...
      let t = Mi.chrome || Mi.ios ? { node: n.selectionRange.focusNode, written: !1 } : void 0;
    ...
    if (this.view.viewport.from || this.view.viewport.to < this.view.state.doc.length)
      for (let t of this.children) t instanceof Ni && t.widget instanceof is && s.push(t.dom);
    n.updateGaps(s);
  }
  updateChildren(t, e, i) {
    ...
    for (let t = n.length - 1; ; t--) {
      ...
      let r,
        ...
        a,
        l,
        { fromA: h, toA: c, fromB: O, toB: u } = e;
      if (i && i.range.fromB < u && i.range.toB > O) {
        let t = sn.build(
            this.view.state.doc,
            O,
            i.range.fromB,
        ...
        (e.breakAtStart
          ? (n.breakAfter = 1)
          : e.content.length &&
            n.merge(n.length, n.length, e.content[0], !1, e.openStart, 0) &&
            ((n.breakAfter = e.content[0].breakAfter), e.content.shift()),
          t.content.length &&
            n.merge(0, 0, t.content[t.content.length - 1], !0, 0, t.openEnd) &&
            t.content.pop(),
          (r = t.content.concat(n).concat(e.content)));
      } else
        ({
          content: r,
          breakAtStart: o,
          openStart: a,
          openEnd: l,
        } = sn.build(this.view.state.doc, O, u, this.decorations, this.dynamicDecorationMap));
      let { i: f, off: d } = s.findPos(c, 1),
        { i: p, off: m } = s.findPos(h, -1);
      Si(this, p, m, f, d, r, o, a, l);
    }
    i && this.fixCompositionDOM(i);
  }
  compositionView(t) {
    let e = new _i(t.text.nodeValue);
    e.flags |= 8;
  ...
  updateSelection(t = !1, e = !1) {
    ...
    let i = this.view.root.activeElement,
      n = i == this.dom,
      s = !n && Je(this.dom, this.view.observer.selectionRange) && !(i && this.dom.contains(i));
    if (!(n || e || s)) return;
    ...
    if (
      ...
      1 == (h = a).node.nodeType &&
      h.node.firstChild &&
      (0 == h.offset || 'false' == h.node.childNodes[h.offset - 1].contentEditable) &&
    ...
    ((!r &&
      c.focusNode &&
      ((ei(a.node, a.offset, c.anchorNode, c.anchorOffset) &&
        ei(l.node, l.offset, c.focusNode, c.focusOffset)) ||
          ...
          if (o.empty) {
            if (Mi.gecko) {
              let t =
                ...
                1 != e.nodeType
                  ? 0
                  : (n && 'false' == e.childNodes[n - 1].contentEditable ? 1 : 0) |
                    (n < e.childNodes.length && 'false' == e.childNodes[n].contentEditable
                      ? 2
                      : 0));
              if (t && 3 != t) {
                let e = ss(a.node, a.offset, 1 == t ? 1 : -1);
                e && (a = new mi(e.node, e.offset));
              }
            }
      ...
      (this.impreciseAnchor = a.precise ? null : new mi(c.anchorNode, c.anchorOffset)),
      (this.impreciseHead = l.precise ? null : new mi(c.focusNode, c.focusOffset)));
  }
  suppressWidgetCursorChange(t, e) {
    return (
      this.hasComposition &&
      e.empty &&
      ei(t.focusNode, t.focusOffset, t.anchorNode, t.anchorOffset) &&
  ...
  enforceCursorAssoc() {
    ...
    t.docView.posFromDOM(c.anchorNode, c.anchorOffset) != e.from && i.collapse(n, s);
  }
  moveToLine(t) {
    let e,
      i = this.dom;
    ...
    for (let n = t.offset; !e && n < i.childNodes.length; n++) {
      let t = Qi.get(i.childNodes[n]);
      t instanceof Ii && (e = t.domAtPos(0));
    }
    for (let n = t.offset - 1; !e && n >= 0; n--) {
      let t = Qi.get(i.childNodes[n]);
      t instanceof Ii && (e = t.domAtPos(t.length));
    }
    return e ? new mi(e.node, e.offset, !0) : t;
  }
  nearest(t) {
    for (let e = t; e; ) {
      let t = Qi.get(e);
  ...
  domAtPos(t) {
    ...
    for (; e < this.children.length - 1; ) {
      ...
      if (i < t.length || t instanceof Ii) break;
      (e++, (i = 0));
    }
  ...
  coordsAt(t, e) {
    ...
    for (let s = this.length, r = this.children.length - 1; r >= 0; r--) {
      ...
      (l <= t &&
        (l < t || o.covers(-1)) &&
        (a > t || o.covers(1)) &&
        (!i || (o instanceof Ii && !(i instanceof Ii && e >= 0))) &&
        ((i = o), (n = l)),
        (s = l));
    }
  ...
  coordsForChar(t) {
    let { i: e, off: i } = this.childPos(t, 1),
      n = this.children[e];
    if (!(n instanceof Ii)) return null;
    ...
    if (!(n instanceof _i)) return null;
    let s = dt(n.text, i);
    if (s == i) return null;
    let r = ui(n.dom, i, s).getClientRects();
  ...
  measureVisibleLineHeights(t) {
    let e = [],
      ...
      o = -1,
      a = this.view.textDirection == an.LTR;
  ...
  textDirectionAt(t) {
    ...
    return 'rtl' == getComputedStyle(this.children[e].dom).direction ? an.RTL : an.LTR;
  }
  measureTextSize() {
    for (let t of this.children)
      if (t instanceof Ii) {
  ...
  childCursor(t = this.length) {
    ...
    return (e && (t -= this.children[--e].length), new bi(this.children, t, e));
  }
  computeBlockGapDeco() {
    let t = [],
    ...
    for (let i = 0, n = 0; ; n++) {
      ...
      if (r > i) {
        let n = (e.lineBlockAt(r).bottom - e.lineBlockAt(i).top) / this.view.scaleY;
        t.push(
          Hi.replace({ widget: new is(n), block: !0, inclusive: !0, isBlockGap: !0 }).range(i, r),
        );
      }
      if (!s) break;
      i = s.to + 1;
  ...
  updateDeco() {
    let t = this.view.state
        .facet(Gn)
        .map((t, e) =>
          (this.dynamicDecorationMap[e] = 'function' == typeof t) ? t(this.view) : t,
        ),
      e = !1,
      i = this.view.state.facet(Bn).map((t, i) => {
        let n = 'function' == typeof t;
        return (n && (e = !0), n ? t(this.view) : t);
      });
    i.length && ((this.dynamicDecorationMap[t.length] = e), t.push($e.join(i)));
  ...
  scrollIntoView(t) {
    ...
    !(function (t, e, i, n, s, r, o, a) {
      ...
      for (let c = t, O = !1; c && !O; )
        if (1 == c.nodeType) {
          ...
          if (u) t = oi(h);
            ...
            if (
              (/^(fixed|sticky)$/.test(getComputedStyle(c).position) && (O = !0),
            ...
            (({ scaleX: f, scaleY: d } = ai(c, e)),
              (t = {
                left: e.left,
                right: e.left + c.clientWidth * f,
                top: e.top,
                bottom: e.top + c.clientHeight * d,
              }));
          }
          let p = 0,
            m = 0;
          if ('nearest' == s)
            e.top < t.top
              ? ((m = -(t.top - e.top + o)),
                i > 0 && e.bottom > t.bottom + m && (m = e.bottom - t.bottom + m + o))
              : e.bottom > t.bottom &&
          ...
          if (
            ('nearest' == n
              ? e.left < t.left
                ? ((p = -(t.left - e.left + r)),
                  i > 0 && e.right > t.right + p && (p = e.right - t.right + p + r))
                : e.right > t.right &&
                  ((p = e.right - t.right + r),
                  i < 0 && e.left < t.left + p && (p = -(t.left + p - e.left + r)))
              : (p =
                  ('center' == n
            ...
            if (u) h.scrollBy(p, m);
              ...
              if (m) {
                let t = c.scrollTop;
                ((c.scrollTop += m / d), (i = (c.scrollTop - t) * d));
              }
              if (p) {
                let e = c.scrollLeft;
                ((c.scrollLeft += p / f), (t = (c.scrollLeft - e) * f));
              }
              ((e = { left: e.left - t, top: e.top - i, right: e.right - t, bottom: e.bottom - i }),
                t && Math.abs(t - p) < 1 && (n = 'nearest'),
                i && Math.abs(i - m) < 1 && (s = 'nearest'));
            }
          if (u) break;
          c = c.assignedSlot || c.parentNode;
        } else {
      ...
      this.view.textDirection == an.LTR,
    );
  }
}
class is extends Ui {
...
function ns(t, e) {
  let i = t.observer.selectionRange,
    n = i.focusNode && ss(i.focusNode, i.focusOffset, 0);
  if (!n) return null;
  let s = e - n.offset;
...
function ss(t, e, i) {
  if (i <= 0)
    for (let i = t, n = e; ; ) {
      if (3 == i.nodeType) return { node: i, offset: n };
      if (!(1 == i.nodeType && n > 0)) break;
      ((i = i.childNodes[n - 1]), (n = si(i)));
    }
  if (i >= 0)
    for (let n = t, s = e; ; ) {
      if (3 == n.nodeType) return { node: n, offset: s };
...
function Os(t, e, i) {
  ...
  for (let u = t.firstChild; u; u = u.nextSibling) {
    ...
    for (let f = 0; f < t.length; f++) {
      let d = t[f];
      s && ls(s, d) && (d = hs(cs(d, s.bottom), s.top));
      let p = os(e, d),
        m = as(i, d);
      if (0 == p && 0 == m) return 3 == u.nodeType ? us(u, e, i) : Os(u, e, i);
      if (!n || o > m || (o == m && r > p)) {
        ((n = u), (s = d), (r = p), (o = m));
        let a = m ? (i < d.top ? -1 : 1) : p ? (e < d.left ? -1 : 1) : 0;
  ...
  return 3 == n.nodeType
    ...
    : O && 'false' != n.contentEditable
      ...
      : {
          node: t,
          offset:
            Array.prototype.indexOf.call(t.childNodes, n) + (e >= (s.left + s.right) / 2 ? 1 : 0),
        };
}
function us(t, e, i) {
  let n = t.nodeValue.length,
    ...
    o = 0;
  for (let a = 0; a < n; a++) {
    let n = ui(t, a, a + 1).getClientRects();
    for (let l = 0; l < n.length; l++) {
      ...
      if (h.left - 1 <= e && h.right + 1 >= e && c < r) {
        let i = e >= (h.left + h.right) / 2,
          n = i;
        if (Mi.chrome || Mi.gecko) {
          ui(t, a).getBoundingClientRect().left == h.right && (n = !i);
        }
...
function fs(t, e, i, n = -1) {
  ...
  let o,
    ...
    u = O - l;
  if (u < 0) return 0;
  if (u > h) return t.state.doc.length;
  for (
    let e = t.viewState.heightOracle.textHeight / 2, s = !1;
    (o = t.elementAtHeight(u)), o.type != Fi.Text;
  )
    for (; (u = n > 0 ? o.bottom + e : o.top - e), !(u >= 0 && u <= h); ) {
      if (s) return i ? null : 0;
      ((s = !0), (n = -n));
    }
  O = l + u;
  let f = o.from;
  if (f < t.viewport.from) return 0 == t.viewport.from ? 0 : i ? null : ds(t, a, o, c, O);
  if (f > t.viewport.to)
    return t.viewport.to == t.state.doc.length ? t.state.doc.length : i ? null : ds(t, a, o, c, O);
  let d = t.dom.ownerDocument,
    p = t.root.elementFromPoint ? t.root : d,
    m = p.elementFromPoint(c, O);
  ...
  let g,
    Q = -1;
  if (m && 0 != (null === (s = t.docView.nearest(m)) || void 0 === s ? void 0 : s.isEditable))
    if (d.caretPositionFromPoint) {
      let t = d.caretPositionFromPoint(c, O);
      t && ({ offsetNode: g, offset: Q } = t);
    } else if (d.caretRangeFromPoint) {
      let e = d.caretRangeFromPoint(c, O);
      e &&
        (({ startContainer: g, startOffset: Q } = e),
        (!t.contentDOM.contains(g) ||
          (Mi.safari &&
            (function (t, e, i) {
              ...
              return ui(t, n - 1, n).getBoundingClientRect().left > i;
            })(g, Q, c)) ||
          (Mi.chrome &&
            (function (t, e, i) {
              if (0 != e) return !1;
              ...
              let n =
                1 == t.nodeType
                  ...
                  : ui(t, 0, Math.max(t.nodeValue.length, 1)).getBoundingClientRect();
              return i - n.left > 5;
            })(g, Q, c))) &&
          (g = void 0));
    }
  if (!g || !t.docView.dom.contains(g)) {
    let e = Ii.find(t.docView, f);
    if (!e) return u > o.top + o.height / 2 ? o.to : o.from;
    ({ node: g, offset: Q } = Os(e.dom, c, O));
  }
  let w = t.docView.nearest(g);
  if (!w) return null;
  if (w.isWidget && 1 == (null === (r = w.dom) || void 0 === r ? void 0 : r.nodeType)) {
    let t = w.dom.getBoundingClientRect();
    return e.y < t.top || (e.y <= t.bottom && e.x <= (t.left + t.right) / 2)
      ? w.posAtStart
      : w.posAtEnd;
  }
  return w.localPosFromDOM(g, Q) + w.posAtStart;
}
function ds(t, e, i, n, s) {
  ...
  if (t.lineWrapping && i.height > 1.5 * t.defaultLineHeight) {
    ...
    r +=
      Math.floor((s - i.top - 0.5 * (t.defaultLineHeight - e)) / e) *
  ...
  return (
    ...
    (function (t, e, i) {
      for (let n = 0, s = 0; ; ) {
        if (s >= e) return n;
        if (n == t.length) break;
        ((s += 9 == t.charCodeAt(n) ? i - (s % i) : 1), (n = dt(t, n)));
      }
      return t.length;
    })(o, r, t.state.tabSize)
  );
...
function ps(t, e) {
  ...
  if (Array.isArray(i.type))
    for (let t of i.type)
      if (t.to > e || (t.to == e && (t.to == i.to || t.type == Fi.Text))) return t;
  return i;
}
function ms(t, e, i, n) {
...
function Qs(t, e, i) {
  let n = gs(
    t.state.facet(In).map((e) => e(t)),
    i.from,
    e.head > i.from ? -1 : 1,
  );
  return n == i.from ? i : Zt.cursor(n, n < i.from ? 1 : -1);
}
class ws {
  ...
  constructor(t) {
    ((this.view = t),
      ...
      Mi.safari && t.contentDOM.addEventListener('input', () => null),
      Mi.gecko &&
        (function (t) {
          Bs.has(t) ||
            (Bs.add(t), t.addEventListener('copy', () => {}), t.addEventListener('cut', () => {}));
  ...
  handleEvent(t) {
    (function (t, e) {
      ...
      for (let i, n = e.target; n != t.contentDOM; n = n.parentNode)
        if (!n || 11 == n.nodeType || ((i = Qi.get(n)) && i.ignoreEvent(e))) return !1;
      return !0;
    })(this.view, t) &&
    ...
    for (let t in e)
      if ('scroll' != t) {
        let s = !e[t].handlers.length,
          r = i[t];
        (r && s != !r.handlers.length && (n.removeEventListener(t, this.handleEvent), (r = null)),
  ...
  keydown(t) {
    if (
      ...
      return !0;
    if (
      (27 != t.keyCode && xs.indexOf(t.keyCode) < 0 && (this.view.inputState.lastEscPress = 0),
      Mi.android && Mi.chrome && !t.synthetic && (13 == t.keyCode || 8 == t.keyCode))
    )
    ...
    return !Mi.ios ||
      ...
      t.metaKey ||
      !(
        ((e = vs.find((e) => e.keyCode == t.keyCode)) && !t.ctrlKey) ||
        (ys.indexOf(t.key) > -1 && t.ctrlKey && !t.shiftKey)
      )
  ...
  flushIOSKey() {
    ...
    return !!t && ((this.pendingIOSKey = void 0), fi(this.view.contentDOM, t.key, t.keyCode));
  }
  ...
  for (let e of t) {
    ...
    if (t && t.domEventHandlers)
      for (let n in t.domEventHandlers) {
        let s = t.domEventHandlers[n];
        s && i(n).handlers.push(bs(e.value, s));
      }
    if (t && t.domEventObservers)
      for (let n in t.domEventObservers) {
        let s = t.domEventObservers[n];
        s && i(n).observers.push(bs(e.value, s));
      }
  }
  for (let t in Ps) i(t).handlers.push(Ps[t]);
  for (let t in Ts) i(t).observers.push(Ts[t]);
  return e;
}
const vs = [
...
class $s {
  constructor(t, e, i, n) {
    ((this.view = t),
      ...
      (this.atoms = t.state.facet(In).map((e) => e(t))));
    ...
    (s.addEventListener('mousemove', (this.move = this.move.bind(this))),
      ...
      (this.multiple =
        t.state.facet(be.allowMultipleSelections) &&
        (function (t, e) {
          let i = t.state.facet($n);
          return i.length ? i[0](e) : Mi.mac ? e.metaKey : e.ctrlKey;
        })(t, e)),
      (this.dragging =
        !(
          !(function (t, e) {
  ...
  move(t) {
    ...
    let s = 0,
      ...
      a = Hn(this.view);
    (t.clientX - a.left <= o.left + 6
      ? (s = -ks(o.left - t.clientX))
      : t.clientX + a.right >= o.right - 6 && (s = ks(t.clientX - o.right)),
      t.clientY - a.top <= o.top + 6
        ? (r = -ks(o.top - t.clientY))
        : t.clientY + a.bottom >= o.bottom - 6 && (r = ks(t.clientY - o.bottom)),
      this.setScrollSpeed(s, r));
  }
  up(t) {
  ...
  skipAtoms(t) {
    ...
    for (let i = 0; i < t.ranges.length; i++) {
      let n = t.ranges[i],
        s = null;
      if (n.empty) {
        let t = gs(this.atoms, n.from, 0);
        t != n.from && (s = Zt.cursor(t, -1));
      } else {
        let t = gs(this.atoms, n.from, -1),
          e = gs(this.atoms, n.to, 1);
        (t == n.from && e == n.to) ||
          (s = Zt.range(n.from == n.anchor ? t : e, n.from == n.head ? t : e));
      }
      s && (e || (e = t.ranges.slice()), (e[i] = s));
    }
    return e ? Zt.create(e, t.mainIndex) : t;
  }
  select(t) {
    let { view: e } = this,
...
const Ps = Object.create(null),
  ...
  Zs = (Mi.ie && Mi.ie_version < 15) || (Mi.ios && Mi.webkit_version < 604);
function Xs(t, e) {
  let i,
    { state: n } = t,
    s = 1,
  ...
  if (null != Ws && n.selection.ranges.every((t) => t.empty) && Ws == r.toString()) {
    let t = -1;
    i = n.changeByRange((i) => {
      ...
      return { changes: { from: a.from, insert: l }, range: Zt.cursor(i.from + l.length) };
    });
  } else
    i = o
      ? n.changeByRange((t) => {
          ...
          return {
            ...
            range: Zt.cursor(t.from + e.length),
          };
        })
...
function As(t, e, i, n) {
  if (1 == n) return Zt.cursor(e, i);
  if (2 == n)
    return (function (t, e, i = 1) {
      let n = t.charCategorizer(e),
        s = t.doc.lineAt(e),
        r = e - s.from;
      if (0 == s.length) return Zt.cursor(e);
      0 == r ? (i = 1) : r == s.length && (i = -1);
      let o = r,
        a = r;
      i < 0 ? (o = dt(s.text, r, !1)) : (a = dt(s.text, r));
      ...
      return Zt.range(o + s.from, a + s.from);
    })(t.state, e, i);
  {
    let i = Ii.find(t.docView, e),
      ...
      r = i ? i.posAtEnd : n.to;
    return (r < t.state.doc.length && r == n.to && r++, Zt.range(s, r));
  }
}
((Ts.scroll = (t) => {
  ...
  (Ps.mousedown = (t, e) => {
    ...
    let i = null;
    for (let n of t.state.facet(Tn)) if (((i = n(t, e)), i)) break;
    if (
      (i ||
        0 != e.button ||
        (i = (function (t, e) {
          ...
          return {
            update(t) {
              t.docChanged && ((i.pos = t.changes.mapPos(i.pos)), (s = s.map(t.changes)));
            },
            get(e, r, o) {
              let a,
                l = _s(t, e),
                h = As(t, l.pos, l.bias, n);
              if (i.pos != l.pos && !r) {
                let e = As(t, i.pos, i.bias, n),
                  s = Math.min(e.from, h.from),
                  r = Math.max(e.to, h.to);
                h = s < h.from ? Zt.range(s, r) : Zt.range(r, s);
              }
              return r
      ...
      (t.inputState.startMouseSelection(new $s(t, e, i, n)),
        n && t.observer.ignore(() => Oi(t.contentDOM)));
      let s = t.inputState.mouseSelection;
      if (s) return (s.start(e), !1 === s.dragging);
    }
    return !1;
  }));
let Cs = (t, e) => t >= e.top && t <= e.bottom,
  Rs = (t, e, i) => Cs(e, i) && t >= i.left && t <= i.right;
function Ms(t, e, i, n) {
  let s = Ii.find(t.docView, e);
  if (!s) return 1;
  ...
  let s = t.posAtCoords({ x: e.clientX, y: e.clientY }, !1),
    ...
    o =
      ...
      (function (t, e) {
        ...
        return i.length ? i[0](e) : Mi.mac ? !e.altKey : !e.ctrlKey;
      })(t, e)
        ? { from: r.from, to: r.to }
        : null,
    a = { from: s, insert: i },
...
((Ps.dragstart = (t, e) => {
  ...
  if (e.target.draggable) {
    ...
    if (n && n.isWidget) {
      let t = n.posAtStart,
        e = t + n.length;
      (t >= i.to || e <= i.from) && (i = Zt.range(t, e));
    }
  }
  let { inputState: n } = t;
  return (
  ...
  (Ps.dragend = (t) => ((t.inputState.draggedContent = null), !1)),
  (Ps.drop = (t, e) => {
    ...
    if (i && i.length) {
      let n = Array(i.length),
        s = 0,
        r = () => {
          ++s == i.length && Ds(t, e, n.filter((t) => null != t).join(t.state.lineBreak), !1);
        };
  ...
  (Ps.paste = (t, e) => {
    if (t.state.readOnly) return !0;
    t.observer.flush();
    let i = Zs ? null : e.clipboardData;
    return i
      ? (Xs(t, i.getData('text/plain') || i.getData('text/uri-text')), !0)
      : ((function (t) {
  ...
  let {
    ...
    if (!e.length) {
      ...
      for (let { from: n } of t.selection.ranges) {
        ...
        (r.number > s &&
          (e.push(r.text), i.push({ from: r.from, to: Math.min(t.doc.length, r.to + 1) })),
          (s = r.number));
      }
      n = !0;
    }
...
function Ls(t, e) {
  ...
  return i ? t.update({ effects: i, annotations: js.of(!0) }) : null;
}
function Gs(t) {
  setTimeout(() => {
    let e = t.hasFocus;
...
((Ts.focus = (t) => {
  ...
  (Ts.blur = (t) => {
    (t.observer.clearSelectionRange(), Gs(t));
  }),
  (Ts.compositionstart = Ts.compositionupdate =
    (t) => {
  ...
  (Ps.beforeinput = (t, e) => {
    ...
    if (
      Mi.chrome &&
      Mi.android &&
      (n = vs.find((t) => t.inputType == e.inputType)) &&
      (t.observer.delayAndroidKey(n.key, n.keyCode), 'Backspace' == n.key || 'Delete' == n.key)
    ) {
      let e = (null === (i = globalThis.visualViewport) || void 0 === i ? void 0 : i.height) || 0;
      setTimeout(() => {
        var i;
        ((null === (i = globalThis.visualViewport) || void 0 === i ? void 0 : i.height) || 0) >
          e + 10 &&
          t.hasFocus &&
...
class Ns {
  ...
  heightForGap(t, e) {
    ...
    return (
      this.lineWrapping &&
        (i += Math.max(0, Math.ceil((e - t - i * this.lineLength * 0.5) / this.lineLength))),
      this.lineHeight * i
    );
  }
  heightForLine(t) {
    ...
    return (
      (1 + Math.max(0, Math.ceil((t - this.lineLength) / (this.lineLength - 5)))) * this.lineHeight
    );
  }
  setDoc(t) {
  ...
  mustRefreshForWrapping(t) {
    return Is.indexOf(t) > -1 != this.lineWrapping;
  }
...
class Fs {
  ...
  get widget() {
    return this._content instanceof tn ? this._content.widget : null;
  }
  ...
  join(t) {
    ...
    return new Fs(this.from, this.length + t.length, this.top, this.height + t.height, e);
  }
}
var Hs = (function (t) {
  return (
...
class Js {
  ...
  setHeight(t, e) {
    this.height != e &&
      (Math.abs(this.height - e) > Ks && (t.heightChanged = !0), (this.height = e));
  }
  replace(t, e, i) {
    return Js.of(i);
  }
  ...
  applyChanges(t, e, i, n) {
    ...
    for (let o = n.length - 1; o >= 0; o--) {
      let { fromA: a, toA: l, fromB: h, toB: c } = n[o],
        O = s.lineAt(a, Hs.ByPosNoHeight, i.setDoc(e), 0, 0),
        u = O.to >= l ? O : s.lineAt(l, Hs.ByPosNoHeight, i, 0, 0);
      for (c += u.to - l, l = u.to; o > 0 && O.from <= n[o - 1].toA; )
        ((a = n[o - 1].fromA),
          (h = n[o - 1].fromB),
          o--,
          a < O.from && (O = s.lineAt(a, Hs.ByPosNoHeight, i, 0, 0)));
      ((h += O.from - a), (a = O.from));
      let f = rr.build(i.setDoc(r), t, h, c);
      s = s.replace(a, l, f);
    }
  ...
  static of(t) {
    ...
    return (
      ...
      new nr(Js.of(t.slice(0, e)), r, Js.of(t.slice(i)))
    );
  }
}
Js.prototype.size = 1;
class tr extends Js {
  ...
  blockAt(t, e, i, n) {
    return new Fs(n, this.length, i, this.height, this.deco || 0);
  }
  lineAt(t, e, i, n, s) {
...
class er extends tr {
  ...
  blockAt(t, e, i, n) {
    return new Fs(n, this.length, i, this.height, this.breaks);
  }
  replace(t, e, i) {
    let n = i[0];
    return 1 == i.length &&
      (n instanceof er || (n instanceof ir && 4 & n.flags)) &&
      Math.abs(this.length - n.length) < 10
      ? (n instanceof ir ? (n = new er(n.length, this.height)) : (n.height = this.height),
    ...
    return (
      n && n.from <= e && n.more
        ...
        : (i || this.outdated) &&
          this.setHeight(
            t,
            Math.max(this.widgetHeight, t.heightForLine(this.length - this.collapsed)) +
...
class ir extends Js {
  ...
  blockAt(t, e, i, n) {
    let { firstLine: s, lastLine: r, perLine: o, perChar: a } = this.heightMetrics(e, n);
    if (e.lineWrapping) {
      let s = n + Math.round(Math.max(0, Math.min(1, (t - i) / this.height)) * this.length),
        r = e.doc.lineAt(s),
        l = o + r.length * a,
        h = Math.max(i, t - l / 2);
      return new Fs(r.from, r.length, h, l, 0);
    }
    {
      let n = Math.max(0, Math.min(r - s, Math.floor((t - i) / o))),
        { from: a, length: l } = e.doc.line(s + n);
      return new Fs(a, l, i + o * n, o, 0);
    }
  }
  lineAt(t, e, i, n, s) {
    if (e == Hs.ByHeight) return this.blockAt(t, i, n, s);
    if (e == Hs.ByPosNoHeight) {
      let { from: e, to: n } = i.doc.lineAt(t);
      return new Fs(e, n - e, 0, 0, 0);
    }
    let { firstLine: r, perLine: o, perChar: a } = this.heightMetrics(i, s),
      l = i.doc.lineAt(t),
      h = o + l.length * a,
      c = l.number - r,
      O = n + o * c + a * (l.from - s - c);
    return new Fs(l.from, l.length, Math.max(n, Math.min(O, n + this.height - h)), h, 0);
  }
  forEachLine(t, e, i, n, s, r) {
    ...
    for (let h = t, c = n; h <= e; ) {
      ...
      let n = a + l * e.length;
      (r(new Fs(e.from, e.length, c, n, 0)), (c += n), (h = e.to + 1));
    }
  }
  replace(t, e, i) {
    let n = this.length - e;
    if (n > 0) {
      let t = i[i.length - 1];
      t instanceof ir ? (i[i.length - 1] = new ir(t.length + n)) : i.push(null, new ir(n - 1));
    }
    if (t > 0) {
      let e = i[0];
      e instanceof ir ? (i[0] = new ir(t + e.length)) : i.unshift(new ir(t - 1), null);
    }
    return Js.of(i);
  }
  decomposeLeft(t, e) {
    e.push(new ir(t - 1), null);
  }
  decomposeRight(t, e) {
    e.push(null, new ir(this.length - t - 1));
  }
  updateHeight(t, e = 0, i = !1, n) {
    let s = e + this.length;
    if (n && n.from <= e + this.length && n.more) {
      let i = [],
        r = Math.max(e, n.from),
        o = -1;
      for (n.from > e && i.push(new ir(n.from - e - 1).updateHeight(t, e)); r <= s && n.more; ) {
        let e = t.doc.lineAt(r).length;
        i.length && i.push(null);
        let s = n.heights[n.index++];
        -1 == o ? (o = s) : Math.abs(s - o) >= Ks && (o = -2);
        let a = new er(e, s);
        ((a.outdated = !1), i.push(a), (r += e + 1));
      }
      r <= s && i.push(null, new ir(s - r).updateHeight(t, r));
      let a = Js.of(i);
      return (
        (o < 0 ||
          Math.abs(a.height - this.height) >= Ks ||
          Math.abs(o - this.heightMetrics(t, e).perLine) >= Ks) &&
          (t.heightChanged = !0),
        a
      );
    }
    return (
      (i || this.outdated) &&
        (this.setHeight(t, t.heightForGap(e, e + this.length)), (this.outdated = !1)),
      this
    );
  }
  toString() {
...
class nr extends Js {
  ...
  forEachLine(t, e, i, n, s, r) {
    ...
    if (this.break)
      (t < a && this.left.forEachLine(t, e, i, n, s, r),
        e >= a && this.right.forEachLine(t, e, i, o, a, r));
    else {
      let l = this.lineAt(a, Hs.ByPos, i, n, s);
  ...
  replace(t, e, i) {
    ...
    if ((t > 0 && sr(s, r - 1), e < this.length)) {
      let t = s.length;
      (this.decomposeRight(e, s), sr(s, t));
    }
    return Js.of(s);
  }
  decomposeLeft(t, e) {
  ...
  updateHeight(t, e = 0, i = !1, n) {
    ...
    return (
      n && n.from <= e + s.length && n.more
        ? (a = s = s.updateHeight(t, e, i, n))
        : s.updateHeight(t, e, i),
      n && n.from <= o + r.length && n.more
        ? (a = r = r.updateHeight(t, o, i, n))
...
function sr(t, e) {
  let i, n;
  null == t[e] &&
    (i = t[e - 1]) instanceof ir &&
    (n = t[e + 1]) instanceof ir &&
    t.splice(e - 1, 3, new ir(i.length + 1 + n.length));
}
class rr {
  constructor(t, e) {
    ((this.pos = t),
  ...
  span(t, e) {
    if (this.lineStart > -1) {
      ...
      (i instanceof er
        ? (i.length += t - this.pos)
        : (t > this.pos || !this.isCovered) && this.nodes.push(new er(t - this.pos, -1)),
        (this.writtenTo = t),
  ...
  point(t, e, i) {
    if (t < e || i.heightRelevant) {
      ...
      let r = e - t;
      i.block ? this.addBlock(new tr(r, n, i)) : (r || s || n >= 5) && this.addLineDeco(n, s, r);
  ...
  enterLine() {
    ...
    ((this.lineStart = t),
      ...
      this.pos > t && this.nodes.push(new er(this.pos - t, -1)),
  ...
  finish(t) {
    ...
    !(this.lineStart > -1) || e instanceof er || this.isCovered
      ? (this.writtenTo < this.pos || null == e) &&
        this.nodes.push(this.blankContent(this.writtenTo, this.pos))
      : this.nodes.push(new er(0, -1));
    let i = t;
    for (let t of this.nodes)
      (t instanceof er && t.updateHeight(this.oracle, i), (i += t ? t.length : 1));
    return this.nodes;
  }
  static build(t, e, i, n) {
    let s = new rr(i, t);
    return ($e.spans(e, i, n, s, 0), s.finish(i));
  }
}
class or {
  constructor() {
  ...
  comparePoint(t, e, i, n) {
    (t < e || (i && i.heightRelevant) || (n && n.heightRelevant)) && nn(t, e, this.changes, 5);
  }
}
function ar(t, e) {
  let i = t.getBoundingClientRect(),
    ...
    a = Math.max(0, i.top),
    l = Math.min(s.innerHeight, i.bottom);
  for (let e = t.parentNode; e && e != n.body; )
    if (1 == e.nodeType) {
      let i = e,
        n = globalThis.getComputedStyle(i);
      if (
...
class hr {
  ...
  draw(t, e) {
    return Hi.replace({ widget: new cr(this.size * (e ? t.scaleY : t.scaleX), e) }).range(
      this.from,
      this.to,
    );
  }
...
class Or {
  constructor(t) {
    ((this.state = t),
      ...
      (this.defaultTextDirection = an.LTR),
      (this.visibleRanges = []),
      (this.mustEnforceCursorAssoc = !1));
    let e = t.facet(Ln).some((t) => 'function' != typeof t && 'cm-lineWrapping' == t.class);
    ((this.heightOracle = new Ns(e)),
      (this.stateDeco = t.facet(Gn).filter((t) => 'function' != typeof t)),
      (this.heightMap = Js.empty().applyChanges(
        this.stateDeco,
        st.empty,
        this.heightOracle.setDoc(t.doc),
        [new Jn(0, 0, 0, t.doc.length)],
      )),
      (this.viewport = this.getViewport(0, null)),
      this.updateViewportLines(),
      this.updateForViewport(),
      (this.lineGaps = this.ensureLineGaps([])),
      (this.lineGapDeco = Hi.set(this.lineGaps.map((t) => t.draw(this, !1)))),
    ...
    ((this.viewports = t.sort((t, e) => t.from - e.from)),
      (this.scaler =
        this.heightMap.height <= 7e6
          ? mr
          : new gr(this.heightOracle, this.heightMap, this.viewports)));
  }
  updateViewportLines() {
    ((this.viewportLines = []),
      this.heightMap.forEachLine(
        ...
        0,
        (t) => {
          this.viewportLines.push(1 == this.scaler.scale ? t : Qr(t, this.scaler));
        },
      ));
  }
  update(t, e = null) {
    ...
    this.stateDeco = this.state.facet(Gn).filter((t) => 'function' != typeof t);
    let n = t.changedRanges,
      s = Jn.extendWithRanges(
        n,
        (function (t, e, i) {
          let n = new or();
          return ($e.compare(t, e, i, n, 0), n.changes);
    ...
    ((this.heightMap = this.heightMap.applyChanges(
      ...
      o
        ? ((this.scrollAnchorPos = t.changes.mapPos(o.from, -1)), (this.scrollAnchorHeight = o.top))
    ...
    ((e && (e.range.head < a.from || e.range.head > a.to)) || !this.viewportIsAppropriate(a)) &&
      (a = this.getViewport(0, e));
    let l =
      !t.changes.empty || 2 & t.flags || a.from != this.viewport.from || a.to != this.viewport.to;
    ((this.viewport = a),
      this.updateForViewport(),
  ...
  measure(t) {
    let e = t.contentDOM,
      i = globalThis.getComputedStyle(e),
      n = this.heightOracle,
      s = i.whiteSpace;
    this.defaultTextDirection = 'rtl' == i.direction ? an.RTL : an.LTR;
    let r = this.heightOracle.mustRefreshForWrapping(s),
      o = e.getBoundingClientRect(),
      a = r || this.mustMeasureContent || this.contentDOMHeight != o.height;
    ((this.contentDOMHeight = o.height), (this.mustMeasureContent = !1));
    let l = 0,
      h = 0;
    if (o.width && o.height) {
      let { scaleX: t, scaleY: i } = ai(e, o);
      (this.scaleX == t && this.scaleY == i) ||
        ((this.scaleX = t), (this.scaleY = i), (l |= 8), (r = a = !0));
    }
    let c = (parseInt(i.paddingTop) || 0) * this.scaleY,
      O = (parseInt(i.paddingBottom) || 0) * this.scaleY;
    ((this.paddingTop == c && this.paddingBottom == O) ||
      ((this.paddingTop = c), (this.paddingBottom = O), (l |= 10)),
      this.editorWidth != t.scrollDOM.clientWidth &&
        (n.lineWrapping && (a = !0), (this.editorWidth = t.scrollDOM.clientWidth), (l |= 8)));
    let u = t.scrollDOM.scrollTop * this.scaleY;
    (this.scrollTop != u && ((this.scrollAnchorHeight = -1), (this.scrollTop = u)),
      (this.scrolledToBottom = pi(t.scrollDOM)));
    let f = (this.printing ? lr : ar)(e, this.paddingTop),
    ...
    if (
      (m != this.inView && ((this.inView = m), m && (a = !0)), !this.inView && !this.scrollTarget)
    )
      return 0;
    let g = o.width;
    if (
      ((this.contentDOMWidth == g && this.editorHeight == t.scrollDOM.clientHeight) ||
      ...
      if (
        ...
        r || (n.lineWrapping && Math.abs(g - this.contentDOMWidth) > n.charWidth))
      ) {
        let { lineHeight: i, charWidth: o, textHeight: a } = t.docView.measureTextSize();
        ((r = i > 0 && n.refresh(s, i, o, a, g / o, e)), r && ((t.docView.minWidth = 0), (l |= 8)));
      }
      ...
      for (let i of this.viewports) {
        ...
        this.heightMap = (
          r
            ? Js.empty().applyChanges(this.stateDeco, st.empty, this.heightOracle, [
                new Jn(0, 0, 0, t.state.doc.length),
              ])
            : this.heightMap
        ).updateHeight(n, 0, r, new Us(i.from, s));
      }
      n.heightChanged && (l |= 2);
    }
    let Q =
    ...
    return (
      Q && (this.viewport = this.getViewport(h, this.scrollTarget)),
      this.updateForViewport(),
      (2 & l || Q) && this.updateViewportLines(),
      (this.lineGaps.length || this.viewport.to - this.viewport.from > 4e3) &&
  ...
  getViewport(t, e) {
    let i = 0.5 - Math.max(-0.5, Math.min(0.5, t / 1e3 / 2)),
      ...
      a = new ur(
        n.lineAt(r - 1e3 * i, Hs.ByHeight, s, 0, 0).from,
        n.lineAt(o + 1e3 * (1 - i), Hs.ByHeight, s, 0, 0).to,
      );
    if (e) {
      let { head: t } = e.range;
      if (t < a.from || t > a.to) {
        ...
        ((i =
          'center' == e.y
            ...
            : 'start' == e.y || ('nearest' == e.y && t < a.from)
              ...
              : o.bottom - r),
          (a = new ur(
            n.lineAt(i - 500, Hs.ByHeight, s, 0, 0).from,
            n.lineAt(i + r + 500, Hs.ByHeight, s, 0, 0).to,
          )));
      }
    }
    return a;
  ...
  mapViewport(t, e) {
    let i = e.mapPos(t.from, -1),
      n = e.mapPos(t.to, 1);
    return new ur(
      this.heightMap.lineAt(i, Hs.ByPos, this.heightOracle, 0, 0).from,
      this.heightMap.lineAt(n, Hs.ByPos, this.heightOracle, 0, 0).to,
    );
  }
  viewportIsAppropriate({ from: t, to: e }, i = 0) {
    if (!this.inView) return !0;
    let { top: n } = this.heightMap.lineAt(t, Hs.ByPos, this.heightOracle, 0, 0),
      { bottom: s } = this.heightMap.lineAt(e, Hs.ByPos, this.heightOracle, 0, 0),
      { visibleTop: r, visibleBottom: o } = this;
    return (
  ...
  mapLineGaps(t, e) {
    ...
    let i = [];
    for (let n of t)
      e.touchesRange(n.from, n.to) || i.push(new hr(e.mapPos(n.from), e.mapPos(n.to), n.size));
    return i;
  }
  ensureLineGaps(t, e) {
    let i = this.heightOracle.lineWrapping,
      ...
      s = n >> 1,
      r = n << 1;
    if (this.defaultTextDirection != an.LTR && !i) return [];
    let o = [],
      a = (n, r, l, h) => {
        if (r - n < s) return;
        ...
        if (!u) {
          if (r < l.to && e && i && e.visibleRanges.some((t) => t.from <= r && t.to >= r)) {
            let t = e.moveToLineBoundary(Zt.cursor(r), !1, !0).head;
            t > n && (r = t);
          }
          u = new hr(n, r, this.gapSize(l, n, r, h));
        }
        o.push(u);
      };
    for (let t of this.viewportLines) {
      if (t.length < r) continue;
      let e = fr(t.from, t.to, this.stateDeco);
      ...
      if (i) {
        let i,
          r,
          a = (n / this.heightOracle.lineLength) * this.heightOracle.lineHeight;
        if (null != l) {
          let n = pr(e, l),
            s = ((this.visibleBottom - this.visibleTop) / 2 + a) / t.height;
          ((i = n - s), (r = n + s));
        } else
          ((i = (this.visibleTop - t.top - a) / t.height),
            (r = (this.visibleBottom - t.top + a) / t.height));
        ((s = dr(e, i)), (o = dr(e, r)));
      } else {
        let t,
          i,
        ...
        if (null != l) {
          let n = pr(e, l),
            s = ((this.pixelViewport.right - this.pixelViewport.left) / 2 + a) / r;
          ((t = n - s), (i = n + s));
        } else ((t = (this.pixelViewport.left - a) / r), (i = (this.pixelViewport.right + a) / r));
        ((s = dr(e, t)), (o = dr(e, i)));
      }
      (s > t.from && a(t.from, s, t, e), o < t.to && a(o, t.to, t, e));
    }
    return o;
  }
  gapSize(t, e, i, n) {
  ...
  updateLineGaps(t) {
    hr.same(t, this.lineGaps) ||
      ((this.lineGaps = t),
      (this.lineGapDeco = Hi.set(t.map((t) => t.draw(this, this.heightOracle.lineWrapping)))));
  }
  ...
  lineBlockAt(t) {
    return (
      ...
      Qr(this.heightMap.lineAt(t, Hs.ByPos, this.heightOracle, 0, 0), this.scaler)
    );
  }
  lineBlockAtHeight(t) {
    return Qr(
      this.heightMap.lineAt(this.scaler.fromDOM(t), Hs.ByHeight, this.heightOracle, 0, 0),
      this.scaler,
    );
  }
  scrollAnchorAt(t) {
...
function dr({ total: t, ranges: e }, i) {
...
const mr = { toDOM: (t) => t, fromDOM: (t) => t, scale: 1 };
class gr {
  constructor(t, e, i) {
    let n = 0,
      s = 0,
    ...
    ((this.viewports = i.map(({ from: i, to: s }) => {
      let r = e.lineAt(i, Hs.ByPos, t, 0, 0).top,
        o = e.lineAt(s, Hs.ByPos, t, 0, 0).bottom;
...
function Qr(t, e) {
  ...
  return new Fs(
    ...
    i,
    n - i,
    Array.isArray(t._content) ? t._content.map((t) => Qr(t, e)) : t._content,
  );
}
const wr = Ct.define({ combine: (t) => t.join(' ') }),
  br = Ct.define({ combine: (t) => t.indexOf(!0) > -1 }),
  Sr = We.newName(),
  vr = We.newName(),
  yr = We.newName(),
  xr = { '&light': '.' + vr, '&dark': '.' + yr };
...
class Tr {
  constructor(t, e) {
    ((this.points = t), (this.text = ''), (this.lineSeparator = e.facet(be.lineSeparator)));
  }
  append(t) {
    this.text += t;
  }
  ...
  readRange(t, e) {
    ...
    for (let n = t; ; ) {
      ...
      ((r && o
        ? r.breakAfter
        : (r ? r.breakAfter : Xr(n)) ||
          (Xr(s) && ('BR' != n.nodeName || n.cmIgnore) && this.text.length > t)) &&
        this.lineBreak(),
        (n = s));
    }
  ...
  findPointInside(t, e) {
    for (let i of this.points)
      (3 == t.nodeType ? i.node == t : t.contains(i.node)) &&
        (i.pos = this.text.length + (Zr(t, i.node, i.offset) ? e : 0));
  }
}
function Zr(t, e, i) {
  for (;;) {
    if (!e || i < si(e)) return !1;
    if (e == t) return !0;
    ((i = ii(e) + 1), (e = e.parentNode));
  }
}
function Xr(t) {
  ...
  constructor(t, e, i, n) {
    ...
    if (t.state.readOnly && e > -1) this.newSel = null;
      ...
      let e =
          s || r
            ...
            : (function (t) {
                ...
                i && (e.push(new Ar(i, n)), (s == i && r == n) || e.push(new Ar(s, r)));
                return e;
              })(t),
        i = new Tr(e, t.state);
      ...
      if (
        ...
        let e = o.from - Math.min(i, n),
          s = o.to - Math.max(i, n);
        (0 != e && 1 != e) || (0 != s && -1 != s) || ((i = 0), (n = t.state.doc.length));
      }
      this.newSel = Zt.single(n, i);
    }
  }
}
function Rr(t, e) {
  ...
  if (e.bounds) {
    let { from: n, to: o } = e.bounds,
      a = s.from,
      l = null;
    (8 === r || (Mi.android && e.text.length < o - n)) && ((a = s.to), (l = 'end'));
    ...
    })(t.state.doc.sliceString(n, o, Pr), e.text, a - n, l);
    h &&
      (Mi.chrome &&
        13 == r &&
        h.toB == h.from + 2 &&
        e.text.slice(h.from, h.toB) == Pr + Pr &&
        h.toB--,
      (i = {
        from: n + h.from,
        to: n + h.toA,
        insert: st.of(e.text.slice(h.from, h.toB).split(Pr)),
      }));
  } else n && ((!t.hasFocus && t.state.facet(Vn)) || n.main.eq(s)) && (n = null);
  if (!i && !n) return !1;
  if (
    (!i && e.typeOver && !s.empty && n && n.main.empty
      ? (i = { from: s.from, to: s.to, insert: t.state.doc.slice(s.from, s.to) })
      : i &&
          i.from >= s.from &&
          i.to <= s.to &&
        ...
        : (Mi.mac || Mi.android) &&
          ...
          ? (n && 2 == i.insert.length && (n = Zt.single(n.main.anchor - 1, n.main.head - 1)),
            (i = { from: s.from, to: s.to, insert: st.of([' ']) }))
          : Mi.chrome &&
            i &&
            i.from == i.to &&
            i.from == s.head &&
            '\n ' == i.insert.toString() &&
            t.lineWrapping &&
            (n && (n = Zt.single(n.main.anchor - 1, n.main.head - 1)),
            (i = { from: s.from, to: s.to, insert: st.of([' ']) })),
    i)
  ) {
    if (Mi.ios && t.inputState.flushIOSKey()) return !0;
    if (
      Mi.android &&
      ((i.from == s.from &&
        i.to == s.to &&
        1 == i.insert.length &&
        2 == i.insert.lines &&
        fi(t.contentDOM, 'Enter', 13)) ||
        (((i.from == s.from - 1 && i.to == s.to && 0 == i.insert.length) ||
          (8 == r && i.insert.length < i.to - i.from && i.to > s.head)) &&
          fi(t.contentDOM, 'Backspace', 8)) ||
        (i.from == s.from &&
          i.to == s.to + 1 &&
          0 == i.insert.length &&
          fi(t.contentDOM, 'Delete', 46)))
    )
      return !0;
    let e,
      o = i.insert.toString();
      ...
      (e = (function (t, e, i) {
        ...
        if (
          ...
          n = s.replaceSelection(
            t.state.toText(i + e.insert.sliceString(0, void 0, t.state.lineBreak) + o),
          );
        } else {
          let o = s.changes(e),
          ...
          if (
            ...
            let l,
              ...
              c = i && ns(t, i.main.head);
            if (c) {
              let t = e.insert.length - (e.to - e.from);
              l = { from: c.from, to: c.to - t };
            } else l = t.state.doc.lineAt(r.head);
            let O = r.to - e.to,
              u = r.to - r.from;
            n = s.changeByRange((i) => {
              if (i.from == r.from && i.to == r.to) return { changes: o, range: a || i.map(o) };
              let n = i.to - O,
                c = n - h.length;
              if (
                i.to - i.from != u ||
                ...
                return { range: i };
              let f = s.changes({ from: c, to: n, insert: e.insert }),
                d = i.to - r.to;
              return {
                changes: f,
                range: a ? Zt.range(Math.max(0, a.anchor + d), Math.max(0, a.head + d)) : i.map(f),
              };
            });
          } else n = { changes: o, selection: a && s.selection.replaceRange(a) };
        }
        let o = 'input.type';
        (t.composing ||
          (t.inputState.compositionPendingChange &&
        ...
        return s.update(n, { userEvent: o, scrollIntoView: !0 });
      })(t, i, n));
    return (t.state.facet(An).some((e) => e(t, i.from, i.to, o, a)) || t.dispatch(a()), !0);
  }
  if (n && !n.main.eq(s)) {
    let e = !1,
      i = 'select';
...
const Mr = {
  ...
  _r = Mi.ie && Mi.ie_version <= 11;
class Yr {
  constructor(t) {
    ((this.view = t),
      (this.active = !1),
      (this.selectionRange = new li()),
      ...
      (this.observer = new MutationObserver((e) => {
        ...
        ((Mi.ie && Mi.ie_version <= 11) || (Mi.ios && t.composing)) &&
        e.some(
          (t) =>
      ...
      'function' == typeof ResizeObserver &&
        ((this.resizeScroll = new ResizeObserver(() => {
          var t;
          (null === (t = this.view.docView) || void 0 === t ? void 0 : t.lastUpdate) <
  ...
  onSelectionChange(t) {
    ...
    if (i.state.facet(Vn) ? i.root.activeElement != this.dom : !Je(i.dom, n)) return;
    let s = n.anchorNode && i.docView.nearest(n.anchorNode);
    s && s.ignoreEvent(t)
      ? e || (this.selectionChanged = !1)
      : ((Mi.ie && Mi.ie_version <= 11) || (Mi.android && Mi.chrome)) &&
          !i.state.selection.main.empty &&
          n.focusNode &&
          ei(n.focusNode, n.focusOffset, n.anchorNode, n.anchorOffset)
        ? this.flushSoon()
        : this.flush(!1);
  }
  readSelectionRange() {
      ...
      e =
        (Mi.safari &&
          ...
          (function (t) {
            ...
            ei(a.node, a.offset, r, o) && ([n, s, r, o] = [r, o, n, s]);
    ...
    return i &&
      ...
      (function (t, e) {
        ...
        for (n = Math.min(n, si(i)); ; )
          if (n) {
            if (1 != i.nodeType) return !1;
            let t = i.childNodes[n - 1];
            'false' == t.contentEditable ? n-- : ((i = t), (n = si(i)));
          } else {
            if (i == t) return !0;
            ((n = ii(i)), (i = i.parentNode));
          }
      })(this.dom, e)
  ...
  start() {
    this.active ||
      (this.observer.observe(this.dom, Mr),
      _r && this.dom.addEventListener('DOMCharacterDataModified', this.onCharData),
      (this.active = !0));
  }
  stop() {
    this.active &&
      ...
      _r && this.dom.removeEventListener('DOMCharacterDataModified', this.onCharData));
  }
  clear() {
      ...
      let t = () => {
        ...
        if (t) {
          (this.clearDelayedAndroidKey(),
            ...
            !this.flush() && t.force && fi(this.dom, t.key, t.keyCode));
        }
      };
    ...
    (this.delayedAndroidKey && 'Enter' != t) ||
      (this.delayedAndroidKey = {
        ...
        force:
          ...
          !!(null === (i = this.delayedAndroidKey) || void 0 === i ? void 0 : i.force),
      });
  }
  ...
  readChange() {
    let { from: t, to: e, typeOver: i } = this.processRecords(),
      n = this.selectionChanged && Je(this.dom, this.selectionRange);
    if (t < 0 && !n) return null;
    (t > -1 && (this.lastChange = Date.now()),
      (this.view.inputState.lastFocusTime = 0),
      (this.selectionChanged = !1));
    let s = new Cr(this.view, t, e, i);
  ...
  setWindow(t) {
    t != this.win &&
      (this.removeWindowListeners(this.win), (this.win = t), this.addWindowListeners(this.win));
  }
...
class Vr {
  ...
  constructor(t = {}) {
    ...
    ((this.dispatchTransactions =
      ...
      (this._root =
        ...
        document),
      (this.viewState = new Or(t.state || be.create(t))),
      t.scrollTo &&
        t.scrollTo.is(Yn) &&
        (this.viewState.scrollTarget = t.scrollTo.value.clip(this.viewState.state)),
      (this.plugins = this.state.facet(En).map((t) => new Wn(t))));
    for (let t of this.plugins) t.update(this);
    ((this.observer = new Yr(this)),
      (this.inputState = new ws(this)),
      this.inputState.ensureHandlers(this.plugins),
      (this.docView = new es(this)),
      this.mountStyles(),
      this.updateAttrs(),
      (this.updateState = 0),
      this.requestMeasure());
  ...
  update(t) {
    ...
    let r = this.hasFocus,
      o = 0,
      a = null;
    t.some((t) => t.annotation(js))
      ? ((this.inputState.notifiedFocused = r), (o = 1))
      : r != this.inputState.notifiedFocused &&
        ((this.inputState.notifiedFocused = r), (a = Ls(s, r)), a || (o = 1));
    ...
    if (
      (l
        ...
        : this.observer.clear(),
      s.facet(be.phrases) != this.state.facet(be.phrases))
    )
      return this.setState(s);
    ((e = ts.create(this, s, t)), (e.flags |= o));
    ...
    try {
      ...
      for (let e of t) {
        if ((c && (c = c.map(e.changes)), e.scrollIntoView)) {
          ...
          c = new _n(t.empty ? t : Zt.cursor(t.head, t.head > t.anchor ? -1 : 1));
        }
        for (let t of e.effects) t.is(Yn) && (c = t.value.clip(this.state));
      }
      (this.viewState.update(e, c),
        (this.bidiCache = Dr.update(this.bidiCache, e.changes)),
        e.empty || (this.updatePlugins(e), this.inputState.update(e)),
        (i = this.docView.update(e)),
        this.state.facet(Kn) != this.styleModules && this.mountStyles(),
        (n = this.updateAttrs()),
    ...
    if (
      (e.startState.facet(wr) != e.state.facet(wr) && (this.viewState.mustMeasureContent = !0),
      (i || n || c || this.viewState.mustEnforceCursorAssoc || this.viewState.mustMeasureContent) &&
        this.requestMeasure(),
      !e.empty)
    )
      for (let t of this.state.facet(Xn))
        try {
          t(e);
        } catch (t) {
          zn(this.state, t, 'update listener');
        }
    (a || h) &&
      Promise.resolve().then(() => {
        (a && this.state == a.startState && this.dispatch(a),
          h && !Rr(this, h) && l.force && fi(this.contentDOM, l.key, l.keyCode));
      });
  }
  setState(t) {
    if (0 != this.updateState)
    ...
    try {
      ...
      ((this.viewState = new Or(t)),
        (this.plugins = t.facet(En).map((t) => new Wn(t))),
  ...
  updatePlugins(t) {
    let e = t.startState.facet(En),
      i = t.state.facet(En);
    if (e != i) {
      let n = [];
      for (let s of i) {
        let i = e.indexOf(s);
        if (i < 0) n.push(new Wn(s));
        else {
  ...
  measure(t = !0) {
    ...
    try {
      for (let t = 0; ; t++) {
        if (r < 0)
          if (pi(i)) ((s = -1), (r = this.viewState.heightMap.height));
          else {
        ...
        let l = a.map((t) => {
            try {
              ...
              return (zn(this.state, t), Er);
            }
          }),
          h = ts.create(this, this.state, []),
          c = !1;
        ((h.flags |= o),
          e ? (e.flags |= o) : (e = h),
          (this.updateState = 2),
        ...
        if (
          ...
          if (this.viewState.editorHeight) {
            ...
            {
              let t =
                (s < 0 ? this.viewState.heightMap.height : this.viewState.lineBlockAt(s).top) - r;
              if (t > 1 || t < -1) {
                ((n += t), (i.scrollTop = n / this.scaleY), (r = -1));
                continue;
              }
            }
          }
    ...
    if (e && !e.empty) for (let t of this.state.facet(Xn)) t(e);
  }
  get themeClasses() {
    return Sr + ' ' + (this.state.facet(br) ? yr : vr) + ' ' + this.state.facet(wr);
  }
  updateAttrs() {
    let t = Wr(this, jn, {
      ...
      e = {
        ...
        class: 'cm-content',
        style: `${Mi.tabSize}: ${this.state.tabSize}`,
        role: 'textbox',
        'aria-multiline': 'true',
      };
    (this.state.readOnly && (e['aria-readonly'] = 'true'), Wr(this, Ln, e));
    let i = this.observer.ignore(() => {
      let i = Gi(this.contentDOM, this.contentAttrs, e),
        n = Gi(this.dom, this.editorAttrs, t);
      return i || n;
    });
  ...
  mountStyles() {
    this.styleModules = this.state.facet(Kn);
    let t = this.state.facet(Vr.cspNonce);
    We.mount(this.root, this.styleModules.concat($r).reverse(), t ? { nonce: t } : void 0);
  }
  readMeasured() {
  ...
  moveByChar(t, e, i) {
    return Qs(this, t, ms(this, t, e, i));
  }
  moveByGroup(t, e) {
    return Qs(
      this,
  ...
  visualLineSide(t, e) {
    let i = this.bidiSpans(t),
      ...
      s = i[e ? i.length - 1 : 0];
    return Zt.cursor(s.side(e, n) + t.from, s.forward(!e, n) ? 1 : -1);
  }
  moveToLineBoundary(t, e, i = !0) {
    return (function (t, e, i, n) {
      let s = ps(t, e.head),
        r =
          n && s.type == Fi.Text && (t.lineWrapping || s.widgetLineBreaks)
            ? t.coordsAtPos(e.assoc < 0 && e.head > s.from ? e.head - 1 : e.head)
            : null;
      if (r) {
        let e = t.dom.getBoundingClientRect(),
          n = t.textDirectionAt(s.from),
          o = t.posAtCoords({
            x: i == (n == an.LTR) ? e.right - 1 : e.left + 1,
            y: (r.top + r.bottom) / 2,
          });
        if (null != o) return Zt.cursor(o, i ? -1 : 1);
      }
      return Zt.cursor(i ? s.to : s.from, i ? -1 : 1);
    })(this, t, e, i);
  }
  moveVertically(t, e, i) {
    return Qs(
      ...
      (function (t, e, i, n) {
        let s = e.head,
          r = i ? 1 : -1;
        if (s == (i ? t.state.doc.length : 0)) return Zt.cursor(s, e.assoc);
        let o,
          a = e.goalColumn,
          l = t.contentDOM.getBoundingClientRect(),
          h = t.coordsAtPos(s, e.assoc || -1),
          c = t.documentTop;
        ...
        for (let e = 0; ; e += 10) {
          let i = o + (u + e) * r,
            n = fs(t, { x: O, y: i }, !1, r);
          if (i < l.top || i > l.bottom || (r < 0 ? n < s : n > s)) {
            let e = t.docView.coordsForChar(n),
              s = !e || i < e.top ? -1 : 1;
            return Zt.cursor(n, s, void 0, a);
          }
        }
      })(this, t, e, i),
    );
  ...
  coordsAtPos(t, e = 1) {
    ...
    let n = this.state.doc.lineAt(t),
      s = this.bidiSpans(n);
    return ri(i, (s[gn.find(s, t - n.from, -1, e)].dir == an.LTR) == e > 0);
  }
  coordsForChar(t) {
  ...
  textDirectionAt(t) {
    return !this.state.facet(Rn) || t < this.viewport.from || t > this.viewport.to
      ? this.textDirection
  ...
  bidiSpans(t) {
    if (t.length > qr) return vn(t.length);
    let e,
      i = this.textDirectionAt(t.from);
    for (let n of this.bidiCache)
      if (n.from == t.from && n.dir == i && (n.fresh || Qn(n.isolates, (e = Un(this, t)))))
        return n.order;
    e || (e = Un(this, t));
    let n = (function (t, e, i) {
      if (!t) return [new gn(0, 0, e == hn ? 1 : 0)];
      if (e == ln && !i.length && !mn.test(t)) return vn(t.length);
      if (i.length) for (; t.length > wn.length; ) wn[wn.length] = 256;
      let n = [],
        s = e == ln ? 0 : 1;
      return (Sn(t, s, s, i, 0, t.length, n), n);
    })(t.text, i, e);
    return (this.bidiCache.push(new Dr(t.from, t.to, i, e, !0, n)), n);
  }
  get hasFocus() {
    var t;
    return (
      (this.dom.ownerDocument.hasFocus() ||
        (Mi.safari &&
          (null === (t = this.inputState) || void 0 === t ? void 0 : t.lastContextMenu) >
            Date.now() - 3e4)) &&
  ...
  focus() {
    this.observer.ignore(() => {
      (Oi(this.contentDOM), this.docView.updateSelection());
    });
  }
  setRoot(t) {
    this._root != t &&
  ...
  static scrollIntoView(t, e = {}) {
    return Yn.of(new _n('number' == typeof t ? Zt.cursor(t) : t, e.y, e.x, e.yMargin, e.xMargin));
  }
  scrollSnapshot() {
    let { scrollTop: t, scrollLeft: e } = this.scrollDOM,
      i = this.viewState.scrollAnchorAt(t);
    return Yn.of(new _n(Zt.cursor(i.from), 'start', 'start', i.top - t, e, !0));
  }
  static domEventHandlers(t) {
    return Dn.define(() => ({}), { eventHandlers: t });
  }
  static domEventObservers(t) {
    return Dn.define(() => ({}), { eventObservers: t });
  }
  static theme(t, e) {
    let i = We.newName(),
      n = [wr.of(i), Kn.of(kr(`.${i}`, t))];
    return (e && e.dark && n.push(br.of(!0)), n);
  }
  static baseTheme(t) {
    return Gt.lowest(Kn.of(kr('.' + Sr, t, xr)));
  }
  static findFromDOM(t) {
    var e;
    let i = t.querySelector('.cm-content'),
      n = (i && Qi.get(i)) || Qi.get(t);
    return (
      (null === (e = null == n ? void 0 : n.rootView) || void 0 === e ? void 0 : e.view) || null
    );
  }
}
((Vr.styleModule = Kn),
  (Vr.inputHandler = An),
  (Vr.focusChangeEffect = Cn),
  (Vr.perLineTextDirection = Rn),
  (Vr.exceptionSink = Zn),
  (Vr.updateListener = Xn),
  (Vr.editable = Vn),
  (Vr.mouseSelectionStyle = Tn),
  (Vr.dragMovesSelection = Pn),
  (Vr.clickAddsSelectionRange = $n),
  (Vr.decorations = Gn),
  (Vr.outerDecorations = Bn),
  (Vr.atomicRanges = In),
  (Vr.bidiIsolatedRanges = Nn),
  (Vr.scrollMargins = Fn),
  (Vr.darkTheme = br),
  (Vr.cspNonce = Ct.define({ combine: (t) => (t.length ? t[0] : '') })),
  (Vr.contentAttributes = Ln),
  (Vr.editorAttributes = jn),
  (Vr.lineWrapping = Vr.contentAttributes.of({ class: 'cm-lineWrapping' })),
  (Vr.announce = le.define()));
const qr = 4096,
  Er = {};
class Dr {
  constructor(t, e, i, n, s, r) {
  ...
  static update(t, e) {
    ...
    let i = [],
      n = t.length ? t[t.length - 1].dir : an.LTR;
    for (let s = Math.max(0, t.length - 10); s < t.length; s++) {
      let r = t[s];
      r.dir != n ||
        e.touchesRange(r.from, r.to) ||
        i.push(new Dr(e.mapPos(r.from, 1), e.mapPos(r.to, -1), r.dir, r.isolates, !1, r.order));
    }
    return i;
  }
}
...
const jr = Mi.mac ? 'mac' : Mi.windows ? 'win' : Mi.linux ? 'linux' : 'key';
function Lr(t, e, i) {
  return (
    e.altKey && (t = 'Alt-' + t),
    e.ctrlKey && (t = 'Ctrl-' + t),
...
const Gr = Gt.default(
      ...
      keydown: (t, e) =>
        (function (t, e, i, n) {
          let s = (function (t) {
              var e =
                (!(
                  (Ie && t.metaKey && t.shiftKey && !t.ctrlKey && !t.altKey) ||
                  (Ne && t.shiftKey && t.key && 1 == t.key.length) ||
                  'Unidentified' == t.key
                ) &&
                  t.key) ||
                (t.shiftKey ? Be : Ge)[t.keyCode] ||
                t.key ||
                'Unidentified';
              return (
                'Esc' == e && (e = 'Escape'),
          ...
          Nr &&
            Nr.view == i &&
            Nr.scope == n &&
            ((a = Nr.prefix + ' '), xs.indexOf(e.keyCode) < 0 && ((h = !0), (Nr = null)));
          let O,
            u,
            f = new Set(),
            d = (t) => {
              if (t) {
                for (let n of t.run)
                  if (!f.has(n) && (f.add(n), n(i, e))) return (t.stopPropagation && (c = !0), !0);
                t.preventDefault && (t.stopPropagation && (c = !0), (h = !0));
              }
              return !1;
            },
            p = t[n];
          p &&
            (d(p[a + Lr(s, e, !o)])
              ...
              : o &&
                  ...
                  !(Mi.windows && e.ctrlKey && e.altKey) &&
                  (O = Ge[e.keyCode]) &&
                  O != s
                ? (d(p[a + Lr(O, e, !0)]) ||
                    (e.shiftKey && (u = Be[e.keyCode]) != s && u != O && d(p[a + Lr(u, e, !1)]))) &&
                  (l = !0)
                : o && e.shiftKey && d(p[a + Lr(s, e, !0)]) && (l = !0),
            !l && d(p._any) && (l = !0));
          h && (l = !0);
                    ...
                    r = (t, n, r, o, a) => {
                        ...
                        (s(i, !0),
                          c[i] ||
                            (c[i] = {
                              ...
                              run: [
                                (e) => {
                                  let n = (Nr = { view: e, prefix: i, scope: t });
                                  return (
                                    setTimeout(() => {
                                      Nr == n && (Nr = null);
                                    }, Ur),
                      ...
                      let f =
                        ...
                        (c[u] = {
                          ...
                          run:
                            (null ===
                              (h = null === (l = c._any) || void 0 === l ? void 0 : l.run) ||
                            void 0 === h
                              ? void 0
                              : h.slice()) || [],
                        });
                    ...
                    if (s)
                      for (let e of t)
                        (r(e, s, n.run, n.preventDefault, n.stopPropagation),
                          n.shift &&
                            r(e, 'Shift-' + s, n.shift, n.preventDefault, n.stopPropagation));
                  }
                  return i;
  ...
  Br = Ct.define({ enables: Gr }),
  Ir = new WeakMap();
let Nr = null;
const Ur = 4e3;
class Fr {
  constructor(t, e, i, n, s) {
    ((this.className = t), (this.left = e), (this.top = i), (this.width = n), (this.height = s));
  }
  draw() {
    let t = document.createElement('div');
  ...
  static forRange(t, e, i) {
    if (i.empty) {
      ...
      if (!n) return [];
      let s = Hr(t);
      return [new Fr(e, n.left - s.left, n.top - s.top, null, n.bottom - n.top)];
    }
    return (function (t, e, i) {
      if (i.to <= t.viewport.from || i.from >= t.viewport.to) return [];
      let n = Math.max(i.from, t.viewport.from),
        s = Math.min(i.to, t.viewport.to),
        r = t.textDirection == an.LTR,
        o = t.contentDOM,
        a = o.getBoundingClientRect(),
        l = Hr(t),
        h = o.querySelector('.cm-line'),
        c = h && globalThis.getComputedStyle(h),
        O = a.left + (c ? parseInt(c.paddingLeft) + Math.min(0, parseInt(c.textIndent)) : 0),
        u = a.right - (c ? parseInt(c.paddingRight) : 0),
        f = ps(t, n),
        d = ps(t, s),
        p = f.type == Fi.Text ? f : null,
        m = d.type == Fi.Text ? d : null;
      p && (t.lineWrapping || f.widgetLineBreaks) && (p = Kr(t, n, p));
      m && (t.lineWrapping || d.widgetLineBreaks) && (m = Kr(t, s, m));
      if (p && m && p.from == m.from) return Q(w(i.from, i.to, p));
      {
        let e = p ? w(i.from, null, p) : b(f, !1),
          n = m ? w(null, i.to, m) : b(d, !0),
          s = [];
        return (
          (p || f).to < (m || d).from - (p && m ? 1 : 0) ||
          (f.widgetLineBreaks > 1 && e.bottom + t.defaultLineHeight / 2 < n.top)
            ? s.push(g(O, e.bottom, u, n.top))
            : e.bottom < n.top &&
              t.elementAtHeight((e.bottom + n.top) / 2).type == Fi.Text &&
              (e.bottom = n.top = (e.bottom + n.top) / 2),
          Q(e).concat(s).concat(Q(n))
        );
      }
      function g(t, i, n, s) {
        return new Fr(e, t - l.left, i - l.top - 0.01, n - t, s - i + 0.01);
      }
      function Q({ top: t, bottom: e, horizontal: i }) {
        let n = [];
      ...
      function w(e, i, n) {
        ...
        function l(e, i, l, h, c) {
          ...
          f &&
            d &&
            ((s = Math.min(f.top, d.top, s)),
            (o = Math.max(f.bottom, d.bottom, o)),
            c == an.LTR
              ? a.push(r && i ? O : f.left, r && h ? u : d.right)
              : a.push(!r && h ? O : d.left, !r && i ? u : f.right));
        }
        let h = null != e ? e : n.from,
          c = null != i ? i : n.to;
        for (let n of t.visibleRanges)
          if (n.to > h && n.from < c)
            for (let s = Math.max(n.from, h), r = Math.min(n.to, c); ; ) {
        ...
        return (
          0 == a.length && l(h, null == e, c, null == i, t.textDirection),
...
function Hr(t) {
  ...
  return {
    left:
      (t.textDirection == an.LTR ? e.left : e.right - t.scrollDOM.clientWidth * t.scaleX) -
...
class Jr {
  ...
  update(t) {
    (t.startState.facet(to) != t.state.facet(to) && this.setOrder(t.state),
  ...
  draw(t) {
    if (
      ...
      t.some((t, e) => {
        return ((i = t), (n = this.drawn[e]), !(i.constructor == n.constructor && i.eq(n)));
        var i, n;
      })
    ) {
      let e = this.dom.firstChild,
        i = 0;
      for (let n of t)
        n.update && e && n.constructor && this.drawn[i].constructor && n.update(e, this.drawn[i])
          ? ((e = e.nextSibling), i++)
...
const to = Ct.define();
function eo(t) {
  return [Dn.define((e) => new Jr(e, t)), to.of(t)];
}
const io = !Mi.ios,
  no = Ct.define({
    combine: (t) =>
...
function so(t = {}) {
  return [no.of(t), oo, lo, co, Mn.of(!0)];
}
function ro(t) {
  return t.startState.facet(no) != t.state.facet(no);
}
const oo = eo({
  above: !0,
  markers(t) {
    ...
    for (let s of e.selection.ranges) {
      ...
      if (s.empty ? !r || io : i.drawRangeCursor) {
        let e = r ? 'cm-cursor cm-cursor-primary' : 'cm-cursor cm-cursor-secondary',
          i = s.empty ? s : Zt.cursor(s.head, s.head > s.anchor ? -1 : 1);
        for (let s of Fr.forRange(t, e, i)) n.push(s);
      }
    }
    return n;
  },
  update(t, e) {
    t.transactions.some((t) => t.selection) &&
      (e.style.animationName = 'cm-blink' == e.style.animationName ? 'cm-blink2' : 'cm-blink');
    let i = ro(t);
    return (i && ao(t.state, e), t.docChanged || t.selectionSet || i);
  },
  mount(t, e) {
    ao(e.state, t);
  },
...
function ao(t, e) {
  e.style.animationDuration = t.facet(no).cursorBlinkRate + 'ms';
}
const lo = eo({
    above: !1,
    markers: (t) =>
      t.state.selection.ranges
        .map((e) => (e.empty ? [] : Fr.forRange(t, 'cm-selectionBackground', e)))
        .reduce((t, e) => t.concat(e)),
    update: (t, e) => t.docChanged || t.selectionSet || t.viewportChanged || ro(t),
...
io &&
  ((ho['.cm-line'].caretColor = 'transparent !important'),
  (ho['.cm-content'] = { caretColor: 'transparent !important' }));
const co = Gt.highest(Vr.theme(ho));
...
class uo {
  ...
  createDeco(t) {
    ...
    for (let { from: e, to: n } of (function (t, e) {
      ...
      Oo(t.state.doc, this.regexp, e, n, (e, n) => this.addMatch(n, t, e, i));
    return e.finish();
  }
  updateDeco(t, e) {
    let i = 1e9,
  ...
  updateRange(t, e, i, n) {
    for (let s of t.visibleRanges) {
      ...
      if (o > r) {
        ...
        else Oo(t.state.doc, this.regexp, a, l, (e, i) => this.addMatch(i, t, e, O));
...
const Qo = Ct.define({
  combine(t) {
    let e = Se(t, { render: null, specialChars: po, addSpecialChars: null });
    return (
      (e.replaceTabs = !(function () {
        var t;
        if (null == go && 'undefined' != typeof document && document.body) {
          let e = document.body.style;
          go = null != (null !== (t = e.tabSize) && void 0 !== t ? t : e.MozTabSize);
        }
        return go || !1;
      })()) && (e.specialChars = new RegExp('\t|' + e.specialChars.source, fo)),
      e.addSpecialChars &&
        (e.specialChars = new RegExp(e.specialChars.source + '|' + e.addSpecialChars.source, fo)),
      e
    );
  },
});
            ...
            return new uo({
              ...
              decoration: (e, i, n) => {
                ...
                if (9 == r) {
                  let t = s.lineAt(n),
                    e = i.state.tabSize,
                    r = Ve(t.text, e, n - t.from);
                  return Hi.replace({
                    widget: new vo(
                      ((e - (r % e)) * this.view.defaultCharacterWidth) / this.view.scaleX,
                    ),
                  });
                }
                return (
                  this.decorationCache[r] ||
                  (this.decorationCache[r] = Hi.replace({ widget: new So(t, r) }))
                );
              },
  ...
  toDOM(t) {
    let e = (function (t) {
      ...
      i =
        ...
        ' ' +
        (mo[this.code] || '0x' + this.code.toString(16)),
...
const yo = Dn.fromClass(
  class {
    ...
    update(t) {
      ...
      i >= 0 &&
        i != this.height &&
        ((this.height = i), (this.attrs = { style: `padding-bottom: ${i}px` }));
    }
  },
);
function xo() {
  return [
    ...
    Ln.of((t) => {
      var e;
      return (null === (e = t.plugin(yo)) || void 0 === e ? void 0 : e.attrs) || null;
    }),
  ];
}
class ko extends Ui {
  ...
  toDOM() {
    ...
    return (
      ...
      t.appendChild(
        'string' == typeof this.content ? document.createTextNode(this.content) : this.content,
      ),
  ...
  coordsAt(t) {
    let e = t.firstChild ? ti(t.firstChild) : [];
    if (!e.length) return null;
    let i = globalThis.getComputedStyle(t.parentNode),
      n = ri(e[0], 'rtl' != i.direction),
  ...
  return Dn.fromClass(
    class {
      constructor(e) {
        ((this.view = e),
          (this.placeholder = t
            ? Hi.set([Hi.widget({ widget: new ko(t), side: 1 }).range(0)])
            : Hi.none));
      }
      get decorations() {
        return this.view.state.doc.length ? Hi.none : this.placeholder;
      }
    },
    { decorations: (t) => t.decorations },
  );
  ...
  update(t, e) {
    ...
    for (let i = 0; i < s.length; i++) {
      ...
      if (n) {
        ...
        if (a < 0) ((r[i] = this.createTooltipView(n)), o && (o[i] = !!n.above));
        else {
          let n = (r[i] = this.tooltipViews[a]);
          (o && (o[i] = e[a]), n.update && n.update(t));
        }
      }
    }
    for (let t of this.tooltipViews)
      r.indexOf(t) < 0 && (t.dom.remove(), null === (i = t.destroy) || void 0 === i || i.call(t));
    return (
...
const Ao = Ct.define({
    combine: (t) => {
      ...
      return {
        position: Mi.ios
          ? 'absolute'
          : (null === (e = t.find((t) => t.position)) || void 0 === e ? void 0 : e.position) ||
            'fixed',
        parent:
          (null === (i = t.find((t) => t.parent)) || void 0 === i ? void 0 : i.parent) || null,
        tooltipSpace:
    ...
    class {
      constructor(t) {
        ...
        ((this.position = e.position),
          ...
          (this.manager = new To(t, Yo, (t) => this.createTooltip(t))),
      ...
      destroy() {
        ...
        for (let e of this.manager.tooltipViews)
          (e.dom.remove(), null === (t = e.destroy) || void 0 === t || t.call(e));
        (this.parent && this.container.remove(),
      ...
      readMeasure() {
        ...
        if ('fixed' == this.position && this.manager.tooltipViews.length) {
          ...
          if (Mi.gecko) n = t.offsetParent != this.container.ownerDocument.body;
          else if (t.style.top == Po && '0px' == t.style.left) {
        ...
        if (n || 'absolute' == this.position)
          if (this.parent) {
            ...
            t.width &&
              t.height &&
              ((e = t.width / this.parent.offsetWidth), (i = t.height / this.parent.offsetHeight));
      ...
      writeMeasure(t) {
        ...
        let { editor: i, space: n, scaleX: s, scaleY: r } = t,
          o = [];
        for (let a = 0; a < this.manager.tooltips.length; a++) {
          ...
          if (
            !O ||
            O.bottom <= Math.max(i.top, n.top) ||
            O.top >= Math.min(i.bottom, n.bottom) ||
            O.right < Math.max(i.left, n.left) - 0.1 ||
            O.left > Math.min(i.right, n.right) + 0.1
          ) {
            c.style.top = Po;
            continue;
          }
          let f = l.arrow ? h.dom.querySelector('.cm-tooltip-arrow') : null,
            d = f ? 7 : 0,
            p = u.right - u.left,
            m = null !== (e = Co.get(h)) && void 0 !== e ? e : u.bottom - u.top,
            g = h.offset || _o,
            Q = this.view.textDirection == an.LTR,
            w =
              u.width > n.right - n.left
                ? Q
                  ...
                  : n.right - u.width
                : Q
                  ? Math.min(O.left - (f ? 14 : 0) + g.x, n.right - p)
                  : Math.max(n.left, O.left - p + (f ? 14 : 0) - g.x),
            b = this.above[a];
          !l.strictSide &&
            (b
              ? O.top - (u.bottom - u.top) - g.y < n.top
              : O.bottom + (u.bottom - u.top) + g.y > n.bottom) &&
            b == n.bottom - O.bottom > O.top - n.top &&
            (b = this.above[a] = !b);
          let S = (b ? O.top - n.top : n.bottom - O.bottom) - d;
          if (S < m && !1 !== h.resize) {
            if (S < this.view.defaultLineHeight) {
              c.style.top = Po;
              continue;
            }
            (Co.set(h, m), (c.style.height = (m = S) / r + 'px'));
          } else c.style.height && (c.style.height = '');
          let v = b ? O.top - m - d - g.y : O.bottom + d + g.y,
            y = w + p;
          if (!0 !== h.overlap)
            for (let t of o)
              t.left < y &&
                ...
                t.top < v + m &&
                t.bottom > v &&
                (v = b ? t.top - m - 2 - d : t.bottom + d + 2);
          if (
            ('absolute' == this.position
              ? ((c.style.top = (v - t.parent.top) / r + 'px'),
                (c.style.left = (w - t.parent.left) / s + 'px'))
              : ((c.style.top = v / r + 'px'), (c.style.left = w / s + 'px')),
            f)
          ) {
            let t = O.left + (Q ? g.x : -g.x) - (w + 14 - 7);
            f.style.left = t / s + 'px';
          }
          (!0 !== h.overlap && o.push({ left: w, top: v, right: y, bottom: v + m }),
      ...
      maybeMeasure() {
        if (
          ...
          for (let t of this.manager.tooltipViews) t.dom.style.top = Po;
      }
    },
    {
      eventObservers: {
...
const qo = Ct.define({
  ...
  Eo = Dn.fromClass(
    class {
      constructor(t) {
        ((this.input = t.state.facet(jo)),
          (this.specs = this.input.filter((t) => t)),
          (this.panels = this.specs.map((e) => e(t))));
        let e = t.state.facet(qo);
        ((this.top = new Do(t, !0, e.topContainer)),
          (this.bottom = new Do(t, !1, e.bottomContainer)),
      ...
      update(t) {
        ...
        (this.top.container != e.topContainer &&
          (this.top.sync([]), (this.top = new Do(t.view, !0, e.topContainer))),
          this.bottom.container != e.bottomContainer &&
            (this.bottom.sync([]), (this.bottom = new Do(t.view, !1, e.bottomContainer))),
          this.top.syncClasses(),
          this.bottom.syncClasses());
        let i = t.state.facet(jo);
        if (i != this.input) {
          let e = i.filter((t) => t),
            n = [],
            s = [],
...
((Lo.prototype.elementClass = ''),
  (Lo.prototype.toDOM = void 0),
  (Lo.prototype.mapMode = wt.TrackBefore),
  (Lo.prototype.startSide = Lo.prototype.endSide = -1),
...
const Go = Ct.define(),
  ...
  Io = Ct.define();
function No(t) {
  return [Fo(), Io.of(Object.assign(Object.assign({}, Bo), t))];
}
const Uo = Ct.define({ combine: (t) => t.some((t) => t) });
function Fo(t) {
  let e = [Ho];
  return (t && !1 === t.fixed && e.push(Uo.of(!0)), e);
}
const Ho = Dn.fromClass(
  class {
    constructor(t) {
      ((this.view = t),
        ...
        (this.gutters = t.state.facet(Io).map((e) => new ea(t, e))));
      for (let t of this.gutters) this.dom.appendChild(t.dom);
      ((this.fixed = !t.state.facet(Uo)),
    ...
    update(t) {
      ...
      (t.geometryChanged && (this.dom.style.minHeight = this.view.contentHeight + 'px'),
        this.view.state.facet(Uo) != !this.fixed &&
    ...
    syncGutters(t) {
      ...
      t && this.dom.remove();
      let i = $e.iter(this.view.state.facet(Go), this.view.viewport.from),
        n = [],
        s = this.gutters.map((t) => new ta(t, this.view.viewport, -this.view.documentPadding.top));
...
class ta {
  constructor(t, e, i) {
    ((this.gutter = t),
      (this.height = i),
      (this.i = 0),
      (this.cursor = $e.iter(t.markers, e.from)));
  }
  addElement(t, e, i) {
    let { gutter: n } = this,
  ...
  line(t, e, i) {
    let n = [];
    (Jo(this.cursor, n, e.from), i.length && (n = n.concat(i)));
    let s = this.gutter.config.lineMarker(t, e, n);
    s && n.unshift(s);
    let r = this.gutter;
    (0 != n.length || r.config.renderEmptyElements) && this.addElement(t, e, n);
  }
  widget(t, e) {
...
class ea {
  constructor(t, e) {
    ...
    ((this.markers = Ko(e.markers(t))),
      e.initialSpacer &&
        ((this.spacer = new ia(t, 0, 0, [e.initialSpacer(t)])),
  ...
  update(t) {
    let e = this.markers;
    if (
      ((this.markers = Ko(this.config.markers(t.view))), this.spacer && this.config.updateSpacer)
    ) {
    ...
    return (
      !$e.eq(this.markers, e, i.from, i.to) ||
...
const aa = Io.compute([sa], (t) => ({
  class: 'cm-lineNumbers',
  renderEmptyElements: !1,
  markers: (t) => t.state.facet(na),
  lineMarker: (t, e, i) =>
    i.some((t) => t.toDOM) ? null : new ra(oa(t, t.state.doc.lineAt(e.from).number)),
  widgetMarker: () => null,
  lineMarkerChange: (t) => t.startState.facet(sa) != t.state.facet(sa),
  initialSpacer: (t) => new ra(oa(t, ha(t.state.doc.lines))),
  updateSpacer(t, e) {
    let i = oa(e.view, ha(e.view.state.doc.lines));
    return i == t.number ? t : new ra(i);
  },
  domEventHandlers: t.facet(sa).domEventHandlers,
}));
function la(t = {}) {
  return [sa.of(t), Fo(), aa];
}
function ha(t) {
  let e = 9;
  for (; e < t; ) e = 10 * e + 9;
...
class Oa {
  constructor(t, e, i, n) {
    ((this.name = t), (this.set = e), (this.base = i), (this.modified = n), (this.id = ca++));
  }
  toString() {
    let { name: t } = this;
  ...
  static define(t, e) {
    ...
    if ((t instanceof Oa && (e = t), null == e ? void 0 : e.base))
...
class fa {
  constructor(t) {
    ((this.name = t), (this.instances = []), (this.id = ua++));
  }
  static get(t, e) {
    if (!e.length) return t;
    let i = e[0].instances.find((i) => {
      return (
        i.base == t &&
        ((n = e), (s = i.modified), n.length == s.length && n.every((t, e) => t == s[e]))
      );
      var n, s;
    });
    if (i) return i;
    let n = [],
      s = new Oa(t.name, n, t, e);
    ...
    for (let e of t.set) if (!e.modified.length) for (let t of r) n.push(fa.get(e, t));
    return s;
  }
}
function da(t) {
    ...
    for (let t of i.split(' '))
      if (t) {
        ...
        for (let e = 0; ; ) {
          ...
          if (
            (i.push('*' == n[0] ? '' : '"' == n[0][0] ? JSON.parse(n[0]) : n[0]),
            (e += n[0].length),
            e == t.length)
          )
            break;
        ...
        let l = new ma(n, s, o > 0 ? i.slice(0, o) : null);
        e[a] = l.sort(e[a]);
      }
  }
  return pa.add(e);
...
function Qa(t, e, i, n = 0, s = t.length) {
  let r = new wa(n, Array.isArray(e) ? e : [e], i);
...
class wa {
  ...
  highlightRange(t, e, i, s, r) {
    ...
    if (u && u.overlay) {
      let n = t.node.enter(u.overlay[0].from + a, 1),
        o = this.highlighters.filter((t) => !t.scope || t.scope(u.tree.type)),
        c = t.firstChild();
      for (let O = 0, f = a; ; O++) {
        let d = O < u.overlay.length ? u.overlay[O] : null,
          p = d ? d.from + a : l,
          m = Math.max(e, f),
          g = Math.min(i, p);
        if (m < g && c)
          for (
            ;
            t.from < g &&
            (this.highlightRange(t, m, g, s, r),
            this.startSpan(Math.min(g, t.to), h),
            !(t.to >= p) && t.nextSibling());
          );
        if (!d || p > i) break;
        ((f = d.to + a),
          f > e &&
            (this.highlightRange(n.cursor(), Math.max(e, d.from + a), Math.min(i, f), '', o),
...
const ba = Oa.define,
  ...
  _a = {
    ...
    unit: ba(Xa),
    modifier: ba(Xa),
    operatorKeyword: ba(Xa),
    controlKeyword: ba(Xa),
    definitionKeyword: ba(Xa),
    moduleKeyword: ba(Xa),
    operator: Aa,
    derefOperator: ba(Aa),
    arithmeticOperator: ba(Aa),
    logicOperator: ba(Aa),
    bitwiseOperator: ba(Aa),
    compareOperator: ba(Aa),
    updateOperator: ba(Aa),
    definitionOperator: ba(Aa),
    typeOperator: ba(Aa),
    controlOperator: ba(Aa),
    punctuation: Ca,
    separator: ba(Ca),
    bracket: Ra,
    angleBracket: ba(Ra),
    ...
    documentMeta: ba(Ma),
    annotation: ba(Ma),
    processingInstruction: ba(Ma),
    definition: Oa.defineModifier('definition'),
    constant: Oa.defineModifier('constant'),
    function: Oa.defineModifier('function'),
    standard: Oa.defineModifier('standard'),
    local: Oa.defineModifier('local'),
    special: Oa.defineModifier('special'),
  };
for (let t in _a) {
  let e = _a[t];
  e instanceof Oa && (e.name = t);
}
var Ya;
ga([
  { tag: _a.link, class: 'tok-link' },
  { tag: _a.heading, class: 'tok-heading' },
  { tag: _a.emphasis, class: 'tok-emphasis' },
  { tag: _a.strong, class: 'tok-strong' },
  { tag: _a.keyword, class: 'tok-keyword' },
  { tag: _a.atom, class: 'tok-atom' },
  { tag: _a.bool, class: 'tok-bool' },
  { tag: _a.url, class: 'tok-url' },
  { tag: _a.labelName, class: 'tok-labelName' },
  { tag: _a.inserted, class: 'tok-inserted' },
  { tag: _a.deleted, class: 'tok-deleted' },
  { tag: _a.literal, class: 'tok-literal' },
  { tag: _a.string, class: 'tok-string' },
  { tag: _a.number, class: 'tok-number' },
  { tag: [_a.regexp, _a.escape, _a.special(_a.string)], class: 'tok-string2' },
  { tag: _a.variableName, class: 'tok-variableName' },
  { tag: _a.local(_a.variableName), class: 'tok-variableName tok-local' },
  { tag: _a.definition(_a.variableName), class: 'tok-variableName tok-definition' },
  { tag: _a.special(_a.variableName), class: 'tok-variableName2' },
  { tag: _a.definition(_a.propertyName), class: 'tok-propertyName tok-definition' },
  { tag: _a.typeName, class: 'tok-typeName' },
  { tag: _a.namespace, class: 'tok-namespace' },
  { tag: _a.className, class: 'tok-className' },
  { tag: _a.macroName, class: 'tok-macroName' },
  { tag: _a.propertyName, class: 'tok-propertyName' },
  { tag: _a.operator, class: 'tok-operator' },
  { tag: _a.comment, class: 'tok-comment' },
  { tag: _a.meta, class: 'tok-meta' },
  { tag: _a.invalid, class: 'tok-invalid' },
  { tag: _a.punctuation, class: 'tok-punctuation' },
]);
const za = new n();
function Va(t) {
  return Ct.define({ combine: t ? (e) => e.concat(t) : void 0 });
}
const qa = new n();
class Ea {
  constructor(t, e, i = [], n = '') {
    ((this.data = t),
      (this.name = n),
      be.prototype.hasOwnProperty('tree') ||
        Object.defineProperty(be.prototype, 'tree', {
          get() {
            return ja(this);
          },
        }),
  ...
  isActiveAt(t, e, i = -1) {
    return Da(t, e, i).type.prop(za) == this.data;
  }
  findRegions(t) {
    let e = t.facet(el);
    ...
    let i = [],
      s = (t, e) => {
        if (t.prop(za) == this.data) return void i.push({ from: e, to: e + t.length });
        let r = t.prop(n.mounted);
        if (r) {
          if (r.tree.prop(za) == this.data) {
        ...
        for (let i = 0; i < t.children.length; i++) {
          let n = t.children[i];
          n instanceof O && s(n, t.positions[i] + e);
        }
      };
    return (s(ja(t), 0), i);
  }
...
function Da(t, e, i) {
  ...
  if (!n || n.allowsNesting)
    for (let t = s; t; t = t.enter(e, i, c.ExcludeBuffers)) t.type.isTop && (s = t);
  return s;
}
Ea.setState = le.define();
class Wa extends Ea {
  constructor(t, e, i) {
  ...
  static define(t) {
    ...
    return new Wa(
      e,
      t.parser.configure({ props: [za.add((t) => (t.isTop ? e : void 0))] }),
      t.name,
    );
  }
  configure(t, e) {
    return new Wa(this.data, this.parser.configure(t), e || this.name);
  }
  get allowsNesting() {
...
function ja(t) {
  let e = t.field(Ea.state, !1);
  return e ? e.tree : O.empty;
}
function La(t, e, i = 50) {
  var n;
  let s = null === (n = t.field(Ea.state, !1)) || void 0 === n ? void 0 : n.context;
  if (!s) return null;
  let r = s.viewport;
  s.updateViewport({ from: 0, to: e });
  let o = s.isDone(e) || s.work(i, e) ? s.tree : null;
  return (s.updateViewport(r), o);
}
function Ga(t, e = t.viewport.to, i = 100) {
  let n = La(t.state, e, i);
  return (n != ja(t.state) && t.dispatch({}), !!n);
}
function Ba(t) {
  var e;
  return (null === (e = t.plugin(tl)) || void 0 === e ? void 0 : e.isWorking()) || !1;
}
class Ia {
  constructor(t) {
...
class Ua {
  ...
  static create(t, e, i) {
    return new Ua(t, e, [], O.empty, 0, i, [], null);
  }
  startParse() {
    return this.parser.startParse(new Ia(this.state.doc), this.fragments);
  }
  work(t, e) {
    return (
      null != e && e >= this.state.doc.length && (e = void 0),
      this.tree != O.empty && this.isDone(null != e ? e : this.state.doc.length)
        ? (this.takeTree(), !0)
        : this.withContext(() => {
            var i;
            if ('number' == typeof t) {
              ...
              if (n) {
                if (
                  ((this.fragments = this.withoutTempSkipped(
                    X.addTree(n, this.fragments, null != this.parse.stoppedAt),
                  )),
                  (this.treeLen =
  ...
  takeTree() {
    ...
    this.parse &&
      ...
      (this.treeLen = t),
      (this.tree = e),
      (this.fragments = this.withoutTempSkipped(X.addTree(this.tree, this.fragments, !0))),
      (this.parse = null));
  }
  withContext(t) {
    let e = Na;
  ...
  withoutTempSkipped(t) {
    for (let e; (e = this.tempSkipped.pop()); ) t = Fa(t, e.from, e.to);
    return t;
  }
  changes(t, e) {
    ...
    return new Ua(this.parser, e, i, n, s, r, o, this.scheduleOn);
  }
  updateViewport(t) {
    ...
    for (let e = 0; e < this.skipped.length; e++) {
      ...
      i < t.to &&
        n > t.from &&
        ((this.fragments = Fa(this.fragments, i, n)), this.skipped.splice(e--, 1));
    }
      ...
      createParse(e, i, n) {
        ...
        return {
          ...
          advance() {
            ...
            return ((this.parsedPos = r), new O(o.none, [], [], r - s));
          },
          stoppedAt: null,
          stopAt() {},
        };
...
function Fa(t, e, i) {
  return X.applyChanges(t, [{ fromA: e, toA: i, fromB: e, toB: i }]);
}
class Ha {
  constructor(t) {
  ...
  apply(t) {
    ...
    return (e.work(20, i) || e.takeTree(), new Ha(e));
  }
  static init(t) {
    let e = Math.min(3e3, t.doc.length),
      i = Ua.create(t.facet(el).parser, t, { from: 0, to: e });
    return (i.work(20, e) || i.takeTree(), new Ha(i));
  }
}
Ea.state = qt.define({
  create: Ha.init,
  update(t, e) {
    for (let t of e.effects) if (t.is(Ea.setState)) return t.value;
    return e.startState.facet(el) != e.state.facet(el) ? Ha.init(e.state) : t.apply(e);
  },
});
let Ka = (t) => {
...
const Ja =
    'undefined' != typeof navigator &&
    (null === (Ya = navigator.scheduling) || void 0 === Ya ? void 0 : Ya.isInputPending)
  ...
  tl = Dn.fromClass(
    class {
      ...
      update(t) {
        let e = this.view.state.field(Ea.state).context;
        ((e.updateViewport(t.view.viewport) || this.view.viewport.to > e.treeLen) &&
          this.scheduleWork(),
      ...
      work(t) {
        ...
        let r =
            Date.now() +
            Math.min(this.chunkBudget, 100, t && !Ja ? Math.max(25, t.timeRemaining() - 5) : 1e9),
          o = s.context.treeLen < n && i.doc.length > n + 1e3,
          a = s.context.work(() => (Ja && Ja()) || Date.now() > r, n + (o ? 0 : 1e5));
        ((this.chunkBudget -= Date.now() - e),
          (a || this.chunkBudget <= 0) &&
            (s.context.takeTree(),
            this.view.dispatch({ effects: Ea.setState.of(new Ha(s.context)) })),
  ...
  el = Ct.define({
    ...
    enables: (t) => [
      Ea.state,
      tl,
      Vr.contentAttributes.compute([t], (e) => {
        let i = e.facet(t);
...
class nl {
  constructor(t, e, i, n, s, r = void 0) {
    ((this.name = t),
      (this.alias = e),
      (this.extensions = i),
      (this.filename = n),
    ...
    if (i)
      for (let i of t)
        for (let t of i.alias) {
          let n = e.indexOf(t);
          if (n > -1 && (t.length > 2 || (!/\w/.test(e[n - 1]) && !/\w/.test(e[n + t.length]))))
            return i;
        }
    return null;
  }
...
function ll(t, e) {
  t instanceof be && (t = new hl(t));
  for (let i of t.state.facet(sl)) {
    let n = i(t, e);
  ...
  return i.length >= e
    ? (function (t, e, i) {
        let n = e.resolveStack(i),
          s = n.node.enterUnfinishedNodesBefore(i);
        if (s != n.node) {
          let t = [];
          for (let e = s; e != n.node; e = e.parent) t.push(e);
          for (let e = t.length - 1; e >= 0; e--) n = { node: t[e], next: n };
        }
        return Ol(n, t, i);
      })(t, i, e)
    : null;
...
class hl {
  constructor(t, e = {}) {
    ((this.state = t), (this.options = e), (this.unit = ol(t)));
  }
  lineAt(t, e = 1) {
  ...
  countColumn(t, e = t.length) {
    return Ve(t, this.state.tabSize, e);
  }
  lineIndent(t, e = 1) {
    let { text: i, from: n } = this.lineAt(t, e),
...
function Ol(t, e, i) {
  for (let n = t; n; n = n.next) {
    let t = ul(n.node);
    if (t) return t(dl.create(e, i, n));
  }
  return 0;
}
function ul(t) {
  let e = t.type.prop(cl);
  if (e) return e;
  let i,
    s = t.firstChild;
...
class dl extends hl {
  ...
  continue() {
    return Ol(this.context.next, this.base, this.pos);
  }
}
function pl(t, e) {
...
function ml({ closing: t, align: e = !0, units: i = 1 }) {
  return (n) => gl(n, e, i, t);
}
...
const Ql = (t) => t.baseIndent;
function wl({ except: t, units: e = 1 } = {}) {
  return (i) => {
...
function kl(t, e, i) {
  ...
  return (function (t, e, i) {
    ...
    let s = null;
    for (let r = n.resolveStack(i, 1); r; r = r.next) {
      let o = r.node;
      if (o.to <= i || o.from > i) continue;
      if (s && o.from < e) break;
      let a = o.type.prop(vl);
      if (a && (o.to < n.length - 50 || n.length == t.doc.length || !xl(o))) {
        let n = a(o, t);
...
const Xl = qt.define({
  ...
  update(t, e) {
    ...
    for (let i of e.effects)
      if (i.is(Pl) && !Cl(t, i.value.from, i.value.to)) {
        let { preparePlaceholder: n } = e.state.facet(zl),
          s = n ? Hi.replace({ widget: new Dl(n(e.state, i.value)) }) : El;
        t = t.update({ add: [s.range(i.value.from, i.value.to)] });
      } else
        i.is(Tl) &&
          (t = t.update({
  ...
  provide: (t) => Vr.decorations.from(t),
  toJSON(t, e) {
    let i = [];
    return (
...
function Rl(t, e) {
  return t.field(Xl, !1) ? e : e.concat(le.appendConfig.of(Vl()));
}
function Ml(t, e, i = !0) {
  let n = t.state.doc.lineAt(e.from).number,
    s = t.state.doc.lineAt(e.to).number;
  return Vr.announce.of(
    `${t.state.phrase(i ? 'Folded lines' : 'Unfolded lines')} ${n} ${t.state.phrase('to')} ${s}.`,
  );
}
const _l = [
    {
      ...
      run: (t) => {
        for (let e of Zl(t)) {
          let i = kl(t.state, e.from, e.to);
          if (i) return (t.dispatch({ effects: Rl(t.state, [Pl.of(i), Ml(t, i)]) }), !0);
        }
        return !1;
      },
    },
    {
      ...
      mac: 'Cmd-Alt-]',
      run: (t) => {
        if (!t.state.field(Xl, !1)) return !1;
        let e = [];
        for (let i of Zl(t)) {
          let n = Al(t.state, i.from, i.to);
          n && e.push(Tl.of(n), Ml(t, n, !1));
        }
      ...
      run: (t) => {
        ...
        for (let n = 0; n < e.doc.length; ) {
          let s = t.lineBlockAt(n),
            r = kl(e, s.from, s.to);
          (r && i.push(Pl.of(r)), (n = (r ? t.lineBlockAt(r.to) : s).to + 1));
        }
        return (i.length && t.dispatch({ effects: Rl(t.state, i) }), !!i.length);
      },
    },
    {
      key: 'Ctrl-Alt-]',
      run: (t) => {
        let e = t.state.field(Xl, !1);
        if (!e || !e.size) return !1;
        let i = [];
        return (
          e.between(0, t.state.doc.length, (t, e) => {
            i.push(Tl.of({ from: t, to: e }));
          }),
  ...
  Yl = { placeholderDOM: null, preparePlaceholder: null, placeholderText: '…' },
  zl = Ct.define({ combine: (t) => Se(t, Yl) });
function Vl(t) {
  let e = [Xl, Gl];
  return (t && e.push(zl.of(t)), e);
}
function ql(t, e) {
  let { state: i } = t,
    n = i.facet(zl),
    s = (e) => {
      let i = t.lineBlockAt(t.posAtDOM(e.target)),
        n = Al(t.state, i.from, i.to);
      (n && t.dispatch({ effects: Tl.of(n) }), e.preventDefault());
    };
  if (n.placeholderDOM) return n.placeholderDOM(t, s, e);
  let r = document.createElement('span');
  return (
    (r.textContent = n.placeholderText),
    r.setAttribute('aria-label', i.phrase('folded code')),
    (r.title = i.phrase('unfold')),
...
function Ll(t = {}) {
    ...
    s = Dn.fromClass(
      class {
        ...
        update(t) {
          (t.docChanged ||
            t.viewportChanged ||
            t.startState.facet(el) != t.state.facet(el) ||
            t.startState.field(Xl, !1) != t.state.field(Xl, !1) ||
            ja(t.startState) != ja(t.state) ||
            e.foldingChanged(t)) &&
        ...
        buildMarkers(t) {
          ...
          for (let s of t.viewportLineBlocks) {
            let r = Al(t.state, s.from, s.to) ? n : kl(t.state, s.from, s.to) ? i : null;
  ...
  return [
    ...
    No({
      ...
      markers(t) {
        var e;
        return (null === (e = t.plugin(s)) || void 0 === e ? void 0 : e.markers) || $e.empty;
      },
      initialSpacer: () => new jl(e, !1),
      domEventHandlers: Object.assign(Object.assign({}, r), {
        click: (t, e, i) => {
          if (r.click && r.click(t, e, i)) return !0;
          let n = Al(t.state, e.from, e.to);
          if (n) return (t.dispatch({ effects: Tl.of(n) }), !0);
          let s = kl(t.state, e.from, e.to);
          return !!s && (t.dispatch({ effects: Pl.of(s) }), !0);
        },
      }),
    }),
    Vl(),
...
class Bl {
  constructor(t, e) {
    ...
    const s = 'string' == typeof e.all ? e.all : e.all ? n(e.all) : void 0,
      r = e.scope;
    ((this.scope = r instanceof Ea ? (t) => t.prop(za) == r.data : r ? (t) => t == r : void 0),
      (this.style = ga(
        t.map((t) => ({ tag: t.tag, class: t.class || n(Object.assign({}, t, { tag: null })) })),
        { all: s },
      ).style),
      (this.module = i ? new We(i) : null),
...
const Il = Ct.define(),
  Nl = Ct.define({ combine: (t) => (t.length ? [t[0]] : null) });
function Ul(t) {
  let e = t.facet(Il);
  return e.length ? e : t.facet(Nl);
}
function Fl(t, e) {
  let i,
    n = [Kl];
  return (
    t instanceof Bl && (t.module && n.push(Vr.styleModule.of(t.module)), (i = t.themeType)),
    (null == e ? void 0 : e.fallback)
      ? n.push(Nl.of(t))
      : i
        ? n.push(
            Il.computeN([Vr.darkTheme], (e) => (e.facet(Vr.darkTheme) == ('dark' == i) ? [t] : [])),
          )
        : n.push(Il.of(t)),
    n
  );
...
class Hl {
  ...
  update(t) {
    ...
    e.length < s.to && !n && e.type == this.tree.type && r >= s.to
      ? ((this.decorations = this.decorations.map(t.changes)), (this.decoratedTo = r))
  ...
  buildDeco(t, e) {
    if (!e || !this.tree.length) return Hi.none;
    let i = new Pe();
    for (let { from: n, to: s } of t.visibleRanges)
      Qa(
        ...
        e,
        (t, e, n) => {
          i.add(t, e, this.markCache[n] || (this.markCache[n] = Hi.mark({ class: n })));
        },
        n,
        s,
      );
...
const Kl = Gt.high(Dn.fromClass(Hl, { decorations: (t) => t.decorations }));
(_a.meta,
  _a.link,
  _a.heading,
  _a.emphasis,
  ...
  _a.comment,
  _a.invalid);
const Jl = Vr.baseTheme({
    '&.cm-focused .cm-matchingBracket': { backgroundColor: '#328c8252' },
    '&.cm-focused .cm-nonmatchingBracket': { backgroundColor: '#bb555544' },
  }),
  th = '()[]{}',
  eh = Ct.define({
    combine: (t) => Se(t, { afterCursor: !0, brackets: th, maxScanDistance: 1e4, renderMatch: sh }),
  }),
  ih = Hi.mark({ class: 'cm-matchingBracket' }),
  nh = Hi.mark({ class: 'cm-nonmatchingBracket' });
function sh(t) {
  let e = [],
    i = t.matched ? ih : nh;
  return (
...
const rh = qt.define({
    ...
    update(t, e) {
      ...
      for (let t of e.state.selection.ranges) {
        if (!t.empty) continue;
        let s =
          Oh(e.state, t.head, -1, n) ||
          (t.head > 0 && Oh(e.state, t.head - 1, 1, n)) ||
          (n.afterCursor &&
            (Oh(e.state, t.head, 1, n) ||
              (t.head < e.state.doc.length && Oh(e.state, t.head + 1, -1, n))));
...
function Oh(t, e, i, n = {}) {
  ...
  for (let n = a; n; n = n.parent) {
    ...
    if (s && n.from < n.to) {
      let o = ch(n);
      if (o && (i > 0 ? e >= o.from && e < o.to : e > o.from && e <= o.to))
        return uh(t, e, i, n, o, s, r);
    }
  }
  return (function (t, e, i, n, s, r, o) {
    ...
    for (let t = 0; !c.next().done && t <= r; ) {
      ...
      for (let t = i > 0 ? 0 : r.length - 1, e = i > 0 ? r.length : -1; t != e; t += i) {
        let e = o.indexOf(r[t]);
        if (!(e < 0 || n.resolveInner(a + t, 1).type != s))
          if ((e % 2 == 0) == i > 0) O++;
          else {
            if (1 == O)
              return { start: h, end: { from: a + t, to: a + t + 1 }, matched: e >> 1 == l >> 1 };
            O--;
          }
      }
      i > 0 && (t += r.length);
...
class dh {
  ...
  eat(t) {
    ...
    if (((e = 'string' == typeof t ? i == t : i && (t instanceof RegExp ? t.test(i) : t(i))), e))
      return (++this.pos, i);
  }
  eatWhile(t) {
    let e = this.pos;
  ...
  indentation() {
    var t;
    return null !== (t = this.overrideIndent) && void 0 !== t
      ? t
      : fh(this.string, null, this.tabSize);
  }
  match(t, e, i) {
    if ('string' == typeof t) {
...
class gh extends Ea {
  constructor(t) {
    let e,
      ...
      s = {
        ...
        copyState: r.copyState || ph,
        indent: r.indent || (() => null),
        languageData: r.languageData || {},
        tokenTable: r.tokenTable || vh,
      };
    var r;
    (super(
      i,
      new (class extends A {
        createParse(t, i, n) {
          return new bh(e, t, i, n);
        }
      })(),
      [sl.of((t, e) => this.getIndent(t, e))],
      t.name,
    ),
      (this.topNode = (function (t) {
        let e = o.define({ id: yh.length, name: 'Document', props: [za.add(() => t)], top: !0 });
        return (yh.push(e), e);
      })(i)),
      (e = this),
      (this.streamParser = s),
      (this.stateAfter = new n({ perNode: !0 })),
      (this.tokenTable = t.tokenTable ? new Th(s.tokenTable) : Zh));
  }
  static define(t) {
    return new gh(t);
  }
  getIndent(t, e) {
    ...
    r && ((i = mh.get(t.state)), null != i && i < e - 1e4 && (i = void 0));
    let o,
      a,
      l = Qh(this, n, 0, s.from, null != i ? i : e);
    if (
      (l ? ((a = l.state), (o = l.pos + 1)) : ((a = this.streamParser.startState(t.unit)), (o = 0)),
      e - o > 1e4)
    )
      return null;
    for (; o < e; ) {
      ...
      if (i.length) {
        let e = r ? r(i.from) : -1,
          s = new dh(i.text, t.state.tabSize, t.unit, e < 0 ? void 0 : e);
        for (; s.pos < n - i.from; ) Sh(this.streamParser.token, s, a);
    ...
    let h = t.lineAt(e);
    return (
      r && null == i && mh.set(t.state, h.from),
      this.streamParser.indent(a, /^\s*(.*)/.exec(h.text)[1], t)
    );
  }
  get allowsNesting() {
    return !1;
...
function Qh(t, e, i, n, s) {
  ...
  for (let r = e.children.length - 1; r >= 0; r--) {
    let o = e.children[r],
      a = i + e.positions[r],
      l = o instanceof O && a < s && Qh(t, o, a, n, s);
    if (l) return l;
  }
  return null;
}
function wh(t, e, i, n, s) {
  ...
  for (let r = e.children.length - 1; r >= 0; r--) {
    let o,
      a = e.positions[r],
      l = e.children[r];
    if (a < n && l instanceof O) {
      if (!(o = wh(t, l, i - a, n - a, s))) break;
      return s
        ? new O(e.type, e.children.slice(0, r).concat(o), e.positions.slice(0, r + 1), a + o.length)
        : o;
    }
  }
  return null;
...
let bh = class {
      ...
      { state: o, tree: a } = (function (t, e, i, n) {
        for (let n of e) {
          let e,
            ...
            o = s <= i && r > i && Qh(t, n.tree, 0 - n.offset, i, r);
          if (o && (e = wh(t, n.tree, i + n.offset, o.pos + n.offset, !1)))
            return { state: o.state, tree: e };
        }
        return { state: t.streamParser.startState(n ? ol(n) : 4), tree: O.empty };
      })(t, i, r, null == s ? void 0 : s.state);
    ((this.state = o), (this.parsedPos = this.chunkStart = r + a.length));
    for (let t = 0; t < a.children.length; t++)
      (this.chunks.push(a.children[t]), this.chunkPos.push(a.positions[t]));
    (s &&
      this.parsedPos < s.viewport.from - 1e5 &&
      ((this.state = this.lang.streamParser.startState(ol(s.state))),
  ...
  parseLine(t) {
    let { line: e, end: i } = this.nextLine(),
      ...
      r = new dh(e, t ? t.state.tabSize : 4, t ? ol(t.state) : 2);
    if (r.eol()) s.blankLine(this.state, r.indentUnit);
    else
      for (; !r.eol(); ) {
        let t = Sh(s.token, r, this.state);
        if (
          (t &&
            (n = this.emitToken(
  ...
  finishChunk() {
    ...
    ((t = new O(t.type, t.children, t.positions, t.length, [
...
class Th {
  constructor(t) {
    ((this.extra = t), (this.table = Object.assign(Object.create(null), Ph)));
  }
  resolve(t) {
...
function Ah(t, e) {
    ...
    for (let i of n.split('.')) {
      ...
      n
        ? 'function' == typeof n
          ? e.length
            ? (e = e.map(n))
            : Xh(i, `Modifier ${i} used at start of tag`)
          : e.length
            ? Xh(i, `Tag ${i} used as modifier`)
            : (e = Array.isArray(n) ? n : [n])
        : Xh(i, `Unknown highlighting tag ${i}`);
    }
  ...
  let n = e.replace(/ /g, '_'),
    ...
    r = $h[s];
  if (r) return r.id;
  let a = ($h[s] = o.define({ id: yh.length, name: n, props: [da({ [n]: i })] }));
  return (yh.push(a), a.id);
}
function Ch(t) {
  return t.length <= 4096 && /[\u0590-\u05f4\u0600-\u06ff\u0700-\u08ac\ufb50-\ufdff]/.test(t);
}
function Rh(t) {
  for (let e = t.iter(); !e.next().done; ) if (Ch(e.value)) return !0;
  return !1;
}
const Mh = Ct.define({ combine: (t) => t.some((t) => t) });
function _h(t = {}) {
  let e = [Yh];
  return (t.alwaysIsolate && e.push(Mh.of(!0)), e);
}
const Yh = Dn.fromClass(
  class {
    constructor(t) {
      ((this.always =
        t.state.facet(Mh) || t.textDirection != an.LTR || t.state.facet(Vr.perLineTextDirection)),
        (this.hasRTL = !this.always && Rh(t.state.doc)),
        (this.tree = ja(t.state)),
        (this.decorations = this.always || this.hasRTL ? zh(t, this.tree, this.always) : Hi.none));
    }
    update(t) {
      let e =
        t.state.facet(Mh) ||
        t.view.textDirection != an.LTR ||
        t.state.facet(Vr.perLineTextDirection);
      if (
        (e ||
          this.hasRTL ||
          !(function (t) {
        ...
        return;
      let i = ja(t.state);
      (e != this.always || i != this.tree || t.docChanged || t.viewportChanged) &&
        ((this.tree = i), (this.always = e), (this.decorations = zh(t.view, i, e)));
    }
  },
  {
    provide: (t) => {
      function e(e) {
        var i, n;
        return null !== (n = null === (i = e.plugin(t)) || void 0 === i ? void 0 : i.decorations) &&
          void 0 !== n
          ? n
          : Hi.none;
      }
      return [Vr.outerDecorations.of(e), Gt.lowest(Vr.bidiIsolatedRanges.of(e))];
    },
  },
);
function zh(t, e, i) {
  ...
  i ||
    (r = (function (t, e) {
      ...
      for (let { from: e, to: o } of t)
        if (!(r && r.to > e && ((e = r.to), e >= o)))
          for (n + i.value.length < e && (i.next(e - (n + i.value.length)), (n = e)); ; ) {
            let t = n,
              e = n + i.value.length;
            if (
              (!i.lineBreak &&
                ...
                (r && r.to > t - 10
                  ? (r.to = Math.min(o, e))
                  : s.push((r = { from: t, to: Math.min(o, e) }))),
              e >= o)
            )
              break;
            ((n = e), i.next());
  ...
  for (let { from: t, to: i } of r)
    e.iterate({
      enter: (t) => {
        let e = t.type.prop(n.isolate);
        e && s.add(t.from, t.to, Vh[e]);
      },
      from: t,
      to: i,
    });
...
const Vh = {
  rtl: Hi.mark({ class: 'cm-iso', inclusive: !0, attributes: { dir: 'rtl' }, bidiIsolate: an.RTL }),
  ltr: Hi.mark({ class: 'cm-iso', inclusive: !0, attributes: { dir: 'ltr' }, bidiIsolate: an.LTR }),
  auto: Hi.mark({ class: 'cm-iso', inclusive: !0, attributes: { dir: 'auto' }, bidiIsolate: null }),
};
class qh {
  ...
  static start(t, e, i = 0) {
    ...
    return new qh(t, [], e, i, i, 0, [], 0, n ? new Eh(n, n.start) : null, 0, null);
  }
  get context() {
  ...
  reduce(t) {
    ...
    if ((o && (this.score += o), 0 == i))
      return (
        ...
        n < s.minRepeatTerm && this.storeNode(n, this.reducePos, this.reducePos, r ? 8 : 4, !0),
    ...
    let a = this.stack.length - 3 * (i - 1) - (262144 & t ? 6 : 0),
      ...
      h = this.reducePos - l;
    h >= 2e3 &&
      !(null === (e = this.p.parser.nodeSet.types[n]) || void 0 === e ? void 0 : e.isAnonymous) &&
    ...
    let c = a ? this.stack[a - 1] : 0,
      O = this.bufferBase + this.buffer.length - c;
    if (n < s.minRepeatTerm || 131072 & t) {
      let t = s.stateFlag(this.state, 1) ? this.pos : this.reducePos;
      this.storeNode(n, l, t, O + 4, !0);
    }
    if (262144 & t) this.state = this.stack[a];
    else {
      let t = this.stack[a - 3];
      this.state = s.getGoto(t, n, !0);
    }
  ...
  storeNode(t, e, i, n = 4, s = !1) {
    ...
    if (s && this.pos != i) {
      ...
      if (s > 0 && 0 != this.buffer[s - 4]) {
        let t = !1;
        for (let e = s; e > 0 && this.buffer[e - 2] > i; e -= 4)
  ...
  shift(t, e, i, n) {
    if (131072 & t) this.pushState(65535 & t, this.pos);
      ...
      let s = t,
        { parser: r } = this.p;
      ((n > this.pos || e <= r.maxNode) &&
        ((this.pos = n), r.stateFlag(s, 1) || (this.reducePos = n)),
        this.pushState(s, i),
        this.shiftContext(e, i),
        e <= r.maxNode && this.buffer.push(e, i, n, 4));
    }
  }
  apply(t, e, i, n) {
  ...
  forceReduce() {
    ...
    if (!t.validAction(this.state, e)) {
      ...
      if (s < 0 || t.getGoto(this.stack[s], n, !1) < 0) {
            ...
            t.allActions(n, (e) => {
              if (393216 & e);
                ...
                if (i > 1) {
                  let n = 65535 & e,
                    s = this.stack.length - 3 * i;
                  if (s >= 0 && t.getGoto(this.stack[s], n, !1) >= 0) return (i << 19) | 65536 | n;
                }
              } else {
                let t = i(e, s + 1);
                if (null != t) return t;
  ...
  updateContext(t) {
    if (t != this.curContext.context) {
      let e = new Eh(this.curContext.tracker, t);
...
class Wh {
  ...
  static create(t, e = t.bufferBase + t.buffer.length) {
    return new Wh(t, e, e - t.bufferBase);
  }
  maybeNext() {
  ...
  fork() {
    return new Wh(this.stack, this.pos, this.index);
  }
}
function jh(t, e = Uint16Array) {
...
class Ih {
  ...
  token(t, e) {
    let { parser: i } = e.p;
    Fh(this.data, t, e, this.id, i.data, i.tokenPrecTable);
  }
}
Ih.prototype.contextual = Ih.prototype.fallback = Ih.prototype.extend = !1;
class Nh {
  constructor(t, e, i) {
    ((this.precTable = e), (this.elseToken = i), (this.data = 'string' == typeof t ? jh(t) : t));
  }
  token(t, e) {
    let i = t.pos,
      n = 0;
    for (;;) {
      let i = t.next < 0,
        s = t.resolveOffset(1, 1);
      if ((Fh(this.data, t, e, 0, this.data, this.precTable), t.token.value > -1)) break;
...
Nh.prototype.contextual = Ih.prototype.fallback = Ih.prototype.extend = !1;
class Uh {
  constructor(t, e = {}) {
    ((this.token = t),
  ...
  t: for (; 0 != (a & t[o]); ) {
    ...
    for (let n = o + 3; n < i; n += 2)
      if ((t[n + 1] & a) > 0) {
        ...
        if (
          l.allows(i) &&
          (-1 == e.token.value || e.token.value == i || Kh(i, e.token.value, s, r))
        ) {
          e.acceptToken(i);
          break;
        }
...
function Kh(t, e, i, n) {
  let s = Hh(i, n, e);
  return s < 0 || Hh(i, n, t) < s;
}
const Jh = 'undefined' != typeof process && process.env && /\bparse\b/.test(process.env.LOG);
let tc = null;
function ec(t, e, i) {
...
class ic {
  ...
  nextFragment() {
    ...
    if (t) {
      for (
        this.safeFrom = t.openStart ? ec(t.tree, t.from + t.offset, 1) - t.offset : t.from,
          this.safeTo = t.openEnd ? ec(t.tree, t.to + t.offset, -1) - t.offset : t.to;
        this.trees.length;
      )
...
class nc {
  constructor(t, e) {
    ((this.stream = e),
      ...
      (this.mainToken = null),
      (this.actions = []),
      (this.tokens = t.tokenizers.map((t) => new Lh())));
  }
  getActions(t) {
    let e = 0,
      i = null,
      ...
      for (let n = 0; n < e.specialized.length; n++)
        if (e.specialized[n] == t.value) {
          ...
          if (s >= 0 && i.p.parser.dialect.allows(s >> 1)) {
            1 & s ? (t.extended = s >> 1) : (t.value = s >> 1);
            break;
          }
        }
  ...
  addActions(t, e, i, n) {
    ...
    for (let t = 0; t < 2; t++)
      for (let a = r.stateSlot(s, t ? 2 : 1); ; a += 3) {
        if (65535 == o[a]) {
          if (1 != o[a + 1]) {
            0 == n && 2 == o[a + 1] && (n = this.putAction(cc(o, a + 2), e, i, n));
            break;
          }
          a = cc(o, a + 2);
        }
        o[a] == e && (n = this.putAction(cc(o, a + 1), e, i, n));
      }
    return n;
  }
}
class sc {
  constructor(t, e, i, n) {
    ((this.parser = t),
      ...
      (this.stream = new Bh(e, n)),
      (this.tokens = new nc(t, this.stream)),
      (this.topTerm = t.top[1]));
    let { from: s } = n[0];
    ((this.stacks = [qh.start(this, t.top[0], s)]),
      (this.fragments =
        i.length && this.stream.end - s > 4 * t.bufferLength ? new ic(i, t.nodeSet) : null));
  }
  get parsedPos() {
  ...
  advance() {
    ...
    if (!s.length) {
      ...
      if (e) return (Jh && console.log('Finish with ' + this.stackID(e)), this.stackToTree(e));
    ...
    if (this.recovering && t) {
      let i =
        null != this.stoppedAt && t[0].pos > this.stoppedAt ? t[0] : this.runRecovery(t, e, s);
      if (i)
        return (
          Jh && console.log('Force-finish ' + this.stackID(i)),
  ...
  advanceStack(t, e, i) {
    ...
    if (this.fragments) {
      ...
      for (let a = this.fragments.nodeAt(s); a; ) {
        ...
        if (s > -1 && a.length && (!e || (a.prop(n.contextHash) || 0) == i))
          return (
            t.useNode(a, s),
            Jh && console.log(o + this.stackID(t) + ` (via reuse of ${r.getName(a.type.id)})`),
            !0
          );
        if (!(a instanceof O) || 0 == a.children.length || a.positions[0] > 0) break;
        let l = a.children[0];
        if (!(l instanceof O && 0 == a.positions[0])) break;
        a = l;
      }
    }
    ...
    if (a > 0)
      return (
        t.reduce(a),
        Jh && console.log(o + this.stackID(t) + ` (via always-reduce ${r.getName(65535 & a)})`),
        !0
      );
    ...
    for (let n = 0; n < l.length; ) {
      ...
      if (
        (u.apply(a, h, f ? f.start : u.pos, c),
        Jh &&
          console.log(
            o +
              this.stackID(u) +
              ` (via ${65536 & a ? `reduce of ${r.getName(65535 & a)}` : 'shift'} for ${r.getName(h)} @ ${s}${u == t ? '' : ', split'})`,
          ),
        O)
      )
        return !0;
      u.pos > s ? e.push(u) : i.push(u);
    }
    return !1;
  }
  advanceFully(t, e) {
    ...
    for (let r = 0; r < t.length; r++) {
      ...
      if (o.deadEnd) {
        ...
        if (
          ((s = !0),
          o.restart(),
          Jh && console.log(h + this.stackID(o) + ' (restarted)'),
      ...
      for (let t = 0; c.forceReduce() && t < 10; t++) {
        if (
          (Jh && console.log(O + this.stackID(c) + ' (via force-reduce)'), this.advanceFully(c, i))
        )
          break;
        Jh && (O = this.stackID(c) + ' -> ');
      }
      for (let t of o.recoverByInsert(a))
        (Jh && console.log(h + this.stackID(t) + ' (via recover-insert)'), this.advanceFully(t, i));
      this.stream.end > o.pos
        ? (l == o.pos && (l++, (a = 0)),
          o.recoverByDelete(a, l),
          Jh &&
            console.log(h + this.stackID(o) + ` (via recover-delete ${this.parser.getName(a)})`),
          rc(o, i))
  ...
  stackID(t) {
    let e = (tc || (tc = new WeakMap())).get(t);
    return (e || tc.set(t, (e = String.fromCodePoint(this.nextStackID++))), e + t);
  }
}
function rc(t, e) {
...
class lc {
  constructor(t) {
    ((this.start = t.start),
      (this.shift = t.shift || ac),
      (this.reduce = t.reduce || ac),
      (this.reuse = t.reuse || ac),
      (this.hash = t.hash || (() => 0)),
...
class hc extends A {
  constructor(e) {
    ...
    ((this.specializers = this.specializerSpecs.map(Oc)),
      (this.states = jh(e.states, Uint32Array)),
      (this.data = jh(e.stateData)),
      (this.goto = jh(e.goto)),
      (this.maxTerm = e.maxTerm),
      (this.tokenizers = e.tokenizers.map((t) => ('number' == typeof t ? new Ih(h, t) : t))),
  ...
  hasAction(t, e) {
    ...
    for (let n = 0; n < 2; n++)
      for (let s, r = this.stateSlot(t, n ? 2 : 1); ; r += 3) {
        if (65535 == (s = i[r])) {
          if (1 != i[r + 1]) {
            if (2 == i[r + 1]) return cc(i, r + 2);
            break;
          }
          s = i[(r = cc(i, r + 2))];
        }
        if (s == e || 0 == s) return cc(i, r + 1);
      }
    return 0;
  }
  stateSlot(t, e) {
  ...
  configure(t) {
    let e = Object.assign(Object.create(hc.prototype), this);
    ...
    return (
      ...
      t.specializers &&
        ...
        (e.specializerSpecs = this.specializerSpecs.map((i, n) => {
          ...
          return ((e.specializers[n] = Oc(r)), r);
        }))),
...
function pc(t) {
  return dc(t) || (t >= 97 && t <= 102) || (t >= 65 && t <= 70);
}
const mc = (t, e, i) => (n, s) => {
    for (let r = !1, o = 0, a = 0; ; a++) {
      let { next: l } = n;
      if (fc(l) || 45 == l || 95 == l || (r && dc(l)))
        (!r && (45 != l || a > 0) && (r = !0), o === a && 45 == l && o++, n.advance());
      else {
        if (92 != l || 10 == n.peek(1)) {
          r && n.acceptToken(2 == o && s.canShift(2) ? e : 40 == l ? i : t);
          break;
        }
        if ((n.advance(), pc(n.next))) {
          do {
            n.advance();
          } while (pc(n.next));
          32 == n.next && n.advance();
  ...
  gc = new Uh(mc(123, 2, 124)),
  Qc = new Uh(mc(125, 3, 4)),
  wc = new Uh((t) => {
  ...
  bc = new Uh((t) => {
    if (!uc.includes(t.peek(-1))) {
      let { next: e } = t;
      if ((37 == e && (t.advance(), t.acceptToken(1)), fc(e))) {
        do {
          t.advance();
        } while (fc(t.next) || dc(t.next));
        t.acceptToken(1);
      }
    }
  }),
  Sc = da({
    ...
    'MatchOp CompareOp': _a.compareOperator,
  ...
  yc = { __proto__: null, or: 98, and: 98, not: 106, only: 106, layer: 170 },
  xc = { __proto__: null, selector: 112, layer: 166 },
  kc = {
    __proto__: null,
    '@import': 162,
    '@media': 174,
  ...
  Pc = hc.deserialize({
    ...
    tokenizers: [wc, bc, gc, Qc, 1, 2, 3, 4, new Nh('m~RRYZ[z{a~~g~aO#v~~dP!P!Qg~lO#w~~', 28, 129)],
    topRules: { StyleSheet: [0, 6], Styles: [1, 105] },
    specialized: [
      { term: 124, get: (t) => vc[t] || -1 },
      { term: 125, get: (t) => yc[t] || -1 },
      { term: 4, get: (t) => xc[t] || -1 },
      { term: 25, get: (t) => kc[t] || -1 },
      { term: 123, get: (t) => $c[t] || -1 },
    ],
    tokenPrec: 1963,
  });
let Tc = null;
function Zc() {
  if (!Tc && 'object' == typeof document && document.body) {
    ...
    for (let n in t)
      'cssText' != n &&
        'cssFloat' != n &&
        'string' == typeof t[n] &&
        (/[A-Z]/.test(n) && (n = n.replace(/[A-Z]/g, (t) => '-' + t.toLowerCase())),
        i.has(n) || (e.push(n), i.add(n)));
    Tc = e.sort().map((t) => ({ type: 'property', label: t }));
  }
  return Tc || [];
}
const Xc = [
...
function qc(t, e, i) {
  if (e.to - e.from > 4096) {
    ...
    let s = [],
      r = new Set(),
      o = e.cursor(c.IncludeAnonymous);
    if (o.firstChild())
      do {
        for (let e of qc(t, o.node, i)) r.has(e.label) || (r.add(e.label), s.push(e));
      } while (o.nextSibling());
    return (Yc.set(e, s), s);
  }
  {
    ...
    return (
      e.cursor().iterate((e) => {
        ...
        if (
          i(e) &&
          e.matchContext(zc) &&
          ':' == (null === (r = e.node.nextSibling) || void 0 === r ? void 0 : r.name)
        ) {
          let i = t.sliceString(e.from, e.to);
          s.has(i) || (s.add(i), n.push({ label: i, type: 'variable' }));
        }
      }),
      n
    );
...
const Ec = (t) => (e) => {
    let { state: i, pos: n } = e,
      s = ja(i).resolveInner(n, -1),
      r = s.type.isError && s.from == s.to - 1 && '-' == i.doc.sliceString(s.from, s.to);
    if (
      'PropertyName' == s.name ||
      ((r || 'TagName' == s.name) && /^(Block|Styles)$/.test(s.resolve(s.to).name))
    )
      return { from: s.from, options: Zc(), validFor: Mc };
    if ('ValueName' == s.name) return { from: s.from, options: Ac, validFor: Mc };
    if ('PseudoClassName' == s.name) return { from: s.from, options: Xc, validFor: Mc };
    if (
      t(s) ||
      ((e.explicit || r) &&
        (function (t, e) {
          var i;
          if ((('(' == t.name || t.type.isError) && (t = t.parent || t), 'ArgList' != t.name))
            return !1;
          let n = null === (i = t.parent) || void 0 === i ? void 0 : i.firstChild;
          return 'Callee' == (null == n ? void 0 : n.name) && 'var' == e.sliceString(n.from, n.to);
        })(s, i.doc))
    )
      return { from: t(s) || r ? s.from : n, options: qc(i.doc, Vc(s), t), validFor: _c };
    if ('TagName' == s.name) {
      for (let { parent: t } = s; t; t = t.parent)
        if ('Block' == t.name) return { from: s.from, options: Zc(), validFor: Mc };
      return { from: s.from, options: Cc, validFor: Mc };
    }
    if ('AtKeyword' == s.name) return { from: s.from, options: Rc, validFor: Mc };
    if (!e.explicit) return null;
    let o = s.resolve(n),
      a = o.childBefore(n);
    return a && ':' == a.name && 'PseudoClassSelector' == o.name
      ? { from: n, options: Xc, validFor: Mc }
      : (a && ':' == a.name && 'Declaration' == o.name) || 'ArgList' == o.name
        ? { from: n, options: Ac, validFor: Mc }
        : 'Block' == o.name || 'Styles' == o.name
          ? { from: n, options: Zc(), validFor: Mc }
          : null;
  },
  Dc = Ec((t) => 'VariableName' == t.name),
  Wc = Wa.define({
    name: 'css',
    parser: Pc.configure({
      props: [cl.add({ Declaration: wl() }), vl.add({ 'Block KeyframeList': yl })],
    }),
    languageData: {
...
function jc() {
  return new il(Wc, Wc.data.of({ autocomplete: Dc }));
}
class Lc {
  constructor(t, e, i, n) {
    ((this.state = t),
  ...
  tokenBefore(t) {
    let e = ja(this.state).resolveInner(this.pos, -1);
    for (; e && t.indexOf(e.name) < 0; ) e = e.parent;
    return e
      ? { from: e.from, to: this.pos, text: this.state.sliceDoc(e.from, this.pos), type: e.type }
      : null;
  }
  matchBefore(t) {
  ...
  addEventListener(t, e, i) {
    'abort' == t &&
      this.abortListeners &&
      (this.abortListeners.push(e), i && i.onDocChange && (this.abortOnDocChange = !0));
  }
}
function Gc(t) {
...
function Ic(t, e) {
  return (i) => {
    for (let e = ja(i.state).resolveInner(i.pos, -1); e; e = e.parent) {
...
class iO {
  constructor(t) {
    ...
    for (let e = 0; e < t.length; ) {
      ...
      let s = t.slice(e, e + n),
        r = s.toUpperCase();
      (this.folded.push(pt(r == s ? s.toLowerCase() : r, 0)), (e += n));
    }
  ...
  match(t) {
    ...
    for (let n = 0, l = Math.min(t.length, 200), g = 0; n < l && c < a; ) {
      ...
      o < 0 &&
        (h < a && l == e[h] && (s[h++] = n),
        u < a && (l == e[u] || l == i[u] ? (0 == u && (f = n), (d = n + 1), u++) : (u = 0)));
      let Q,
        w =
          l < 255
            ? (l >= 48 && l <= 57) || (l >= 97 && l <= 122)
              ...
              : l >= 65 && l <= 90
                ? 1
                : 0
            : (Q = mt(l)) != Q.toLowerCase()
              ? 1
              : Q != Q.toUpperCase()
                ? 2
                : 0;
      ((!n || (1 == w && p) || (0 == g && 0 != w)) &&
        (e[c] == l || (i[c] == l && (O = !0)) ? (r[c++] = n) : r.length && (m = !1)),
        (g = w),
        (n += gt(l)));
    }
    return c == a && 0 == r[0] && m
      ? this.result((O ? -200 : 0) - 100, r, t)
      : u == a && 0 == f
        ? this.ret(-200 - t.length + (d == t.length ? 0 : -100), [0, d])
        : o > -1
          ? this.ret(-700 - t.length, [o, o + this.pattern.length])
          : u == a
            ? this.ret(-900 - t.length, [f, d])
            : c == a
              ? this.result((O ? -200 : 0) - 100 - 700 + (m ? 0 : -1100), r, t)
              : 2 == e.length
                ? null
  ...
  result(t, e, i) {
    let n = [],
      s = 0;
    for (let t of e) {
      let e = t + (this.astral ? gt(pt(i, t)) : 1);
      s && n[s - 1] == t ? (n[s - 1] = e) : ((n[s++] = t), (n[s++] = e));
    }
  ...
  match(t) {
    ...
    return null == i
      ...
      : ((this.matched = [0, e.length]),
        (this.score = i + (t.length == this.pattern.length ? 0 : -100)),
        this);
  }
}
const sO = Ct.define({
  combine: (t) =>
    Se(
      ...
      },
      {
        ...
        closeOnBlur: (t, e) => t && e,
        icons: (t, e) => t && e,
        tooltipClass: (t, e) => (i) => rO(t(i), e(i)),
        optionClass: (t, e) => (i) => rO(t(i), e(i)),
...
function oO(t, e, i, n, s, r) {
  let o,
    ...
    d = n.right - n.left,
    p = n.bottom - n.top;
  if ((h && u < Math.min(d, f) ? (h = !1) : !h && f < Math.min(d, u) && (h = !0), d <= (h ? u : f)))
    ((o = Math.max(s.top, Math.min(i.top, s.bottom - p)) - e.top), (a = Math.min(400, h ? u : f)));
  else {
    ((c = !0), (a = Math.min(400, (l ? e.right : s.right - e.left) - 30)));
    let t = s.bottom - e.bottom;
    t >= p || t > e.top ? (o = i.bottom - e.top) : ((O = 'bottom'), (o = e.bottom - i.top));
  }
  return {
    style: `${O}: ${o / ((e.bottom - e.top) / r.offsetHeight)}px; max-width: ${a / ((e.right - e.left) / r.offsetWidth)}px`,
...
class lO {
  constructor(t, e, i) {
    ...
    ((this.optionContent = (function (t) {
          ...
          e.push({
            render(t) {
              ...
              return (
                ...
                t.type &&
                  e.classList.add(...t.type.split(/\s+/g).map((t) => 'cm-completionIcon-' + t)),
        ...
        e.push(
          {
            render(t, e, i, n) {
              ...
              for (let t = 0; t < n.length; ) {
                let e = n[t++],
                  i = n[t++];
                e > o && s.appendChild(document.createTextNode(r.slice(o, e)));
                let a = s.appendChild(document.createElement('span'));
                (a.appendChild(document.createTextNode(r.slice(e, i))),
                  (a.className = 'cm-completionMatchedText'),
                  (o = i));
              }
              return (o < r.length && s.appendChild(document.createTextNode(r.slice(o))), s);
            },
            position: 50,
          },
          {
      ...
      (this.range = aO(s.length, r, o.maxRenderedOptions)),
      (this.dom = document.createElement('div')),
      (this.dom.className = 'cm-tooltip-autocomplete'),
      this.updateTooltipClass(t.state),
      this.dom.addEventListener('mousedown', (i) => {
        let { options: n } = t.state.field(e).open;
        for (let e, s = i.target; s && s != this.dom; s = s.parentNode)
          if ('LI' == s.nodeName && (e = /-(\d+)$/.exec(s.id)) && +e[1] < n.length)
            return (this.applyCompletion(t, n[+e[1]]), void i.preventDefault());
      }),
      this.dom.addEventListener('focusout', (e) => {
        let i = t.state.field(this.stateField, !1);
        i &&
          i.tooltip &&
          t.state.facet(sO).closeOnBlur &&
          e.relatedTarget != t.contentDOM &&
          t.dispatch({ effects: eO.of(null) });
      }),
  ...
  update(t) {
    ...
    if ((this.updateTooltipClass(t.state), i != n)) {
      let { options: s, selected: r, disabled: o } = i.open;
      ((n.open && n.open.options == s) ||
        ((this.range = aO(s.length, r, t.state.facet(sO).maxRenderedOptions)),
        this.showOptions(s, i.id)),
        this.updateSel(),
        o != (null === (e = n.open) || void 0 === e ? void 0 : e.disabled) &&
  ...
  updateSel() {
    let t = this.view.state.field(this.stateField),
      e = t.open;
    if (
      (((e.selected > -1 && e.selected < this.range.from) || e.selected >= this.range.to) &&
        ((this.range = aO(
          e.options.length,
          e.selected,
          this.view.state.facet(sO).maxRenderedOptions,
        )),
      ...
      'then' in s
        ? s
            ...
            .catch((t) => zn(this.view.state, t, 'completion info'))
  ...
  addInfoPane(t, e) {
    ...
    if (((i.className = 'cm-tooltip cm-completionInfo'), null != t.nodeType))
      ...
      e &&
        (function (t, e) {
          ...
          n.top < i.top
            ...
            : n.bottom > i.bottom && (t.scrollTop += (n.bottom - i.bottom) / s);
        })(this.list, e),
      e
    );
  }
  measureInfo() {
    ...
    return n.top > Math.min(s.bottom, e.bottom) - 10 || n.bottom < Math.max(s.top, e.top) + 10
      ? null
      : this.view.state.facet(sO).positionInfo(this.view, e, n, i, s, this.dom);
  }
  placeInfo(t) {
    this.info &&
      (t
  ...
  createListBox(t, e, i) {
    ...
    for (let r = i.from; r < i.to; r++) {
      let { completion: o, match: a } = t[r],
        { section: l } = o;
      if (l) {
        let t = 'string' == typeof l ? l : l.name;
        if (t != s && (r > i.from || 0 == i.from))
          if (((s = t), 'string' != typeof l && l.header)) n.appendChild(l.header(l));
          else {
            n.appendChild(document.createElement('completion-section')).textContent = t;
          }
      }
...
class OO {
  ...
  setSelected(t, e) {
    return t == this.selected || t >= this.options.length
      ? this
      : new OO(this.options, pO(e, t), this.tooltip, this.timestamp, t, this.disabled);
  }
  static build(t, e, i, n, s, r) {
    if (n && !r && t.some((t) => 1 == t.state)) return n.setDisabled();
    let o = (function (t, e) {
      let i = [],
        n = null,
        s = (t) => {
      ...
      for (let n of t)
        if (n.hasResult()) {
          ...
          if (!1 === n.result.filter)
            for (let e of n.result.options) s(new Nc(e, n.source, t ? t(e) : [], 1e9 - i.length));
          else {
            let i,
              o = e.sliceDoc(n.from, n.to),
              a = r.filterStrict ? new nO(o) : new iO(o);
            for (let e of n.result.options)
              if ((i = a.match(e.label))) {
                let r = e.displayLabel ? (t ? t(e, i.matched) : []) : i.matched;
                s(new Nc(e, n.source, r, i.score + (e.boost || 0)));
              }
          }
        }
      if (n) {
          ...
          s = (t, e) => {
            ...
            return (
              (null !== (i = t.rank) && void 0 !== i ? i : 1e9) -
                (null !== (n = e.rank) && void 0 !== n ? n : 1e9) || (t.name < e.name ? -1 : 1)
            );
          };
      ...
      let o = [],
        a = null,
        l = r.compareCompletions;
      for (let t of i.sort((t, e) => e.score - t.score || l(t.completion, e.completion))) {
        let e = t.completion;
        (!a ||
        a.label != e.label ||
        a.detail != e.detail ||
        ...
        a.boost != e.boost
          ? o.push(t)
          : cO(t.completion) > cO(a) && (o[o.length - 1] = t),
          (a = t.completion));
      }
      return o;
    })(t, e);
    if (!o.length) return n && t.some((t) => 1 == t.state) ? n.setDisabled() : null;
    let a = e.facet(sO).selectOnOpen ? 0 : -1;
  ...
  setDisabled() {
    return new OO(this.options, this.attrs, this.tooltip, this.timestamp, this.selected, !0);
  }
}
class uO {
  constructor(t, e, i) {
  ...
  static start() {
    return new uO(mO, 'cm-ac-' + Math.floor(2e6 * Math.random()).toString(36), null);
  }
  update(t) {
    let { state: e } = t,
      i = e.facet(sO),
      n = (i.override || e.languageDataAt('autocomplete', Uc(e)).map(Jc)).map((e) =>
        (
          this.active.find((t) => t.source == e) ||
          new QO(e, this.active.some((t) => 0 != t.state) ? 1 : 0)
        ).update(t, i),
      );
    n.length == this.active.length && n.every((t, e) => t == this.active[e]) && (n = this.active);
    let s = this.open,
      r = t.effects.some((t) => t.is(bO));
    (s && t.docChanged && (s = s.map(t.changes)),
      ...
      r
        ? (s = OO.build(n, e, this.id, s, i, r))
        : s && s.disabled && !n.some((t) => 1 == t.state) && (s = null),
      !s &&
        n.every((t) => 1 != t.state) &&
        n.some((t) => t.hasResult()) &&
        (n = n.map((t) => (t.hasResult() ? new QO(t.source, 0) : t))));
    for (let e of t.effects) e.is(SO) && (s = s && s.setSelected(e.value, this.id));
    return n == this.active && s == this.open ? this : new uO(n, this.id, s);
  }
  get tooltip() {
    return this.open ? this.open.tooltip : null;
  }
  get attrs() {
    return this.open ? this.open.attrs : this.active.length ? fO : dO;
  }
}
const fO = { 'aria-autocomplete': 'list' },
  dO = {};
function pO(t, e) {
...
class QO {
  ...
  update(t, e) {
    let i = gO(t, e),
      n = this;
    ((8 & i || (16 & i && this.touches(t))) && (n = new QO(n.source, 0)),
      4 & i && 0 == n.state && (n = new QO(this.source, 1)),
      (n = n.updateFor(t, i)));
    for (let e of t.effects)
      if (e.is(tO)) n = new QO(n.source, 1, e.value ? Uc(t.state) : -1);
      else if (e.is(eO)) n = new QO(n.source, 0);
      else if (e.is(bO)) for (let t of e.value) t.source == n.source && (n = t);
    return n;
  }
  updateFor(t, e) {
  ...
  map(t) {
    return t.empty || this.explicitPos < 0
      ? this
      : new QO(this.source, this.state, t.mapPos(this.explicitPos));
  }
  touches(t) {
    return t.changes.touchesRange(Uc(t.state));
  }
}
class wO extends QO {
  constructor(t, e, i, n, s) {
  ...
  updateFor(t, e) {
    ...
    if (
      ...
      o > r ||
      !n ||
      (2 & e && Uc(t.startState) == this.from)
    )
      return new QO(this.source, 4 & e ? 1 : 0);
    let a = this.explicitPos < 0 ? -1 : t.changes.mapPos(this.explicitPos);
    return (function (t, e, i, n) {
      if (!t) return !1;
      let s = e.sliceDoc(i, n);
      return 'function' == typeof t ? t(s, i, n, e) : Fc(t, !0).test(s);
    })(n.validFor, t.state, s, r)
      ? new wO(this.source, a, n, s, r)
      : n.update && (n = n.update(n, s, r, new Lc(t.state, o, a >= 0)))
        ? new wO(this.source, a, n, n.from, null !== (i = n.to) && void 0 !== i ? i : Uc(t.state))
        : new QO(this.source, 1, a);
  }
  map(t) {
    if (t.empty) return this;
    return (this.result.map ? this.result.map(this.result, t) : this.result)
      ? new wO(
          this.source,
      ...
      : new QO(this.source, 0);
  }
  touches(t) {
    return t.changes.touchesRange(this.from, this.to);
  }
}
const bO = le.define({ map: (t, e) => t.map((t) => t.map(e)) }),
  SO = le.define(),
  vO = qt.define({
    create: () => uO.start(),
    update: (t, e) => t.update(e),
    provide: (t) => [Yo.from(t, (t) => t.tooltip), Vr.contentAttributes.from(t, (t) => t.attrs)],
  });
function yO(t, e) {
  const i = e.completion.apply || e.completion.label;
  let n = t.state.field(vO).active.find((t) => t.source == e.source);
  return (
    n instanceof wO &&
    ('string' == typeof i
      ? t.dispatch(
                  ...
                  Object.assign(
                    ...
                    t.changeByRange((a) => {
                      if (
                        a != s &&
                        i != n &&
                        t.sliceDoc(a.from + r, a.from + o) != t.sliceDoc(i, n)
                      )
                        return { range: a };
                      let l = t.toText(e);
                      return {
                        changes: {
                          from: a.from + r,
                          to: n == s.from ? a.to : a.from + o,
                          insert: l,
                        },
                        range: Zt.cursor(a.from + r + l.length),
                      };
                    }),
                  ),
...
const xO = hO(vO, yO);
function kO(t, e = 'option') {
  return (i) => {
    let n = i.state.field(vO, !1);
    if (
      !n ||
      !n.open ||
      n.open.disabled ||
      Date.now() - n.open.timestamp < i.state.facet(sO).interactionDelay
    )
      return !1;
    let s,
      r = 1;
    'page' == e &&
      (s = zo(i, n.open.tooltip)) &&
      (r = Math.max(
        2,
    ...
    return (
      ...
      i.dispatch({ effects: SO.of(a) }),
      !0
    );
  };
}
const $O = (t) => {
    let e = t.state.field(vO, !1);
    return (
      !(
        t.state.readOnly ||
        !e ||
        ...
        e.open.selected < 0 ||
        e.open.disabled ||
        Date.now() - e.open.timestamp < t.state.facet(sO).interactionDelay
      ) && yO(t, e.open.options[e.open.selected])
    );
  },
  PO = (t) => !!t.state.field(vO, !1) && (t.dispatch({ effects: tO.of(!0) }), !0),
  TO = (t) => {
    let e = t.state.field(vO, !1);
    return (
      !(!e || !e.active.some((t) => 0 != t.state)) && (t.dispatch({ effects: eO.of(null) }), !0)
    );
  };
class ZO {
  constructor(t, e) {
    ...
    class {
      constructor(t) {
        ((this.view = t),
          ...
          (this.pendingStart = !1),
          (this.composing = 0));
        for (let e of t.state.field(vO).active) 1 == e.state && this.startQuery(e);
      }
      update(t) {
        let e = t.state.field(vO),
          i = t.state.facet(sO);
        if (!t.selectionSet && !t.docChanged && t.startState.field(vO) == e) return;
        ...
        for (let e = 0; e < this.running.length; e++) {
          ...
          if (
            ...
            (i.updates.length + t.transactions.length > 50 && Date.now() - i.time > 1e3)
          ) {
            for (let t of i.context.abortListeners)
              try {
                t();
              } catch (t) {
                zn(this.view.state, t);
              }
        ...
        (this.debounceUpdate > -1 && clearTimeout(this.debounceUpdate),
          t.transactions.some((t) => t.effects.some((t) => t.is(tO))) && (this.pendingStart = !0));
      ...
      startUpdate() {
        ...
        this.running.length &&
          ...
          (this.debounceAccept = setTimeout(
            () => this.accept(),
            this.view.state.facet(sO).updateSyncTime,
          ));
      }
      startQuery(t) {
        let { state: e } = this.view,
          i = Uc(e),
          n = new Lc(e, i, t.explicitPos == i, this.view),
          s = new ZO(t, n);
        (this.running.push(s),
          Promise.resolve(t.source(n)).then(
            ...
            (t) => {
              (this.view.dispatch({ effects: eO.of(null) }), zn(this.view.state, t));
            },
          ));
      }
      scheduleAccept() {
      ...
      accept() {
        ...
        let e = [],
          i = this.view.state.facet(sO),
          n = this.view.state.field(vO);
        for (let s = 0; s < this.running.length; s++) {
          ...
          if ((this.running.splice(s--, 1), r.done)) {
            let n = new wO(
              ...
              null !== (t = r.done.to) && void 0 !== t
                ? t
                : Uc(r.updates.length ? r.updates[0].startState : this.view.state),
            );
          ...
          let o = n.active.find((t) => t.source == r.active.source);
          if (o && 1 == o.state)
            if (null == r.done) {
              let t = new QO(r.active.source, 0);
              for (let e of r.updates) t = t.update(e, i);
              1 != t.state && e.push(t);
            } else this.startQuery(o);
        }
        (e.length || (n.open && n.open.disabled)) && this.view.dispatch({ effects: bO.of(e) });
      }
    },
    {
      eventHandlers: {
        blur(t) {
          let e = this.view.state.field(vO, !1);
          if (e && e.tooltip && this.view.state.facet(sO).closeOnBlur) {
            let i = e.open && zo(this.view, e.open.tooltip);
            (i && i.dom.contains(t.relatedTarget)) ||
              setTimeout(() => this.view.dispatch({ effects: eO.of(null) }), 10);
          }
        },
        compositionstart() {
          this.composing = 1;
        ...
        compositionend() {
          (3 == this.composing && setTimeout(() => this.view.dispatch({ effects: tO.of(!1) }), 20),
            (this.composing = 0));
        },
      },
    },
  ),
  AO = 'object' == typeof navigator && /Win/.test(navigator.platform),
  CO = Gt.highest(
    Vr.domEventHandlers({
      keydown(t, e) {
        let i = e.state.field(vO, !1);
        if (
          !i ||
          !i.open ||
          i.open.disabled ||
...
class _O {
  ...
  map(t) {
    let e = t.mapPos(this.from, -1, wt.TrackDel),
      i = t.mapPos(this.to, 1, wt.TrackDel);
    return null == e || null == i ? null : new _O(this.field, e, i);
  }
}
class YO {
  constructor(t, e) {
  ...
  instantiate(t, e) {
    ...
    for (let s of this.lines) {
      if (i.length) {
        let i = r,
          o = /^\t*/.exec(s)[0].length;
        for (let e = 0; e < o; e++) i += t.facet(rl);
        (n.push(e + i.length - o), (s = i + s.slice(o)));
      }
      (i.push(s), (e += s.length + 1));
    }
    let o = this.fieldPositions.map((t) => new _O(t.field, n[t.line] + t.from, n[t.line] + t.to));
    ...
    for (let r of t.split(/\r\n?|\n/)) {
      for (; (e = /[#$]\{(?:(\d+)(?::([^}]*))?|((?:\\[{}]|[^}])*))\}/.exec(r)); ) {
        ...
        for (let e = 0; e < i.length; e++)
          (null != t ? i[e].seq == t : l && i[e].name == l) && (a = e);
        if (a < 0) {
          let e = 0;
        ...
        (s.push(new MO(a, n.length, e.index, e.index + l.length)),
          (r = r.slice(0, e.index) + o + r.slice(e.index + e[0].length)));
      }
      ((r = r.replace(/\\([{}])/g, (t, e, i) => {
        for (let t of s) t.line == n.length && t.from > i && (t.from--, t.to--);
        return e;
      })),
        n.push(r));
    }
...
let zO = Hi.widget({
  ...
  VO = Hi.mark({ class: 'cm-snippetField' });
class qO {
  constructor(t, e) {
    ((this.ranges = t),
      (this.active = e),
      (this.deco = Hi.set(t.map((t) => (t.from == t.to ? zO : VO).range(t.from, t.to)))));
  }
  map(t) {
    let e = [];
...
const EO = le.define({ map: (t, e) => t && t.map(e) }),
  DO = le.define(),
  WO = qt.define({
    create: () => null,
    update(t, e) {
      for (let i of e.effects) {
        if (i.is(EO)) return i.value;
        if (i.is(DO) && t) return new qO(t.ranges, i.value);
      }
      return (
    ...
    provide: (t) => Vr.decorations.from(t, (t) => (t ? t.deco : Hi.none)),
  });
function jO(t, e) {
  return Zt.create(t.filter((t) => t.field == e).map((t) => Zt.range(t.from, t.to)));
}
function LO(t) {
  let e = YO.parse(t);
  return (t, i, n, s) => {
    let { text: r, ranges: o } = e.instantiate(t.state, n),
      a = {
        changes: { from: n, to: s, insert: st.of(r) },
        scrollIntoView: !0,
        annotations: i ? [Hc.of(i), he.userEvent.of('input.complete')] : void 0,
      };
    if ((o.length && (a.selection = jO(o, 0)), o.some((t) => t.field > 0))) {
      let e = new qO(o, 0),
        i = (a.effects = [EO.of(e)]);
      void 0 === t.state.field(WO, !1) && i.push(le.appendConfig.of([WO, NO, FO, RO]));
    }
...
function GO(t) {
  return ({ state: e, dispatch: i }) => {
    ...
    return (
      i(
        e.update({
          selection: jO(n.ranges, s),
          effects: EO.of(r ? null : new qO(n.ranges, s)),
          scrollIntoView: !0,
        }),
      ),
      !0
...
const BO = [
    { key: 'Tab', run: GO(1), shift: GO(-1) },
    {
      key: 'Escape',
      run: ({ state: t, dispatch: e }) =>
        !!t.field(WO, !1) && (e(t.update({ effects: EO.of(null) })), !0),
    },
  ],
  IO = Ct.define({ combine: (t) => (t.length ? t[0] : BO) }),
  NO = Gt.highest(Br.compute([IO], (t) => t.facet(IO)));
function UO(t, e) {
  return Object.assign(Object.assign({}, e), { apply: LO(t) });
}
const FO = Vr.domEventHandlers({
  mousedown(t, e) {
    let i,
      n = e.state.field(WO, !1);
    if (!n || null == (i = e.posAtCoords({ x: t.clientX, y: t.clientY }))) return !1;
    let s = n.ranges.find((t) => t.from <= i && t.to >= i);
    return (
      !(!s || s.field == n.active) &&
      (e.dispatch({
        selection: jO(n.ranges, s.field),
        effects: EO.of(n.ranges.some((t) => t.field > s.field) ? new qO(n.ranges, s.field) : null),
        scrollIntoView: !0,
      }),
      !0)
    );
  ...
  for (let r = t.iterLines(), o = 0; !r.next().done; ) {
    ...
    for (e.lastIndex = 0; (t = e.exec(a)); )
      if (
        !n[t[0]] &&
        o + t.index != s &&
        (i.push({ type: 'text', label: t[0] }), (n[t[0]] = !0), i.length >= 2e3)
      )
        return;
    o += a.length + 1;
  }
...
function tu(t, e, i, n, s) {
  ...
  if (t.children) {
    ...
    for (let o of t.children) {
      if (o.length >= 1e3)
        for (let t of tu(o, e, i, n - r, s - r)) l[t.label] || ((l[t.label] = !0), a.push(t));
      else JO(o, i, a, l, s - r);
      r += o.length + 1;
    }
  } else JO(t, i, a, l, s);
...
const eu = (t) => {
    let e = t.state.languageDataAt('wordChars', t.pos).join(''),
      ...
      n = t.matchBefore(HO(i, (t) => t + '$'));
    if (!n && !t.explicit) return null;
    let s = n ? n.from : t.pos,
      r = tu(
        t.state.doc,
        (function (t) {
          return KO[t] || (KO[t] = new WeakMap());
        })(e),
        i,
        5e4,
        s,
      );
    return { from: s, options: r, validFor: HO(i, (t) => '^' + t) };
  },
  iu = { brackets: ['(', '[', '{', "'", '"'], before: ')]}:;>', stringPrefixes: [] },
  nu = le.define({
    map(t, e) {
  ...
  su = new (class extends ve {})();
((su.startSide = 1), (su.endSide = -1));
const ru = qt.define({
  create: () => $e.empty,
  update(t, e) {
    ...
    for (let i of e.effects) i.is(nu) && (t = t.update({ add: [su.range(i.value, i.value + 1)] }));
    return t;
  },
});
function ou() {
...
const au = '()[]{}<>';
function lu(t) {
  for (let e = 0; e < 8; e += 2) if (au.charCodeAt(e) == t) return au.charAt(e + 1);
  return mt(t < 128 ? t : t + 1);
}
function hu(t, e) {
  return t.languageDataAt('closeBrackets', e)[0] || iu;
}
const cu = 'object' == typeof navigator && /Android\b/.test(navigator.userAgent),
  Ou = Vr.inputHandler.of((t, e, i, n) => {
    if ((cu ? t.composing : t.compositionStarted) || t.state.readOnly) return !1;
    let s = t.state.selection.main;
    if (n.length > 2 || (2 == n.length && 1 == gt(pt(n, 0))) || e != s.from || i != s.to) return !1;
    let r = (function (t, e) {
      let i = hu(t, t.selection.main.head),
        n = i.brackets || iu.brackets;
      for (let s of n) {
        let r = lu(pt(s, 0));
        if (e == s)
          return r == s
            ? gu(t, s, n.indexOf(s + s + s) > -1, i)
            : pu(t, s, r, i.before || iu.before);
        if (e == r && fu(t, t.selection.main.from)) return mu(t, s, r);
      }
      return null;
    })(t.state, n);
  ...
  uu = [
    {
      ...
      run: ({ state: t, dispatch: e }) => {
        ...
        let i = hu(t, t.selection.main.head).brackets || iu.brackets,
          n = null,
          s = t.changeByRange((e) => {
            if (e.empty) {
              let n = (function (t, e) {
                let i = t.sliceString(e - 2, e);
                return gt(pt(i, 0)) == i.length ? i : i.slice(1);
              })(t.doc, e.head);
              for (let s of i)
                if (s == n && du(t.doc, e.head) == lu(pt(s, 0)))
                  return {
                    changes: { from: e.head - s.length, to: e.head + s.length },
                    range: Zt.cursor(e.head - s.length),
                  };
            }
            return { range: (n = e) };
          });
...
function fu(t, e) {
  let i = !1;
  return (
    t.field(ru).between(0, t.doc.length, (t) => {
      t == e && (i = !0);
    }),
    i
  );
    ...
    r = t.changeByRange((r) => {
      if (!r.empty)
        return {
          ...
          effects: nu.of(r.to + e.length),
          range: Zt.range(r.anchor + e.length, r.head + e.length),
        };
      let o = du(t.doc, r.head);
      return !o || /\s/.test(o) || n.indexOf(o) > -1
        ? {
            changes: { insert: e + i, from: r.head },
            effects: nu.of(r.head + e.length),
            range: Zt.cursor(r.head + e.length),
          }
        : { range: (s = r) };
    });
...
function mu(t, e, i) {
  let n = null,
    s = t.changeByRange((e) =>
      e.empty && du(t.doc, e.head) == i
        ? {
            changes: { from: e.head, to: e.head + i.length, insert: i },
            range: Zt.cursor(e.head + i.length),
          }
        : (n = { range: e }),
    );
...
function gu(t, e, i, n) {
  let s = n.stringPrefixes || iu.stringPrefixes,
    r = null,
    o = t.changeByRange((n) => {
      if (!n.empty)
        return {
          ...
          effects: nu.of(n.to + e.length),
          range: Zt.range(n.anchor + e.length, n.head + e.length),
        };
      let o,
        a = n.head,
        l = du(t.doc, a);
      if (l == e) {
        if (Qu(t, a))
          return {
            ...
            effects: nu.of(a + e.length),
            range: Zt.cursor(a + e.length),
          };
        if (fu(t, a)) {
          let n = i && t.sliceDoc(a, a + 3 * e.length) == e + e + e ? e + e + e : e;
          return {
            changes: { from: a, to: a + n.length, insert: n },
            range: Zt.cursor(a + n.length),
          };
        }
      } else {
        if (
        ...
        if (
          t.charCategorizer(a)(l) != me.Word &&
          wu(t, a, s) > -1 &&
          !(function (t, e, i, n) {
            let s = ja(t).resolveInner(e, -1),
            ...
            for (let o = 0; o < 5; o++) {
              ...
              if (!a || (a > -1 && n.indexOf(o.slice(0, a)) > -1)) {
                let e = s.firstChild;
                for (; e && e.from == s.from && e.to - e.from > i.length + a; ) {
...
function Qu(t, e) {
  let i = ja(t).resolveInner(e + 1);
  return i.parent && i.from == e;
}
function wu(t, e, i) {
  let n = t.charCategorizer(e);
  if (n(t.sliceDoc(e - 1, e)) != me.Word) return e;
  for (let s of i) {
    let i = e - s.length;
    if (t.sliceDoc(i, e) == s && n(t.sliceDoc(i - 1, i)) != me.Word) return i;
  }
  return -1;
}
function bu(t = {}) {
  return [CO, vO, sO.of(t), XO, vu, RO];
}
const Su = [
    { key: 'Ctrl-Space', run: PO },
    { mac: 'Alt-`', run: PO },
    { key: 'Escape', run: TO },
    { key: 'ArrowDown', run: kO(!0) },
    { key: 'ArrowUp', run: kO(!1) },
    { key: 'PageDown', run: kO(!0, 'page') },
    { key: 'PageUp', run: kO(!1, 'page') },
    { key: 'Enter', run: $O },
  ],
  vu = Gt.highest(Br.computeN([sO], (t) => (t.facet(sO).defaultKeymap ? [Su] : [])));
function yu(t) {
  let e = t.field(vO, !1);
...
function ku(t) {
  var e;
  let i = null === (e = t.field(vO, !1)) || void 0 === e ? void 0 : e.open;
  if (!i || i.disabled) return [];
  let n = xu.get(i.options);
  return (n || xu.set(i.options, (n = i.options.map((t) => t.completion))), n);
}
function $u(t) {
  var e;
  let i = null === (e = t.field(vO, !1)) || void 0 === e ? void 0 : e.open;
  return i && !i.disabled && i.selected >= 0 ? i.options[i.selected].completion : null;
}
function Pu(t) {
  var e;
  let i = null === (e = t.field(vO, !1)) || void 0 === e ? void 0 : e.open;
  return i && !i.disabled && i.selected >= 0 ? i.selected : null;
}
const Tu = (t) => {
  let { state: e } = t,
    i = e.doc.lineAt(e.selection.main.from),
    n = Cu(t.state, i.from);
  return n.line ? Xu(t) : !!n.block && Au(t);
};
function Zu(t, e) {
  ...
  Au = Zu(
    (t, e) =>
      (function (t, e, i = e.selection.ranges) {
        let n = i.map((t) => Cu(e, t.from).block);
        ...
        let s = i.map((t, i) =>
          (function (t, { open: e, close: i }, n, s) {
            ...
            s - n <= 2 * Ru
              ? (r = o = t.sliceDoc(n, s))
              : ((r = t.sliceDoc(n, n + Ru)), (o = t.sliceDoc(s - Ru, s)));
            let u = /^\s*/.exec(r)[0].length,
              f = /\s*$/.exec(o)[0].length,
              d = o.length - f - i.length;
            if (r.slice(u, u + e.length) == e && o.slice(d, d + i.length) == i)
              return {
                open: { pos: n + u + e.length, margin: /\s/.test(r.charAt(u + e.length)) ? 1 : 0 },
...
const Ru = 50;
function Mu(t, e, i = e.selection.ranges) {
  let n = [],
    s = -1;
      ...
      for (let i = t; i <= r; ) {
        ...
        if (l.from > s && (t == r || r > l.from)) {
          ...
          (t < l.text.length && t < o && (o = t),
            n.push({ line: l, comment: i, token: a, indent: t, empty: e, single: !1 }));
        }
        i = l.to + 1;
      }
      if (o < 1e9)
        for (let t = i; t < n.length; t++) n[t].indent < n[t].line.text.length && (n[t].indent = o);
...
const qu = qt.define({
  ...
  update(t, e) {
    ...
    if (n) {
      let s = e.docChanged
          ...
          : void 0,
        r = Bu.fromTransaction(e, s),
        o = n.side,
        a = 0 == o ? t.undone : t.done;
      return (
        (a = r ? Iu(a, a.length, i.minDepth, r) : Hu(a, e.startState.selection)),
        new nf(0 == o ? n.rest : a, 0 == o ? a : n.rest)
      );
    }
    let s = e.annotation(Yu);
    if ((('full' != s && 'before' != s) || (t = t.isolate()), !1 === e.annotation(he.addToHistory)))
      return e.changes.empty ? t : t.addMapping(e.changes.desc);
    let r = Bu.fromTransaction(e),
      o = e.annotation(he.time),
      a = e.annotation(he.userEvent);
    return (
      r
        ? (t = t.addChanges(r, o, a, i, e))
  ...
  fromJSON: (t) => new nf(t.done.map(Bu.fromJSON), t.undone.map(Bu.fromJSON)),
});
function Eu(t = {}) {
  return [
    qu,
    ...
    Vr.domEventHandlers({
      beforeinput(t, e) {
        let i = 'historyUndo' == t.inputType ? Wu : 'historyRedo' == t.inputType ? ju : null;
...
class Bu {
  ...
  setSelAfter(t) {
    return new Bu(this.changes, this.effects, this.mapped, this.startSelection, t);
  }
  toJSON() {
    var t, e, i;
    return {
  ...
  static fromJSON(t) {
    return new Bu(
      t.changes && St.fromJSON(t.changes),
      [],
      t.mapped && bt.fromJSON(t.mapped),
      t.startSelection && Zt.fromJSON(t.startSelection),
      t.selectionsAfter.map(Zt.fromJSON),
    );
  }
  static fromTransaction(t, e) {
    let i = Uu;
    for (let e of t.startState.facet(zu)) {
      let n = e(t);
      n.length && (i = i.concat(n));
    }
    return !i.length && t.changes.empty
      ? null
      : new Bu(t.changes.invert(t.startState.doc), i, void 0, e || t.startState.selection, Uu);
  }
  static selection(t) {
    return new Bu(void 0, Uu, void 0, void 0, t);
  }
}
function Iu(t, e, i, n) {
...
function Hu(t, e) {
  if (t.length) {
    let i = t[t.length - 1],
      n = i.selectionsAfter.slice(Math.max(0, i.selectionsAfter.length - Fu));
    return n.length && n[n.length - 1].eq(e)
      ? t
      : (n.push(e), Iu(t, t.length - 1, 1e9, i.setSelAfter(n)));
  }
  return [Bu.selection([e])];
}
function Ku(t) {
  let e = t[t.length - 1],
    i = t.slice();
  return (
    (i[t.length - 1] = e.setSelAfter(e.selectionsAfter.slice(0, e.selectionsAfter.length - 1))),
    i
  );
}
function Ju(t, e) {
  ...
  return n.length ? [Bu.selection(n)] : Uu;
}
function tf(t, e, i) {
  let n = Nu(t.selectionsAfter.length ? t.selectionsAfter.map((t) => t.map(e)) : Uu, i);
  if (!t.changes) return Bu.selection(n);
  let s = t.changes.map(e),
    r = e.mapDesc(t.changes, !0),
    o = t.mapped ? t.mapped.composeDesc(r) : r;
  return new Bu(s, le.mapEffects(t.effects, e), o, t.startSelection.map(r), n);
}
const ef = /^(input\.type|delete)($|\.)/;
class nf {
  constructor(t, e, i = 0, n = void 0) {
    ((this.done = t), (this.undone = e), (this.prevTime = i), (this.prevUserEvent = n));
  }
  isolate() {
    return this.prevTime ? new nf(this.done, this.undone) : this;
  }
        ...
        ((!o.selectionsAfter.length &&
          ...
          ? Iu(
              ...
              new Bu(
                ...
                Nu(t.effects, o.effects),
                o.mapped,
                o.startSelection,
                Uu,
              ),
            )
          : Iu(r, r.length, n.minDepth, t)),
      new nf(r, Uu, e, i)
    );
  }
  addSelection(t, e, i, n) {
    let s = this.done.length ? this.done[this.done.length - 1].selectionsAfter : Uu;
    return s.length > 0 &&
      e - this.prevTime < n &&
      ...
      ? this
      : new nf(Hu(this.done, t), this.undone, e, i);
    var r, o;
  }
  addMapping(t) {
    return new nf(Ju(this.done, t), Ju(this.undone, t), this.prevTime, this.prevUserEvent);
  }
  pop(t, e, i) {
    ...
    if (i && s.selectionsAfter.length)
      return e.update({
        ...
        annotations: _u.of({ side: t, rest: Ku(n) }),
        userEvent: 0 == t ? 'select.undo' : 'select.redo',
        scrollIntoView: !0,
      });
    if (s.changes) {
      let i = 1 == n.length ? Uu : n.slice(0, n.length - 1);
      return (
        s.mapped && (i = Ju(i, s.mapped)),
        e.update({
          changes: s.changes,
          selection: s.startSelection,
          effects: s.effects,
          annotations: _u.of({ side: t, rest: i }),
          filter: !1,
...
const sf = [
  ...
  { key: 'Alt-u', mac: 'Mod-Shift-u', run: Gu, preventDefault: !0 },
];
function rf(t, e) {
  return Zt.create(t.ranges.map(e), t.mainIndex);
}
function of(t, e) {
  return t.update({ selection: e, scrollIntoView: !0, userEvent: 'select' });
}
function af({ state: t, dispatch: e }, i) {
  let n = rf(t.selection, i);
  return !n.eq(t.selection) && (e(of(t, n)), !0);
}
function lf(t, e) {
  return Zt.cursor(e ? t.to : t.from);
}
function hf(t, e) {
  return af(t, (i) => (i.empty ? t.moveByChar(i, e) : lf(i, e)));
}
function cf(t) {
  return t.textDirectionAt(t.state.selection.main.head) == an.LTR;
}
const Of = (t) => hf(t, !cf(t)),
  uf = (t) => hf(t, cf(t));
function ff(t, e) {
  return af(t, (i) => (i.empty ? t.moveByGroup(i, e) : lf(i, e)));
}
const df = (t) => ff(t, !cf(t)),
  pf = (t) => ff(t, cf(t));
function mf(t, e, i) {
...
function gf(t, e, i) {
  let s,
    r,
    o = ja(t).resolveInner(e.head),
    a = i ? n.closedBy : n.openedBy;
  for (let n = e.head; ; ) {
    let e = i ? o.childAfter(n) : o.childBefore(n);
    if (!e) break;
    mf(t, e, a) ? (o = e) : (n = i ? e.to : e.from);
  }
  return (
    (r =
      o.type.prop(a) && (s = i ? Oh(t, o.from, 1) : Oh(t, o.to, -1)) && s.matched
        ? i
          ? s.end.to
          : s.end.from
        : i
...
const Qf = (t) => af(t, (e) => gf(t.state, e, !cf(t))),
  wf = (t) => af(t, (e) => gf(t.state, e, cf(t)));
function bf(t, e) {
  return af(t, (i) => {
    if (!i.empty) return lf(i, e);
...
function yf(t) {
  let e,
    ...
    s = 0;
  if (i) {
    for (let e of t.state.facet(Vr.scrollMargins)) {
      let i = e(t);
      ((null == i ? void 0 : i.top) && (n = Math.max(null == i ? void 0 : i.top, n)),
        (null == i ? void 0 : i.bottom) && (s = Math.max(null == i ? void 0 : i.bottom, s)));
    }
...
function xf(t, e) {
  let i,
    n = yf(t),
    { state: s } = t,
    r = rf(s.selection, (i) => (i.empty ? t.moveVertically(i, e, n.height) : lf(i, e)));
  ...
  if (n.selfScroll) {
    ...
    e &&
      e.top > a &&
      e.bottom < l &&
      (i = Vr.scrollIntoView(r.main.head, { y: 'start', yMargin: e.top - a }));
  }
  return (t.dispatch(of(s, r), { effects: i }), !0);
}
const kf = (t) => xf(t, !1),
  $f = (t) => xf(t, !0);
function Pf(t, e, i) {
  ...
  if (
    ...
    i && e.head != n.from + i && (s = Zt.cursor(n.from + i));
  }
  return s;
}
function Tf(t, e, i) {
  let n = !1,
    s = rf(t.selection, (e) => {
      let s =
        Oh(t, e.head, -1) ||
        Oh(t, e.head, 1) ||
        (e.head > 0 && Oh(t, e.head - 1, 1)) ||
        (e.head < t.doc.length && Oh(t, e.head + 1, -1));
      if (!s || !s.end) return e;
      n = !0;
      let r = s.start.from == e.head ? s.end.to : s.end.from;
      return i ? Zt.range(e.anchor, r) : Zt.cursor(r);
    });
  return !!n && (e(of(t, s)), !0);
}
const Zf = ({ state: t, dispatch: e }) => Tf(t, e, !1),
  Xf = ({ state: t, dispatch: e }) => Tf(t, e, !0);
function Af(t, e) {
  let i = rf(t.state.selection, (t) => {
    let i = e(t);
    return Zt.range(t.anchor, i.head, i.goalColumn, i.bidiLevel || void 0);
  });
  return !i.eq(t.state.selection) && (t.dispatch(of(t.state, i)), !0);
}
function Cf(t, e) {
  return Af(t, (i) => t.moveByChar(i, e));
}
const Rf = (t) => Cf(t, !cf(t)),
  Mf = (t) => Cf(t, cf(t));
function _f(t, e) {
  return Af(t, (i) => t.moveByGroup(i, e));
}
const Yf = (t) => _f(t, !cf(t)),
  zf = (t) => _f(t, cf(t)),
  Vf = (t) => Af(t, (e) => gf(t.state, e, !cf(t))),
  qf = (t) => Af(t, (e) => gf(t.state, e, cf(t)));
function Ef(t, e) {
  return Af(t, (i) => t.moveVertically(i, e));
}
const Df = (t) => Ef(t, !1),
  Wf = (t) => Ef(t, !0);
function jf(t, e) {
  return Af(t, (i) => t.moveVertically(i, e, yf(t).height));
}
const Lf = (t) => jf(t, !1),
  Gf = (t) => jf(t, !0),
  Bf = ({ state: t, dispatch: e }) => (e(of(t, { anchor: 0 })), !0),
  If = ({ state: t, dispatch: e }) => (e(of(t, { anchor: t.doc.length })), !0),
  Nf = ({ state: t, dispatch: e }) => (e(of(t, { anchor: t.selection.main.anchor, head: 0 })), !0),
  Uf = ({ state: t, dispatch: e }) => (
    e(of(t, { anchor: t.selection.main.anchor, head: t.doc.length })),
    !0
  );
function Ff(t, e) {
  ...
  let i = 'delete.selection',
    ...
    s = n.changeByRange((n) => {
      ...
      if (s == r) {
        let o = e(n);
        (o < s
          ? ((i = 'delete.backward'), (o = Hf(t, o, !1)))
          : o > s && ((i = 'delete.forward'), (o = Hf(t, o, !0))),
          (s = Math.min(s, o)),
          (r = Math.max(r, o)));
      } else ((s = Hf(t, s, !1)), (r = Hf(t, r, !0)));
      return s == r
        ? { range: n }
        : { changes: { from: s, to: r }, range: Zt.cursor(s, s < n.head ? -1 : 1) };
    });
  return (
    !s.changes.empty &&
    (t.dispatch(
      n.update(s, {
        scrollIntoView: !0,
        userEvent: i,
        effects: 'delete.selection' == i ? Vr.announce.of(n.phrase('Selection deleted')) : void 0,
      }),
    ),
    !0)
  );
...
function Hf(t, e, i) {
  if (t instanceof Vr)
    for (let n of t.state.facet(Vr.atomicRanges).map((e) => e(t)))
      n.between(e, e, (t, n) => {
        t < e && n > e && (e = i ? n : t);
      });
  return e;
...
const Kf = (t, e) =>
    Ff(t, (i) => {
      ...
      if (
        ...
        r > a.from &&
        r < a.from + 200 &&
        !/[^ \t]/.test((n = a.text.slice(0, r - a.from)))
      ) {
        if ('\t' == n[n.length - 1]) return r - 1;
        let t = Ve(n, o.tabSize) % ol(o) || ol(o);
        for (let e = 0; e < t && ' ' == n[n.length - 1 - e]; e++) r--;
        s = r;
      } else
        ((s = dt(a.text, r - a.from, e, e) + a.from),
          s == r && a.number != (e ? o.doc.lines : 1) && (s += e ? 1 : -1));
      return s;
    }),
  Jf = (t) => Kf(t, !1),
  td = (t) => Kf(t, !0),
  ed = (t, e) =>
    Ff(t, (i) => {
      ...
      for (let t = null; ; ) {
        if (n == (e ? r.to : r.from)) {
          n == i.head && r.number != (e ? s.doc.lines : 1) && (n += e ? 1 : -1);
          break;
        }
        let a = dt(r.text, n - r.from, e) + r.from,
        ...
        a =
          ...
          (function (t, e) {
            ...
            return r &&
              ...
              !/\S/.test(t.sliceDoc(r.to, o.from))
              ? { from: r.to, to: o.from }
              : null;
          })(e, s);
      t && (s = r = (r <= o.to ? o : e.doc.lineAt(r)).to);
      let l = new hl(e, { simulateBreak: s, simulateDoubleBreak: !!a }),
        h = ll(l, s);
      for (
        null == h && (h = Ve(/^\s*/.exec(e.doc.lineAt(s).text)[0], e.tabSize));
        r < o.to && /\s/.test(o.text[r - o.from]);
      )
        r++;
      a
        ? ({ from: s, to: r } = a)
        : s > o.from && s < o.from + 100 && !/\S/.test(o.text.slice(0, s)) && (s = o.from);
      let c = ['', al(e, h)];
      return (
        a && c.push(al(e, l.lineIndent(o.from, -1))),
        { changes: { from: s, to: r, insert: st.of(c) }, range: Zt.cursor(s + 1 + c[1].length) }
      );
    });
...
function rd(t, e) {
  ...
  return t.changeByRange((n) => {
    ...
    let r = t.changes(s);
    return { changes: s, range: Zt.range(r.mapPos(n.anchor, 1), r.mapPos(n.head, 1)) };
  });
}
const od = ({ state: t, dispatch: e }) =>
    !t.readOnly &&
    (e(
      t.update(
        rd(t, (e, i) => {
  ...
  ad = ({ state: t, dispatch: e }) =>
    ...
    (e(
      t.update(
        rd(t, (e, i) => {
          let n = /^\s*/.exec(e.text)[0];
          if (!n) return;
          let s = Ve(n, t.tabSize),
            r = 0,
            o = al(t, Math.max(0, s - ol(t)));
    ...
    !0),
  ld = [
    { key: 'ArrowLeft', run: Of, shift: Rf, preventDefault: !0 },
    { key: 'Mod-ArrowLeft', mac: 'Alt-ArrowLeft', run: df, shift: Yf, preventDefault: !0 },
    {
      mac: 'Cmd-ArrowLeft',
      run: (t) => af(t, (e) => Pf(t, e, !cf(t))),
      shift: (t) => Af(t, (e) => Pf(t, e, !cf(t))),
      preventDefault: !0,
    },
    { key: 'ArrowRight', run: uf, shift: Mf, preventDefault: !0 },
    { key: 'Mod-ArrowRight', mac: 'Alt-ArrowRight', run: pf, shift: zf, preventDefault: !0 },
    {
      mac: 'Cmd-ArrowRight',
      run: (t) => af(t, (e) => Pf(t, e, cf(t))),
      shift: (t) => Af(t, (e) => Pf(t, e, cf(t))),
    ...
    { mac: 'Cmd-ArrowUp', run: Bf, shift: Nf },
    { mac: 'Ctrl-ArrowUp', run: kf, shift: Lf },
    { key: 'ArrowDown', run: vf, shift: Wf, preventDefault: !0 },
    { mac: 'Cmd-ArrowDown', run: If, shift: Uf },
    { mac: 'Ctrl-ArrowDown', run: $f, shift: Gf },
    { key: 'PageUp', run: kf, shift: Lf },
    { key: 'PageDown', run: $f, shift: Gf },
    {
      key: 'Home',
      run: (t) => af(t, (e) => Pf(t, e, !1)),
      shift: (t) => Af(t, (e) => Pf(t, e, !1)),
      preventDefault: !0,
    },
    { key: 'Mod-Home', run: Bf, shift: Nf },
    {
      key: 'End',
      run: (t) => af(t, (e) => Pf(t, e, !0)),
      shift: (t) => Af(t, (e) => Pf(t, e, !0)),
      preventDefault: !0,
    },
    { key: 'Mod-End', run: If, shift: Uf },
    { key: 'Enter', run: nd },
    {
      key: 'Mod-a',
      run: ({ state: t, dispatch: e }) => (
        e(t.update({ selection: { anchor: 0, head: t.doc.length }, userEvent: 'select' })),
        !0
      ),
    },
    { key: 'Backspace', run: Jf, shift: Jf },
    { key: 'Delete', run: td },
    { key: 'Mod-Backspace', mac: 'Alt-Backspace', run: id },
    { key: 'Mod-Delete', mac: 'Alt-Delete', run: (t) => ed(t, !0) },
    {
      mac: 'Mod-Backspace',
      run: (t) =>
        Ff(t, (e) => {
    ...
    [
      { key: 'Ctrl-b', run: Of, shift: Rf, preventDefault: !0 },
      { key: 'Ctrl-f', run: uf, shift: Mf },
      { key: 'Ctrl-p', run: Sf, shift: Df },
      { key: 'Ctrl-n', run: vf, shift: Wf },
      {
        key: 'Ctrl-a',
        run: (t) => af(t, (e) => Zt.cursor(t.lineBlockAt(e.head).from, 1)),
        shift: (t) => Af(t, (e) => Zt.cursor(t.lineBlockAt(e.head).from)),
      },
      {
        key: 'Ctrl-e',
        run: (t) => af(t, (e) => Zt.cursor(t.lineBlockAt(e.head).to, -1)),
        shift: (t) => Af(t, (e) => Zt.cursor(t.lineBlockAt(e.head).to)),
      },
      { key: 'Ctrl-d', run: td },
      { key: 'Ctrl-h', run: Jf },
      {
      ...
      { key: 'Ctrl-Alt-h', run: id },
      {
        key: 'Ctrl-o',
        run: ({ state: t, dispatch: e }) => {
          if (t.readOnly) return !1;
          let i = t.changeByRange((t) => ({
            changes: { from: t.from, to: t.to, insert: st.of(['', '']) },
            range: Zt.cursor(t.from),
          }));
      ...
      },
      {
        ...
        run: ({ state: t, dispatch: e }) => {
          ...
          let i = t.changeByRange((e) => {
            ...
            let i = e.from,
              n = t.doc.lineAt(i),
              s = i == n.from ? i - 1 : dt(n.text, i - n.from, !1) + n.from,
              r = i == n.to ? i + 1 : dt(n.text, i - n.from, !0) + n.from;
            return {
          ...
          return (
            !i.changes.empty &&
            (e(t.update(i, { scrollIntoView: !0, userEvent: 'move.character' })), !0)
          );
        },
      },
      { key: 'Ctrl-v', run: $f },
...
function gd(t, e) {
  let i = t.pos + e;
  if (md == i && pd == t) return dd;
  let n = t.peek(e);
  for (; fd(n); ) n = t.peek(++e);
  let s = '';
  for (; ud(n); ) ((s += String.fromCharCode(n)), (n = t.peek(++e)));
  return ((pd = t), (md = i), (dd = s ? s.toLowerCase() : n == Qd || n == wd ? void 0 : null));
}
const Qd = 63,
  wd = 33;
function bd(t, e) {
...
const Sd = [6, 10, 7, 8, 9],
  vd = new lc({
    start: null,
    shift: (t, e, i, n) => (Sd.indexOf(e) > -1 ? new bd(gd(n, 1) || '', t) : t),
    reduce: (t, e) => (20 == e && t ? t.parent : t),
    reuse(t, e, i, n) {
      let s = e.type.id;
      return 6 == s || 36 == s ? new bd(gd(n, 1) || '', t) : t;
    },
    strict: !1,
  }),
  yd = new Uh(
    (t, e) => {
      if (60 != t.next) return void (t.next < 0 && e.context && t.acceptToken(57));
      t.advance();
      let i = 47 == t.next;
      i && t.advance();
      let n = gd(t, 0);
      ...
      if (i) {
        if (n == s) return t.acceptToken(11);
        if (s && cd[s]) return t.acceptToken(57, -2);
        ...
        if (hd.hasOwnProperty(n)) return t.acceptToken(10);
        s && Od[s] && Od[s][n] ? t.acceptToken(57, -1) : t.acceptToken(6);
      }
    },
    { contextual: !0 },
  ),
...
const kd = new Uh((t, e) => {
  if (47 == t.next && 62 == t.peek(1)) {
    let i =
      e.dialectEnabled(1) ||
      (function (t) {
        for (; t; t = t.parent) if ('svg' == t.name || 'math' == t.name) return !0;
        return !1;
      })(e.context);
  ...
  return new Uh((s) => {
    for (let r = 0, o = 0, a = 0; ; a++) {
      ...
      if (
        (0 == r && 60 == s.next) ||
        (1 == r && 47 == s.next) ||
        (r >= 2 && r < n && s.next == t.charCodeAt(r - 2))
      )
        (r++, o++);
      else if ((2 != r && r != n) || !fd(s.next)) {
        if (r == n && 62 == s.next) {
...
const Pd = $d('script', 54, 1),
  ...
  Ad = hc.deserialize({
    ...
    tokenizers: [Pd, Td, Zd, kd, yd, xd, 0, 1, 2, 3, 4, 5],
...
function Md(t, e, i) {
  let n;
  for (let s of i)
    if (!s.attrs || s.attrs(n || (n = Cd(t.node.parent.firstChild, e))))
...
function _d(t = [], e = []) {
  let i = [],
    ...
    r = [];
  for (let e of t) {
    ('script' == e.tag ? i : 'style' == e.tag ? n : 'textarea' == e.tag ? s : r).push(e);
  }
  let o = e.length ? Object.create(null) : null;
  for (let t of e) (o[t.name] || (o[t.name] = [])).push(t);
  return R((t, e) => {
    let a = t.type.id;
    if (28 == a) return Md(t, e, i);
    if (31 == a) return Md(t, e, n);
    if (34 == a) return Md(t, e, s);
    if (20 == a && r.length) {
      let i,
        n = t.node,
        s = n.firstChild,
      ...
      if (o)
        for (let t of r)
          if (t.tag == o && (!t.attrs || t.attrs(i || (i = Cd(s, e))))) {
            let e = n.lastChild,
              i = 37 == e.type.id ? e.from : n.to;
            if (i > s.to) return { parser: t.parser, overlay: [{ from: s.to, to: i }] };
          }
    }
    if (o && 23 == a) {
      let i,
      ...
      if ((i = n.firstChild)) {
        ...
        if (t)
          for (let i of t) {
            if (i.tagName && i.tagName != Rd(n.parent, e)) continue;
            let t = n.lastChild;
            if (26 == t.type.id) {
              let e = t.from + 1,
                n = t.lastChild,
                s = t.to - (n && n.isError ? 0 : 1);
              if (s > e) return { parser: i.parser, overlay: [{ from: e, to: s }] };
            } else if (27 == t.type.id)
              return { parser: i.parser, overlay: [{ from: t.from, to: t.to }] };
          }
      }
    }
    return null;
...
const Yd = [
  ...
  zd = new lc({
    start: !1,
    shift: (t, e) => (5 == e || 6 == e || 320 == e ? t : 321 == e),
    strict: !1,
  }),
  Vd = new Uh(
    (t, e) => {
      let { next: i } = t;
      (125 == i || -1 == i || e.context) && t.acceptToken(318);
    },
    ...
    (t, e) => {
      ...
      Yd.indexOf(n) > -1 ||
        ((47 != n || (47 != (i = t.peek(1)) && 42 != i)) &&
          (125 == n || 59 == n || -1 == n || e.context || t.acceptToken(316)));
    },
    { contextual: !0 },
  ),
  Ed = new Uh(
    (t, e) => {
      91 != t.next || e.context || t.acceptToken(317);
    },
    { contextual: !0 },
  ),
  Dd = new Uh(
    (t, e) => {
      ...
      if (43 == i || 45 == i) {
        ...
        63 == i &&
          46 == t.peek(1) &&
          (t.advance(), t.advance(), (t.next < 48 || t.next > 57) && t.acceptToken(3));
    },
    { contextual: !0 },
  );
function Wd(t, e) {
...
const jd = new Uh((t, e) => {
    ...
    let i = 0;
    for (; Yd.indexOf(t.next) > -1; ) (t.advance(), i++);
    if (Wd(t.next, !0)) {
      for (t.advance(), i++; Wd(t.next, !1); ) (t.advance(), i++);
      for (; Yd.indexOf(t.next) > -1; ) (t.advance(), i++);
      if (44 == t.next) return;
      for (let e = 0; ; e++) {
        if (7 == e) {
          if (!Wd(t.next, !0)) return;
          break;
        }
  ...
  Ld = da({
    ...
    'for while do if else switch try catch finally return throw break continue default case defer':
      _a.controlKeyword,
    'in of await yield void typeof delete instanceof as satisfies': _a.operatorKeyword,
    'let var const using function class extends': _a.definitionKeyword,
    'import export from': _a.moduleKeyword,
    'with debugger new': _a.keyword,
    ...
    Star: _a.modifier,
    VariableName: _a.variableName,
    'CallExpression/VariableName TaggedTemplateExpression/VariableName': _a.function(
      _a.variableName,
    ),
    ...
    'NewExpression/VariableName': _a.className,
    ...
    'is keyof unique infer asserts': _a.operatorKeyword,
  ...
  Nd = hc.deserialize({
    ...
    tokenizers: [
      ...
      new Nh('j~RQYZXz{^~^O(Q~~aP!P!Qd~iO(R~~', 25, 323),
    ],
    topRules: { Script: [0, 7], SingleExpression: [1, 276], SingleClassItem: [2, 277] },
    dialects: { jsx: 0, ts: 15175 },
    dynamicPrecedences: { 80: 1, 82: 1, 94: 1, 169: 1, 199: 1 },
    specialized: [
      { term: 327, get: (t) => Gd[t] || -1 },
      { term: 343, get: (t) => Bd[t] || -1 },
      { term: 95, get: (t) => Id[t] || -1 },
    ],
    tokenPrec: 15201,
  }),
  Ud = [
    UO('function ${name}(${params}) {\n\t${}\n}', {
      label: 'function',
      detail: 'definition',
      type: 'keyword',
    }),
    UO('for (let ${index} = 0; ${index} < ${bound}; ${index}++) {\n\t${}\n}', {
      label: 'for',
      detail: 'loop',
      type: 'keyword',
    }),
    UO('for (let ${name} of ${collection}) {\n\t${}\n}', {
      label: 'for',
      detail: 'of loop',
      type: 'keyword',
    }),
    ...
    UO('import {${names}} from "${module}"\n${}', {
      label: 'import',
      detail: 'named',
      type: 'keyword',
    }),
    UO('import ${name} from "${module}"\n${}', {
      label: 'import',
      detail: 'default',
      type: 'keyword',
    }),
  ...
  Fd = Ud.concat([
    ...
    UO('type ${name} = ${type}', { label: 'type', detail: 'definition', type: 'keyword' }),
...
const tp = ['FunctionDeclaration'],
  ep = {
    FunctionDeclaration: Jd('function'),
    ClassDeclaration: Jd('class'),
    ClassExpression: () => !0,
    EnumDeclaration: Jd('constant'),
    TypeAliasDeclaration: Jd('type'),
    NamespaceDeclaration: Jd('namespace'),
    VariableDefinition(t, e) {
      t.matchContext(tp) || e(t, 'variable');
    },
    TypeDefinition(t, e) {
      e(t, 'type');
    },
  ...
  return (
    e.cursor(c.IncludeAnonymous).iterate((e) => {
      if (s) s = !1;
        ...
        let t = ep[e.name];
        if ((t && t(e, r)) || Kd.has(e.name)) return !1;
      } else if (e.to - e.from > 8192) {
        for (let i of ip(t, e.node)) n.push(i);
        return !1;
      }
    }),
    Hd.set(e, n),
...
function rp(t) {
  let e = ja(t.state).resolveInner(t.pos, -1);
  if (sp.indexOf(e.name) > -1) return null;
  let i =
    'VariableName' == e.name || (e.to - e.from < 20 && np.test(t.state.sliceDoc(e.from, e.to)));
  if (!i && !t.explicit) return null;
  let n = [];
  for (let i = e; i; i = i.parent) Kd.has(i.name) && (n = n.concat(ip(t.state.doc, i)));
  return { options: n, from: i ? e.from : t.pos, validFor: np };
}
function op(t, e, i) {
  var n;
  let s = [];
  for (;;) {
    ...
    if ('VariableName' == (null == o ? void 0 : o.name))
      return (s.push(t(o)), { path: s.reverse(), name: i });
    if (
      'MemberExpression' != (null == o ? void 0 : o.name) ||
      'PropertyName' != (null === (n = r = o.lastChild) || void 0 === n ? void 0 : n.name)
    )
      return null;
    (s.push(t(r)), (e = o));
  }
...
function ap(t) {
  let e = (e) => t.state.doc.sliceString(e.from, e.to),
    i = ja(t.state).resolveInner(t.pos, -1);
  return 'PropertyName' == i.name
    ? op(e, i.parent, e(i))
    : ('.' != i.name && '?.' != i.name) || 'MemberExpression' != i.parent.name
      ? sp.indexOf(i.name) > -1
        ? null
        : 'VariableName' == i.name || (i.to - i.from < 20 && np.test(e(i)))
          ? { path: [], name: e(i) }
...
const lp = Wa.define({
    ...
    parser: Nd.configure({
      props: [
        cl.add({
          IfStatement: wl({ except: /^\s*({|else\b)/ }),
          TryStatement: wl({ except: /^\s*({|catch\b|finally\b)/ }),
          LabeledStatement: Ql,
          SwitchBody: (t) => {
            let e = t.textAfter,
              i = /^\s*\}/.test(e),
        ...
        vl.add({
          'Block ClassBody SwitchBody EnumBody ObjectExpression ArrayExpression ObjectType': yl,
  ...
  hp = {
    ...
    facet: Va({ commentTokens: { block: { open: '{/*', close: '*/}' } } }),
  },
  cp = lp.configure({ dialect: 'ts' }, 'typescript'),
  Op = lp.configure({ dialect: 'jsx', props: [qa.add((t) => (t.isTop ? [hp] : void 0))] }),
  up = lp.configure(
    { dialect: 'jsx ts', props: [qa.add((t) => (t.isTop ? [hp] : void 0))] },
    'typescript',
  );
let fp = (t) => ({ label: t, type: 'keyword' });
const dp =
    'break case const continue default delete export extends false finally in instanceof let new return static super switch this throw true typeof var yield'
      .split(' ')
      .map(fp),
  pp = dp.concat(['declare', 'implements', 'private', 'protected', 'public'].map(fp));
function mp(t = {}) {
  let e = t.jsx ? (t.typescript ? up : Op) : t.typescript ? cp : lp,
    i = t.typescript ? Fd.concat(pp) : Ud.concat(dp);
  return new il(e, [
    lp.data.of({ autocomplete: Ic(sp, Bc(i)) }),
    lp.data.of({ autocomplete: rp }),
    t.jsx ? wp : [],
  ]);
}
function gp(t, e, i = t.length) {
...
const Qp = 'object' == typeof navigator && /Android\b/.test(navigator.userAgent),
  wp = Vr.inputHandler.of((t, e, i, n, s) => {
    if (
      (Qp ? t.composing : t.compositionStarted) ||
      t.state.readOnly ||
      e != i ||
      ('>' != n && '/' != n) ||
      !lp.isActiveAt(t.state, e, -1)
    )
      return !1;
    let r = s(),
      { state: o } = r,
      a = o.changeByRange((t) => {
        ...
        let i,
          { head: s } = t,
          r = ja(o).resolveInner(s - 1, -1);
        if (
          ('JSXStartTag' == r.name && (r = r.parent),
          o.doc.sliceString(s - 1, s) != n || ('JSXAttributeValue' == r.name && r.to > s))
        );
        else {
          if ('>' == n && 'JSXFragmentTag' == r.name)
            return { range: t, changes: { from: s, insert: '</>' } };
          if ('/' == n && 'JSXStartCloseTag' == r.name) {
            let t = r.parent,
              n = t.parent;
            if (
              n &&
              t.from == s - 2 &&
              ((i = gp(o.doc, n.firstChild, s)) ||
                'JSXFragmentTag' == (null === (e = n.firstChild) || void 0 === e ? void 0 : e.name))
            ) {
              let t = `${i}>`;
              return { range: Zt.cursor(s + t.length, -1), changes: { from: s, insert: t } };
            }
          } else if ('>' == n) {
            let e = (function (t) {
              for (;;) {
            ...
            if (e && !/^\/?>|^<\//.test(o.doc.sliceString(s, s + 2)) && (i = gp(o.doc, e, s)))
              return { range: t, changes: { from: s, insert: `</${i}>` } };
          }
        }
        return { range: t };
      });
    return (
      !a.changes.empty &&
      (t.dispatch([r, o.update(a, { userEvent: 'input.complete', scrollIntoView: !0 })]), !0)
    );
  });
function bp(t, e, i, n) {
...
function Sp(t, e, i) {
  let n = bp(t.line, t.column, e, i),
    s = {
      from: n,
      to: null != t.endLine && 1 != t.endColumn ? bp(t.endLine, t.endColumn, e, i) : n,
      message: t.message,
...
var vp = Object.freeze({
  ...
  esLint: function (t, e) {
    return (
      ...
      (i) => {
        let { state: n } = i,
          s = [];
        for (let { from: i, to: r } of lp.findRegions(n)) {
          let o = n.doc.lineAt(i),
            a = { line: o.number - 1, col: i - o.from, pos: i };
          for (let o of t.verify(n.sliceDoc(i, r), e)) s.push(Sp(o, n.doc, a));
        }
        return s;
      }
    );
  ...
  javascript: mp,
  javascriptLanguage: lp,
  jsxLanguage: Op,
  localCompletionSource: rp,
  scopeCompletionSource: function (t) {
    let e = new Map();
    return (i) => {
      let n = ap(i);
      if (!n) return null;
      let s = t;
      for (let t of n.path) if (((s = s[t]), !s)) return null;
      let r = e.get(s);
      return (
        r ||
          e.set(
            ...
            (r = (function (t, e) {
              let i = [],
                n = new Set();
              for (let s = 0; ; s++) {
                for (let r of (Object.getOwnPropertyNames || Object.keys)(t)) {
                  if (!/^[a-zA-Z_$\xaa-\uffdc][\w$\xaa-\uffdc]*$/.test(r) || n.has(r)) continue;
                  let o;
                  n.add(r);
                  try {
                    o = t[r];
        ...
        { from: i.pos - n.name.length, options: r, validFor: np }
      );
    };
  },
  snippets: Ud,
  tsxLanguage: up,
  typescriptLanguage: cp,
  typescriptSnippets: Fd,
});
const yp = ['_blank', '_self', '_top', '_parent'],
  xp = ['ascii', 'utf-8', 'utf-16', 'latin1', 'latin1'],
  kp = ['get', 'post', 'put', 'delete'],
  $p = ['application/x-www-form-urlencoded', 'multipart/form-data', 'text/plain'],
  Pp = ['true', 'false'],
  Tp = {},
  Zp = {
    a: { attrs: { href: null, ping: null, type: null, media: null, target: yp, hreflang: null } },
    abbr: Tp,
    address: Tp,
    area: {
      attrs: {
    ...
    b: Tp,
    base: { attrs: { href: null, target: yp } },
    bdi: Tp,
    bdo: Tp,
  ...
  Ap =
    'beforeunload copy cut dragstart dragover dragleave dragenter dragend drag paste focus blur change click load mousedown mouseenter mouseleave mouseup keydown keyup resize scroll unload'
      .split(' ')
      .map((t) => 'on' + t);
for (let t of Ap) Xp[t] = null;
class Cp {
  constructor(t, e) {
    ((this.tags = { ...Zp, ...t }),
      (this.globalAttrs = { ...Xp, ...e }),
      (this.allTags = Object.keys(this.tags)),
      (this.globalAttrNames = Object.keys(this.globalAttrs)));
  }
}
function Rp(t, e, i = t.length) {
  if (!e) return '';
  let n = e.firstChild,
...
function _p(t, e, i) {
  let n = i.tags[Rp(t, Mp(e))];
  return (null == n ? void 0 : n.children) || i.allTags;
}
function Yp(t, e) {
  let i = [];
  for (let n = Mp(e); n && !n.type.isTop; n = Mp(n.parent)) {
    let s = Rp(t, n);
...
function qp(t, e, i, n) {
  ...
  return {
    from: i,
    to: n,
    options: Yp(t.doc, e).map((t, e) => ({ label: t, apply: t + s, type: 'type', boost: 99 - e })),
    validFor: zp,
  };
}
function Ep(t, e) {
  let { state: i, pos: n } = e,
    s = ja(i).resolveInner(n, -1),
    r = s.resolve(n);
  for (let t, e = n; r == s && (t = s.childBefore(e)); ) {
    let i = t.lastChild;
  ...
  return 'TagName' == s.name
    ...
    : 'StartTag' == s.name
      ? Vp(i, t, s, n, n)
      : 'StartCloseTag' == s.name || 'IncompleteCloseTag' == s.name
        ? qp(i, s, n, n)
        : 'OpenTag' == s.name || 'SelfClosingTag' == s.name || 'AttributeName' == s.name
          ? (function (t, e, i, n, s) {
              let r = Mp(i),
                o = r ? e.tags[Rp(t.doc, r)] : null,
            ...
            })(i, t, s, 'AttributeName' == s.name ? s.from : n, n)
          : 'Is' == s.name || 'AttributeValue' == s.name || 'UnquotedAttributeValue' == s.name
            ? (function (t, e, i, n, s) {
                var r;
                let o,
                  a =
                    null === (r = i.parent) || void 0 === r ? void 0 : r.getChild('AttributeName'),
                  l = [];
                if (a) {
              ...
              })(i, t, s, 'Is' == s.name ? n : s.from, n)
            : !e.explicit || ('Element' != r.name && 'Text' != r.name && 'Document' != r.name)
              ? null
              : (function (t, e, i, n) {
                  let s = [],
                    r = 0;
                  for (let n of _p(t.doc, i, e)) s.push({ label: '<' + n, type: 'type' });
                  for (let e of Yp(t.doc, i))
                    s.push({ label: '</' + e + '>', type: 'type', boost: 99 - r++ });
                  return { from: n, to: n, options: s, validFor: /^<\/?[:\-\.\w\u00b7-\uffff]*$/ };
                })(i, t, s, n);
}
function Dp(t) {
  return Ep(Cp.default, t);
}
function Wp(t) {
  let { extraTags: e, extraGlobalAttributes: i } = t,
    n = i || e ? new Cp(e, i) : Cp.default;
  return (t) => Ep(n, t);
}
const jp = lp.parser.configure({ top: 'SingleExpression' }),
  Lp = [
    {
      tag: 'script',
    ...
    { tag: 'script', attrs: (t) => 'text/typescript-jsx' == t.type, parser: up.parser },
    {
      tag: 'script',
    ...
    },
    {
      tag: 'script',
      attrs: (t) =>
        !t.type || /^(?:text|application)\/(?:x-)?(?:java|ecma)script$|^module$|^$/i.test(t.type),
      parser: lp.parser,
    },
    {
      tag: 'style',
  ...
  Gp = [{ name: 'style', parser: Wc.parser.configure({ top: 'Styles' }) }].concat(
    Ap.map((t) => ({ name: t, parser: lp.parser })),
  ),
  Bp = Wa.define({
    name: 'html',
    parser: Ad.configure({
      props: [
        ...
        lh.add({ 'OpenTag CloseTag': (t) => t.getChild('TagName') }),
      ],
    }),
    languageData: {
...
function Np(t = {}) {
  ...
  (!1 === t.matchClosingTags && (i = 'noMatch'),
    ...
    ((t.nestedLanguages && t.nestedLanguages.length) ||
      ...
      (e = _d((t.nestedLanguages || []).concat(Lp), (t.nestedAttributes || []).concat(Gp))));
  let n = e ? Bp.configure({ wrap: e, dialect: i }) : i ? Ip.configure({ dialect: i }) : Ip;
  return new il(n, [
    Ip.data.of({ autocomplete: Wp(t) }),
    !1 !== t.autoCloseTags ? Fp : [],
    mp().support,
    jc().support,
  ]);
}
const Up = new Set(
  ...
  Fp = Vr.inputHandler.of((t, e, i, n, s) => {
    if (
      t.composing ||
      t.state.readOnly ||
      e != i ||
      ('>' != n && '/' != n) ||
      !Ip.isActiveAt(t.state, e, -1)
    )
      return !1;
    let r = s(),
      { state: o } = r,
      a = o.changeByRange((t) => {
        ...
        let r,
          ...
          { head: l } = t,
          h = ja(o).resolveInner(l, -1);
        if (a && '>' == n && 'EndTag' == h.name) {
          let n = h.parent;
          if (
            'CloseTag' !=
              (null === (i = null === (e = n.parent) || void 0 === e ? void 0 : e.lastChild) ||
              void 0 === i
                ? void 0
                : i.name) &&
            (r = Rp(o.doc, n.parent, l)) &&
            !Up.has(r)
          ) {
            return {
              range: t,
          ...
          if (
            h.from == l - 2 &&
            'CloseTag' != (null === (s = t.lastChild) || void 0 === s ? void 0 : s.name) &&
            (r = Rp(o.doc, t, l)) &&
            !Up.has(r)
          ) {
            let t = l + ('>' === o.doc.sliceString(l, l + 1) ? 1 : 0),
              e = `${r}>`;
            return { range: Zt.cursor(l + e.length, -1), changes: { from: l, to: t, insert: e } };
          }
        }
        return { range: t };
      });
...
var Hp = Object.freeze({
  ...
  autoCloseTags: Fp,
  html: Np,
  htmlCompletionSource: Dp,
  htmlCompletionSourceWith: Wp,
  htmlLanguage: Ip,
});
const Kp = 'function' == typeof String.prototype.normalize ? (t) => t.normalize('NFKD') : (t) => t;
class Jp {
...
function im(t) {
  let e = [am, om];
  return (t && e.push(em.of(t)), e);
}
const nm = Hi.mark({ class: 'cm-selectionMatch' }),
  sm = Hi.mark({ class: 'cm-selectionMatch cm-selectionMatch-main' });
function rm(t, e, i, n) {
  return !(
    (0 != i && t(e.sliceDoc(i - 1, i)) == me.Word) ||
    (n != e.doc.length && t(e.sliceDoc(n, n + 1)) == me.Word)
  );
}
const om = Dn.fromClass(
    class {
      constructor(t) {
      ...
      getDeco(t) {
        let e = t.state.facet(em),
          { state: i } = t,
          n = i.selection;
        if (n.ranges.length > 1) return Hi.none;
        let s,
          r = n.main,
          o = null;
        if (r.empty) {
          if (!e.highlightWordAroundCursor) return Hi.none;
          let t = i.wordAt(r.head);
          if (!t) return Hi.none;
          ((o = i.charCategorizer(r.head)), (s = i.sliceDoc(t.from, t.to)));
        } else {
          let t = r.to - r.from;
          if (t < e.minSelectionLength || t > 200) return Hi.none;
          if (e.wholeWords) {
            if (
              ...
              !rm(o, i, r.from, r.to) ||
                !(function (t, e, i, n) {
                  return t(e.sliceDoc(i, i + 1)) == me.Word && t(e.sliceDoc(n - 1, n)) == me.Word;
                })(o, i, r.from, r.to))
            )
              return Hi.none;
          } else if (((s = i.sliceDoc(r.from, r.to).trim()), !s)) return Hi.none;
        }
        let a = [];
        for (let n of t.visibleRanges) {
          let t = new Jp(i.doc, s, n.from, n.to);
          for (; !t.next().done; ) {
            ...
            if (
              ...
              (r.empty && n <= r.from && s >= r.to
                ? a.push(sm.range(n, s))
                : (n >= r.to || s <= r.from) && a.push(nm.range(n, s)),
...
const lm = ({ state: t, dispatch: e }) => {
  let { ranges: i } = t.selection;
  if (i.some((t) => t.from === t.to))
    return (({ state: t, dispatch: e }) => {
      let { selection: i } = t,
        n = Zt.create(
          i.ranges.map((e) => t.wordAt(e.head) || Zt.cursor(e.head)),
          i.mainIndex,
        );
  ...
  let s = (function (t, e) {
    ...
    for (let i = !1, s = new Jp(t.doc, e, n[n.length - 1].to); ; ) {
      if ((s.next(), !s.done)) {
      ...
      if (i) return null;
      ((s = new Jp(t.doc, e, 0, Math.max(0, n[n.length - 1].from - 1))), (i = !0));
    }
  })(t, n);
  return (
    !!s &&
    (e(
      t.update({
        selection: t.selection.addRange(Zt.range(s.from, s.to), !1),
        effects: Vr.scrollIntoView(s.to),
      }),
    ),
    !0)
  );
...
const Om = Ct.define({
  combine: (t) =>
    Se(t, { highlightActiveBlock: !0, hideFirstIndent: !1, markerType: 'fullScope', thickness: 1 }),
});
class um {
  constructor(t, e, i, n) {
    ((this.lines = t),
      ...
      (this.unitWidth = i),
      (this.markerType = n));
    for (const t of this.lines) this.add(t);
    this.state.facet(Om).highlightActiveBlock && this.findAndSetActiveLines();
  }
  has(t) {
  ...
  set(t, e, i) {
    const n = !t.text.trim().length,
      s = { line: t, col: e, level: i, empty: n };
  ...
  add(t) {
    ...
    const e = cm(t.text, this.state.tabSize),
  ...
  closestNonEmpty(t, e) {
    ...
    const n = this.state.doc.line(-1 === e ? 1 : this.state.doc.lines);
    return this.set(n, 0, 0);
  }
  findAndSetActiveLines() {
    const t = hm(this.state);
...
function fm(t) {
  const e = { light: '#F0F1F2', dark: '#2B3245', activeLight: '#E4E5E6', activeDark: '#3C445C' };
  let i = e;
  return (
...
function dm(t, e, i, n, s) {
  return `${`repeating-linear-gradient(to right, var(${t}) 0 ${e}px, transparent ${e}px ${i}ch)`} ${n * i}.5ch/calc(${i * s}ch - 1px) no-repeat`;
}
function pm(t, e, i, n) {
  ...
  if (void 0 !== r) {
    const t = r - o - 1;
    (t > 0 && a.push(dm('--indent-marker-bg-color', n, e, o, t)),
      a.push(dm('--indent-marker-active-bg-color', n, e, r - 1, 1)),
      r !== s && a.push(dm('--indent-marker-bg-color', n, e, r, s - r)));
  } else a.push(dm('--indent-marker-bg-color', n, e, o, s - o));
  return a.join(',');
}
class mm {
  constructor(t) {
    ((this.view = t),
      (this.unitWidth = ol(t.state)),
      (this.currentLineNumber = hm(t.state).number),
  ...
  update(t) {
    const e = ol(t.state),
      i = e !== this.unitWidth;
    i && (this.unitWidth = e);
    const n = hm(t.state).number,
      s = n !== this.currentLineNumber;
    this.currentLineNumber = n;
    const r = t.state.facet(Om).highlightActiveBlock && s;
    (t.docChanged || t.viewportChanged || i || r) && this.generate(t.state);
  }
  generate(t) {
    const e = new Pe(),
      i = (function (t, e = t.state) {
        const i = new Set();
        for (const { from: n, to: s } of t.visibleRanges) {
          let t = n;
          for (; t <= s; ) {
      ...
      { hideFirstIndent: n, markerType: s, thickness: r } = t.facet(Om),
      o = new um(i, t, this.unitWidth, s);
    for (const t of i) {
      const i = o.get(t.number);
      if (!(null == i ? void 0 : i.level)) continue;
      const s = pm(i, this.unitWidth, n, r);
      e.add(
        t.from,
        t.from,
        Hi.line({ class: 'cm-indent-markers', attributes: { style: `--indent-markers: ${s}` } }),
      );
    }
...
function gm(t = {}) {
  return [Om.of(t), fm(t.colors), Dn.fromClass(mm, { decorations: (t) => t.decorations })];
}
function Qm() {
  return import('./angular.js');
}
async function wm() {
  return gh.define(
    (
...
const vm = Wa.define({
  ...
  ym = {
    cssCompletionSource: Dc,
    cssLanguage: vm,
    css: () => new il(vm, vm.data.of({ autocomplete: Dc })),
  };
async function xm() {
  return gh.define(
    (
