...
function u(e, t) {
  ...
  if (e.match(s)) return [null, 'number'];
...
const g = {
  name: 'clojure',
  startState: function () {
    return { ctx: { prev: null, start: 0, indentTo: 0 }, lastToken: null, tokenize: u };
  },
  token: function (e, t) {
...
var N = /^('{3}|\"{3}|['\"])/,
  C = /^(\/{3}|\/)/,
  j = k(['Infinity', 'NaN', 'undefined', 'null', 'true', 'false', 'on', 'off', 'yes', 'no']);
function q(e, t) {
  if (e.sol()) {
  ...
  if (e.match(C)) {
    if ('/' != e.current() || e.match(/^.*\//, !1))
      return ((t.tokenize = E(e.current(), !0, 'string.special')), t.tokenize(e, t));
    e.backUp(1);
  }
  return e.match(w) || e.match(z)
    ? 'operator'
    : e.match(v)
      ? 'punctuation'
      : e.match(j)
        ? 'atom'
        : e.match(_) || (t.prop && e.match(x))
          ? 'property'
          : e.match(S)
            ? 'keyword'
            : e.match(x)
...
function D(e, t, n = 'coffee') {
  for (var r = 0, o = !1, a = null, i = t.scope; i; i = i.prev)
    if ('coffee' === i.type || '}' == i.type) {
      r = i.offset + e.indentUnit;
      break;
    }
  ('coffee' !== n
    ? ((o = null), (a = e.column() + e.current().length))
    : t.scope.align && (t.scope.align = !1),
    (t.scope = { offset: r, type: n, prev: t.scope, align: o, alignOffset: a }));
}
function P(e, t) {
  if (t.scope.prev) {
  ...
  token: function (e, t) {
    ...
    var r = (function (e, t) {
      var n = t.tokenize(e, t),
        r = e.current();
      ('return' === r && (t.dedent = !0),
        ((('->' === r || '=>' === r) && e.eol()) || 'indent' === n) && D(e, t));
      var o = '[({'.indexOf(r);
      if (
        (-1 !== o && D(e, t, '])}'.slice(o, o + 1)),
        T.exec(r) && D(e, t),
        'then' == r && P(e, t),
        'dedent' === n && P(e, t))
      )
...
var L = Object.freeze({ __proto__: null, coffeeScript: I });
...
function M(e, t, n, r) {
  var o = e.indented;
  return (
    e.context && 'statement' == e.context.type && 'statement' != n && (o = e.context.indented),
    (e.context = new A(o, t, n, r, null, e.context))
  );
}
function F(e) {
...
function K(e) {
  var t,
    ...
    m = !1 !== e.indentSwitch,
    h = e.namespaceSeparator,
    g = e.isPunctuationChar || /[\[\]{}\(\),;\:\.]/,
    b = e.numberStart || /[\d\.]/,
    y = e.number || /^(?:0x[a-f\d]+|0b[01]+|(?:\d+\.?\d*|\.\d+)(?:e[-+]?\d+)?)(u|ll?|l|f)?/i,
    k = e.isOperatorChar || /[+\-*&%=<>!?|\/]/,
    w = e.isIdentifierChar || /[\w\$_\xa1-\uffff]/,
  ...
  function x(e, r) {
      ...
      return (
        (r.tokenize =
          ...
          function (e, t) {
            ...
            return ((a || (!r && !p)) && (t.tokenize = null), 'string');
          })),
        r.tokenize(e, r)
      );
    if (b.test(f)) {
    ...
    var x = e.current();
    return U(a, x)
      ? (U(s, x) && (t = 'newstatement'), U(c, x) && (n = !0), 'keyword')
      : U(i, x)
        ? 'type'
        : U(l, x) || (v && v(x))
          ? (U(s, x) && (t = 'newstatement'), 'builtin')
          : U(d, x)
            ? 'atom'
            : 'variable';
  }
  ...
  return {
    ...
    token: function (r, o) {
      ...
      if (
        (r.sol() &&
          (null == a.align && (a.align = !1), (o.indented = r.indentation()), (o.startOfLine = !0)),
        r.eatSpace())
      )
        return (z(r, o), null);
      t = n = null;
      ...
      if (
        ...
        for (; 'statement' == o.context.type; ) F(o);
        ...
        t == a.type
          ...
          : f &&
            ((('}' == a.type || 'top' == a.type) && ';' != t) ||
              ('statement' == a.type && 'newstatement' == t)) &&
            M(o, r.column(), 'statement', r.current());
      if (
        ('variable' == i &&
          ('def' == o.prevToken ||
      ...
      return (
        'def' == i && !1 === e.styleDefs && (i = 'variable'),
        (o.startOfLine = !1),
        (o.prevToken = n ? 'def' : i || t),
        z(r, o),
        i
      );
    },
    indent: function (t, n, a) {
      if ((t.tokenize != x && null != t.tokenize) || (t.typeAtEndOfLine && B(t.context)))
        return null;
      var i = t.context,
        l = n && n.charAt(0),
        s = l == i.type;
      if (('statement' == i.type && '}' == l && (i = i.prev), e.dontIndentStatements))
        for (; 'statement' == i.type && e.dontIndentStatements.test(i.info); ) i = i.prev;
      if (u.indent) {
      ...
      return 'statement' == i.type
        ? i.indented + ('{' == l ? 0 : r || a.unit)
        : !i.align || (o && ')' == i.type)
          ? ')' != i.type || s
            ? i.indented +
              (s ? 0 : a.unit) +
              (s || !d || /^(?:case|default)\b/.test(n) ? 0 : a.unit)
            : i.indented + (r || a.unit)
          : i.column + (s ? 0 : 1);
    },
    languageData: {
      indentOnInput: m ? /^\s*(?:case .*?:|default:|\{\}?|\})$/ : /^\s*[{}]$/,
      commentTokens: { line: '//', block: { open: '/*', close: '*/' } },
      autocomplete: Object.keys(a)
...
var W =
  ...
  G = R('int long char short double float unsigned signed void bool'),
  Y = R('SEL instancetype id Class Protocol BOOL');
function H(e) {
...
var J = 'case do else for if switch while struct enum union',
  ee = 'struct enum union';
function te(e, t) {
  ...
  return function (t, n) {
    for (var r; (r = t.next()); ) {
      if ('*' == r && t.eat('/')) {
        ...
        return ((n.tokenize = de(e - 1)), n.tokenize(t, n));
      }
      if ('/' == r && t.eat('*')) return ((n.tokenize = de(e + 1)), n.tokenize(t, n));
    }
    return 'comment';
  };
}
(K({
  ...
  K({
    ...
    hooks: {
      ...
      '"': function (e, t) {
        return !!e.match(/""$/) && ((t.tokenize = ce), t.tokenize(e, t));
      },
    },
  }),
  K({
  ...
  hooks: {
    ...
    '=': function (e, t) {
      ...
      return (
        ...
        ((t.context = new A(n.indented, n.column, n.type, n.info, null, n.prev)), 'operator')
      );
    },
    '/': function (e, t) {
      return !!e.eat('*') && ((t.tokenize = de(1)), t.tokenize(e, t));
    },
  },
...
(K({
  ...
  K({
    ...
    builtin: R(X),
    blockKeywords: R(
      J + ' @synthesize @try @catch @finally @autoreleasepool @synchronized class try catch',
    ),
...
function be(e, t, n, r) {
  ...
  function a(t, n) {
    for (var a = !1; !t.eol(); ) {
      if (!r && !a && '$' == t.peek()) return (he(n), (n.tokenize = ye), 'string');
      var i = t.next();
      if (i == e && !a && (!o || t.match(e + e))) {
        n.tokenize = null;
        break;
      }
      a = !r && !a && '\\' == i;
...
function ke(e, t) {
  return (e.eatWhile(/[\w_]/), (t.tokenize = ge(t)), 'variable');
}
K({
  name: 'ceylon',
  keywords: R(
  ...
  hooks: {
    ...
    '"': function (e, t) {
      return ((t.tokenize = me(e.match('""') ? 'triple' : 'single')), t.tokenize(e, t));
    },
    '`': function (e, t) {
      return !(!fe || !e.match('`')) && ((t.tokenize = fe), (fe = null), t.tokenize(e, t));
    },
    "'": function (e) {
      return e.match(/^(\\[^'\s]+|[^\\'])'/)
        ? 'string.special'
...
var ve = Object.freeze({ __proto__: null, clike: K, dart: we, kotlin: pe, scala: ue });
function xe(e) {
  var t,
    n,
    r = (e = { ...Re, ...e }).inline,
    ...
    u = e.fontProperties || {},
    p = e.counterDescriptors || {},
    f = e.colorKeywords || {},
    m = e.valueKeywords || {},
    h = e.allowNested,
    g = e.lineComment,
    b = !0 === e.supportsAtComponent,
    y = !1 !== e.highlightNonStandardPropertyKeywords;
  function k(e, n) {
    return ((t = n), e);
  }
  function w(e, t) {
  ...
  function C(e) {
    ...
    n = m.hasOwnProperty(t) ? 'atom' : f.hasOwnProperty(t) ? 'keyword' : 'variable';
  }
  var j = {
    top: function (e, t, r) {
    ...
    block: function (e, t, r) {
      if ('word' == e) {
        ...
        return c.hasOwnProperty(o)
          ...
          : d.hasOwnProperty(o)
            ? ((n = y ? 'string.special' : 'property'), 'maybeprop')
            : h
              ? ((n = t.match(/^\s*:(?:\s|$)/, !1) ? 'property' : 'tag'), 'block')
              : ((n = 'error'), 'maybeprop');
      }
      return 'meta' == e
        ? 'block'
        : h || ('hash' != e && 'qualifier' != e)
          ? j.top(e, t, r)
          : ((n = 'error'), 'block');
    },
    ...
    documentTypes: function (e, t, r) {
      return 'word' == e && a.hasOwnProperty(t.current())
    ...
    atComponentBlock: function (e, t, r) {
      return '}' == e
        ? N(e, t, r)
        : '{' == e
          ? T(r) && z(r, t, h ? 'block' : 'top', !1)
          : ('word' == e && (n = 'error'), r.context.type);
    },
    ...
    restricted_atBlock: function (e, t, r) {
      return '}' == e
        ...
        : 'word' == e
          ? ((n =
              ('@font-face' == r.stateArg && !u.hasOwnProperty(t.current().toLowerCase())) ||
              ('@counter-style' == r.stateArg && !p.hasOwnProperty(t.current().toLowerCase()))
                ? 'error'
                : 'property'),
            'maybeprop')
          : 'restricted_atBlock';
    ...
    at: function (e, t, r) {
      return ';' == e
        ...
        : '{' == e || '}' == e
          ? N(e, t, r)
          : ('word' == e ? (n = 'tag') : 'hash' == e && (n = 'builtin'), 'at');
    },
  ...
  return {
    ...
    token: function (e, r) {
      ...
      return (
        ...
        (n = o),
        'comment' != t && (r.state = j[r.state](t, e, r)),
        n
      );
    },
      ...
      return (
        ...
        r.prev &&
          ...
          ('block' != r.type &&
            ...
            ? ((')' != o || ('parens' != r.type && 'atBlock_parens' != r.type)) &&
                ('{' != o || ('at' != r.type && 'atBlock' != r.type))) ||
              (a = Math.max(0, r.indent - n.unit))
            : (a = (r = r.prev).indent)),
        a
      );
    },
...
var ze = ['domain', 'regexp', 'url', 'url-prefix'],
  Te = _e(ze),
  Se = [
    'all',
    'aural',
  ...
  Be = _e($e),
  Ke = ze.concat(Se).concat(Ce).concat(qe).concat(Oe).concat(Pe).concat(Me).concat($e);
const Re = {
    documentTypes: Te,
    mediaTypes: Ne,
    mediaFeatures: je,
    ...
    fontProperties: Le,
    counterDescriptors: Ae,
    colorKeywords: Fe,
    valueKeywords: Be,
    tokenHooks: {
      '/': function (e, t) {
        return !!e.eat('*') && ((t.tokenize = We), We(e, t));
      },
    },
  },
  Ue = xe({ name: 'css' });
...
var Ze,
  Xe = Object.freeze({ __proto__: null, css: Ue, gss: Ve, mkCSS: xe }),
  Ge = {
    break: !0,
    case: !0,
    chan: !0,
...
function Qe(e, t) {
    ...
    return (
      (t.tokenize =
        ...
        function (e, t) {
          ...
          return ((a || (!o && '`' != n)) && (t.tokenize = Qe), 'string');
        })),
      t.tokenize(e, t)
    );
  if (/[\d\.]/.test(r))
  ...
  if (/[\[\]{}\(\),;\:\.]/.test(r)) return ((Ze = r), null);
  if ('/' == r) {
    if (e.eat('*')) return ((t.tokenize = Je), Je(e, t));
    if (e.eat('/')) return (e.skipToEnd(), 'comment');
  }
  if (He.test(r)) return (e.eatWhile(He), 'operator');
  e.eatWhile(/[\w\$_\xa1-\uffff]/);
  var o = e.current();
  return Ge.propertyIsEnumerable(o)
    ? (('case' != o && 'default' != o) || (Ze = 'case'), 'keyword')
    : Ye.propertyIsEnumerable(o)
      ? 'atom'
      : 'variable';
}
function Je(e, t) {
...
function tt(e, t, n) {
  return (e.context = new et(e.indented, t, n, null, e.context));
}
function nt(e) {
  if (e.context.prev) {
    var t = e.context.type;
...
const rt = {
  name: 'go',
  startState: function (e) {
    return { tokenize: null, context: new et(-e, 0, 'top', !1), indented: 0, startOfLine: !0 };
  },
  token: function (e, t) {
    var n = t.context;
    if (
        ...
        '{' == Ze
          ...
          : '[' == Ze
            ...
            : '(' == Ze
              ...
              : 'case' == Ze
                ? (n.type = 'case')
                : (('}' == Ze && '}' == n.type) || Ze == n.type) && nt(t),
        (t.startOfLine = !1)),
      r
    );
  },
  indent: function (e, t, n) {
    if (e.tokenize != Qe && null != e.tokenize) return null;
    var r = e.context,
      o = t && t.charAt(0);
...
var ot = Object.freeze({ __proto__: null, go: rt }),
  at = {};
function it(e, t) {
  for (var n = 0; n < t.length; n++) at[t[n]] = e;
}
var lt = ['true', 'false'],
  st = [
    'if',
...
function dt(e, t) {
  ...
  if ("'" === o || '"' === o || '`' === o)
    return (t.tokens.unshift(ut(o, '`' === o ? 'quote' : 'string')), mt(e, t));
  if ('#' === o) return r && e.eat('!') ? (e.skipToEnd(), 'meta') : (e.skipToEnd(), 'comment');
  if ('$' === o) return (t.tokens.unshift(ft), mt(e, t));
  ...
  e.eatWhile(/[\w-]/);
  var i = e.current();
  return '=' === e.peek() && /\w+/.test(i) ? 'def' : at.hasOwnProperty(i) ? at[i] : null;
}
function ut(e, t) {
  var n = '(' == e ? ')' : '{' == e ? '}' : e;
  return function (r, o) {
    for (var a, i = !1; null != (a = r.next()); ) {
      ...
      if ('$' === a && !i && "'" !== e && r.peek() != n) {
        ((i = !0), r.backUp(1), o.tokens.unshift(ft));
        break;
      }
      if (!i && e !== n && a === e) return (o.tokens.unshift(ut(e, t)), mt(r, o));
      if (!i && /['"]/.test(a) && !/['"]/.test(e)) {
        (o.tokens.unshift(pt(a, 'string')), r.backUp(1));
        break;
      }
      i = !i && '\\' === a;
    }
...
function pt(e, t) {
  return function (n, r) {
    return ((r.tokens[0] = ut(e, t)), n.next(), mt(n, r));
  };
}
(it('atom', lt), it('keyword', st), it('builtin', ct));
var ft = function (e, t) {
  t.tokens.length > 1 && e.eat('$');
  var n = e.next();
  return /['"({]/.test(n)
    ? ((t.tokens[0] = ut(n, '(' == n ? 'quote' : '{' == n ? 'def' : 'string')), mt(e, t))
    : (/\d/.test(n) || e.eatWhile(/\w/), t.tokens.shift(), 'def');
};
function mt(e, t) {
  return (t.tokens[0] || dt)(e, t);
}
const ht = {
  name: 'shell',
  startState: function () {
  ...
  languageData: {
    autocomplete: lt.concat(st, ct),
    closeBrackets: { brackets: ['(', '[', '{', "'", '"', '`'] },
    commentTokens: { line: '#' },
  },
};
var gt = Object.freeze({ __proto__: null, shell: ht });
export { L as a, ve as b, b as c, Xe as d, ot as g, gt as s };
