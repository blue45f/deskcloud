...
function Q(O, r, e) {
  return new p((t) => {
    ...
    for (
      ;
      t.next != O && t.next >= 0 && (e || (38 != t.next && (123 != t.next || 123 != t.peek(1))));
    )
      t.advance();
...
const S = Q(39, 33, !1),
  ...
  P = n.deserialize({
    ...
    tokenizers: [l, S, s, u, q, 0, 1],
    topRules: { Content: [0, 2], Attribute: [1, 9] },
    tokenPrec: 0,
  }),
  R = i.parser.configure({ top: 'SingleExpression' }),
  $ = P.configure({
    props: [
      a({
        Text: o.content,
        ...
        'AttributeValue ExpressionAttributeValue StatementAttributeValue': o.attributeValue,
        Entity: o.character,
        InvalidEntity: o.invalid,
        'BoundAttributeName/Identifier': o.attributeName,
        'EventName/Identifier': o.special(o.attributeName),
        'ReferenceName/Identifier': o.variableName,
        'DirectiveName/Identifier': o.keyword,
        '{{ }}': o.brace,
        '( )': o.paren,
        '[ ]': o.bracket,
        "# '*'": o.punctuation,
  ...
  g = { parser: R },
  c = { parser: i.parser },
  b = { parser: $.configure({ wrap: t((O, r) => ('InterpolationContent' == O.name ? g : null)) }) },
  m = {
    parser: $.configure({
      wrap: t((O, r) => {
        var e;
  ...
  v = e();
function W(O) {
  return O.configure({ wrap: t(f) }, 'angular');
}
const d = W(v.language);
function f(O, r) {
  switch (O.name) {
    case 'Attribute':
...
function C(e = {}) {
  let t = v;
  if (e.base) {
    if ('html' != e.base.language.name || !(e.base.language instanceof O))
      throw new RangeError('The base option must be the result of calling html(...)');
    t = e.base;
  }
  return new r(t.language == v.language ? d : W(t.language), [
    t.support,
    t.language.data.of({
...
export { C as angular, d as angularLanguage };
