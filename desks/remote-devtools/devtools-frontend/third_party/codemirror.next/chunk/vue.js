...
const l = a.deserialize({
  ...
  u = l.configure({
    props: [
      n({
        ...
        VueAttributeName: o.keyword,
        Identifier: o.variableName,
        'AttributeValue ScriptAttributeValue': o.attributeValue,
        Entity: o.character,
        '{{ }}': o.brace,
        '@ :': o.punctuation,
      }),
  ...
  m = { parser: p },
  S = { parser: u.configure({ wrap: r((O, t) => ('InterpolationContent' == O.name ? m : null)) }) },
  b = {
    parser: u.configure({
      wrap: r((O, t) => ('AttributeScript' == O.name ? m : null)),
      top: 'Attribute',
    }),
  },
  c = e();
function Q(O) {
  return O.configure({ dialect: 'selfClosing', wrap: r(y) }, 'vue');
}
const P = Q(c.language);
function y(O, t) {
  switch (O.name) {
    case 'Attribute':
...
function X(e = {}) {
  ...
  return new t(r.language == c.language ? P : Q(r.language), [
    r.support,
    r.language.data.of({ closeBrackets: { brackets: ['{', '"'] } }),
  ]);
}
export { X as vue, P as vueLanguage };
