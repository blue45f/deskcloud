import { L as e, a as O, b as o, i as b, f as r, s, d as P, g as t, t as a } from './codemirror.js';
const S = {
    __proto__: null,
    anyref: 34,
    dataref: 34,
  ...
  i = e.define({
    ...
    parser: Q.configure({
      props: [
        b.add({ App: P({ closing: ')', align: !1 }) }),
        r.add({ App: t, BlockComment: (e) => ({ from: e.from + 2, to: e.to - 2 }) }),
        s({
          Keyword: a.keyword,
          Type: a.typeName,
          Number: a.number,
...
export { n as wast, i as wastLanguage };
