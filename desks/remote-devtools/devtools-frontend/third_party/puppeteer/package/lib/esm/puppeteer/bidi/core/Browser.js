  ...
  return class Browser extends _classSuper {
    static {
      ...
      __esDecorate(
        ...
        _removeIntercept_decorators,
        {
          ...
          static: false,
          private: false,
          access: { has: (obj) => 'removeIntercept' in obj, get: (obj) => obj.removeIntercept },
          metadata: _metadata,
        },
        null,
        _instanceExtraInitializers,
      ...
      __esDecorate(
        ...
        _createUserContext_decorators,
        {
          ...
          static: false,
          private: false,
          access: { has: (obj) => 'createUserContext' in obj, get: (obj) => obj.createUserContext },
          metadata: _metadata,
        },
        null,
        _instanceExtraInitializers,
      ...
      __esDecorate(
        this,
        null,
        _installExtension_decorators,
        {
          kind: 'method',
          name: 'installExtension',
          static: false,
          private: false,
          access: { has: (obj) => 'installExtension' in obj, get: (obj) => obj.installExtension },
          metadata: _metadata,
        },
        null,
        _instanceExtraInitializers,
      ...
      __esDecorate(
        this,
        null,
        _uninstallExtension_decorators,
        {
          kind: 'method',
      ...
      __esDecorate(
        this,
        null,
        _setClientWindowState_decorators,
        {
          kind: 'method',
      ...
      __esDecorate(
        this,
        null,
        _getClientWindowInfo_decorators,
        {
          kind: 'method',
    ...
    async #syncBrowsingContexts() {
      ...
      let contexts;
      {
        ...
        try {
          const sessionEmitter = __addDisposableResource(
            env_1,
