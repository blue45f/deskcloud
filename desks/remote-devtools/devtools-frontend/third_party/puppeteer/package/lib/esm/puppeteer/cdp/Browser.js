...
export class CdpBrowser extends BrowserBase {
  ...
  async _attach(downloadBehavior) {
    ...
    this.#targetManager.on(
      'targetAvailable' /* TargetManagerEvent.TargetAvailable */,
      this.#onAttachedToTarget,
    );
    this.#targetManager.on(
      'targetGone' /* TargetManagerEvent.TargetGone */,
      this.#onDetachedFromTarget,
    );
    this.#targetManager.on(
      'targetChanged' /* TargetManagerEvent.TargetChanged */,
      this.#onTargetChanged,
    );
    this.#targetManager.on(
      'targetDiscovered' /* TargetManagerEvent.TargetDiscovered */,
  ...
  #onAttachedToTarget = async (target) => {
    if (
      ...
      (await target._initializedDeferred.valueOrThrow()) === InitializationStatus.SUCCESS
    ) {
  ...
  #onDetachedFromTarget = async (target) => {
    ...
    if (
      ...
      target
        .browserContext()
        .emit('targetdestroyed' /* BrowserContextEvent.TargetDestroyed */, target);
    }
  };
