...
let BidiBrowser = (() => {
  ...
  return class BidiBrowser extends _classSuper {
    static {
      ...
      __esDecorate(
        this,
        (_private_trustedEmitter_descriptor = {
        ...
        _private_trustedEmitter_initializers,
    ...
    static async create(opts) {
      ...
      await Promise.all(
        [
          'request' /* Bidi.Network.DataType.Request */,
          'response' /* Bidi.Network.DataType.Response */,
        ].map(
    ...
    #createBrowserContext(userContext) {
      ...
      browserContext.trustedEmitter.on(
        'targetcreated' /* BrowserContextEvent.TargetCreated */,
        (target) => {
