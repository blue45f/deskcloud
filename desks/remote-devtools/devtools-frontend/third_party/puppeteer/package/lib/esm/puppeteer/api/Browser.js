...
export class Browser extends EventEmitter {
  ...
  async waitForTarget(predicate, options = {}) {
    ...
    return await firstValueFrom(
      merge(
        fromEmitterEvent(this, 'targetcreated' /* BrowserEvent.TargetCreated */),
        fromEmitterEvent(this, 'targetchanged' /* BrowserEvent.TargetChanged */),
        from(this.targets()),
      ).pipe(filterAsync(predicate), raceWith(fromAbortSignal(signal), timeout(ms))),
    );
  }
  /**
