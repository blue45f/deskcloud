...
export class QueryHandler {
  ...
  static async queryOne(element, selector) {
    ...
    try {
      const result = __addDisposableResource(
        env_2,
        await element.evaluateHandle(
          this._querySelector,
          selector,
  ...
  static async waitFor(elementOrFrame, selector, options) {
    ...
    try {
      let frame;
      const element = __addDisposableResource(
        env_3,
        await (async () => {
      ...
      try {
        ...
        try {
          ...
          const handle = __addDisposableResource(
            env_4,
            await frame.isolatedRealm().waitForFunction(
        ...
        const waitForSelectorError = new (error instanceof TimeoutError ? TimeoutError : Error)(
