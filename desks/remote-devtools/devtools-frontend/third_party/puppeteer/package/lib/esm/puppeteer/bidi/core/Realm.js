  ...
  return class Realm extends _classSuper {
    static {
      ...
      __esDecorate(
        ...
        _disown_decorators,
        {
          ...
          static: false,
          private: false,
          access: { has: (obj) => 'disown' in obj, get: (obj) => obj.disown },
          metadata: _metadata,
        },
        null,
        _instanceExtraInitializers,
      ...
      __esDecorate(
        ...
        _callFunction_decorators,
        {
          ...
          static: false,
          private: false,
          access: { has: (obj) => 'callFunction' in obj, get: (obj) => obj.callFunction },
          metadata: _metadata,
        },
        null,
        _instanceExtraInitializers,
    ...
    async resolveExecutionContextId() {
      if (!this.executionContextId) {
        const { result } = await this.session.connection.send('goog:cdp.resolveRealm', {
          realm: this.id,
        });
