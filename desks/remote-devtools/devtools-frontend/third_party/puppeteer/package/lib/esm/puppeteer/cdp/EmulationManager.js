...
let EmulationManager = (() => {
  ...
  return class EmulationManager {
    static {
      ...
      __esDecorate(
        ...
        _private_applyViewport_decorators,
        {
          ...
          static: false,
          private: true,
          access: { has: (obj) => #applyViewport in obj, get: (obj) => obj.#applyViewport },
          metadata: _metadata,
        },
        null,
      ...
      __esDecorate(
        ...
        _private_emulateIdleState_decorators,
        {
          ...
          static: false,
          private: true,
          access: { has: (obj) => #emulateIdleState in obj, get: (obj) => obj.#emulateIdleState },
          metadata: _metadata,
        },
        null,
        _instanceExtraInitializers,
      ...
      __esDecorate(
        ...
        _private_emulateTimezone_decorators,
        {
          ...
          static: false,
          private: true,
          access: { has: (obj) => #emulateTimezone in obj, get: (obj) => obj.#emulateTimezone },
          metadata: _metadata,
        },
        null,
        _instanceExtraInitializers,
      ...
      __esDecorate(
        ...
        _private_emulateMediaType_decorators,
        {
          ...
          static: false,
          private: true,
          access: { has: (obj) => #emulateMediaType in obj, get: (obj) => obj.#emulateMediaType },
          metadata: _metadata,
        },
        null,
        _instanceExtraInitializers,
      ...
      __esDecorate(
        ...
        _private_setGeolocation_decorators,
        {
          ...
          static: false,
          private: true,
          access: { has: (obj) => #setGeolocation in obj, get: (obj) => obj.#setGeolocation },
          metadata: _metadata,
        },
        null,
        _instanceExtraInitializers,
      ...
      __esDecorate(
        this,
        (_private_emulateFocus_descriptor = {
          value: __setFunctionName(async function (client, state) {
            if (!state.active) {
              return;
            }
        ...
        _private_emulateFocus_decorators,
        {
          ...
          static: false,
          private: true,
          access: { has: (obj) => #emulateFocus in obj, get: (obj) => obj.#emulateFocus },
          metadata: _metadata,
        },
        null,
        _instanceExtraInitializers,
    ...
    async emulateMediaType(type) {
      assert(
        type === 'screen' || type === 'print' || (type ?? undefined) === undefined,
