  ...
  return class BidiFrame extends _classSuper {
    static {
      ...
      __esDecorate(
        ...
        _goto_decorators,
        {
          ...
          static: false,
          private: false,
          access: { has: (obj) => 'goto' in obj, get: (obj) => obj.goto },
          metadata: _metadata,
        },
        null,
      ...
      __esDecorate(
        ...
        _setContent_decorators,
        {
          ...
          static: false,
          private: false,
          access: { has: (obj) => 'setContent' in obj, get: (obj) => obj.setContent },
          metadata: _metadata,
        },
        null,
        _instanceExtraInitializers,
      ...
      __esDecorate(
        ...
        _waitForNavigation_decorators,
        {
          ...
          static: false,
          private: false,
          access: { has: (obj) => 'waitForNavigation' in obj, get: (obj) => obj.waitForNavigation },
          metadata: _metadata,
        },
        null,
        _instanceExtraInitializers,
      ...
      __esDecorate(
        this,
        (_private_waitForLoad$_descriptor = {
        ...
        _private_waitForLoad$_decorators,
        {
          ...
          static: false,
          private: true,
          access: { has: (obj) => #waitForLoad$ in obj, get: (obj) => obj.#waitForLoad$ },
          metadata: _metadata,
        },
        null,
        _instanceExtraInitializers,
      ...
      __esDecorate(
        this,
        (_private_waitForNetworkIdle$_descriptor = {
          value: __setFunctionName(function (options = {}) {
            let { waitUntil = 'load' } = options;
            if (!Array.isArray(waitUntil)) {
              waitUntil = [waitUntil];
    ...
    #initialize() {
      ...
      this.browsingContext.on('request', ({ request }) => {
        ...
        request.once('success', () => {
          this.page().trustedEmitter.emit(
            'requestfinished' /* PageEvent.RequestFinished */,
            httpRequest,
          );
        });
        request.once('error', () => {
          this.page().trustedEmitter.emit(
            'requestfailed' /* PageEvent.RequestFailed */,
            httpRequest,
          );
        });
      ...
      this.browsingContext.on('worker', ({ realm }) => {
        ...
        realm.on('destroyed', () => {
          this.page().trustedEmitter.emit(
            'workerdestroyed' /* PageEvent.WorkerDestroyed */,
            worker,
          );
        });
    ...
    async goto(url, options = {}) {
      const [response] = await Promise.all([
        ...
        rewriteNavigationError(url, options.timeout ?? this.timeoutSettings.navigationTimeout()),
      );
      return response;
    }
    async setContent(html, options = {}) {
      await Promise.all([
        ...
        firstValueFrom(
          combineLatest([this.#waitForLoad$(options), this.#waitForNetworkIdle$(options)]),
        ),
      ]);
    }
