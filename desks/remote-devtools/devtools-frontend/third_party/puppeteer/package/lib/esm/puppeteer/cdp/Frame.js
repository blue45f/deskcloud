...
let CdpFrame = (() => {
  ...
  return class CdpFrame extends _classSuper {
    ...
    (_addPreloadScript_decorators = [throwIfDetached]),
    (_addExposedFunctionBinding_decorators = [throwIfDetached]),
    (_removeExposedFunctionBinding_decorators = [throwIfDetached]),
    (_waitForDevicePrompt_decorators = [throwIfDetached]),
    disposeSymbol)]() {
      if (this.#detached) {
        return;
      }
