...
var ue = (c, e) => {
  for (var t in e) pe(c, t, { get: e[t], enumerable: !0 });
};
var he = {};
ue(he, {
  Hooks: () => T,
...
var te = /[&<>"']/,
  fe = new RegExp(te.source, 'g'),
  ne = /[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,
  ge = new RegExp(ne.source, 'g'),
  de = { '&': '&amp;', '<': '&lt;', '>': '&gt;', '"': '&quot;', "'": '&#39;' },
  W = (c) => de[c];
function x(c, e) {
  if (e) {
    if (te.test(c)) return c.replace(fe, W);
  } else if (ne.test(c)) return c.replace(ge, W);
  return c;
}
var ke = /&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/gi;
function xe(c) {
  return c.replace(
    ke,
    (e, t) => (
...
function d(c, e) {
  ...
  let s = {
    replace: (n, i) => {
      ...
      return ((r = r.replace(be, '$1')), (t = t.replace(n, r)), s);
    },
...
function S(c, e, t) {
  ...
  let n = 0;
  for (; n < s; ) {
    let i = c.charAt(s - n - 1);
    if (i === e && !t) n++;
    else if (i !== e && t) n++;
    else break;
  }
  return c.slice(0, s - n);
}
function we(c, e) {
  ...
  for (let s = 0; s < c.length; s++)
    ...
    else if (c[s] === e[1] && (t--, t < 0)) return s;
  return -1;
}
function V(c, e, t, s) {
  let n = e.href,
    i = e.title ? x(e.title) : null,
    r = c[1].replace(/\\([\[\]])/g, '$1');
  if (c[0].charAt(0) !== '!') {
    s.state.inLink = !0;
    let l = { type: 'link', raw: t, href: n, title: i, text: r, tokens: s.inlineTokens(r) };
    return ((s.state.inLink = !1), l);
  }
  return { type: 'image', raw: t, href: n, title: i, text: x(r) };
}
function me(c, e) {
  let t = c.match(/^(\s+)(?:```)/);
  if (t === null) return e;
...
`),
        ...
        for (; s.length > 0; ) {
          ...
          for (h = 0; h < s.length; h++)
            if (/^ {0,3}>/.test(s[h])) (o.push(s[h]), (l = !0));
            else if (!l) o.push(s[h]);
            else break;
          s = s.slice(h);
          let a = o.join(`
`),
...
`),
              w = this.blockquote(b);
            ((r[r.length - 1] = w),
              (n = n.substring(0, n.length - k.raw.length) + w.raw),
              (i = i.substring(0, i.length - k.text.length) + w.text));
            break;
          } else if (u?.type === 'list') {
            let k = u,
              b =
...
`),
              w = this.list(b);
            ((r[r.length - 1] = w),
              (n = n.substring(0, n.length - u.raw.length) + w.raw),
              (i = i.substring(0, i.length - k.raw.length) + w.raw),
              (s = b.substring(r[r.length - 1].raw.length).split(`
`)));
            continue;
          }
        }
        return { type: 'blockquote', raw: n, tokens: r, text: i };
      }
    }
    list(e) {
      ...
      if (t) {
        ...
        ((s = n ? `\\d{1,9}\\${s.slice(-1)}` : `\\${s}`),
          this.options.pedantic && (s = n ? s : '[*+-]'));
        let r = new RegExp(`^( {0,3}${s})((?:[	 ][^\\n]*)?(?:\\n|$))`),
          l = '',
          o = '',
          h = !1;
        for (; e; ) {
...
`),
            ...
            let j = new RegExp(
              ...
              X = new RegExp(`^ {0,${Math.min(3, u - 1)}}(?:\`\`\`|~~~)`),
              G = new RegExp(`^ {0,${Math.min(3, u - 1)}}#`);
            for (; e; ) {
              let Q = e.split(
                `
`,
              ...
              if (
                ...
                X.test(f) || G.test(f) || j.test(f) || U.test(e))
              )
                break;
              if (f.search(/[^ ]/) >= u || !f.trim())
                o +=
                  `
` + f.slice(u);
              else {
                if (k || p.search(/[^ ]/) >= 4 || X.test(p) || G.test(p) || U.test(p)) break;
                o +=
                  `
` + f;
              }
...
`),
        ...
        for (let a = 0; a < i.items.length; a++)
          if (
            ...
            (i.items[a].tokens = this.lexer.blockTokens(i.items[a].text, [])),
            !i.loose)
          ) {
            let p = i.items[a].tokens.filter((u) => u.type === 'space'),
              f = p.length > 0 && p.some((u) => /\n.*\n/.test(u.raw));
            i.loose = f;
          }
    ...
    def(e) {
      ...
      if (t) {
        let s = t[1].toLowerCase().replace(/\s+/g, ' '),
          n = t[2]
          ...
          i = t[3]
            ...
            : t[3];
        return { type: 'def', tag: s, raw: t[0], href: n, title: i };
      }
    }
    table(e) {
...
`
            ? t[1].slice(0, -1)
            : t[1];
        return { type: 'paragraph', raw: t[0], text: s, tokens: this.lexer.inline(s) };
      }
    }
    text(e) {
    ...
    link(e) {
      ...
      if (t) {
        ...
        return (
          (n = n.trim()),
          /^</.test(n) &&
            (this.options.pedantic && !/>$/.test(s) ? (n = n.slice(1)) : (n = n.slice(1, -1))),
          V(
            t,
            {
    ...
    emStrong(e, t, s = '') {
      ...
      if (!(n[1] || n[2] || '') || !s || this.rules.inline.punctuation.exec(s)) {
        ...
        for (p.lastIndex = 0, t = t.slice(-1 * e.length + r); (n = p.exec(t)) != null; ) {
    ...
    codespan(e) {
      ...
      if (t) {
        let s = t[2].replace(/\n/g, ' '),
          ...
          i = /^ /.test(s) && / $/.test(s);
        return (
          n && i && (s = s.substring(1, s.length - 1)),
          (s = x(s, !0)),
    ...
    autolink(e) {
      ...
      if (t) {
        let s, n;
        return (
          t[2] === '@' ? ((s = x(t[1])), (n = 'mailto:' + s)) : ((s = x(t[1])), (n = s)),
          { type: 'link', raw: t[0], text: s, href: n, tokens: [{ type: 'text', raw: s, text: s }] }
        );
      }
    }
    url(e) {
      ...
      if ((t = this.rules.inline.url.exec(e))) {
        let s, n;
        if (t[2] === '@') ((s = x(t[0])), (n = 'mailto:' + s));
        else {
          let i;
          do ((i = t[0]), (t[0] = this.rules.inline._backpedal.exec(t[0])?.[0] ?? ''));
          while (i !== t[0]);
          ((s = x(t[0])), t[1] === 'www.' ? (n = 'http://' + t[0]) : (n = t[0]));
        }
        return {
          type: 'link',
          raw: t[0],
    ...
    inlineText(e) {
      ...
      if (t) {
        let s;
        return (
          this.lexer.state.inRawBlock ? (s = t[0]) : (s = x(t[0])),
          { type: 'text', raw: t[0], text: s }
        );
      }
    }
  },
  ...
  qe = /^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,
  C = '\\p{P}\\p{S}',
  Be = d(/^((?![*_])[\spunctuation])/, 'u')
    .replace(/punctuation/g, C)
    .getRegex(),
  Ze = /\[[^[\]]*?\]\([^\(\)]*?\)|`[^`]*?`|<[^<>]*?>/g,
  Pe = d(/^(?:\*+(?:((?!\*)[punct])|[^\s*]))|^_+(?:((?!_)[punct])|([^\s_]))/, 'u')
    .replace(/punct/g, C)
    .getRegex(),
  ve = d(
  ...
  ce = d(/^!?\[(ref)\](?:\[\])?/)
    .replace('ref', O)
    .getRegex(),
  He = d('reflink|nolink(?!\\()', 'g').replace('reflink', ae).replace('nolink', ce).getRegex(),
  F = {
    _backpedal: E,
    anyPunctuation: Qe,
    autolink: De,
  ...
  D = {
    ...F,
    escape: d(le).replace('])', '~|])').getRegex(),
    url: d(/^((?:ftp|https?):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/, 'i')
  ...
  Ue = {
    ...D,
    br: d(oe).replace('{2,}', '*').getRegex(),
    text: d(D.text)
      .replace('\\b_', '\\b_| {2,}\\n')
      .replace(/\{2,\}/g, '*')
      .getRegex(),
  },
  q = { normal: H, gfm: Ee, pedantic: Le },
  A = { normal: F, gfm: D, breaks: Ue, pedantic: Fe },
  m = class c {
    tokens;
    options;
    state;
    ...
    constructor(e) {
      ...
      let t = { block: q.normal, inline: A.normal };
      (this.options.pedantic
...
`,
    ...
    blockTokens(e, t = [], s = !1) {
      this.options.pedantic
        ...
        : (e = e.replace(/^( *)(\t+)/gm, (l, o, h) => o + '    '.repeat(h.length)));
      let n, i, r;
      for (; e; )
        if (
          !(
    ...
    inlineTokens(e, t = []) {
      ...
      if (this.tokens.links) {
        ...
        if (a.length > 0)
          for (; (l = this.tokenizer.rules.inline.reflinkSearch.exec(r)) != null; )
            a.includes(l[0].slice(l[0].lastIndexOf('[') + 1, -1)) &&
              (r =
                r.slice(0, l.index) +
                '[' +
      ...
      for (; e; )
        if (
          ...
          if ((s = this.tokenizer.emStrong(e, r, h))) {
            ((e = e.substring(s.raw.length)), t.push(s));
            continue;
          }
          ...
          if ((s = this.tokenizer.inlineText(i))) {
            ((e = e.substring(s.raw.length)),
              ...
              (o = !0),
              (n = t[t.length - 1]),
              n && n.type === 'text' ? ((n.raw += s.raw), (n.text += s.text)) : t.push(s));
            continue;
          }
          if (e) {
          ...
          ? e.tokens.length > 0 && e.tokens[0].type === 'paragraph'
            ? ((e.tokens[0].text = s + ' ' + e.tokens[0].text),
              e.tokens[0].tokens &&
                ...
                (e.tokens[0].tokens[0].text = s + ' ' + e.tokens[0].tokens[0].text))
            : e.tokens.unshift({ type: 'text', raw: s + ' ', text: s + ' ' })
          : (t += s + ' ');
      }
      return (
...
`;
    ...
    table(e) {
      let t = '',
        s = '';
      for (let i = 0; i < e.header.length; i++) s += this.tablecell(e.header[i]);
      t += this.tablerow({ text: s });
      let n = '';
      for (let i = 0; i < e.rows.length; i++) {
        let r = e.rows[i];
        s = '';
        for (let l = 0; l < r.length; l++) s += this.tablecell(r[l]);
...
` + this.renderer.text(l)));
  ...
  Z = class {
    ...
    parse = this.#e(m.lex, y.parse);
    parseInline = this.#e(m.lexInline, y.parseInline);
    Parser = y;
    Renderer = R;
    TextRenderer = I;
    Lexer = m;
    ...
    walkTokens(e, t) {
      ...
      for (let n of e)
        switch (((s = s.concat(t.call(this, n))), n.type)) {
          case 'table': {
            let i = n;
            for (let r of i.header) s = s.concat(this.walkTokens(r.tokens, t));
            for (let r of i.rows) for (let l of r) s = s.concat(this.walkTokens(l.tokens, t));
            break;
          }
          case 'list': {
            let i = n;
          ...
          default: {
            ...
            this.defaults.extensions?.childTokens?.[i.type]
              ? this.defaults.extensions.childTokens[i.type].forEach((r) => {
                  let l = i[r].flat(1 / 0);
                  s = s.concat(this.walkTokens(l, t));
                })
    ...
    use(...e) {
      ...
      return (
        e.forEach((s) => {
          ...
          if (
            ...
            for (let r in s.renderer) {
              ...
              let l = r,
                ...
                h = i[l];
              i[l] = (...a) => {
                s.useNewRenderer || (o = this.#t(o, l, i));
                let p = o.apply(i, a);
          ...
          if (s.hooks) {
            let i = this.defaults.hooks || new T();
            for (let r in s.hooks) {
              ...
              T.passThroughHooks.has(r)
                ? (i[l] = (a) => {
                    if (this.defaults.async)
                      return Promise.resolve(o.call(i, a)).then((f) => h.call(i, f));
                    let p = o.call(i, a);
                    return h.call(i, p);
                  })
                : (i[l] = (...a) => {
      ...
      switch (t) {
        case 'heading':
          return function (n) {
            return !n.type || n.type !== t
              ...
              : e.call(
                  this,
                  s.parser.parseInline(n.tokens),
                  n.depth,
                  xe(s.parser.parseInline(n.tokens, s.parser.textRenderer)),
                );
          };
        case 'code':
          return function (n) {
        ...
        case 'table':
          return function (n) {
            ...
            let i = '',
              r = '';
            for (let o = 0; o < n.header.length; o++)
              r += this.tablecell({
        ...
        case 'blockquote':
          return function (n) {
            if (!n.type || n.type !== t) return e.apply(this, arguments);
            let i = this.parser.parse(n.tokens);
                  ...
                  ? a.tokens.length > 0 && a.tokens[0].type === 'paragraph'
                    ? ((a.tokens[0].text = k + ' ' + a.tokens[0].text),
                      a.tokens[0].tokens &&
                        ...
                        (a.tokens[0].tokens[0].text = k + ' ' + a.tokens[0].tokens[0].text))
                    : a.tokens.unshift({ type: 'text', text: k + ' ' })
                  : (u += k + ' ');
              }
              ((u += this.parser.parse(a.tokens, l)),
                (o += this.listitem({
                  type: 'list_item',
                  raw: u,
                  text: u,
    ...
    #e(e, t) {
      return (s, n) => {
        ...
        if ((r.hooks && (r.hooks.options = r), r.async))
          return Promise.resolve(r.hooks ? r.hooks.preprocess(s) : s)
            .then((o) => e(o, r))
...
Please report this to https://github.com/markedjs/marked.`),
          ...
          let n = '<p>An error occurred:</p><pre>' + x(s.message + '', !0) + '</pre>';
...
g.options = g.setOptions = function (c) {
  return (_.setOptions(c), (g.defaults = _.defaults), ee(g.defaults), g);
};
g.getDefaults = P;
g.defaults = $;
g.use = function (...c) {
  return (_.use(...c), (g.defaults = _.defaults), ee(g.defaults), g);
};
g.walkTokens = function (c, e) {
  return _.walkTokens(c, e);
};
g.parseInline = _.parseInline;
g.Parser = y;
g.parser = y.parse;
g.Renderer = R;
g.TextRenderer = I;
