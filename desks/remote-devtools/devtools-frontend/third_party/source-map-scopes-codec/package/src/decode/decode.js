...
class Decoder {
  ...
  decode() {
    ...
    while (iter.hasNext()) {
      ...
      switch (tag) {
        ...
        case 4 /* Tag.GENERATED_RANGE_START */: {
          ...
          const line =
            flags & 1 /* GeneratedRangeFlags.HAS_LINE */ ? iter.nextUnsignedVLQ() : undefined;
          const column = iter.nextUnsignedVLQ();
          const definitionIdx =
            flags & 2 /* GeneratedRangeFlags.HAS_DEFINITION */ ? iter.nextSignedVLQ() : undefined;
        ...
        case 5 /* Tag.GENERATED_RANGE_END */: {
          ...
          const maybeColumn =
            iter.hasNext() && iter.peek() !== ',' ? iter.nextUnsignedVLQ() : undefined;
        ...
        case 7 /* Tag.GENERATED_RANGE_SUBRANGE_BINDING */: {
          ...
          const bindings = [];
          while (iter.hasNext() && iter.peek() !== ',') {
            bindings.push([iter.nextUnsignedVLQ(), iter.nextUnsignedVLQ(), iter.nextUnsignedVLQ()]);
          }
    ...
    const info = {
      scopes: this.#scopes,
      ranges: this.#ranges,
      hasVariableAndBindingInfo:
        this.#seenOriginalScopeVariables && this.#seenGeneratedRangeBindings,
    };
    this.#scopes = [];
    this.#ranges = [];
  ...
  #throwInStrictMode(message) {
    if (this.#mode === 1 /* DecodeMode.STRICT */) throw new Error(message);
  }
