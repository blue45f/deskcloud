...
*/
  ...
  function ca(a, b) {
    ...
    a.base = function (d, e, g) {
      for (var m = Array(arguments.length - 2), n = 2; n < arguments.length; n++)
        m[n - 2] = arguments[n];
  ...
  x.prototype.add = function (a) {
    return new x(
      (((this.g + a.g) & 4294967295) >>> 0) >>> 0,
      ((((this.h + a.h) & 4294967295) >>> 0) + (4294967296 <= this.g + a.g ? 1 : 0)) >>> 0,
    );
  };
  x.prototype.sub = function (a) {
    return new x(
      (((this.g - a.g) & 4294967295) >>> 0) >>> 0,
      ((((this.h - a.h) & 4294967295) >>> 0) - (0 > this.g - a.g ? 1 : 0)) >>> 0,
    );
  };
  function ma(a) {
    var b = a & 65535,
  ...
  x.prototype.toString = function () {
    for (var a = '', b = this; 0 != b.g || 0 != b.h; ) {
      ...
      for (; 0 != e.g || 0 != e.h; )
        (0 >= (d.h < b.h || (d.h == b.h && d.g < b.g) ? -1 : d.h == b.h && d.g == b.g ? 0 : 1) &&
          ((c = c.add(e)), (b = b.sub(d))),
          (d = ka(d)),
          (e = ka(e)));
      c = [c, b];
  ...
  function xa(a, b) {
    for (var c = 128, d = 0, e = 0, g = 0; 4 > g && 128 <= c; g++)
      ((c = a.h[a.g++]), (d |= (c & 127) << (7 * g)));
    128 <= c && ((c = a.h[a.g++]), (d |= (c & 127) << 28), (e |= (c & 127) >> 4));
    if (128 <= c)
      for (g = 0; 5 > g && 128 <= c; g++) ((c = a.h[a.g++]), (e |= (c & 127) << (7 * g + 3)));
  ...
  f.ha = function (a) {
    ...
    if (8192 >= e.length) e = String.fromCharCode.apply(null, e);
      ...
      b = '';
      for (d = 0; d < e.length; d += 8192)
        b += String.fromCharCode.apply(null, Array.prototype.slice.call(e, d, d + 8192));
      e = b;
    }
    this.g = c;
    return a + e;
  ...
  f.ca = function (a) {
    if (0 > a || this.g + a > this.h.length)
      return ((this.D = !0), t('Invalid byte length!'), new Uint8Array(0));
  ...
  function za(a) {
    ...
    r(c == Math.floor(c));
    r(0 <= b && 4294967296 > b);
    for (r(0 <= c && 4294967296 > c); 0 < c || 127 < b; )
  ...
  function Ba(a, b) {
    r(b == Math.floor(b));
    r(0 <= b && 1.8446744073709552e19 > b);
    A(b);
    za(a);
  }
  function Ca(a, b) {
    r(b == Math.floor(b));
    r(-0x7fffffffffffffff <= b && 0x7fffffffffffffff > b);
    A(b);
    za(a);
  }
  function Da(a, b) {
  ...
  f.U = function (a) {
    r(a == Math.floor(a));
    r(-0x7fffffffffffffff <= a && 0x7fffffffffffffff > a);
    A(a);
    Aa(this, y, z);
  };
  f.J = function (a) {
    ...
    else if (3.4028234663852886e38 < b) ((z = 0), (y = ((a << 31) | 2139095040) >>> 0));
    else if (1.1754943508222875e-38 > b)
      ((b = Math.round(b / Math.pow(2, -149))), (z = 0), (y = ((a << 31) | b) >>> 0));
    else {
  ...
  f.I = function (a) {
    ...
    else if (1.7976931348623157e308 < b) ((z = ((a << 31) | 2146435072) >>> 0), (y = 0));
    else if (2.2250738585072014e-308 > b)
      ((b /= Math.pow(2, -1074)), (z = ((a << 31) | (b / 4294967296)) >>> 0), (y = b >>> 0));
    else {
      var c = b,
        d = 0;
      ...
      if (128 > d) this.g.push(d);
        ...
        if (55296 <= d && 56319 >= d && c + 1 < a.length) {
          ...
          56320 <= e &&
            ...
            this.g.push((d >> 18) | 240),
            this.g.push(((d >> 12) & 63) | 128),
            this.g.push(((d >> 6) & 63) | 128),
            this.g.push((d & 63) | 128),
            c++);
        } else
          (this.g.push((d >> 12) | 224),
            this.g.push(((d >> 6) & 63) | 128),
            this.g.push((d & 63) | 128));
    }
  ...
  E.prototype.M = function () {
    ...
    if (a) return (t('Decoder hit an error'), !1);
    this.D = this.g.g;
    var b = this.g.v();
    a = b >>> 3;
    b &= 7;
    if (0 != b && 5 != b && 1 != b && 2 != b && 3 != b && 4 != b)
      return (t('Invalid wire type: %s (at position %s)', b, this.D), (this.o = !0), !1);
    this.j = a;
    this.h = b;
    return !0;
  };
    ...
    switch (a.h) {
      ...
      case 3:
        ...
        do {
          ...
          if (4 == a.h) {
            a.j != b && (t('Unmatched end-group tag'), (a.o = !0));
            break;
          }
          F(a);
        } while (1);
  ...
  E.prototype.Ia = function (a, b, c) {
    ...
    this.o ||
      4 == this.h ||
      (t('Group submessage did not end with an END_GROUP tag'), (this.o = !0));
  };
  ...
  H.prototype.oa = function () {
    r(0 == this.o.length);
    for (
      var a = new Uint8Array(this.h + this.g.length()), b = this.j, c = b.length, d = 0, e = 0;
      e < c;
      e++
    ) {
      var g = b[e];
  ...
  H.prototype.T = function (a, b) {
    null != b &&
      (r(-2147483648 <= b && 2147483648 > b), null != b && (J(this, a, 0), D(this.g, b)));
  };
  H.prototype.writeInt32 = H.prototype.T;
  H.prototype.U = function (a, b) {
    null != b &&
      (r(-0x7fffffffffffffff <= b && 0x7fffffffffffffff > b),
      null != b && (J(this, a, 0), Ca(this.g, b)));
  };
  ...
  H.prototype.W = function (a, b) {
    null != b &&
      (r(0 <= b && 1.8446744073709552e19 > b), null != b && (J(this, a, 0), Ba(this.g, b)));
  };
  H.prototype.writeUint64 = H.prototype.W;
  H.prototype.Kb = function (a, b) {
    null != b &&
      (r(-2147483648 <= b && 2147483648 > b), null != b && (J(this, a, 0), Da(this.g, b)));
  };
  H.prototype.writeSint32 = H.prototype.Kb;
  H.prototype.Lb = function (a, b) {
    null != b &&
      (r(-0x7fffffffffffffff <= b && 0x7fffffffffffffff > b),
      null != b && (J(this, a, 0), Ea(this.g, b)));
  };
  ...
  H.prototype.va = function (a, b) {
    null != b && (r(0 <= b && 1.8446744073709552e19 > b), J(this, a, 1), this.g.W(b));
  };
  ...
  H.prototype.xa = function (a, b) {
    null != b &&
      (r(-0x7fffffffffffffff <= b && 0x7fffffffffffffff > b), J(this, a, 1), this.g.U(b));
  };
  ...
  H.prototype.hb = function (a, b) {
    if (null != b && b.length)
      for (J(this, a, 2), C(this.g, 4 * b.length), a = 0; a < b.length; a++) this.g.A(b[a]);
  };
  H.prototype.writePackedFixed32 = H.prototype.hb;
  H.prototype.ib = function (a, b) {
    if (null != b && b.length)
      for (J(this, a, 2), C(this.g, 8 * b.length), a = 0; a < b.length; a++) this.g.W(b[a]);
  };
  H.prototype.writePackedFixed64 = H.prototype.ib;
  H.prototype.mb = function (a, b) {
    if (null != b && b.length)
      for (J(this, a, 2), C(this.g, 4 * b.length), a = 0; a < b.length; a++) this.g.T(b[a]);
  };
  H.prototype.writePackedSfixed32 = H.prototype.mb;
  H.prototype.nb = function (a, b) {
    if (null != b && b.length)
      for (J(this, a, 2), C(this.g, 8 * b.length), a = 0; a < b.length; a++) this.g.U(b[a]);
  };
  H.prototype.writePackedSfixed64 = H.prototype.nb;
  H.prototype.jb = function (a, b) {
    if (null != b && b.length)
      for (J(this, a, 2), C(this.g, 4 * b.length), a = 0; a < b.length; a++) this.g.J(b[a]);
  };
  H.prototype.writePackedFloat = H.prototype.jb;
  H.prototype.fb = function (a, b) {
    if (null != b && b.length)
      for (J(this, a, 2), C(this.g, 8 * b.length), a = 0; a < b.length; a++) this.g.I(b[a]);
  };
  H.prototype.writePackedDouble = H.prototype.fb;
  H.prototype.eb = function (a, b) {
    if (null != b && b.length)
      for (J(this, a, 2), C(this.g, b.length), a = 0; a < b.length; a++) this.g.H(b[a]);
  };
  ...
  M.deserializeBinary = function (a, b, c, d, e, g, m) {
    for (; b.M() && !b.aa(); ) {
      ...
      1 == n
        ? (g = c.call(b))
        : 2 == n && (a.h ? (r(e), m || (m = new a.h()), d.call(b, m, e)) : (m = d.call(b)));
    }
    r(void 0 != g);
    r(void 0 != m);
    a.set(g, m);
  ...
  function v() {}
  k('jspb.Message', v);
  v.GENERATE_TO_OBJECT = !0;
  v.GENERATE_FROM_OBJECT = !0;
  ...
  function Ga(a, b, c, d, e, g) {
    ...
    a: {
      ...
      if (
        ...
        ((b = c - 1),
        (c = a.s[b]),
        !(null === c || 'object' != typeof c || Array.isArray(c) || (R && c instanceof Uint8Array)))
      ) {
        a.F = b - a.B;
        a.m = c;
        break a;
    ...
    if (e)
      for (d = 0; d < e.length; d++)
        ((b = e[d]),
          b < a.F ? ((b += a.B), (a.s[b] = a.s[b] || S)) : (T(a), (a.m[b] = a.m[b] || S)));
  ...
  function La(a) {
    ...
    if (R && a instanceof Uint8Array) {
      ...
      ia();
      b = ea[b];
      const m = Array(Math.floor(a.length / 3)),
        n = b[64] || '';
      let w = 0,
        K = 0;
  ...
  function Na(a) {
    if (a && 1 < a.length) {
      ...
      da(a, function (c) {
        h(c) != b &&
          t('Inconsistent type in JSPB repeated field array. Got ' + h(c) + ' expected ' + b);
      });
    }
  }
  function Oa(a, b, c) {
  ...
  function Qa(a, b, c, d) {
    ...
    (c = Ha(a, c)) &&
      c !== b &&
      void 0 !== d &&
      (a.i && c in a.i && (a.i[c] = void 0), V(a, c, void 0));
    return V(a, b, d);
  }
  v.setOneofField = Qa;
  function Ha(a, b) {
    ...
    if (this.m) {
      ...
      if (a.L) {
        if (a.C())
          return (
            this.i[b] ||
              (this.i[b] = l(this.m[b] || [], function (c) {
                return new a.ctor(c);
              })),
            this.i[b]
          );
      } else if (a.C())
        return (!this.i[b] && this.m[b] && (this.i[b] = new a.ctor(this.m[b])), this.i[b]);
      return this.m[b];
    }
  };
  ...
  v.prototype.ab = function (a, b) {
    ...
    a.L
      ? ((b = b || []),
        a.C()
          ? ((this.i[c] = b),
            (this.m[c] = l(b, function (d) {
              return d.l();
            })))
          : (this.m[c] = b))
      : a.C()
        ? ((this.i[c] = b), (this.m[c] = b ? b.l() : b))
        : (this.m[c] = b);
    return this;
  };
  ...
  v.difference = function (a, b) {
    ...
    var d = [],
      e = 0,
      g = c.length > b.length ? c.length : b.length;
    a.h && ((d[0] = a.h), (e = 1));
  ...
  function Ta(a, b) {
    ...
    for (d in a) c[d] = 0;
    for (d in b) c[d] = 0;
    for (d in c) if (!X(a[d], b[d])) return !1;
    return !0;
  }
    ...
    if (a.constructor === Array) {
      ...
      for (c = 0; c < g; c++) {
        ...
        m &&
          ...
          (r(void 0 === d), r(c === a.length - 1), (d = m), (m = void 0));
        n &&
          n.constructor == Object &&
          (r(void 0 === e), r(c === b.length - 1), (e = n), (n = void 0));
        if (!X(m, n)) return !1;
      }
      return d || e ? ((d = d || {}), (e = e || {}), Ta(d, e)) : !0;
    }
  ...
  Z.prototype.ta = function (a) {
    var b,
      c = { Qb: null == (b = U(this, 1)) ? void 0 : b, Pb: null == (b = U(this, 3)) ? void 0 : b };
    a && (c.Mb = this);
    return c;
  };
  function Wa(a) {
    a = new E(a);
    for (var b = new Z(); a.M() && !a.aa(); )
      switch (a.j) {
        case 1:
  ...
  k(
    ...
    function (
      a,
      b = 'Active Google-visible variation IDs on this client. These are reported for analysis, but do not directly affect any server-side behavior.',
      c = 'Active Google-visible variation IDs on this client that trigger server-side behavior. These are reported for analysis *and* directly affect server-side behavior.',
    ) {
