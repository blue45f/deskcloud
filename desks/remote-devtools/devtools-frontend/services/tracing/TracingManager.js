...
export class TracingManager extends SDK.SDKModel.SDKModel {
  ...
  eventsCollected(events) {
    ...
    const progress = Math.min(this.#eventsRetrieved / 900_000 + 0.15, 0.9);
...
SDK.SDKModel.SDKModel.register(TracingManager, {
  capabilities: 128 /* SDK.Target.Capability.TRACING */,
  autostart: false,
});
