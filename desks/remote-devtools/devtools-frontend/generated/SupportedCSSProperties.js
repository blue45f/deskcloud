...
export const generatedPropertyValues = {
  ...
  '-webkit-line-break': {
    values: ['auto', 'loose', 'normal', 'strict', 'after-white-space'],
  },
  '-webkit-line-clamp': {
    values: ['none'],
  },
  ...
  'column-rule-break': {
    values: ['none', 'normal', 'intersection'],
  },
  'column-rule-color': {
    values: ['currentcolor'],
  },
  ...
  'column-rule-visibility-items': {
    values: ['all', 'auto', 'around', 'between'],
  },
  'column-rule-width': {
    values: ['thin', 'medium', 'thick'],
  },
  ...
  'container-type': {
    values: ['normal', 'inline-size', 'size', 'scroll-state', 'anchored'],
  },
  'content-visibility': {
    values: ['visible', 'auto', 'hidden'],
  },
  continue: {
    values: ['auto', 'collapse', '-webkit-legacy'],
  },
  'corner-bottom-left-shape': {
  ...
  'dynamic-range-limit': {
    values: ['standard', 'no-limit', 'constrained'],
  },
  'empty-cells': {
    values: ['show', 'hide'],
  },
  ...
  'flex-wrap': {
    values: ['nowrap', 'wrap', 'wrap-reverse', 'balance'],
  },
  float: {
  ...
  'image-animation': {
    values: ['normal', 'running', 'paused', 'stopped'],
  },
  'image-rendering': {
    values: [
      'auto',
  ...
  'rule-overlap': {
    values: ['row-over-column', 'column-over-row'],
  },
  rx: {
    values: ['auto'],
  },
