...
export class ExperimentsSupport {
  ...
  isEnabled(experimentName) {
    if (this.#isHostExperiment(experimentName)) {
      return (
        this.#enabledForTests.has(experimentName) ||
...
(function (GenAiEnterprisePolicyValue) {
  ...
  GenAiEnterprisePolicyValue[(GenAiEnterprisePolicyValue['ALLOW_WITHOUT_LOGGING'] = 1)] =
    'ALLOW_WITHOUT_LOGGING';
...
(function (GdpProfilesEnterprisePolicyValue) {
  ...
  GdpProfilesEnterprisePolicyValue[
    (GdpProfilesEnterprisePolicyValue['ENABLED_WITHOUT_BADGES'] = 1)
  ] = 'ENABLED_WITHOUT_BADGES';
