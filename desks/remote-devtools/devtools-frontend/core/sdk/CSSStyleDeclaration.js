...
export class CSSStyleDeclaration {
  ...
  #reinitialize(payload) {
    ...
    if (payload.cssText && this.range) {
      ...
      for (const cssProperty of payload.cssProperties) {
        ...
        const parsedProperty = CSSProperty.parsePayload(
          this,
      ...
      for (const cssProperty of payload.cssProperties) {
        this.#allProperties.push(
          CSSProperty.parsePayload(this, this.#allProperties.length, cssProperty),
        );
      }
    }
  ...
  insertPropertyAt(index, name, value, userCallback) {
    void this.newBlankProperty(index)
