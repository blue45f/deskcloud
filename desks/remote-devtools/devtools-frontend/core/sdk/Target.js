...
export class Target extends ProtocolClient.InspectorBackend.TargetBase {
    ...
    switch (type) {
      case Type.FRAME:
        this.#capabilitiesMask =
          ...
          8192 /* Capability.STORAGE */ |
          2 /* Capability.DOM */ |
          4 /* Capability.JS */ |
          8 /* Capability.LOG */ |
          16 /* Capability.NETWORK */ |
          32 /* Capability.TARGET */ |
          128 /* Capability.TRACING */ |
          256 /* Capability.EMULATION */ |
          1024 /* Capability.INPUT */ |
          2048 /* Capability.INSPECTOR */ |
          32768 /* Capability.AUDITS */ |
          65536 /* Capability.WEB_AUTHN */ |
          131072 /* Capability.IO */ |
          262144 /* Capability.MEDIA */ |
          524288 /* Capability.EVENT_BREAKPOINTS */ |
          1048576 /* Capability.DOM_STORAGE */;
        ...
        if (parentTarget?.type() !== Type.FRAME) {
          ...
          this.#capabilitiesMask |=
            4096 /* Capability.DEVICE_EMULATION */ |
            64 /* Capability.SCREEN_CAPTURE */ |
            512 /* Capability.SECURITY */ |
            16384 /* Capability.SERVICE_WORKER */;
  ...
  decorateLabel(label) {
    return this.#type === Type.Worker || this.#type === Type.ServiceWorker
      ? '\u2699 ' + label
      : label;
  }
  parentTarget() {
