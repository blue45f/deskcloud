...
export class ServiceWorkerManager extends SDKModel {
  ...
  deleteRegistration(registrationId) {
    ...
    if (registration.isRedundant()) {
      ...
      this.dispatchEventToListeners(
        'RegistrationDeleted' /* Events.REGISTRATION_DELETED */,
        registration,
      );
      return;
    }
  ...
  workerRegistrationUpdated(registrations) {
    for (const payload of registrations) {
      ...
      if (!registration) {
        ...
        this.dispatchEventToListeners(
          'RegistrationUpdated' /* Events.REGISTRATION_UPDATED */,
          registration,
        );
        continue;
      }
  ...
  workerErrorReported(payload) {
    ...
    this.dispatchEventToListeners('RegistrationErrorAdded' /* Events.REGISTRATION_ERROR_ADDED */, {
      registration,
      error: payload,
    });
  }
...
export class ServiceWorkerVersion {
  ...
  isStoppedAndRedundant() {
    return (
      this.runningStatus ===
        'stopped' /* Protocol.ServiceWorker.ServiceWorkerVersionRunningStatus.Stopped */ &&
  ...
  isStarting() {
    return (
      this.runningStatus ===
      'starting' /* Protocol.ServiceWorker.ServiceWorkerVersionRunningStatus.Starting */
    );
  }
  isRunning() {
    return (
      this.runningStatus ===
      'running' /* Protocol.ServiceWorker.ServiceWorkerVersionRunningStatus.Running */
    );
  }
  isStopping() {
    return (
      this.runningStatus ===
      'stopping' /* Protocol.ServiceWorker.ServiceWorkerVersionRunningStatus.Stopping */
    );
  }
  isNew() {
  ...
  isInstalling() {
    return (
      this.status ===
      'installing' /* Protocol.ServiceWorker.ServiceWorkerVersionStatus.Installing */
    );
  }
  isInstalled() {
    return (
      this.status === 'installed' /* Protocol.ServiceWorker.ServiceWorkerVersionStatus.Installed */
    );
  }
  isActivating() {
    return (
      this.status ===
      'activating' /* Protocol.ServiceWorker.ServiceWorkerVersionStatus.Activating */
    );
  }
  isActivated() {
    return (
      this.status === 'activated' /* Protocol.ServiceWorker.ServiceWorkerVersionStatus.Activated */
    );
  }
  isRedundant() {
    return (
  ...
  parseJSONRules(input) {
    try {
      ...
      for (const parsedRule of parsedObject) {
        ...
        routerRules.push(
          new ServiceWorkerRouterRule(JSON.stringify(condition), JSON.stringify(source), id),
        );
      }
      return routerRules;
    } catch {
...
(function (ServiceWorkerVersion) {
  ServiceWorkerVersion.RunningStatus = {
    ['running' /* Protocol.ServiceWorker.ServiceWorkerVersionRunningStatus.Running */]:
      i18nLazyString(UIStrings.running),
    ['starting' /* Protocol.ServiceWorker.ServiceWorkerVersionRunningStatus.Starting */]:
      i18nLazyString(UIStrings.starting),
    ['stopped' /* Protocol.ServiceWorker.ServiceWorkerVersionRunningStatus.Stopped */]:
      i18nLazyString(UIStrings.stopped),
    ['stopping' /* Protocol.ServiceWorker.ServiceWorkerVersionRunningStatus.Stopping */]:
      i18nLazyString(UIStrings.stopping),
  };
  ServiceWorkerVersion.Status = {
    ['activated' /* Protocol.ServiceWorker.ServiceWorkerVersionStatus.Activated */]: i18nLazyString(
      UIStrings.activated,
    ),
    ['activating' /* Protocol.ServiceWorker.ServiceWorkerVersionStatus.Activating */]:
      i18nLazyString(UIStrings.activating),
    ['installed' /* Protocol.ServiceWorker.ServiceWorkerVersionStatus.Installed */]: i18nLazyString(
      UIStrings.installed,
    ),
    ['installing' /* Protocol.ServiceWorker.ServiceWorkerVersionStatus.Installing */]:
      i18nLazyString(UIStrings.installing),
    ['new' /* Protocol.ServiceWorker.ServiceWorkerVersionStatus.New */]: i18nLazyString(
      UIStrings.new,
    ),
    ['redundant' /* Protocol.ServiceWorker.ServiceWorkerVersionStatus.Redundant */]: i18nLazyString(
      UIStrings.redundant,
    ),
  };
...
class ServiceWorkerContextNamer {
  ...
  executionContextCreated(event) {
    ...
    this.updateContextLabel(
      executionContext,
      this.#versionByTargetId.get(serviceWorkerTargetId) || null,
    );
  }
  ...
  updateContextLabel(context, version) {
    ...
    context.setLabel(
      i18nString(UIStrings.sSS, { PH1: label, PH2: version.id, PH3: localizedStatus() }),
    );
  }
}
SDKModel.register(ServiceWorkerManager, {
  capabilities: 16384 /* Capability.SERVICE_WORKER */,
  autostart: true,
});
