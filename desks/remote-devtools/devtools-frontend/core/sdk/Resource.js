...
export class Resource {
  ...
  constructor(
    ...
    this.#lastModified =
      lastModified && Platform.DateUtilities.isValid(lastModified) ? lastModified : null;
  ...
  contentType() {
    if (
      this.resourceType() === Common.ResourceType.resourceTypes.Document &&
  ...
  async searchInContent(query, caseSensitive, isRegex) {
    ...
    const result = await this.#resourceTreeModel
      .target()
      .pageAgent()
