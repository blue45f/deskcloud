    ...
    if (!Host.InspectorFrontendHost.isUnderTest()) {
      void this.#logAgent.invoke_startViolationsReport({
        config: [
          ...
          {
            name: 'blockedEvent' /* Protocol.Log.ViolationSettingName.BlockedEvent */,
            threshold: 100,
          },
          {
            name: 'blockedParser' /* Protocol.Log.ViolationSettingName.BlockedParser */,
            threshold: -1,
          },
          { name: 'handler' /* Protocol.Log.ViolationSettingName.Handler */, threshold: 150 },
          {
            name: 'recurringHandler' /* Protocol.Log.ViolationSettingName.RecurringHandler */,
            threshold: 50,
          },
          {
            name: 'discouragedAPIUse' /* Protocol.Log.ViolationSettingName.DiscouragedAPIUse */,
            threshold: -1,
          },
        ],
      });
