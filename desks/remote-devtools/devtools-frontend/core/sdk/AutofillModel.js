...
export class AutofillModel extends SDKModel {
  ...
  constructor(target) {
    ...
    this.#showTestAddressesInAutofillMenu = settings.createSetting(
            ...
            },
            {
              fields: [
                ...
                { name: 'ADDRESS_HOME_DEPENDENT_LOCALITY', value: 'Lomas de Chapultepec' },
                {
                  ...
                  value:
                    'Entre calle Volcán y calle Montes Celestes, cerca de la estación de metro',
                },
                {
