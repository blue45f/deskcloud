...
export class Settings {
  ...
  constructor({
    ...
    for (const registration of this.#settingRegistrations) {
      ...
      const setting =
        isRegex && typeof evaluatedDefaultValue === 'string'
      ...
      if (registration.userActionCondition) {
        setting.setRequiresUserAction(
          Boolean(Root.Runtime.Runtime.queryParam(registration.userActionCondition)),
        );
      }
  ...
  constructor({ deprecationNotice }) {
    ...
    this.experiment = deprecationNotice.experiment
      ? Root.Runtime.experiments
          ...
          .find((e) => e.name === deprecationNotice.experiment)
      : undefined;
  }
}
