...
(function (FunctionalityType) {
  ...
  FunctionalityType[(FunctionalityType['FUNCTIONALITY_TYPE_UNSPECIFIED'] = 0)] =
    'FUNCTIONALITY_TYPE_UNSPECIFIED';
...
(function (ClientFeature) {
  ...
  ClientFeature[(ClientFeature['CHROME_PERFORMANCE_ANNOTATIONS_AGENT'] = 20)] =
    'CHROME_PERFORMANCE_ANNOTATIONS_AGENT';
  ...
  ClientFeature[(ClientFeature['CHROME_PERFORMANCE_FULL_AGENT'] = 24)] =
    'CHROME_PERFORMANCE_FULL_AGENT';
  // Chrome Context Selection Agent.
  ClientFeature[(ClientFeature['CHROME_CONTEXT_SELECTION_AGENT'] = 25)] =
    'CHROME_CONTEXT_SELECTION_AGENT';
  ...
  ClientFeature[(ClientFeature['CHROME_CONVERSATION_SUMMARY_AGENT'] = 27)] =
    'CHROME_CONVERSATION_SUMMARY_AGENT';
