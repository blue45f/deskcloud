...
export class UserMetrics {
  ...
  panelShown(panelName, isLaunching) {
    ...
    InspectorFrontendHostInstance.recordEnumeratedHistogram(
      'DevTools.PanelShown' /* EnumeratedHistogram.PanelShown */,
      code,
      PanelCodes.MAX_VALUE,
    );
  ...
  sourcesPanelFileDebugged(mediaType) {
    ...
    InspectorFrontendHostInstance.recordEnumeratedHistogram(
      'DevTools.SourcesPanelFileDebugged' /* EnumeratedHistogram.SourcesPanelFileDebugged */,
      code,
  ...
  sourcesPanelFileOpened(mediaType) {
    const code = (mediaType && MediaTypes[mediaType]) || MediaTypes.Unknown;
    InspectorFrontendHostInstance.recordEnumeratedHistogram(
      'DevTools.SourcesPanelFileOpened' /* EnumeratedHistogram.SourcesPanelFileOpened */,
      code,
      MediaTypes.MAX_VALUE,
    );
  }
  networkPanelResponsePreviewOpened(mediaType) {
    const code = (mediaType && MediaTypes[mediaType]) || MediaTypes.Unknown;
    InspectorFrontendHostInstance.recordEnumeratedHistogram(
      'DevTools.NetworkPanelResponsePreviewOpened' /* EnumeratedHistogram.NetworkPanelResponsePreviewOpened */,
      code,
      MediaTypes.MAX_VALUE,
    );
  }
  actionTaken(action) {
    InspectorFrontendHostInstance.recordEnumeratedHistogram(
      'DevTools.ActionTaken' /* EnumeratedHistogram.ActionTaken */,
      action,
      Action.MAX_VALUE,
    );
  }
  panelLoaded(panelName, histogramName) {
    ...
    // Use rAF and globalThis.setTimeout to ensure the marker is fired after layout and rendering.
  ...
  keybindSetSettingChanged(keybindSet) {
    ...
    InspectorFrontendHostInstance.recordEnumeratedHistogram(
      'DevTools.KeybindSetSettingChanged' /* EnumeratedHistogram.KeybindSetSettingChanged */,
      value,
  ...
  keyboardShortcutFired(actionId) {
    ...
    InspectorFrontendHostInstance.recordEnumeratedHistogram(
      'DevTools.KeyboardShortcutFired' /* EnumeratedHistogram.KeyboardShortcutFired */,
      action,
  ...
  issuesPanelOpenedFrom(issueOpener) {
    InspectorFrontendHostInstance.recordEnumeratedHistogram(
      'DevTools.IssuesPanelOpenedFrom' /* EnumeratedHistogram.IssuesPanelOpenedFrom */,
      issueOpener,
      6 /* IssueOpener.MAX_VALUE */,
    );
  }
  issuesPanelIssueExpanded(issueExpandedCategory) {
    ...
    InspectorFrontendHostInstance.recordEnumeratedHistogram(
      'DevTools.IssuesPanelIssueExpanded' /* EnumeratedHistogram.IssuesPanelIssueExpanded */,
      issueExpanded,
  ...
  issuesPanelResourceOpened(issueCategory, type) {
    ...
    InspectorFrontendHostInstance.recordEnumeratedHistogram(
      'DevTools.IssuesPanelResourceOpened' /* EnumeratedHistogram.IssuesPanelResourceOpened */,
      value,
  ...
  issueCreated(code) {
    ...
    InspectorFrontendHostInstance.recordEnumeratedHistogram(
      'DevTools.IssueCreated' /* EnumeratedHistogram.IssueCreated */,
      issueCreated,
  ...
  experimentEnabledAtLaunch(experimentId) {
    ...
    InspectorFrontendHostInstance.recordEnumeratedHistogram(
      'DevTools.ExperimentEnabledAtLaunch' /* EnumeratedHistogram.ExperimentEnabledAtLaunch */,
      experiment,
  ...
  navigationSettingAtFirstTimelineLoad(state) {
    InspectorFrontendHostInstance.recordEnumeratedHistogram(
      'DevTools.TimelineNavigationSettingState' /* EnumeratedHistogram.TimelineNavigationSettingState */,
      state,
      4 /* TimelineNavigationSetting.MAX_VALUE */,
    );
  }
  experimentDisabledAtLaunch(experimentId) {
    ...
    InspectorFrontendHostInstance.recordEnumeratedHistogram(
      'DevTools.ExperimentDisabledAtLaunch' /* EnumeratedHistogram.ExperimentDisabledAtLaunch */,
      experiment,
      DevtoolsExperiments.MAX_VALUE,
    );
  }
  experimentChanged(experimentId, isEnabled) {
    ...
    const actionName = isEnabled
      ? 'DevTools.ExperimentEnabled' /* EnumeratedHistogram.ExperimentEnabled */
      : 'DevTools.ExperimentDisabled'; /* EnumeratedHistogram.ExperimentDisabled */
    InspectorFrontendHostInstance.recordEnumeratedHistogram(
      actionName,
      experiment,
      DevtoolsExperiments.MAX_VALUE,
  ...
  developerResourceLoaded(developerResourceLoaded) {
    ...
    InspectorFrontendHostInstance.recordEnumeratedHistogram(
      'DevTools.DeveloperResourceLoaded' /* EnumeratedHistogram.DeveloperResourceLoaded */,
      developerResourceLoaded,
      8 /* DeveloperResourceLoaded.MAX_VALUE */,
    );
  }
  developerResourceScheme(developerResourceScheme) {
    ...
    InspectorFrontendHostInstance.recordEnumeratedHistogram(
      'DevTools.DeveloperResourceScheme' /* EnumeratedHistogram.DeveloperResourceScheme */,
      developerResourceScheme,
      9 /* DeveloperResourceScheme.MAX_VALUE */,
    );
  }
  language(language) {
    ...
    InspectorFrontendHostInstance.recordEnumeratedHistogram(
      'DevTools.Language' /* EnumeratedHistogram.Language */,
      languageCode,
      Language.MAX_VALUE,
    );
  }
  syncSetting(devtoolsSyncSettingEnabled) {
    InspectorFrontendHostInstance.getSyncInformation((syncInfo) => {
      ...
      if (syncInfo.isSyncActive && !syncInfo.arePreferencesSynced) {
        ...
        settingValue = devtoolsSyncSettingEnabled
          ? 4 /* SyncSetting.DEVTOOLS_SYNC_SETTING_ENABLED */
          : 3 /* SyncSetting.DEVTOOLS_SYNC_SETTING_DISABLED */;
      }
      InspectorFrontendHostInstance.recordEnumeratedHistogram(
        'DevTools.SyncSetting' /* EnumeratedHistogram.SyncSetting */,
        settingValue,
        5 /* SyncSetting.MAX_VALUE */,
      );
    });
  }
  recordingToggled(value) {
    InspectorFrontendHostInstance.recordEnumeratedHistogram(
      'DevTools.RecordingToggled' /* EnumeratedHistogram.RecordingToggled */,
      value,
      3 /* RecordingToggled.MAX_VALUE */,
    );
  }
  recordingReplayFinished(value) {
    InspectorFrontendHostInstance.recordEnumeratedHistogram(
      'DevTools.RecordingReplayFinished' /* EnumeratedHistogram.RecordingReplayFinished */,
      value,
      5 /* RecordingReplayFinished.MAX_VALUE */,
    );
  }
  recordingReplayStarted(value) {
    InspectorFrontendHostInstance.recordEnumeratedHistogram(
      'DevTools.RecordingReplayStarted' /* EnumeratedHistogram.RecordingReplayStarted */,
      value,
      4 /* RecordingReplayStarted.MAX_VALUE */,
    );
  }
  lighthouseModeRun(type) {
    InspectorFrontendHostInstance.recordEnumeratedHistogram(
      'DevTools.LighthouseModeRun' /* EnumeratedHistogram.LighthouseModeRun */,
      type,
      4 /* LighthouseModeRun.MAX_VALUE */,
    );
  }
  lighthouseCategoryUsed(type) {
    InspectorFrontendHostInstance.recordEnumeratedHistogram(
      'DevTools.LighthouseCategoryUsed' /* EnumeratedHistogram.LighthouseCategoryUsed */,
      type,
      6 /* LighthouseCategoryUsed.MAX_VALUE */,
    );
  }
  swatchActivated(swatch) {
    InspectorFrontendHostInstance.recordEnumeratedHistogram(
      'DevTools.SwatchActivated' /* EnumeratedHistogram.SwatchActivated */,
      swatch,
      13 /* SwatchType.MAX_VALUE */,
    );
  }
  ...
  builtInAiAvailability(availability) {
    InspectorFrontendHostInstance.recordEnumeratedHistogram(
      'DevTools.BuiltInAiAvailability' /* EnumeratedHistogram.BuiltInAiAvailability */,
      availability,
      10 /* BuiltInAiAvailability.MAX_VALUE */,
    );
  }
  ...
  extensionEvalTarget(target) {
    InspectorFrontendHostInstance.recordEnumeratedHistogram(
      'DevTools.ExtensionEvalTarget' /* EnumeratedHistogram.ExtensionEvalTarget */,
      target,
      3 /* ExtensionEvalTarget.MAX_VALUE */,
    );
  }
}
/**
...
(function (Action) {
  ...
  Action[(Action['FileSystemDirectoryContentReceived'] = 13)] =
    'FileSystemDirectoryContentReceived';
  ...
  Action[(Action['ChangeInspectedNodeInElementsPanel'] = 26)] =
    'ChangeInspectedNodeInElementsPanel';
  ...
  Action[(Action['SettingsOpenedFromCommandMenu-deprecated'] = 38)] =
  ...
  Action[(Action['VirtualAuthenticatorEnvironmentEnabled'] = 42)] =
    'VirtualAuthenticatorEnvironmentEnabled';
  ...
  Action[(Action['ServiceWorkerNetworkRequestClicked'] = 49)] =
    'ServiceWorkerNetworkRequestClicked';
  Action[(Action['ServiceWorkerNetworkRequestClosedQuickly'] = 50)] =
    'ServiceWorkerNetworkRequestClosedQuickly';
  Action[(Action['NetworkPanelServiceWorkerRespondWith'] = 51)] =
    'NetworkPanelServiceWorkerRespondWith';
  ...
  Action[(Action['BreakpointGroupExpandedStateChanged'] = 59)] =
    'BreakpointGroupExpandedStateChanged';
  Action[(Action['HeaderOverrideFileCreated'] = 60)] = 'HeaderOverrideFileCreated';
  Action[(Action['HeaderOverrideEnableEditingClicked'] = 61)] =
    'HeaderOverrideEnableEditingClicked';
  ...
  Action[(Action['PersistenceNetworkOverridesEnabled'] = 66)] =
    'PersistenceNetworkOverridesEnabled';
  Action[(Action['PersistenceNetworkOverridesDisabled'] = 67)] =
    'PersistenceNetworkOverridesDisabled';
  Action[(Action['BreakpointRemovedFromContextMenu'] = 68)] = 'BreakpointRemovedFromContextMenu';
  Action[(Action['BreakpointsInFileRemovedFromRemoveButton'] = 69)] =
    'BreakpointsInFileRemovedFromRemoveButton';
  Action[(Action['BreakpointsInFileRemovedFromContextMenu'] = 70)] =
  ...
  Action[(Action['BreakpointsInFileEnabledDisabledFromContextMenu'] = 72)] =
    'BreakpointsInFileEnabledDisabledFromContextMenu';
  Action[(Action['BreakpointConditionEditedFromSidebar'] = 73)] =
    'BreakpointConditionEditedFromSidebar';
  ...
  Action[(Action['BreakpointRemovedFromGutterContextMenu'] = 81)] =
    'BreakpointRemovedFromGutterContextMenu';
  ...
  Action[(Action['OverrideContentFromSourcesContextMenu'] = 84)] =
    'OverrideContentFromSourcesContextMenu';
  Action[(Action['OverrideContentFromNetworkContextMenu'] = 85)] =
    'OverrideContentFromNetworkContextMenu';
  ...
  Action[(Action['OverrideContentContextMenuAbandonSetup'] = 93)] =
    'OverrideContentContextMenuAbandonSetup';
  Action[(Action['OverrideContentContextMenuActivateDisabled'] = 94)] =
    'OverrideContentContextMenuActivateDisabled';
  Action[(Action['OverrideContentContextMenuOpenExistingFile'] = 95)] =
    'OverrideContentContextMenuOpenExistingFile';
  Action[(Action['OverrideContentContextMenuSaveNewFile'] = 96)] =
    'OverrideContentContextMenuSaveNewFile';
  Action[(Action['ShowAllOverridesFromSourcesContextMenu'] = 97)] =
    'ShowAllOverridesFromSourcesContextMenu';
  Action[(Action['ShowAllOverridesFromNetworkContextMenu'] = 98)] =
    'ShowAllOverridesFromNetworkContextMenu';
  ...
  Action[(Action['OverrideTabDeleteFolderContextMenu'] = 105)] =
    'OverrideTabDeleteFolderContextMenu';
  Action[(Action['WorkspaceDropFolder'] = 107)] = 'WorkspaceDropFolder';
  Action[(Action['WorkspaceSelectFolder'] = 108)] = 'WorkspaceSelectFolder';
  Action[(Action['OverrideContentContextMenuSourceMappedWarning'] = 109)] =
    'OverrideContentContextMenuSourceMappedWarning';
  Action[(Action['OverrideContentContextMenuRedirectToDeployed'] = 110)] =
  ...
  Action[(Action['ToggleEmulateFocusedPageFromStylesPaneOn'] = 126)] =
    'ToggleEmulateFocusedPageFromStylesPaneOn';
  Action[(Action['ToggleEmulateFocusedPageFromStylesPaneOff'] = 127)] =
    'ToggleEmulateFocusedPageFromStylesPaneOff';
  Action[(Action['ToggleEmulateFocusedPageFromRenderingTab'] = 128)] =
    'ToggleEmulateFocusedPageFromRenderingTab';
  Action[(Action['ToggleEmulateFocusedPageFromCommandMenu'] = 129)] =
  ...
  Action[(Action['ScrollDrivenAnimationGroupSelected'] = 143)] =
    'ScrollDrivenAnimationGroupSelected';
  Action[(Action['ScrollDrivenAnimationGroupScrubbed'] = 144)] =
    'ScrollDrivenAnimationGroupScrubbed';
  Action[(Action['AiAssistanceOpenedFromElementsPanel'] = 145)] =
    'AiAssistanceOpenedFromElementsPanel';
  ...
  Action[(Action['InsightsOptInTeaserSettingsLinkClicked'] = 161)] =
    'InsightsOptInTeaserSettingsLinkClicked';
  Action[(Action['InsightsOptInTeaserConfirmedInSettings'] = 162)] =
  ...
  Action[(Action['InsightsReminderTeaserSettingsLinkClicked'] = 166)] =
    'InsightsReminderTeaserSettingsLinkClicked';
  Action[(Action['InsightsReminderTeaserAbortedInSettings'] = 167)] =
    'InsightsReminderTeaserAbortedInSettings';
  Action[(Action['GeneratingInsightWithoutDisclaimer'] = 168)] =
    'GeneratingInsightWithoutDisclaimer';
  Action[(Action['AiAssistanceOpenedFromElementsPanelFloatingButton'] = 169)] =
    'AiAssistanceOpenedFromElementsPanelFloatingButton';
  Action[(Action['AiAssistanceOpenedFromNetworkPanel'] = 170)] =
    'AiAssistanceOpenedFromNetworkPanel';
  Action[(Action['AiAssistanceOpenedFromSourcesPanel'] = 171)] =
    'AiAssistanceOpenedFromSourcesPanel';
  Action[(Action['AiAssistanceOpenedFromSourcesPanelFloatingButton'] = 172)] =
    'AiAssistanceOpenedFromSourcesPanelFloatingButton';
  Action[(Action['AiAssistanceOpenedFromPerformancePanelCallTree'] = 173)] =
    'AiAssistanceOpenedFromPerformancePanelCallTree';
  Action[(Action['AiAssistanceOpenedFromNetworkPanelFloatingButton'] = 174)] =
  ...
  Action[(Action['AiAssistanceDynamicSuggestionClicked'] = 178)] =
    'AiAssistanceDynamicSuggestionClicked';
  ...
  Action[(Action['AiCodeCompletionResponseServedFromCache'] = 184)] =
  ...
  Action[(Action['AiCodeCompletionSuggestionDisplayed'] = 186)] =
    'AiCodeCompletionSuggestionDisplayed';
  Action[(Action['AiCodeCompletionSuggestionAccepted'] = 187)] =
    'AiCodeCompletionSuggestionAccepted';
  ...
  Action[(Action['AiCodeGenerationSuggestionDisplayed'] = 195)] =
    'AiCodeGenerationSuggestionDisplayed';
  Action[(Action['AiCodeGenerationSuggestionAccepted'] = 196)] =
    'AiCodeGenerationSuggestionAccepted';
  Action[(Action['InsightTeaserModelDownloadStarted'] = 197)] = 'InsightTeaserModelDownloadStarted';
  Action[(Action['InsightTeaserModelDownloadCompleted'] = 198)] =
    'InsightTeaserModelDownloadCompleted';
...
(function (PanelCodes) {
  ...
  PanelCodes[(PanelCodes['settings-throttling-conditions'] = 34)] =
    'settings-throttling-conditions';
  ...
  PanelCodes[(PanelCodes['background-service-background-fetch'] = 46)] =
    'background-service-background-fetch';
  PanelCodes[(PanelCodes['background-service-background-sync'] = 47)] =
    'background-service-background-sync';
  PanelCodes[(PanelCodes['background-service-push-messaging'] = 48)] =
    'background-service-push-messaging';
  PanelCodes[(PanelCodes['background-service-notifications'] = 49)] =
    'background-service-notifications';
  PanelCodes[(PanelCodes['background-service-payment-handler'] = 50)] =
    'background-service-payment-handler';
  PanelCodes[(PanelCodes['background-service-periodic-background-sync'] = 51)] =
...
(function (KeyboardShortcutAction) {
  ...
  KeyboardShortcutAction[(KeyboardShortcutAction['quick-open.show-command-menu'] = 1)] =
  ...
  KeyboardShortcutAction[(KeyboardShortcutAction['debugger.toggle-breakpoint'] = 8)] =
    'debugger.toggle-breakpoint';
  KeyboardShortcutAction[(KeyboardShortcutAction['debugger.toggle-breakpoint-enabled'] = 9)] =
    'debugger.toggle-breakpoint-enabled';
  KeyboardShortcutAction[(KeyboardShortcutAction['debugger.toggle-pause'] = 10)] =
    'debugger.toggle-pause';
  KeyboardShortcutAction[(KeyboardShortcutAction['elements.edit-as-html'] = 11)] =
    'elements.edit-as-html';
  KeyboardShortcutAction[(KeyboardShortcutAction['elements.hide-element'] = 12)] =
    'elements.hide-element';
  KeyboardShortcutAction[(KeyboardShortcutAction['elements.redo'] = 13)] = 'elements.redo';
  KeyboardShortcutAction[(KeyboardShortcutAction['elements.toggle-element-search'] = 14)] =
    'elements.toggle-element-search';
  KeyboardShortcutAction[(KeyboardShortcutAction['elements.undo'] = 15)] = 'elements.undo';
  KeyboardShortcutAction[(KeyboardShortcutAction['main.search-in-panel.find'] = 16)] =
    'main.search-in-panel.find';
  KeyboardShortcutAction[(KeyboardShortcutAction['main.toggle-drawer'] = 17)] =
    'main.toggle-drawer';
  KeyboardShortcutAction[(KeyboardShortcutAction['network.hide-request-details'] = 18)] =
    'network.hide-request-details';
  KeyboardShortcutAction[(KeyboardShortcutAction['network.search'] = 19)] = 'network.search';
  KeyboardShortcutAction[(KeyboardShortcutAction['network.toggle-recording'] = 20)] =
  ...
  KeyboardShortcutAction[(KeyboardShortcutAction['background-service.toggle-recording'] = 24)] =
    'background-service.toggle-recording';
  KeyboardShortcutAction[(KeyboardShortcutAction['components.collect-garbage'] = 25)] =
    'components.collect-garbage';
  KeyboardShortcutAction[(KeyboardShortcutAction['console.clear.history'] = 26)] =
    'console.clear.history';
  KeyboardShortcutAction[(KeyboardShortcutAction['console.create-pin'] = 27)] =
    'console.create-pin';
  KeyboardShortcutAction[(KeyboardShortcutAction['coverage.start-with-reload'] = 28)] =
    'coverage.start-with-reload';
  KeyboardShortcutAction[(KeyboardShortcutAction['coverage.toggle-recording'] = 29)] =
    'coverage.toggle-recording';
  KeyboardShortcutAction[(KeyboardShortcutAction['debugger.breakpoint-input-window'] = 30)] =
    'debugger.breakpoint-input-window';
  KeyboardShortcutAction[(KeyboardShortcutAction['debugger.evaluate-selection'] = 31)] =
    'debugger.evaluate-selection';
  KeyboardShortcutAction[(KeyboardShortcutAction['debugger.next-call-frame'] = 32)] =
    'debugger.next-call-frame';
  KeyboardShortcutAction[(KeyboardShortcutAction['debugger.previous-call-frame'] = 33)] =
    'debugger.previous-call-frame';
  KeyboardShortcutAction[(KeyboardShortcutAction['debugger.run-snippet'] = 34)] =
    'debugger.run-snippet';
  KeyboardShortcutAction[(KeyboardShortcutAction['debugger.toggle-breakpoints-active'] = 35)] =
    'debugger.toggle-breakpoints-active';
  KeyboardShortcutAction[(KeyboardShortcutAction['elements.capture-area-screenshot'] = 36)] =
    'elements.capture-area-screenshot';
  KeyboardShortcutAction[
    (KeyboardShortcutAction['emulation.capture-full-height-screenshot'] = 37)
  ] = 'emulation.capture-full-height-screenshot';
  KeyboardShortcutAction[(KeyboardShortcutAction['emulation.capture-node-screenshot'] = 38)] =
    'emulation.capture-node-screenshot';
  KeyboardShortcutAction[(KeyboardShortcutAction['emulation.capture-screenshot'] = 39)] =
    'emulation.capture-screenshot';
  KeyboardShortcutAction[(KeyboardShortcutAction['emulation.show-sensors'] = 40)] =
    'emulation.show-sensors';
  KeyboardShortcutAction[(KeyboardShortcutAction['emulation.toggle-device-mode'] = 41)] =
    'emulation.toggle-device-mode';
  KeyboardShortcutAction[(KeyboardShortcutAction['help.release-notes'] = 42)] =
    'help.release-notes';
  KeyboardShortcutAction[(KeyboardShortcutAction['help.report-issue'] = 43)] = 'help.report-issue';
  KeyboardShortcutAction[(KeyboardShortcutAction['input.start-replaying'] = 44)] =
    'input.start-replaying';
  KeyboardShortcutAction[(KeyboardShortcutAction['input.toggle-pause'] = 45)] =
    'input.toggle-pause';
  KeyboardShortcutAction[(KeyboardShortcutAction['input.toggle-recording'] = 46)] =
    'input.toggle-recording';
  KeyboardShortcutAction[(KeyboardShortcutAction['inspector-main.focus-debuggee'] = 47)] =
    'inspector-main.focus-debuggee';
  KeyboardShortcutAction[(KeyboardShortcutAction['inspector-main.hard-reload'] = 48)] =
    'inspector-main.hard-reload';
  KeyboardShortcutAction[(KeyboardShortcutAction['inspector-main.reload'] = 49)] =
    'inspector-main.reload';
  KeyboardShortcutAction[(KeyboardShortcutAction['live-heap-profile.start-with-reload'] = 50)] =
    'live-heap-profile.start-with-reload';
  KeyboardShortcutAction[(KeyboardShortcutAction['live-heap-profile.toggle-recording'] = 51)] =
  ...
  KeyboardShortcutAction[(KeyboardShortcutAction['main.search-in-panel.cancel'] = 55)] =
    'main.search-in-panel.cancel';
  KeyboardShortcutAction[(KeyboardShortcutAction['main.search-in-panel.find-next'] = 56)] =
    'main.search-in-panel.find-next';
  KeyboardShortcutAction[(KeyboardShortcutAction['main.search-in-panel.find-previous'] = 57)] =
  ...
  KeyboardShortcutAction[
    (KeyboardShortcutAction['network-conditions.network-low-end-mobile'] = 62)
  ] = 'network-conditions.network-low-end-mobile';
  KeyboardShortcutAction[
    (KeyboardShortcutAction['network-conditions.network-mid-tier-mobile'] = 63)
  ] = 'network-conditions.network-mid-tier-mobile';
  KeyboardShortcutAction[(KeyboardShortcutAction['network-conditions.network-offline'] = 64)] =
    'network-conditions.network-offline';
  KeyboardShortcutAction[(KeyboardShortcutAction['network-conditions.network-online'] = 65)] =
    'network-conditions.network-online';
  KeyboardShortcutAction[(KeyboardShortcutAction['profiler.heap-toggle-recording'] = 66)] =
    'profiler.heap-toggle-recording';
  KeyboardShortcutAction[(KeyboardShortcutAction['profiler.js-toggle-recording'] = 67)] =
    'profiler.js-toggle-recording';
  KeyboardShortcutAction[(KeyboardShortcutAction['resources.clear'] = 68)] = 'resources.clear';
  KeyboardShortcutAction[(KeyboardShortcutAction['settings.documentation'] = 69)] =
    'settings.documentation';
  KeyboardShortcutAction[(KeyboardShortcutAction['settings.shortcuts'] = 70)] =
    'settings.shortcuts';
  KeyboardShortcutAction[(KeyboardShortcutAction['sources.add-folder-to-workspace'] = 71)] =
    'sources.add-folder-to-workspace';
  KeyboardShortcutAction[(KeyboardShortcutAction['sources.add-to-watch'] = 72)] =
    'sources.add-to-watch';
  KeyboardShortcutAction[(KeyboardShortcutAction['sources.close-all'] = 73)] = 'sources.close-all';
  KeyboardShortcutAction[(KeyboardShortcutAction['sources.close-editor-tab'] = 74)] =
    'sources.close-editor-tab';
  KeyboardShortcutAction[(KeyboardShortcutAction['sources.create-snippet'] = 75)] =
    'sources.create-snippet';
  KeyboardShortcutAction[(KeyboardShortcutAction['sources.go-to-line'] = 76)] =
    'sources.go-to-line';
  KeyboardShortcutAction[(KeyboardShortcutAction['sources.go-to-member'] = 77)] =
    'sources.go-to-member';
  KeyboardShortcutAction[(KeyboardShortcutAction['sources.jump-to-next-location'] = 78)] =
    'sources.jump-to-next-location';
  KeyboardShortcutAction[(KeyboardShortcutAction['sources.jump-to-previous-location'] = 79)] =
  ...
  KeyboardShortcutAction[(KeyboardShortcutAction['sources.switch-file'] = 83)] =
    'sources.switch-file';
  KeyboardShortcutAction[(KeyboardShortcutAction['timeline.jump-to-next-frame'] = 84)] =
    'timeline.jump-to-next-frame';
  KeyboardShortcutAction[(KeyboardShortcutAction['timeline.jump-to-previous-frame'] = 85)] =
    'timeline.jump-to-previous-frame';
  KeyboardShortcutAction[(KeyboardShortcutAction['timeline.load-from-file'] = 86)] =
    'timeline.load-from-file';
  KeyboardShortcutAction[(KeyboardShortcutAction['timeline.next-recording'] = 87)] =
    'timeline.next-recording';
  KeyboardShortcutAction[(KeyboardShortcutAction['timeline.previous-recording'] = 88)] =
    'timeline.previous-recording';
  KeyboardShortcutAction[(KeyboardShortcutAction['timeline.record-reload'] = 89)] =
    'timeline.record-reload';
  KeyboardShortcutAction[(KeyboardShortcutAction['timeline.save-to-file'] = 90)] =
    'timeline.save-to-file';
  KeyboardShortcutAction[(KeyboardShortcutAction['timeline.show-history'] = 91)] =
    'timeline.show-history';
  KeyboardShortcutAction[(KeyboardShortcutAction['timeline.toggle-recording'] = 92)] =
    'timeline.toggle-recording';
  KeyboardShortcutAction[(KeyboardShortcutAction['sources.increment-css'] = 93)] =
    'sources.increment-css';
  KeyboardShortcutAction[(KeyboardShortcutAction['sources.increment-css-by-ten'] = 94)] =
    'sources.increment-css-by-ten';
  KeyboardShortcutAction[(KeyboardShortcutAction['sources.decrement-css'] = 95)] =
    'sources.decrement-css';
  KeyboardShortcutAction[(KeyboardShortcutAction['sources.decrement-css-by-ten'] = 96)] =
  ...
  KeyboardShortcutAction[(KeyboardShortcutAction['layers.rotate-mode'] = 99)] =
    'layers.rotate-mode';
  ...
  KeyboardShortcutAction[(KeyboardShortcutAction['help.report-translation-issue'] = 106)] =
    'help.report-translation-issue';
  KeyboardShortcutAction[(KeyboardShortcutAction['rendering.toggle-prefers-color-scheme'] = 107)] =
    'rendering.toggle-prefers-color-scheme';
  KeyboardShortcutAction[(KeyboardShortcutAction['chrome-recorder.start-recording'] = 108)] =
    'chrome-recorder.start-recording';
  KeyboardShortcutAction[(KeyboardShortcutAction['chrome-recorder.replay-recording'] = 109)] =
    'chrome-recorder.replay-recording';
  KeyboardShortcutAction[(KeyboardShortcutAction['chrome-recorder.toggle-code-view'] = 110)] =
    'chrome-recorder.toggle-code-view';
  KeyboardShortcutAction[(KeyboardShortcutAction['chrome-recorder.copy-recording-or-step'] = 111)] =
    'chrome-recorder.copy-recording-or-step';
  KeyboardShortcutAction[(KeyboardShortcutAction['elements.new-style-rule'] = 114)] =
    'elements.new-style-rule';
  KeyboardShortcutAction[(KeyboardShortcutAction['elements.refresh-event-listeners'] = 115)] =
  ...
  KeyboardShortcutAction[(KeyboardShortcutAction['timeline.dim-third-parties'] = 118)] =
    'timeline.dim-third-parties';
  KeyboardShortcutAction[(KeyboardShortcutAction['main.toggle-drawer-orientation'] = 119)] =
...
(function (DevtoolsExperiments) {
  /* eslint-disable @typescript-eslint/naming-convention */
  DevtoolsExperiments[(DevtoolsExperiments['capture-node-creation-stacks'] = 1)] =
  ...
  DevtoolsExperiments[(DevtoolsExperiments['sampling-heap-profiler-timeline'] = 17)] =
    'sampling-heap-profiler-timeline';
  DevtoolsExperiments[(DevtoolsExperiments['timeline-invalidation-tracking'] = 26)] =
  ...
  DevtoolsExperiments[(DevtoolsExperiments['instrumentation-breakpoints'] = 61)] =
    'instrumentation-breakpoints';
  DevtoolsExperiments[(DevtoolsExperiments['use-source-map-scopes'] = 76)] =
...
(function (IssueResourceOpened) {
  /* eslint-disable @typescript-eslint/naming-convention */
  IssueResourceOpened[(IssueResourceOpened['CrossOriginEmbedderPolicyRequest'] = 0)] =
    'CrossOriginEmbedderPolicyRequest';
  IssueResourceOpened[(IssueResourceOpened['CrossOriginEmbedderPolicyElement'] = 1)] =
    'CrossOriginEmbedderPolicyElement';
  ...
  IssueResourceOpened[(IssueResourceOpened['ContentSecurityPolicyDirective'] = 6)] =
    'ContentSecurityPolicyDirective';
  IssueResourceOpened[(IssueResourceOpened['ContentSecurityPolicyElement'] = 7)] =
...
(function (IssueCreated) {
  ...
  IssueCreated[(IssueCreated['ContentSecurityPolicyIssue::kInlineViolation'] = 1)] =
    'ContentSecurityPolicyIssue::kInlineViolation';
  IssueCreated[(IssueCreated['ContentSecurityPolicyIssue::kEvalViolation'] = 2)] =
    'ContentSecurityPolicyIssue::kEvalViolation';
  IssueCreated[(IssueCreated['ContentSecurityPolicyIssue::kURLViolation'] = 3)] =
    'ContentSecurityPolicyIssue::kURLViolation';
  IssueCreated[(IssueCreated['ContentSecurityPolicyIssue::kTrustedTypesSinkViolation'] = 4)] =
    'ContentSecurityPolicyIssue::kTrustedTypesSinkViolation';
  IssueCreated[(IssueCreated['ContentSecurityPolicyIssue::kTrustedTypesPolicyViolation'] = 5)] =
    'ContentSecurityPolicyIssue::kTrustedTypesPolicyViolation';
  IssueCreated[(IssueCreated['HeavyAdIssue::NetworkTotalLimit'] = 6)] =
    'HeavyAdIssue::NetworkTotalLimit';
  ...
  IssueCreated[
    (IssueCreated['CrossOriginEmbedderPolicyIssue::CoepFrameResourceNeedsCoepHeader'] = 9)
  ] = 'CrossOriginEmbedderPolicyIssue::CoepFrameResourceNeedsCoepHeader';
  IssueCreated[
    (IssueCreated['CrossOriginEmbedderPolicyIssue::CoopSandboxedIFrameCannotNavigateToCoopPage'] =
      10)
  ] = 'CrossOriginEmbedderPolicyIssue::CoopSandboxedIFrameCannotNavigateToCoopPage';
  IssueCreated[(IssueCreated['CrossOriginEmbedderPolicyIssue::CorpNotSameOrigin'] = 11)] =
  ...
  IssueCreated[(IssueCreated['CrossOriginEmbedderPolicyIssue::CorpNotSameSite'] = 13)] =
    'CrossOriginEmbedderPolicyIssue::CorpNotSameSite';
  IssueCreated[(IssueCreated['CookieIssue::ExcludeSameSiteNoneInsecure::ReadCookie'] = 14)] =
    'CookieIssue::ExcludeSameSiteNoneInsecure::ReadCookie';
  IssueCreated[(IssueCreated['CookieIssue::ExcludeSameSiteNoneInsecure::SetCookie'] = 15)] =
    'CookieIssue::ExcludeSameSiteNoneInsecure::SetCookie';
  IssueCreated[(IssueCreated['CookieIssue::WarnSameSiteNoneInsecure::ReadCookie'] = 16)] =
    'CookieIssue::WarnSameSiteNoneInsecure::ReadCookie';
  IssueCreated[(IssueCreated['CookieIssue::WarnSameSiteNoneInsecure::SetCookie'] = 17)] =
    'CookieIssue::WarnSameSiteNoneInsecure::SetCookie';
  IssueCreated[(IssueCreated['CookieIssue::WarnSameSiteStrictLaxDowngradeStrict::Secure'] = 18)] =
    'CookieIssue::WarnSameSiteStrictLaxDowngradeStrict::Secure';
  IssueCreated[(IssueCreated['CookieIssue::WarnSameSiteStrictLaxDowngradeStrict::Insecure'] = 19)] =
    'CookieIssue::WarnSameSiteStrictLaxDowngradeStrict::Insecure';
  IssueCreated[(IssueCreated['CookieIssue::WarnCrossDowngrade::ReadCookie::Secure'] = 20)] =
    'CookieIssue::WarnCrossDowngrade::ReadCookie::Secure';
  IssueCreated[(IssueCreated['CookieIssue::WarnCrossDowngrade::ReadCookie::Insecure'] = 21)] =
    'CookieIssue::WarnCrossDowngrade::ReadCookie::Insecure';
  IssueCreated[(IssueCreated['CookieIssue::WarnCrossDowngrade::SetCookie::Secure'] = 22)] =
    'CookieIssue::WarnCrossDowngrade::SetCookie::Secure';
  IssueCreated[(IssueCreated['CookieIssue::WarnCrossDowngrade::SetCookie::Insecure'] = 23)] =
    'CookieIssue::WarnCrossDowngrade::SetCookie::Insecure';
  IssueCreated[(IssueCreated['CookieIssue::ExcludeNavigationContextDowngrade::Secure'] = 24)] =
    'CookieIssue::ExcludeNavigationContextDowngrade::Secure';
  IssueCreated[(IssueCreated['CookieIssue::ExcludeNavigationContextDowngrade::Insecure'] = 25)] =
    'CookieIssue::ExcludeNavigationContextDowngrade::Insecure';
  IssueCreated[(IssueCreated['CookieIssue::ExcludeContextDowngrade::ReadCookie::Secure'] = 26)] =
    'CookieIssue::ExcludeContextDowngrade::ReadCookie::Secure';
  IssueCreated[(IssueCreated['CookieIssue::ExcludeContextDowngrade::ReadCookie::Insecure'] = 27)] =
  ...
  IssueCreated[(IssueCreated['CookieIssue::ExcludeContextDowngrade::SetCookie::Insecure'] = 29)] =
    'CookieIssue::ExcludeContextDowngrade::SetCookie::Insecure';
  IssueCreated[
    (IssueCreated['CookieIssue::ExcludeSameSiteUnspecifiedTreatedAsLax::ReadCookie'] = 30)
  ] = 'CookieIssue::ExcludeSameSiteUnspecifiedTreatedAsLax::ReadCookie';
  IssueCreated[
    (IssueCreated['CookieIssue::ExcludeSameSiteUnspecifiedTreatedAsLax::SetCookie'] = 31)
  ] = 'CookieIssue::ExcludeSameSiteUnspecifiedTreatedAsLax::SetCookie';
  IssueCreated[
    (IssueCreated['CookieIssue::WarnSameSiteUnspecifiedLaxAllowUnsafe::ReadCookie'] = 32)
  ] = 'CookieIssue::WarnSameSiteUnspecifiedLaxAllowUnsafe::ReadCookie';
  IssueCreated[
    (IssueCreated['CookieIssue::WarnSameSiteUnspecifiedLaxAllowUnsafe::SetCookie'] = 33)
  ] = 'CookieIssue::WarnSameSiteUnspecifiedLaxAllowUnsafe::SetCookie';
  IssueCreated[
    (IssueCreated['CookieIssue::WarnSameSiteUnspecifiedCrossSiteContext::ReadCookie'] = 34)
  ] = 'CookieIssue::WarnSameSiteUnspecifiedCrossSiteContext::ReadCookie';
  IssueCreated[
    (IssueCreated['CookieIssue::WarnSameSiteUnspecifiedCrossSiteContext::SetCookie'] = 35)
  ] = 'CookieIssue::WarnSameSiteUnspecifiedCrossSiteContext::SetCookie';
  IssueCreated[(IssueCreated['SharedArrayBufferIssue::TransferIssue'] = 36)] =
    'SharedArrayBufferIssue::TransferIssue';
  IssueCreated[(IssueCreated['SharedArrayBufferIssue::CreationIssue'] = 37)] =
    'SharedArrayBufferIssue::CreationIssue';
  IssueCreated[(IssueCreated['CorsIssue::InsecureLocalNetwork'] = 42)] =
    'CorsIssue::InsecureLocalNetwork';
  IssueCreated[(IssueCreated['CorsIssue::InvalidHeaders'] = 44)] = 'CorsIssue::InvalidHeaders';
  IssueCreated[(IssueCreated['CorsIssue::WildcardOriginWithCredentials'] = 45)] =
    'CorsIssue::WildcardOriginWithCredentials';
  IssueCreated[(IssueCreated['CorsIssue::PreflightResponseInvalid'] = 46)] =
    'CorsIssue::PreflightResponseInvalid';
  IssueCreated[(IssueCreated['CorsIssue::OriginMismatch'] = 47)] = 'CorsIssue::OriginMismatch';
  IssueCreated[(IssueCreated['CorsIssue::AllowCredentialsRequired'] = 48)] =
    'CorsIssue::AllowCredentialsRequired';
  IssueCreated[(IssueCreated['CorsIssue::MethodDisallowedByPreflightResponse'] = 49)] =
    'CorsIssue::MethodDisallowedByPreflightResponse';
  IssueCreated[(IssueCreated['CorsIssue::HeaderDisallowedByPreflightResponse'] = 50)] =
    'CorsIssue::HeaderDisallowedByPreflightResponse';
  IssueCreated[(IssueCreated['CorsIssue::RedirectContainsCredentials'] = 51)] =
    'CorsIssue::RedirectContainsCredentials';
  IssueCreated[(IssueCreated['CorsIssue::DisallowedByMode'] = 52)] = 'CorsIssue::DisallowedByMode';
  IssueCreated[(IssueCreated['CorsIssue::CorsDisabledScheme'] = 53)] =
    'CorsIssue::CorsDisabledScheme';
  IssueCreated[(IssueCreated['CorsIssue::PreflightMissingAllowExternal'] = 54)] =
    'CorsIssue::PreflightMissingAllowExternal';
  IssueCreated[(IssueCreated['CorsIssue::PreflightInvalidAllowExternal'] = 55)] =
    'CorsIssue::PreflightInvalidAllowExternal';
  IssueCreated[(IssueCreated['CorsIssue::NoCorsRedirectModeNotFollow'] = 57)] =
    'CorsIssue::NoCorsRedirectModeNotFollow';
  IssueCreated[(IssueCreated['QuirksModeIssue::QuirksMode'] = 58)] = 'QuirksModeIssue::QuirksMode';
  IssueCreated[(IssueCreated['QuirksModeIssue::LimitedQuirksMode'] = 59)] =
    'QuirksModeIssue::LimitedQuirksMode';
  IssueCreated[(IssueCreated['DeprecationIssue'] = 60)] = 'DeprecationIssue';
  IssueCreated[(IssueCreated['ClientHintIssue::MetaTagAllowListInvalidOrigin'] = 61)] =
    'ClientHintIssue::MetaTagAllowListInvalidOrigin';
  IssueCreated[(IssueCreated['ClientHintIssue::MetaTagModifiedHTML'] = 62)] =
    'ClientHintIssue::MetaTagModifiedHTML';
  IssueCreated[(IssueCreated['GenericIssue::CrossOriginPortalPostMessageError'] = 64)] =
    'GenericIssue::CrossOriginPortalPostMessageError';
  IssueCreated[(IssueCreated['GenericIssue::FormLabelForNameError'] = 65)] =
    'GenericIssue::FormLabelForNameError';
  IssueCreated[(IssueCreated['GenericIssue::FormDuplicateIdForInputError'] = 66)] =
    'GenericIssue::FormDuplicateIdForInputError';
  IssueCreated[(IssueCreated['GenericIssue::FormInputWithNoLabelError'] = 67)] =
    'GenericIssue::FormInputWithNoLabelError';
  IssueCreated[(IssueCreated['GenericIssue::FormAutocompleteAttributeEmptyError'] = 68)] =
    'GenericIssue::FormAutocompleteAttributeEmptyError';
  IssueCreated[(IssueCreated['GenericIssue::FormEmptyIdAndNameAttributesForInputError'] = 69)] =
    'GenericIssue::FormEmptyIdAndNameAttributesForInputError';
  IssueCreated[(IssueCreated['GenericIssue::FormAriaLabelledByToNonExistingIdError'] = 70)] =
    'GenericIssue::FormAriaLabelledByToNonExistingIdError';
  IssueCreated[
    (IssueCreated['GenericIssue::FormInputAssignedAutocompleteValueToIdOrNameAttributeError'] = 71)
  ] = 'GenericIssue::FormInputAssignedAutocompleteValueToIdOrNameAttributeError';
  IssueCreated[(IssueCreated['GenericIssue::FormLabelHasNeitherForNorNestedInputError'] = 72)] =
    'GenericIssue::FormLabelHasNeitherForNorNestedInputError';
  IssueCreated[(IssueCreated['GenericIssue::FormLabelForMatchesNonExistingIdError'] = 73)] =
    'GenericIssue::FormLabelForMatchesNonExistingIdError';
  IssueCreated[(IssueCreated['GenericIssue::FormHasPasswordFieldWithoutUsernameFieldError'] = 74)] =
    'GenericIssue::FormHasPasswordFieldWithoutUsernameFieldError';
  IssueCreated[
    (IssueCreated['GenericIssue::FormInputHasWrongButWellIntendedAutocompleteValueError'] = 75)
  ] = 'GenericIssue::FormInputHasWrongButWellIntendedAutocompleteValueError';
  IssueCreated[(IssueCreated['StylesheetLoadingIssue::LateImportRule'] = 76)] =
    'StylesheetLoadingIssue::LateImportRule';
  IssueCreated[(IssueCreated['StylesheetLoadingIssue::RequestFailed'] = 77)] =
    'StylesheetLoadingIssue::RequestFailed';
  IssueCreated[(IssueCreated['CookieIssue::WarnThirdPartyPhaseout::ReadCookie'] = 82)] =
    'CookieIssue::WarnThirdPartyPhaseout::ReadCookie';
  IssueCreated[(IssueCreated['CookieIssue::WarnThirdPartyPhaseout::SetCookie'] = 83)] =
    'CookieIssue::WarnThirdPartyPhaseout::SetCookie';
  IssueCreated[(IssueCreated['CookieIssue::ExcludeThirdPartyPhaseout::ReadCookie'] = 84)] =
    'CookieIssue::ExcludeThirdPartyPhaseout::ReadCookie';
  IssueCreated[(IssueCreated['CookieIssue::ExcludeThirdPartyPhaseout::SetCookie'] = 85)] =
    'CookieIssue::ExcludeThirdPartyPhaseout::SetCookie';
  IssueCreated[(IssueCreated['ElementAccessibilityIssue::DisallowedSelectChild'] = 86)] =
    'ElementAccessibilityIssue::DisallowedSelectChild';
  IssueCreated[(IssueCreated['ElementAccessibilityIssue::DisallowedOptGroupChild'] = 87)] =
    'ElementAccessibilityIssue::DisallowedOptGroupChild';
  IssueCreated[(IssueCreated['ElementAccessibilityIssue::NonPhrasingContentOptionChild'] = 88)] =
    'ElementAccessibilityIssue::NonPhrasingContentOptionChild';
  IssueCreated[(IssueCreated['ElementAccessibilityIssue::InteractiveContentOptionChild'] = 89)] =
    'ElementAccessibilityIssue::InteractiveContentOptionChild';
  IssueCreated[(IssueCreated['ElementAccessibilityIssue::InteractiveContentLegendChild'] = 90)] =
    'ElementAccessibilityIssue::InteractiveContentLegendChild';
  IssueCreated[(IssueCreated['SRIMessageSignatureIssue::MissingSignatureHeader'] = 91)] =
    'SRIMessageSignatureIssue::MissingSignatureHeader';
  IssueCreated[(IssueCreated['SRIMessageSignatureIssue::MissingSignatureInputHeader'] = 92)] =
    'SRIMessageSignatureIssue::MissingSignatureInputHeader';
  IssueCreated[(IssueCreated['SRIMessageSignatureIssue::InvalidSignatureHeader'] = 93)] =
    'SRIMessageSignatureIssue::InvalidSignatureHeader';
  IssueCreated[(IssueCreated['SRIMessageSignatureIssue::InvalidSignatureInputHeader'] = 94)] =
    'SRIMessageSignatureIssue::InvalidSignatureInputHeader';
  IssueCreated[
    (IssueCreated['SRIMessageSignatureIssue::SignatureHeaderValueIsNotByteSequence'] = 95)
  ] = 'SRIMessageSignatureIssue::SignatureHeaderValueIsNotByteSequence';
  IssueCreated[
    (IssueCreated['SRIMessageSignatureIssue::SignatureHeaderValueIsParameterized'] = 96)
  ] = 'SRIMessageSignatureIssue::SignatureHeaderValueIsParameterized';
  IssueCreated[
    (IssueCreated['SRIMessageSignatureIssue::SignatureHeaderValueIsIncorrectLength'] = 97)
  ] = 'SRIMessageSignatureIssue::SignatureHeaderValueIsIncorrectLength';
  IssueCreated[(IssueCreated['SRIMessageSignatureIssue::SignatureInputHeaderMissingLabel'] = 98)] =
    'SRIMessageSignatureIssue::SignatureInputHeaderMissingLabel';
  IssueCreated[
    (IssueCreated['SRIMessageSignatureIssue::SignatureInputHeaderValueNotInnerList'] = 99)
  ] = 'SRIMessageSignatureIssue::SignatureInputHeaderValueNotInnerList';
  IssueCreated[
    (IssueCreated['SRIMessageSignatureIssue::SignatureInputHeaderValueMissingComponents'] = 100)
  ] = 'SRIMessageSignatureIssue::SignatureInputHeaderValueMissingComponents';
  IssueCreated[
    (IssueCreated['SRIMessageSignatureIssue::SignatureInputHeaderInvalidComponentType'] = 101)
  ] = 'SRIMessageSignatureIssue::SignatureInputHeaderInvalidComponentType';
  IssueCreated[
    (IssueCreated['SRIMessageSignatureIssue::SignatureInputHeaderInvalidComponentName'] = 102)
  ] = 'SRIMessageSignatureIssue::SignatureInputHeaderInvalidComponentName';
  IssueCreated[
    (IssueCreated['SRIMessageSignatureIssue::SignatureInputHeaderInvalidHeaderComponentParameter'] =
      103)
  ...
  IssueCreated[(IssueCreated['SRIMessageSignatureIssue::SignatureInputHeaderKeyIdLength'] = 105)] =
    'SRIMessageSignatureIssue::SignatureInputHeaderKeyIdLength';
  IssueCreated[
    (IssueCreated['SRIMessageSignatureIssue::SignatureInputHeaderInvalidParameter'] = 106)
  ] = 'SRIMessageSignatureIssue::SignatureInputHeaderInvalidParameter';
  IssueCreated[
    (IssueCreated['SRIMessageSignatureIssue::SignatureInputHeaderMissingRequiredParameters'] = 107)
  ] = 'SRIMessageSignatureIssue::SignatureInputHeaderMissingRequiredParameters';
  IssueCreated[(IssueCreated['SRIMessageSignatureIssue::ValidationFailedSignatureExpired'] = 108)] =
    'SRIMessageSignatureIssue::ValidationFailedSignatureExpired';
  IssueCreated[(IssueCreated['SRIMessageSignatureIssue::ValidationFailedInvalidLength'] = 109)] =
    'SRIMessageSignatureIssue::ValidationFailedInvalidLength';
  IssueCreated[
    (IssueCreated['SRIMessageSignatureIssue::ValidationFailedSignatureMismatch'] = 110)
  ] = 'SRIMessageSignatureIssue::ValidationFailedSignatureMismatch';
  IssueCreated[(IssueCreated['CorsIssue::LocalNetworkAccessPermissionDenied'] = 111)] =
    'CorsIssue::LocalNetworkAccessPermissionDenied';
  IssueCreated[
    (IssueCreated['SRIMessageSignatureIssue::ValidationFailedIntegrityMismatch'] = 112)
  ] = 'SRIMessageSignatureIssue::ValidationFailedIntegrityMismatch';
  IssueCreated[
    (IssueCreated['ElementAccessibilityIssue::InteractiveContentSummaryDescendant'] = 113)
  ] = 'ElementAccessibilityIssue::InteractiveContentSummaryDescendant';
  IssueCreated[(IssueCreated['CorsIssue::InvalidLocalNetworkAccess'] = 114)] =
    'CorsIssue::InvalidLocalNetworkAccess';
  /* eslint-enable @typescript-eslint/naming-convention */
...
(function (ManifestSectionCodes) {
  ...
  ManifestSectionCodes[(ManifestSectionCodes['Window Controls Overlay'] = 5)] =
