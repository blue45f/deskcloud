...
const str_ = i18n.i18n.registerUIStrings(
  'ui/legacy/components/data_grid/ShowMoreDataGridNode.ts',
  UIStrings,
);
...
export class ShowMoreDataGridNode extends DataGridNode {
  ...
  constructor(callback, startPosition, endPosition, chunkSize) {
    ...
    this.showNext = UI.UIUtils.createTextButton(
      i18nString(UIStrings.showDBefore, { PH1: this.chunkSize }),
    );
    ...
    this.showLast = UI.UIUtils.createTextButton(
      i18nString(UIStrings.showDAfter, { PH1: this.chunkSize }),
    );
