...
export class ContrastInfo extends Common.ObjectWrapper.ObjectWrapper {
  ...
  constructor(contrastInfo) {
    ...
    this.#isNull = false;
    this.contrastRatioThresholds = Common.ColorUtils.getContrastThreshold(
      contrastInfo.computedFontSize,
      contrastInfo.computedFontWeight,
    );
    this.#contrastRatioAPCAThreshold = Common.ColorUtils.getAPCAThreshold(
      contrastInfo.computedFontSize,
      contrastInfo.computedFontWeight,
    );
  ...
  #setBgColor(bgColor) {
    ...
    this.#contrastRatioAPCA = Common.ColorUtils.contrastRatioAPCA(
      this.fgColor.rgba(),
      this.#bgColor.rgba(),
    );
  }
  ...
  updateContrastRatio() {
    ...
    this.#contrastRatio = Common.ColorUtils.contrastRatio(
      this.fgColor.rgba(),
      this.#bgColor.rgba(),
    );
    this.#contrastRatioAPCA = Common.ColorUtils.contrastRatioAPCA(
