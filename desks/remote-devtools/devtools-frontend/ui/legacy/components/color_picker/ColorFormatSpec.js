...
const roundAndStringify = (arr) =>
  arr.map((el) => Platform.StringUtilities.stringifyWithPrecision(el, 2));
...
export const colorFormatSpec = {
  ...
  ['hsl' /* Common.Color.Format.HSL */]: {
    label: 'HSLA',
    toValues: function (color) {
      const canonicalHslParams = roundAndStringify(
        color.as('hsla' /* Common.Color.Format.HSLA */).canonicalHSLA(),
      );
  ...
  ['hwb' /* Common.Color.Format.HWB */]: {
    label: 'HWBA',
    toValues: function (color) {
      const canonicalHwbParams = roundAndStringify(
        color.as('hwba' /* Common.Color.Format.HWBA */).canonicalHWBA(),
      );
  ...
  ['srgb' /* Common.Color.Format.SRGB */]: {
    ...
    fromValues: function (values) {
      return Common.Color.parse(
        `color(${'srgb' /* Common.Color.Format.SRGB */} ${functionParamsText(values)})`,
      );
    },
  },
  ['srgb-linear' /* Common.Color.Format.SRGB_LINEAR */]: {
    ...
    toValues: function (color) {
      ...
      return roundAndStringify([
        ...
        srgbLinearColor.p1,
        srgbLinearColor.p2,
        srgbLinearColor.alpha ?? 1,
      ]);
    },
    fromValues: function (values) {
      return Common.Color.parse(
        `color(${'srgb-linear' /* Common.Color.Format.SRGB_LINEAR */} ${functionParamsText(values)})`,
      );
    },
  },
  ['display-p3' /* Common.Color.Format.DISPLAY_P3 */]: {
    ...
    fromValues(values) {
      return Common.Color.parse(
        `color(${'display-p3' /* Common.Color.Format.DISPLAY_P3 */} ${functionParamsText(values)})`,
      );
    },
  },
  ['a98-rgb' /* Common.Color.Format.A98_RGB */]: {
    ...
    fromValues: function (values) {
      return Common.Color.parse(
        `color(${'a98-rgb' /* Common.Color.Format.A98_RGB */} ${functionParamsText(values)})`,
      );
    },
  },
  ['prophoto-rgb' /* Common.Color.Format.PROPHOTO_RGB */]: {
    ...
    toValues: function (color) {
      ...
      return roundAndStringify([
        ...
        proPhotoRGBColor.p1,
        proPhotoRGBColor.p2,
        proPhotoRGBColor.alpha ?? 1,
      ]);
    },
    fromValues: function (values) {
      return Common.Color.parse(
        `color(${'prophoto-rgb' /* Common.Color.Format.PROPHOTO_RGB */} ${functionParamsText(values)})`,
      );
    },
  },
  ['rec2020' /* Common.Color.Format.REC_2020 */]: {
    ...
    toValues: function (color) {
      ...
      return roundAndStringify([
        ...
        rec2020Color.p1,
        rec2020Color.p2,
        rec2020Color.alpha ?? 1,
      ]);
    },
    fromValues: function (values) {
      return Common.Color.parse(
        `color(${'rec2020' /* Common.Color.Format.REC_2020 */} ${functionParamsText(values)})`,
      );
    },
  },
  ['xyz' /* Common.Color.Format.XYZ */]: {
    ...
    fromValues: function (values) {
      return Common.Color.parse(
        `color(${'xyz' /* Common.Color.Format.XYZ */} ${functionParamsText(values)})`,
      );
    },
  },
  ['xyz-d50' /* Common.Color.Format.XYZ_D50 */]: {
    ...
    fromValues: function (values) {
      return Common.Color.parse(
        `color(${'xyz-d50' /* Common.Color.Format.XYZ_D50 */} ${functionParamsText(values)})`,
      );
    },
  },
  ['xyz-d65' /* Common.Color.Format.XYZ_D65 */]: {
    ...
    fromValues: function (values) {
      return Common.Color.parse(
        `color(${'xyz-d65' /* Common.Color.Format.XYZ_D65 */} ${functionParamsText(values)})`,
      );
    },
  },
};
