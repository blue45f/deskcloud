...
export class TargetDetachedDialog extends SDK.SDKModel.SDKModel {
  ...
  constructor(target) {
    ...
    if (
      target.parentTarget()?.type() === SDK.Target.Type.BROWSER &&
      TargetDetachedDialog.hideCrashedDialog
    ) {
...
SDK.SDKModel.SDKModel.register(TargetDetachedDialog, {
  capabilities: 2048 /* SDK.Target.Capability.INSPECTOR */,
  autostart: true,
});
