...
const str_ = i18n.i18n.registerUIStrings(
  'ui/legacy/components/perf_ui/NetworkPriorities.ts',
  UIStrings,
);
...
export function priorityUILabelMap() {
  if (priorityUILabelMapInstance.size === 0) {
    priorityUILabelMapInstance.set(
      'VeryLow' /* Protocol.Network.ResourcePriority.VeryLow */,
      i18nString(UIStrings.lowest),
    );
    priorityUILabelMapInstance.set(
      'Low' /* Protocol.Network.ResourcePriority.Low */,
      i18nString(UIStrings.low),
    );
    priorityUILabelMapInstance.set(
      'Medium' /* Protocol.Network.ResourcePriority.Medium */,
      i18nString(UIStrings.medium),
    );
    priorityUILabelMapInstance.set(
      'High' /* Protocol.Network.ResourcePriority.High */,
      i18nString(UIStrings.high),
    );
    priorityUILabelMapInstance.set(
      'VeryHigh' /* Protocol.Network.ResourcePriority.VeryHigh */,
      i18nString(UIStrings.highest),
    );
  }
