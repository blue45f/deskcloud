...
export function render(container) {
  ...
  function onSimpleMenu(event) {
    ...
    // Regular item
    simpleMenu.defaultSection().appendItem(
      'Regular item',
      () => {
    ...
    // Checkbox item
    simpleMenu.defaultSection().appendCheckboxItem(
      'Checkbox item',
      () => {
  ...
  function onCustomSectionMenu(event) {
    ...
    customSection2.appendItem('Section inner item 1', () => {}, {
      jslogContext: 'my-inner-item-3',
    });
  ...
  function onSubMenu(event) {
    ...
    const subMenu = subMenuMenu
      .defaultSection()
      .appendSubMenuItem('Item to open sub menu', /* disabled */ false, 'my-sub-menu');
    subMenu
      .defaultSection()
      .appendItem('Sub menu inner item 1', () => {}, { jslogContext: 'my-inner-item-1' });
    subMenu
      .defaultSection()
      .appendItem('Sub menu inner item 2', () => {}, { jslogContext: 'my-inner-item-2' });
