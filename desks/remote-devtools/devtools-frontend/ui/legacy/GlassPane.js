...
export class GlassPane {
  ...
  setPointerEventsBehavior(pointerEventsBehavior) {
    ...
    this.contentElement.classList.toggle(
      'no-pointer-events',
      pointerEventsBehavior === 'PierceContents' /* PointerEventsBehavior.PIERCE_CONTENTS */,
    );
  }
  ...
  positionContent() {
    ...
    if (
      this.sizeBehavior === 'SetExactWidthMaxHeight' /* SizeBehavior.SET_EXACT_WIDTH_MAX_HEIGHT */
    ) {
