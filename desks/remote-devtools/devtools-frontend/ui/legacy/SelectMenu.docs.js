...
export function render(container) {
  ...
  }
  {
    ...
    Lit.render(
      html`<select id="menu" aria-label="Select an option" @change=${onChange}>
        <option hidden>Select an option</option>
        <option
          id="option-1"
          jslog=${VisualLogging.item('option-1').track({
            click: true,
          })}
          value="Option1"
        >
        ...
        <option
          jslog=${VisualLogging.item('option-2').track({
            click: true,
          })}
          value="Option2"
        >
        ...
        <option
          disabled
          jslog=${VisualLogging.item('option-3').track({
            click: true,
          })}
          value="Option3"
        >
  ...
  }
  {
    ...
    Lit.render(
      html`<select aria-label="Select an option" @change=${onChange}>
