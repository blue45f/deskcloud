...
export function setAutocomplete(
  element,
  interactionModel = 'none' /* AutocompleteInteractionModel.NONE */,
) {
...
export class LiveAnnouncer {
  ...
  static #announce(message, role) {
    ...
    const element = LiveAnnouncer.getOrCreateAnnouncerElement(
      dialog?.isShowing() ? dialog.contentElement : undefined,
      role,
    );
