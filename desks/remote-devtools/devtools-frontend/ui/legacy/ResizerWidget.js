...
export class ResizerWidget extends Common.ObjectWrapper.ObjectWrapper {
  ...
  sendDragStart(x, y) {
    this.dispatchEventToListeners('ResizeStart' /* Events.RESIZE_START */, {
      startX: x,
      currentX: x,
      startY: y,
      currentY: y,
  ...
  sendDragMove(startX, currentX, startY, currentY, shiftKey) {
    this.dispatchEventToListeners('ResizeUpdateXY' /* Events.RESIZE_UPDATE_XY */, {
      startX,
      currentX,
      startY,
      currentY,
...
export class SimpleResizerWidget extends ResizerWidget {
  ...
  sendDragMove(startX, currentX, startY, currentY, shiftKey) {
    if (this.#isVertical) {
      this.dispatchEventToListeners('ResizeUpdatePosition' /* Events.RESIZE_UPDATE_POSITION */, {
