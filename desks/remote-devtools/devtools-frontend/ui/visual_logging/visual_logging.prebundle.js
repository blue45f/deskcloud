...
export const logClick = (loggable, event, options = {}) =>
...
export const logKeyDown = async (l, e, context) =>
...
export function registerLoggable(loggable, config, parent, size) {
  ...
  NonDomState.registerLoggable(
    loggable,
    LoggingConfig.parseJsLog(config),
    parent || undefined,
    size,
  );
...
export const bezierCurveEditor = LoggingConfig.makeConfigStringBuilder.bind(
  null,
  'BezierCurveEditor',
);
export const bezierPresetCategory = LoggingConfig.makeConfigStringBuilder.bind(
  null,
  'BezierPresetCategory',
);
export const breakpointMarker = LoggingConfig.makeConfigStringBuilder.bind(
  null,
  'BreakpointMarker',
);
...
export const elementsBreadcrumbs = LoggingConfig.makeConfigStringBuilder.bind(
  null,
  'ElementsBreadcrumbs',
);
...
export const mediaInspectorView = LoggingConfig.makeConfigStringBuilder.bind(
  null,
  'MediaInspectorView',
);
...
export const paletteColorShades = LoggingConfig.makeConfigStringBuilder.bind(
  null,
  'PaletteColorShades',
);
...
export const responsivePresets = LoggingConfig.makeConfigStringBuilder.bind(
  null,
  'ResponsivePresets',
);
