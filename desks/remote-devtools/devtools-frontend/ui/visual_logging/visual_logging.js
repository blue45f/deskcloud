import { assertNotNullOrUndefined as ne } from './../../core/platform/platform.js';
import * as xe from './../../core/host/host.js';
import * as Ce from './../../core/root/root.js';
var ke = new Set([
  '%',
  '*',
...
function Le(e) {
  return oe(e.getAttribute(Se) || '');
}
var w;
(function (e) {
  ((e[(e.TreeItem = 1)] = 'TreeItem'),
    (e[(e.Close = 2)] = 'Close'),
    (e[(e.Counter = 3)] = 'Counter'),
    (e[(e.Drawer = 4)] = 'Drawer'),
    (e[(e.Resizer = 5)] = 'Resizer'),
    (e[(e.Toggle = 6)] = 'Toggle'),
    (e[(e.Tree = 7)] = 'Tree'),
    (e[(e.TextField = 8)] = 'TextField'),
    (e[(e.AnimationClip = 9)] = 'AnimationClip'),
    (e[(e.Section = 10)] = 'Section'),
    (e[(e.SectionHeader = 11)] = 'SectionHeader'),
    (e[(e.Timeline = 12)] = 'Timeline'),
    (e[(e.CSSRuleHeader = 13)] = 'CSSRuleHeader'),
    (e[(e.Expand = 14)] = 'Expand'),
    (e[(e.ToggleSubpane = 15)] = 'ToggleSubpane'),
    (e[(e.ControlPoint = 16)] = 'ControlPoint'),
    (e[(e.Toolbar = 17)] = 'Toolbar'),
    (e[(e.Popover = 18)] = 'Popover'),
    (e[(e.BreakpointMarker = 19)] = 'BreakpointMarker'),
    (e[(e.DropDown = 20)] = 'DropDown'),
    (e[(e.Adorner = 21)] = 'Adorner'),
    (e[(e.Gutter = 22)] = 'Gutter'),
    (e[(e.MetricsBox = 23)] = 'MetricsBox'),
    (e[(e.MetricsBoxPart = 24)] = 'MetricsBoxPart'),
    (e[(e.Badge = 25)] = 'Badge'),
    (e[(e.DOMBreakpoint = 26)] = 'DOMBreakpoint'),
    (e[(e.Action = 29)] = 'Action'),
    (e[(e.FilterDropdown = 30)] = 'FilterDropdown'),
    (e[(e.Dialog = 31)] = 'Dialog'),
    (e[(e.BezierCurveEditor = 32)] = 'BezierCurveEditor'),
    (e[(e.BezierPresetCategory = 34)] = 'BezierPresetCategory'),
    (e[(e.Preview = 35)] = 'Preview'),
    (e[(e.Canvas = 36)] = 'Canvas'),
    (e[(e.ColorEyeDropper = 37)] = 'ColorEyeDropper'),
    (e[(e.Link = 44)] = 'Link'),
    (e[(e.Item = 46)] = 'Item'),
    (e[(e.PaletteColorShades = 47)] = 'PaletteColorShades'),
    (e[(e.Panel = 48)] = 'Panel'),
    (e[(e.ShowStyleEditor = 50)] = 'ShowStyleEditor'),
    (e[(e.Slider = 51)] = 'Slider'),
    (e[(e.CssColorMix = 52)] = 'CssColorMix'),
    (e[(e.Value = 53)] = 'Value'),
    (e[(e.Key = 54)] = 'Key'),
    (e[(e.PieChart = 59)] = 'PieChart'),
    (e[(e.PieChartSlice = 60)] = 'PieChartSlice'),
    (e[(e.PieChartTotal = 61)] = 'PieChartTotal'),
    (e[(e.ElementsBreadcrumbs = 62)] = 'ElementsBreadcrumbs'),
    (e[(e.PanelTabHeader = 66)] = 'PanelTabHeader'),
    (e[(e.Menu = 67)] = 'Menu'),
    (e[(e.TableRow = 68)] = 'TableRow'),
    (e[(e.TableHeader = 69)] = 'TableHeader'),
    (e[(e.TableCell = 70)] = 'TableCell'),
    (e[(e.Pane = 72)] = 'Pane'),
    (e[(e.ResponsivePresets = 73)] = 'ResponsivePresets'),
    (e[(e.DeviceModeRuler = 74)] = 'DeviceModeRuler'),
...
var ye = new Set();
function ie(e) {
  if (!(typeof e != 'string' || !e.length || ke.has(e) || ye.has(e))) {
    if (
      Ce.Runtime.Runtime.queryParam('debugFrontend') ||
      xe.InspectorFrontendHost.isUnderTest() ||
      localStorage.getItem('veDebugLoggingEnabled') === 'Test'
    ) {
...
`,
        ...
        .slice(3).join(`
`);
      console.error(`Unknown VE context: '${e}'
${t}
...
function oe(e) {
  let t = e.replace(/ /g, '').split(';'),
    i = (c) => t.find((g) => g.startsWith(c))?.substr(c.length),
    o = pt(t[0]);
  if (o === 0) throw new Error('Unkown VE: ' + e);
  let r = { ve: o },
    n = i('context:');
  n?.trim().length && (ie(n), (r.context = n));
  let l = i('parent:');
  l && (r.parent = l);
  let a = i('track:');
  if (a) {
    ...
    for (let c of a.split(','))
      c.startsWith('keydown:') ? (r.track.keydown = c.substr(8)) : (r.track[c] = !0);
  }
  return r;
}
function s(e, t) {
  let i = [e];
  return (
    typeof t == 'string' && t.trim().length && (i.push(`context: ${t}`), ie(t)),
    {
      context: function (o) {
        return (
          (typeof o == 'number' || (typeof o == 'string' && o.length)) && i.push(`context: ${o}`),
          ie(t),
          this
        );
      },
      parent: function (o) {
        return (i.push(`parent: ${o}`), this);
      },
      track: function (o) {
        return (
          i.push(
            `track: ${Object.entries(o)
              .map(([r, n]) => (n !== !0 ? `${r}: ${n}` : r))
              .join(', ')}`,
          ),
          this
...
var O = new WeakMap();
function ht() {
  let e = new BigInt64Array(1);
  return (crypto.getRandomValues(e), Number(e[0] >> (64n - 53n)));
}
function re(e, t, i) {
  if (t.parent && N.has(t.parent) && e instanceof Element)
    for (i = N.get(t.parent)?.(e); i instanceof Element && !H(i); )
      i = i.parentElementOrShadowHost() ?? void 0;
  if (O.has(e)) {
    let r = O.get(e);
    return (i && r.parent !== u(i) && (r.parent = u(i)), r);
  }
  let o = {
    impressionLogged: !1,
    processed: !1,
...
var N = new Map();
function Te(e, t) {
  if (N.has(e)) throw new Error(`Parent provider with the name '${e} is already registered'`);
  N.set(e, t);
}
var ze = Symbol('veParent');
Te('mapped', (e) => e[ze]);
function ft(e, t) {
  e[ze] = t;
}
...
function Fe() {
  h ||
    ...
    d.classList.add('ve-debug'),
    (d.style.position = 'absolute'),
    (d.style.background = 'var(--sys-color-cdt-base-container)'),
    (d.style.borderRadius = '2px'),
    (d.style.padding = '8px'),
    (d.style.boxShadow = 'var(--drop-shadow)'),
    h.appendChild(d));
}
function Ee(e, t) {
  ((q = e), e && Fe(), (Ie = t), e || _(null));
}
globalThis.setVeDebuggingEnabled = Ee;
var ae = null;
function Re(e) {
  (Fe(), (ae = e), _(null));
}
function bt(e, t) {
  t = t.trim();
  let i = u(e),
    o = i?.config?.ve ? w[i?.config?.ve] : null;
  for (; i && t; ) {
    let r = Pe(i.config);
    if (t.endsWith(r)) t = t.slice(0, -r.length).trim();
    else if (o && t.endsWith(o)) ((t = t.slice(0, -o.length).trim()), (o = null));
    else break;
    if (((i = i.parent), i && !t.endsWith('>'))) break;
    t = t.slice(0, -1).trim();
  }
  !t && !i && _(e, !0);
}
function de(e) {
  ae && e instanceof HTMLElement && bt(e, ae);
  let t = u(e);
  !q || !t || t.processedForDebugging || (e instanceof HTMLElement && vt(e, t));
}
function wt(e, t) {
  if (d && ((d.style.display = 'block'), (d.textContent = e), t)) {
    let i = d.getBoundingClientRect();
    (globalThis.innerHeight < t.bottom + i.height + 8
      ? (d.style.top = `${t.top - i.height - 8}px`)
      : (d.style.top = `${t.bottom + 8}px`),
      globalThis.innerWidth < t.left + i.width
        ? ((d.style.right = '0px'), (d.style.left = ''))
        : ((d.style.right = ''), (d.style.left = `${t.left}px`)));
  }
}
function _(e, t = !1) {
  if (
    ...
    ((o.style.position = 'absolute'),
      ...
      (o.style.background = 'rgb(71 140 222 / 50%)'),
      (o.style.border = 'dashed 1px #7327C6'),
...
function vt(e, t) {
  e.tagName === 'OPTION'
    ? t.parent?.selectOpen &&
      d &&
      ((d.innerHTML += '<br>' + Tt(t.config)), (t.processedForDebugging = !0))
    : (e.addEventListener(
        'mousedown',
        (i) => {
          I.length && d && q && (i.stopImmediatePropagation(), i.preventDefault());
        },
        { capture: !0 },
      ),
      e.addEventListener(
        'click',
        (i) => {
          I.includes(i.currentTarget) &&
            d &&
            q &&
            (Ie?.(d.textContent || ''), i.stopImmediatePropagation(), i.preventDefault());
        },
        { capture: !0 },
      ),
      e.addEventListener(
        ...
        () => {
          ...
          let i = [t],
            o = t.parent;
          for (; o; ) (i.unshift(o), (o = o.parent));
          wt(i.map((r) => Pe(r.config)).join(' > '), e.getBoundingClientRect());
        },
        { capture: !0 },
      ),
      e.addEventListener(
      ...
      (t.processedForDebugging = !0));
}
function k(e, t, i) {
  let o = localStorage.getItem('veDebugLoggingEnabled');
  if (o)
    switch (o) {
      case 'Intuitive':
        kt(e, t, i);
...
function yt(e, t, i) {
  (e !== 'SettingAccess' && e !== 'FunctionCall' && e !== 'Resize' && (B = null),
    F({ interaction: e, veid: t?.veid || 0 }),
    ge());
}
function xt(e, t, i) {
  let o = t ? qe.get(t.veid) : null;
  if (o) {
    let r = { time: Date.now() - E, type: e, ...i };
    (U(r), o.interactions.push(r));
  }
}
function U(e) {
  for (let t in e) {
    let i = t;
    typeof e[i] > 'u' && delete e[i];
  }
}
function Be(e) {
  switch (localStorage.getItem('veDebugLoggingEnabled')) {
    case 'Intuitive':
      Ct(e);
      break;
    case 'Test':
...
function Ct(e) {
  ...
  for (let o of e) {
    ...
    if ((U(r), t.set(o.veid, r), !o.parent || !t.has(o.parent?.veid))) r.parent = o.parent?.veid;
    else {
      let n = t.get(o.parent?.veid);
      ((n.children = n.children || []), n.children.push(r));
    }
  }
  let i = [...t.values()].filter((o) => 'parent' in o);
  i.length === 1
    ? ((i[0].time = Date.now() - E), F(i[0]))
    : F({ event: 'Impression', children: i, time: Date.now() - E });
}
var se = new Map(),
  B = null;
function St(e) {
  B || ((B = { impressions: [] }), y.push(B));
  for (let t of e) {
    let i = '';
    (t.parent && (i = (se.get(t.parent.veid) || '<UNKNOWN>') + ' > '),
      (i += w[t.config.ve]),
      t.config.context && (i += ': ' + t.config.context),
      se.set(t.veid, i),
      B.impressions.push(i));
  }
  ge();
}
var qe = new Map();
function Lt(e) {
  for (let t of e) {
    let i = (r) => {
        ...
        return (U(n), r.parent && (n.parent = i(r.parent)), n);
      },
      o = { ...i(t), interactions: [], time: Date.now() - E };
    (qe.set(t.veid, o), F(o));
  }
}
function Pe(e) {
  return `${w[e.ve]}${e.context ? `: ${e.context}` : ''}`;
}
function Tt(e) {
  let t = [w[e.ve]];
  return (
    e.context && t.push(`context: ${e.context}`),
    e.parent && t.push(`parent: ${e.parent}`),
    e.track &&
      t.push(
        `track: ${Object.entries(e.track)
          .map(([i, o]) => `${i}${typeof o == 'string' ? `: ${o}` : ''}`)
          .join(', ')}`,
      ),
    t.join('; ')
  );
...
var y = [];
function F(e) {
  let t = localStorage.getItem('veDebugLoggingEnabled');
  t && (y.push(e), t === 'Intuitive' && console.info('VE Debug:', e));
}
function Ae(e, t = 'Intuitive') {
  e
    ? localStorage.setItem('veDebugLoggingEnabled', t)
    : localStorage.removeItem('veDebugLoggingEnabled');
}
function zt(e, t) {
  let i = (o) => {
    if (o.event === 'Impression' && o.veid === e) return o;
    let r = 0;
...
function De(e, t) {
  return [
    ...t.strings.map((i) => (e[i] ? `"${e[i]}"` : '$NullString')),
    ...t.numerics.map((i) => e[i] ?? 'null'),
    ...t.booleans.map((i) => e[i] ?? '$NullBool'),
  ].join(', ');
}
function Dt() {
  let e = { strings: ['ve', 'context'], numerics: ['veid', 'width', 'height'], booleans: [] },
    t = {
      strings: ['type', 'context'],
      numerics: ['width', 'height', 'mouseButton', 'time'],
      booleans: ['width', 'height', 'mouseButton', 'time'],
    },
    i = (a) => a.map((c, g) => `$${g + 1} as ${c}`).join(', '),
    o = (a) => `$VeFields(${De(a, e)}, ${a.parent ? `STRUCT(${o(a.parent)})` : null})`,
    r = (a) => `$Interaction(${De(a, t)})`,
    n = (a) => `$Entry(${o(a)}, ([${a.interactions.map(r).join(', ')}]), ${a.time})`,
    l = y;
  console.log(`
...
function jt() {
  ...
  for (let t of y) {
    e.push(t);
    let i = t.veid;
    for (let o of t.interactions) e.push({ ...o, veid: i });
  }
  return (e.sort((t, i) => t.time - i.time), e);
}
var le = class {
  #e = new Map();
  add(t) {
  ...
  getArea(t) {
    let i = (t.width || 0) * (t.height || 0),
      o = t.parent ? this.#e.get(t.parent?.veid) : null;
    if (!o) return i;
    let r = this.getArea(o);
    return (i > r && (i = r), i);
  }
  get data() {
    return [...this.#e.values()]
      .filter((t) => this.getArea(t))
      .sort((t, i) => this.getArea(i) - this.getArea(t));
  }
};
function je(e, t, i, o) {
  let r = e;
  for (let n of t.data) {
    ...
    let l = r.children[r.children.length - 1];
    ((l?.type === 'Impression' ? l.veid : null) !== n.veid &&
      (r.children.push(...o),
      (o.length = 0),
      (l = {
        type: 'Impression',
...
function Me(e) {
  if (e.type === 'Impression') {
    for (; e.children.length === 1; )
      e.children[0].type === 'Impression' && (e.children = e.children[0].children);
    for (let t of e.children) Me(t);
  }
}
function It() {
  let e = jt(),
    t = new le(),
    i = { type: 'Session', children: [] },
    o = e[0].time,
    r = [];
  for (let n of e) {
    if ((n.time > o + 1e3 && (je(i, t, o, r), (r.length = 0)), !('type' in n))) t.add(n);
    else if (n.type === 'Resize') {
      let l = t.get(n.veid);
      if (!l) continue;
      let a = t.getArea(l);
      ((l.width = n.width), (l.height = n.height), t.getArea(l) !== 0 && a !== 0 && r.push(n));
    } else r.push(n);
    o = n.time;
  }
  return (je(i, t, o, r), Me(i), i);
}
var E = Date.now();
function He() {
  ((E = Date.now()),
    localStorage.getItem('veDebugLoggingEnabled') === 'Intuitive' && F({ event: 'SessionStart' }));
}
function Ft(e, t) {
  if ('interaction' in t && 'interaction' in e) {
    let i = Oe(e);
    return t.interaction === i;
  }
  if ('impressions' in t && 'impressions' in e) {
    let i = new Set(e.impressions);
    return ![...new Set(t.impressions)].filter((n) => !i.has(n)).length;
  }
  return !1;
}
var m = null;
function Et(e) {
  ...
  for (let o of e.sort())
    if (o !== i) {
      for (; !o.startsWith(i); ) i = i.substr(0, i.lastIndexOf(' > '));
      (t.push(' '.repeat(i.length) + o.substr(i.length)), (i = o));
    }
  return t.join(`
`);
}
...
function Oe(e) {
  if ('interaction' in e) {
    if (e.veid !== void 0) {
      let t = se.get(e.veid) || (e.veid ? '<UNKNOWN>' : '');
      return `${e.interaction}: ${t}`;
    }
...
function ce(e) {
  return e.map((t) => ('interaction' in t ? Oe(t) : Et(t.impressions))).join(`
`);
}
async function Bt(e) {
  if (m)
  ...
  let { promise: t, resolve: i, reject: o } = Promise.withResolvers();
  ((m = { expectedEvents: e, success: i, fail: o, unmatchedEvents: [] }), ge());
  let r = setTimeout(() => {
    if (m?.missingEvents?.length) {
      let n = y.filter((l) => ('interaction' in l ? l.interaction !== 'SettingAccess' : !0));
      m.fail(
        new Error(`
Missing VE Events:
${ce(m.missingEvents)}
Unmatched VE Events:
${ce(m.unmatchedEvents)}
All events:
...
function qt(e, t, i, o) {
  ...
  ('impressions' in r &&
    'impressions' in i &&
    (r.impressions = r.impressions.filter((n) => {
      let l = i.impressions.includes(n);
      return (l && o.add(n), !l);
    })),
    e.unmatchedEvents.push(r));
}
function Pt(e, t, i) {
  e.missingEvents = e.expectedEvents.slice(t);
  for (let o of e.missingEvents)
    'impressions' in o && (o.impressions = o.impressions.filter((r) => !i.has(r)));
  e.missingEvents = e.missingEvents.filter(
    (o) => !('impressions' in o) || o.impressions.length > 0,
  );
}
function ge() {
  if (!m) return;
  let e = y,
    ...
    o = new Set();
  m.unmatchedEvents = [];
  for (let r = 0; r < m.expectedEvents.length; ++r) {
    let n = m.expectedEvents[r],
      l = !1;
    for (; t < e.length; ) {
      if (Ft(e[t], n)) {
        ((l = !0), (i = !0), t++);
    ...
    if (!l) {
      (Pt(m, r, o), m.missingEvents?.length || (($ = t), m.success()));
      return;
    }
  }
  (($ = t), m.success());
...
function At() {
  return (console.error($), ce(y.slice($)));
}
globalThis.setVeDebugLoggingEnabled = Ae;
globalThis.getUnmatchedVeEvents = At;
globalThis.veDebugEventsLog = y;
globalThis.findVeDebugImpression = zt;
globalThis.exportAdHocAnalysisLogForSql = Dt;
globalThis.buildStateFlow = It;
globalThis.expectVeEvents = Bt;
import * as T from './../../core/common/common.js';
import * as A from './../../core/host/host.js';
import * as Ve from './../components/render_coordinator/render_coordinator.js';
function Ne(e) {
  let t = [],
    i = [],
    o = [],
    r = (a, c) => {
      for (let g of a) o.push({ element: g, parent: c });
    };
  for (let a of e) r(a.body.children);
  let n = 0,
    l = () => o[n++];
  for (;;) {
    let a = l();
    if (!a) break;
    let { element: c } = a;
    if (c.localName === 'template') continue;
    let { parent: g } = a;
    (H(c) && (t.push({ element: c, parent: g }), (g = c)),
      c.localName === 'slot' && c.assignedElements().length
        ? r(c.assignedElements(), g)
        : c.shadowRoot
          ? (i.push(c.shadowRoot), r(c.shadowRoot.children, g))
          : r(c.children, g));
  }
  return { loggables: t, shadowRoots: i };
}
var Ht = 10;
function ue(e, t) {
  let i = e.getBoundingClientRect(),
    o = Ot(t, i),
    r = Math.max(Math.min(Ht, i.width, i.height), 1);
  return !o || o.width < r || o.height < r ? null : o;
}
function Ot(e, t) {
  let i = Math.max(e.left, t.left),
    o = Math.min(e.left + e.width, t.left + t.width);
  if (i <= o) {
    let r = Math.max(e.top, t.top),
      n = Math.min(e.top + e.height, t.top + t.height);
    if (r <= n) return new DOMRect(i, r, o - i, n - r);
  }
  return null;
}
...
async function pe(e) {
  let t = await Promise.all(
    e.map(async (i) => {
      let o = u(i);
      W(o);
      let r = { id: o.veid, type: o.config.ve };
      return (
        typeof o.config.context < 'u' && (r.context = await x(o.config.context)),
        o.parent && (r.parent = o.parent.veid),
        o.size && ((r.width = Math.round(o.size.width)), (r.height = Math.round(o.size.height))),
        r
      );
    }),
  );
  t.length &&
    (v.InspectorFrontendHost.InspectorFrontendHostInstance.recordImpression({ impressions: t }),
    Be(e.map((i) => u(i))));
}
var G = (e, t) => {
    let i = u(e);
    if (!i) return;
    i.size = t;
    let o = { veid: i.veid, width: Math.round(i.size.width), height: Math.round(i.size.height) };
    (v.InspectorFrontendHost.InspectorFrontendHostInstance.recordResize(o),
      k('Resize', i, { width: Math.round(t.width), height: Math.round(t.height) }));
  },
  R = (e) => (t, i, o) => {
    let r = u(t);
    if (!r) return;
    let n = { veid: r.veid, doubleClick: !!o?.doubleClick };
    (i instanceof MouseEvent &&
      'sourceCapabilities' in i &&
      i.sourceCapabilities &&
      (n.mouseButton = i.button),
      e.schedule(async () => {
        (v.InspectorFrontendHost.InspectorFrontendHostInstance.recordClick(n),
          k('Click', r, { mouseButton: n.mouseButton, doubleClick: n.doubleClick }));
      }, 'Delayed'));
  },
  $e = (e) => async (t) => {
    let i = u(t.currentTarget);
    W(i);
    let o = { veid: i.veid };
    e.schedule(async () => {
      (v.InspectorFrontendHost.InspectorFrontendHostInstance.recordHover(o), k('Hover', i));
    }, 'Delayed');
  },
  _e = (e) => async (t) => {
    let i = u(t.currentTarget);
    ...
    let o = { veid: i.veid };
    e.schedule(async () => {
      (v.InspectorFrontendHost.InspectorFrontendHostInstance.recordDrag(o), k('Drag', i));
    }, 'Delayed');
  };
async function Ue(e) {
  let t = u(e);
  W(t);
  let i = { veid: t.veid },
    o = t.pendingChangeContext;
  (o && (i.context = await x(o)),
    v.InspectorFrontendHost.InspectorFrontendHostInstance.recordChange(i),
    k('Change', t, { context: o }));
}
var K = null,
  J = (e) => async (t, i, o) => {
    if (!(i instanceof KeyboardEvent)) return;
    let r = t ? u(t) : null,
      n = typeof r?.config.track?.keydown == 'string' ? r.config.track.keydown : '';
    if (n.length && !n.split('|').includes(i.code) && !n.split('|').includes(i.key)) return;
    let l = { veid: r?.veid };
    (!o && n?.length && (o = Nt(i)),
      K && o && K !== o && e.process?.(),
      (K = o || null),
      e.schedule(async () => {
        (o && (l.context = await x(o)),
          v.InspectorFrontendHost.InspectorFrontendHostInstance.recordKeyDown(l),
          k('KeyDown', r, { context: o }),
          (K = null));
      }));
  };
function Nt(e) {
...
async function x(e) {
  ...
  let t = parseInt(e, 10);
  if (!isNaN(t)) return t;
  if (!crypto.subtle) return 3735928559;
  let o = new TextEncoder().encode(e),
    r = await crypto.subtle.digest('SHA-1', o);
  return new DataView(r).getInt32(0, !0);
}
async function $t(e, t) {
  let i, o;
  typeof t == 'string'
    ? (o = t)
    : (typeof t == 'number' || typeof t == 'boolean') && (i = Number(t));
  let r = await x(e);
  if (!r) return;
  let n = { name: r, numeric_value: i, string_value: await x(o) };
  (v.InspectorFrontendHost.InspectorFrontendHostInstance.recordSettingAccess(n),
    k('SettingAccess', null, { name: e, numericValue: i, stringValue: o }));
}
async function _t(e, t) {
  let i = await x(e);
  if (typeof i > 'u') return;
  let o = { name: i, context: await x(t) };
  (v.InspectorFrontendHost.InspectorFrontendHostInstance.recordFunctionCall(o),
    k('FunctionCall', null, { name: e, context: t }));
}
var P = new WeakMap();
function Ke(e) {
  return P.get(e || X) || [];
...
function We(e, t, i, o) {
  let r = Ke(i);
  (r.push({ loggable: e, config: t, parent: i, size: o }), P.set(i || X, r));
}
function me(e) {
  return P.has(e || X);
}
...
var Wt = 500,
  ...
  S = j,
  Q = j,
  et = new MutationObserver(C),
  tt = new ResizeObserver(ut),
  it = new IntersectionObserver(ut),
  V = [],
  z = new Map(),
  ee = new Set();
function ot(e) {
  for (let t of e)
    (et.observe(t, { attributes: !0, childList: !0, subtree: !0 }),
      t.querySelectorAll('[popover]')?.forEach((i) => i.addEventListener('toggle', C)));
}
var ve = !1;
function rt() {
  return ve;
...
async function Qt(e) {
  ((ve = !0),
    (Z = e?.processingThrottler || new T.Throttler.Throttler(Wt)),
    (D = e?.keyboardLogThrottler || new T.Throttler.Throttler(Gt)),
    (fe = e?.hoverLogThrottler || new T.Throttler.Throttler(Jt)),
    (we = e?.dragLogThrottler || new T.Throttler.Throttler(Xt)),
    (S = e?.clickLogThrottler || new T.Throttler.Throttler(Yt)),
    (Q = e?.resizeLogThrottler || new T.Throttler.Throttler(Zt)),
    He(),
    await nt(document));
}
async function nt(e) {
  (V.push(e),
    ['interactive', 'complete'].includes(e.readyState) && (await te()),
    e.addEventListener('visibilitychange', C),
    e.addEventListener('scroll', C),
    ot([e.body]));
}
async function Vt() {
  (await D.schedule(async () => {}, 'AsSoonAsPossible'), (ve = !1), Xe());
  for (let e of V)
    (e.removeEventListener('visibilitychange', C), e.removeEventListener('scroll', C));
  (et.disconnect(),
    tt.disconnect(),
    it.disconnect(),
    (V.length = 0),
...
async function ei() {
  for (; Q.process; ) await Q.processCompleted;
}
async function at() {
  for (; S.process; ) await S.processCompleted;
  for (; D.process; ) await D.processCompleted;
}
function st() {
  for (let e of ee) Y(e);
}
function C() {
  Z && Z.schedule(() => Ve.read('processForLogging', te));
}
var be = new Map(),
  lt = (e) => {
    let t = e.ownerDocument,
      i =
        be.get(t) ||
        new DOMRect(0, 0, t.defaultView?.innerWidth || 0, t.defaultView?.innerHeight || 0);
    return (be.set(t, i), i);
  };
async function te() {
  if (document.hidden) return;
  let e = performance.now(),
    { loggables: t, shadowRoots: i } = Ne(V),
    o = [];
  ot(i);
  let r = [void 0];
  for (let { element: n, parent: l } of t) {
    let a = re(n, Le(n), l);
    if (!a.impressionLogged) {
      let c = ue(n, lt(n)),
        g = n.tagName === 'OPTION' && a.parent?.selectOpen;
      ((c && n.checkVisibility({ checkVisibilityCSS: !0 }) && (!l || a.parent?.impressionLogged)) ||
        g) &&
        (c && (a.size = c), o.push(n), (a.impressionLogged = !0));
    }
    if ((a.impressionLogged && me(n) && r.push(n), !a.processed)) {
      let c = (f) => (p) => {
        let b = p.currentTarget;
        (he(p), R(S)(b, p, { doubleClick: f }));
      };
      if (
        (a.config.track?.click &&
          (n.addEventListener('click', c(!1), { capture: !0 }),
          n.addEventListener('auxclick', c(!1), { capture: !0 }),
          n.addEventListener('contextmenu', c(!1), { capture: !0 })),
        a.config.track?.dblclick && n.addEventListener('dblclick', c(!0), { capture: !0 }),
        a.config.track?.hover &&
          (n.addEventListener('mouseover', $e(fe), { capture: !0 }),
          n.addEventListener('mouseout', () => fe.schedule(ct, 'AsSoonAsPossible'), {
            capture: !0,
          })),
        a.config.track?.drag &&
          (n.addEventListener('pointerdown', ti, { capture: !0 }),
          document.addEventListener('pointerup', he, { capture: !0 }),
          document.addEventListener('dragend', he, { capture: !0 })),
        a.config.track?.change &&
          (n.addEventListener(
            'input',
            (f) => {
              f instanceof InputEvent &&
                (a.pendingChangeContext && a.pendingChangeContext !== f.inputType && Y(n),
                (a.pendingChangeContext = f.inputType),
                ee.add(n));
            },
            { capture: !0 },
          ),
          n.addEventListener(
            ...
            (f) => {
              let p = f?.target ?? n;
              (['checkbox', 'radio'].includes(p.type) &&
                (a.pendingChangeContext = p.checked ? 'on' : 'off'),
                Y(n));
            },
            { capture: !0 },
          ),
          n.addEventListener(
            'focusout',
            () => {
              a.pendingChangeContext && Y(n);
            },
            { capture: !0 },
          )),
        a.config.track?.keydown &&
          n.addEventListener('keydown', (f) => J(D)(f.currentTarget, f), { capture: !0 }),
        a.config.track?.resize && (tt.observe(n), it.observe(n)),
        n.tagName === 'SELECT')
      ) {
        let f = (p) => {
          (R(S)(n, p), !a.selectOpen && ((a.selectOpen = !0), C()));
        };
        (n.addEventListener('click', f, { capture: !0 }),
          n.addEventListener(
            'keydown',
            (p) => {
              let b = p;
              (((A.Platform.isMac() || b.altKey) &&
                (b.code === 'ArrowDown' || b.code === 'ArrowUp')) ||
                (!b.altKey && !b.ctrlKey && b.code === 'F4')) &&
                f(p);
            },
            { capture: !0 },
          ),
          n.addEventListener(
            ...
            (p) => {
              let b = p;
              (b.key === ' ' || (!A.Platform.isMac() && b.key === '\r')) && f(p);
            },
            { capture: !0 },
          ),
          n.addEventListener(
            'change',
            (p) => {
              for (let b of n.selectedOptions) u(b)?.config.track?.click && R(S)(b, p);
            },
            { capture: !0 },
          ));
      }
  ...
  for (let n = 0; n < r.length; ++n) {
    let l = r[n];
    for (let { loggable: a, config: c, parent: g, size: L } of Ge(l)) {
      let M = re(a, c, g);
      M.impressionLogged ||
        (L && (M.size = L), de(a), o.push(a), (M.impressionLogged = !0), me(a) && r.push(a));
    }
    Je(l);
  }
  (o.length && (await at(), await ei(), st(), await pe(o)),
    A.userMetrics.visualLoggingProcessingDone(performance.now() - e));
}
function Y(e) {
  let t = u(e);
  t && (Ue(e), delete t.pendingChangeContext, ee.delete(e));
}
async function ct() {}
var dt = 0,
  gt = 0;
function ti(e) {
  e instanceof MouseEvent && ((dt = e.screenX), (gt = e.screenY), _e(we)(e));
}
function he(e) {
  e instanceof MouseEvent &&
    (Math.abs(e.screenX - dt) >= Ye ||
      Math.abs(e.screenY - gt) >= Ye ||
      we.schedule(ct, 'AsSoonAsPossible'));
}
function Qe(e, t) {
  for (; t; ) {
    if (t === e) return !0;
...
async function ut(e) {
  for (let t of e) {
    let i = t.target,
      o = u(i),
      r = ue(i, lt(i)) || new DOMRect(0, 0, 0, 0);
    if (!o?.size) continue;
    let n = r.width * r.height * o.size.width * o.size.height === 0,
      l = !1;
    for (let [a, c] of z.entries()) {
      if (a === i) continue;
      let g = u(a),
        L = c.width * c.height * (g?.size?.width || 0) * (g?.size?.height || 0) === 0;
      if (Qe(g, o) && n && L) {
        l = !0;
        break;
      }
      Qe(o, g) && n && L && z.delete(a);
    }
    l ||
      (z.set(i, r),
      Q.schedule(async () => {
        ...
        for (let [a, c] of z.entries()) {
          let g = u(a);
          g &&
            (Math.abs(c.width - g.size.width) >= Ze || Math.abs(c.height - g.size.height) >= Ze) &&
            G(a, c);
        }
        z.clear();
      }, 'Delayed'));
...
var xi = (e, t, i = {}) => R(S)(e, t, i),
  Ci = (e, t) => G(e, t),
  Si = async (e, t, i) => await J(D)(e, t, i);
function Li(e, t, i, o) {
  rt() && (We(e, oe(t), i || void 0, o), C());
}
async function Ti(e) {
  if (!e) return !1;
  let t = await x(e);
  return t ? [431010711, -1313957874, -1093325535].includes(t) : !1;
}
function zi(e) {
  (Re(e), e && te());
}
var Di = s.bind(null, 'Action'),
  ji = s.bind(null, 'Adorner'),
  Ii = s.bind(null, 'AnimationClip'),
  Fi = s.bind(null, 'Badge'),
  Ei = s.bind(null, 'BezierCurveEditor'),
  Ri = s.bind(null, 'BezierPresetCategory'),
  Bi = s.bind(null, 'BreakpointMarker'),
  qi = s.bind(null, 'Canvas'),
  Pi = s.bind(null, 'Close'),
  Ai = s.bind(null, 'ColorEyeDropper'),
  Mi = s.bind(null, 'Counter'),
  Hi = s.bind(null, 'ControlPoint'),
  Oi = s.bind(null, 'CssColorMix'),
  Ni = s.bind(null, 'CSSRuleHeader'),
  $i = s.bind(null, 'DeviceModeRuler'),
  _i = s.bind(null, 'DOMBreakpoint'),
  Ui = s.bind(null, 'Drawer'),
  Ki = s.bind(null, 'DropDown'),
  Wi = s.bind(null, 'ElementsBreadcrumbs'),
  Gi = s.bind(null, 'Expand'),
  Ji = s.bind(null, 'FilterDropdown'),
  Xi = s.bind(null, 'Gutter'),
  Yi = s.bind(null, 'Dialog'),
  Zi = s.bind(null, 'Item'),
  Qi = s.bind(null, 'Key'),
  Vi = s.bind(null, 'Link'),
  eo = s.bind(null, 'MediaInspectorView'),
  to = s.bind(null, 'Menu'),
  io = s.bind(null, 'MetricsBox'),
  oo = s.bind(null, 'PaletteColorShades'),
  ro = s.bind(null, 'Pane'),
  no = s.bind(null, 'Panel'),
  ao = s.bind(null, 'PanelTabHeader'),
  so = s.bind(null, 'PieChart'),
  lo = s.bind(null, 'PieChartSlice'),
  co = s.bind(null, 'PieChartTotal'),
  go = s.bind(null, 'Popover'),
  uo = s.bind(null, 'Preview'),
  po = s.bind(null, 'Resizer'),
  mo = s.bind(null, 'ResponsivePresets'),
  ho = s.bind(null, 'ShowStyleEditor'),
  fo = s.bind(null, 'Slider'),
  bo = s.bind(null, 'Section'),
  wo = s.bind(null, 'SectionHeader'),
  vo = s.bind(null, 'TableRow'),
  ko = s.bind(null, 'TableCell'),
  yo = s.bind(null, 'TableHeader'),
  xo = s.bind(null, 'TextField'),
  Co = s.bind(null, 'Timeline'),
  So = s.bind(null, 'Toggle'),
  Lo = s.bind(null, 'Toolbar'),
  To = s.bind(null, 'ToggleSubpane'),
  zo = s.bind(null, 'Tree'),
  Do = s.bind(null, 'TreeItem'),
  jo = s.bind(null, 'Value');
export {
  Di as action,
  nt as addDocument,
  ji as adorner,
  Ii as animationClip,
  Fi as badge,
  Ei as bezierCurveEditor,
  Ri as bezierPresetCategory,
  Bi as breakpointMarker,
  qi as canvas,
  Pi as close,
  Ai as colorEyeDropper,
  Hi as controlPoint,
  Mi as counter,
  Oi as cssColorMix,
  Ni as cssRuleHeader,
  $i as deviceModeRuler,
  Yi as dialog,
  _i as domBreakpoint,
  Ui as drawer,
  Ki as dropDown,
  Wi as elementsBreadcrumbs,
  Gi as expand,
  Ji as filterDropdown,
  Xi as gutter,
  Ti as isUnderInspection,
  Zi as item,
  Qi as key,
  Vi as link,
  xi as logClick,
  _t as logFunctionCall,
  pe as logImpressions,
  Si as logKeyDown,
  Ci as logResize,
  $t as logSettingAccess,
  eo as mediaInspectorView,
  to as menu,
  io as metricsBox,
  oo as paletteColorShades,
  ro as pane,
  no as panel,
  ao as panelTabHeader,
  so as pieChart,
  lo as pieChartSlice,
  co as pieChartTotal,
  go as popover,
  uo as preview,
  Li as registerLoggable,
  Te as registerParentProvider,
  po as resizer,
  mo as responsivePresets,
  bo as section,
  wo as sectionHeader,
  zi as setHighlightedVe,
  ft as setMappedParent,
  Ae as setVeDebugLoggingEnabled,
  Ee as setVeDebuggingEnabled,
  ho as showStyleEditor,
  fo as slider,
  Qt as startLogging,
  Vt as stopLogging,
  ko as tableCell,
