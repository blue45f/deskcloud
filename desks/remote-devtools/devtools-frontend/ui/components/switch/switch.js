...
var o = class s extends Event {
    checked;
    static eventName = 'switchchange';
    constructor(e) {
      (super(s.eventName), (this.checked = e));
    }
  },
  t = class extends HTMLElement {
    ...
    #a = (e) => {
      ((this.#e = e.target.checked), this.dispatchEvent(new o(this.#e)));
    };
    #s() {
      let e = this.#r && l.toggle(this.#r).track({ change: !0 });
      b(
        h`
    <style>${i}</style>
    <label jslog=${e || a}>
...
customElements.define('devtools-switch', t);
export { c as Switch };
