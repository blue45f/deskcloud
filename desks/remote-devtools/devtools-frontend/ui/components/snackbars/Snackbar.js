...
export class Snackbar extends HTMLElement {
  ...
  connectedCallback() {
    ...
    // clang-format off
    const actionButton = this.actionButtonLabel
      ? html`<devtools-button
        ...
        >`
      : Lit.nothing;
    const crossButton = this.closable
      ? html`<devtools-button
      ...
      html`
        ...
        <div class=${containerCls}>
          <div class="label-container">
            ...
            ${!this.#isLongAction ? actionButton : Lit.nothing} ${crossButton}
          </div>
          ${this.#isLongAction
            ? html`<div class="long-action-container">${actionButton}</div>`
            : Lit.nothing}
        </div>
      `,
      this.#shadow,
