...
EditableContent = __decorate([customElement('devtools-editable-content')], EditableContent);
/**
...
const defaultSuggestionFilter = (option, query) =>
  ...
  willUpdate(changedProperties) {
    ...
    if (changedProperties.has('expression') || changedProperties.has('options')) {
      ...
      this.#suggestions = this.options.filter((option) =>
        (this.suggestionFilter || defaultSuggestionFilter)(option, this.expression),
      );
    }
  }
  render() {
    ...
    return html`<style>
      ...
      <ul class="suggestions">
        ${this.#suggestions.map(
          (suggestion, index) =>
            html` <li
              class=${classMap({ selected: index === this.cursor })}
...
__decorate([property(jsonPropertyOptions)], SuggestionBox.prototype, 'options', void 0);
__decorate([property()], SuggestionBox.prototype, 'expression', void 0);
__decorate([property()], SuggestionBox.prototype, 'suggestionFilter', void 0);
__decorate([state()], SuggestionBox.prototype, 'cursor', void 0);
SuggestionBox = __decorate([customElement('devtools-suggestion-box')], SuggestionBox);
let SuggestionInput = class SuggestionInput extends LitElement {
  ...
  constructor() {
    ...
    let jslog = VisualLogging.value().track({
...
__decorate([property(jsonPropertyOptions)], SuggestionInput.prototype, 'options', void 0);
__decorate([property({ type: Boolean })], SuggestionInput.prototype, 'autocomplete', void 0);
__decorate([property()], SuggestionInput.prototype, 'suggestionFilter', void 0);
__decorate([state()], SuggestionInput.prototype, 'expression', void 0);
__decorate([property()], SuggestionInput.prototype, 'placeholder', void 0);
__decorate([property()], SuggestionInput.prototype, 'value', void 0);
__decorate([property({ type: Boolean })], SuggestionInput.prototype, 'disabled', void 0);
__decorate([property({ type: Boolean })], SuggestionInput.prototype, 'strikethrough', void 0);
__decorate([property()], SuggestionInput.prototype, 'mimeType', void 0);
__decorate([property()], SuggestionInput.prototype, 'jslogContext', void 0);
SuggestionInput = __decorate([customElement('devtools-suggestion-input')], SuggestionInput);
