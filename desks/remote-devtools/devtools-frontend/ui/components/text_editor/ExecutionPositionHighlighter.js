...
export function positionHighlighter(executionLineClassName, executionTokenClassName) {
  const executionLine = CodeMirror.Decoration.line({
    attributes: { class: executionLineClassName },
  });
  const executionToken = CodeMirror.Decoration.mark({
    attributes: { class: executionTokenClassName },
  });
