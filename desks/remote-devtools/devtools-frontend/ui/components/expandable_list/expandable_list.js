...
var {
  ...
  o = class extends HTMLElement {
    ...
    #t;
    set data(e) {
      ((this.#i = e.rows), (this.#t = e.title), this.#o());
    }
    #r() {
...
customElements.define('devtools-expandable-list', o);
export { d as ExpandableList };
