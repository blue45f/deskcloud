...
var S = {};
c(S, { FeedbackButton: () => n });
import * as b from './../../../core/host/host.js';
import * as h from './../../../core/i18n/i18n.js';
import * as w from './../../../core/platform/platform.js';
import * as p from './../helpers/helpers.js';
import { html as F, render as C } from './../../lit/lit.js';
import './../buttons/buttons.js';
var $ = { feedback: 'Feedback' },
  E = h.i18n.registerUIStrings('ui/components/panel_feedback/FeedbackButton.ts', $),
  H = h.i18n.getLocalizedString.bind(void 0, E),
  n = class extends HTMLElement {
    #i = this.attachShadow({ mode: 'open' });
    #e = { feedbackUrl: w.DevToolsPath.EmptyUrlString };
    set data(e) {
      ((this.#e = e), p.ScheduledRender.scheduleRender(this, this.#o));
    }
    #t() {
      b.InspectorFrontendHost.InspectorFrontendHostInstance.openInNewTab(this.#e.feedbackUrl);
    }
    #o() {
      if (!p.ScheduledRender.isScheduledRender(this))
...
customElements.define('devtools-feedback-button', n);
var L = {};
c(L, { PanelFeedback: () => r });
import './../../kit/kit.js';
...
customElements.define('devtools-panel-feedback', r);
var T = {};
c(T, { PreviewToggle: () => d });
import './../../kit/kit.js';
...
import { html as l, nothing as f, render as q } from './../../lit/lit.js';
var U = `:host{display:block}.container{display:flex;flex-wrap:wrap;padding:4px}.feedback,
...
var a = {
  ...
  z = u.i18n.registerUIStrings('ui/components/panel_feedback/PreviewToggle.ts', a),
  x = u.i18n.getLocalizedString.bind(void 0, z),
  d = class extends HTMLElement {
    ...
    set data(e) {
      ((this.#e = e.name),
        (this.#t = e.helperText),
        (this.#o = e.feedbackURL),
        (this.#s = e.learnMoreURL),
        (this.#n = e.experiment),
        (this.#r = e.onChangeCallback),
        this.#l());
    }
    #l() {
      let e = this.#n && g.Runtime.experiments.isEnabled(this.#n);
      q(
        l`
      <style>${U}</style>
      <div class="container">
    ...
    #a(e) {
      ...
      (this.#n && g.Runtime.experiments.setEnabled(this.#n, t), this.#r?.(t));
    }
  };
customElements.define('devtools-preview-toggle', d);
export { S as FeedbackButton, L as PanelFeedback, T as PreviewToggle };
