...
const str_ = i18n.i18n.registerUIStrings(
  'ui/components/panel_feedback/PanelFeedback.ts',
  UIStrings,
);
const i18nString = i18n.i18n.getLocalizedString.bind(undefined, str_);
const videoThumbnailUrl = new URL(
  '../../../Images/preview_feature_video_thumbnail.svg',
  import.meta.url,
).toString();
    ...
    render(
      html`
        ...
        <div class="preview">
          ...
          <p>
            ${i18nString(UIStrings.previewText)}
            <devtools-link href=${this.#props.feedbackUrl} .jslogContext=${'feedback'}
              >${i18nString(UIStrings.previewTextFeedbackLink)}</devtools-link
            >
          </p>
          <div class="video">
            <div class="thumbnail">
            ...
            <div class="video-description">
              ...
              <devtools-link
                ...
                href=${this.#props.quickStartUrl}
                jslogcontext="css-overview.quick-start"
                >${this.#props.quickStartLinkText}</devtools-link
              >
            </div>
          </div>
        </div>
