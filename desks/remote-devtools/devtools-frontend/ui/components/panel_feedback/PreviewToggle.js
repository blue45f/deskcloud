...
const str_ = i18n.i18n.registerUIStrings(
  'ui/components/panel_feedback/PreviewToggle.ts',
  UIStrings,
);
    ...
    render(
      html` <style>
        ...
        <div class="container">
          ...
          >
            <devtools-icon name="experiment" class="medium"> </devtools-icon>${this.#name}
          </devtools-checkbox>
          ...
          ${this.#feedbackURL && !this.#helperText
            ? html`<div class="feedback">
                <devtools-link
                  ...
                  >${i18nString(UIStrings.shortFeedbackLink)}</devtools-link
                >
              </div>`
            : nothing}
          ${this.#learnMoreURL
            ? html`<div class="learn-more">
                <devtools-link
                  ...
                  >${i18nString(UIStrings.learnMoreLink)}</devtools-link
                >
              </div>`
            : nothing}
          <div class="helper">
