  ...
  #render() {
    ...
    const data = {
      groups: [
        {
          ...toIconGroup(
            getIssueKindIconName('PageError' /* IssuesManager.Issue.IssueKind.PAGE_ERROR */),
            iconSize,
          ),
          text: countToString(
            'PageError' /* IssuesManager.Issue.IssueKind.PAGE_ERROR */,
        ...
        {
          ...toIconGroup(
            getIssueKindIconName('Improvement' /* IssuesManager.Issue.IssueKind.IMPROVEMENT */),
            iconSize,
          ),
          text: countToString(
            'Improvement' /* IssuesManager.Issue.IssueKind.IMPROVEMENT */,
