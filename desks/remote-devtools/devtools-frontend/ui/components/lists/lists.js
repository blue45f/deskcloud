...
var o = { edit: 'Edit', remove: 'Remove' },
  $ = u.i18n.registerUIStrings('ui/components/lists/List.ts', o),
  l = u.i18n.getLocalizedString.bind(void 0, $),
  a = class extends CustomEvent {
    constructor(t) {
      super('edit', { bubbles: !0, composed: !0, detail: t });
    }
  },
  d = class extends CustomEvent {
    constructor(t) {
      super('delete', { bubbles: !0, composed: !0, detail: t });
    }
  },
  c = class extends HTMLElement {
    ...
    constructor() {
      (super(),
        ...
        (this.#e = new MutationObserver(this.#t.bind(this))));
    }
    set editable(t) {
      this.#i !== t && ((this.#i = t), this.#t());
    }
    set deletable(t) {
      this.#s !== t && ((this.#s = t), this.#t());
    }
    set disableListItemFocus(t) {
      this.#o !== t && ((this.#o = t), this.#t());
    }
    attributeChangedCallback(t, s, e) {
      ...
      t === 'editable'
        ...
        : t === 'deletable'
          ? (this.deletable = i)
          : t === 'disable-li-focus' && (this.disableListItemFocus = i);
    }
    connectedCallback() {
      (this.#e.observe(this, { childList: !0 }), this.#t());
    }
    disconnectedCallback() {
      this.#e.disconnect();
    }
    createSlottedListItem(t) {
      return n`
    ...
    #t() {
      if (this.shadowRoot) {
        let s = [...this.children].map((e, i) => {
          let b = `slot-${i}`;
          return (e.getAttribute('slot') !== b && e.setAttribute('slot', b), { index: i, item: e });
        });
        x(
          n`
    <style>${h}</style>
    ...
    ${f.repeat(
      s,
      (e) => e.item,
      (e) => this.createSlottedListItem(e.index),
    )}
    </ul>
  `,
          this.shadowRoot,
    ...
    #r(t) {
      this.dispatchEvent(new d({ index: t }));
    }
    #n(t) {
      this.dispatchEvent(new a({ index: t }));
    }
  };
customElements.define('devtools-list', c);
export { m as List };
