...
var o = class extends HTMLElement {
  ...
  #e = !1;
  cloneNode(r) {
    let e = a.UIUtils.cloneCustomElement(this, r);
    return ((e.name = this.name), (e.#e = this.#e), e);
  }
  connectedCallback() {
    (this.getAttribute('aria-label') || this.setAttribute('aria-label', this.name), this.#t());
  }
    ...
    if (e !== t)
      switch (r) {
        case 'active':
          ...
          break;
        case 'toggleable':
          ((this.#e = t === 'true'), this.#r(this.getAttribute('active') === 'true'));
          break;
      }
  }
  isActive() {
  ...
  #r(r) {
    if (!this.#e) return;
    let e = r === void 0 ? !this.isActive() : r;
    (this.setAttribute('role', 'button'), this.setAttribute('aria-pressed', (!!e).toString()));
  }
  show() {
  ...
  #t() {
    h(c`<style>${i}</style><slot></slot>`, this.#o, { host: this });
  }
};
customElements.define('devtools-adorner', o);
export { l as Adorner };
