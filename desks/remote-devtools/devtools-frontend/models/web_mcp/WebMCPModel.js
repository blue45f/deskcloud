...
export class Tool {
  ...
  get frame() {
    return (
      this.#target
        ...
        ?.frameForId(this.#protocolTool.frameId) ?? undefined
    );
  }
  get isDeclarative() {
  ...
  get node() {
    ...
    return (
      this.#protocolTool.backendNodeId &&
      target &&
...
SDK.SDKModel.SDKModel.register(WebMCPModel, {
  capabilities: 2097152 /* SDK.Target.Capability.WEB_MCP */,
  autostart: true,
});
