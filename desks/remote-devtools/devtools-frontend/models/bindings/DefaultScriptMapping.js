...
export class DefaultScriptMapping {
  ...
  uiLocationToRawLocations(uiSourceCode, lineNumber, columnNumber) {
    ...
    ({ lineNumber, columnNumber } = script.relativeLocationToRawLocation({
      lineNumber,
      columnNumber,
    }));
  ...
  uiLocationRangeToRawLocationRanges(uiSourceCode, { startLine, startColumn, endLine, endColumn }) {
    ...
    ({ lineNumber: startLine, columnNumber: startColumn } = script.relativeLocationToRawLocation({
      lineNumber: startLine,
      columnNumber: startColumn,
    }));
    ({ lineNumber: endLine, columnNumber: endColumn } = script.relativeLocationToRawLocation({
      lineNumber: endLine,
  ...
  parsedScriptSource(event) {
    ...
    const uiSourceCode = this.#project.createUISourceCode(
      url,
