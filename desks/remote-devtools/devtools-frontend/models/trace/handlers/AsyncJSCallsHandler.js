...
export async function finalize() {
  ...
  for (const flow of flows) {
    ...
    if (
      !maybeAsyncTaskScheduled ||
      !Types.Events.isDebuggerAsyncTaskScheduled(maybeAsyncTaskScheduled)
    ) {
      continue;
    }
    ...
    runEntryPointToScheduler.set(asyncEntryPoint || asyncTaskRun, {
      taskName,
      scheduler: asyncCaller || maybeAsyncTaskScheduled,
    });
    ...
    const entryPoints = Platform.MapUtilities.getWithDefault(
