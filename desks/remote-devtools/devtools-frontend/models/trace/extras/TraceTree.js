...
export class TopDownNode extends Node {
  ...
  buildChildren() {
    ...
    const instantEventCallback =
      root.doNotAggregate || root.includeInstantEvents ? onInstantEvent : undefined;
    ...
    function onStartEvent(e) {
      const { startTime: currentStartTime, endTime: currentEndTime } =
        Helpers.Timing.eventTimingsMilliSeconds(e);
      ++depth;
      ...
      const actualEndTime =
        currentEndTime !== undefined ? Math.min(currentEndTime, endTime) : endTime;
