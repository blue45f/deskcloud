...
export class AutomaticFileSystemWorkspaceBinding {
  ...
  constructor(automaticFileSystemManager, isolatedFileSystemManager, workspace) {
    ...
    this.#automaticFileSystemManager.addEventListener(
      'AutomaticFileSystemChanged' /* AutomaticFileSystemManagerEvents.AUTOMATIC_FILE_SYSTEM_CHANGED */,
      this.#update,
      this,
    );
   ...
   */
  static instance(
    { forceNew, automaticFileSystemManager, isolatedFileSystemManager, workspace } = {
      forceNew: false,
