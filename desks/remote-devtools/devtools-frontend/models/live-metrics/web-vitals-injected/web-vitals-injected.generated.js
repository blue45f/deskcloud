!(function () {
  ...
  var d,
    ...
    v = (e) => {
      if ('hidden' === document.visibilityState) {
        if ('visibilitychange' === e.type) for (let e of h) e();
        isFinite(f) ||
          ((f = 'visibilitychange' === e.type ? e.timeStamp : 0),
        ...
        ((f =
          (document.prerendering
            ...
            : globalThis.performance
                ...
                .filter((t) => 'hidden' === t.name && t.startTime > e)[0]?.startTime) ?? y()),
            ...
            for (let t of e)
              'first-contentful-paint' === t.name &&
                ...
                t.startTime < o.firstHiddenTime &&
                  ((c.value = Math.max(t.startTime - s(), 0)), c.entries.push(t), n(!0)));
          });
        u &&
          ((n = i(e, c, _, t.reportAllChanges)),
          r((r) => {
            ((c = l('FCP')),
              (n = i(e, c, _, t.reportAllChanges)),
              a(() => {
                ((c.value = performance.now() - r.timeStamp), n(!0));
              }));
          }));
      });
    },
    ...
    D = (e) => {
      for (let t of e)
        t.interactionId &&
          ((L = Math.min(L, t.interactionId)),
          (P = Math.max(P, t.interactionId)),
          (I = P ? (P - L) / 7 + 1 : 0));
    },
    C = () => (d ? I : (performance.interactionCount ?? 0)),
    M = 0,
    w = class {
      ...
      _resetInteractions() {
        ((M = C()), (this._longestInteractionList.length = 0), this._longestInteractionMap.clear());
      }
      _estimateP98LongestInteraction() {
        let e = Math.min(this._longestInteractionList.length - 1, Math.floor((C() - M) / 50));
        return this._longestInteractionList[e];
      }
      _processEntry(e) {
        if ((this._onBeforeProcessingEntry?.(e), !e.interactionId && 'first-input' !== e.entryType))
          return;
        ...
        if (n || this._longestInteractionList.length < 10 || e.duration > t._latency) {
          if (
            ...
            let e = this._longestInteractionList.splice(10);
    ...
    F = (e, t = {}) => {
      ...
      b(() => {
        'interactionCount' in performance ||
          d ||
          (d = p('event', D, { type: 'event', buffered: !0, durationThreshold: 0 }));
        let a,
          o = l('INP'),
          s = u(t, w),
          c = (e) => {
          ...
          m = p('event', c, { durationThreshold: t.durationThreshold ?? 40 });
        ((a = i(e, o, x, t.reportAllChanges)),
          m &&
            ...
            r(() => {
              (s._resetInteractions(), (o = l('INP')), (a = i(e, o, x, t.reportAllChanges)));
            })));
      });
    },
    B = class {
  ...
  var j = (e) => {
    ...
    q = (e) => e.find((e) => 1 === e.node?.nodeType) || e[0],
    H = (e, t = {}) => {
      let n = u((t = Object.assign({}, t)), m),
        o = new WeakMap();
      n._onAfterProcessingUnexpectedShift = (e) => {
        if (e?.sources?.length) {
          let n = q(e.sources),
            r = n?.node;
          if (r) {
            let e = t.generateTarget?.(r) ?? V(r);
            o.set(n, e);
          }
        }
      };
      ((e, t = {}) => {
        ...
        E(
          g(() => {
            let o,
              ...
              c = u(t, m),
              d = (e) => {
                for (let t of e) c._processEntry(t);
                c._sessionValue > s.value &&
                  ((s.value = c._sessionValue), (s.entries = c._sessionEntries), o());
              },
              g = p('layout-shift', d);
            g &&
              ((o = i(e, s, S, t.reportAllChanges)),
              n.onHidden(() => {
                (d(g.takeRecords()), o(!0));
              }),
              r(() => {
        ...
        let n = ((e) => {
          let t = {};
          if (e.entries.length) {
            let n = ((e) => e.reduce((e, t) => (e.value > t.value ? e : t)))(e.entries);
            if (n?.sources?.length) {
              let e = q(n.sources);
              e &&
                (t = {
                  largestShiftTarget: o.get(e),
    ...
    U = (e, t = {}) => {
      E((t) => {
        let r = ((e) => {
          let t = { timeToFirstByte: 0, firstByteToFCP: e.value, loadState: j(n()) };
          if (e.entries.length) {
            let n = o(),
              r = e.entries.at(-1);
            if (n) {
    ...
    $ = (e, t = {}) => {
      let n = u((t = Object.assign({}, t)), w),
        ...
        d = () => {
          let e = n._longestInteractionList.map((e) => o.get(e.entries[0])),
            t = i.length - 50;
          i = i.filter((n, r) => r >= t || e.includes(n));
          let s = new Set();
          for (let e of i) {
            let t = m(e.startTime, e.processingEnd);
            for (let e of t) s.add(e);
          }
          let c = r.length - 1 - 50;
          ((r = r.filter((e, t) => (e.startTime > a && t > c) || s.has(e))), (l = !1));
        };
      ((n._onBeforeProcessingEntry = (e) => {
        ((async function (e) {
          if (!t.onEachInteraction || (await Promise.resolve(), !e.interactionId)) return;
          let n = g({
            entries: [e],
            name: 'INP',
            rating: 'good',
          ...
          ((e) => {
            ...
            for (let r = i.length - 1; r >= 0; r--) {
              ...
              if (Math.abs(n - a.renderTime) <= 8) {
                ((t = a),
                  (t.startTime = Math.min(e.startTime, t.startTime)),
            ...
            (t ||
              ...
              i.push(t)),
              (e.interactionId || 'first-input' === e.entryType) && o.set(e, t),
              c());
          })(e));
      }),
        (n._onAfterProcessingINPCandidate = (e) => {
          if (!s.get(e)) {
            let n = e.entries[0].target;
            if (n) {
              let r = t.generateTarget?.(n) ?? V(n);
              s.set(e, r);
            }
          }
        }));
      let m = (e, t) => {
        ...
        g = (e) => {
          let t = e.entries[0],
            ...
            l = Math.min(r.processingEnd, a),
            c = r.entries.sort((e, t) => e.processingStart - t.processingStart),
            u = m(t.startTime, l),
            d = n._longestInteractionMap.get(t.interactionId),
            p = {
              ...
              processingDuration: l - i,
              presentationDelay: a - l,
          ...
          return (
            ((e) => {
              ...
              let t,
                ...
                r = e.interactionTime,
                i = e.inputDelay,
                a = e.processingDuration,
                o = 0,
                s = 0,
                l = 0,
                c = 0;
              for (let l of e.longAnimationFrameEntries) {
                s = s + l.startTime + l.duration - l.styleAndLayoutStart;
                for (let e of l.scripts) {
                  let l = e.startTime + e.duration;
                  if (l < r) continue;
                  let u = l - Math.max(r, e.startTime),
              ...
              (d >= r + i + a && (l = e.nextPaintTime - d),
                t && n && (e.longestScript = { entry: t, subpart: n, intersectingDuration: c }),
                (e.totalScriptDuration = o),
                (e.totalStyleAndLayoutDuration = s),
                (e.totalPaintDuration = l),
                (e.totalUnattributedDuration = e.nextPaintTime - r - o - s - l));
            })(p),
            Object.assign(e, { attribution: p })
          );
        };
      (p('long-animation-frame', (e) => {
        ((r = r.concat(e)), c());
      }),
        F((t) => {
          let n = g(t);
          ...
          let n,
            ...
            m = (e) => {
              ...
              for (let t of e)
                (d._processEntry(t),
                  t.startTime < o.firstHiddenTime &&
                    ((c.value = Math.max(t.startTime - s(), 0)), (c.entries = [t]), n()));
            },
            f = p('largest-contentful-paint', m);
          if (f) {
            n = i(e, c, k, t.reportAllChanges);
            let o = g(() => {
                (m(f.takeRecords()), f.disconnect(), n(!0));
              }),
              s = (e) => {
                e.isTrusted && (A(o), removeEventListener(e.type, s, { capture: !0 }));
              };
          ...
          if (e.entries.length) {
            ...
            if (n) {
              let r = n.activationStart || 0,
                ...
                a =
                  i.url &&
                  performance.getEntriesByType('resource').filter((e) => e.name === i.url)[0],
                o = Math.max(0, n.responseStart - r),
                s = Math.max(o, a ? (a.requestStart || a.startTime) - r : 0),
                l = Math.min(e.value, Math.max(s, a ? a.responseEnd - r : 0));
              ((t = {
                target: c.get(i),
                timeToFirstByte: o,
                resourceLoadDelay: s - o,
                resourceLoadDuration: l - s,
                elementRenderDelay: e.value - l,
                navigationEntry: n,
                lcpEntry: i,
              }),
                i.url && (t.url = i.url),
    ...
    J = (e, t = {}) => {
      ((e, t = {}) => {
        let n = l('TTFB'),
          a = i(e, n, N, t.reportAllChanges);
        O(() => {
          let c = o();
          c &&
            ((n.value = Math.max(c.responseStart - s(), 0)),
            (n.entries = [c]),
            a(!0),
            r(() => {
              ((n = l('TTFB', 0)), (a = i(e, n, N, t.reportAllChanges)), a(!0));
            }));
        });
      })((t) => {
        let n = ((e) => {
  ...
  var z = Object.freeze({
    ...
    onEachLayoutShift: function (e) {
      new PerformanceObserver((t) => {
        ...
        for (const t of n) {
          if (t.hadRecentInput) continue;
          const n = t.sources.map((e) => e.node).filter((e) => e instanceof Node);
          e({ attribution: { affectedNodes: n }, entry: t, value: t.value });
        }
  ...
  const { onLCP: Q, onCLS: X, onINP: Y } = R,
    { onEachLayoutShift: Z } = z,
    ee = new AbortController(),
    te = (e) => {
      const t = e.addEventListener;
      e.addEventListener = function (e, n, r) {
        const i = 'boolean' == typeof r ? { capture: r } : { ...r };
        return (
          i.signal ? (i.signal = AbortSignal.any([i.signal, ee.signal])) : (i.signal = ee.signal),
          t.call(this, e, n, i)
        );
      };
    };
  (te(Window.prototype), te(Document.prototype));
  const ne = new Set();
  class re extends globalThis.PerformanceObserver {
    constructor(e) {
      (super(e), ne.add(this));
    }
    disconnect() {
      (super.disconnect(), ne.delete(this));
    }
  }
  const ie = [],
    ae = new WeakMap();
  function oe(e) {
    let t = ae.get(e);
    return (void 0 !== t || ((t = ie.length), ie.push(new WeakRef(e)), ae.set(e, t)), t);
  }
  globalThis.PerformanceObserver = re;
  let se = !1;
  function le(e) {
    const t = JSON.stringify(e);
    globalThis.__chromium_devtools_metrics_reporter(t);
  }
  function ce() {
    if (document.prerendering) return !0;
    const e = globalThis.performance.getEntriesByType?.('navigation')[0]?.activationStart;
    return void 0 !== e && e > 0;
  }
  ((globalThis.__chromium_devtools_kill_live_metrics = () => {
    if (!se) {
      for (const e of ne) e.disconnect();
      (ne.clear(), ee.abort(), (ie.length = 0), (se = !0));
    }
  }),
    (globalThis.getNodeForIndex = (e) => ie[e].deref()));
  let ue = null;
  (le({ name: 'reset' }),
    new PerformanceObserver((e) => {
      for (const t of e.getEntries()) null !== ue || ce() || (ue = 'hidden' === t.name);
    }).observe({ type: 'visibility-state', buffered: !0 }),
    r(() => {
      ((ue = !1), le({ name: 'reset' }));
    }),
    Q(
      (e) => {
        ...
        (n && (t.nodeIndex = oe(n)), le(t));
      },
      { reportAllChanges: !0 },
    ),
    X(
      (e) => {
        le({ name: 'CLS', value: e.value, clusterShiftIds: e.entries.map(K) });
      },
      { reportAllChanges: !0 },
    ),
    Y(
        ...
        onEachInteraction: function (e) {
          const t = {
            ...
            longAnimationFrameEntries:
              ((n = e.attribution.longAnimationFrameEntries.slice(-5).map((e) => e.toJSON())),
              n.map((e) => {
                const t = [];
                ...
                return (t.sort((e, t) => e.startTime - t.startTime), (e.scripts = t), e);
              })),
          };
          var n;
          const r = e.attribution.interactionTarget;
          (r && (t.nodeIndex = Number(r)), le(t));
        },
        generateTarget(e) {
          if (e) return String(oe(e));
        },
      },
    ),
    Z((e) => {
      le({
        name: 'LayoutShift',
        score: e.value,
        uniqueLayoutShiftId: K(e.entry),
        affectedNodeIndices: e.attribution.affectedNodes.map(oe),
      });
    }));
})();
