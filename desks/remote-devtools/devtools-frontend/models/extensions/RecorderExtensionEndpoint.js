...
export class RecorderExtensionEndpoint extends ExtensionEndpoint {
  ...
  stringify(recording) {
    return this.sendRequest(
      'stringify' /* PrivateAPI.RecorderExtensionPluginCommands.Stringify */,
      { recording },
    );
  }
  /**
  ...
  stringifyStep(step) {
    return this.sendRequest(
      'stringifyStep' /* PrivateAPI.RecorderExtensionPluginCommands.StringifyStep */,
      { step },
    );
  }
  /**
   ...
   */
  replay(recording) {
    return this.sendRequest('replay' /* PrivateAPI.RecorderExtensionPluginCommands.Replay */, {
      recording,
    });
  }
}
