...
export class LanguageExtensionEndpoint {
  ...
  handleScript(script) {
    try {
      if (
        !this.canAccessURL(script.contentURL()) ||
        (script.hasSourceURL && !this.canAccessURL(script.sourceURL)) ||
    ...
    return (
      language !== null &&
      script.debugSymbols !== null &&
      language === this.supportedScriptTypes.language &&
  ...
  addRawModule(rawModuleId, symbolsURL, rawModule) {
    ...
    return this.endpoint.sendRequest(
      'addRawModule' /* PrivateAPI.LanguageExtensionPluginCommands.AddRawModule */,
  ...
  removeRawModule(rawModuleId) {
    return this.endpoint.sendRequest(
      'removeRawModule' /* PrivateAPI.LanguageExtensionPluginCommands.RemoveRawModule */,
      { rawModuleId },
    );
  }
  /**
  ...
  sourceLocationToRawLocation(sourceLocation) {
    return this.endpoint.sendRequest(
      'sourceLocationToRawLocation' /* PrivateAPI.LanguageExtensionPluginCommands.SourceLocationToRawLocation */,
      { sourceLocation },
    );
  }
  /**
  ...
  rawLocationToSourceLocation(rawLocation) {
    return this.endpoint.sendRequest(
      'rawLocationToSourceLocation' /* PrivateAPI.LanguageExtensionPluginCommands.RawLocationToSourceLocation */,
      { rawLocation },
    );
  }
  getScopeInfo(type) {
    return this.endpoint.sendRequest(
      'getScopeInfo' /* PrivateAPI.LanguageExtensionPluginCommands.GetScopeInfo */,
      { type },
    );
  }
  /**
  ...
  listVariablesInScope(rawLocation) {
    return this.endpoint.sendRequest(
      'listVariablesInScope' /* PrivateAPI.LanguageExtensionPluginCommands.ListVariablesInScope */,
      { rawLocation },
    );
  }
  /**
  ...
  getFunctionInfo(rawLocation) {
    return this.endpoint.sendRequest(
      'getFunctionInfo' /* PrivateAPI.LanguageExtensionPluginCommands.GetFunctionInfo */,
      { rawLocation },
    );
  }
  /**
  ...
  getInlinedFunctionRanges(rawLocation) {
    return this.endpoint.sendRequest(
      'getInlinedFunctionRanges' /* PrivateAPI.LanguageExtensionPluginCommands.GetInlinedFunctionRanges */,
      { rawLocation },
    );
  }
  /**
  ...
  getInlinedCalleesRanges(rawLocation) {
    return this.endpoint.sendRequest(
      'getInlinedCalleesRanges' /* PrivateAPI.LanguageExtensionPluginCommands.GetInlinedCalleesRanges */,
      { rawLocation },
    );
  }
  async getMappedLines(rawModuleId, sourceFileURL) {
    return await this.endpoint.sendRequest(
      'getMappedLines' /* PrivateAPI.LanguageExtensionPluginCommands.GetMappedLines */,
      { rawModuleId, sourceFileURL },
    );
  }
  async evaluate(expression, context, stopId) {
    return await this.endpoint.sendRequest(
      'formatValue' /* PrivateAPI.LanguageExtensionPluginCommands.FormatValue */,
      { expression, context, stopId },
    );
  }
  getProperties(objectId) {
    return this.endpoint.sendRequest(
      'getProperties' /* PrivateAPI.LanguageExtensionPluginCommands.GetProperties */,
      { objectId },
    );
  }
  releaseObject(objectId) {
    return this.endpoint.sendRequest(
      'releaseObject' /* PrivateAPI.LanguageExtensionPluginCommands.ReleaseObject */,
      { objectId },
    );
  }
}
