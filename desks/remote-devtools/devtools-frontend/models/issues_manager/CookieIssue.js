...
export class CookieIssue extends Issue {
  ...
  static createIssuesFromCookieIssueDetails(cookieIssueDetails, issuesModel, issueId) {
    ...
    if (
      ...
      cookieIssueDetails.cookieExclusionReasons.length > 0
    ) {
  ...
  static codeForCookieIssueDetails(reason, warningReasons, operation, cookieUrl) {
    const isURLSecure =
      cookieUrl &&
      (Common.ParsedURL.schemeIs(cookieUrl, 'https:') ||
        Common.ParsedURL.schemeIs(cookieUrl, 'wss:'));
    const secure = isURLSecure ? 'Secure' : 'Insecure';
    if (
      reason ===
        'ExcludeSameSiteStrict' /* Protocol.Audits.CookieExclusionReason.ExcludeSameSiteStrict */ ||
      reason ===
        'ExcludeSameSiteLax' /* Protocol.Audits.CookieExclusionReason.ExcludeSameSiteLax */ ||
      reason ===
        'ExcludeSameSiteUnspecifiedTreatedAsLax' /* Protocol.Audits.CookieExclusionReason.ExcludeSameSiteUnspecifiedTreatedAsLax */
    ) {
      if (warningReasons && warningReasons.length > 0) {
        if (
          warningReasons.includes(
            'WarnSameSiteStrictLaxDowngradeStrict' /* Protocol.Audits.CookieWarningReason.WarnSameSiteStrictLaxDowngradeStrict */,
          )
        ) {
          return [
        ...
        if (
          warningReasons.includes(
            'WarnSameSiteStrictCrossDowngradeStrict' /* Protocol.Audits.CookieWarningReason.WarnSameSiteStrictCrossDowngradeStrict */,
          ) ||
          warningReasons.includes(
            'WarnSameSiteStrictCrossDowngradeLax' /* Protocol.Audits.CookieWarningReason.WarnSameSiteStrictCrossDowngradeLax */,
          ) ||
          warningReasons.includes(
            'WarnSameSiteLaxCrossDowngradeStrict' /* Protocol.Audits.CookieWarningReason.WarnSameSiteLaxCrossDowngradeStrict */,
          ) ||
          warningReasons.includes(
            'WarnSameSiteLaxCrossDowngradeLax' /* Protocol.Audits.CookieWarningReason.WarnSameSiteLaxCrossDowngradeLax */,
          )
        ) {
          return [
            'CookieIssue' /* Protocol.Audits.InspectorIssueCode.CookieIssue */,
      ...
      if (
        warningReasons.includes(
          'WarnCrossSiteRedirectDowngradeChangesInclusion' /* Protocol.Audits.CookieWarningReason.WarnCrossSiteRedirectDowngradeChangesInclusion */,
        )
      ) {
        return [
          'CookieIssue' /* Protocol.Audits.InspectorIssueCode.CookieIssue */,
    ...
    if (
      reason ===
      'ExcludePortMismatch' /* Protocol.Audits.CookieExclusionReason.ExcludePortMismatch */
    ) {
      return [
        'CookieIssue' /* Protocol.Audits.InspectorIssueCode.CookieIssue */,
        'ExcludePortMismatch',
    ...
    if (
      reason ===
      'ExcludeSchemeMismatch' /* Protocol.Audits.CookieExclusionReason.ExcludeSchemeMismatch */
    ) {
      return [
        'CookieIssue' /* Protocol.Audits.InspectorIssueCode.CookieIssue */,
  ...
  isCausedByThirdParty() {
    ...
    return isCausedByThirdParty(
      outermostFrame,
      this.details().cookieUrl,
      this.details().siteForCookies,
    );
  }
  getKind() {
  ...
  static getCookieStatus(cookieIssueDetails) {
    if (
      cookieIssueDetails.cookieExclusionReasons.includes(
    ...
    if (
      cookieIssueDetails.cookieWarningReasons.includes(
  ...
  static fromInspectorIssue(issuesModel, inspectorIssue) {
    ...
    return CookieIssue.createIssuesFromCookieIssueDetails(
      cookieIssueDetails,
      issuesModel,
...
const schemefulSameSiteArticles = [
  {
    ...
    linkTitle: i18nLazyString(UIStrings.howSchemefulSamesiteWorks),
  },
];
...
function sameSiteWarnStrictLaxDowngradeStrict(isSecure) {
  return {
    ...
    substitutions: schemefulSameSiteSubstitutions({
      isDestinationSecure: isSecure,
      isOriginSecure: !isSecure,
    }),
...
const issueDescriptions = new Map([
  ...
  [
    ...
    sameSiteWarnStrictLaxDowngradeStrict(true),
  ],
  [
    'CookieIssue::WarnSameSiteStrictLaxDowngradeStrict::Insecure',
    sameSiteWarnStrictLaxDowngradeStrict(false),
  ],
  ...
  [
    ...
    sameSiteExcludeNavigationContextDowngrade(true),
  ],
  [
  ...
  [
    'CookieIssue::WarnDeprecationTrialMetadata::ReadCookie',
    placeholderDescriptionForInvisibleIssues,
  ],
  [
    'CookieIssue::WarnDeprecationTrialMetadata::SetCookie',
    placeholderDescriptionForInvisibleIssues,
  ],
  [
    'CookieIssue::WarnThirdPartyCookieHeuristic::ReadCookie',
    placeholderDescriptionForInvisibleIssues,
  ],
  [
    'CookieIssue::WarnThirdPartyCookieHeuristic::SetCookie',
    placeholderDescriptionForInvisibleIssues,
  ],
