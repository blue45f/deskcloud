...
const issueDescriptions = new Map([
  [
    'FormLabelForNameError' /* Protocol.Audits.GenericIssueErrorType.FormLabelForNameError */,
    genericFormLabelForNameError,
  ],
  [
    'FormInputWithNoLabelError' /* Protocol.Audits.GenericIssueErrorType.FormInputWithNoLabelError */,
  ...
  [
    'FormDuplicateIdForInputError' /* Protocol.Audits.GenericIssueErrorType.FormDuplicateIdForInputError */,
...
const issueTypes = new Map([
  [
    'FormLabelForNameError' /* Protocol.Audits.GenericIssueErrorType.FormLabelForNameError */,
    'PageError' /* IssueKind.PAGE_ERROR */,
  ],
  [
    'FormInputWithNoLabelError' /* Protocol.Audits.GenericIssueErrorType.FormInputWithNoLabelError */,
