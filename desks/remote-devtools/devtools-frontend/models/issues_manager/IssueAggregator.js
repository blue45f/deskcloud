...
export class IssueAggregator extends Common.ObjectWrapper.ObjectWrapper {
  ...
  constructor(issuesManager) {
    ...
    this.issuesManager.addEventListener(
      'FullUpdateRequired' /* IssuesManagerEvents.FULL_UPDATE_REQUIRED */,
  ...
  #aggregateIssue(issue) {
    ...
    this.dispatchEventToListeners(
      'AggregatedIssueUpdated' /* Events.AGGREGATED_ISSUE_UPDATED */,
      aggregatedIssue,
    );
  ...
  aggregatedIssueCodes() {
    return new Set([
      ...this.#aggregatedIssuesByKey.keys(),
      ...this.#hiddenAggregatedIssuesByKey.keys(),
    ]);
  }
