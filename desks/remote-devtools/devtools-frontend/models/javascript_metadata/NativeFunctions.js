...
export const NativeFunctions = [
  ...
  },
  {
    ...
    signatures: [
      ['mode', 'countsList', 'countsOffset', 'type', 'offsetsList', 'offsetsOffset', 'drawcount'],
    ],
  },
  {
    name: 'beginQuery',
  ...
  },
  {
    name: 'clearBufferfv',
    signatures: [
      ['buffer', 'drawbuffer', 'values', '?srcOffset'],
      ['buffer', 'drawbuffer', 'value', '?srcOffset'],
    ],
  },
  {
    name: 'clearBufferiv',
  ...
  },
  {
    name: 'uniform1uiv',
    signatures: [
      ['location', 'data', '?srcOffset', '?srcLength'],
      ['location', 'v', '?srcOffset', '?srcLength'],
    ],
  },
  {
    name: 'uniform2ui',
  ...
  },
  {
    ...
    signatures: [
      ...
      ['target', 'level', 'internalformat', 'format', 'type', 'offscreenCanvas'],
      ['target', 'level', 'internalformat', 'format', 'type', 'video'],
      ['target', 'level', 'internalformat', 'format', 'type', 'bitmap'],
      ['target', 'level', 'internalformat', 'format', 'type', 'frame'],
      [
        'target',
        'level',
        'internalformat',
  ...
  },
  {
    ...
    signatures: [
      ...
      ['target', 'level', 'internalformat', 'width', 'height', 'border', 'format', 'type', 'image'],
      [
        'target',
        'level',
        'internalformat',
      ...
      ['target', 'level', 'internalformat', 'width', 'height', 'border', 'format', 'type', 'video'],
      ['target', 'level', 'internalformat', 'width', 'height', 'border', 'format', 'type', 'frame'],
      [
        'target',
        'level',
        'internalformat',
  ...
  },
  {
    ...
    signatures: [
      ...
      ['target', 'level', 'xoffset', 'yoffset', 'format', 'type', 'offscreenCanvas'],
      ['target', 'level', 'xoffset', 'yoffset', 'format', 'type', 'video'],
      ['target', 'level', 'xoffset', 'yoffset', 'format', 'type', 'bitmap'],
      ['target', 'level', 'xoffset', 'yoffset', 'format', 'type', 'frame'],
      ['target', 'level', 'xoffset', 'yoffset', 'width', 'height', 'format', 'type', 'pixels'],
    ],
    receivers: [
      'WebGLRenderingContextWebGPU',
  ...
  },
  {
    ...
    signatures: [
      ...
      ['target', 'level', 'xoffset', 'yoffset', 'width', 'height', 'format', 'type', 'image'],
      ['target', 'level', 'xoffset', 'yoffset', 'width', 'height', 'format', 'type', 'canvas'],
      [
        'target',
        'level',
        'xoffset',
      ...
      ['target', 'level', 'xoffset', 'yoffset', 'width', 'height', 'format', 'type', 'video'],
      ['target', 'level', 'xoffset', 'yoffset', 'width', 'height', 'format', 'type', 'frame'],
      ['target', 'level', 'xoffset', 'yoffset', 'width', 'height', 'format', 'type', 'bitmap'],
      [
        'target',
        'level',
        'xoffset',
  ...
  },
  {
    ...
    signatures: [
      ...
      ['element', 'sx', 'sy', 'swidth', 'sheight', 'dx', 'dy', '?dwidth', '?dheight'],
    ],
  },
  {
    name: 'Path2D',
  ...
  },
  {
    name: 'lstmCell',
    signatures: [
      ['input', 'weight', 'recurrentWeight', 'hiddenState', 'cellState', 'hiddenSize', '?options'],
    ],
  },
  {
    name: 'pad',
  ...
  },
  {
    ...
    signatures: [
      ['mode', 'count', 'type', 'offset', 'instance_count', 'basevertex', 'baseinstance'],
    ],
  },
  {
  ...
  },
  {
    ...
    signatures: [
      ...
      ['target', 'level', 'internalformat', 'width', 'height', 'format', 'type', 'element'],
      [
        'target',
        'level',
        'internalformat',
  ...
  },
  {
    ...
    signatures: [
      ['source', 'destination'],
      ['source', 'width', 'height', 'destination'],
      ['source', 'sx', 'sy', 'swidth', 'sheight', 'destination'],
    ],
  },
  {
    name: 'setIndexBuffer',
