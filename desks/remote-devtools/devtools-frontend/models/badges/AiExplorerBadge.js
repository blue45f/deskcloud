...
const AI_EXPLORER_BADGE_URI = new URL(
  '../../Images/ai-explorer-badge.svg',
  import.meta.url,
).toString();
...
export class AiExplorerBadge extends Badge {
  ...
  #aiConversationCountSetting = Common.Settings.Settings.instance().createSetting(
    AI_CONVERSATION_COUNT_SETTING_NAME,
    0,
    'Synced' /* Common.Settings.SettingStorageType.SYNCED */,
  );
  interestedActions = [BadgeAction.STARTED_AI_CONVERSATION];
