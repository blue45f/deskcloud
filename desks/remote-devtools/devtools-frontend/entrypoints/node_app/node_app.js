...
var r = {
  ...
  H = C.i18n.registerUIStrings('panels/mobile_throttling/mobile_throttling-meta.ts', r),
  a = C.i18n.getLazilyComputedLocalizedString.bind(void 0, H),
  S;
async function h() {
  return (S || (S = await import('./../../panels/mobile_throttling/mobile_throttling.js')), S);
}
...
q.Settings.registerSettingExtension({
  storageType: 'Synced',
...
var w = {
  ...
  B = P.i18n.registerUIStrings('panels/js_timeline/js_timeline-meta.ts', w),
  m = P.i18n.getLazilyComputedLocalizedString.bind(void 0, B),
  y;
async function T() {
  return (y || (y = await import('./../../panels/timeline/timeline.js')), y);
}
function E(e) {
  return y === void 0 ? [] : e(y);
}
p.ViewManager.registerViewExtension({
  location: 'panel',
  id: 'timeline',
  title: m(w.performance),
  commandPrompt: m(w.showPerformance),
  order: 66,
  hasToolbar: !1,
  isPreviewFeature: !0,
  async loadView(e) {
    let z = await T(),
      U = e.context.get(L.PageResourceLoader.PageResourceLoader);
    return z.TimelinePanel.TimelinePanel.instance({ forceNew: !0, resourceLoader: U });
  },
});
p.ActionRegistration.registerActionExtension({
  ...
  title: m(w.showRecentTimelineSessions),
  contextTypes() {
...
p.ActionRegistration.registerActionExtension({
  ...
  options: [
    { value: !0, title: m(w.record) },
    { value: !1, title: m(w.stop) },
  ],
  bindings: [
...
import * as O from './../../panels/common/common.js';
import * as i from './../../ui/legacy/legacy.js';
import * as R from './../../panels/network/forward/forward.js';
var t = {
  ...
  W = c.i18n.registerUIStrings('panels/network/network-meta.ts', t),
  o = c.i18n.getLazilyComputedLocalizedString.bind(void 0, W),
  v = c.i18n.getLocalizedString.bind(void 0, W),
  N,
  _ = M.Runtime.Runtime.isNode();
async function n() {
  return (N || (N = await import('./../../panels/network/network.js')), N);
}
function k(e) {
  return N === void 0 ? [] : e(N);
}
...
i.ActionRegistration.registerActionExtension({
  ...
  toggleWithRedColor: !0,
  contextTypes() {
    return k((e) => [e.NetworkPanel.NetworkPanel]);
  },
  async loadActionDelegate() {
    let e = await n();
...
i.ActionRegistration.registerActionExtension({
  ...
  iconClass: 'plus',
  contextTypes() {
    return k((e) => [e.RequestConditionsDrawer.RequestConditionsDrawer]);
  },
  async loadActionDelegate() {
    let e = await n();
...
s.Revealer.registerRevealer({
  contextTypes() {
    return [R.UIRequestLocation.UIRequestLocation];
  },
  async loadRevealer() {
    let e = await n();
...
s.Revealer.registerRevealer({
  contextTypes() {
    return [R.NetworkRequestId.NetworkRequestId];
  },
  destination: s.Revealer.RevealerDestination.NETWORK_PANEL,
  async loadRevealer() {
    let e = await n();
...
s.Revealer.registerRevealer({
  contextTypes() {
    return [R.UIFilter.UIRequestFilter, O.ExtensionServer.RevealableNetworkRequestFilter];
  },
  destination: s.Revealer.RevealerDestination.NETWORK_PANEL,
  async loadRevealer() {
    let e = await n();
...
import * as K from './../main/main.js';
import * as A from './app/app.js';
var { NodeConnectionsPanel: j } = A.NodeConnectionsPanel,
  { NodeMainImpl: Y } = A.NodeMain,
  g = {
  ...
  J = x.i18n.registerUIStrings('entrypoints/node_app/node_app.ts', g),
  u = x.i18n.getLazilyComputedLocalizedString.bind(void 0, J),
  D;
async function Q() {
...
f.ViewManager.registerViewExtension({
  location: 'panel',
  id: 'node-connection',
  title: u(g.connection),
  commandPrompt: u(g.showConnection),
  order: 0,
  async loadView() {
    return new j();
  },
...
f.ViewManager.registerViewExtension({
  ...
  title: u(g.networkTitle),
  commandPrompt: u(g.showNode),
  order: 2,
  persistence: 'permanent',
  async loadView() {
    return (await Q()).SourcesNavigator.NetworkNavigatorView.instance();
  },
});
var b;
async function X() {
  return (b || (b = await import('./../../panels/application/application.js')), b);
}
f.ViewManager.registerViewExtension({
  location: 'panel',
  id: 'resources',
  title: u(g.application),
  commandPrompt: u(g.showApplication),
  order: 70,
  async loadView() {
    return (await X()).ResourcesPanel.ResourcesPanel.instance({ forceNew: !0, mode: 'node' });
  },
  tags: [],
});
globalThis.runtime = G.Runtime.Runtime.instance({ forceNew: !0 });
F.Runnable.registerEarlyInitializationRunnable(Y.instance);
new K.MainImpl.MainImpl();
