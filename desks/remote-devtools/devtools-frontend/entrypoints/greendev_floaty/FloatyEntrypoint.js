...
import * as y from './../../core/i18n/i18n.js';
var e = {
  ...
  me = y.i18n.registerUIStrings('core/sdk/sdk-meta.ts', e),
  t = y.i18n.getLazilyComputedLocalizedString.bind(void 0, me);
...
r.Settings.registerSettingExtension({
  ...
  options: [
    ...
    },
    {
      ...
      text: y.i18n.lockedLazyString('prefers-color-scheme: light'),
      value: 'light',
    },
    {
      title: t(e.emulateCss, { PH1: 'prefers-color-scheme: dark' }),
      text: y.i18n.lockedLazyString('prefers-color-scheme: dark'),
      value: 'dark',
    },
  ],
  tags: [t(e.query)],
...
r.Settings.registerSettingExtension({
  ...
  options: [
    { title: t(e.doNotEmulateCss, { PH1: 'forced-colors' }), text: t(e.noEmulation), value: '' },
    {
      ...
      text: y.i18n.lockedLazyString('forced-colors: active'),
      value: 'active',
    },
    {
      title: t(e.emulateCss, { PH1: 'forced-colors: none' }),
      text: y.i18n.lockedLazyString('forced-colors: none'),
      value: 'none',
    },
  ],
  tags: [t(e.query)],
...
r.Settings.registerSettingExtension({
  ...
  options: [
    ...
    },
    {
      ...
      text: y.i18n.lockedLazyString('prefers-reduced-motion: reduce'),
      value: 'reduce',
    },
  ],
  tags: [t(e.query)],
...
r.Settings.registerSettingExtension({
  ...
  options: [
    { title: t(e.doNotEmulateCss, { PH1: 'prefers-contrast' }), text: t(e.noEmulation), value: '' },
    {
      ...
      text: y.i18n.lockedLazyString('prefers-contrast: more'),
      value: 'more',
    },
    {
      title: t(e.emulateCss, { PH1: 'prefers-contrast: less' }),
      text: y.i18n.lockedLazyString('prefers-contrast: less'),
      value: 'less',
    },
    {
      title: t(e.emulateCss, { PH1: 'prefers-contrast: custom' }),
      text: y.i18n.lockedLazyString('prefers-contrast: custom'),
      value: 'custom',
    },
  ],
  tags: [t(e.query)],
...
r.Settings.registerSettingExtension({
  ...
  options: [
    ...
    },
    {
      ...
      text: y.i18n.lockedLazyString('prefers-reduced-data: reduce'),
      value: 'reduce',
    },
  ],
...
r.Settings.registerSettingExtension({
  ...
  options: [
    ...
    },
    {
      ...
      text: y.i18n.lockedLazyString('prefers-reduced-transparency: reduce'),
      value: 'reduce',
    },
  ],
...
r.Settings.registerSettingExtension({
  ...
  options: [
    { title: t(e.doNotEmulateCss, { PH1: 'color-gamut' }), text: t(e.noEmulation), value: '' },
    {
      ...
      text: y.i18n.lockedLazyString('color-gamut: srgb'),
      value: 'srgb',
    },
    {
      title: t(e.emulateCss, { PH1: 'color-gamut: p3' }),
      text: y.i18n.lockedLazyString('color-gamut: p3'),
      value: 'p3',
    },
    {
      title: t(e.emulateCss, { PH1: 'color-gamut: rec2020' }),
      text: y.i18n.lockedLazyString('color-gamut: rec2020'),
      value: 'rec2020',
    },
  ],
...
var c = {
  ...
  pe = z.i18n.registerUIStrings('panels/sensors/sensors-meta.ts', c),
  d = z.i18n.getLazilyComputedLocalizedString.bind(void 0, pe),
  B;
async function oe() {
  return (B || (B = await import('./../../panels/sensors/sensors.js')), B);
}
q.ViewManager.registerViewExtension({
  location: 'drawer-view',
  commandPrompt: d(c.showSensors),
  title: d(c.sensors),
  id: 'sensors',
  ...
  async loadView() {
    let i = await oe();
    return new i.SensorsView.SensorsView();
  },
  tags: [
    d(c.geolocation),
    d(c.timezones),
    ...
    d(c.locales),
    d(c.accelerometer),
    d(c.deviceOrientation),
  ],
});
q.ViewManager.registerViewExtension({
  location: 'settings-view',
  id: 'emulation-locations',
  commandPrompt: d(c.showLocations),
  title: d(c.locations),
  order: 40,
  async loadView() {
    let i = await oe();
    return new i.LocationsSettingsTab.LocationsSettingsTab();
  },
...
M.Settings.registerSettingExtension({
  title: d(c.cpuPressure),
  reloadRequired: !0,
  settingName: 'emulation.cpu-pressure',
  settingType: 'enum',
  defaultValue: 'none',
  options: [
    { value: 'none', title: d(c.noPressureEmulation), text: d(c.noPressureEmulation) },
    { value: 'nominal', title: d(c.nominal), text: d(c.nominal) },
    { value: 'fair', title: d(c.fair), text: d(c.fair) },
    { value: 'serious', title: d(c.serious), text: d(c.serious) },
    { value: 'critical', title: d(c.critical), text: d(c.critical) },
  ],
});
M.Settings.registerSettingExtension({
  title: d(c.touch),
  ...
  defaultValue: 'none',
  options: [
    { value: 'none', title: d(c.devicebased), text: d(c.devicebased) },
    { value: 'force', title: d(c.forceEnabled), text: d(c.forceEnabled) },
  ],
});
M.Settings.registerSettingExtension({
  title: d(c.emulateIdleDetectorState),
  settingName: 'emulation.idle-detection',
  settingType: 'enum',
  defaultValue: 'none',
  options: [
    { value: 'none', title: d(c.noIdleEmulation), text: d(c.noIdleEmulation) },
    {
      value: '{"isUserActive":true,"isScreenUnlocked":true}',
      title: d(c.userActiveScreenUnlocked),
      text: d(c.userActiveScreenUnlocked),
    },
    {
      value: '{"isUserActive":true,"isScreenUnlocked":false}',
      title: d(c.userActiveScreenLocked),
      text: d(c.userActiveScreenLocked),
    },
    {
      value: '{"isUserActive":false,"isScreenUnlocked":true}',
      title: d(c.userIdleScreenUnlocked),
      text: d(c.userIdleScreenUnlocked),
    },
    {
      value: '{"isUserActive":false,"isScreenUnlocked":false}',
      title: d(c.userIdleScreenLocked),
      text: d(c.userIdleScreenLocked),
    },
  ],
});
...
var m = {
  ...
  Se = W.i18n.registerUIStrings('entrypoints/inspector_main/inspector_main-meta.ts', m),
  S = W.i18n.getLazilyComputedLocalizedString.bind(void 0, Se),
  J;
async function k() {
  return (J || (J = await import('./../inspector_main/inspector_main.js')), J);
}
C.ViewManager.registerViewExtension({
  location: 'drawer-view',
  id: 'rendering',
  title: S(m.rendering),
  commandPrompt: S(m.showRendering),
  persistence: 'closeable',
  order: 50,
  async loadView() {
    let i = await k();
    return new i.RenderingOptions.RenderingOptionsView();
  },
  tags: [
    S(m.paint),
    S(m.layout),
    ...
    S(m.cssMediaType),
    S(m.cssMediaFeature),
    S(m.visionDeficiency),
    S(m.colorVisionDeficiency),
  ],
});
C.ActionRegistration.registerActionExtension({
  ...
  async loadActionDelegate() {
    let i = await k();
    return new i.InspectorMain.ReloadActionDelegate();
  },
  iconClass: 'refresh',
  title: S(m.reloadPage),
  bindings: [
...
C.ActionRegistration.registerActionExtension({
  ...
  category: 'RENDERING',
  title: S(m.toggleCssPrefersColorSchemeMedia),
  async loadActionDelegate() {
    let i = await k();
    return new i.RenderingOptions.ReloadActionDelegate();
  },
});
H.Settings.registerSettingExtension({
  category: 'NETWORK',
  title: S(m.forceAdBlocking),
  settingName: 'network.ad-blocking-enabled',
  settingType: 'boolean',
  storageType: 'Session',
  defaultValue: !1,
  options: [
    { value: !0, title: S(m.blockAds) },
    { value: !1, title: S(m.showAds) },
  ],
});
H.Settings.registerSettingExtension({
  category: 'GLOBAL',
  storageType: 'Synced',
  title: S(m.autoOpenDevTools),
  settingName: 'auto-attach-to-created-pages',
  settingType: 'boolean',
  order: 2,
  defaultValue: !1,
  options: [
    { value: !0, title: S(m.autoOpenDevTools) },
    { value: !1, title: S(m.doNotAutoOpen) },
  ],
});
H.Settings.registerSettingExtension({
  category: 'APPEARANCE',
  storageType: 'Synced',
  title: S(m.disablePaused),
...
C.Toolbar.registerToolbarItem({
  async loadItem() {
    return (await k()).InspectorMain.NodeIndicatorProvider.instance();
  },
  order: 2,
...
C.Toolbar.registerToolbarItem({
  async loadItem() {
    return (await k()).OutermostTargetSelector.OutermostTargetSelector.instance();
  },
  order: 97,
...
import * as X from './../../ui/legacy/components/utils/utils.js';
...
var n = {
  ...
  he = R.i18n.registerUIStrings('entrypoints/main/main-meta.ts', n),
  a = R.i18n.getLazilyComputedLocalizedString.bind(void 0, he),
  _,
  K;
async function T() {
  return (_ || (_ = await import('./../main/main.js')), _);
}
async function ye() {
  return (K || (K = await import('./../inspector_main/inspector_main.js')), K);
}
s.ActionRegistration.registerActionExtension({
  category: 'DRAWER',
  actionId: 'inspector-main.focus-debuggee',
  async loadActionDelegate() {
    let i = await ye();
    return new i.InspectorMain.FocusDebuggeeActionDelegate();
  },
  order: 100,
  title: a(n.focusDebuggee),
});
s.ActionRegistration.registerActionExtension({
  category: 'DRAWER',
  actionId: 'main.toggle-drawer',
  async loadActionDelegate() {
    return new s.InspectorView.ActionDelegate();
  },
  order: 101,
  title: a(n.toggleDrawer),
...
s.ActionRegistration.registerActionExtension({
  ...
  title: a(n.toggleDrawerOrientation),
  bindings: [{ shortcut: 'Shift+Esc' }],
  condition: (i) => !!i?.devToolsFlexibleLayout?.verticalDrawerEnabled,
});
s.ActionRegistration.registerActionExtension({
...
s.ActionRegistration.registerActionExtension({
  ...
  category: 'GLOBAL',
  title: a(n.reloadDevtools),
  async loadActionDelegate() {
    let i = await T();
    return new i.MainImpl.ReloadActionDelegate();
  },
  bindings: [{ shortcut: 'Alt+R' }],
});
s.ActionRegistration.registerActionExtension({
  category: 'GLOBAL',
  title: a(n.restoreLastDockPosition),
  actionId: 'main.toggle-dock',
  async loadActionDelegate() {
    return new s.DockController.ToggleDockActionDelegate();
  },
  bindings: [
...
s.ActionRegistration.registerActionExtension({
  ...
  async loadActionDelegate() {
    let i = await T();
    return new i.MainImpl.ZoomActionDelegate();
  },
  bindings: [
    {
...
s.ActionRegistration.registerActionExtension({
  ...
  category: 'GLOBAL',
  title: a(n.searchInPanel),
  async loadActionDelegate() {
    let i = await T();
    return new i.MainImpl.SearchActionDelegate();
  },
  bindings: [
...
v.Settings.registerSettingExtension({
  category: 'APPEARANCE',
  storageType: 'Synced',
  title: a(n.theme),
  ...
  reloadRequired: !1,
  options: [
    { title: a(n.switchToBrowserPreferredTheme), text: a(n.autoTheme), value: 'systemPreferred' },
    { title: a(n.switchToLightTheme), text: a(n.lightCapital), value: 'default' },
    { title: a(n.switchToDarkTheme), text: a(n.darkCapital), value: 'dark' },
  ],
  tags: [a(n.darkLower), a(n.lightLower)],
});
v.Settings.registerSettingExtension({
  category: 'APPEARANCE',
  storageType: 'Synced',
  title: a(n.matchChromeColorScheme),
  settingName: 'chrome-theme-colors',
  settingType: 'boolean',
  defaultValue: !0,
  options: [
    { value: !0, title: a(n.matchChromeColorSchemeCommand) },
    { value: !1, title: a(n.dontMatchChromeColorSchemeCommand) },
  ],
  reloadRequired: !0,
  learnMore: {
    url: 'https://goo.gle/devtools-customize-theme',
    tooltip: a(n.matchChromeColorSchemeDocumentation),
  },
});
v.Settings.registerSettingExtension({
  category: 'APPEARANCE',
  storageType: 'Synced',
  title: a(n.panelLayout),
  settingName: 'sidebar-position',
  settingType: 'enum',
  defaultValue: 'auto',
  options: [
    { title: a(n.useHorizontalPanelLayout), text: a(n.horizontal), value: 'bottom' },
    { title: a(n.useVerticalPanelLayout), text: a(n.vertical), value: 'right' },
    { title: a(n.useAutomaticPanelLayout), text: a(n.auto), value: 'auto' },
  ],
});
v.Settings.registerSettingExtension({
  category: 'APPEARANCE',
  ...
  defaultValue: 'en-US',
  options: [
    { value: 'browserLanguage', title: a(n.browserLanguage), text: a(n.browserLanguage) },
    ...R.i18n
...
v.Settings.registerSettingExtension({
  ...
  storageType: 'Synced',
  title:
    ae.Platform.platform() === 'mac'
      ? a(n.enableShortcutToSwitchPanels)
      : a(n.enableCtrlShortcutToSwitchPanels),
...
v.Settings.registerSettingExtension({
  ...
  defaultValue: 'right',
  options: [
    { value: 'right', text: a(n.right), title: a(n.dockToRight) },
    { value: 'bottom', text: a(n.bottom), title: a(n.dockToBottom) },
    { value: 'left', text: a(n.left), title: a(n.dockToLeft) },
    { value: 'undocked', text: a(n.undocked), title: a(n.undockIntoSeparateWindow) },
  ],
});
v.Settings.registerSettingExtension({
  storageType: 'Synced',
  ...
  options: [
    { value: 'devToolsDefault', title: a(n.devtoolsDefault), text: a(n.devtoolsDefault) },
    {
      value: 'vsCode',
...
function ne(i) {
  return () => R.i18n.getLocalizedLanguageRegion(i, R.DevToolsLocale.DevToolsLocale.instance());
}
function fe(i) {
  return { value: i, title: ne(i), text: ne(i) };
}
v.Settings.registerSettingExtension({
  category: 'ACCOUNT',
  settingName: 'sync-preferences',
  settingType: 'boolean',
  title: a(n.saveSettings),
  defaultValue: !1,
  reloadRequired: !0,
});
v.Settings.registerSettingExtension({
...
v.Settings.registerSettingExtension({
  category: 'GLOBAL',
  storageType: 'Local',
  title: a(n.searchAsYouTypeSetting),
  settingName: 'search-as-you-type',
  settingType: 'boolean',
  order: 3,
  defaultValue: !0,
  options: [
    { value: !0, title: a(n.searchAsYouTypeCommand) },
    { value: !1, title: a(n.searchOnEnterCommand) },
  ],
});
s.ViewManager.registerLocationResolver({
  name: 'drawer-view',
  category: 'DRAWER',
  async loadResolver() {
    return s.InspectorView.InspectorView.instance();
  },
});
s.ViewManager.registerLocationResolver({
  name: 'drawer-sidebar',
...
s.ContextMenu.registerProvider({
  contextTypes() {
    return [se.UISourceCode.UISourceCode, O.Resource.Resource, O.NetworkRequest.NetworkRequest];
  },
  async loadProvider() {
    return new X.Linkifier.ContentProviderContextMenuProvider();
  },
});
s.ContextMenu.registerProvider({
  contextTypes() {
  ...
  async loadProvider() {
    return new s.LinkContextMenuProvider.LinkContextMenuProvider();
  },
});
s.ContextMenu.registerProvider({
  contextTypes() {
  ...
  async loadProvider() {
    return new X.Linkifier.LinkContextMenuProvider();
  },
});
s.Toolbar.registerToolbarItem({ separator: !0, location: 'main-toolbar-left', order: 100 });
s.Toolbar.registerToolbarItem({ separator: !0, order: 96, location: 'main-toolbar-right' });
s.Toolbar.registerToolbarItem({
  condition(i) {
    let o = i?.devToolsGlobalAiButton?.enabled,
      u = i?.aidaAvailability?.blockedByGeo === !0,
      l = i?.aidaAvailability?.blockedByEnterprisePolicy === !0;
    return !!(o && !u && !l);
  },
  async loadItem() {
    return (await T()).GlobalAiButton.GlobalAiButtonToolbarProvider.instance();
  },
  order: 98,
  location: 'main-toolbar-right',
});
s.Toolbar.registerToolbarItem({
  async loadItem() {
    return (await T()).MainImpl.SettingsButtonProvider.instance();
  },
  order: 99,
  location: 'main-toolbar-right',
});
s.Toolbar.registerToolbarItem({
  condition: () => !ie.Runtime.Runtime.isTraceApp(),
  async loadItem() {
    return (await T()).MainImpl.MainMenuItem.instance();
  },
  order: 100,
  location: 'main-toolbar-right',
});
s.Toolbar.registerToolbarItem({
  async loadItem() {
    return s.DockController.CloseButtonProvider.instance();
  },
  order: 101,
  location: 'main-toolbar-right',
});
v.AppProvider.registerAppProvider({
  async loadAppProvider() {
    return (await T()).SimpleApp.SimpleAppProvider.instance();
  },
  order: 10,
});
...
import * as re from './../../foundation/foundation.js';
import * as V from './../../models/ai_assistance/ai_assistance.js';
import * as G from './../../ui/legacy/legacy.js';
import * as le from './../../ui/legacy/theme_support/theme_support.js';
var { AidaClient: ve } = p.AidaClient,
  { ResponseType: Ce } = V.AiAgent,
  D = null,
  j = class i {
    #o;
    #n;
    ...
    #l;
    constructor(o) {
      let u = new URLSearchParams(globalThis.location.hash.substring(1));
      ((this.#e = parseInt(u.get('backendNodeId') || '0', 10)),
        (this.#l = !!this.#e),
        (this.#a = new BroadcastChannel('green-dev-sync')),
        (this.#a.onmessage = (l) => {
          this.#p(l.data);
        }),
        this.#m(o));
    ...
    #m(o) {
      ((this.#o = o.getElementById('chat-container')),
        (this.#n = o.querySelector('.green-dev-floaty-dialog-text-field')),
        (this.#r = o.querySelector('.green-dev-floaty-dialog-play-button')),
        this.#r?.addEventListener('click', () => {
          this.#t && this.runConversation();
        }));
      let u = o.querySelector('.green-dev-floaty-dialog-context-text');
      u &&
        ((u.style.cursor = 'pointer'),
        (u.title = 'Click to show in DevTools Panel'),
        u.addEventListener('click', () => {
          this.#c();
        }));
      let l = o.querySelector('.learn-more-link');
      l &&
        l.addEventListener('click', (w) => {
          (w.preventDefault(),
            p.InspectorFrontendHost.InspectorFrontendHostInstance.openInNewTab(
              'https://developer.chrome.com/docs/devtools/ai-assistance',
            ));
        });
      let h = o.querySelector('.green-dev-floaty-dialog-node-description');
      (h?.addEventListener('mousemove', () => {
        this.#t && this.#t.highlight();
      }),
        h?.addEventListener('mouseleave', () => {
          if (this.#t && this.#e) {
            let w = JSON.stringify({
              ...
              params: { inspectedElementAnchorConfig: { backendNodeId: this.#e } },
            });
            p.InspectorFrontendHost.InspectorFrontendHostInstance.sendMessageToBackend(w);
          }
        }),
        this.#n?.addEventListener('keydown', (w) => {
          w.key === 'Enter' && this.#t && this.runConversation();
        }),
        this.#n?.focus());
    }
    #c() {
      let o = {
        ...
        messages: this.#y(),
        sessionId: this.#e,
        nodeDescription: document.querySelector('.green-dev-floaty-dialog-node-description')
          ?.textContent,
      };
      this.#a.postMessage(o);
    }
    #p(o) {
      if (o.type === 'main-window-alive') {
        if (D) {
          let u = new BroadcastChannel('green-dev-sync');
          (u.postMessage({ type: 'activate-panel', sessionId: D }), u.close());
        }
      } else
        o.type === 'request-session-state'
          ? (this.#c(),
            D && (this.#a.postMessage({ type: 'select-tab', sessionId: D }), (D = null)))
          : o.type === 'user-input' && o.sessionId === this.#e
            ? this.#n && ((this.#n.value = o.text ?? ''), this.runConversation())
            : o.type === 'restore-floaty' &&
              o.sessionId === this.#e &&
              p.InspectorFrontendHost.InspectorFrontendHostInstance.bringToFront();
    }
    static instance(o = { forceNew: null, document }) {
      let { forceNew: u, document: l } = o;
      return ((!Z || u) && (Z = new i(l)), Z);
    }
    handlePanelRequest = (o) => {
      ((D = o.data),
        this.#d(D, 0),
        p.InspectorFrontendHost.InspectorFrontendHostInstance.openInNewTab('magic:open-devtools'));
    };
    #S = 10;
    #h = 200;
    #d(o, u) {
      if (u >= this.#S) return;
      let l = new BroadcastChannel('green-dev-sync');
      (l.postMessage({ type: 'activate-panel', sessionId: o }),
        l.close(),
        setTimeout(() => {
          D === o && this.#d(o, u + 1);
        }, this.#h));
    }
    handleRestoreEvent(o) {
      let u = o.data;
      this.#l
        ? this.#e === u &&
          (console.error('[GreenDev] Calling bringToFront for session ' + u),
          p.InspectorFrontendHost.InspectorFrontendHostInstance.bringToFront())
        : this.#a.postMessage({ type: 'restore-floaty', sessionId: u });
    }
    setNode(o) {
      if (
        (this.#t &&
          this.#t
            .domModel()
            .overlayModel()
            .removeEventListener('InspectPanelShowRequested', this.handlePanelRequest),
        this.#t === o)
      )
        return;
      ((this.#t = o),
        this.#t
          .domModel()
          .overlayModel()
          .addEventListener('InspectPanelShowRequested', this.handlePanelRequest),
        (this.#e = o.backendNodeId()),
        o.domModel().overlayModel().clearHighlight(),
        this.#n?.focus(),
        (this.#i = void 0),
        (this.#s = void 0));
      let u = document.querySelector('.green-dev-floaty-dialog-node-description'),
        l = '';
      if (u) {
        let h = o.getAttribute('id');
        if (h) l = `#${h}`;
        else {
          let w = o.classNames().join('.');
          l = o.nodeName().toLowerCase() + (w ? `.${w}` : '');
        }
        u.textContent = l;
      }
      if (
        (this.#a.postMessage({ type: 'node-changed', sessionId: this.#e, nodeDescription: l }),
        this.#e)
      ) {
        ...
        p.InspectorFrontendHost.InspectorFrontendHostInstance.sendMessageToBackend(h);
      }
    }
    #y() {
      let o = [];
      if (this.#o) {
        let u = this.#o.querySelectorAll('.message');
        for (let l of u) {
          let h = l.classList.contains('user-message'),
            w = l.querySelector('.message-content')?.textContent || '';
          o.push({ text: w, isUser: h });
        }
      }
      return o;
    }
    #u(o) {
      return `Error: '${o}' - Protip: to use AI features you need to be signed in.`;
    }
    runConversation = async () => {
      if (!this.#n || !this.#t) return;
      let o = this.#n.value || this.#n.placeholder;
      if (((this.#n.value = ''), !this.#i)) {
        let l = new ve();
        ((this.#i = new V.StylingAgent.StylingAgent({ aidaClient: l })),
          (this.#s = new V.StylingAgent.NodeContext(this.#t)));
      }
      (this.#g(o, !0),
        this.#a.postMessage({
          type: 'new-message',
      ...
      try {
        if (!this.#s) throw new Error('Node context not found.');
        for await (let l of this.#i.run(o, { selected: this.#s })) {
          switch (l.type) {
            case 'answer':
              ((u.textContent = l.text),
                this.#a.postMessage({
          ...
          this.#o && (this.#o.scrollTop = this.#o.scrollHeight);
        }
      } catch (l) {
        u.textContent = `Exception: ${l instanceof Error ? l.message : String(l)}`;
      }
    };
    #g(o, u) {
      let l = document.createElement('div');
      l.className = `message ${u ? 'user-message' : 'ai-message'}`;
      let h = document.createElement('div');
      return (
        (h.className = 'message-content'),
        (h.textContent = o),
        l.appendChild(h),
        this.#o && (this.#o.appendChild(l), (this.#o.scrollTop = this.#o.scrollHeight)),
        h
      );
    }
  },
...
function L(i, o) {
  try {
    E.Runtime.experiments.register(i, o);
  } catch (u) {
    console.error('Unable to register experiment ', i, o, u);
  }
}
async function Ee() {
  try {
    E.Runtime.Runtime.setPlatform(p.Platform.platform());
    let [i, o] = await Promise.all([
      new Promise((g) => p.InspectorFrontendHost.InspectorFrontendHostInstance.getHostConfig(g)),
      new Promise((g) => p.InspectorFrontendHost.InspectorFrontendHostInstance.getPreferences(g)),
    ]);
    (Object.assign(E.Runtime.hostConfig, i),
      L(
        E.ExperimentNames.ExperimentName.CAPTURE_NODE_CREATION_STACKS,
        'Capture node creation stacks',
      ),
      L(
        E.ExperimentNames.ExperimentName.INSTRUMENTATION_BREAKPOINTS,
        'Enable instrumentation breakpoints',
      ),
      L(
        E.ExperimentNames.ExperimentName.USE_SOURCE_MAP_SCOPES,
        'Use scope information from source maps',
      ),
      L(E.ExperimentNames.ExperimentName.LIVE_HEAP_PROFILE, 'Live heap profile'),
      L(E.ExperimentNames.ExperimentName.PROTOCOL_MONITOR, 'Protocol Monitor'),
      L(
        E.ExperimentNames.ExperimentName.SAMPLING_HEAP_PROFILER_TIMELINE,
        'Sampling heap profiler timeline',
      ),
      L(E.ExperimentNames.ExperimentName.APCA, 'APCA'));
    let u = {
        register: (g) =>
          p.InspectorFrontendHost.InspectorFrontendHostInstance.registerPreference(g, {
            synced: !1,
          }),
        set: p.InspectorFrontendHost.InspectorFrontendHostInstance.setPreference,
        get: (g) =>
          new Promise((A) =>
            p.InspectorFrontendHost.InspectorFrontendHostInstance.getPreference(g, A),
          ),
        remove: p.InspectorFrontendHost.InspectorFrontendHostInstance.removePreference,
        clear: p.InspectorFrontendHost.InspectorFrontendHostInstance.clearPreferences,
      },
      l = new x.Settings.SettingsStorage(o, u, ''),
      h = new x.Settings.SettingsStorage(o, u, ''),
      w = new x.Settings.SettingsStorage(
        globalThis.localStorage,
        {
          register(g) {},
          async get(g) {
            return globalThis.localStorage.getItem(g);
          },
          set(g, A) {
            globalThis.localStorage.setItem(g, A);
          },
          remove(g) {
            globalThis.localStorage.removeItem(g);
          },
    ...
    (x.Settings.Settings.instance({
      ...
      globalStorage: h,
      localStorage: w,
      settingRegistrations: x.SettingRegistration.getRegisteredSettings(),
    }),
      G.UIUtils.initializeUIUtils(document),
      le.ThemeSupport.instance({
        forceNew: !0,
        setting: x.Settings.Settings.instance().moduleSetting('ui-theme'),
      }),
      G.ZoomManager.ZoomManager.instance({
        forceNew: !0,
        win: window,
        frontendHost: p.InspectorFrontendHost.InspectorFrontendHostInstance,
      }));
    let ce = x.Settings.Settings.instance().moduleSetting('language').get();
    F.DevToolsLocale.DevToolsLocale.instance({
      create: !0,
      data: {
        navigatorLanguage: navigator.language,
        settingLanguage: ce,
        lookupClosestDevToolsLocale: F.i18n.lookupClosestSupportedDevToolsLocale,
      },
    });
    let de = new re.Universe.Universe({
    ...
    (E.DevToolsContext.setGlobalInstance(de.context),
      await F.i18n.fetchAndRegisterLocaleData('en-US'),
      p.InspectorFrontendHost.InspectorFrontendHostInstance.connectionReady());
    let ue = globalThis.location.hash.substring(1),
      ge = new URLSearchParams(ue),
      U = parseInt(ge.get('backendNodeId') || '0', 10),
      N = j.instance({ forceNew: null, document });
    if (U)
      await f.Connections.initMainConnection(
        async () => {
          let g = f.TargetManager.TargetManager.instance();
          g.createTarget('main', 'Main', f.Target.Type.FRAME, null);
          let A = await new Promise((Y) => {
            let Q = g.primaryPageTarget();
            if (Q) {
              Y(Q);
              return;
            }
            let ee = {
              targetAdded: (te) => {
                te === g.primaryPageTarget() && (g.unobserveTargets(ee), Y(te));
              },
              targetRemoved: () => {},
            };
            g.observeTargets(ee);
          ...
          if (!A) return;
          let I = A.model(f.DOMModel.DOMModel);
          if (!I) return;
          let b = A.model(f.OverlayModel.OverlayModel);
          b && b.addEventListener('InspectedElementWindowRestored', N.handleRestoreEvent, N);
          let $ = (await I.pushNodesByBackendIdsToFrontend(new Set([U])))?.get(U) || null;
          $ && N.setNode($);
        },
        () => {},
      );
      ...
      let g = f.TargetManager.TargetManager.instance(),
        A = {
          targetAdded: (I) => {
            if (I.type() === f.Target.Type.FRAME) {
              let b = I.model(f.OverlayModel.OverlayModel);
              b &&
                (b.addEventListener('InspectedElementWindowRestored', N.handleRestoreEvent, N),
                b.addEventListener('InspectPanelShowRequested', N.handlePanelRequest));
            }
          },
          targetRemoved: (I) => {
            if (I.type() === f.Target.Type.FRAME) {
              let b = I.model(f.OverlayModel.OverlayModel);
              b &&
                (b.removeEventListener('InspectedElementWindowRestored', N.handleRestoreEvent, N),
                b.removeEventListener('InspectPanelShowRequested', N.handlePanelRequest));
            }
          },
        };
      g.observeTargets(A);
    ...
    console.error('[GreenDev] FATAL ERROR during init():', i);
  }
}
Ee();
