    ...
    html`
      ...
      <div class="global-ai-button-container">
        <button
          ...
          @click=${input.onClick}
          title=${strings.title}
          jslog=${VisualLogging.action().track({ click: true }).context('global-ai-button')}
        >
...
export class GlobalAiButton extends UI.Widget.Widget {
  ...
  #addHoverEventListeners() {
    UI.InspectorView.InspectorView.instance()
      ...
      .addEventListener('mouseenter', this.#handleMainToolbarMouseEnter);
    UI.InspectorView.InspectorView.instance()
      .tabbedPane.headerElement()
      .addEventListener('mouseleave', this.#handleMainToolbarMouseLeave);
  }
  #removeHoverEventListeners() {
    UI.InspectorView.InspectorView.instance()
      .tabbedPane.headerElement()
      .removeEventListener('mouseenter', this.#handleMainToolbarMouseEnter);
    UI.InspectorView.InspectorView.instance()
      .tabbedPane.headerElement()
      .removeEventListener('mouseleave', this.#handleMainToolbarMouseLeave);
  }
  ...
  #onClick() {
    ...
    const isVerticalDrawerFeatureEnabled = Boolean(
