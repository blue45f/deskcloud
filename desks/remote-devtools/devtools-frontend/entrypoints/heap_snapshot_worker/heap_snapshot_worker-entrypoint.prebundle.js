...
const dispatcher = new HeapSnapshotWorker.HeapSnapshotWorkerDispatcher.HeapSnapshotWorkerDispatcher(
  Platform.HostRuntime.HOST_RUNTIME.workerScope.postMessage.bind(
    Platform.HostRuntime.HOST_RUNTIME.workerScope,
  ),
);
Platform.HostRuntime.HOST_RUNTIME.workerScope.onmessage =
