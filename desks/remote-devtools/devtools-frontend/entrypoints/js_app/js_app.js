...
var g = {
  ...
  j = D.i18n.registerUIStrings('panels/js_timeline/js_timeline-meta.ts', g),
  w = D.i18n.getLazilyComputedLocalizedString.bind(void 0, j),
  R;
async function N() {
  return (R || (R = await import('./../../panels/timeline/timeline.js')), R);
}
function E(e) {
  return R === void 0 ? [] : e(R);
}
u.ViewManager.registerViewExtension({
  location: 'panel',
  id: 'timeline',
  title: w(g.performance),
  commandPrompt: w(g.showPerformance),
  order: 66,
  hasToolbar: !1,
  isPreviewFeature: !0,
  async loadView(e) {
    let T = await N(),
      C = e.context.get(M.PageResourceLoader.PageResourceLoader);
    return T.TimelinePanel.TimelinePanel.instance({ forceNew: !0, resourceLoader: C });
  },
});
u.ActionRegistration.registerActionExtension({
  ...
  title: w(g.showRecentTimelineSessions),
  contextTypes() {
    return E((e) => [e.TimelinePanel.TimelinePanel]);
  },
  bindings: [
...
u.ActionRegistration.registerActionExtension({
  ...
  options: [
    { value: !0, title: w(g.record) },
    { value: !1, title: w(g.stop) },
  ],
  bindings: [
...
var r = {
  ...
  Y = b.i18n.registerUIStrings('panels/mobile_throttling/mobile_throttling-meta.ts', r),
  a = b.i18n.getLazilyComputedLocalizedString.bind(void 0, Y),
  P;
async function y() {
  return (P || (P = await import('./../../panels/mobile_throttling/mobile_throttling.js')), P);
}
d.ViewManager.registerViewExtension({
  location: 'settings-view',
  id: 'throttling-conditions',
  title: a(r.throttling),
  commandPrompt: a(r.showThrottling),
  order: 35,
  async loadView() {
    let e = await y();
...
d.ActionRegistration.registerActionExtension({
  ...
  tags: [a(r.device), a(r.throttlingTag)],
});
d.ActionRegistration.registerActionExtension({
  actionId: 'network-conditions.network-low-end-mobile',
  category: 'NETWORK',
  title: a(r.enableSlowGThrottling),
  async loadActionDelegate() {
    let e = await y();
    return new e.ThrottlingManager.ActionDelegate();
  },
...
d.ActionRegistration.registerActionExtension({
  ...
  category: 'NETWORK',
  title: a(r.enableFastGThrottling),
  async loadActionDelegate() {
    let e = await y();
    return new e.ThrottlingManager.ActionDelegate();
  },
...
import * as W from './../../core/root/root.js';
import * as l from './../../core/sdk/sdk.js';
import * as V from './../../models/workspace/workspace.js';
import * as K from './../../panels/common/common.js';
import * as i from './../../ui/legacy/legacy.js';
import * as m from './../../panels/network/forward/forward.js';
var t = {
  ...
  F = c.i18n.registerUIStrings('panels/network/network-meta.ts', t),
  o = c.i18n.getLazilyComputedLocalizedString.bind(void 0, F),
  v = c.i18n.getLocalizedString.bind(void 0, F),
  h,
  J = W.Runtime.Runtime.isNode();
async function n() {
  return (h || (h = await import('./../../panels/network/network.js')), h);
}
function p(e) {
  return h === void 0 ? [] : e(h);
}
i.ViewManager.registerViewExtension({
  ...
  isPreviewFeature: J,
  async loadView() {
    return (await n()).NetworkPanel.NetworkPanel.instance();
  },
});
i.ViewManager.registerViewExtension({
  location: 'drawer-view',
  id: 'network.blocked-urls',
  commandPrompt: () => v(t.showRequestConditions),
  title: () => v(t.networkRequestConditions),
...
i.ViewManager.registerViewExtension({
  ...
  tags: [
    ...
    c.i18n.lockedLazyString('useragent'),
    c.i18n.lockedLazyString('user agent'),
    c.i18n.lockedLazyString('user-agent'),
  ],
  async loadView() {
    return (await n()).NetworkConfigView.NetworkConfigView.instance();
  },
});
i.ViewManager.registerViewExtension({
  ...
  async loadView() {
    return (await n()).NetworkPanel.SearchNetworkView.instance();
  },
});
i.ActionRegistration.registerActionExtension({
  ...
  toggleWithRedColor: !0,
  contextTypes() {
    return p((e) => [e.NetworkPanel.NetworkPanel]);
  },
  async loadActionDelegate() {
    let e = await n();
...
i.ActionRegistration.registerActionExtension({
  ...
  category: 'NETWORK',
  title: () => v(t.addNetworkRequestBlockingOrThrottlingPattern),
  iconClass: 'plus',
  contextTypes() {
    return p((e) => [e.RequestConditionsDrawer.RequestConditionsDrawer]);
  },
  async loadActionDelegate() {
    let e = await n();
...
i.ActionRegistration.registerActionExtension({
  ...
  category: 'NETWORK',
  title: () => v(t.removeAllNetworkRequestBlockingOrThrottlingPatterns),
  iconClass: 'clear',
  contextTypes() {
    return p((e) => [e.RequestConditionsDrawer.RequestConditionsDrawer]);
  },
...
s.Settings.registerSettingExtension({
  ...
  settingType: 'boolean',
  defaultValue: !1,
  tags: [c.i18n.lockedLazyString('HAR')],
  options: [
...
i.ContextMenu.registerProvider({
  contextTypes() {
    return [
      l.NetworkRequest.NetworkRequest,
      l.Resource.Resource,
      V.UISourceCode.UISourceCode,
      l.TraceObject.RevealableNetworkRequest,
    ];
  },
  async loadProvider() {
    return (await n()).NetworkPanel.NetworkPanel.instance();
...
s.Revealer.registerRevealer({
  contextTypes() {
    return [l.NetworkRequest.NetworkRequest];
  },
  destination: s.Revealer.RevealerDestination.NETWORK_PANEL,
  async loadRevealer() {
    let e = await n();
...
s.Revealer.registerRevealer({
  contextTypes() {
    return [m.UIRequestLocation.UIRequestLocation];
  },
  async loadRevealer() {
    let e = await n();
...
s.Revealer.registerRevealer({
  contextTypes() {
    return [m.NetworkRequestId.NetworkRequestId];
  },
  destination: s.Revealer.RevealerDestination.NETWORK_PANEL,
  async loadRevealer() {
    let e = await n();
...
s.Revealer.registerRevealer({
  contextTypes() {
    return [m.UIFilter.UIRequestFilter, K.ExtensionServer.RevealableNetworkRequestFilter];
  },
  destination: s.Revealer.RevealerDestination.NETWORK_PANEL,
  async loadRevealer() {
    let e = await n();
...
s.Revealer.registerRevealer({
  contextTypes() {
    return [l.NetworkManager.AppliedNetworkConditions];
  },
  destination: s.Revealer.RevealerDestination.NETWORK_PANEL,
  async loadRevealer() {
    let e = await n();
...
import * as H from './../../ui/legacy/components/utils/utils.js';
import * as U from './../../ui/legacy/legacy.js';
import * as B from './../main/main.js';
var f = { main: 'Main', networkTitle: 'Scripts', showNode: 'Show Scripts' },
  _ = A.i18n.registerUIStrings('entrypoints/js_app/js_app.ts', f),
  Q = A.i18n.getLocalizedString.bind(void 0, _),
  G = A.i18n.getLazilyComputedLocalizedString.bind(void 0, _),
  x,
  q;
async function X() {
  return (q || (q = await import('./../../panels/sources/sources.js')), q);
}
var I = class e {
  static instance(T = { forceNew: null }) {
    let { forceNew: C } = T;
    return ((!x || C) && (x = new e()), x);
  }
  async run() {
    (S.userMetrics.actionTaken(S.UserMetrics.Action.ConnectToNodeJSDirectly),
      k.Connections.initMainConnection(async () => {
        k.TargetManager.TargetManager.instance()
          .createTarget('main', Q(f.main), k.Target.Type.NODE, null)
          .runtimeAgent()
          .invoke_runIfWaitingForDebugger();
      }, H.TargetDetachedDialog.TargetDetachedDialog.connectionLost));
  }
};
U.ViewManager.registerViewExtension({
  location: 'navigator-view',
  id: 'navigator-network',
  title: G(f.networkTitle),
  commandPrompt: G(f.showNode),
  order: 2,
  persistence: 'permanent',
  async loadView() {
    return (await X()).SourcesNavigator.NetworkNavigatorView.instance();
  },
});
z.Runnable.registerEarlyInitializationRunnable(I.instance);
new B.MainImpl.MainImpl();
export { I as JsMainImpl };
