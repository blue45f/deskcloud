...
const FRAME = {
  ...
  crossOriginIsolatedContextType:
    'Isolated' /* Protocol.Page.CrossOriginIsolatedContextType.Isolated */,
  gatedAPIFeatures: [],
};
const MAIN_FRAME = {
  ...FRAME,
...
export async function addChildFrame(target, framePayload) {
  ...
  getMainFrame(target);
  const childFrame = resourceTreeModel.frameAttached(
    `CHILD_FRAME_${++childFrameId}`,
    MAIN_FRAME_ID,
  );
