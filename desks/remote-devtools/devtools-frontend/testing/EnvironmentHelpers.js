...
describeWithEnvironment.only = function (
  title,
  fn,
  opts = {
    reset: true,
...
describeWithEnvironment.skip = function (
  title,
  fn,
  _opts = {
    reset: true,
...
export function createFakeSetting(name, defaultValue) {
  ...
  return new Common.Settings.Setting(
    name,
    defaultValue,
...
export function createFakeRegExpSetting(name, defaultValue) {
  const storage = new Common.Settings.SettingsStorage({}, undefined, 'test');
  return new Common.Settings.RegExpSetting(
    name,
    defaultValue,
    new Common.ObjectWrapper.ObjectWrapper(),
    storage,
