...
export class ConsoleSidebar extends Common.ObjectWrapper.eventMixin(UI.Widget.VBox) {
  ...
  #groups = [
    ...
    new ConsoleFilterGroup(
      'user message' /* GroupName.CONSOLE_API */,
      CONSOLE_API_PARSED_FILTERS,
      ConsoleFilter.allLevelsFilterValue(),
    ),
    new ConsoleFilterGroup(
      'error' /* GroupName.ERROR */,
      [],
      ConsoleFilter.singleLevelMask('error' /* Protocol.Log.LogEntryLevel.Error */),
    ),
    new ConsoleFilterGroup(
      'warning' /* GroupName.WARNING */,
      [],
      ConsoleFilter.singleLevelMask('warning' /* Protocol.Log.LogEntryLevel.Warning */),
    ),
    new ConsoleFilterGroup(
      'info' /* GroupName.INFO */,
      [],
      ConsoleFilter.singleLevelMask('info' /* Protocol.Log.LogEntryLevel.Info */),
    ),
    new ConsoleFilterGroup(
      'verbose' /* GroupName.VERBOSE */,
      [],
      ConsoleFilter.singleLevelMask('verbose' /* Protocol.Log.LogEntryLevel.Verbose */),
    ),
  ];
  #selectedFilterSetting = Common.Settings.Settings.instance().createSetting(
    'console.sidebar-selected-filter',
    null,
  );
  #selectedFilter = this.#groups.find((group) => group.name === this.#selectedFilterSetting.get())
    ?.filter;
