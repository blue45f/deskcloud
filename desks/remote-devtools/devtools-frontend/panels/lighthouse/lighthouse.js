...
var O = (a, e) => {
  for (var t in e) ft(a, t, { get: e[t], enumerable: !0 });
};
(function (a, e) {
  typeof define == 'function' && define.amd
    ...
    : typeof module == 'object' && module.exports
      ...
      : ((a.Lighthouse = a.Lighthouse || {}),
        (a.Lighthouse.ReportGenerator = e()),
        (a.Lighthouse.ReportGenerator.ReportGenerator = a.Lighthouse.ReportGenerator));
  ...
  var a = (() => {
    var e = Object.defineProperty,
      ...
      i = (L, l) => {
        for (var g in l) e(L, g, { get: l[g], enumerable: !0 });
      },
      o = (L, l, g, _) => {
        if ((l && typeof l == 'object') || typeof l == 'function')
          for (let k of n(l))
            !r.call(L, k) &&
              k !== g &&
              e(L, k, { get: () => l[k], enumerable: !(_ = t(l, k)) || _.enumerable });
        return L;
      },
      d = (L) => o(e({}, '__esModule', { value: !0 }), L),
      p = {};
    i(p, { ReportGenerator: () => J });
    var f = {},
      u = `<!--
@license
...
`,
  ...
  return a.ReportGenerator ?? a;
});
var Ue = {};
O(Ue, {
  Events: () => M,
  LighthouseController: () => Z,
  getPresets: () => V,
  getRuntimeSettings: () => A,
});
import * as v from './../../core/common/common.js';
import * as P from './../../core/host/host.js';
import * as de from './../../core/i18n/i18n.js';
import * as y from './../../core/sdk/sdk.js';
import * as B from './../../models/emulation/emulation.js';
import * as Ie from './../emulation/emulation.js';
var s = {
    canOnlyAuditHttphttpsPages:
    ...
    doesThisPageFollowBestPractices:
    ...
    navigationTooltip:
      'Navigation mode analyzes a page load, exactly like the original Lighthouse reports.',
    timespan: 'Timespan',
    timespanTooltip:
      'Timespan mode analyzes an arbitrary period of time, typically containing user interactions.',
    snapshot: 'Snapshot',
    snapshotTooltip:
      'Snapshot mode analyzes the page in a particular state, typically after user interactions.',
    mobile: 'Mobile',
    desktop: 'Desktop',
  ...
  De = de.i18n.registerUIStrings('panels/lighthouse/LighthouseController.ts', s),
  H = de.i18n.getLocalizedString.bind(void 0, De),
  h = de.i18n.getLazilyComputedLocalizedString.bind(void 0, De),
  _e = class {
    controller;
    inspectedURL;
    categoryIDs;
    ...
    constructor(e, t, n, r, i, o) {
      ((this.controller = e),
        (this.protocolService = t),
        (this.inspectedURL = n),
        (this.categoryIDs = r),
        (this.flags = i),
        (this.isAIControlled = o),
        (this.#e = !1));
    }
    isRunning() {
      return this.#e;
    ...
    async start() {
      ...
      try {
        (await this.setupEmulationAndProtocolConnection(),
          this.flags.mode === 'timespan' &&
            (await this.protocolService.startTimespan({
              inspectedURL: this.inspectedURL,
              categoryIDs: this.categoryIDs,
              flags: this.flags,
            })));
      } catch (e) {
        throw (await this.cancel(), e);
      }
    }
    async collect() {
      try {
        let e = await this.protocolService.collectLighthouseResults({
          inspectedURL: this.inspectedURL,
          categoryIDs: this.categoryIDs,
          flags: this.flags,
        });
        if (!e) throw new Error('No Lighthouse response');
        if (e.fatal) {
    ...
    async cancel() {
      return (
        this.#t || ((this.#e = !1), (this.#t = this.restoreEmulationAndProtocolConnection())),
        await this.#t
      );
    }
    async setupEmulationAndProtocolConnection() {
      let e = B.DeviceModeModel.DeviceModeModel.instance();
      if (
        ((this.emulationStateBefore = {
          emulation: {
            type: e.type(),
            enabled: e.enabledSetting().get(),
            outlineEnabled: e.deviceOutlineSetting().get(),
            toolbarControlsEnabled: e.toolbarControlsEnabledSetting().get(),
            scale: e.scaleSetting().get(),
            device: e.device(),
            mode: e.mode(),
          },
          network: {
            conditions: y.NetworkManager.MultitargetNetworkManager.instance().networkConditions(),
          },
        }),
        e.toolbarControlsEnabledSetting().set(!1),
        'formFactor' in this.flags && this.flags.formFactor === 'desktop')
      )
        (e.enabledSetting().set(!1), e.emulate(B.DeviceModeModel.Type.None, null, null));
      else if (this.flags.formFactor === 'mobile') {
        (e.enabledSetting().set(!0), e.deviceOutlineSetting().set(!0));
        for (let t of B.EmulatedDevices.EmulatedDevicesList.instance().standard())
          t.title === 'Moto G Power' && e.emulate(B.DeviceModeModel.Type.Device, t, t.modes[0], 1);
      }
      await this.protocolService.attach();
    }
    async restoreEmulationAndProtocolConnection() {
      if ((await this.protocolService.detach(), this.emulationStateBefore)) {
        let r = B.DeviceModeModel.DeviceModeModel.instance();
        r.emulate(B.DeviceModeModel.Type.None, null, null);
        let {
          type: i,
          enabled: o,
          outlineEnabled: d,
          toolbarControlsEnabled: p,
          scale: f,
          device: u,
          mode: U,
        } = this.emulationStateBefore.emulation;
        (r.enabledSetting().set(o),
          r.deviceOutlineSetting().set(d),
          r.toolbarControlsEnabledSetting().set(p),
          i === B.DeviceModeModel.Type.Responsive && r.scaleSetting().set(f),
          r.emulate(i, u, U, f),
          y.NetworkManager.MultitargetNetworkManager.instance().setNetworkConditions(
            this.emulationStateBefore.network.conditions,
          ),
          delete this.emulationStateBefore);
      }
      Ie.InspectedPagePlaceholder.InspectedPagePlaceholder.instance().update(!0);
      let e = y.TargetManager.TargetManager.instance().primaryPageTarget();
      if (!e) return;
      let t = e.model(y.ResourceTreeModel.ResourceTreeModel);
      if (!t) return;
      if (this.flags.mode === 'navigation') {
        let r = await this.controller.getInspectedURL();
        await t.navigate(r);
      }
    }
  },
  Z = class extends v.ObjectWrapper.ObjectWrapper {
    protocolService;
    manager;
    ...
    constructor(e) {
      (super(),
        (this.protocolService = e),
        e.registerStatusCallback((n) =>
          this.dispatchEventToListeners(M.AuditProgressChanged, { message: n }),
        ));
      for (let n of V()) n.setting.addChangeListener(this.recomputePageAuditability.bind(this));
      for (let n of A()) n.setting.addChangeListener(this.recomputePageAuditability.bind(this));
      (v.Settings.Settings.instance()
        .moduleSetting('java-script-disabled')
        .addChangeListener(this.recomputePageAuditability.bind(this)),
        y.TargetManager.TargetManager.instance().observeModels(
          y.ServiceWorkerManager.ServiceWorkerManager,
          this,
        ),
        y.TargetManager.TargetManager.instance().addEventListener(
          'InspectedURLChanged',
    ...
    modelAdded(e) {
      e.target() === y.TargetManager.TargetManager.instance().primaryPageTarget() &&
        ((this.manager = e),
    ...
    modelRemoved(e) {
      this.manager === e &&
        (this.serviceWorkerListeners &&
          v.EventTarget.removeEventListeners(this.serviceWorkerListeners),
        (this.manager = null),
        this.recomputePageAuditability());
    }
    hasActiveServiceWorker() {
      if (!this.manager) return !1;
      let e = this.manager.target();
      if (!e) return !1;
      let n = v.ParsedURL.ParsedURL.fromString(e.inspectedURL())?.securityOrigin();
      for (let r of this.manager.registrations().values())
        if (r.securityOrigin === n) {
          for (let i of r.versions.values()) if (i.controlledClients.length > 1) return !0;
        }
      return !1;
    }
    hasAtLeastOneCategory() {
      return V().some((e) => e.setting.get());
    }
    unauditablePageMessage() {
      if (!this.manager || this.getFlags().mode !== 'navigation') return null;
      let t = this.manager.target()?.inspectedURL();
      if (!t?.startsWith('http')) return H(s.canOnlyAuditHttphttpsPages);
      try {
        if (new URL(t).pathname.endsWith('.pdf')) return H(s.canOnlyAuditHttphttpsPages);
      } catch {
        return H(s.canOnlyAuditHttphttpsPages);
      }
      return null;
    }
    javaScriptDisabled() {
      return v.Settings.Settings.instance().moduleSetting('java-script-disabled').get();
    }
    async hasImportantResourcesNotCleared() {
      let e = A().find((o) => o.setting.name === 'lighthouse.clear-storage');
      if ((e && !e.setting.get()) || !this.manager) return '';
      let t = this.manager.target(),
        n = t.inspectedURL();
      if (!n) return '';
      let r = await t.storageAgent().invoke_getUsageAndQuota({ origin: n });
      if (r.getError()) return '';
      let i = r.usageBreakdown
        .filter((o) => o.usage)
        .map((o) => vt.get(o.storageType))
        .map((o) => (o ? o() : void 0))
        .filter(Boolean);
      return i.length === 1
        ? H(s.thereMayBeStoredDataAffectingSingular, { PH1: String(i[0]) })
        : i.length > 1
          ? H(s.thereMayBeStoredDataAffectingLoadingPlural, { PH1: i.join(', ') })
          : '';
    }
    async evaluateInspectedURL() {
      let e = y.TargetManager.TargetManager.instance().primaryPageTarget();
      if (!e) throw new Error('Unable to find main target required for Lighthouse');
      let t = e.inspectedURL(),
        n = e.model(y.ResourceTreeModel.ResourceTreeModel),
        r = n && (await n.navigationHistory());
      if (!n || !r) return t;
      let { currentIndex: i, entries: o } = r;
      return o[i].url;
    }
    getCurrentRun() {
    ...
    getFlags() {
      let e = {};
      for (let t of A()) t.setFlags(e, t.setting.get());
      return e;
    }
    getCategoryIDs() {
      let { mode: e } = this.getFlags(),
        t = [];
      for (let n of V())
        (e && !n.supportedModes.includes(e)) || (n.setting.get() && t.push(n.configID));
      return t;
    }
    async getInspectedURL(e) {
      return (
        (e?.force || !this.inspectedURL) && (this.inspectedURL = await this.evaluateInspectedURL()),
        this.inspectedURL
      );
    }
    recomputePageAuditability() {
      let e = this.hasActiveServiceWorker(),
        t = this.hasAtLeastOneCategory(),
        n = this.unauditablePageMessage(),
        r = this.javaScriptDisabled(),
        i = '';
      (e
        ? (i = H(s.multipleTabsAreBeingControlledBy))
        : t
          ? n
            ? (i = n)
            : r && (i = H(s.javaScriptDisabled))
          : (i = H(s.atLeastOneCategoryMustBeSelected)),
        this.dispatchEventToListeners(M.PageAuditabilityChanged, { helpText: i }),
        this.hasImportantResourcesNotCleared().then((o) => {
          (this.getFlags().mode !== 'navigation' && (o = ''),
            this.dispatchEventToListeners(M.PageWarningsChanged, { warning: o }));
        }));
    }
    recordMetrics(e, t) {
      P.userMetrics.actionTaken(P.UserMetrics.Action.LighthouseStarted);
      for (let n of V())
        t.includes(n.configID) && P.userMetrics.lighthouseCategoryUsed(n.userMetric);
      switch (e.mode) {
        case 'navigation':
          P.userMetrics.lighthouseModeRun(0);
          break;
        case 'timespan':
          P.userMetrics.lighthouseModeRun(1);
          break;
        case 'snapshot':
          P.userMetrics.lighthouseModeRun(2);
          break;
      }
    }
    async startLighthouse(e) {
      return (
        this.lastAction && (await this.lastAction),
        (this.lastAction = new Promise(async (t) => {
          this.currentLighthouseRun &&
            (await this.currentLighthouseRun.cancel(), (this.currentLighthouseRun = void 0));
          let n = await this.getInspectedURL({ force: !0 }),
            r = e?.categoryIds ?? this.getCategoryIDs(),
            i = this.getFlags();
          (e?.mode && (i.mode = e.mode),
            this.recordMetrics(i, r),
            (this.currentLighthouseRun = new _e(
              this,
    ...
    async collectLighthouseResults() {
      if (!this.currentLighthouseRun) throw new Error('Lighthouse is not started');
      let e = await this.currentLighthouseRun.collect();
      return (
        P.userMetrics.actionTaken(P.UserMetrics.Action.LighthouseFinished),
    ...
    async cancelLighthouse() {
      return (
        this.lastAction && (await this.lastAction),
        (this.lastAction = new Promise(async (e) => {
          (this.currentLighthouseRun &&
            (await this.currentLighthouseRun.cancel(), (this.currentLighthouseRun = void 0)),
            e());
        })),
  ...
  vt = new Map([
    ['local_storage', h(s.localStorage)],
    ['indexeddb', h(s.indexeddb)],
    ['websql', h(s.webSql)],
  ]),
  we = null;
function V() {
  return (
    we ||
      (we = [
        {
          setting: v.Settings.Settings.instance().createSetting(
            'lighthouse.cat-perf',
            !0,
            'Synced',
          ),
          configID: 'performance',
          title: h(s.performance),
          description: h(s.howLongDoesThisAppTakeToShow),
        ...
        },
        {
          ...
          title: h(s.accessibility),
          description: h(s.isThisPageUsableByPeopleWith),
        ...
        },
        {
          ...
          title: h(s.bestPractices),
          description: h(s.doesThisPageFollowBestPractices),
          supportedModes: ['navigation', 'timespan', 'snapshot'],
          userMetric: 2,
        },
        {
          setting: v.Settings.Settings.instance().createSetting('lighthouse.cat-seo', !0, 'Synced'),
          configID: 'seo',
          title: h(s.seo),
          description: h(s.isThisPageOptimizedForSearch),
          supportedModes: ['navigation', 'snapshot'],
          userMetric: 3,
        },
      ]),
      ...
      (ye = [
        {
          ...
          title: h(s.applyMobileEmulation),
          description: h(s.applyMobileEmulationDuring),
          setFlags: (a, e) => {
            a.formFactor = e;
          },
          options: [
            { label: h(s.mobile), tooltip: h(s.applyMobileEmulationDuring), value: 'mobile' },
            { label: h(s.desktop), tooltip: h(s.applyDesktopEmulationDuring), value: 'desktop' },
          ],
        },
        {
          setting: v.Settings.Settings.instance().createSetting(
          ...
          title: h(s.lighthouseMode),
          description: h(s.runLighthouseInMode),
          setFlags: (a, e) => {
            a.mode = e;
          },
          options: [
            { label: h(s.navigation), tooltip: h(s.navigationTooltip), value: 'navigation' },
            { label: h(s.timespan), tooltip: h(s.timespanTooltip), value: 'timespan' },
            { label: h(s.snapshot), tooltip: h(s.snapshotTooltip), value: 'snapshot' },
          ],
        ...
        },
        {
          ...
          title: h(s.throttlingMethod),
          learnMore:
            'https://github.com/GoogleChrome/lighthouse/blob/master/docs/throttling.md#devtools-lighthouse-panel-throttling',
          description: h(s.simulateASlowerPageLoadBasedOn),
          setFlags: (a, e) => {
            typeof e == 'string'
              ? (a.throttlingMethod = e)
              : (a.throttlingMethod = e ? 'simulate' : 'devtools');
          },
          options: [
            { label: h(s.simulatedThrottling), value: 'simulate' },
            { label: h(s.devtoolsThrottling), value: 'devtools' },
          ],
        },
        {
          setting: v.Settings.Settings.instance().createSetting(
          ...
          title: h(s.clearStorage),
          description: h(s.resetStorageLocalstorage),
          setFlags: (a, e) => {
            a.disableStorageReset = !e;
          },
        },
        {
          setting: v.Settings.Settings.instance().createSetting(
          ...
          title: h(s.enableSampling),
          description: h(s.enableJavaScriptSampling),
          setFlags: (a, e) => {
            e
              ? (a.additionalTraceCategories = 'disabled-by-default-v8.cpu_profiler')
              : (a.additionalTraceCategories = '');
          },
        },
      ]),
    ye
...
var M;
(function (a) {
  ((a.PageAuditabilityChanged = 'PageAuditabilityChanged'),
    (a.PageWarningsChanged = 'PageWarningsChanged'),
    (a.AuditProgressChanged = 'AuditProgressChanged'));
})(M || (M = {}));
var mt = {};
O(mt, { ActiveLighthouseReport: () => G, LighthousePanel: () => Re });
...
var Fe = `.lh-root{--report-menu-width:0;user-select:text}.lh-audit-group{position:relative}button.view-trace{margin:10px}.lh-tools--viewer{display:none!important}.lighthouse-settings-pane{flex:none;background-color:var(--sys-color-cdt-base-container);border-bottom:1px solid var(--sys-color-divider)}.lighthouse-settings-pane devtools-toolbar{flex:1 1;flex-wrap:wrap}select.lighthouse-report{min-width:140px;max-width:min(180px,calc(100% - 30px))}.lighthouse-toolbar-container{display:flex;flex:none}.lighthouse-toolbar-container > devtools-toolbar{background-color:var(--sys-color-cdt-base-container);border-bottom:1px solid var(--sys-color-divider)}.lighthouse-toolbar-container > :first-child{flex:1 1 auto}.lh-devtools .lh-element-screenshot__overlay{position:absolute}.lighthouse-results-container{position:relative;:focus-visible{outline:-webkit-focus-ring-color auto 1px}.lh-tools__button{height:var(--sys-size-9);width:var(--sys-size-9);min-width:var(--sys-size-9);&:focus-visible{border-radius:var(--sys-shape-corner-full);outline:var(--sys-size-2) solid var(--sys-color-state-focus-ring)}&.lh-active + .lh-tools__dropdown{clip:rect(-8px,204px,270px,-10px)}}.lh-tools__dropdown{padding:var(--sys-size-5) 0;border-radius:var(--sys-shape-corner-small);box-shadow:var(--sys-elevation-level3);top:24px;&:hover a:focus{background-color:transparent}a{height:var(--sys-size-11);padding:0 var(--sys-size-8);white-space:nowrap;align-items:center;&::before{content:none}}}}
/*# sourceURL=${import.meta.resolve('./lighthousePanel.css')} */`;
var He = {};
O(He, { CancelledError: () => W, ProtocolService: () => Q });
...
var Oe = 1,
  ...
  Q = class {
    ...
    #e = new Map();
    async attach() {
      await E.TargetManager.TargetManager.instance().suspendAllTargets();
      let e = E.TargetManager.TargetManager.instance().primaryPageTarget();
      if (!e) throw new Error('Unable to find main target required for Lighthouse');
      let t = E.TargetManager.TargetManager.instance().rootTarget();
      if (!t) throw new Error('Could not find the root target');
      if (!e.model(E.ChildTargetManager.ChildTargetManager))
        throw new Error('Unable to find child target manager required for Lighthouse');
      let r = e.model(E.ResourceTreeModel.ResourceTreeModel);
      if (!r) throw new Error('Unable to find resource tree model required for Lighthouse');
      let i = t.model(E.ChildTargetManager.ChildTargetManager);
      if (!i) throw new Error('Could not find the child target manager class for the root target');
      let o = t.router()?.connection;
      if (!o) throw new Error('Expected root target to have a session router');
      let d = await i.getParentTargetId(),
        { sessionId: p } = await t
          .targetAgent()
          .invoke_attachToTarget({ targetId: d, flatten: !0 });
      ((this.connection = o), this.connection.observe(this));
      let f = () => {
        e.pageAgent().invoke_handleJavaScriptDialog({ accept: !0 });
      };
      (r.addEventListener(E.ResourceTreeModel.Events.JavaScriptDialogOpening, f),
        (this.removeDialogHandler = () =>
          r.removeEventListener(E.ResourceTreeModel.Events.JavaScriptDialogOpening, f)),
        (this.rootTargetId = d),
        (this.rootTarget = t),
        (this.mainSessionId = p));
    }
    getLocales() {
      return [Be.DevToolsLocale.DevToolsLocale.instance().locale];
    }
    async startTimespan(e) {
      let { inspectedURL: t, categoryIDs: n, flags: r } = e;
    ...
    async collectLighthouseResults(e) {
      let { inspectedURL: t, categoryIDs: n, flags: r } = e;
      if (!this.mainSessionId || !this.rootTargetId)
        throw new Error('Unable to get target info required for Lighthouse');
      let i = r.mode;
      return (
        i === 'timespan' && (i = 'endTimespan'),
        await this.sendWithResponse(i, {
          url: t,
          categoryIDs: n,
          flags: r,
          config: this.configForTesting,
    ...
    async detach() {
      for (let n of this.#e.values()) n(new W());
      this.#e.clear();
      let e = this.lighthouseWorkerPromise,
        t = this.rootTarget;
      ((this.lighthouseWorkerPromise = void 0),
        ...
        t &&
          this.mainSessionId &&
          (await t.targetAgent().invoke_detachFromTarget({ sessionId: this.mainSessionId })),
        await E.TargetManager.TargetManager.instance().resumeAllTargets(),
        this.removeDialogHandler?.());
    }
    registerStatusCallback(e) {
      this.lighthouseMessageUpdateCallback = e;
    }
    onEvent(e) {
      this.dispatchProtocolMessage(e);
    }
    dispatchProtocolMessage(e) {
      (e.sessionId || ('method' in e && e.method?.startsWith('Target'))) &&
        this.send('dispatchProtocolMessage', { message: e });
    }
    onDisconnect() {}
    initWorker() {
      return (
        (this.lighthouseWorkerPromise = new Promise((e) => {
          let t = new URL(
              '../../entrypoints/lighthouse_worker/lighthouse_worker.js',
              import.meta.url,
            ),
            n = new URL(globalThis.location.href).searchParams.get('remoteBase');
          n && t.searchParams.set('remoteBase', n);
          let r = new Worker(t, { type: 'module' });
          r.addEventListener('message', (i) => {
            if (i.data === 'workerReady') {
              e(r);
              return;
            }
            this.onWorkerMessage(i);
          });
        })),
        this.lighthouseWorkerPromise
      );
    }
    async ensureWorkerExists() {
      ...
      return (
        this.lighthouseWorkerPromise
          ? (e = await this.lighthouseWorkerPromise)
          : (e = await this.initWorker()),
        e
      );
    }
    onWorkerMessage(e) {
      let t = e.data;
      t.action === 'statusUpdate'
        ? this.lighthouseMessageUpdateCallback &&
          t.args &&
          'message' in t.args &&
          this.lighthouseMessageUpdateCallback(t.args.message)
        : t.action === 'sendProtocolMessage' &&
          t.args &&
          'message' in t.args &&
          this.sendProtocolMessage(t.args.message);
    }
    sendProtocolMessage(e) {
      let { id: t, method: n, params: r, sessionId: i } = JSON.parse(e);
      this.connection?.send(n, r, i).then((o) => {
        let d =
          'result' in o
            ? { id: t, sessionId: i, result: o.result }
            : { id: t, sessionId: i, error: o.error };
        this.dispatchProtocolMessage(d);
      });
    }
    async send(e, t = {}) {
      let n = await this.ensureWorkerExists(),
        r = Oe++;
      n.postMessage({ id: r, action: e, args: { ...t, id: r } });
    }
    async sendWithResponse(e, t = {}) {
      let n = await this.ensureWorkerExists(),
        r = Oe++,
        i = new Promise((o, d) => {
          let p = (f) => {
            let u = f.data;
            u.id === r && (n.removeEventListener('message', p), this.#e.delete(r), o(u.result));
          };
          (n.addEventListener('message', p),
            this.#e.set(r, (f) => {
              (n.removeEventListener('message', p), d(f));
            }));
        });
      return (n.postMessage({ id: r, action: e, args: { ...t, id: r } }), await i);
    }
  };
var je = {};
O(je, { LighthouseReportRenderer: () => ee });
...
import * as Ve from './../../models/text_utils/text_utils.js';
import * as xe from './../../models/workspace/workspace.js';
import * as $e from './../../third_party/lighthouse/report/report.js';
import * as Ge from './../../ui/legacy/components/utils/utils.js';
import * as Se from './../../ui/legacy/legacy.js';
import * as X from './../../ui/legacy/theme_support/theme_support.js';
import { html as bt, nothing as wt, render as yt } from './../../ui/lit/lit.js';
import * as ge from './../../ui/visual_logging/visual_logging.js';
import * as We from './../common/common.js';
var _t = 40,
  ee = class a {
    static renderLighthouseReport(e, t, n) {
      let r;
      t &&
        (r = async () => {
          pe.userMetrics.actionTaken(pe.UserMetrics.Action.LighthouseViewTrace);
          let u = new I.TraceObject.TraceObject(t.Trace.traceEvents);
          j.Revealer.reveal(u);
        });
      async function i(u) {
        let b = new j.ParsedURL.ParsedURL(e.finalUrl || e.finalDisplayedUrl)
            .domain()
            .replace(/[^a-z0-9.-]+/gi, '_'),
          J = Ne.DateUtilities.toISO8601Compact(new Date(e.fetchTime)),
          L = u.type.match('json') ? '.json' : '.html',
          l = `${b}-${J}${L}`,
          g = await u.arrayBuffer().then(j.Base64.encode);
        (await xe.FileManager.FileManager.instance().save(
          l,
          new Ve.ContentData.ContentData(g, !0, u.type),
          !0,
        ),
          xe.FileManager.FileManager.instance().close(l));
      }
      async function o(u) {
        let U = u.cloneNode(!0),
          b = globalThis.open('', '_blank', 'channelmode=1,status=1,resizable=1');
        b &&
          (b.document.body.replaceWith(U),
          await a.linkifyNodeDetails(U),
          n?.beforePrint?.(),
          b.focus(),
          b.print(),
          b.close(),
      ...
      function d() {
        return Lighthouse.ReportGenerator.ReportGenerator.generateReportHtml(e);
      }
      let p = $e.renderReport(e, {
        disableDarkMode: !0,
        onViewTrace: r,
        onSaveFileOverride: i,
        onPrintOverride: o,
        getStandaloneReportHTML: d,
      });
      p.classList.add('lh-devtools');
      let f = () => {
        p.classList.toggle('lh-dark', X.ThemeSupport.instance().themeName() === 'dark');
      };
      return (
        X.ThemeSupport.instance().addEventListener(X.ThemeChangeEvent.eventName, f),
        f(),
        (p._lighthouseResultForTesting = e),
        (p._lighthouseArtifactsForTesting = t),
        a.installVisualLogging(p),
        a.waitForMainTargetLoad().then(() => {
          (a.linkifyNodeDetails(p), a.linkifySourceLocationDetails(p));
        }),
        p
      );
    }
    static async waitForMainTargetLoad() {
      let e = I.TargetManager.TargetManager.instance().primaryPageTarget();
      if (!e) return;
      let t = e.model(I.ResourceTreeModel.ResourceTreeModel);
      t && (await t.once(I.ResourceTreeModel.Events.Load));
    }
    static async linkifyNodeDetails(e) {
      let t = I.TargetManager.TargetManager.instance().primaryPageTarget();
      if (!t) return;
      let n = t.model(I.DOMModel.DOMModel);
      if (n)
        for (let r of e.getElementsByClassName('lh-node')) {
          let i = r,
            o = i.dataset;
          if (!o.path) continue;
          let d = await n.pushNodeByPathToFrontend(o.path);
          if (!d) continue;
          let p = n.nodeForId(d);
          if (!p) continue;
          let f = We.DOMLinkifier.Linkifier.instance().linkify(p, {
            tooltip: o.snippet,
            preventKeyboardFocus: void 0,
          });
          Se.Tooltip.Tooltip.install(i, '');
          let u = i.querySelector('.lh-element-screenshot');
          ((i.textContent = ''), yt(bt`${u ?? wt}${f}`, i));
        }
    }
    static async linkifySourceLocationDetails(e) {
      for (let t of e.getElementsByClassName('lh-source-location')) {
        let n = t,
          r = n.dataset;
        if (!r.sourceUrl || !r.sourceLine || !r.sourceColumn) continue;
        let i = r.sourceUrl,
          o = Number(r.sourceLine),
          d = Number(r.sourceColumn),
          p = Ge.Linkifier.Linkifier.linkifyURL(i, {
            lineNumber: o,
            columnNumber: d,
            showColumnNumber: !1,
            inlineFrameIndex: 0,
        ...
        (Se.Tooltip.Tooltip.install(n, ''), (n.textContent = ''), n.appendChild(p));
      }
    }
    static installVisualLogging(e) {
      for (let t of e.getElementsByClassName('lh-audit')) {
        let n = t.querySelector('summary');
        if (!n) continue;
        let r = t.id;
        if (!r) continue;
        t.setAttribute('jslog', `${ge.item(`lighthouse.audit.${r}`).track({ resize: !0 })}`);
        let i;
        ...
        i &&
          n.setAttribute(
            'jslog',
            `${ge.expand(`lighthouse.audit-summary.${i}`).track({ click: !0 })}`,
          );
      }
    }
  };
var Ye = {};
O(Ye, { Item: () => ne, ReportSelector: () => te });
import * as Ke from './../../core/common/common.js';
import * as Ee from './../../core/i18n/i18n.js';
import * as Je from './../../ui/legacy/legacy.js';
var ke = { reports: 'Reports', newReport: '(new report)' },
  xt = Ee.i18n.registerUIStrings('panels/lighthouse/LighthouseReportSelector.ts', ke),
  qe = Ee.i18n.getLocalizedString.bind(void 0, xt),
  te = class {
    ...
    itemByOptionElement;
    constructor(e) {
      ((this.renderNewLighthouseView = e),
        (this.newLighthouseItem = document.createElement('option')),
        (this.#e = new Je.Toolbar.ToolbarComboBox(
    ...
    setEmptyState() {
      (this.#e.removeOptions(),
        this.#e.setEnabled(!1),
        (this.newLighthouseItem = document.createElement('option')),
        (this.newLighthouseItem.label = qe(ke.newReport)),
        this.#e.addOption(this.newLighthouseItem),
        this.#e.select(this.newLighthouseItem));
    }
    handleChange(e) {
      let t = this.selectedItem();
      t ? t.select() : this.renderNewLighthouseView();
    }
    selectedItem() {
      let e = this.#e.selectedOption();
    ...
    prepend(e) {
      let t = e.optionElement(),
        n = this.#e.element;
      (this.itemByOptionElement.set(t, e),
    ...
    clearAll() {
      for (let e of this.#e.options())
        e !== this.newLighthouseItem &&
          (this.itemByOptionElement.get(e)?.delete(), this.itemByOptionElement.delete(e));
      this.setEmptyState();
    }
    selectNewReport() {
      this.#e.select(this.newLighthouseItem);
  ...
  ne = class {
    ...
    element;
    constructor(e, t, n) {
      ((this.renderReport = t), (this.showLandingCallback = n));
      let r = e.finalDisplayedUrl || e.finalUrl || '',
        i = new Ke.ParsedURL.ParsedURL(r),
        o = e.fetchTime;
      ((this.element = document.createElement('option')),
        (this.element.label = `${new Date(o).toLocaleTimeString()} - ${i.domain()}`));
    }
    select() {
      this.renderReport();
    }
    ...
    delete() {
      (this.element && this.element.remove(), this.showLandingCallback());
    }
  };
var nt = {};
O(nt, { StartView: () => oe });
  ...
  re = class {
    ...
    constructor(e, t, n) {
      ((this.setting = t),
        ...
        Le.ARIAUtils.setDescription(this.element, n),
        Le.ARIAUtils.markAsRadioGroup(this.element),
        (this.radioElements = []),
        St(
          Qe`
        ${this.options.map((r) => {
      ...
      `,
        ...
        t.addChangeListener(this.settingChanged, this),
        this.settingChanged());
    }
    updateUI() {
      ((this.ignoreChangeEvents = !0),
        this.radioElements[this.selectedIndex] &&
          (this.radioElements[this.selectedIndex].checked = !0),
        (this.ignoreChangeEvents = !1));
    }
    settingChanged() {
      let e = this.setting.get();
      ((this.selectedIndex = this.options.findIndex((t) => t.value === e)), this.updateUI());
    }
    valueChanged(e) {
      if (this.ignoreChangeEvents) return;
      let t = this.radioElements.find((n) => n.checked);
      t && this.setting.set(t.value);
    }
  };
var R = {
  ...
  Lt = Te.i18n.registerUIStrings('panels/lighthouse/LighthouseStartView.ts', R),
  D = Te.i18n.getLocalizedString.bind(void 0, Lt),
  Ct = (a, e, t) => {
    Et(
      kt`
  ...
  oe = class extends z.Widget.Widget {
    controller;
    panel;
    #e;
    startButton;
    ...
    constructor(e, t) {
      (super({ useShadowDom: !0 }),
        ...
        (this.controller = e),
        (this.panel = t),
        (this.#e = document.createElement('devtools-toolbar')),
        this.#e.classList.add('lighthouse-settings-toolbar'),
        this.render());
    }
    populateRuntimeSettingAsRadio(e, t, n) {
      let r = A().find((d) => d.setting.name === e);
      if (!r?.options) throw new Error(`${e} is not a setting with options`);
      let i = document.createElement('div');
      if ((i.classList.add('lighthouse-form-section-label'), (i.textContent = t), r.learnMore)) {
        let d = Ce.create(r.learnMore, D(R.learnMore), 'lighthouse-learn-more', 'learn-more');
        i.append(d);
      }
      n.appendChild(i);
      let o = new re(r.options, r.setting, r.description());
      (n.appendChild(o.element), z.ARIAUtils.setLabel(o.element, t));
    }
    populateRuntimeSettingAsToolbarCheckbox(e, t) {
      let n = A().find((i) => i.setting.name === e);
      if (!n?.title) throw new Error(`${e} is not a setting with a title`);
      n.setting.setTitle(n.title());
      let r = new z.Toolbar.ToolbarSettingCheckbox(n.setting, n.description());
      if ((t.appendToolbarItem(r), n.learnMore)) {
        let i = Ce.create(n.learnMore, D(R.learnMore), 'lighthouse-learn-more', 'learn-more');
        ((i.style.margin = '5px'), r.element.appendChild(i));
      }
    }
    populateRuntimeSettingAsToolbarDropdown(e, t) {
      let n = A().find((o) => o.setting.name === e);
      if (!n?.title) throw new Error(`${e} is not a setting with a title`);
      let r = n.options?.map((o) => ({ label: o.label(), value: o.value })) || [];
      n.setting.setTitle(n.title());
      let i = new z.Toolbar.ToolbarSettingComboBox(r, n.setting, n.title());
      if ((i.setTitle(n.description()), t.appendToolbarItem(i), n.learnMore)) {
        let o = Ce.create(n.learnMore, D(R.learnMore), 'lighthouse-learn-more', 'learn-more');
        ((o.style.marginLeft = '5px'),
          (o.style.display = 'inline-flex'),
          (o.style.height = 'revert'),
          t.appendToolbarItem(new z.Toolbar.ToolbarItem(o)));
      }
    }
    populateFormControls(e, t, n) {
      (this.populateRuntimeSettingAsRadio('lighthouse.device-type', D(R.device), e),
        (this.checkboxes = []));
      for (let r of V()) {
        r.setting.setTitle(r.title());
        let i = new z.Toolbar.ToolbarSettingCheckbox(r.setting, r.description());
        (t.createChild('div', 'vbox lighthouse-launcher-row').appendChild(i.element),
          i.element.setAttribute('data-lh-category', r.configID),
          this.checkboxes.push({ preset: r, checkbox: i }),
          n && !r.supportedModes.includes(n) && (i.setEnabled(!1), i.setIndeterminate(!0)));
      }
    }
    render() {
      (this.populateRuntimeSettingAsToolbarCheckbox('lighthouse.clear-storage', this.#e),
        this.populateRuntimeSettingAsToolbarCheckbox('lighthouse.enable-sampling', this.#e),
        this.populateRuntimeSettingAsToolbarDropdown('lighthouse.throttling', this.#e));
      let { mode: e } = this.controller.getFlags(),
        t = {
          helpText: void 0,
          warningText: void 0,
      ...
      (Ct({}, t, this.contentElement),
        (this.helpText = t.helpText),
        (this.warningText = t.warningText));
      let n = t.modeFormElements,
        r = t.deviceTypeFormElements,
        i = t.categoriesFormElements;
      if (!n || !r || !i) throw new Error('Required elements not found in template');
      (this.populateRuntimeSettingAsRadio('lighthouse.mode', D(R.mode), n),
        this.populateFormControls(r, i, e),
        this.refresh());
    }
    populateStartButton(e) {
      let t, n;
      e === 'timespan'
        ? ((t = D(R.startTimespan)),
          (n = () => {
            this.panel.handleTimespanStart();
          }))
        : e === 'snapshot'
          ? ((t = D(R.analyzeSnapshot)),
            (n = () => {
              this.panel.handleCompleteRun();
            }))
          : ((t = D(R.analyzeNavigation)),
            (n = () => {
              this.panel.handleCompleteRun();
            }));
      let r = this.contentElement.querySelector('.lighthouse-start-button-container');
      r &&
        ((r.textContent = ''),
        (this.startButton = z.UIUtils.createTextButton(t, n, {
          variant: 'primary',
          jslogContext: 'lighthouse.start',
        })),
        r.append(this.startButton));
    }
    refresh() {
      let { mode: e } = this.controller.getFlags();
      this.populateStartButton(e);
      for (let { checkbox: t, preset: n } of this.checkboxes)
        n.supportedModes.includes(e)
          ? (t.setEnabled(!0), t.setIndeterminate(!1))
          : (t.setEnabled(!1), t.setIndeterminate(!0));
      this.onResize();
    }
    onResize() {
      let e = this.contentElement.offsetWidth < 500,
        t = this.contentElement.offsetWidth > 800,
        n = this.contentElement.querySelector('.lighthouse-start-view header'),
        r = this.contentElement.querySelector('.lighthouse-options');
      (n && (n.classList.toggle('hbox', !e), n.classList.toggle('vbox', e)),
        r && (r.classList.toggle('wide', t), r.classList.toggle('narrow', e)));
    }
    focusStartButton() {
      this.startButton.focus();
    }
    setStartButtonEnabled(e) {
      (this.helpText && this.helpText.classList.toggle('hidden', e),
        this.startButton && (this.startButton.disabled = !e));
    }
    setUnauditableExplanation(e) {
      this.helpText && (this.helpText.textContent = e);
    }
    setWarningText(e) {
      this.warningText &&
        ((this.warningText.textContent = e), this.warningText.classList.toggle('hidden', !e));
    }
    wasShown() {
      (super.wasShown(), this.controller.recomputePageAuditability());
    }
    settingsToolbar() {
      return this.#e;
    }
...
var { html: me } = se,
  c = {
    ...
    lighthouseIsGatheringInformation:
    ...
    lighthouseIsLoadingYourPageWithMobile:
  ...
  at = ve.i18n.registerUIStrings('panels/lighthouse/LighthouseStatusView.ts', c),
  S = ve.i18n.getLocalizedString.bind(void 0, at),
  m = ve.i18n.getLazilyComputedLocalizedString.bind(void 0, at),
  st = (a, e, t) => {
    let {
        statusHeader: n,
        statusText: r,
        ...
        progressBarValue: o,
        progressBarTotal: d,
        cancelButtonVisible: p,
        onCancel: f,
        bugReport: u,
      } = a,
      U = (b, J) => {
        let L = navigator.userAgent.match(/Chrome\/(\S+)/) || ['', 'Unknown'],
          g = `
${b.friendlyMessage || b.message}
\`\`\`
Channel: DevTools
Initial URL: ${J}
Chrome Version: ${L[1]}
...
`;
        return me`
      <p>${S(c.ifThisIssueIsReproduciblePlease)}</p>
      <code class="monospace">${g.trim()}</code>
    `;
      };
    se.render(
      me`
    <div class="lighthouse-view vbox">
      ...
      <div class="lighthouse-status vbox">
        <div class="lighthouse-progress-wrapper">
          <div
            class="lighthouse-progress-bar ${i}"
            role="progressbar"
            aria-valuemin="0"
            aria-valuemax=${d}
            aria-valuenow=${o}
        ...
        <div class="lighthouse-status-text" role="status">
          ${
            u
              ? me`
            <p>${S(c.ahSorryWeRanIntoAnError)}</p>
            ${
              u.knownBugPattern
                ? me`
              <p>${S(c.tryToNavigateToTheUrlInAFresh)}</p>
            `
                : U(u.error, u.auditURL)
            }
          `
              : r
          }
      ...
      <div class="lighthouse-action-buttons">
        <devtools-button
          ...
          @click=${f}
          style=${se.Directives.styleMap({ visibility: p ? 'visible' : 'hidden' })}
        >${S(c.cancel)}</devtools-button>
      </div>
    </div>
  `,
      t,
  ...
  ae = class {
    ...
    constructor(e) {
      ((this.panel = e),
        ...
        (this.fastFactsQueued = rt.map((t) => t())),
        (this.currentPhase = null),
        (this.scheduledFastFactTimeout = null),
        (this.dialog = new be.Dialog.Dialog()),
        this.dialog.setDimmed(!0),
        this.dialog.setCloseOnEscape(!1),
        this.dialog.setOutsideClickCallback((t) => t.consume(!0)),
        (this.statusHeader = ''),
        (this.statusText = ''),
        (this.progressBarClass = ''),
        (this.progressBarValue = 0),
        (this.cancelButtonVisible = !0),
        (this.isAIControlled = !1),
        (this.bugReport = null),
        this.render());
    }
    render() {
      (this.dialogRoot ||
        ((this.dialogRoot = be.UIUtils.createShadowRootWithCoreStyles(this.dialog.contentElement, {
          cssFile: ue,
        })),
        this.dialog.setSizeBehavior('SetExactWidthMaxHeight'),
        this.dialog.setMaxContentSize(new ot.Size(500, 400))),
        st(
          {
    ...
    reset() {
      (this.resetProgressBarClasses(),
        ...
        (this.textChangedAt = 0),
        (this.fastFactsQueued = rt.map((e) => e())),
        (this.currentPhase = null),
        (this.scheduledFastFactTimeout = null),
        (this.bugReport = null),
        (this.statusText = ''),
    ...
    show(e) {
      (this.reset(), this.updateStatus(S(c.loading)));
      let t = this.getStatusHeader();
      (this.renderStatusHeader(t), this.dialog.show(e), this.render());
    }
    getStatusHeader() {
      let t = it.ParsedURL.ParsedURL.fromString(this.inspectedURL)?.host;
      return this.isAIControlled
        ? t
          ? S(c.aiAuditingS, { PH1: t })
          : S(c.aiAuditingYourWebPage)
        : t
          ? S(c.auditingS, { PH1: t })
          : S(c.auditingYourWebPage);
    }
    renderStatusHeader(e) {
      ((this.statusHeader = `${e}\u2026`), this.render());
    }
    hide() {
      this.dialog.isShowing() && this.dialog.hide();
    }
    setAIControlled(e) {
      this.isAIControlled = e;
    }
    setInspectedURL(e = '') {
      this.inspectedURL = e;
    }
    updateStatus(e) {
      ...
      if (e.startsWith('Cancel')) {
        (this.commitTextChange(S(c.cancelling)), clearTimeout(this.scheduledFastFactTimeout));
        return;
      }
      let t = this.getPhaseForMessage(e);
      if (!t && !this.currentPhase)
        (this.commitTextChange(S(c.lighthouseIsWarmingUp)),
          clearTimeout(this.scheduledFastFactTimeout));
      else if (t) {
        this.currentPhase = t;
        let n = this.getMessageForPhase(t);
        (this.commitTextChange(n),
          this.scheduleFastFactCheck(),
          this.resetProgressBarClasses(),
          (this.progressBarClass = t.progressBarClass),
          (this.progressBarValue = fe.indexOf(t)),
          this.render());
      }
    }
    cancel() {
      this.panel.handleRunCancel();
    }
    getMessageForPhase(e) {
      if (e.message()) return e.message();
      let t = A().find((d) => d.setting.name === 'lighthouse.device-type'),
        n = A().find((d) => d.setting.name === 'lighthouse.throttling'),
        r = t ? t.setting.get() : '',
        i = n ? n.setting.get() : '',
        o = Mt.find((d) => d.deviceType === r && d.throttling === i);
      return o ? o.message() : S(c.lighthouseIsLoadingYourPage);
    }
    getPhaseForMessage(e) {
      return fe.find((t) => t.statusMessageRegex.test(e)) || null;
    }
    resetProgressBarClasses() {
      ((this.progressBarClass = ''), this.render());
    }
    ...
    updateFastFactIfNecessary() {
      if (performance.now() - this.textChangedAt < lt || !this.fastFactsQueued.length) return;
      let t = Math.floor(Math.random() * this.fastFactsQueued.length);
      (this.commitTextChange(S(c.fastFactMessageWithPlaceholder, { PH1: this.fastFactsQueued[t] })),
        this.fastFactsQueued.splice(t, 1));
    }
    commitTextChange(e) {
      ((this.textChangedAt = performance.now()), (this.statusText = e), this.render());
    }
    renderBugReport(e) {
      (console.error(e),
        this.scheduledFastFactTimeout && globalThis.clearTimeout(this.scheduledFastFactTimeout),
        this.resetProgressBarClasses(),
        ...
        (this.bugReport = {
          ...
          knownBugPattern: At.some((t) => t.test(e.message)),
        }),
        this.render());
    }
    renderText(e, t) {
      ((this.statusHeader = `${e}\u2026`), this.commitTextChange(t));
    }
    toggleCancelButton(e) {
      ((this.cancelButtonVisible = e), this.render());
    }
  },
  lt = 6e3,
  Tt = 3e3,
  ...
  fe = [
    {
      ...
      message: m(c.lighthouseIsLoadingThePage),
      statusMessageRegex: /^(Navigating to)/,
    },
    {
      id: 'gathering',
      progressBarClass: 'gathering',
      message: m(c.lighthouseIsGatheringInformation),
      statusMessageRegex: /(Gather|artifact)/i,
    },
    {
      id: 'auditing',
      progressBarClass: 'auditing',
      message: m(c.almostThereLighthouseIsNow),
      statusMessageRegex: /^Audit/,
    },
  ],
  Mt = [
    { deviceType: 'mobile', throttling: 'on', message: m(c.lighthouseIsLoadingYourPageWith) },
    {
      deviceType: 'desktop',
      throttling: 'on',
      message: m(c.lighthouseIsLoadingYourPageWithThrottling),
    },
    {
      deviceType: 'mobile',
      throttling: 'off',
      message: m(c.lighthouseIsLoadingYourPageWithMobile),
    },
    { deviceType: 'desktop', throttling: 'off', message: m(c.lighthouseIsLoadingThePage) },
  ],
  rt = [
    m(c.mbTakesAMinimumOfSecondsTo),
    m(c.rebuildingPinterestPagesFor),
    m(c.byReducingTheResponseSizeOfJson),
    m(c.walmartSawAIncreaseInRevenueFor),
    m(c.ifASiteTakesSecondToBecome),
    m(c.OfGlobalMobileUsersInWereOnGOrG),
    m(c.theAverageUserDeviceCostsLess),
    m(c.SecondsIsTheAverageTimeAMobile),
    m(c.OfMobilePagesTakeNearlySeconds),
    m(c.asPageLoadTimeIncreasesFromOne),
    m(c.asTheNumberOfElementsOnAPage),
    m(c.OfMobilePagesTakeNearlySeconds),
    m(c.lighthouseOnlySimulatesMobile),
  ];
var pt = {};
O(pt, { TimespanView: () => ce });
import * as Ae from './../../core/i18n/i18n.js';
import * as dt from './../../models/geometry/geometry.js';
import './../../ui/components/buttons/buttons.js';
import * as K from './../../ui/legacy/legacy.js';
import { Directives as ht, html as Rt, render as zt } from './../../ui/lit/lit.js';
var q = {
  ...
  Pt = Ae.i18n.registerUIStrings('panels/lighthouse/LighthouseTimespanView.ts', q),
  le = Ae.i18n.getLocalizedString.bind(void 0, Pt),
  It = (a, e, t) => {
    zt(
      Rt`
      <div class="lighthouse-view vbox">
  ...
  ce = class extends K.Dialog.Dialog {
    panel;
    statusHeader;
    contentContainer;
    endButton;
    constructor(e) {
      (super(),
        ...
        (this.endButton = null),
        this.setDimmed(!0),
        this.setCloseOnEscape(!1),
        this.setOutsideClickCallback((t) => t.consume(!0)),
        this.render());
    }
    show(e) {
      (this.reset(), super.show(e));
    }
    reset() {
      this.statusHeader &&
        this.contentContainer &&
        this.endButton &&
        ((this.statusHeader.textContent = le(q.timespanStarting)),
        (this.contentContainer.textContent = ''),
        (this.endButton.disabled = !0));
    }
    ready() {
      this.statusHeader &&
        this.contentContainer &&
        this.endButton &&
        ((this.statusHeader.textContent = le(q.timespanStarted)),
        (this.contentContainer.textContent = le(q.interactWithPage)),
        (this.endButton.disabled = !1),
        this.endButton.focus());
    }
    render() {
      let e = K.UIUtils.createShadowRootWithCoreStyles(this.contentElement, { cssFile: ue });
      this.endButton = K.UIUtils.createTextButton(le(q.endTimespan), this.endTimespan.bind(this), {
        variant: 'primary',
        jslogContext: 'lighthouse.end-time-span',
        className: 'end-timespan',
      });
      let t = K.UIUtils.createTextButton(le(q.cancel), this.cancel.bind(this), {
          className: 'cancel',
          jslogContext: 'lighthouse.cancel',
        }),
        n = { statusHeader: void 0, contentContainer: void 0 };
      (It({ cancelButton: t, endButton: this.endButton }, n, e),
        (this.statusHeader = n.statusHeader ?? null),
        (this.contentContainer = n.contentContainer ?? null),
        this.setSizeBehavior('SetExactWidthMaxHeight'),
        this.setMaxContentSize(new dt.Size(500, 400)),
        this.reset());
    }
    async endTimespan() {
...
var N = {
  ...
  Dt = ze.i18n.registerUIStrings('panels/lighthouse/LighthousePanel.ts', N),
  $ = ze.i18n.getLocalizedString.bind(void 0, Dt),
  Me,
  G = class {
    report;
    constructor(e) {
  ...
  Re = class a extends w.Panel.Panel {
    controller;
    startView;
    statusView;
    timespanView;
    ...
    constructor(e) {
      (super('lighthouse'),
        this.registerRequiredCSS(Fe),
        (this.controller = e),
        (this.startView = new oe(this.controller, this)),
        (this.timespanView = new ce(this)),
        (this.statusView = new ae(this)),
        (this.warningText = null),
        (this.unauditableExplanation = null),
        (this.cachedRenderedReports = new Map()),
        new w.DropTarget.DropTarget(
          this.contentElement,
          [w.DropTarget.Type.File],
          $(N.dropLighthouseJsonHere),
          this.handleDrop.bind(this),
        ),
        this.controller.addEventListener(
          M.PageAuditabilityChanged,
          this.refreshStartAuditUI.bind(this),
        ),
        this.controller.addEventListener(M.PageWarningsChanged, this.refreshWarningsUI.bind(this)),
        this.controller.addEventListener(M.AuditProgressChanged, this.refreshStatusUI.bind(this)),
        this.renderToolbar(),
        (this.auditResultsElement = this.contentElement.createChild(
          'div',
        ...
        w.Context.Context.instance().setFlavor(G, null));
    }
    static instance(e) {
      if (!Me || e?.forceNew) {
        let t = e?.protocolService ?? new Q(),
          n = e?.controller ?? new Z(t);
        Me = new a(n);
      }
      return Me;
    }
    ...
    async handleTimespanEnd() {
      try {
        (this.timespanView.hide(), this.renderStatusView());
        let { lhr: e, artifacts: t } = await this.controller.collectLighthouseResults();
        this.buildReportUI(e, t);
      } catch (e) {
        this.handleError(e);
      }
    }
    async handleCompleteRun(e) {
      try {
        (await this.controller.startLighthouse(e), this.renderStatusView());
        let { lhr: t, artifacts: n } = await this.controller.collectLighthouseResults();
        return (
          this.buildReportUI(t, n),
          w.Context.Context.instance().setFlavor(G, new G(t)),
          { report: t }
        );
      } catch (t) {
        return (
    ...
    async handleRunCancel() {
      (this.statusView.updateStatus($(N.cancelling)),
        this.timespanView.hide(),
        await this.controller.cancelLighthouse(),
        this.renderStartView());
    }
    handleError(e) {
      e instanceof W || (e instanceof Error && this.statusView.renderBugReport(e));
    }
    refreshWarningsUI(e) {
      this.controller.getCurrentRun() ||
        ((this.warningText = e.data.warning), this.startView.setWarningText(e.data.warning));
    }
    refreshStartAuditUI(e) {
      this.controller.getCurrentRun() ||
        (this.startView.refresh(),
        (this.unauditableExplanation = e.data.helpText),
        this.startView.setUnauditableExplanation(e.data.helpText),
        this.startView.setStartButtonEnabled(!e.data.helpText));
    }
    refreshStatusUI(e) {
      this.statusView.updateStatus(e.data.message);
    }
    refreshToolbarUI() {
      this.clearButton.setEnabled(this.reportSelector.hasItems());
    }
    clearAll() {
      (this.reportSelector.clearAll(), this.renderStartView(), this.refreshToolbarUI());
    }
    renderToolbar() {
      let e = this.element.createChild('div', 'lighthouse-toolbar-container');
      (e.setAttribute('jslog', `${ut.toolbar()}`), (e.role = 'toolbar'));
      let t = e.createChild('devtools-toolbar');
      ((t.role = 'presentation'),
        (this.newButton = new w.Toolbar.ToolbarButton($(N.performAnAudit), 'plus')),
        t.appendToolbarItem(this.newButton),
        this.newButton.addEventListener('Click', this.renderStartView.bind(this)),
        t.appendSeparator(),
        (this.reportSelector = new te(() => this.renderStartView())),
        t.appendToolbarItem(this.reportSelector.comboBox()),
        (this.clearButton = new w.Toolbar.ToolbarButton($(N.clearAll), 'clear')),
        t.appendToolbarItem(this.clearButton),
        this.clearButton.addEventListener('Click', this.clearAll.bind(this)),
        (this.settingsPane = new w.Widget.HBox()),
        ...
        (this.showSettingsPaneSetting = gt.Settings.Settings.instance().createSetting(
          'lighthouse-show-settings-toolbar',
          !1,
          'Synced',
        )),
        (this.rightToolbar = e.createChild('devtools-toolbar')),
        (this.rightToolbar.role = 'presentation'),
        this.rightToolbar.appendSeparator(),
        this.rightToolbar.appendToolbarItem(
          new w.Toolbar.ToolbarSettingToggle(
            this.showSettingsPaneSetting,
            'gear',
            $(N.lighthouseSettings),
            'gear-filled',
          ),
        ),
    ...
    toggleSettingsDisplay(e) {
      (this.rightToolbar.classList.toggle('hidden', !e),
        this.settingsPane.element.classList.toggle('hidden', !e),
        this.updateSettingsPaneVisibility());
    }
    renderStartView() {
      (this.auditResultsElement.removeChildren(),
        ...
        this.contentElement.classList.toggle('in-progress', !1),
        this.startView.show(this.contentElement),
        this.toggleSettingsDisplay(!0),
        ...
        this.unauditableExplanation || this.startView.focusStartButton(),
        this.startView.setWarningText(this.warningText),
        this.newButton.setEnabled(!1),
        this.refreshToolbarUI(),
        this.setDefaultFocusedChild(this.startView));
    }
    renderStatusView() {
      let e = this.controller.getCurrentRun();
      (this.contentElement.classList.toggle('in-progress', !0),
        this.statusView.setInspectedURL(e?.inspectedURL),
        this.statusView.setAIControlled(!!e?.isAIControlled),
        this.statusView.show(this.contentElement));
    }
    beforePrint() {
      (this.statusView.show(this.contentElement),
        this.statusView.toggleCancelButton(!1),
        this.statusView.renderText($(N.printing), $(N.thePrintPopupWindowIsOpenPlease)));
    }
    afterPrint() {
      (this.statusView.hide(), this.statusView.toggleCancelButton(!0));
    }
    renderReport(e, t) {
      (this.toggleSettingsDisplay(!1),
        this.contentElement.classList.toggle('in-progress', !1),
        this.startView.hideWidget(),
        this.statusView.hide(),
        this.auditResultsElement.removeChildren(),
        this.newButton.setEnabled(!0),
        this.refreshToolbarUI());
      let n = this.cachedRenderedReports.get(e);
      if (n) {
        this.auditResultsElement.appendChild(n);
        return;
      }
      let r = ee.renderLighthouseReport(e, t, {
        beforePrint: this.beforePrint.bind(this),
        afterPrint: this.afterPrint.bind(this),
      });
      this.cachedRenderedReports.set(e, r);
    }
    buildReportUI(e, t) {
      if (e === null) return;
      let n = new ne(e, () => this.renderReport(e, t), this.renderStartView.bind(this));
      (this.reportSelector.prepend(n),
        this.refreshToolbarUI(),
        this.renderReport(e),
    ...
    handleDrop(e) {
      ...
      if (t[0].kind === 'file') {
        ...
        ((i.onload = () => this.loadedFromFile(i.result)), i.readAsText(r));
      }
    }
    loadedFromFile(e) {
      let t = JSON.parse(e);
      t.lighthouseVersion && this.buildReportUI(t);
    }
    elementsToRestoreScrollPositionsFor() {
      let e = super.elementsToRestoreScrollPositionsFor(),
        t = this.auditResultsElement.querySelector('.lh-container');
      return (t && e.push(t), e);
    }
    onKeyDown(e) {
      e.key === 'Escape' &&
        this.auditResultsElement.querySelector('.lh-tools__button.lh-active') &&
        (e.handled = !0);
    }
    static async executeLighthouseRecording(e) {
      let t = a.instance();
      await w.ViewManager.ViewManager.instance().showView('lighthouse');
      let { report: n } = await t.handleCompleteRun(e);
      return n;
    }
  };
export {
  Ue as LighthouseController,
  mt as LighthousePanel,
  He as LighthouseProtocolService,
  je as LighthouseReportRenderer,
  Ye as LighthouseReportSelector,
  nt as LighthouseStartView,
  ct as LighthouseStatusView,
  pt as LighthouseTimespanView,
  tt as RadioSetting,
};
/**
 * @license
