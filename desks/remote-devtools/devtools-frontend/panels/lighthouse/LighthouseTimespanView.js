  ...
  render(
    html`
      <div class="lighthouse-view vbox">
        ...
        ></span>
        <div class="lighthouse-action-buttons hbox">${input.cancelButton} ${input.endButton}</div>
      </div>
    `,
    target,
  );
...
export class TimespanView extends UI.Dialog.Dialog {
  ...
  render() {
    const dialogRoot = UI.UIUtils.createShadowRootWithCoreStyles(this.contentElement, {
