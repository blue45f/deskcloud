...
export class WebAudioModel extends SDK.SDKModel.SDKModel {
  ...
  audioListenerCreated({ listener }) {
    this.dispatchEventToListeners(
      'AudioListenerCreated' /* Events.AUDIO_LISTENER_CREATED */,
      listener,
    );
  }
  audioListenerWillBeDestroyed({ listenerId, contextId }) {
    this.dispatchEventToListeners(
      'AudioListenerWillBeDestroyed' /* Events.AUDIO_LISTENER_WILL_BE_DESTROYED */,
      { listenerId, contextId },
    );
  }
  ...
  audioNodeWillBeDestroyed({ contextId, nodeId }) {
    this.dispatchEventToListeners(
      'AudioNodeWillBeDestroyed' /* Events.AUDIO_NODE_WILL_BE_DESTROYED */,
      { contextId, nodeId },
    );
  }
  ...
  audioParamWillBeDestroyed({ contextId, nodeId, paramId }) {
    this.dispatchEventToListeners(
      'AudioParamWillBeDestroyed' /* Events.AUDIO_PARAM_WILL_BE_DESTROYED */,
      { contextId, nodeId, paramId },
    );
  }
  nodesConnected({ contextId, sourceId, destinationId, sourceOutputIndex, destinationInputIndex }) {
    this.dispatchEventToListeners('NodesConnected' /* Events.NODES_CONNECTED */, {
      contextId,
      sourceId,
      destinationId,
      sourceOutputIndex,
  ...
  nodesDisconnected({
    ...
    this.dispatchEventToListeners('NodesDisconnected' /* Events.NODES_DISCONNECTED */, {
      contextId,
      sourceId,
      destinationId,
      sourceOutputIndex,
  ...
  nodeParamConnected({ contextId, sourceId, destinationId, sourceOutputIndex }) {
    this.dispatchEventToListeners('NodeParamConnected' /* Events.NODE_PARAM_CONNECTED */, {
      contextId,
      sourceId,
      destinationId,
      sourceOutputIndex,
  ...
  nodeParamDisconnected({ contextId, sourceId, destinationId, sourceOutputIndex }) {
    this.dispatchEventToListeners('NodeParamDisconnected' /* Events.NODE_PARAM_DISCONNECTED */, {
      contextId,
      sourceId,
      destinationId,
      sourceOutputIndex,
...
SDK.SDKModel.SDKModel.register(WebAudioModel, {
