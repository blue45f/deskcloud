...
export class DeviceModeWrapper extends UI.Widget.VBox {
  ...
  constructor(inspectedPagePlaceholder) {
    ...
    this.toggleDeviceModeAction = UI.ActionRegistry.ActionRegistry.instance().getAction(
    ...
    this.showDeviceModeSetting.setRequiresUserAction(
      Boolean(Root.Runtime.Runtime.queryParam('hasOtherClients')),
    );
    this.showDeviceModeSetting.addChangeListener(this.update.bind(this, false));
    SDK.TargetManager.TargetManager.instance().addModelListener(
      SDK.OverlayModel.OverlayModel,
      'ScreenshotRequested' /* SDK.OverlayModel.Events.SCREENSHOT_REQUESTED */,
    ...
    switch (actionId) {
      ...
      case 'emulation.capture-node-screenshot': {
        ...
        async function captureClip() {
          ...
          const { x: oopifOffsetX, y: oopifOffsetY } = await getOopifOffset(
