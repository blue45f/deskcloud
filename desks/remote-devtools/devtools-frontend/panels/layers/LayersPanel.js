...
export class LayersPanel extends UI.Panel.PanelWithSidebar {
  ...
  constructor() {
    ...
    this.layerTreeOutline.addEventListener(
      'PaintProfilerRequested' /* LayerViewer.LayerTreeOutline.Events.PAINT_PROFILER_REQUESTED */,
    ...
    this.rightSplitWidget = new UI.SplitWidget.SplitWidget(
      false,
      true,
    ...
    this.layers3DView.addEventListener(
      'PaintProfilerRequested' /* LayerViewer.Layers3DView.Events.PAINT_PROFILER_REQUESTED */,
      this.onPaintProfileRequested,
      this,
    );
    this.layers3DView.addEventListener(
      'ScaleChanged' /* LayerViewer.Layers3DView.Events.SCALE_CHANGED */,
      this.onScaleChanged,
      this,
    );
    ...
    this.layerDetailsView.addEventListener(
      'PaintProfilerRequested' /* LayerViewer.LayerDetailsView.Events.PAINT_PROFILER_REQUESTED */,
      this.onPaintProfileRequested,
      this,
    );
    this.tabbedPane.appendTab(
      DetailsViewTabs.Details,
      i18nString(UIStrings.details),
      this.layerDetailsView,
    );
