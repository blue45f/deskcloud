...
export class AiCodeGenerationUpgradeDialog {
  static show({ noLogging }) {
    ...
    // clang-format off
    Lit.render(
      html` <div class="ai-code-generation-upgrade-dialog">
        <style>
          ${styles}
        </style>
        <header>
          ...
          <h2 tabindex="-1">${lockedString(UIStringsNotTranslate.codeCompletionJustGotBetter)}</h2>
        </header>
        <main class="reminder-container">
          ...
          <div class="reminder-item">
            ...
            <span
              >${noLogging
                ? lockedString(UIStringsNotTranslate.disclaimerTextPrivacyNoLogging)
