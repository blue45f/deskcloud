...
function getTooltipDisclaimerText(noLogging, panel) {
  switch (panel) {
    case 'console' /* AiCodeCompletion.AiCodeCompletion.ContextFlavor.CONSOLE */:
      return noLogging
        ? lockedString(
            UIStringsNotTranslate.tooltipDisclaimerTextForAiCodeCompletionNoLoggingInConsole,
          )
    ...
    case 'sources' /* AiCodeCompletion.AiCodeCompletion.ContextFlavor.SOURCES */:
      return noLogging
        ? lockedString(
            UIStringsNotTranslate.tooltipDisclaimerTextForAiCodeCompletionNoLoggingInSources,
          )
    ...
    case 'styles' /* AiCodeCompletion.AiCodeCompletion.ContextFlavor.STYLES */:
      return noLogging
        ? lockedString(
            UIStringsNotTranslate.tooltipDisclaimerTextForAiCodeCompletionNoLoggingInStyles,
          )
    ...
    html`
      ...
      <div class="ai-code-completion-disclaimer">
        ...
        <span
          ...
          >${lockedString(UIStringsNotTranslate.relevantData)}</span
    ...
    if (loading) {
      if (!this.#loading) {
        ...
        UI.ARIAUtils.LiveAnnouncer.status(
          lockedString(UIStringsNotTranslate.dataIsBeingSentToGoogle),
        );
      }
