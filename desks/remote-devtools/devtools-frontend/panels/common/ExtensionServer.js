...
export class HostsPolicy {
  ...
  isAllowedOnURL(inspectedURL) {
    ...
    if (
      this.runtimeBlockedHosts.some((pattern) => pattern.matchesUrl(inspectedURL)) &&
...
export class ExtensionServer extends Common.ObjectWrapper.ObjectWrapper {
  ...
  constructor() {
    ...
    this.registerHandler(
      'addRequestHeaders' /* Extensions.ExtensionAPI.PrivateAPI.Commands.AddRequestHeaders */,
      this.onAddRequestHeaders.bind(this),
    );
    this.registerHandler(
      'createPanel' /* Extensions.ExtensionAPI.PrivateAPI.Commands.CreatePanel */,
      this.onCreatePanel.bind(this),
    );
    this.registerHandler(
      'createSidebarPane' /* Extensions.ExtensionAPI.PrivateAPI.Commands.CreateSidebarPane */,
      this.onCreateSidebarPane.bind(this),
    );
    this.registerHandler(
      'createToolbarButton' /* Extensions.ExtensionAPI.PrivateAPI.Commands.CreateToolbarButton */,
      this.onCreateToolbarButton.bind(this),
    );
    this.registerHandler(
      'evaluateOnInspectedPage' /* Extensions.ExtensionAPI.PrivateAPI.Commands.EvaluateOnInspectedPage */,
      this.onEvaluateOnInspectedPage.bind(this),
    );
    this.registerHandler(
      '_forwardKeyboardEvent' /* Extensions.ExtensionAPI.PrivateAPI.Commands.ForwardKeyboardEvent */,
      this.onForwardKeyboardEvent.bind(this),
    );
    this.registerHandler(
      'getHAR' /* Extensions.ExtensionAPI.PrivateAPI.Commands.GetHAR */,
      this.onGetHAR.bind(this),
    );
    this.registerHandler(
      'getPageResources' /* Extensions.ExtensionAPI.PrivateAPI.Commands.GetPageResources */,
      this.onGetPageResources.bind(this),
    );
    this.registerHandler(
      'getRequestContent' /* Extensions.ExtensionAPI.PrivateAPI.Commands.GetRequestContent */,
      this.onGetRequestContent.bind(this),
    );
    this.registerHandler(
      'getResourceContent' /* Extensions.ExtensionAPI.PrivateAPI.Commands.GetResourceContent */,
      this.onGetResourceContent.bind(this),
    );
    this.registerHandler(
      'Reload' /* Extensions.ExtensionAPI.PrivateAPI.Commands.Reload */,
      this.onReload.bind(this),
    );
    this.registerHandler(
      'setOpenResourceHandler' /* Extensions.ExtensionAPI.PrivateAPI.Commands.SetOpenResourceHandler */,
      this.onSetOpenResourceHandler.bind(this),
    );
    this.registerHandler(
      'setThemeChangeHandler' /* Extensions.ExtensionAPI.PrivateAPI.Commands.SetThemeChangeHandler */,
      this.onSetThemeChangeHandler.bind(this),
    );
    this.registerHandler(
      'setResourceContent' /* Extensions.ExtensionAPI.PrivateAPI.Commands.SetResourceContent */,
      this.onSetResourceContent.bind(this),
    );
    this.registerHandler(
      'attachSourceMapToResource' /* Extensions.ExtensionAPI.PrivateAPI.Commands.AttachSourceMapToResource */,
      this.onAttachSourceMapToResource.bind(this),
    );
    this.registerHandler(
      'setSidebarHeight' /* Extensions.ExtensionAPI.PrivateAPI.Commands.SetSidebarHeight */,
      this.onSetSidebarHeight.bind(this),
    );
    this.registerHandler(
      'setSidebarContent' /* Extensions.ExtensionAPI.PrivateAPI.Commands.SetSidebarContent */,
      this.onSetSidebarContent.bind(this),
    );
    this.registerHandler(
      'setSidebarPage' /* Extensions.ExtensionAPI.PrivateAPI.Commands.SetSidebarPage */,
      this.onSetSidebarPage.bind(this),
    );
    this.registerHandler(
      'showPanel' /* Extensions.ExtensionAPI.PrivateAPI.Commands.ShowPanel */,
      this.onShowPanel.bind(this),
    );
    this.registerHandler(
      'subscribe' /* Extensions.ExtensionAPI.PrivateAPI.Commands.Subscribe */,
      this.onSubscribe.bind(this),
    );
    this.registerHandler(
      'openResource' /* Extensions.ExtensionAPI.PrivateAPI.Commands.OpenResource */,
      this.onOpenResource.bind(this),
    );
    this.registerHandler(
      'unsubscribe' /* Extensions.ExtensionAPI.PrivateAPI.Commands.Unsubscribe */,
      this.onUnsubscribe.bind(this),
    );
    this.registerHandler(
      'updateButton' /* Extensions.ExtensionAPI.PrivateAPI.Commands.UpdateButton */,
      this.onUpdateButton.bind(this),
    );
    this.registerHandler(
      'registerLanguageExtensionPlugin' /* Extensions.ExtensionAPI.PrivateAPI.Commands.RegisterLanguageExtensionPlugin */,
      this.registerLanguageExtensionEndpoint.bind(this),
    );
    this.registerHandler(
      'getWasmLinearMemory' /* Extensions.ExtensionAPI.PrivateAPI.Commands.GetWasmLinearMemory */,
      this.onGetWasmLinearMemory.bind(this),
    );
    this.registerHandler(
      'getWasmGlobal' /* Extensions.ExtensionAPI.PrivateAPI.Commands.GetWasmGlobal */,
      this.onGetWasmGlobal.bind(this),
    );
    this.registerHandler(
      'getWasmLocal' /* Extensions.ExtensionAPI.PrivateAPI.Commands.GetWasmLocal */,
      this.onGetWasmLocal.bind(this),
    );
    this.registerHandler(
      'getWasmOp' /* Extensions.ExtensionAPI.PrivateAPI.Commands.GetWasmOp */,
      this.onGetWasmOp.bind(this),
    );
    this.registerHandler(
      'registerRecorderExtensionPlugin' /* Extensions.ExtensionAPI.PrivateAPI.Commands.RegisterRecorderExtensionPlugin */,
      this.registerRecorderExtensionEndpoint.bind(this),
    );
    this.registerHandler(
      'reportResourceLoad' /* Extensions.ExtensionAPI.PrivateAPI.Commands.ReportResourceLoad */,
      this.onReportResourceLoad.bind(this),
    );
    this.registerHandler(
      'setFunctionRangesForScript' /* Extensions.ExtensionAPI.PrivateAPI.Commands.SetFunctionRangesForScript */,
      this.onSetFunctionRangesForScript.bind(this),
    );
    this.registerHandler(
      'createRecorderView' /* Extensions.ExtensionAPI.PrivateAPI.Commands.CreateRecorderView */,
      this.onCreateRecorderView.bind(this),
    );
    this.registerHandler(
      'showRecorderView' /* Extensions.ExtensionAPI.PrivateAPI.Commands.ShowRecorderView */,
      this.onShowRecorderView.bind(this),
    );
    this.registerHandler(
      'showNetworkPanel' /* Extensions.ExtensionAPI.PrivateAPI.Commands.ShowNetworkPanel */,
  ...
  dispose() {
    ...
    SDK.TargetManager.TargetManager.instance().removeEventListener(
      'InspectedURLChanged' /* SDK.TargetManager.Events.INSPECTED_URL_CHANGED */,
  ...
  #onThemeChange = () => {
    ...
    for (const port of this.themeChangeHandlers.values()) {
      port.postMessage({
        command: 'host-theme-change' /* Extensions.ExtensionAPI.PrivateAPI.Events.ThemeChange */,
        themeName,
      });
    }
  };
  ...
  initializeExtensions() {
    ...
    if (this.inspectedTabId !== null) {
      Host.InspectorFrontendHost.InspectorFrontendHostInstance.setAddExtensionCallback(
  ...
  notifySearchAction(panelId, action, searchString) {
    this.postNotification(
      'panel-search-' /* Extensions.ExtensionAPI.PrivateAPI.Events.PanelSearch */ + panelId,
      [action, searchString],
    );
  }
  notifyViewShown(identifier, frameIndex) {
    this.postNotification(
      'view-shown-' /* Extensions.ExtensionAPI.PrivateAPI.Events.ViewShown */ + identifier,
      [frameIndex],
    );
  }
  notifyViewHidden(identifier) {
    this.postNotification(
      'view-hidden,' /* Extensions.ExtensionAPI.PrivateAPI.Events.ViewHidden */ + identifier,
      [],
    );
  }
  notifyButtonClicked(identifier) {
    this.postNotification(
      'button-clicked-' /* Extensions.ExtensionAPI.PrivateAPI.Events.ButtonClicked */ + identifier,
      [],
    );
  }
  profilingStarted() {
    this.postNotification(
      'profiling-started-' /* Extensions.ExtensionAPI.PrivateAPI.Events.ProfilingStarted */,
      [],
    );
  }
  profilingStopped() {
    this.postNotification(
      'profiling-stopped-' /* Extensions.ExtensionAPI.PrivateAPI.Events.ProfilingStopped */,
      [],
    );
  }
  registerLanguageExtensionEndpoint(message, _shared_port) {
    if (
      ...
      return this.status.E_BADARG(
        'command',
        `expected ${'registerLanguageExtensionPlugin' /* Extensions.ExtensionAPI.PrivateAPI.Commands.RegisterLanguageExtensionPlugin */}`,
      );
    }
    ...
    const {
      pluginName,
      port,
      supportedScriptTypes: { language, symbol_types },
    } = message;
    const symbol_types_array =
      Array.isArray(symbol_types) && symbol_types.every((e) => typeof e === 'string')
        ? symbol_types
        : [];
  ...
  async onGetWasmLinearMemory(message) {
    if (
      ...
      return this.status.E_BADARG(
        'command',
        `expected ${'getWasmLinearMemory' /* Extensions.ExtensionAPI.PrivateAPI.Commands.GetWasmLinearMemory */}`,
      );
    }
  ...
  async onGetWasmGlobal(message) {
    if (
      ...
      return this.status.E_BADARG(
        'command',
        `expected ${'getWasmGlobal' /* Extensions.ExtensionAPI.PrivateAPI.Commands.GetWasmGlobal */}`,
      );
    }
  ...
  async onGetWasmLocal(message) {
    if (
      ...
      return this.status.E_BADARG(
        'command',
        `expected ${'getWasmLocal' /* Extensions.ExtensionAPI.PrivateAPI.Commands.GetWasmLocal */}`,
      );
    }
  ...
  async onGetWasmOp(message) {
    if (
      message.command !== 'getWasmOp' /* Extensions.ExtensionAPI.PrivateAPI.Commands.GetWasmOp */
    ) {
      return this.status.E_BADARG(
        'command',
        `expected ${'getWasmOp' /* Extensions.ExtensionAPI.PrivateAPI.Commands.GetWasmOp */}`,
      );
    }
  ...
  registerRecorderExtensionEndpoint(message, _shared_port) {
    if (
      ...
      return this.status.E_BADARG(
        'command',
        `expected ${'registerRecorderExtensionPlugin' /* Extensions.ExtensionAPI.PrivateAPI.Commands.RegisterRecorderExtensionPlugin */}`,
      );
    }
  ...
  onReportResourceLoad(message) {
    if (
      ...
      return this.status.E_BADARG(
        'command',
        `expected ${'reportResourceLoad' /* Extensions.ExtensionAPI.PrivateAPI.Commands.ReportResourceLoad */}`,
      );
    }
    ...
    SDK.PageResourceLoader.PageResourceLoader.instance().resourceLoadedThroughExtension(
      pageResource,
    );
    return this.status.OK();
  }
  onSetFunctionRangesForScript(message, port) {
    if (
      ...
      return this.status.E_BADARG(
        'command',
        `expected ${'setFunctionRangesForScript' /* Extensions.ExtensionAPI.PrivateAPI.Commands.SetFunctionRangesForScript */}`,
      );
    }
    ...
    if (!uiSourceCode.contentType().isScript() || !uiSourceCode.contentType().isFromSourceMap()) {
      return this.status.E_BADARG(
        'command',
        `expected a source map script resource for url: ${scriptUrl}`,
      );
    }
    try {
  ...
  onShowRecorderView(message) {
    if (
      ...
      return this.status.E_BADARG(
        'command',
        `expected ${'showRecorderView' /* Extensions.ExtensionAPI.PrivateAPI.Commands.ShowRecorderView */}`,
      );
    }
  ...
  onShowNetworkPanel(message) {
    if (
      ...
      return this.status.E_BADARG(
        'command',
        `expected ${'showNetworkPanel' /* Extensions.ExtensionAPI.PrivateAPI.Commands.ShowNetworkPanel */}`,
      );
    }
  ...
  onCreateRecorderView(message, port) {
    if (
      ...
      return this.status.E_BADARG(
        'command',
        `expected ${'createRecorderView' /* Extensions.ExtensionAPI.PrivateAPI.Commands.CreateRecorderView */}`,
      );
    }
    const id = message.id;
    ...
    const pagePath = ExtensionServer.expandResourcePath(
      this.getExtensionOrigin(port),
      message.pagePath,
    );
  ...
  inspectedURLChanged(event) {
    ...
    this.postNotification(
      'inspected-url-changed' /* Extensions.ExtensionAPI.PrivateAPI.Events.InspectedURLChanged */,
      [url],
    );
  ...
  onSubscribe(message, port) {
    if (
      message.command !== 'subscribe' /* Extensions.ExtensionAPI.PrivateAPI.Commands.Subscribe */
    ) {
      return this.status.E_BADARG(
        'command',
        `expected ${'subscribe' /* Extensions.ExtensionAPI.PrivateAPI.Commands.Subscribe */}`,
      );
    }
  ...
  onUnsubscribe(message, port) {
    if (
      ...
      return this.status.E_BADARG(
        'command',
        `expected ${'unsubscribe' /* Extensions.ExtensionAPI.PrivateAPI.Commands.Unsubscribe */}`,
      );
    }
    const subscribers = this.subscribers.get(message.type);
    if (!subscribers) {
  ...
  onAddRequestHeaders(message) {
    if (
      ...
      return this.status.E_BADARG(
        'command',
        `expected ${'addRequestHeaders' /* Extensions.ExtensionAPI.PrivateAPI.Commands.AddRequestHeaders */}`,
      );
    }
  ...
  onCreatePanel(message, port) {
    if (
      ...
      return this.status.E_BADARG(
        'command',
        `expected ${'createPanel' /* Extensions.ExtensionAPI.PrivateAPI.Commands.CreatePanel */}`,
      );
    }
    const id = message.id;
    // The ids are generated on the client API side and must be unique, so the check below
  ...
  onShowPanel(message) {
    if (
      message.command !== 'showPanel' /* Extensions.ExtensionAPI.PrivateAPI.Commands.ShowPanel */
    ) {
      return this.status.E_BADARG(
        'command',
        `expected ${'showPanel' /* Extensions.ExtensionAPI.PrivateAPI.Commands.ShowPanel */}`,
      );
    }
  ...
  onCreateToolbarButton(message, port) {
    if (
      ...
      return this.status.E_BADARG(
        'command',
        `expected ${'createToolbarButton' /* Extensions.ExtensionAPI.PrivateAPI.Commands.CreateToolbarButton */}`,
      );
    }
    ...
    const resourcePath = ExtensionServer.expandResourcePath(
      this.getExtensionOrigin(port),
      message.icon,
    );
  ...
  onUpdateButton(message, port) {
    if (
      ...
      return this.status.E_BADARG(
        'command',
        `expected ${'updateButton' /* Extensions.ExtensionAPI.PrivateAPI.Commands.UpdateButton */}`,
      );
    }
    ...
    const resourcePath =
      message.icon &&
      ExtensionServer.expandResourcePath(this.getExtensionOrigin(port), message.icon);
  ...
  onCreateSidebarPane(message) {
    if (
      ...
      return this.status.E_BADARG(
        'command',
        `expected ${'createSidebarPane' /* Extensions.ExtensionAPI.PrivateAPI.Commands.CreateSidebarPane */}`,
      );
    }
    const id = message.id;
    const sidebar = new ExtensionSidebarPane(
      this,
      message.panel,
      i18n.i18n.lockedString(message.title),
      id,
  ...
  onSetSidebarHeight(message) {
    if (
      ...
      return this.status.E_BADARG(
        'command',
        `expected ${'setSidebarHeight' /* Extensions.ExtensionAPI.PrivateAPI.Commands.SetSidebarHeight */}`,
      );
    }
  ...
  onSetSidebarContent(message, port) {
    if (
      ...
      return this.status.E_BADARG(
        'command',
        `expected ${'setSidebarContent' /* Extensions.ExtensionAPI.PrivateAPI.Commands.SetSidebarContent */}`,
      );
    }
  ...
  onSetSidebarPage(message, port) {
    if (
      ...
      return this.status.E_BADARG(
        'command',
        `expected ${'setSidebarPage' /* Extensions.ExtensionAPI.PrivateAPI.Commands.SetSidebarPage */}`,
      );
    }
    const sidebar = this.clientObjects.get(message.id);
    if (!sidebar || !(sidebar instanceof ExtensionSidebarPane)) {
  ...
  onOpenResource(message) {
    if (
      ...
      return this.status.E_BADARG(
        'command',
        `expected ${'openResource' /* Extensions.ExtensionAPI.PrivateAPI.Commands.OpenResource */}`,
      );
    }
    ...
    if (uiSourceCode) {
      void Common.Revealer.reveal(
        uiSourceCode.uiLocation(message.lineNumber, message.columnNumber),
      );
      return this.status.OK();
    }
  ...
  onSetOpenResourceHandler(message, port) {
    if (
      ...
      return this.status.E_BADARG(
        'command',
        `expected ${'setOpenResourceHandler' /* Extensions.ExtensionAPI.PrivateAPI.Commands.SetOpenResourceHandler */}`,
      );
    }
  ...
  onSetThemeChangeHandler(message, port) {
    if (
      ...
      return this.status.E_BADARG(
        'command',
        `expected ${'setThemeChangeHandler' /* Extensions.ExtensionAPI.PrivateAPI.Commands.SetThemeChangeHandler */}`,
      );
    }
    const extensionOrigin = this.getExtensionOrigin(port);
  ...
  onReload(message, port) {
    if (message.command !== 'Reload' /* Extensions.ExtensionAPI.PrivateAPI.Commands.Reload */) {
      return this.status.E_BADARG(
        'command',
        `expected ${'Reload' /* Extensions.ExtensionAPI.PrivateAPI.Commands.Reload */}`,
      );
    }
  ...
  onEvaluateOnInspectedPage(message, port) {
    if (
      ...
      return this.status.E_BADARG(
        'command',
        `expected ${'evaluateOnInspectedPage' /* Extensions.ExtensionAPI.PrivateAPI.Commands.EvaluateOnInspectedPage */}`,
      );
    }
  ...
  async onGetHAR(message, port) {
    if (message.command !== 'getHAR' /* Extensions.ExtensionAPI.PrivateAPI.Commands.GetHAR */) {
      return this.status.E_BADARG(
        'command',
        `expected ${'getHAR' /* Extensions.ExtensionAPI.PrivateAPI.Commands.GetHAR */}`,
      );
    }
    const requests = Logs.NetworkLog.NetworkLog.instance()
      .requests()
      .filter((r) => this.extensionAllowedOnURL(r.url(), port));
    ...
    if (contentProvider instanceof Workspace.UISourceCode.UISourceCode) {
      ...
      buildId =
        Bindings.DebuggerWorkspaceBinding.DebuggerWorkspaceBinding.instance()
          ...
          .find((script) => Boolean(script.buildId))?.buildId ?? undefined;
    }
    return {
  ...
  onGetPageResources(_message, port) {
    ...
    function pushResourceData(contentProvider) {
      if (
        !resources.has(contentProvider.contentURL()) &&
    ...
    uiSourceCodes = uiSourceCodes.concat(
      Workspace.Workspace.WorkspaceImpl.instance().uiSourceCodesForProjectType(
  ...
  onGetRequestContent(message, port) {
    if (
      ...
      return this.status.E_BADARG(
        'command',
        `expected ${'getRequestContent' /* Extensions.ExtensionAPI.PrivateAPI.Commands.GetRequestContent */}`,
      );
    }
  ...
  onGetResourceContent(message, port) {
    if (
      ...
      return this.status.E_BADARG(
        'command',
        `expected ${'getResourceContent' /* Extensions.ExtensionAPI.PrivateAPI.Commands.GetResourceContent */}`,
      );
    }
  ...
  onAttachSourceMapToResource(message, port) {
    ...
    const debuggerBindingsInstance =
      Bindings.DebuggerWorkspaceBinding.DebuggerWorkspaceBinding.instance();
  ...
  onSetResourceContent(message, port) {
    if (
      ...
      return this.status.E_BADARG(
        'command',
        `expected ${'setResourceContent' /* Extensions.ExtensionAPI.PrivateAPI.Commands.SetResourceContent */}`,
      );
    }
  ...
  onForwardKeyboardEvent(message) {
    if (
      ...
      return this.status.E_BADARG(
        'command',
        `expected ${'_forwardKeyboardEvent' /* Extensions.ExtensionAPI.PrivateAPI.Commands.ForwardKeyboardEvent */}`,
      );
    }
  ...
  initExtensions() {
    this.registerAutosubscriptionHandler(
      'resource-added' /* Extensions.ExtensionAPI.PrivateAPI.Events.ResourceAdded */,
      Workspace.Workspace.WorkspaceImpl.instance(),
      Workspace.Workspace.Events.UISourceCodeAdded,
      this.notifyResourceAdded,
    );
    this.registerAutosubscriptionTargetManagerHandler(
      'network-request-finished' /* Extensions.ExtensionAPI.PrivateAPI.Events.NetworkRequestFinished */,
    ...
    this.registerSubscriptionHandler(
      'panel-objectSelected-' /* Extensions.ExtensionAPI.PrivateAPI.Events.PanelObjectSelected */ +
        'elements',
  ...
  notifyUISourceCodeContentCommitted(event) {
    ...
    this.postNotification(
      'resource-content-committed' /* Extensions.ExtensionAPI.PrivateAPI.Events.ResourceContentCommitted */,
  ...
  addExtension(extensionInfo) {
    ...
    const inspectedURL =
      SDK.TargetManager.TargetManager.instance().primaryPageTarget()?.inspectedURL() ?? '';
    if (inspectedURL === '') {
    ...
    try {
      ...
      const extensionRegistration = new RegisteredExtension(
        name,
        hostsPolicy,
        Boolean(extensionInfo.allowFileAccess),
      );
  ...
  static canInspectURL(url) {
    ...
    if (
      (globalThis.DevToolsAPI?.getOriginsForbiddenForExtensions?.() || []).includes(
        parsedURL.origin,
      )
    ) {
      return false;
  ...
  static #isUrlFromChromeWebStore(parsedURL) {
    if (
      ...
      parsedURL.hostname.match(/^chrome\.google\.com\.?$/) &&
    ...
    if (
      parsedURL.protocol.startsWith('http') &&
      parsedURL.hostname.match(/^chromewebstore\.google\.com\.?$/)
    ) {
      return true;
    }
    return false;
...
class ExtensionServerPanelView extends UI.View.SimpleView {
  ...
  constructor(name, title, panel) {
    ...
    const viewId = Platform.StringUtilities.isExtendedKebabCase(kebabTitle)
      ? kebabTitle
      : 'extension-panel';
    super({ title, viewId });
    this.name = name;
  ...
  constructor() {
    function makeStatus(code, description, ...details) {
      ...
      if (code !== 'OK') {
        status.isError = true;
        console.error(
          'Extension server error: ' + Platform.StringUtilities.sprintf(description, ...details),
        );
      }
      return status;
    }
