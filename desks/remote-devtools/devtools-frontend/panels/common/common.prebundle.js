...
export class TypeToAllowDialog {
  static async show(options) {
    ...
    const shadowRoot = UI.UIUtils.createShadowRootWithCoreStyles(dialog.contentElement, {
      cssFile: commonStyles,
    });
    ...
    const result = await new Promise((resolve) => {
      ...
      const allowButton = UI.UIUtils.createTextButton(
        i18nString(UIStrings.allow),
        () => {
