...
export const DEFAULT_VIEW = (input, _output, target) => {
  ...
  const teaserAriaLabel =
    lockedString(UIStringsNotTranslate.press) +
    ' ' +
    cmdOrCtrl +
    ' ' +
    lockedString(UIStringsNotTranslate.i) +
    ' ' +
    lockedString(UIStringsNotTranslate.toTurnOnCodeSuggestions) +
    ' ' +
    lockedString(UIStringsNotTranslate.press) +
    ' ' +
    cmdOrCtrl +
    ' ' +
    lockedString(UIStringsNotTranslate.x) +
    ' ' +
...
export class AiCodeCompletionTeaser extends UI.Widget.Widget {
  ...
  #aiCodeCompletionFreCompletedSetting = Common.Settings.Settings.instance().createSetting(
  ...
  #onAiCodeCompletionSettingChanged() {
    if (
      this.#aiCodeCompletionFreCompletedSetting.get() ||
  ...
  wasShown() {
    ...
    this.#aiCodeCompletionFreCompletedSetting.addChangeListener(
      this.#boundOnAiCodeCompletionSettingChanged,
    );
    this.#aiCodeCompletionTeaserDismissedSetting.addChangeListener(
      this.#boundOnAiCodeCompletionSettingChanged,
    );
  ...
  willHide() {
    ...
    this.#aiCodeCompletionFreCompletedSetting.removeChangeListener(
      this.#boundOnAiCodeCompletionSettingChanged,
    );
    this.#aiCodeCompletionTeaserDismissedSetting.removeChangeListener(
      this.#boundOnAiCodeCompletionSettingChanged,
    );
  }
  onDetach() {
