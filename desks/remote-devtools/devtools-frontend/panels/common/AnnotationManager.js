...
export class AnnotationManager {
  ...
  #addAnnotation(annotationData) {
    ...
    this.#annotations.set(annotationData.id, {
  ...
  async #resolveAnnotationWithId(id) {
    ...
    if (!annotation) {
      console.warn(
        'Unable to find annotation with id',
        id,
        ' in annotations map',
        this.#annotations,
      );
    ...
    const annotationRegistration =
      Annotations.AnnotationRepository.instance().getAnnotationDataById(id);
    ...
    if (!position) {
      // eslint-disable-next-line no-console
      console.log(
        `Unable to calculate position for annotation with id ${annotationRegistration?.id}`,
      );
      return;
    }
