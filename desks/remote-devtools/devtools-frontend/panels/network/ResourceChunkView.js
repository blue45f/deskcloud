...
export class ResourceChunkView extends UI.Widget.VBox {
  ...
  constructor(
    request,
    messageFilterSettingKey,
    splitWidgetSettingKey,
    dataGridDisplayName,
    filterUsingRegexHint,
  ) {
    super();
    this.messageFilterSetting = Common.Settings.Settings.instance().createSetting(
      messageFilterSettingKey,
      '',
    );
    ...
    this.filterTypeCombobox = new UI.Toolbar.ToolbarComboBox(
    ...
    this.filterTextInput.addEventListener(
    ...
    function onRowContextMenu(contextMenu, genericNode) {
      ...
      contextMenu
        .footerSection()
        .appendItem(i18nString(UIStrings.clearAllL), this.clearChunks.bind(this), {
