...
export class BinaryResourceView extends UI.Widget.VBox {
  ...
  constructor(content, contentUrl, resourceType, element) {
    ...
    this.binaryResourceViewFactory =
      new SourceFrame.BinaryResourceViewFactory.BinaryResourceViewFactory(
        content,
        contentUrl,
        resourceType,
      );
    ...
    this.binaryViewTypeSetting = Common.Settings.Settings.instance().createSetting(
      'binary-view-type',
      'hex',
    );
    this.binaryViewTypeCombobox = new UI.Toolbar.ToolbarComboBox(
      this.binaryViewTypeChanged.bind(this),
      i18nString(UIStrings.binaryViewType),
    );
  ...
  copySelectedViewToClipboard() {
    ...
    this.addFadeoutSettimeoutId = globalThis.setTimeout(addFadeoutClass.bind(this), 2000);
  }
  updateView() {
  ...
  addCopyToContextMenu(contextMenu, submenuItemText) {
    const copyMenu = contextMenu
      .clipboardSection()
      .appendSubMenuItem(submenuItemText, false, 'copy');
    const footerSection = copyMenu.footerSection();
    footerSection.appendItem(
      i18nString(UIStrings.copyAsBase),
      async () => {
    ...
    footerSection.appendItem(
      i18nString(UIStrings.copyAsHex),
      async () => {
    ...
    footerSection.appendItem(
      i18nString(UIStrings.copyAsUtf),
      async () => {
