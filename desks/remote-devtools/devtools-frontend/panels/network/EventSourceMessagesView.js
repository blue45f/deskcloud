...
export class EventSourceMessagesView extends UI.Widget.VBox {
  ...
  filterTextInput;
  filterRegex;
  messageFilterSetting = Common.Settings.Settings.instance().createSetting(
  ...
  wasShown() {
    ...
    this.request.addEventListener(
      SDK.NetworkRequest.Events.EVENT_SOURCE_MESSAGE_ADDED,
      this.messageAdded,
      this,
    );
  }
  ...
  messageFilter(message) {
    return (
      !this.filterRegex ||
      this.filterRegex.test(message.eventName) ||
      this.filterRegex.test(message.eventId) ||
