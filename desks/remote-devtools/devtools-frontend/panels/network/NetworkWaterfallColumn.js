...
export class NetworkWaterfallColumn extends UI.Widget.VBox {
  ...
  constructor(calculator) {
    ...
    const baseLineColor = ThemeSupport.ThemeSupport.instance().getComputedValue(
  ...
  static buildRequestTimeRangeStyle() {
    ...
    styleMap.set('connecting' /* NetworkTimeCalculator.RequestTimeRangeNames.CONNECTING */, {
      fillStyle:
        RequestTimeRangeNameToColor[
          'connecting' /* NetworkTimeCalculator.RequestTimeRangeNames.CONNECTING */
        ],
    });
    styleMap.set('ssl' /* NetworkTimeCalculator.RequestTimeRangeNames.SSL */, {
      fillStyle:
        RequestTimeRangeNameToColor['ssl' /* NetworkTimeCalculator.RequestTimeRangeNames.SSL */],
    });
    styleMap.set('dns' /* NetworkTimeCalculator.RequestTimeRangeNames.DNS */, {
      fillStyle:
        RequestTimeRangeNameToColor['dns' /* NetworkTimeCalculator.RequestTimeRangeNames.DNS */],
    });
    styleMap.set('proxy' /* NetworkTimeCalculator.RequestTimeRangeNames.PROXY */, {
      fillStyle:
        RequestTimeRangeNameToColor[
          'proxy' /* NetworkTimeCalculator.RequestTimeRangeNames.PROXY */
        ],
    });
    styleMap.set('blocking' /* NetworkTimeCalculator.RequestTimeRangeNames.BLOCKING */, {
      fillStyle:
        RequestTimeRangeNameToColor[
          'blocking' /* NetworkTimeCalculator.RequestTimeRangeNames.BLOCKING */
        ],
    });
    styleMap.set('push' /* NetworkTimeCalculator.RequestTimeRangeNames.PUSH */, {
      fillStyle:
        RequestTimeRangeNameToColor['push' /* NetworkTimeCalculator.RequestTimeRangeNames.PUSH */],
    });
    styleMap.set('queueing' /* NetworkTimeCalculator.RequestTimeRangeNames.QUEUEING */, {
      fillStyle:
        RequestTimeRangeNameToColor[
          'queueing' /* NetworkTimeCalculator.RequestTimeRangeNames.QUEUEING */
        ],
      lineWidth: 2,
    ...
    styleMap.set('receiving' /* NetworkTimeCalculator.RequestTimeRangeNames.RECEIVING */, {
      fillStyle:
        RequestTimeRangeNameToColor[
          'receiving' /* NetworkTimeCalculator.RequestTimeRangeNames.RECEIVING */
        ],
      lineWidth: 2,
      borderColor: '#03A9F4',
    });
    styleMap.set('waiting' /* NetworkTimeCalculator.RequestTimeRangeNames.WAITING */, {
      fillStyle:
        RequestTimeRangeNameToColor[
          'waiting' /* NetworkTimeCalculator.RequestTimeRangeNames.WAITING */
        ],
    });
    styleMap.set(
      'receiving-push' /* NetworkTimeCalculator.RequestTimeRangeNames.RECEIVING_PUSH */,
      {
        fillStyle:
          RequestTimeRangeNameToColor[
            'receiving-push' /* NetworkTimeCalculator.RequestTimeRangeNames.RECEIVING_PUSH */
    ...
    styleMap.set('serviceworker' /* NetworkTimeCalculator.RequestTimeRangeNames.SERVICE_WORKER */, {
      fillStyle:
        RequestTimeRangeNameToColor[
          'serviceworker' /* NetworkTimeCalculator.RequestTimeRangeNames.SERVICE_WORKER */
        ],
    });
    styleMap.set(
      'serviceworker-preparation' /* NetworkTimeCalculator.RequestTimeRangeNames.SERVICE_WORKER_PREPARATION */,
      {
        fillStyle:
          RequestTimeRangeNameToColor[
            'serviceworker-preparation' /* NetworkTimeCalculator.RequestTimeRangeNames.SERVICE_WORKER_PREPARATION */
    ...
    styleMap.set(
      'serviceworker-respondwith' /* NetworkTimeCalculator.RequestTimeRangeNames.SERVICE_WORKER_RESPOND_WITH */,
      {
        fillStyle:
          RequestTimeRangeNameToColor[
            'serviceworker-respondwith' /* NetworkTimeCalculator.RequestTimeRangeNames.SERVICE_WORKER_RESPOND_WITH */
  ...
  resetPaths() {
    ...
    this.styleForDownloadingResourceType.forEach((style) =>
      this.pathForStyle.set(style, new Path2D()),
    );
  ...
  getPopoverRequest(event) {
    ...
    let end;
    if (useTimingBars) {
      range = NetworkTimeCalculator.calculateRequestTimeRanges(request, 0).find(
        (data) => data.name === 'total' /* NetworkTimeCalculator.RequestTimeRangeNames.TOTAL */,
      );
    ...
    if (
      event.clientX < this.canvasPosition.left + start ||
      event.clientX > this.canvasPosition.left + end
    ) {
      return null;
    }
    ...
    const y =
      this.headerHeight +
      (this.rowHeight * rowIndex - this.scrollTop) +
      (this.rowHeight - barHeight) / 2;
    if (
      event.clientY < this.canvasPosition.top + y ||
      event.clientY > this.canvasPosition.top + y + barHeight
    ) {
      return null;
    }
  ...
  draw() {
    ...
    const lastRequestIndex = Math.min(
      nodes.length,
      firstRequestIndex + Math.ceil(this.offsetHeight / this.rowHeight),
    );
  ...
  drawLayers(context, useTimingBars) {
    for (const entry of this.pathForStyle) {
      ...
      if (style.fillStyle) {
        context.fillStyle = useTimingBars
          ? ThemeSupport.ThemeSupport.instance().getComputedValue(style.fillStyle)
          : style.fillStyle;
        context.fill(path);
      }
      context.restore();
  ...
  buildSimplifiedBarLayers(context, node, y) {
    ...
    if (!this.calculator.startAtZero) {
      const queueingRange = NetworkTimeCalculator.calculateRequestTimeRanges(request, 0).find(
        (data) => data.name === 'total' /* NetworkTimeCalculator.RequestTimeRangeNames.TOTAL */,
      );
  ...
  buildTimingBarLayers(node, y) {
    ...
    for (const range of ranges) {
      if (
        range.name === 'total' /* NetworkTimeCalculator.RequestTimeRangeNames.TOTAL */ ||
        range.name === 'sending' /* NetworkTimeCalculator.RequestTimeRangeNames.SENDING */ ||
