        ...
        html`
          ...
          <div class="whatsnew" jslog=${VisualLogging.section().context('release-notes')}>
            <div class="whatsnew-content">
              <div class="header">${releaseNote.header}</div>
              <div>
                <devtools-button
              ...
              <div class="feature-container">
                <div class="video-container">
                  ${releaseNote.videoLinks.map((value) => {
                    return html`
                      <devtools-link href=${value.link} jslogcontext="learn-more">
                        <div class="video">
                          <img
                            class="thumbnail"
                            src=${input.getThumbnailPath(
                              value.type ?? 'WhatsNew' /* VideoType.WHATS_NEW */,
                            )}
                          />
