...
const str_ = i18n.i18n.registerUIStrings(
  'panels/accessibility/AccessibilitySidebarView.ts',
  UIStrings,
);
...
export class AccessibilitySidebarView extends UI.Widget.VBox {
  ...
  constructor() {
    ...
    this.toggleAction = UI.ActionRegistry.ActionRegistry.instance().getAction(
      'elements.toggle-a11y-tree',
    );
    this.toggleAction.addEventListener(
    ...
    render(
      html`
        <div style="display: flex; align-items: center; gap: 8px;">
          ...
          ></devtools-switch>
          <span style="color: var(--sys-color-on-surface);"
            >${i18nString(UIStrings.showAccessibilityTree)}</span
          >
        </div>
      `,
