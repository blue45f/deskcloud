...
export default `@scope to (devtools-widget > *){.tree-outline li{min-height:20px}devtools-icon{color:var(--icon-file-default);margin-right:var(--sys-size-4)}.tree-element-title > div{display:flex;align-items:center}.navigator-sm-script-tree-item devtools-icon,
