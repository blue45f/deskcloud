...
export class ThrottlingPresets {
  static getNoThrottlingConditions() {
    const title =
      typeof SDK.NetworkManager.NoThrottlingConditions.title === 'function'
  ...
  static getOfflineConditions() {
    const title =
      typeof SDK.NetworkManager.OfflineConditions.title === 'function'
  ...
  static getLowEndMobileConditions() {
    const useCalibrated =
      SDK.CPUThrottlingManager.CalibratedLowTierMobileThrottlingOption.rate() !== 0;
  ...
  static getMidTierMobileConditions() {
    const useCalibrated =
      SDK.CPUThrottlingManager.CalibratedMidTierMobileThrottlingOption.rate() !== 0;
    const cpuThrottlingOption = useCalibrated
  ...
  static getAdvancedMobilePresets() {
    return [ThrottlingPresets.getOfflineConditions()];
  }
