...
const str_ = i18n.i18n.registerUIStrings(
  'panels/mobile_throttling/NetworkPanelIndicator.ts',
  UIStrings,
);
...
export class NetworkPanelIndicator {
  constructor() {
    ...
    manager.addEventListener(
      'InterceptorsChanged' /* SDK.NetworkManager.MultitargetNetworkManager.Events.INTERCEPTORS_CHANGED */,
      updateVisibility,
    );
    manager.addEventListener(
      'AcceptedEncodingsChanged' /* SDK.NetworkManager.MultitargetNetworkManager.Events.ACCEPTED_ENCODINGS_CHANGED */,
      updateVisibility,
    );
