...
export class ExtensionManager extends Common.ObjectWrapper.ObjectWrapper {
  ...
  attach() {
    ...
    pluginManager.addEventListener(
      'pluginAdded' /* Extensions.RecorderPluginManager.Events.PLUGIN_ADDED */,
      this.#handlePlugin,
    );
    pluginManager.addEventListener(
      'pluginRemoved' /* Extensions.RecorderPluginManager.Events.PLUGIN_REMOVED */,
      this.#handlePlugin,
    );
    pluginManager.addEventListener(
      'viewRegistered' /* Extensions.RecorderPluginManager.Events.VIEW_REGISTERED */,
      this.#handleView,
    );
  ...
  #handlePlugin = () => {
    this.dispatchEventToListeners(
      'extensionsUpdated' /* Events.EXTENSIONS_UPDATED */,
      this.extensions(),
    );
  };
  #handleView = (event) => {
