...
var j = (s, e) => {
  for (var t in e) cs(s, t, { get: e[t], enumerable: !0 });
};
var wt = {};
j(wt, { ControlButton: () => X, DEFAULT_VIEW: () => yt });
...
var { html: ds } = Be,
  yt = (s, e, t) => {
    let { label: o, shape: i, disabled: r, onClick: n } = s;
    Be.render(
      ds`
    <style>${vt}</style>
    <button
        @click=${(g) => {
          r ? (g.stopPropagation(), g.preventDefault()) : n(g);
        }}
        .disabled=${r}
        class="control">
  ...
  X = class extends bt.Widget.Widget {
    #t = '';
    #e = 'square';
    #s = !1;
    #o = () => {};
    #i;
    constructor(e, t) {
      (super(e, { useShadowDom: !0, classes: ['flex-none'] }), (this.#i = t || yt));
    }
    set label(e) {
    ...
    performUpdate() {
      this.#i(
        { label: this.#t, shape: this.#e, disabled: this.#s, onClick: this.#o },
        {},
        this.contentElement,
      );
    }
...
var $t = {};
j($t, { CreateRecordingView: () => ze, DEFAULT_VIEW: () => xt });
import './../../../ui/kit/kit.js';
import * as Ke from './../../../core/i18n/i18n.js';
import * as we from './../../../models/badges/badges.js';
import './../../../ui/components/buttons/buttons.js';
import * as Se from './../../../ui/components/input/input.js';
import * as We from './../../../ui/legacy/legacy.js';
import * as He from './../../../ui/lit/lit.js';
import * as D from './../../../ui/visual_logging/visual_logging.js';
import * as L from './../models/models.js';
...
var {
    html: qe,
    Directives: { ref: ps, createRef: us, repeat: hs },
  } = He,
  k = {
  ...
  gs = Ke.i18n.registerUIStrings('panels/recorder/components/CreateRecordingView.ts', k),
  C = Ke.i18n.getLocalizedString.bind(void 0, gs),
  { widget: ms } = We.Widget,
  xt = (s, e, t) => {
    let {
        name: o,
        ...
        onRecordingCancelled: I,
        onErrorReset: y,
      } = s,
      v = us(),
      S = (b) => {
        (n && y(), b.key === 'Enter' && (g(), b.stopPropagation(), b.preventDefault()));
      };
    e.focusInput = () => {
      v.value?.focus();
    };
    let R = new Map([
      [L.Schema.SelectorType.ARIA, C(k.selectorTypeARIA)],
      [L.Schema.SelectorType.CSS, C(k.selectorTypeCSS)],
      [L.Schema.SelectorType.Text, C(k.selectorTypeText)],
      [L.Schema.SelectorType.XPath, C(k.selectorTypeXPath)],
      [L.Schema.SelectorType.Pierce, C(k.selectorTypePierce)],
    ]);
    He.render(
      qe`
      <style>${St}</style>
  ...
  ze = class extends We.Widget.Widget {
    #t;
    #e = '';
    #s = '';
    #o = [];
    ...
    set recorderSettings(e) {
      ((this.#n = e),
        (this.#e = this.#n.defaultTitle),
        (this.#s = this.#n.selectorAttribute),
        (this.#o = Object.values(L.Schema.SelectorType).map((t) => ({
          selectorType: t,
          checked: this.#n?.getSelectorByType(t) ?? !0,
        }))),
        this.requestUpdate());
    }
    constructor(e, t) {
      (super(e, { useShadowDom: !0 }), (this.#i = t || xt));
    }
    wasShown() {
      (super.wasShown(),
        this.requestUpdate(),
        this.updateComplete.then(() => this.#a.focusInput?.()));
    }
    startRecording() {
      if (!this.#n) throw new Error('settings not set');
      if (!this.#e.trim()) {
        ((this.#t = new Error(C(k.recordingNameIsRequired))), this.requestUpdate());
        return;
      }
      let e = this.#o.filter((o) => o.checked).map((o) => o.selectorType);
      if (
        !e.includes(L.Schema.SelectorType.CSS) &&
        !e.includes(L.Schema.SelectorType.XPath) &&
        !e.includes(L.Schema.SelectorType.Pierce)
      ) {
        ((this.#t = new Error(C(k.includeNecessarySelectors))), this.requestUpdate());
        return;
      }
      for (let o of Object.values(L.Schema.SelectorType))
        this.#n.setSelectorByType(o, e.includes(o));
      let t = this.#s.trim();
      (t && (this.#n.selectorAttribute = t),
        this.onRecordingStarted({
          name: this.#e,
          selectorTypesToRecord: e,
          selectorAttribute: this.#s ? this.#s : void 0,
        }),
        we.UserBadges.instance().recordAction(we.BadgeAction.RECORDER_RECORDING_STARTED));
    }
    performUpdate() {
      this.#i(
        {
          name: this.#e,
          selectorAttribute: this.#s,
          selectorTypes: this.#o,
          error: this.#t,
          onRecordingCancelled: this.onRecordingCancelled,
          onUpdate: (e) => {
            ('name' in e
              ? (this.#e = e.name)
              : 'selectorAttribute' in e
                ? (this.#s = e.selectorAttribute)
                : (this.#o = this.#o.map((t) =>
                    t.selectorType === e.selectorType ? { ...t, checked: e.checked } : t,
                  )),
              this.requestUpdate());
          },
          onRecordingStarted: () => {
          ...
          onErrorReset: () => {
            ((this.#t = void 0), this.requestUpdate());
          },
        },
        this.#a,
        this.contentElement,
...
var Rt = {};
j(Rt, {
  CreateRecordingEvent: () => xe,
  DEFAULT_VIEW: () => It,
  DeleteRecordingEvent: () => $e,
  OpenRecordingEvent: () => ke,
  PlayRecordingEvent: () => Ee,
  RecordingListView: () => _e,
});
import './../../../ui/kit/kit.js';
import * as Xe from './../../../core/i18n/i18n.js';
import './../../../ui/components/buttons/buttons.js';
import * as Et from './../../../ui/legacy/legacy.js';
import * as Ye from './../../../ui/lit/lit.js';
import * as Ct from './../../../ui/visual_logging/visual_logging.js';
import * as Tt from './../models/models.js';
var kt = `@scope to (devtools-widget > *){*{margin:0;padding:0;box-sizing:border-box;font-size:inherit}*:focus,
...
var { html: Ge } = Ye,
  ...
  fs = Xe.i18n.registerUIStrings('panels/recorder/components/RecordingListView.ts', Y),
  ee = Xe.i18n.getLocalizedString.bind(void 0, fs),
  xe = class s extends Event {
    static eventName = 'createrecording';
    constructor() {
      super(s.eventName, { composed: !0, bubbles: !0 });
    }
  },
  $e = class s extends Event {
    storageName;
    static eventName = 'deleterecording';
    constructor(e) {
      (super(s.eventName, { composed: !0, bubbles: !0 }), (this.storageName = e));
    }
  },
  ke = class s extends Event {
    storageName;
  ...
  _e = class extends Et.Widget.Widget {
    #t = [];
    #e = !0;
    #s;
    constructor(e, t) {
      (super(e, { useShadowDom: !0 }), (this.#s = t || It));
    }
    set recordings(e) {
    ...
    #o() {
      this.contentElement.dispatchEvent(new xe());
    }
    #i(e, t) {
      (t.stopPropagation(), this.contentElement.dispatchEvent(new $e(e)));
    }
    #a(e, t) {
      (t.stopPropagation(), this.contentElement.dispatchEvent(new ke(e)));
    }
    #n(e, t) {
      (t.stopPropagation(), this.contentElement.dispatchEvent(new Ee(e)));
    }
    #l(e, t) {
      t.key === 'Enter' && this.#a(e, t);
    }
    performUpdate() {
      this.#s(
        {
          recordings: this.#t,
          replayAllowed: this.#e,
          onCreateClick: this.#o.bind(this),
          onDeleteClick: this.#i.bind(this),
          onOpenClick: this.#a.bind(this),
          onPlayRecordingClick: this.#n.bind(this),
          onKeyDown: this.#l.bind(this),
        },
        {},
        this.contentElement,
      );
    ...
    wasShown() {
      (super.wasShown(), this.performUpdate());
    }
  };
var ls = {};
j(ls, { DEFAULT_VIEW: () => as, RecordingView: () => gt });
import './../../../ui/kit/kit.js';
import './../../../ui/legacy/legacy.js';
import './../../../ui/kit/kit.js';
import * as et from './../../../core/i18n/i18n.js';
import './../../../ui/components/buttons/buttons.js';
import * as tt from './../../../ui/lit/lit.js';
import * as Te from './../../../ui/visual_logging/visual_logging.js';
import * as Ce from './../extensions/extensions.js';
...
var { html: vs } = tt,
  Je = { closeView: 'Close', extension: 'Content provided by a browser extension' },
  bs = et.i18n.registerUIStrings('panels/recorder/components/ExtensionView.ts', Je),
  Mt = et.i18n.getLocalizedString.bind(void 0, bs),
  Ze = class s extends Event {
    static eventName = 'recorderextensionviewclosed';
    constructor() {
      super(s.eventName, { bubbles: !0, composed: !0 });
    }
  },
  Qe = class extends HTMLElement {
    ...
    #e;
    constructor() {
      (super(), this.setAttribute('jslog', `${Te.section('extension-view')}`));
    }
    connectedCallback() {
      this.#o();
    }
    disconnectedCallback() {
      this.#e && Ce.ExtensionManager.ExtensionManager.instance().getView(this.#e.id).hide();
    }
    set descriptor(e) {
      ((this.#e = e),
        this.#o(),
        Ce.ExtensionManager.ExtensionManager.instance().getView(e.id).show());
    }
    #s() {
      this.dispatchEvent(new Ze());
    }
    #o() {
      if (!this.#e) return;
      let e = Ce.ExtensionManager.ExtensionManager.instance().getView(this.#e.id).frame();
      tt.render(
        vs`
        <style>${Lt}</style>
...
customElements.define('devtools-recorder-extension-view', Qe);
...
var Ot = {};
j(Ot, { DEFAULT_VIEW: () => Vt, ReplaySection: () => le });
import * as st from './../../../core/i18n/i18n.js';
import * as Dt from './../../../core/platform/platform.js';
import './../../../ui/components/buttons/buttons.js';
import * as Le from './../../../ui/legacy/legacy.js';
import * as ce from './../../../ui/lit/lit.js';
import * as te from './../../../ui/visual_logging/visual_logging.js';
import * as Pt from './../models/models.js';
var Nt = `.select-button{display:flex;gap:var(--sys-size-6)}.groups-label{display:inline-block;padding:0 var(--sys-size-4) var(--sys-size-4) 0}.select-button devtools-button{position:relative}
/*# sourceURL=${import.meta.resolve('./replaySection.css')} */`;
var {
    html: Ie,
    Directives: { ifDefined: ys, repeat: At },
  } = ce,
  U = {
    Replay: 'Replay',
  ...
  ws = st.i18n.registerUIStrings('panels/recorder/components/ReplaySection.ts', U),
  P = st.i18n.getLocalizedString.bind(void 0, ws),
  Re = 'extension',
  Vt = (s, e, t) => {
    let {
        disabled: o,
      ...
      v = (S) => {
        S.target instanceof HTMLSelectElement && g(S.target.value);
      };
    ce.render(
      Ie`
      <style>
  ...
  le = class extends Le.Widget.Widget {
    onStartReplay;
    #t = !1;
    #e;
    #s = [];
    ...
    #i = [];
    constructor(e, t) {
      (super(e, { useShadowDom: !0 }), (this.#o = t || Vt), (this.#i = this.#a()));
    }
    set settings(e) {
      ((this.#e = e), this.performUpdate());
    }
    set replayExtensions(e) {
      ((this.#s = e), (this.#i = this.#a()), this.performUpdate());
    }
    get disabled() {
      return this.#t;
    }
      ...
      this.#o(
        {
          ...
          groups: this.#i,
          selectedItem: e,
          actionTitle: Pt.Tooltip.getTooltipForActions(
            e.label(),
            'chrome-recorder.replay-recording',
          ),
          onButtonClick: () => this.#l(),
          onItemSelected: (t) => this.#d(t),
        },
        void 0,
        this.contentElement,
      );
    ...
    #a() {
          ...
          items: [
            {
              value: 'normal',
              buttonIconName: 'play',
              buttonLabel: () => P(U.ReplayNormalButtonLabel),
              label: () => P(U.ReplayNormalItemLabel),
            },
            {
              value: 'slow',
              buttonIconName: 'play',
              buttonLabel: () => P(U.ReplaySlowButtonLabel),
              label: () => P(U.ReplaySlowItemLabel),
            },
            {
              value: 'very_slow',
              buttonIconName: 'play',
              buttonLabel: () => P(U.ReplayVerySlowButtonLabel),
              label: () => P(U.ReplayVerySlowItemLabel),
            },
            {
              value: 'extremely_slow',
              buttonIconName: 'play',
              buttonLabel: () => P(U.ReplayExtremelySlowButtonLabel),
              label: () => P(U.ReplayExtremelySlowItemLabel),
            },
          ],
        },
      ];
      return (
        this.#s.length &&
          e.push({
            name: P(U.extensionGroup),
            items: this.#s.map((t, o) => ({
              value: Re + o,
              buttonIconName: 'play',
              buttonLabel: () => t.getName(),
              label: () => t.getName(),
            })),
          }),
        e
    ...
    #n() {
      let e = this.#e?.replayExtension || this.#e?.speed || '';
      for (let t of this.#i) for (let o of t.items) if (o.value === e) return o;
      return this.#i[0].items[0];
    }
    #l() {
      let e = this.#e?.replayExtension || this.#e?.speed || '';
      if (e?.startsWith(Re)) {
        let t = Number(e.substring(Re.length)),
          o = this.#s[t];
        (this.#e && (this.#e.replayExtension = Re + t),
          this.onStartReplay && this.onStartReplay('normal', o));
      } else this.onStartReplay && this.onStartReplay(this.#e ? this.#e.speed : 'normal');
      this.performUpdate();
    }
    #d(e) {
      let t = e;
      (this.#e && t && ((this.#e.speed = t), (this.#e.replayExtension = '')), this.performUpdate());
    }
  };
var is = {};
j(is, {
  AddBreakpointEvent: () => fe,
  AddStep: () => me,
  CaptureSelectorsEvent: () => pt,
  CopyStepEvent: () => De,
  DEFAULT_VIEW: () => os,
  RemoveBreakpointEvent: () => ve,
  RemoveStep: () => Ve,
  StepChanged: () => Pe,
  StepView: () => re,
});
import './../../../ui/kit/kit.js';
var Jt = {};
j(Jt, { EditorState: () => J, StepEditedEvent: () => Ne, StepEditor: () => Z });
import * as ct from './../../../core/i18n/i18n.js';
import * as at from './../../../core/platform/platform.js';
import './../../../ui/components/buttons/buttons.js';
import * as Ue from './../../../ui/components/suggestion_input/suggestion_input.js';
import * as Gt from './../../../ui/legacy/legacy.js';
import * as ks from './../../../ui/lit/lit.js';
import * as w from './../../../ui/visual_logging/visual_logging.js';
import * as m from './../models/models.js';
import * as _t from './../util/util.js';
var Kt = {};
j(Kt, {
  DEFAULT_VIEW: () => zt,
  RequestSelectorAttributeEvent: () => de,
  SelectorPicker: () => pe,
});
...
import * as nt from './../../../ui/lit/lit.js';
import * as Bt from './../../../ui/visual_logging/visual_logging.js';
import * as se from './../models/models.js';
import * as F from './../util/util.js';
var jt = `:host{display:inline-block}.selector-picker{width:18px;height:18px}
/*# sourceURL=${import.meta.resolve('./selectorPicker.css')} */`;
var { html: Ss } = nt,
  ot = 'captureSelectors',
  de = class s extends Event {
    static eventName = 'requestselectorattribute';
    send;
    constructor(e) {
      (super(s.eventName, { bubbles: !0, composed: !0 }), (this.send = e));
    }
  },
  qt = { selectorPicker: 'Select an element in the page to update selectors' },
  xs = rt.i18n.registerUIStrings('panels/recorder/components/SelectorPicker.ts', qt),
  $s = rt.i18n.getLocalizedString.bind(void 0, xs),
  zt = (s, e, t) => {
    let { active: o, disabled: i, onClick: r } = s;
    nt.render(
      Ss`
      <style>${jt}</style>
      <devtools-button
  ...
  pe = class s extends Ft.Widget.Widget {
    #t;
    #e = !1;
    #s = !1;
    #o;
    #i = new it.Mutex.Mutex();
    #a = new Map();
    #n = new Map();
    onSelectorPicked;
    onAttributeRequested;
    constructor(e, t) {
      (super(e, { useShadowDom: !0 }), (this.#t = t || zt));
    }
    static get #l() {
      return N.TargetManager.TargetManager.instance();
    }
    set disabled(e) {
      ((this.#e = e), this.requestUpdate());
    }
    performUpdate() {
      this.#t(
        { active: this.#s, disabled: this.#e, onClick: this.#d.bind(this) },
        {},
        this.contentElement,
      );
    }
    #d(e) {
      (e.preventDefault(), e.stopPropagation(), this.#c());
    }
    async #c() {
      return this.#s ? await this.#u() : await this.#p();
    }
    #p = () =>
      this.#i.run(async () => {
        this.#s ||
          ...
          (this.#o = await new Promise((e, t) => {
            let o = setTimeout(t, 1e3);
            this.onAttributeRequested
              ? this.onAttributeRequested((i) => {
                  (clearTimeout(o), e(i));
                })
              : (clearTimeout(o), e(void 0));
          })),
          s.#l.observeTargets(this),
          this.requestUpdate());
      });
    #u = () =>
      this.#i.run(async () => {
        this.#s &&
          ((this.#s = !1),
          s.#l.unobserveTargets(this),
          s.#l.targets().map(this.targetRemoved.bind(this)),
          (this.#o = void 0),
          this.requestUpdate());
      });
    targetAdded(e) {
      if (e.type() !== N.Target.Type.FRAME) return;
      let t = this.#a.get(e);
      (t || ((t = new it.Mutex.Mutex()), this.#a.set(e, t)),
        t.run(async () => {
          (await this.#m(e), await this.#h(e));
        }));
    }
    targetRemoved(e) {
      let t = this.#a.get(e);
      t &&
        t.run(async () => {
          try {
            (await this.#g(e), await this.#f(e));
          } catch {}
        });
    }
    #r = (e) => {
      if (e.data.name !== ot) return;
      let t = e.data.executionContextId,
        o = N.TargetManager.TargetManager.instance().targets(),
        i = se.SDKUtils.findTargetByExecutionContext(o, t),
        r = se.SDKUtils.findFrameIdByExecutionContext(o, t);
      if (!i || !r)
        throw new Error(
          `No execution context found for the binding call + ${JSON.stringify(e.data)}`,
        );
      let n = i.model(N.ResourceTreeModel.ResourceTreeModel);
      if (!n) throw new Error(`ResourceTreeModel instance is missing for the target: ${i.id()}`);
      let a = n.frameForId(r);
      if (!a) throw new Error('Frame is not found');
      (this.onSelectorPicked &&
        this.onSelectorPicked({
          ...JSON.parse(e.data.payload),
          ...se.SDKUtils.getTargetFrameContext(i, a),
        }),
        this.#u());
    };
    async #h(e) {
      let o = `${await F.InjectedScript.get()};DevToolsRecorder.startSelectorPicker({getAccessibleName, getAccessibleRole}, ${JSON.stringify(this.#o ? this.#o : void 0)}, ${F.isDebugBuild})`,
        [{ identifier: i }] = await Promise.all([
          e
            .pageAgent()
            .invoke_addScriptToEvaluateOnNewDocument({
              source: o,
              worldName: F.DEVTOOLS_RECORDER_WORLD_NAME,
              includeCommandLineAPI: !0,
            }),
          se.SDKUtils.evaluateInAllFrames(F.DEVTOOLS_RECORDER_WORLD_NAME, e, o),
        ]);
      this.#n.set(e, i);
    }
    async #g(e) {
      let t = this.#n.get(e);
      (Me.assertNotNullOrUndefined(t),
        this.#n.delete(e),
        await e.pageAgent().invoke_removeScriptToEvaluateOnNewDocument({ identifier: t }),
        await se.SDKUtils.evaluateInAllFrames(
          F.DEVTOOLS_RECORDER_WORLD_NAME,
          e,
          'DevToolsRecorder.stopSelectorPicker()',
        ));
    }
    async #m(e) {
      let t = e.model(N.RuntimeModel.RuntimeModel);
      (Me.assertNotNullOrUndefined(t),
        t.addEventListener(N.RuntimeModel.Events.BindingCalled, this.#r),
        await t.addBinding({ name: ot, executionContextName: F.DEVTOOLS_RECORDER_WORLD_NAME }));
    }
    async #f(e) {
      await e.runtimeAgent().invoke_removeBinding({ name: ot });
      let t = e.model(N.RuntimeModel.RuntimeModel);
      (Me.assertNotNullOrUndefined(t),
        t.removeEventListener(N.RuntimeModel.Events.BindingCalled, this.#r));
    }
    wasShown() {
      (super.wasShown(), this.requestUpdate());
    }
    wasHidden() {
      (super.wasHidden(), this.#u());
    }
  };
var Wt = `*{box-sizing:border-box;padding:0;margin:0;font-size:inherit}:host{display:block}.row{display:flex;flex-direction:row;color:var(--sys-color-token-property-special);font-family:var(--monospace-font-family);font-size:var(--monospace-font-size);align-items:center;line-height:18px;margin-top:3px}.row devtools-button{line-height:1;margin-left:0.5em}.separator{margin-right:0.5em;color:var(--sys-color-on-surface)}.padded{margin-left:2em}.padded.double{margin-left:4em}.inline-button{width:18px;height:18px;opacity:0%;visibility:hidden;transition:opacity 200ms;flex-shrink:0}.row:focus-within .inline-button,
...
function oe(s, e = 'Assertion failed!') {
  if (!s) throw new Error(e);
}
var ie = (s) => {
    for (let e of Reflect.ownKeys(s)) {
      let t = s[e];
      ((t && typeof t == 'object') || typeof t == 'function') && ie(t);
    }
  ...
  B = (s, e) => {
    if (e instanceof f) {
      oe(Array.isArray(s), `Expected an array. Got ${typeof s}.`);
      let t = [...s],
        o = Object.keys(e.value).sort((i, r) => Number(r) - Number(i));
      for (let i of o) {
        let r = e.value[Number(i)];
        r === void 0
          ? t.splice(Number(i), 1)
          : r instanceof z
            ? t.splice(Number(i), 0, r.value)
            : (t[Number(i)] = B(t[i], r));
      }
      return Object.freeze(t);
    }
    if (typeof e == 'object' && !Array.isArray(e)) {
      oe(!Array.isArray(s), 'Expected an object. Got an array.');
      let t = { ...s },
        o = Object.keys(e);
      for (let i of o) {
        let r = e[i];
        r === void 0 ? delete t[i] : (t[i] = B(t[i], r));
      }
      return Object.freeze(t);
    }
    return e;
...
var ue = function (s, e, t, o) {
    var i = arguments.length,
      r = i < 3 ? e : o === null ? (o = Object.getOwnPropertyDescriptor(e, t)) : o,
      n;
    if (typeof Reflect == 'object' && typeof Reflect.decorate == 'function')
      r = Reflect.decorate(s, e, t, o);
    else
      for (var a = s.length - 1; a >= 0; a--)
        (n = s[a]) && (r = (i < 3 ? n(r) : i > 3 ? n(e, t, r) : n(e, t)) || r);
    return (i > 3 && r && Object.defineProperty(e, t, r), r);
  },
  { html: E, Decorators: Es, Directives: Cs, LitElement: Ts } = ks,
  { customElement: Is, property: Xt, state: Yt } = Es,
  { live: K } = Cs,
  { widget: Rs } = Gt.Widget,
  Ls = Object.freeze({
    string: (s) => s.trim(),
  ...
  x = ie({
    ...
    target: 'main',
    frame: [0],
    assertedEvents: [{ type: 'navigation', url: 'https://example.com', title: 'Title' }],
    value: 'Value',
    key: 'Enter',
    operator: '>=',
    count: 1,
  ...
  lt = ie({
    ...
    [m.Schema.StepType.DoubleClick]: {
      required: ['offsetX', 'offsetY', 'selectors'],
      optional: ['assertedEvents', 'button', 'deviceType', 'frame', 'target', 'timeout'],
    },
    [m.Schema.StepType.Hover]: {
      required: ['selectors'],
      optional: ['assertedEvents', 'frame', 'target', 'timeout'],
    },
    [m.Schema.StepType.Change]: {
      required: ['selectors', 'value'],
      optional: ['assertedEvents', 'frame', 'target', 'timeout'],
    },
    [m.Schema.StepType.KeyDown]: {
      required: ['key'],
      optional: ['assertedEvents', 'target', 'timeout'],
    },
    [m.Schema.StepType.KeyUp]: {
      required: ['key'],
      optional: ['assertedEvents', 'target', 'timeout'],
    },
    [m.Schema.StepType.Scroll]: {
      required: [],
      optional: ['assertedEvents', 'frame', 'target', 'timeout', 'x', 'y'],
    },
    [m.Schema.StepType.Close]: { required: [], optional: ['assertedEvents', 'target', 'timeout'] },
    [m.Schema.StepType.Navigate]: {
      required: ['url'],
      optional: ['assertedEvents', 'target', 'timeout'],
    },
    [m.Schema.StepType.WaitForElement]: {
      required: ['selectors'],
      optional: [
        'assertedEvents',
        'attributes',
    ...
    [m.Schema.StepType.WaitForExpression]: {
      required: ['expression'],
      optional: ['assertedEvents', 'frame', 'target', 'timeout'],
    },
    [m.Schema.StepType.CustomStep]: {
      required: ['name', 'parameters'],
      optional: ['assertedEvents', 'target', 'timeout'],
    },
    [m.Schema.StepType.EmulateNetworkConditions]: {
      required: ['download', 'latency', 'upload'],
      optional: ['assertedEvents', 'target', 'timeout'],
    },
    [m.Schema.StepType.SetViewport]: {
      required: ['deviceScaleFactor', 'hasTouch', 'height', 'isLandscape', 'isMobile', 'width'],
      optional: ['assertedEvents', 'target', 'timeout'],
    },
  }),
  M = {
  ...
  Ms = ct.i18n.registerUIStrings('panels/recorder/components/StepEditor.ts', M),
  A = ct.i18n.getLocalizedString.bind(void 0, Ms),
  Ne = class s extends Event {
    static eventName = 'stepedited';
    data;
    constructor(e) {
      (super(s.eventName, { bubbles: !0, composed: !0 }), (this.data = e));
    }
  },
  Us = (s) => JSON.parse(JSON.stringify(s)),
  J = class {
    static #t = new _t.SharedObject.SharedObject(
      () => m.RecordingPlayer.RecordingPlayer.connectPuppeteer(),
      ({ browser: e }) => m.RecordingPlayer.RecordingPlayer.disconnectPuppeteer(e),
    );
    static async default(e) {
      let t = { type: e },
        o = lt[t.type],
        i = Promise.resolve();
      for (let r of o.required)
        i = Promise.all([
          i,
          (async () => Object.assign(t, { [r]: await this.defaultByAttribute(t, r) }))(),
        ]);
      return (await i, Object.freeze(t));
    }
    static async defaultByAttribute(e, t) {
      return await this.#t.run((o) => {
        switch (t) {
          case 'assertedEvents':
            return B(
              x.assertedEvents,
              new f({ 0: { url: o.page.url() || x.assertedEvents[0].url } }),
            );
          case 'url':
            return o.page.url() || x.url;
          case 'height':
            return o.page.evaluate(() => visualViewport.height) || x.height;
          case 'width':
            return o.page.evaluate(() => visualViewport.width) || x.width;
          default:
            return x[t];
        }
      });
    ...
    static fromStep(e) {
      ...
      for (let o of ['parameters', 'properties'])
        o in e && e[o] !== void 0 && (t[o] = JSON.stringify(e[o]));
      if ('attributes' in e && e.attributes) {
        t.attributes = [];
        for (let [o, i] of Object.entries(e.attributes)) t.attributes.push({ name: o, value: i });
      }
      return (
        'selectors' in e &&
          (t.selectors = e.selectors.map((o) => (typeof o == 'string' ? [o] : [...o]))),
        ie(t)
      );
    }
    static toStep(e) {
      ...
      for (let o of ['parameters', 'properties']) {
        let i = e[o];
        i && Object.assign(t, { [o]: JSON.parse(i) });
      }
      if (e.attributes)
        if (e.attributes.length !== 0) {
          let o = {};
          for (let { name: i, value: r } of e.attributes) Object.assign(o, { [i]: r });
          Object.assign(t, { attributes: o });
        } else 'attributes' in t && delete t.attributes;
      if (e.selectors) {
        let o = e.selectors
          .filter((i) => i.length > 0)
          .map((i) => (i.length === 1 ? i[0] : [...i]));
        o.length !== 0
          ? Object.assign(t, { selectors: o })
          : 'selectors' in t && delete t.selectors;
      }
      return (
        e.frame?.length === 0 && 'frame' in t && delete t.frame,
        Us(m.SchemaUtils.parseStep(t))
      );
    }
  },
  Z = class extends Ts {
    ...
    constructor() {
      (super(),
        (this.state = { type: m.Schema.StepType.WaitForElement }),
        (this.isTypeEditable = !0),
        (this.disabled = !1));
    }
    createRenderRoot() {
      let e = super.createRenderRoot();
      return (e.addEventListener('keydown', this.#a), e);
    }
    set step(e) {
      ((this.state = ie(J.fromStep(e))), (this.error = void 0));
    }
    #e(e) {
      try {
        (this.dispatchEvent(new Ne(J.toStep(e))), (this.state = e));
      } catch (t) {
    ...
    #s = (e) => {
      this.#e(
        B(this.state, {
          target: e.target,
          frame: e.frame,
          selectors: e.selectors.map((t) => (typeof t == 'string' ? [t] : t)),
          offsetX: e.offsetX,
          offsetY: e.offsetY,
        }),
      );
    ...
    #i = (e, t) => (o) => {
      (o.preventDefault(), o.stopPropagation(), this.#e(B(this.state, e)), this.#v(t));
    };
    #a = (e) => {
      if (
        (oe(e instanceof KeyboardEvent),
        e.target instanceof Ue.SuggestionInput.SuggestionInput && e.key === 'Enter')
      ) {
        (e.preventDefault(), e.stopPropagation());
        let t = this.renderRoot.querySelectorAll('devtools-suggestion-input'),
          o = [...t].findIndex((i) => i === e.target);
        o >= 0 && o + 1 < t.length ? t[o + 1].focus() : e.target.blur();
      }
    };
    #n = (e) => (t) => {
      if ((oe(t.target instanceof Ue.SuggestionInput.SuggestionInput), t.target.disabled)) return;
      let o = Ht[e.attribute],
        i = Ls[o](t.target.value),
        r = e.from.bind(this)(i);
      r && this.#e(B(this.state, r));
    };
    #l = async (e) => {
      if ((oe(e.target instanceof Ue.SuggestionInput.SuggestionInput), e.target.disabled)) return;
      let t = e.target.value;
      if (t !== this.state.type) {
        if (!Object.values(m.Schema.StepType).includes(t)) {
          this.error = A(M.unknownActionType);
          return;
        }
        this.#e(await J.default(t));
      }
    };
    #d = async (e) => {
      (e.preventDefault(), e.stopPropagation());
      let t = e.target.dataset.attribute;
      (this.#e(B(this.state, { [t]: await J.defaultByAttribute(this.state, t) })),
        this.#v(`[data-attribute=${t}].attribute devtools-suggestion-input`));
    };
    #c(e) {
      if (!this.disabled)
        return E`
    ...
    #p(e) {
      if (!(this.disabled || ![...lt[this.state.type].optional].includes(e) || this.disabled))
        return E`<devtools-button
      .size=${'SMALL'}
      .iconName=${'bin'}
      .variant=${'icon'}
      .title=${A(M.deleteRow)}
      ...
      @click=${(i) => {
        (i.preventDefault(), i.stopPropagation(), this.#e(B(this.state, { [e]: void 0 })));
      }}
    ></devtools-button>`;
    }
    #u(e) {
      return (
        this.#t.add('type'),
        E`<div class="row attribute" data-attribute="type" jslog=${w.treeItem('type').track({ resize: !0 })}>
    ...
    #r(e) {
      this.#t.add(e);
      let t = this.state[e]?.toString();
      if (t !== void 0)
        return E`<div class="row attribute" data-attribute=${e} jslog=${w.treeItem(at.StringUtilities.toKebabCase(e)).track({ resize: !0 })}>
      ...
      <devtools-suggestion-input
        ...
        @blur=${this.#n({
          attribute: e,
          from(o) {
            if (this.state[e] !== void 0) return { [e]: o };
          },
        })}
      ></devtools-suggestion-input>
      ${this.#p(e)}
    ...
    #h() {
      if ((this.#t.add('frame'), this.state.frame !== void 0))
        return E`
            ...
            <div class="padded row">
              <devtools-suggestion-input
                ...
                @blur=${this.#n({
                  attribute: 'frame',
                  from(i) {
                    if (this.state.frame?.[t] !== void 0) return { frame: new f({ [t]: i }) };
                  },
                })}
              ></devtools-suggestion-input>
    ...
    #g() {
      if ((this.#t.add('selectors'), this.state.selectors !== void 0))
        return E`<div class="attribute" data-attribute="selectors" jslog=${w.treeItem('selectors')}>
      <div class="row">
      ...
      ${this.state.selectors.map(
        (e, t, o) => E`<div class="padded row" data-selector-path=${t}>
            ...
            >
              <devtools-suggestion-input
                ...
                @blur=${this.#n({
                  attribute: 'selectors',
                  from(a) {
                    if (this.state.selectors?.[t]?.[r] !== void 0)
                      return { selectors: new f({ [t]: new f({ [r]: a }) }) };
                  },
                })}
              ></devtools-suggestion-input>
    ...
    #m() {
      if ((this.#t.add('assertedEvents'), this.state.assertedEvents !== void 0))
        return E`<div class="attribute" data-attribute="assertedEvents" jslog=${w.treeItem('asserted-events')}>
      <div class="row">
        <div>asserted events<span class="separator">:</span></div>
        ${this.#p('assertedEvents')}
      </div>
      ${this.state.assertedEvents.map(
        (e, t) => E` <div class="padded row" jslog=${w.treeItem('event-type')}>
          ...
          <div class="padded row" jslog=${w.treeItem('event-title')}>
            ...
            <devtools-suggestion-input
              ...
              @blur=${this.#n({
                ...
                from(o) {
                  if (this.state.assertedEvents?.[t]?.title !== void 0)
                    return { assertedEvents: new f({ [t]: { title: o } }) };
                },
              })}
            ></devtools-suggestion-input>
          </div>
          <div  id="event-url" class="padded row" jslog=${w.treeItem('event-url')}>
            ...
            <devtools-suggestion-input
              ...
              @blur=${this.#n({
                attribute: 'url',
                from(o) {
                  if (this.state.assertedEvents?.[t]?.url !== void 0)
                    return { assertedEvents: new f({ [t]: { url: o } }) };
                },
              })}
            ></devtools-suggestion-input>
          </div>`,
    ...
    #f() {
      if ((this.#t.add('attributes'), this.state.attributes !== void 0))
        return E`<div class="attribute" data-attribute="attributes" jslog=${w.treeItem('attributes')}>
      <div class="row">
        <div>attributes<span class="separator">:</span></div>
        ${this.#p('attributes')}
      </div>
      ${this.state.attributes.map(
        ({ name: e, value: t }, o, i) => E`<div class="padded row" jslog=${w.treeItem('attribute')}>
          <devtools-suggestion-input
            .disabled=${this.disabled}
            ...
            @blur=${this.#n({
              ...
              from(r) {
                if (this.state.attributes?.[o]?.name !== void 0)
                  return { attributes: new f({ [o]: { name: r } }) };
              },
            })}
          ></devtools-suggestion-input>
          ...
          <devtools-suggestion-input
            ...
            @blur=${this.#n({
              attribute: 'attributes',
              from(r) {
                if (this.state.attributes?.[o]?.value !== void 0)
                  return { attributes: new f({ [o]: { value: r } }) };
              },
            })}
          ></devtools-suggestion-input>
          ${this.#c({
            class: 'add-attribute-assertion',
            title: A(M.addSelectorPart),
            iconName: 'plus',
            onClick: this.#i(
              {
                attributes: new f({
                  [o + 1]: new z(
                    (() => {
                      {
                        let r = new Set(i.map(({ name: I }) => I)),
                          n = x.attributes[0],
                          a = n.name,
                          g = 0;
                        for (; r.has(a); ) (++g, (a = `${n.name}-${g}`));
                        return { ...n, name: a };
                      }
                    })(),
                  ),
              ...
              `devtools-suggestion-input[data-path="attributes.${o + 1}.name"]`,
            ),
          })}
    ...
    #y() {
      return [...lt[this.state.type].optional]
        .filter((t) => this.state[t] === void 0)
        .map(
          (t) => E`<devtools-button
          .variant=${'outlined'}
          class="add-row"
    ...
    #v = (e) => {
      this.updateComplete.then(() => {
        this.renderRoot.querySelector(e)?.focus();
      });
    };
    render() {
      this.#t = new Set();
    ...
    `;
      for (let t of Object.keys(Ht))
        if (!this.#t.has(t)) throw new Error(`The editable attribute ${t} does not have UI`);
      return e;
    }
  };
ue([Yt()], Z.prototype, 'state', void 0);
ue([Yt()], Z.prototype, 'error', void 0);
ue([Xt({ type: Boolean })], Z.prototype, 'isTypeEditable', void 0);
ue([Xt({ type: Boolean })], Z.prototype, 'disabled', void 0);
Z = ue([Is('devtools-recorder-step-editor')], Z);
import * as ut from './../../../core/i18n/i18n.js';
import * as dt from './../../../core/platform/platform.js';
import * as Ae from './../../../ui/components/menus/menus.js';
import * as be from './../../../ui/legacy/legacy.js';
import * as ye from './../../../ui/lit/lit.js';
import * as H from './../../../ui/visual_logging/visual_logging.js';
import * as T from './../models/models.js';
...
var ss = {};
j(ss, { DEFAULT_VIEW: () => ts, TimelineSection: () => he });
import * as es from './../../../ui/legacy/legacy.js';
...
var { html: Ns } = ge,
  ts = (s, e, t) => {
    let o = {
      'timeline-section': !0,
      'is-end-of-group': s.isEndOfGroup,
      'is-start-of-group': s.isStartOfGroup,
      'is-first-section': s.isFirstSection,
      'is-last-section': s.isLastSection,
  ...
  he = class extends es.Widget.Widget {
    #t = !1;
    #e = !1;
    #s = !1;
    #o = !1;
    ...
    #a;
    constructor(e, t = ts) {
      (super(e, { useShadowDom: !0 }), (this.#a = t));
    }
    set isEndOfGroup(e) {
      ((this.#t = e), this.requestUpdate());
    }
    set isStartOfGroup(e) {
      ((this.#e = e), this.requestUpdate());
    }
    set isFirstSection(e) {
      ((this.#s = e), this.requestUpdate());
    }
    set isLastSection(e) {
      ((this.#o = e), this.requestUpdate());
    ...
    performUpdate() {
      this.#a(
        {
          isEndOfGroup: this.#t,
          isStartOfGroup: this.#e,
          isFirstSection: this.#s,
          isLastSection: this.#o,
          isSelected: this.#i,
        },
        {},
        this.contentElement,
...
var { html: Q } = ye,
  ...
  Ds = ut.i18n.registerUIStrings('panels/recorder/components/StepView.ts', c),
  d = ut.i18n.getLocalizedString.bind(void 0, Ds),
  pt = class s extends Event {
  ...
  De = class s extends Event {
    ...
    step;
    constructor(e) {
      (super(s.eventName, { bubbles: !0, composed: !0 }), (this.step = e));
    }
  },
  Pe = class s extends Event {
  ...
  me = class s extends Event {
    static eventName = 'addstep';
    position;
    stepOrSection;
    constructor(e, t) {
      (super(s.eventName, { bubbles: !0, composed: !0 }),
        (this.stepOrSection = e),
        (this.position = t));
    }
  },
  Ve = class s extends Event {
  ...
  fe = class s extends Event {
    static eventName = 'addbreakpoint';
    index;
    constructor(e) {
      (super(s.eventName, { bubbles: !0, composed: !0 }), (this.index = e));
    }
  },
  ve = class s extends Event {
...
function Ps(s) {
  if (s.section)
    return s.section.title ? s.section.title : Q`<span class="fallback">(No Title)</span>`;
  if (!s.step) throw new Error('Missing both step and section');
  switch (s.step.type) {
    case T.Schema.StepType.CustomStep:
      return d(c.customStepTitle);
    case T.Schema.StepType.SetViewport:
      return d(c.setViewportClickTitle);
    case T.Schema.StepType.Click:
      return d(c.clickStepTitle);
    case T.Schema.StepType.DoubleClick:
      return d(c.doubleClickStepTitle);
    case T.Schema.StepType.Hover:
      return d(c.hoverStepTitle);
    case T.Schema.StepType.EmulateNetworkConditions:
      return d(c.emulateNetworkConditionsStepTitle);
    case T.Schema.StepType.Change:
      return d(c.changeStepTitle);
    case T.Schema.StepType.Close:
      return d(c.closeStepTitle);
    case T.Schema.StepType.Scroll:
      return d(c.scrollStepTitle);
    case T.Schema.StepType.KeyUp:
      return d(c.keyUpStepTitle);
    case T.Schema.StepType.KeyDown:
      return d(c.keyDownStepTitle);
    case T.Schema.StepType.WaitForElement:
      return d(c.waitForElementStepTitle);
    case T.Schema.StepType.WaitForExpression:
      return d(c.waitForExpressionStepTitle);
    case T.Schema.StepType.Navigate:
      return d(c.navigateStepTitle);
  }
}
function Vs(s) {
  switch (s) {
    case 'button':
      return d(c.elementRoleButton);
    case 'input':
      return d(c.elementRoleInput);
    default:
      return d(c.elementRoleFallback);
  }
}
function Os(s) {
  if (!('selectors' in s)) return '';
  let e = s.selectors.flat().find((o) => o.startsWith('aria/'));
  if (!e) return '';
  let t = e.match(/^aria\/(.+?)(\[role="(.+)"\])?$/);
  return t ? `${Vs(t[3])} "${t[1]}"` : '';
}
function js(s) {
  return s ? s.url : '';
...
var os = (s, e, t) => {
    if (!s.step && !s.section) return;
    let o = {
        step: !0,
        expanded: s.showDetails,
        'is-success': s.state === 'success',
        'is-current': s.state === 'current',
        'is-outstanding': s.state === 'outstanding',
        'is-error': s.state === 'error',
        'is-stopped': s.state === 'stopped',
        'is-start-of-group': s.isStartOfGroup,
        'is-first-section': s.isFirstSection,
        'has-breakpoint': s.hasBreakpoint,
      },
      i = !!s.step,
      r = Ps({ step: s.step, section: s.section }),
      n = s.step ? Os(s.step) : js(s.section);
    ye.render(
      Q`
    <style>${Zt}</style>
    <div>
      <devtools-widget ${As(he, { isFirstSection: s.isFirstSection, isLastSection: s.isLastSection, isStartOfGroup: s.isStartOfGroup, isEndOfGroup: s.isEndOfGroup, isSelected: s.isSelected })}
        @contextmenu=${(a) => {
          let g = new be.ContextMenu.ContextMenu(a);
          (s.populateStepContextMenu(g), g.show());
        }}
        data-step-index=${s.stepIndex}
        data-section-index=${s.sectionIndex}
        @click=${(a) => {
          a.stopPropagation();
          let g = s.step || s.section;
          g && s.onStepClick(g);
        }}
        @mouseover=${() => {
          let a = s.step || s.section;
          a && s.onStepHover(a);
        }}
        ...
        <div class="details">
          ${
            s.step &&
            Q`<devtools-recorder-step-editor
  ...
  re = class extends be.Widget.Widget {
    #t = new IntersectionObserver((e) => {
      this.#e.isVisible = e[0].isIntersecting;
    });
    #e = {
      state: 'default',
      showDetails: !1,
      ...
      isSelected: !1,
      actions: [],
      stepEdited: this.#a.bind(this),
      onBreakpointClick: this.#l.bind(this),
      handleStepAction: this.#n.bind(this),
      toggleShowDetails: this.#o.bind(this),
      onToggleShowDetailsKeydown: this.#i.bind(this),
      populateStepContextMenu: this.#c.bind(this),
      onStepClick: () => {},
      onStepHover: () => {},
    };
    #s;
    constructor(e, t) {
      (super(e, { useShadowDom: !0, classes: ['step-view-widget'] }), (this.#s = t || os));
    }
    set step(e) {
      ((this.#e.step = e), this.requestUpdate());
    }
    set section(e) {
      ((this.#e.section = e), this.requestUpdate());
    }
    set state(e) {
      let t = this.#e.state;
      ((this.#e.state = e),
        this.performUpdate(),
        this.#e.state !== t &&
          this.#e.state === 'current' &&
          !this.#e.isVisible &&
          this.contentElement.scrollIntoView());
    }
    set error(e) {
      ((this.#e.error = e), this.requestUpdate());
    }
    set isEndOfGroup(e) {
      ((this.#e.isEndOfGroup = e), this.requestUpdate());
    }
    set isStartOfGroup(e) {
      ((this.#e.isStartOfGroup = e), this.requestUpdate());
    }
    set stepIndex(e) {
      ((this.#e.stepIndex = e), this.requestUpdate());
    }
    set sectionIndex(e) {
      ((this.#e.sectionIndex = e), this.requestUpdate());
    }
    set isFirstSection(e) {
      ((this.#e.isFirstSection = e), this.requestUpdate());
    }
    set isLastSection(e) {
      ((this.#e.isLastSection = e), this.requestUpdate());
    }
    set isRecording(e) {
      ((this.#e.isRecording = e), this.requestUpdate());
    }
    set isPlaying(e) {
      ((this.#e.isPlaying = e), this.requestUpdate());
    }
    set hasBreakpoint(e) {
      ((this.#e.hasBreakpoint = e), this.requestUpdate());
    }
    set removable(e) {
      ((this.#e.removable = e), this.requestUpdate());
    }
    set builtInConverters(e) {
      ((this.#e.builtInConverters = e), this.requestUpdate());
    }
    set extensionConverters(e) {
      ((this.#e.extensionConverters = e), this.requestUpdate());
    }
    set isSelected(e) {
      ((this.#e.isSelected = e), this.requestUpdate());
    }
    set recorderSettings(e) {
      ((this.#e.recorderSettings = e), this.requestUpdate());
    }
    set onStepClick(e) {
      ((this.#e.onStepClick = e), this.requestUpdate());
    }
    set onStepHover(e) {
      ((this.#e.onStepHover = e), this.requestUpdate());
    }
    get step() {
      return this.#e.step;
    }
    ...
    wasShown() {
      (super.wasShown(), this.#t.observe(this.contentElement), this.requestUpdate());
    }
    willHide() {
      (super.willHide(), this.#t.unobserve(this.contentElement));
    }
    #o() {
      ((this.#e.showDetails = !this.#e.showDetails), this.requestUpdate());
    }
    #i(e) {
      let t = e;
      (t.key === 'Enter' || t.key === ' ') && (this.#o(), e.stopPropagation(), e.preventDefault());
    }
    #a(e) {
      let t = this.#e.step || this.#e.section?.causingStep;
      if (!t) throw new Error('Expected step.');
      this.contentElement.dispatchEvent(new Pe(t, e.data));
    }
    #n(e) {
      switch (e.itemValue) {
        case 'add-step-before': {
          let t = this.#e.step || this.#e.section;
          if (!t) throw new Error('Expected step or section.');
          this.contentElement.dispatchEvent(new me(t, 'before'));
          break;
        }
        case 'add-step-after': {
          let t = this.#e.step || this.#e.section;
          if (!t) throw new Error('Expected step or section.');
          this.contentElement.dispatchEvent(new me(t, 'after'));
          break;
        }
        case 'remove-step': {
          let t = this.#e.section?.causingStep;
          if (!this.#e.step && !t) throw new Error('Expected step.');
          this.contentElement.dispatchEvent(new Ve(this.#e.step || t));
          break;
        }
        case 'add-breakpoint': {
          if (!this.#e.step) throw new Error('Expected step');
          this.contentElement.dispatchEvent(new fe(this.#e.stepIndex));
          break;
        }
        case 'remove-breakpoint': {
          if (!this.#e.step) throw new Error('Expected step');
          this.contentElement.dispatchEvent(new ve(this.#e.stepIndex));
          break;
        }
        default: {
          let t = e.itemValue;
          if (!t.startsWith(W)) throw new Error('Unknown step action.');
          let o = this.#e.step || this.#e.section?.causingStep;
          if (!o) throw new Error('Step not found.');
          let i = t.substring(W.length);
          (this.#e.recorderSettings && (this.#e.recorderSettings.preferredCopyFormat = i),
            this.contentElement.dispatchEvent(new De(structuredClone(o))));
        }
      }
    }
    #l() {
      (this.#e.hasBreakpoint
        ? this.contentElement.dispatchEvent(new ve(this.#e.stepIndex))
        : this.contentElement.dispatchEvent(new fe(this.#e.stepIndex)),
        this.requestUpdate());
    }
      ...
      if (
        (this.#e.isPlaying ||
          (this.#e.step &&
            e.push({
              id: 'add-step-before',
              label: d(c.addStepBefore),
              group: 'stepManagement',
              groupTitle: d(c.stepManagement),
            }),
          e.push({
            id: 'add-step-after',
            label: d(c.addStepAfter),
            group: 'stepManagement',
            groupTitle: d(c.stepManagement),
          }),
          this.#e.removable &&
        ...
        this.#e.step &&
          ...
          (this.#e.hasBreakpoint
            ? e.push({
                ...
                label: d(c.removeBreakpoint),
                group: 'breakPointManagement',
                groupTitle: d(c.breakpoints),
              })
            : e.push({
                id: 'add-breakpoint',
                label: d(c.addBreakpoint),
                group: 'breakPointManagement',
                groupTitle: d(c.breakpoints),
              })),
        this.#e.step)
      ) {
        for (let t of this.#e.builtInConverters || [])
          e.push({
            id: W + dt.StringUtilities.toKebabCase(t.getId()),
            label: t.getFormatName(),
            group: 'copy',
            groupTitle: d(c.copyAs),
          });
        for (let t of this.#e.extensionConverters || [])
          e.push({
            id: W + dt.StringUtilities.toKebabCase(t.getId()),
            label: t.getFormatName(),
            group: 'copy',
            groupTitle: d(c.copyAs),
            jslogContext: W + 'extension',
          });
      }
      return e;
    };
    #c(e) {
      let t = this.#d(),
        o = t.filter((n) => n.id.startsWith(W)),
        i = t.filter((n) => !n.id.startsWith(W));
      for (let n of i)
        e.section(n.group).appendItem(
          n.label,
          () => {
            this.#n(new Ae.Menu.MenuItemSelectedEvent(n.id));
          },
          { jslogContext: n.id },
        );
      let r = o.find((n) => n.id === W + this.#e.recorderSettings?.preferredCopyFormat);
      if (
        (r &&
          e.section('copy').appendItem(
            r.label,
            () => {
              this.#n(new Ae.Menu.MenuItemSelectedEvent(r.id));
            },
            { jslogContext: r.id },
          ),
        o.length)
      ) {
        let n = e.section('copy').appendSubMenuItem(d(c.copyAs), !1, 'copy');
        for (let a of o)
          a !== r &&
            n.section(a.group).appendItem(
              a.label,
              () => {
                this.#n(new Ae.Menu.MenuItemSelectedEvent(a.id));
              },
              { jslogContext: a.id },
            );
      }
    ...
    performUpdate() {
      ((this.#e.actions = this.#d()), this.#s(this.#e, void 0, this.contentElement));
    }
  };
var { html: l } = $,
  { widget: Oe } = G.Widget,
  ...
  Bs = ne.i18n.registerUIStrings('panels/recorder/components/RecordingView.ts', p),
  u = ne.i18n.getLocalizedString.bind(void 0, Bs),
  ht = [
    V.NetworkManager.NoThrottlingConditions,
    V.NetworkManager.OfflineConditions,
    V.NetworkManager.Slow3GConditions,
    V.NetworkManager.Slow4GConditions,
    V.NetworkManager.Fast4GConditions,
  ];
function qs({
  settings: s,
  replaySettingsExpanded: e,
  onSelectMenuLabelClick: t,
  onNetworkConditionsChange: o,
  onTimeoutInput: i,
  isRecording: r,
  replayState: n,
  onReplaySettingsKeydown: a,
  onToggleReplaySettings: g,
}) {
  if (!s) return $.nothing;
  let I = [];
  s.viewportSettings &&
    (I.push(l`<div>${s.viewportSettings.isMobile ? u(p.mobile) : u(p.desktop)}</div>`),
    I.push(l`<div class="separator"></div>`),
    I.push(l`<div>${s.viewportSettings.width}×${s.viewportSettings.height} px</div>`));
  let y = [];
  if (!e)
    (s.networkConditionsSettings
      ? s.networkConditionsSettings.title
        ? y.push(l`<div>${s.networkConditionsSettings.title}</div>`)
        : y.push(l`<div>
      ...
      : y.push(
          l`<div>${V.NetworkManager.NoThrottlingConditions.title instanceof Function ? V.NetworkManager.NoThrottlingConditions.title() : V.NetworkManager.NoThrottlingConditions.title}</div>`,
        ),
      y.push(l`<div class="separator"></div>`),
      y.push(
        l`<div>${u(p.timeout, { value: s.timeout || O.RecordingPlayer.defaultTimeout })}</div>`,
      ));
  else {
    let b =
        s.networkConditionsSettings?.i18nTitleKey ||
        V.NetworkManager.NoThrottlingConditions.i18nTitleKey,
      _ = ht.find((q) => q.i18nTitleKey === b),
      ft = '';
    (_ && (ft = _.title instanceof Function ? _.title() : _.title),
      y.push(l`<div class="editable-setting">
  ...
  let v = !r && !n.isPlaying,
    S = { 'settings-title': !0, expanded: e },
    R = { expanded: e, settings: !0 };
  return l`
        ...
        >
          ...
          <div slot="sidebar" jslog=${h.pane('source-code').track({ resize: !0 })}>
            ...
            <div class="section-toolbar" jslog=${h.toolbar()}>
              ...
              >
                ${s.builtInConverters.map(
                  (t) => l`<devtools-menu-item
                    .value=${t.getId()}
                    .selected=${s.converterId === t.getId()}
                    jslog=${h
                      .action()
                      .track({ click: !0 })
                      .context(`converter-${mt.StringUtilities.toKebabCase(t.getId())}`)}
                  >
                    ${t.getFormatName()}
                  </devtools-menu-item>`,
                )}
                ${s.extensionConverters.map(
                  (t) => l`<devtools-menu-item
                    .value=${t.getId()}
                    .selected=${s.converterId === t.getId()}
...
function Ks(s, e) {
  ...
  return l`
    <div class="text-editor" jslog=${h.textField().track({ change: !0 })}>
      <devtools-text-editor .state=${s.editorState} ${$.Directives.ref((t) => {
        !t ||
          !(t instanceof Fe.TextEditor.TextEditor) ||
          (e.highlightLinesInEditor = (o, i, r = !1) => {
            let n = t.editor,
              a = t.createSelection(
                { lineNumber: o + i, columnNumber: 0 },
                { lineNumber: o, columnNumber: 0 },
              ),
              g = t.state.doc.lineAt(a.main.anchor);
            ((a = t.createSelection(
              { lineNumber: o + i - 1, columnNumber: g.length + 1 },
              { lineNumber: o, columnNumber: 0 },
            )),
              n.dispatch({
                selection: a,
                effects: r ? [ae.EditorView.scrollIntoView(a.main, { y: 'nearest' })] : void 0,
              }));
          });
...
function Hs(s) {
  return s.replayState.isPlaying
    ? l`
        <devtools-button .jslogContext=${'abort-replay'} @click=${s.onAbortReplay} .iconName=${'pause'} .variant=${'outlined'}>
          ${u(p.cancelReplay)}
        </devtools-button>`
    : s.recorderSettings
      ? l`${Oe(le, { settings: s.recorderSettings, replayExtensions: s.replayExtensions, onStartReplay: s.onTogglePlaying, disabled: s.replayState.isPlaying })}`
      : $.nothing;
}
function Gs(s) {
  return l`
            ...
            <div class="section">
              ...
              <div class="content">
                <div class="steps">
                  ...
                  ${e.steps.map((o) => {
                    let i = s.recording.steps.indexOf(o);
                    return l`
                      <devtools-widget
                  ...
                  ${
                    !s.recordingTogglingInProgress && s.isRecording && t === s.sections.length - 1
                      ? l`<devtools-button
                  ...
                  >${u(p.addAssertion)}</devtools-button>`
                      : void 0
                  }
...
function _s(s) {
  if (!s.recording) return $.nothing;
  let { title: e } = s.recording,
    t = !s.replayState.isPlaying && !s.isRecording;
  return l`
    <div class="header">
      <div class="header-title-wrapper">
        ...
        ${
          s.isTitleInvalid
            ? l`<div class="title-input-error-text">
...
var as = (s, e, t) => {
    let o = {
        wrapper: !0,
        'is-recording': s.isRecording,
        'is-playing': s.replayState.isPlaying,
        'was-successful': s.lastReplayResult === 'Success',
        'was-failure': s.lastReplayResult === 'Failure',
      },
      i = s.recordingTogglingInProgress ? u(p.recordingIsBeingStopped) : u(p.endRecording);
    $.render(
      l`
    ...
    <div @click=${s.onWrapperClick} class=${$.Directives.classMap(o)}>
      <div class="recording-view main">
        ${_s(s)}
        ${
          s.extensionDescriptor
            ? l`
            <devtools-recorder-extension-view .descriptor=${s.extensionDescriptor}></devtools-recorder-extension-view>`
            : l`
          ${qs(s)}
          ${zs(s, e)}
        `
  ...
  gt = class extends G.Widget.Widget {
    replayState = { isPlaying: !1, isPausedOnBreakpoint: !1 };
    isRecording = !1;
    recordingTogglingInProgress = !1;
    ...
    set recorderSettings(e) {
      ((this.#t = e),
        (this.#l = this.recorderSettings?.preferredCopyFormat ?? this.#e[0]?.getId()),
        this.#b());
    }
    #e = [];
    ...
    #r = {};
    constructor(e, t) {
      (super(e, { useShadowDom: !0 }), (this.#u = t || as));
    }
    performUpdate() {
      let e =
        [...(this.builtInConverters || []), ...(this.extensionConverters || [])].find(
          (t) => t.getId() === this.#l,
      ...
      this.#u(
        {
          ...
          replaySettingsExpanded: this.#i,
          replayState: this.replayState,
          sections: this.sections,
          selectedStep: this.#o ?? null,
          ...
          getSectionState: this.#g.bind(this),
          getStepState: this.#h.bind(this),
          onAbortReplay: () => {
            this.abortReplay?.();
          },
          onMeasurePerformanceClick: this.#M.bind(this),
          onTogglePlaying: (t, o) => {
            this.playRecording?.({ targetPanel: 'chrome-recorder', speed: t, extension: o });
          },
          onCodeFormatChange: this.#U.bind(this),
          onCopyStep: this.#R.bind(this),
          onEditTitleButtonClick: this.#T.bind(this),
          onNetworkConditionsChange: this.#$.bind(this),
          onReplaySettingsKeydown: this.#v.bind(this),
          onSelectMenuLabelClick: this.#I.bind(this),
          onStepClick: this.#f.bind(this),
          onStepHover: this.#m.bind(this),
          onTimeoutInput: this.#k.bind(this),
          onTitleBlur: this.#E.bind(this),
          onTitleInputKeyDown: this.#C.bind(this),
          onToggleReplaySettings: this.#w.bind(this),
          onWrapperClick: this.#y.bind(this),
    ...
    wasShown() {
      (super.wasShown(), document.addEventListener('copy', this.#p), this.performUpdate());
    }
    willHide() {
      (super.willHide(), document.removeEventListener('copy', this.#p));
    }
    scrollToBottom() {
      let e = this.contentElement?.querySelector('.sections');
      e && (e.scrollTop = e.scrollHeight);
    }
    #h(e) {
      if (!this.currentStep) return 'default';
        ...
        return this.currentError
          ...
          : this.replayState?.isPlaying
            ? this.replayState?.isPausedOnBreakpoint
              ...
              : 'current'
            : 'success';
      let t = this.recording.steps.indexOf(this.currentStep);
      return t === -1 ? 'default' : this.recording.steps.indexOf(e) < t ? 'success' : 'outstanding';
    }
    #g(e) {
      let t = this.currentStep;
      if (!t) return 'default';
      let o = this.sections.find((n) => n.steps.includes(t));
      if (!o && this.currentError) return 'error';
      if (e === o) return 'success';
      let i = this.sections.indexOf(o),
        r = this.sections.indexOf(e);
      return i >= r ? 'success' : 'outstanding';
    }
    #m = (e) => {
      let t = 'type' in e ? e : e.causingStep;
      !t || this.#o || this.#x(t);
    };
    #f(e) {
      let t = 'type' in e ? e : e.causingStep || null;
      this.#o !== t && ((this.#o = t), this.performUpdate(), t && this.#x(t, !0));
    }
    #y() {
      this.#o && ((this.#o = null), this.performUpdate());
    }
    #v(e) {
      e.key === 'Enter' && (e.preventDefault(), this.#w(e));
    }
    #w(e) {
      (e.stopPropagation(), (this.#i = !this.#i), this.performUpdate());
    }
    #$(e) {
      let t = e.target;
      if (t instanceof HTMLSelectElement) {
        let o = ht.find((i) => i.i18nTitleKey === t.value);
        this.networkConditionsChanged?.(
          o?.i18nTitleKey === V.NetworkManager.NoThrottlingConditions.i18nTitleKey ? void 0 : o,
        );
      }
    }
    #k(e) {
      ...
      this.timeoutChanged?.(Number(t.value));
    }
    #E = (e) => {
      let o = e.target.value.trim();
      if (!o) {
        ((this.#s = !0), this.performUpdate());
        return;
      }
      this.titleChanged?.(o);
    };
    ...
    #T = () => {
      let e = this.contentElement.querySelector('#title-input');
      if (!e) throw new Error('Missing #title-input');
      e.focus();
    };
    #I = (e) => {
      let t = e.target;
      t.matches('.wrapping-label') && t.querySelector('devtools-select-menu')?.click();
    };
    async #S(e) {
      let t = [...this.builtInConverters, ...this.extensionConverters].find(
        (i) => i.getId() === this.recorderSettings?.preferredCopyFormat,
      );
      if ((t || (t = this.builtInConverters[0]), !t)) throw new Error('No default converter found');
      let o = '';
      (e
        ? (o = await t.stringifyStep(e))
        : this.recording && ([o] = await t.stringify(this.recording)),
        je.InspectorFrontendHost.InspectorFrontendHostInstance.copyText(o));
    }
    #R(e) {
      (e.stopPropagation(), this.#S(e.step));
    }
    async #L(e) {
      e.target === document.body &&
        (e.preventDefault(),
        await this.#S(this.#o),
        je.userMetrics.keyboardShortcutFired('chrome-recorder.copy-recording-or-step'));
    }
    #M(e) {
      (e.stopPropagation(), this.playRecording?.({ targetPanel: 'timeline', speed: 'normal' }));
    }
    showCodeToggle = () => {
      ((this.#a = !this.#a),
        this.#a
          ? G.ARIAUtils.LiveAnnouncer.alert(u(p.codeSidebarOpened))
          : G.ARIAUtils.LiveAnnouncer.alert(u(p.codeSidebarClosed)),
        this.#b());
    };
    #b = async () => {
      ...
      if (!e) return;
      let [t, o] = await e.stringify(this.recording);
      ((this.#n = t), (this.#d = o), this.#d?.shift());
      let i = e.getMediaType(),
        r = i ? await rs.CodeHighlighter.languageFromMIME(i) : null;
      ((this.#c = ae.EditorState.create({
        doc: this.#n,
        extensions: [
          Fe.Config.baseConfiguration(this.#n),
          ae.EditorState.readOnly.of(!0),
          ae.EditorView.lineWrapping,
          r || [],
        ],
      })),
        this.performUpdate(),
    ...
    #x = (e, t = !1) => {
      if (!this.#d) return;
      let o = this.recording.steps.indexOf(e);
      if (o === -1) return;
      let i = this.#d[o * 2],
        r = this.#d[o * 2 + 1];
      this.#r.highlightLinesInEditor?.(i, r, t);
    };
    #U = (e) => {
      ((this.#l = e.itemValue),
        this.recorderSettings && (this.recorderSettings.preferredCopyFormat = e.itemValue),
        this.#b());
    };
  };
export {
  wt as ControlButton,
  $t as CreateRecordingView,
  Rt as RecordingListView,
  ls as RecordingView,
  Ot as ReplaySection,
  Kt as SelectorPicker,
  Jt as StepEditor,
  is as StepView,
  ss as TimelineSection,
};
