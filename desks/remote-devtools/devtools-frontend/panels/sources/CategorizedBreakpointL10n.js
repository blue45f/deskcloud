...
const LOCALIZED_INSTRUMENTATION_NAMES = {
  ['beforeBidderWorkletBiddingStart' /* SDK.EventBreakpointsModel.InstrumentationNames.BEFORE_BIDDER_WORKLET_BIDDING_START */]:
    i18nLazyString(UIStrings.beforeBidderWorkletBiddingStart),
  ['beforeBidderWorkletReportingStart' /* SDK.EventBreakpointsModel.InstrumentationNames.BEFORE_BIDDER_WORKLET_REPORTING_START */]:
    i18nLazyString(UIStrings.beforeBidderWorkletReportingStart),
  ['beforeSellerWorkletScoringStart' /* SDK.EventBreakpointsModel.InstrumentationNames.BEFORE_SELLER_WORKLET_SCORING_START */]:
    i18nLazyString(UIStrings.beforeSellerWorkletScoringStart),
  ['beforeSellerWorkletReportingStart' /* SDK.EventBreakpointsModel.InstrumentationNames.BEFORE_SELLER_WORKLET_REPORTING_START */]:
    i18nLazyString(UIStrings.beforeSellerWorkletReportingStart),
  ['setTimeout' /* SDK.EventBreakpointsModel.InstrumentationNames.SET_TIMEOUT */]:
    i18n.i18n.lockedLazyString('setTimeout'),
  ['clearTimeout' /* SDK.EventBreakpointsModel.InstrumentationNames.CLEAR_TIMEOUT */]:
    i18n.i18n.lockedLazyString('clearTimeout'),
  ['setTimeout.callback' /* SDK.EventBreakpointsModel.InstrumentationNames.SET_TIMEOUT_CALLBACK */]:
    i18nLazyString(UIStrings.setTimeoutOrIntervalFired, { PH1: 'setTimeout' }),
  ['setInterval' /* SDK.EventBreakpointsModel.InstrumentationNames.SET_INTERVAL */]:
    i18n.i18n.lockedLazyString('setInterval'),
  ['clearInterval' /* SDK.EventBreakpointsModel.InstrumentationNames.CLEAR_INTERVAL */]:
    i18n.i18n.lockedLazyString('clearInterval'),
  ['setInterval.callback' /* SDK.EventBreakpointsModel.InstrumentationNames.SET_INTERVAL_CALLBACK */]:
    i18nLazyString(UIStrings.setTimeoutOrIntervalFired, { PH1: 'setInterval' }),
  ['scriptFirstStatement' /* SDK.EventBreakpointsModel.InstrumentationNames.SCRIPT_FIRST_STATEMENT */]:
    i18nLazyString(UIStrings.scriptFirstStatement),
  ['scriptBlockedByCSP' /* SDK.EventBreakpointsModel.InstrumentationNames.SCRIPT_BLOCKED_BY_CSP */]:
    i18nLazyString(UIStrings.scriptBlockedByContentSecurity),
  ['sharedStorageWorkletScriptFirstStatement' /* SDK.EventBreakpointsModel.InstrumentationNames.SHARED_STORAGE_WORKLET_SCRIPT_FIRST_STATEMENT */]:
    i18nLazyString(UIStrings.scriptFirstStatement),
  ['requestAnimationFrame' /* SDK.EventBreakpointsModel.InstrumentationNames.REQUEST_ANIMATION_FRAME */]:
    i18nLazyString(UIStrings.requestAnimationFrame),
  ['cancelAnimationFrame' /* SDK.EventBreakpointsModel.InstrumentationNames.CANCEL_ANIMATION_FRAME */]:
    i18nLazyString(UIStrings.cancelAnimationFrame),
  ['requestAnimationFrame.callback' /* SDK.EventBreakpointsModel.InstrumentationNames.REQUEST_ANIMATION_FRAME_CALLBACK */]:
    i18nLazyString(UIStrings.animationFrameFired),
  ['webglErrorFired' /* SDK.EventBreakpointsModel.InstrumentationNames.WEBGL_ERROR_FIRED */]:
    i18nLazyString(UIStrings.webglErrorFired),
  ['webglWarningFired' /* SDK.EventBreakpointsModel.InstrumentationNames.WEBGL_WARNING_FIRED */]:
    i18nLazyString(UIStrings.webglWarningFired),
  ['Element.setInnerHTML' /* SDK.EventBreakpointsModel.InstrumentationNames.ELEMENT_SET_INNER_HTML */]:
    i18nLazyString(UIStrings.setInnerhtml),
  ['canvasContextCreated' /* SDK.EventBreakpointsModel.InstrumentationNames.CANVAS_CONTEXT_CREATED */]:
    i18nLazyString(UIStrings.createCanvasContext),
  ['Geolocation.getCurrentPosition' /* SDK.EventBreakpointsModel.InstrumentationNames.GEOLOCATION_GET_CURRENT_POSITION */]:
    i18n.i18n.lockedLazyString('getCurrentPosition'),
  ['Geolocation.watchPosition' /* SDK.EventBreakpointsModel.InstrumentationNames.GEOLOCATION_WATCH_POSITION */]:
    i18n.i18n.lockedLazyString('watchPosition'),
  ['Notification.requestPermission' /* SDK.EventBreakpointsModel.InstrumentationNames.NOTIFICATION_REQUEST_PERMISSION */]:
    i18n.i18n.lockedLazyString('requestPermission'),
  ['DOMWindow.close' /* SDK.EventBreakpointsModel.InstrumentationNames.DOM_WINDOW_CLOSE */]:
    i18n.i18n.lockedLazyString('globalThis.close'),
  ['Document.write' /* SDK.EventBreakpointsModel.InstrumentationNames.DOCUMENT_WRITE */]:
    i18n.i18n.lockedLazyString('document.write'),
  ['audioContextCreated' /* SDK.EventBreakpointsModel.InstrumentationNames.AUDIO_CONTEXT_CREATED */]:
    i18nLazyString(UIStrings.createAudiocontext),
  ['audioContextClosed' /* SDK.EventBreakpointsModel.InstrumentationNames.AUDIO_CONTEXT_CLOSED */]:
    i18nLazyString(UIStrings.closeAudiocontext),
  ['audioContextResumed' /* SDK.EventBreakpointsModel.InstrumentationNames.AUDIO_CONTEXT_RESUMED */]:
    i18nLazyString(UIStrings.resumeAudiocontext),
  ['audioContextSuspended' /* SDK.EventBreakpointsModel.InstrumentationNames.AUDIO_CONTEXT_SUSPENDED */]:
    i18nLazyString(UIStrings.suspendAudiocontext),
};
const LOCALIZED_CSP_VIOLATION_TYPES = {
  ['trustedtype-policy-violation' /* Protocol.DOMDebugger.CSPViolationType.TrustedtypePolicyViolation */]:
    i18nLazyString(UIStrings.policyViolations),
  ['trustedtype-sink-violation' /* Protocol.DOMDebugger.CSPViolationType.TrustedtypeSinkViolation */]:
    i18nLazyString(UIStrings.sinkViolations),
};
