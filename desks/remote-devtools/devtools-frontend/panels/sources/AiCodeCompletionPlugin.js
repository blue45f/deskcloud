...
export class AiCodeCompletionPlugin extends Plugin {
  ...
  #aiCodeCompletionDisclaimerToolbarItem = new UI.Toolbar.ToolbarItem(
    this.#aiCodeCompletionDisclaimerContainer,
  );
  ...
  constructor(uiSourceCode) {
    ...
    this.#aiCodeCompletionProvider =
      TextEditor.AiCodeCompletionProvider.AiCodeCompletionProvider.createInstance(
        this.aiCodeCompletionConfig,
      );
    this.#aiCodeCompletionDisclaimerContainer.classList.add(
      'ai-code-completion-disclaimer-container',
    );
  ...
  #createAiCodeCompletionDisclaimer() {
    ...
    this.#aiCodeCompletionDisclaimer.panel =
      'sources' /* AiCodeCompletion.AiCodeCompletion.ContextFlavor.SOURCES */;
    this.#aiCodeCompletionDisclaimer.show(
      this.#aiCodeCompletionDisclaimerContainer,
      undefined,
      true,
    );
  ...
  #createAiCodeCompletionCitationsToolbar() {
    ...
    this.#aiCodeCompletionCitationsToolbar.show(
      this.#aiCodeCompletionCitationsToolbarContainer,
      undefined,
      true,
    );
  }
