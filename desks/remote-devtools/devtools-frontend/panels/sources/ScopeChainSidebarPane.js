...
export class ScopeChainSidebarPane extends UI.Widget.VBox {
  ...
  flavorChanged(callFrame) {
    ...
    if (callFrame) {
      ...
      this.#scopeChainModel = new SourceMapScopes.ScopeChainModel.ScopeChainModel(
        callFrame.sdkFrame,
      );
      this.#scopeChainModel.addEventListener(
        'ScopeChainUpdated' /* SourceMapScopes.ScopeChainModel.Events.SCOPE_CHAIN_UPDATED */,
  ...
  createScopeSectionTreeElement(scope) {
    ...
    titleElement.createChild('div', 'scope-chain-sidebar-pane-section-subtitle').textContent =
      subtitle;
    titleElement.createChild('div', 'scope-chain-sidebar-pane-section-title').textContent = title;
    const root = new ObjectUI.ObjectPropertiesSection.ObjectTree(scope.object(), {
