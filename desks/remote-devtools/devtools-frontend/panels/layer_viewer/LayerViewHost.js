...
export class LayerSelection extends Selection {
  ...
  isEqual(other) {
    return (
      other.typeInternal === 'Layer' /* Type.LAYER */ && other.layer().id() === this.layer().id()
    );
  }
}
export class ScrollRectSelection extends Selection {
  ...
  isEqual(other) {
    return (
      other.typeInternal === 'ScrollRect' /* Type.SCROLL_RECT */ &&
...
export class SnapshotSelection extends Selection {
  ...
  isEqual(other) {
    return (
      other.typeInternal === 'Snapshot' /* Type.SNAPSHOT */ &&
      this.layer().id() === other.layer().id() &&
...
export class LayerViewHost {
  ...
  constructor() {
    ...
    this.#showInternalLayersSetting = Common.Settings.Settings.instance().createSetting(
