...
export class TransformController extends Common.ObjectWrapper.ObjectWrapper {
  ...
  constructor(element, disableRotate, preventDefaultOnMouseDown = true) {
    ...
    if (!disableRotate) {
      ...
      panModeButton.addEventListener(
        ...
        this.setMode.bind(this, 'Pan' /* Modes.PAN */),
      );
      ...
      const rotateModeButton = new UI.Toolbar.ToolbarToggle(
        i18nString(UIStrings.rotateModeV),
        '3d-rotate',
        undefined,
        'layers.3d-rotate',
        /* toggleOnClick */ false,
      ...
      rotateModeButton.addEventListener(
        'Click' /* UI.Toolbar.ToolbarButton.Events.CLICK */,
        this.setMode.bind(this, 'Rotate' /* Modes.ROTATE */),
      );
    ...
    const resetButton = new UI.Toolbar.ToolbarButton(
      i18nString(UIStrings.resetTransform),
      '3d-center',
      undefined,
      'layers.3d-center',
    );
    resetButton.addEventListener(
      'Click' /* UI.Toolbar.ToolbarButton.Events.CLICK */,
      this.resetAndNotify.bind(this, undefined),
    );
  ...
  onScale(scaleFactor, x, y) {
    scaleFactor =
      Platform.NumberUtilities.clamp(this.#scale * scaleFactor, this.minScale, this.maxScale) /
      this.#scale;
