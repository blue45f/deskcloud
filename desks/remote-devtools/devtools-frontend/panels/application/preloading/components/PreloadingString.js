...
const str_ = i18n.i18n.registerUIStrings(
  'panels/application/preloading/components/PreloadingString.ts',
  UIStrings,
);
...
export const PrefetchReasonDescription = {
  PrefetchFailedIneligibleRedirect: {
    name: i18nLazyString(UIStrings.PrefetchFailedIneligibleRedirect),
  },
  PrefetchFailedInvalidRedirect: { name: i18nLazyString(UIStrings.PrefetchFailedInvalidRedirect) },
  PrefetchFailedMIMENotSupported: {
    name: i18nLazyString(UIStrings.PrefetchFailedMIMENotSupported),
  },
  ...
  PrefetchNotEligibleDataSaverEnabled: {
    name: i18nLazyString(UIStrings.PrefetchNotEligibleDataSaverEnabled),
  },
  PrefetchNotEligibleExistingProxy: {
    name: i18nLazyString(UIStrings.PrefetchNotEligibleExistingProxy),
  },
  PrefetchNotEligibleHostIsNonUnique: {
    name: i18nLazyString(UIStrings.PrefetchNotEligibleHostIsNonUnique),
  },
  PrefetchNotEligibleNonDefaultStoragePartition: {
  ...
  PrefetchNotEligibleSchemeIsNotHttps: {
    name: i18nLazyString(UIStrings.PrefetchNotEligibleSchemeIsNotHttps),
  },
  PrefetchNotEligibleUserHasCookies: {
    name: i18nLazyString(UIStrings.PrefetchNotEligibleUserHasCookies),
  },
  PrefetchNotEligibleUserHasServiceWorker: {
    name: i18nLazyString(UIStrings.PrefetchNotEligibleUserHasServiceWorker),
  },
  ...
  PrefetchEvictedForNewerPrefetch: {
    name: i18nLazyString(UIStrings.PrefetchEvictedForNewerPrefetch),
  },
  PrefetchEvictedAfterCandidateRemoved: {
    name: i18nLazyString(UIStrings.PrefetchEvictedAfterCandidateRemoved),
  },
  PrefetchNotEligibleBatterySaverEnabled: {
    name: i18nLazyString(UIStrings.PrefetchNotEligibleBatterySaverEnabled),
  },
  PrefetchNotEligiblePreloadingDisabled: {
    name: i18nLazyString(UIStrings.PrefetchNotEligiblePreloadingDisabled),
  },
  PrefetchNotEligibleUserHasServiceWorkerNoFetchHandler: {
    name: () => i18n.i18n.lockedString('Unknown'),
  },
  ...
  PrefetchEvictedAfterBrowsingDataRemoved: {
    name: i18nLazyString(UIStrings.PrefetchEvictedAfterBrowsingDataRemoved),
  },
};
  ...
  switch (prefetchStatus) {
    ...
    case 'PrefetchFailedNon2XX' /* Protocol.Preload.PrefetchStatus.PrefetchFailedNon2XX */:
      if (statusCode !== undefined) {
        return i18nString(UIStrings.PrefetchFailedNon2XXWithStatusCode, {
    ...
    case 'PrefetchNotEligibleSameSiteCrossOriginPrefetchRequiredProxy' /* Protocol.Preload.PrefetchStatus.PrefetchNotEligibleSameSiteCrossOriginPrefetchRequiredProxy */:
      return PrefetchReasonDescription[
        'PrefetchNotEligibleSameSiteCrossOriginPrefetchRequiredProxy'
      ].name();
  ...
  switch (attempt.prerenderStatus) {
    ...
    case 'MojoBinderPolicy' /* Protocol.Preload.PrerenderFinalStatus.MojoBinderPolicy */:
      ...
      return i18nString(UIStrings.prerenderFinalStatusMojoBinderPolicy, {
        PH1: attempt.disallowedMojoInterface,
      });
    ...
    case 'NavigationBadHttpStatus' /* Protocol.Preload.PrerenderFinalStatus.NavigationBadHttpStatus */:
      if (statusCode !== undefined) {
        return i18nString(UIStrings.prerenderFinalStatusNavigationBadHttpStatusWithStatusCode, {
          PH1: String(statusCode),
        });
      }
    ...
    case 'SameSiteCrossOriginRedirectNotOptInInInitialNavigation' /* Protocol.Preload.PrerenderFinalStatus.SameSiteCrossOriginRedirectNotOptInInInitialNavigation */:
      return i18nString(
        UIStrings.prerenderFinalStatusSameSiteCrossOriginRedirectNotOptInInInitialNavigation,
      );
    case 'SameSiteCrossOriginNavigationNotOptInInInitialNavigation' /* Protocol.Preload.PrerenderFinalStatus.SameSiteCrossOriginNavigationNotOptInInInitialNavigation */:
      return i18nString(
        UIStrings.prerenderFinalStatusSameSiteCrossOriginNavigationNotOptInInInitialNavigation,
      );
    ...
    case 'SameSiteCrossOriginRedirectNotOptInInMainFrameNavigation' /* Protocol.Preload.PrerenderFinalStatus.SameSiteCrossOriginRedirectNotOptInInMainFrameNavigation */:
      return i18nString(
        UIStrings.prerenderFinalStatusSameSiteCrossOriginRedirectNotOptInInMainFrameNavigation,
      );
    case 'SameSiteCrossOriginNavigationNotOptInInMainFrameNavigation' /* Protocol.Preload.PrerenderFinalStatus.SameSiteCrossOriginNavigationNotOptInInMainFrameNavigation */:
      return i18nString(
        UIStrings.prerenderFinalStatusSameSiteCrossOriginNavigationNotOptInInMainFrameNavigation,
      );
...
export function composedStatus(attempt, statusCode) {
  ...
  switch (attempt.action) {
    case 'Prefetch' /* Protocol.Preload.SpeculationAction.Prefetch */: {
      const detail =
        prefetchFailureReason(attempt, statusCode) ?? i18n.i18n.lockedString('Internal error');
      return short + ' - ' + detail;
    }
    case 'Prerender' /* Protocol.Preload.SpeculationAction.Prerender */:
    case 'PrerenderUntilScript' /* Protocol.Preload.SpeculationAction.PrerenderUntilScript */: {
