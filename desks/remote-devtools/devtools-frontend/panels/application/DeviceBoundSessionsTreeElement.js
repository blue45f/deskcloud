...
const str_ = i18n.i18n.registerUIStrings(
  'panels/application/DeviceBoundSessionsTreeElement.ts',
  UIStrings,
);
    ...
    for (const [site, noLongerFailedSessionIds] of noLongerFailedSessions) {
      ...
      if (siteData) {
        for (const noLongerFailedSessionId of noLongerFailedSessionIds) {
          ...
          if (sessionElement) {
            const isSessionTerminated = this.#model.isSessionTerminated(
              site,
              noLongerFailedSessionId,
            );
