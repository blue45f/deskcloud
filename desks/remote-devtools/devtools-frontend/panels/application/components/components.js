...
var f = (t, e) => {
  for (var a in e) Gt(t, a, { get: e[a], enumerable: !0 });
};
var tt = {};
f(tt, { BackForwardCacheView: () => ye });
...
import { html as g, nothing as T, render as Xt } from './../../../ui/lit/lit.js';
import * as S from './../../../ui/visual_logging/visual_logging.js';
...
var o = {
    ...
    relatedActiveContentsExist:
      "The page was opened using '`globalThis.open()`' and another tab has a reference to it, or the page opened a globalThis.",
    ...
    serviceWorkerVersionActivation:
      'The page was evicted from back/forward cache due to a service worker activation.',
    ...
    serviceWorkerClaim:
      'The page was claimed by a service worker while it is in back/forward cache.',
    haveInnerContents:
    ...
    backForwardCacheDisabledByLowMemory:
      'Back/forward cache is disabled due to insufficient memory.',
    ...
    sharedWorkerMessage:
      'The page was evicted from the cache because it received a message from a SharedWorker',
    ...
    pictureInPicture:
      'Pages that use Picture-in-Picture are not currently eligible for back/forward cache.',
    speechRecognizer:
      'Pages that use SpeechRecognizer are not currently eligible for back/forward cache.',
    idleManager: 'Pages that use IdleManager are not currently eligible for back/forward cache.',
    paymentManager:
      'Pages that use PaymentManager are not currently eligible for back/forward cache.',
    speechSynthesis:
    ...
    contentSecurityHandler:
      'Pages that use SecurityHandler are not eligible for back/forward cache.',
    ...
    contentFileSystemAccess:
      'Pages that use File System Access API are not eligible for back/forward cache.',
    ...
    embedderSafeBrowsingTriggeredPopupBlocker:
      'Safe Browsing considered this page to be abusive and blocked popup.',
    ...
    embedderDomDistillerSelfDeletingRequestDelegate:
      'DOM distillation was in progress upon navigating away.',
    embedderOomInterventionTabHelper:
      'Out-Of-Memory Intervention bar was present upon navigating away.',
    embedderOfflinePage: 'The offline page was shown upon navigating away.',
    embedderChromePasswordManagerClientBindCredentialManager:
      'Chrome Password Manager was present upon navigating away.',
    ...
    embedderExtensionMessaging:
      'Back/forward cache is disabled due to extensions using messaging API.',
  ...
  Jt = m.i18n.registerUIStrings('panels/application/components/BackForwardCacheStrings.ts', o),
  r = m.i18n.getLazilyComputedLocalizedString.bind(void 0, Jt),
  we = {
    NotPrimaryMainFrame: { name: r(o.notMainFrame) },
    BackForwardCacheDisabled: { name: r(o.backForwardCacheDisabled) },
    RelatedActiveContentsExist: { name: r(o.relatedActiveContentsExist) },
    HTTPStatusNotOK: { name: r(o.HTTPStatusNotOK) },
    SchemeNotHTTPOrHTTPS: { name: r(o.schemeNotHTTPOrHTTPS) },
    Loading: { name: r(o.loading) },
    WasGrantedMediaAccess: { name: r(o.wasGrantedMediaAccess) },
    HTTPMethodNotGET: { name: r(o.HTTPMethodNotGET) },
    SubframeIsNavigating: { name: r(o.subframeIsNavigating) },
    Timeout: { name: r(o.timeout) },
    CacheLimit: { name: r(o.cacheLimit) },
    JavaScriptExecution: { name: r(o.JavaScriptExecution) },
    RendererProcessKilled: { name: r(o.rendererProcessKilled) },
    RendererProcessCrashed: { name: r(o.rendererProcessCrashed) },
    GrantedMediaStreamAccess: { name: r(o.grantedMediaStreamAccess) },
    CacheFlushed: { name: r(o.cacheFlushed) },
    ServiceWorkerVersionActivation: { name: r(o.serviceWorkerVersionActivation) },
    SessionRestored: { name: r(o.sessionRestored) },
    ServiceWorkerPostMessage: { name: r(o.serviceWorkerPostMessage) },
    EnteredBackForwardCacheBeforeServiceWorkerHostAdded: {
      name: r(o.enteredBackForwardCacheBeforeServiceWorkerHostAdded),
    },
    ServiceWorkerClaim: { name: r(o.serviceWorkerClaim) },
    HaveInnerContents: { name: r(o.haveInnerContents) },
    TimeoutPuttingInCache: { name: r(o.timeoutPuttingInCache) },
    BackForwardCacheDisabledByLowMemory: { name: r(o.backForwardCacheDisabledByLowMemory) },
    BackForwardCacheDisabledByCommandLine: { name: r(o.backForwardCacheDisabledByCommandLine) },
    NetworkRequestDatapipeDrainedAsBytesConsumer: {
      name: r(o.networkRequestDatapipeDrainedAsBytesConsumer),
    },
    NetworkRequestRedirected: { name: r(o.networkRequestRedirected) },
    NetworkRequestTimeout: { name: r(o.networkRequestTimeout) },
    NetworkExceedsBufferLimit: { name: r(o.networkExceedsBufferLimit) },
    NavigationCancelledWhileRestoring: { name: r(o.navigationCancelledWhileRestoring) },
    BackForwardCacheDisabledForPrerender: { name: r(o.backForwardCacheDisabledForPrerender) },
    UserAgentOverrideDiffers: { name: r(o.userAgentOverrideDiffers) },
    ForegroundCacheLimit: { name: r(o.foregroundCacheLimit) },
    BackForwardCacheDisabledForDelegate: { name: r(o.backForwardCacheDisabledForDelegate) },
    UnloadHandlerExistsInMainFrame: { name: r(o.unloadHandlerExistsInMainFrame) },
    UnloadHandlerExistsInSubFrame: { name: r(o.unloadHandlerExistsInSubFrame) },
    ServiceWorkerUnregistration: { name: r(o.serviceWorkerUnregistration) },
    NoResponseHead: { name: r(o.noResponseHead) },
    CacheControlNoStore: { name: r(o.cacheControlNoStore) },
    CacheControlNoStoreCookieModified: { name: r(o.cacheControlNoStore) },
    CacheControlNoStoreHTTPOnlyCookieModified: { name: r(o.cacheControlNoStore) },
    DisableForRenderFrameHostCalled: { name: r(o.ineligibleAPI) },
    BlocklistedFeatures: { name: r(o.ineligibleAPI) },
    SchedulerTrackedFeatureUsed: { name: r(o.ineligibleAPI) },
    DomainNotAllowed: { name: r(o.internalError) },
    ConflictingBrowsingInstance: { name: r(o.internalError) },
    NotMostRecentNavigationEntry: { name: r(o.internalError) },
    IgnoreEventAndEvict: { name: r(o.internalError) },
    BrowsingInstanceNotSwapped: { name: r(o.internalError) },
    ActivationNavigationsDisallowedForBug1234857: { name: r(o.internalError) },
    Unknown: { name: r(o.internalError) },
    RenderFrameHostReused_SameSite: { name: r(o.internalError) },
    RenderFrameHostReused_CrossSite: { name: r(o.internalError) },
    WebSocket: { name: r(o.webSocket) },
    WebTransport: { name: r(o.webTransport) },
    WebRTC: { name: r(o.webRTC) },
    MainResourceHasCacheControlNoStore: { name: r(o.mainResourceHasCacheControlNoStore) },
    MainResourceHasCacheControlNoCache: { name: r(o.mainResourceHasCacheControlNoCache) },
    SubresourceHasCacheControlNoStore: { name: r(o.subresourceHasCacheControlNoStore) },
    SubresourceHasCacheControlNoCache: { name: r(o.subresourceHasCacheControlNoCache) },
    ContainsPlugins: { name: r(o.containsPlugins) },
    DocumentLoaded: { name: r(o.documentLoaded) },
    DedicatedWorkerOrWorklet: { name: r(o.dedicatedWorkerOrWorklet) },
    OutstandingNetworkRequestOthers: { name: r(o.outstandingNetworkRequestOthers) },
    OutstandingIndexedDBTransaction: { name: r(o.outstandingIndexedDBTransaction) },
    RequestedNotificationsPermission: { name: r(o.requestedNotificationsPermission) },
    RequestedMIDIPermission: { name: r(o.requestedMIDIPermission) },
    RequestedAudioCapturePermission: { name: r(o.requestedAudioCapturePermission) },
    RequestedVideoCapturePermission: { name: r(o.requestedVideoCapturePermission) },
    RequestedBackForwardCacheBlockedSensors: { name: r(o.requestedBackForwardCacheBlockedSensors) },
    RequestedBackgroundWorkPermission: { name: r(o.requestedBackgroundWorkPermission) },
    BroadcastChannel: { name: r(o.broadcastChannel) },
    IndexedDBConnection: { name: r(o.indexedDBConnection) },
    WebXR: { name: r(o.webXR) },
    SharedWorker: { name: r(o.sharedWorker) },
    SharedWorkerMessage: { name: r(o.sharedWorkerMessage) },
    WebLocks: { name: r(o.webLocks) },
    WebHID: { name: r(o.webHID) },
    WebShare: { name: r(o.webShare) },
    RequestedStorageAccessGrant: { name: r(o.requestedStorageAccessGrant) },
    WebNfc: { name: r(o.webNfc) },
    OutstandingNetworkRequestFetch: { name: r(o.outstandingNetworkRequestFetch) },
    OutstandingNetworkRequestXHR: { name: r(o.outstandingNetworkRequestXHR) },
    AppBanner: { name: r(o.appBanner) },
    Printing: { name: r(o.printing) },
    WebDatabase: { name: r(o.webDatabase) },
    PictureInPicture: { name: r(o.pictureInPicture) },
    SpeechRecognizer: { name: r(o.speechRecognizer) },
    IdleManager: { name: r(o.idleManager) },
    PaymentManager: { name: r(o.paymentManager) },
    SpeechSynthesis: { name: r(o.speechSynthesis) },
    KeyboardLock: { name: r(o.keyboardLock) },
    WebOTPService: { name: r(o.webOTPService) },
    OutstandingNetworkRequestDirectSocket: { name: r(o.outstandingNetworkRequestDirectSocket) },
    InjectedJavascript: { name: r(o.injectedJavascript) },
    InjectedStyleSheet: { name: r(o.injectedStyleSheet) },
    Dummy: { name: r(o.internalError) },
    ContentDiscarded: { name: r(o.contentDiscarded) },
    ContentSecurityHandler: { name: r(o.contentSecurityHandler) },
    ContentWebAuthenticationAPI: { name: r(o.contentWebAuthenticationAPI) },
    ContentFileChooser: { name: r(o.contentFileChooser) },
    ContentSerial: { name: r(o.contentSerial) },
    ContentFileSystemAccess: { name: r(o.contentFileSystemAccess) },
    ContentMediaDevicesDispatcherHost: { name: r(o.contentMediaDevicesDispatcherHost) },
    ContentWebBluetooth: { name: r(o.contentWebBluetooth) },
    ContentWebUSB: { name: r(o.contentWebUSB) },
    ContentMediaSession: { name: r(o.contentMediaSession) },
    ContentMediaSessionService: { name: r(o.contentMediaSessionService) },
    ContentMediaPlay: { name: r(o.contentMediaPlay) },
    ContentScreenReader: { name: r(o.contentScreenReader) },
    EmbedderPopupBlockerTabHelper: { name: r(o.embedderPopupBlockerTabHelper) },
    EmbedderSafeBrowsingTriggeredPopupBlocker: {
      name: r(o.embedderSafeBrowsingTriggeredPopupBlocker),
    },
    EmbedderSafeBrowsingThreatDetails: { name: r(o.embedderSafeBrowsingThreatDetails) },
    EmbedderAppBannerManager: { name: r(o.embedderAppBannerManager) },
    EmbedderDomDistillerViewerSource: { name: r(o.embedderDomDistillerViewerSource) },
    EmbedderDomDistillerSelfDeletingRequestDelegate: {
      name: r(o.embedderDomDistillerSelfDeletingRequestDelegate),
    },
    EmbedderOomInterventionTabHelper: { name: r(o.embedderOomInterventionTabHelper) },
    EmbedderOfflinePage: { name: r(o.embedderOfflinePage) },
    EmbedderChromePasswordManagerClientBindCredentialManager: {
      name: r(o.embedderChromePasswordManagerClientBindCredentialManager),
    },
    EmbedderPermissionRequestManager: { name: r(o.embedderPermissionRequestManager) },
    EmbedderModalDialog: { name: r(o.embedderModalDialog) },
    EmbedderExtensions: { name: r(o.embedderExtensions) },
    EmbedderExtensionMessaging: { name: r(o.embedderExtensionMessaging) },
    EmbedderExtensionMessagingForOpenPort: { name: r(o.embedderExtensionMessagingForOpenPort) },
    EmbedderExtensionSentMessageToCachedFrame: {
      name: r(o.embedderExtensionSentMessageToCachedFrame),
    },
    ErrorDocument: { name: r(o.errorDocument) },
    FencedFramesEmbedder: { name: r(o.fencedFramesEmbedder) },
    KeepaliveRequest: { name: r(o.keepaliveRequest) },
    JsNetworkRequestReceivedCacheControlNoStoreResource: {
      name: r(o.jsNetworkRequestReceivedCacheControlNoStoreResource),
    },
    IndexedDBEvent: { name: r(o.indexedDBEvent) },
    CookieDisabled: { name: r(o.cookieDisabled) },
    WebRTCUsedWithCCNS: { name: r(o.webRTCUsedWithCCNS) },
    WebTransportUsedWithCCNS: { name: r(o.webTransportUsedWithCCNS) },
    WebSocketUsedWithCCNS: { name: r(o.webSocketUsedWithCCNS) },
    HTTPAuthRequired: { name: m.i18n.lockedLazyString('HTTPAuthRequired') },
    CookieFlushed: { name: m.i18n.lockedLazyString('CookieFlushed') },
    SmartCard: { name: m.i18n.lockedLazyString('SmartCard') },
    LiveMediaStreamTrack: { name: m.i18n.lockedLazyString('LiveMediaStreamTrack') },
    UnloadHandler: { name: m.i18n.lockedLazyString('UnloadHandler') },
    ParserAborted: { name: m.i18n.lockedLazyString('ParserAborted') },
    BroadcastChannelOnMessage: { name: m.i18n.lockedLazyString('BroadcastChannelOnMessage') },
    RequestedByWebViewClient: { name: m.i18n.lockedLazyString('RequestedByWebViewClient') },
    PostMessageByWebViewClient: { name: m.i18n.lockedLazyString('PostMessageByWebViewClient') },
    WebViewSettingsChanged: { name: m.i18n.lockedLazyString('WebViewSettingsChanged') },
    WebViewJavaScriptObjectChanged: {
      name: m.i18n.lockedLazyString('WebViewJavaScriptObjectChanged'),
    },
    WebViewMessageListenerInjected: {
      name: m.i18n.lockedLazyString('WebViewMessageListenerInjected'),
    },
    WebViewSafeBrowsingAllowlistChanged: {
      name: m.i18n.lockedLazyString('WebViewSafeBrowsingAllowlistChanged'),
    },
    WebViewDocumentStartJavascriptChanged: {
      name: m.i18n.lockedLazyString('WebViewDocumentStartJavascriptChanged'),
    },
    CacheControlNoStoreDeviceBoundSessionTerminated: { name: r(o.cacheControlNoStore) },
    CacheLimitPrunedOnModerateMemoryPressure: {
      name: m.i18n.lockedLazyString('CacheLimitPrunedOnModerateMemoryPressure'),
    },
    CacheLimitPrunedOnCriticalMemoryPressure: {
      name: m.i18n.lockedLazyString('CacheLimitPrunedOnCriticalMemoryPressure'),
    },
  };
var Qe = `devtools-report-value{overflow:hidden}.inline-icon{vertical-align:sub}.gray-text{color:var(--sys-color-token-subtle);margin:0 0 5px 56px;display:flex;flex-direction:row;align-items:center;flex:auto;overflow-wrap:break-word;overflow:hidden;grid-column-start:span 2}.details-list{margin-left:56px;grid-column-start:span 2}.help-outline-icon{margin:0 2px}.circled-exclamation-icon{margin-right:10px;flex-shrink:0}.status{margin-right:11px;flex-shrink:0}.report-line{grid-column-start:span 2;display:flex;align-items:center;margin:0 30px;line-height:26px}.report-key{color:var(--sys-color-token-subtle);min-width:auto;overflow-wrap:break-word;align-self:start}.report-value{padding:0 6px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.link,
...
var l = {
    ...
    framesTitle: 'Frames',
    issuesInSingleFrame:
      '{n, plural, =1 {# issue found in 1 frame.} other {# issues found in 1 frame.}}',
    issuesInMultipleFrames:
      '{n, plural, =1 {# issue found in {m} frames.} other {# issues found in {m} frames.}}',
    framesPerIssue: '{n, plural, =1 {# frame} other {# frames}}',
    blankURLTitle: 'Blank URL [{PH1}]',
    filesPerIssue: '{n, plural, =1 {# file} other {# files}}',
  },
  Yt = Se.i18n.registerUIStrings('panels/application/components/BackForwardCacheView.ts', l),
  c = Se.i18n.getLocalizedString.bind(void 0, Yt),
  { widget: Qt } = X.Widget;
function Zt(t, e, a, n, i) {
  if (!t)
    return g`
      <devtools-report-key>
        ${c(l.mainFrame)}
  ...
  let s = n === 'Running',
    d = Ze.ParsedURL.schemeIs(t.url, 'devtools:');
  return g`
...
function eo(t) {
  if (!t || (t.frameCount === 0 && t.issueCount === 0)) return T;
  function e(n) {
    return g`
  ...
  return (
    t.frameCount === 1
      ? (a = c(l.issuesInSingleFrame, { n: t.issueCount }))
      : (a = c(l.issuesInMultipleFrames, { n: t.issueCount, m: t.frameCount })),
    g`
...
function oo(t, e, a) {
  ...
  let n = t.filter((d) => d.type === 'PageSupportNeeded'),
    i = t.filter((d) => d.type === 'SupportPending'),
    s = t.filter((d) => d.type === 'Circumstantial');
  return g`
    ${ke(c(l.pageSupportNeeded), c(l.pageSupportNeededExplanation), n, a)}
    ${ke(c(l.supportPending), c(l.supportPendingExplanation), i, a)}
    ${ke(c(l.circumstantial), c(l.circumstantialExplanation), s, a)}`;
}
function ke(t, e, a, n) {
  return g`
    ${
...
function ro(t) {
  if (t.reason === 'EmbedderExtensionSentMessageToCachedFrame' && t.context) {
    let e = 'chrome://extensions/?id=' + t.context;
    return g`${c(l.blockingExtensionId)}
      <devtools-link .href=${e}>${t.context}</devtools-link>`;
  }
  return T;
}
function ao(t) {
  if (t === void 0 || t.length === 0) return T;
  let e = [g`<div>${c(l.framesPerIssue, { n: t.length })}</div>`];
  return (
    e.push(
      ...t.map(
        (a) => g`<div class="text-ellipsis" title=${a}
    jslog=${S.treeItem().track({ resize: !0 })}>${a}</div>`,
      ),
    ),
    g`
...
function no(t) {
  return t.reason === 'UnloadHandlerExistsInMainFrame' ||
    t.reason === 'UnloadHandlerExistsInSubFrame'
    ? g`
...
function io(t) {
  if (t === void 0 || t.length === 0) return T;
  let e = 50,
    a = [g`<div>${c(l.filesPerIssue, { n: t.length })}</div>`];
  return (
    a.push(
      ...t.map(
        (n) => g`
          ${Qt(et.Linkifier.ScriptLocationLink, { sourceURL: n.url, lineNumber: n.lineNumber, options: { columnNumber: n.columnNumber, showColumnNumber: !0, inlineFrameIndex: 0, maxLength: e } })}`,
      ),
    ),
    g`
      <div class="details-list">
...
var lo = (t, e, a) => {
  ...
  ye = class extends X.Widget.Widget {
    #t = 'Result';
    #e = 0;
    #o;
    constructor(e = lo) {
      (super({ useShadowDom: !0, delegatesFocus: !0 }),
        (this.#o = e),
        this.#r()?.addEventListener(
          p.ResourceTreeModel.Events.PrimaryPageChanged,
          this.requestUpdate,
          this,
        ),
        this.#r()?.addEventListener(
          p.ResourceTreeModel.Events.BackForwardCacheDetailsUpdated,
          this.requestUpdate,
          this,
        ),
        this.requestUpdate());
    ...
    #r() {
      return (
        p.TargetManager.TargetManager.instance()
          .primaryPageTarget()
          ?.model(p.ResourceTreeModel.ResourceTreeModel) || null
      );
    }
    #a() {
      return this.#r()?.mainFrame || null;
    }
    async performUpdate() {
      let e = new Map(),
        a = this.#a(),
        n = a?.backForwardCacheDetails?.explanationsTree;
      n && this.#c(n, { blankCount: 1 }, e);
      let i = this.#l(n, { blankCount: 1 });
      i.node.iconName = 'frame';
      let s = {
        frame: a,
        frameTreeData: i,
        reasonToFramesMap: e,
        screenStatus: this.#t,
        navigateAwayAndBack: this.#d.bind(this),
      };
    ...
    #n() {
      (p.TargetManager.TargetManager.instance().removeModelListener(
        ...
        p.ResourceTreeModel.Events.FrameNavigated,
        this.#n,
        this,
      ),
        (this.#t = 'Result'),
        ...
        this.updateComplete.then(() => {
          (X.ARIAUtils.LiveAnnouncer.alert(c(l.testCompleted)), this.contentElement.focus());
        }));
    }
    async #i() {
      (p.TargetManager.TargetManager.instance().removeModelListener(
    ...
    async #s(e) {
      let n = p.TargetManager.TargetManager.instance()
          .primaryPageTarget()
          ?.model(p.ResourceTreeModel.ResourceTreeModel),
        i = await n?.navigationHistory();
      !n ||
        !i ||
        (i.currentIndex === this.#e
          ? globalThis.setTimeout(this.#s.bind(this, e * 2), e)
          : (p.TargetManager.TargetManager.instance().addModelListener(
            ...
            n.navigateToHistoryEntry(i.entries[i.currentIndex - 1])));
    }
    async #d() {
      let a = p.TargetManager.TargetManager.instance()
          .primaryPageTarget()
          ?.model(p.ResourceTreeModel.ResourceTreeModel),
        n = await a?.navigationHistory();
      !a ||
        !n ||
        ((this.#e = n.currentIndex),
        (this.#t = 'Running'),
        this.requestUpdate(),
        p.TargetManager.TargetManager.instance().addModelListener(
          p.ResourceTreeModel.ResourceTreeModel,
        ...
        a.navigate('chrome://terms'));
    }
    #l(e, a) {
      if (!e) return { node: { text: '' }, frameCount: 0, issueCount: 0 };
      let n = 1,
        i = 0,
        s = [],
        d = '';
      e.url.length
        ? (d = e.url)
        : ((d = c(l.blankURLTitle, { PH1: a.blankCount })), (a.blankCount += 1));
      for (let x of e.explanations) {
        let y = { text: x.reason };
        ((i += 1), s.push(y));
      }
      for (let x of e.children) {
        let y = this.#l(x, a);
        y.issueCount > 0 && (s.push(y.node), (i += y.issueCount), (n += y.frameCount));
      }
      let v = { text: `(${i}) ${d}` };
      return (
        s.length
          ? ((v = { ...v, children: s }), (v.iconName = 'iframe'))
          : e.url.length || (a.blankCount -= 1),
        { node: v, frameCount: n, issueCount: i }
      );
    }
    #c(e, a, n) {
      let i = e.url;
      (i.length === 0 && ((i = c(l.blankURLTitle, { PH1: a.blankCount })), (a.blankCount += 1)),
        e.explanations.forEach((s) => {
          let d = n.get(s.reason);
          d === void 0 ? ((d = [i]), n.set(s.reason, d)) : d.push(i);
        }),
        e.children.map((s) => {
          this.#c(s, a, n);
        }));
...
var at = {};
f(at, { BounceTrackingMitigationsView: () => Ce, DEFAULT_VIEW: () => rt, i18nString: () => I });
import './../../../ui/components/report_view/report_view.js';
...
var ot = `devtools-data-grid{margin-top:0}.link,
...
var { html: M } = V,
  ...
  co = xe.i18n.registerUIStrings(
    'panels/application/components/BounceTrackingMitigationsView.ts',
    P,
  ),
  I = xe.i18n.getLocalizedString.bind(void 0, co),
  uo = (t) => {
    let e = t.screenStatus === 'Running';
    return M`
    <devtools-button
  ...
  ho = (t) =>
    t.seenButtonClick
      ? t.trackingSites.length === 0
        ? M`
      <devtools-report-section>
      ${
        t.screenStatus === 'Running'
          ? M`
  ...
  `
      : V.nothing,
  go = (t) =>
    t.screenStatus === 'Initializing'
      ? V.nothing
      : t.screenStatus === 'Disabled'
        ? M`
      <devtools-report-section>
        ${I(P.featureDisabled)}
      </devtools-report-section>
  ...
  Ce = class extends re.Widget.Widget {
    #t = [];
    #e = 'Initializing';
    #o = !1;
    #r;
    constructor(e, a = rt) {
      (super(e, { useShadowDom: !0, classes: ['overflow-auto'] }), (this.#r = a));
      let n = $e.TargetManager.TargetManager.instance().primaryPageTarget();
      n
        ? n
            .systemInfo()
            .invoke_getFeatureState({ featureState: 'DIPS' })
            .then((i) => {
              ((this.#e = i.featureEnabled ? 'Result' : 'Disabled'), this.requestUpdate());
            })
        : (this.#e = 'Result');
    }
    wasShown() {
    ...
    performUpdate() {
      this.#r(
        {
          screenStatus: this.#e,
          trackingSites: this.#t,
          seenButtonClick: this.#o,
          runMitigations: this.#a.bind(this),
        },
        void 0,
        this.contentElement,
      );
    ...
    async #a() {
      ...
      if (!e) return;
      ((this.#o = !0), (this.#e = 'Running'), this.requestUpdate());
      let a = await e.storageAgent().invoke_runBounceTrackingMitigations();
      ((this.#t = []),
        a.deletedSites.forEach((n) => {
          this.#t.push(n);
        }),
        this.#n());
    }
    #n() {
      ((this.#e = 'Result'), this.requestUpdate());
    }
  };
var st = {};
f(st, { CrashReportContextGrid: () => Pe, DEFAULT_VIEW: () => it, i18nString: () => Q });
import './../../../ui/legacy/components/data_grid/data_grid.js';
import * as Te from './../../../core/host/host.js';
import * as Ie from './../../../core/i18n/i18n.js';
import * as ne from './../../../ui/legacy/legacy.js';
import { html as nt, render as po } from './../../../ui/lit/lit.js';
var Y = { key: 'Key', value: 'Value', copyKey: 'Copy key', copyValue: 'Copy value' },
  mo = Ie.i18n.registerUIStrings('panels/application/components/CrashReportContextGrid.ts', Y),
  Q = Ie.i18n.getLocalizedString.bind(void 0, mo),
  it = (t, e, a) => {
    po(
      nt`
      <style>
  ...
  Pe = class extends ne.Widget.Widget {
    #t = [];
    #e = [];
    #o;
    #r = [];
    #a;
    constructor(e, a = it) {
      (super(e, { useShadowDom: !0 }), (this.#a = a));
    }
    set data(e) {
      ((this.#t = e.entries),
        (this.#o = e.selectedKey),
        (this.#r = e.filters || []),
        this.requestUpdate());
    }
    #n() {
      ...
      this.#e = this.#t.filter((e) =>
        this.#r.every((a) => {
          let n = a.regex;
          if (!n) return !0;
          let i = n.test(e.key) || n.test(e.value);
          return a.negative ? !i : i;
        }),
      );
    }
    #i(e, a, n) {
      ...
      (s.defaultSection().appendItem(
        Q(Y.copyKey),
        () => {
          Te.InspectorFrontendHost.InspectorFrontendHostInstance.copyText(a);
        },
        ...
        s.defaultSection().appendItem(
          Q(Y.copyValue),
          () => {
            Te.InspectorFrontendHost.InspectorFrontendHostInstance.copyText(n);
          },
        ...
        this.#a(
          {
            entries: this.#e,
            selectedKey: this.#o,
            onSelect: (e) => this.element.dispatchEvent(new CustomEvent('select', { detail: e })),
            onContextMenu: (e, a, n) => this.#i(e, a, n),
          },
          void 0,
          this.contentElement,
        ));
...
var ut = {};
f(ut, { DEFAULT_VIEW: () => ct, EndpointsGrid: () => Me, i18nString: () => De });
import './../../../ui/legacy/components/data_grid/data_grid.js';
import * as A from './../../../core/i18n/i18n.js';
import * as se from './../../../ui/legacy/legacy.js';
import * as vo from './../../../ui/lit/lit.js';
import * as lt from './../../../ui/visual_logging/visual_logging.js';
var dt = `@scope to (devtools-widget > *){:scope{overflow:auto;height:100%}.endpoints-container{height:100%;display:flex;flex-direction:column;width:100%}.endpoints-header{font-size:15px;background-color:var(--sys-color-surface2);padding:1px 4px;flex-shrink:0}devtools-data-grid{flex:auto}}
...
var Re = {
  ...
  fo = A.i18n.registerUIStrings('panels/application/components/EndpointsGrid.ts', Re),
  De = A.i18n.getLocalizedString.bind(void 0, fo),
  { render: bo, html: ie } = vo,
  ct = (t, e, a) => {
    bo(
      ie`
    <style>${dt}</style>
  ...
  Me = class extends se.Widget.Widget {
    endpoints = new Map();
    #t;
    constructor(e, a = ct) {
      (super(e), (this.#t = a), this.requestUpdate());
    }
    performUpdate() {
      this.#t({ endpoints: this.endpoints }, void 0, this.contentElement);
    }
  };
var pt = {};
f(pt, { InterestGroupAccessGrid: () => de, i18nString: () => F });
import './../../../ui/legacy/components/data_grid/data_grid.js';
import * as Le from './../../../core/i18n/i18n.js';
import * as gt from './../../../ui/legacy/legacy.js';
import * as Ee from './../../../ui/lit/lit.js';
var ht = `:host{display:flex;padding:20px;height:100%}.heading{font-size:15px}devtools-data-grid{margin-top:20px}.info-icon{vertical-align:text-bottom;height:14px}.no-events-message{margin-top:20px}
...
var { html: Z } = Ee,
  ...
  wo = Le.i18n.registerUIStrings('panels/application/components/InterestGroupAccessGrid.ts', U),
  F = Le.i18n.getLocalizedString.bind(void 0, wo),
...
customElements.define('devtools-interest-group-access-grid', de);
var wt = {};
f(wt, { PermissionsPolicySection: () => Fe, renderIconLink: () => Ue });
import './../../../ui/kit/kit.js';
import './../../../ui/components/report_view/report_view.js';
import * as Be from './../../../core/common/common.js';
import * as ce from './../../../core/i18n/i18n.js';
import * as vt from './../../../core/sdk/sdk.js';
import * as ft from './../../network/forward/forward.js';
import './../../../ui/components/buttons/buttons.js';
import * as bt from './../../../ui/legacy/legacy.js';
import { html as W, nothing as ee, render as ko } from './../../../ui/lit/lit.js';
import * as le from './../../../ui/visual_logging/visual_logging.js';
var mt = `@scope to (devtools-widget > *){:scope{display:contents}.text-ellipsis{overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.link,
...
var $ = {
    ...
    clickToShowHeader:
      'Click to reveal the request whose "`Permissions-Policy`" HTTP header disables this feature.',
    clickToShowIframe:
      'Click to reveal the top-most iframe which does not allow this feature in the elements panel.',
  ...
  yo = ce.i18n.registerUIStrings('panels/application/components/PermissionsPolicySection.ts', $),
  R = ce.i18n.getLocalizedString.bind(void 0, yo);
function Ue(t, e, a, n) {
  return W`
    <devtools-button
      .iconName=${t}
...
function So(t) {
  return t.length
    ...
    <devtools-report-value>${t.map(({ feature: e }) => e).join(', ')}</devtools-report-value>`
    : ee;
}
function $o(t, e, a, n, i) {
  if (!t.length) return ee;
  if (!e)
    return W`
  ...
  let s = t.map(({ policy: d, blockReason: v, linkTargetDOMNode: x, linkTargetRequest: y }) => {
    let be = (() => {
      switch (v) {
        case 'IframeAttribute':
          return R($.disabledByIframe);
        case 'Header':
          return R($.disabledByHeader);
        case 'InFencedFrameTree':
          return R($.disabledByFencedFrame);
        default:
          return '';
      }
    })();
...
var Co = (t, e, a) => {
  ...
  Fe = class extends bt.Widget.Widget {
    #t = [];
    #e = !1;
    #o;
    constructor(e, a = Co) {
      (super(e, { useShadowDom: !1 }), (this.#o = a));
    }
    set policies(e) {
    ...
    async #a(e) {
      await Be.Revealer.reveal(e);
    }
    async #n(e) {
      if (!e) return;
      let a = e.responseHeaderValue('permissions-policy') ? 'permissions-policy' : 'feature-policy',
        n = ft.UIRequestLocation.UIRequestLocation.responseHeaderMatch(e, { name: a, value: '' });
      await Be.Revealer.reveal(n);
    }
    async performUpdate() {
      let e = vt.FrameManager.FrameManager.instance(),
        a = this.#t.sort((d, v) => d.feature.localeCompare(v.feature)),
        n = a.filter((d) => d.allowed).sort((d, v) => d.feature.localeCompare(v.feature)),
        i = a.filter((d) => !d.allowed).sort((d, v) => d.feature.localeCompare(v.feature)),
        s = this.#e
          ? await Promise.all(
              i.map(async (d) => {
                let v = d.locator ? e.getFrame(d.locator.frameId) : void 0,
                  x = d.locator?.blockReason,
                  y = await ((x === 'IframeAttribute' && v?.getOwnerDOMNodeOrDocument()) || void 0),
                  be = v?.resourceForURL(v.url),
                  _t = (x === 'Header' && be?.request) || void 0;
                return { policy: d, blockReason: x, linkTargetDOMNode: y, linkTargetRequest: _t };
              }),
            )
          : i.map((d) => ({ policy: d }));
      this.#o(
        {
          ...
          disallowed: s,
          showDetails: this.#e,
          onToggleShowDetails: this.#r.bind(this),
          onRevealDOMNode: this.#a.bind(this),
          onRevealHeader: this.#n.bind(this),
        },
        void 0,
        this.contentElement,
      );
...
var xt = {};
f(xt, { ProtocolHandlersView: () => Ne });
import './../../../ui/kit/kit.js';
import * as j from './../../../core/host/host.js';
import * as He from './../../../core/i18n/i18n.js';
import * as yt from './../../../core/platform/platform.js';
import './../../../ui/components/buttons/buttons.js';
import * as St from './../../../ui/components/input/input.js';
import * as $t from './../../../ui/i18n/i18n.js';
...
var Io = 'https://web.dev/url-protocol-handler/',
  ...
  Ae = He.i18n.registerUIStrings('panels/application/components/ProtocolHandlersView.ts', D),
  K = He.i18n.getLocalizedString.bind(void 0, Ae),
  Ro = xo.bind(void 0, Ae);
function Do(t, e) {
  let a = t.length > 0 ? D.protocolDetected : D.protocolNotDetected;
  return z`
    <div class="protocol-handlers-row status">
      <devtools-icon class="inline-icon"
                     name=${t.length > 0 ? 'check-circle' : 'info'}>
      </devtools-icon>
      ${$t.getFormatLocalizedStringTemplate(Ae, a, {
        PH1: z`
...
var Lo = (t, e, a) => {
  ...
  Ne = class extends ue.Widget.Widget {
    #t = [];
    #e = yt.DevToolsPath.EmptyUrlString;
    #o = '';
    #r = '';
    #a;
    constructor(e, a = Lo) {
      (super(e, { useShadowDom: !1, classes: ['vbox'] }), (this.#a = a));
    }
    set protocolHandlers(e) {
      ((this.#t = e), this.requestUpdate());
    }
    ...
    set manifestLink(e) {
      let a = this.#e !== e;
      ((this.#e = e),
        a && ((this.#r = ''), (this.#o = this.#t[0]?.protocol ?? '')),
        this.requestUpdate());
    }
    get manifestLink() {
      return this.#e;
    ...
    #i = (e) => {
      ((this.#r = e.target.value), this.requestUpdate());
    };
    #s = () => {
      let e = `${this.#o}://${this.#r}`;
      (j.InspectorFrontendHost.InspectorFrontendHostInstance.openInNewTab(e),
        j.userMetrics.actionTaken(j.UserMetrics.Action.CaptureTestProtocolClicked));
    };
    performUpdate() {
      this.#a(
        {
          protocolHandler: this.#t,
          manifestLink: this.#e,
          queryInputState: this.#r,
          protocolSelectHandler: this.#n,
          queryInputChangeHandler: this.#i,
          testProtocolClickHandler: this.#s,
        },
        void 0,
        this.contentElement,
      );
...
var It = {};
f(It, { DEFAULT_VIEW: () => Pt, ReportsGrid: () => qe, i18nString: () => O });
import './../../../ui/kit/kit.js';
import './../../../ui/legacy/components/data_grid/data_grid.js';
import * as N from './../../../core/i18n/i18n.js';
import * as he from './../../../core/root/root.js';
import * as ge from './../../../ui/legacy/legacy.js';
import * as Eo from './../../../ui/lit/lit.js';
import * as Tt from './../../../ui/visual_logging/visual_logging.js';
var We = `@scope to (devtools-widget > *){:scope{overflow:auto;height:100%}.reporting-container{height:100%;display:flex;flex-direction:column;width:100%}.reporting-header{font-size:15px;background-color:var(--sys-color-surface2);padding:1px 4px;flex-shrink:0}devtools-data-grid{flex:auto}.inline-icon{vertical-align:text-bottom}}
...
var q = {
  ...
  Bo = N.i18n.registerUIStrings('panels/application/components/ReportsGrid.ts', q),
  O = N.i18n.getLocalizedString.bind(void 0, Bo),
  { render: Uo, html: _ } = Eo,
  Fo = 'https://developer.chrome.com/docs/capabilities/web-apis/reporting-api',
  Pt = (t, e, a) => {
    Uo(
      _`
    <style>${We}</style>
      ...
      ${
        ...
        <devtools-data-grid striped>
          <table>
            <tr>
              ${
                t.protocolMonitorExperimentEnabled
                  ? _`
  ...
  qe = class extends ge.Widget.Widget {
    reports = [];
    #t = !1;
    #e;
    onReportSelected = () => {};
    constructor(e, a = Pt) {
      (super(e),
        (this.#e = a),
        (this.#t = he.Runtime.experiments.isEnabled(
          he.ExperimentNames.ExperimentName.PROTOCOL_MONITOR,
        )),
        this.requestUpdate());
    }
    performUpdate() {
      let e = {
        ...
        protocolMonitorExperimentEnabled: this.#t,
...
var Lt = {};
f(Lt, { ServiceWorkerRouterView: () => Oe });
import * as Dt from './../../../ui/legacy/legacy.js';
import { html as Mt, render as No } from './../../../ui/lit/lit.js';
var Rt = `:host{display:block;white-space:normal;max-width:400px}.router-rules{border:1px solid var(--sys-color-divider);border-spacing:0;padding-left:10px;padding-right:10px;line-height:initial;margin-top:0;padding-bottom:12px;text-wrap:balance}.router-rule{display:flex;margin-top:12px;flex-direction:column}.rule-id{color:var(--sys-color-token-subtle)}.item{display:flex;flex-direction:column;padding-left:10px}.condition,
...
var Ao = (t, e, a) => {
  ...
  Oe = class extends Dt.Widget.Widget {
    #t = [];
    #e;
    constructor(e, a = Ao) {
      (super(e, { useShadowDom: !0 }), (this.#e = a));
    }
    set rules(e) {
      ((this.#t = e), this.#t.length > 0 && this.requestUpdate());
    }
    get rules() {
      return this.#t;
    }
    performUpdate() {
      this.#e({ rules: this.#t }, void 0, this.contentElement);
    }
  };
var Ft = {};
f(Ft, { DEFAULT_VIEW: () => Ut, SharedStorageAccessGrid: () => Ke, i18nString: () => k });
import './../../../ui/kit/kit.js';
import './../../../ui/legacy/components/data_grid/data_grid.js';
import * as ze from './../../../core/i18n/i18n.js';
import * as Bt from './../../../ui/legacy/legacy.js';
import * as Wo from './../../../ui/lit/lit.js';
import * as Ve from './../../../ui/visual_logging/visual_logging.js';
var Et = `@scope to (devtools-widget > *){:scope{padding:20px;height:100%;display:flex}.heading{font-size:15px}devtools-data-grid{margin-top:20px}.info-icon{vertical-align:text-bottom;height:14px}.no-events-message{margin-top:20px}}
/*# sourceURL=${import.meta.resolve('./sharedStorageAccessGrid.css')} */`;
var qo = 'https://developers.google.com/privacy-sandbox/private-advertising/shared-storage',
  { render: Oo, html: pe } = Wo,
  w = {
  ...
  Vo = ze.i18n.registerUIStrings('panels/application/components/SharedStorageAccessGrid.ts', w),
  k = ze.i18n.getLocalizedString.bind(void 0, Vo),
  Ut = (t, e, a) => {
    Oo(
      pe`
    <style>${Et}</style>
  ...
  Ke = class extends Bt.Widget.Widget {
    #t;
    #e = [];
    #o = () => {};
    constructor(e, a = Ut) {
      (super(e, { useShadowDom: !0 }), (this.#t = a), this.performUpdate());
    }
    set events(e) {
    ...
    performUpdate() {
      this.#t({ events: this.#e, onSelect: this.#o.bind(this) }, {}, this.contentElement);
    }
  };
var Kt = {};
f(Kt, { SharedStorageMetadataView: () => me });
import './../../../ui/kit/kit.js';
import * as je from './../../../core/i18n/i18n.js';
import './../../../ui/components/buttons/buttons.js';
import * as jo from './../../../ui/lit/lit.js';
var Nt = `.text-ellipsis{overflow:hidden;text-overflow:ellipsis;white-space:nowrap}devtools-icon{vertical-align:text-bottom;margin-left:var(--sys-size-3);width:16px;height:16px}devtools-button{vertical-align:sub;margin-left:var(--sys-size-3)}.entropy-budget{display:flex;align-items:center;height:18px}
/*# sourceURL=${import.meta.resolve('./sharedStorageMetadataView.css')} */`;
var Vt = {};
f(Vt, { StorageMetadataView: () => G });
import './../../../ui/components/report_view/report_view.js';
import * as te from './../../../core/i18n/i18n.js';
import * as At from './../../../core/sdk/sdk.js';
import './../../../ui/components/buttons/buttons.js';
import * as Wt from './../../../ui/components/legacy_wrapper/legacy_wrapper.js';
import * as qt from './../../../ui/components/render_coordinator/render_coordinator.js';
import * as Ot from './../../../ui/legacy/legacy.js';
import { html as b, nothing as C, render as Ko } from './../../../ui/lit/lit.js';
var Ht = `.default-bucket{font-style:italic}
...
var u = {
    ...
    yesBecauseAncestorChainHasCrossSite:
  ...
  zo = te.i18n.registerUIStrings('panels/application/components/StorageMetadataView.ts', u),
  h = te.i18n.getLocalizedString.bind(void 0, zo),
  G = class extends Wt.LegacyWrapper.WrappableComponent {
    #t = this.attachShadow({ mode: 'open' });
    #e;
    #o = null;
    #r = null;
    #a = !0;
    setStorageKey(e) {
      ((this.#o = At.StorageKeyManager.parseStorageKey(e)), this.render());
    }
    setStorageBucket(e) {
      ((this.#r = e), this.setStorageKey(e.bucket.storageKey));
    }
    setShowOnlyBucket(e) {
      this.#a = e;
    }
    enableStorageBucketControls(e) {
      ((this.#e = e), this.#o && this.render());
    }
    render() {
      return qt.write('StorageMetadataView render', async () => {
        Ko(
          b`
        <style>${Ht}</style>
    ...
    getTitle() {
      if (!this.#o) return;
      let e = this.#o.origin,
        a = this.#r?.bucket.name || h(u.defaultBucket);
      return this.#e ? `${a} - ${e}` : e;
    }
    key(e) {
      return b`<devtools-report-key>${e}</devtools-report-key>`;
    }
    value(e) {
      return b`<devtools-report-value>${e}</devtools-report-value>`;
    }
    async renderReportContent() {
      if (!this.#o) return C;
      let e = this.#o.origin,
        a = !!this.#o.components.get('3'),
        n = !!this.#o.components.get('1'),
        i = !!this.#o.components.get('4'),
        s = this.#o.components.get('0'),
        d = a
          ? h(u.yesBecauseAncestorChainHasCrossSite)
          : n
            ? h(u.yesBecauseKeyIsOpaque)
            : i
              ? h(u.yesBecauseTopLevelIsOpaque)
              : s && e !== s
                ? h(u.yesBecauseOriginNotInTopLevelSite)
                : null;
      return b`
        ${
          s && e !== s
            ? b`${this.key(h(u.origin))}
            ${this.value(b`<div class="text-ellipsis" title=${e}>${e}</div>`)}`
            : C
        }
        ...
        ${
          d
            ? b`
          ${this.key(h(u.isThirdParty))}${this.value(d)}`
            : C
        }
    ...
    #n() {
      if (!this.#r) throw new Error('Should not call #renderStorageBucketInfo if #bucket is null.');
      let {
          bucket: { name: e },
          persistent: a,
          durability: n,
      ...
      ${this.value(this.#i())}`
        : s
          ? b`
          ${this.key(h(u.bucketName))}
          ${this.value(b`<span class="default-bucket">default</span>`)}`
          : b`
        ${this.key(h(u.bucketName))}
        ${this.value(e)}`;
    }
    #i() {
      if (!this.#r) throw new Error('Should not call #getExpirationString if #bucket is null.');
      let { expiration: e } = this.#r;
      return e === 0 ? h(u.none) : new Date(e * 1e3).toLocaleString();
    }
    #s() {
      return b`
    <devtools-report-divider></devtools-report-divider>
    ...
    async #d() {
      if (!this.#e || !this.#r)
        throw new Error(
          'Should not call #deleteBucket if #storageBucketsModel or #storageBucket is null.',
        );
      (await Ot.UIUtils.ConfirmDialog.show(
        h(u.bucketWillBeRemoved),
        h(u.confirmBucketDeletion, { PH1: this.#r.bucket.name || '' }),
        this,
        { jslogContext: 'delete-bucket-confirmation' },
      )) && this.#e.deleteBucket(this.#r.bucket);
    }
  };
customElements.define('devtools-storage-metadata-view', G);
var { html: J } = jo,
  L = {
    sharedStorage: 'Shared storage',
    ...
    budgetExplanation:
      'Remaining data leakage allowed within a 24-hour period for this origin in bits of entropy',
    resetBudget: 'Reset Budget',
    numBytesUsed: 'Number of Bytes Used',
  },
  _o = je.i18n.registerUIStrings('panels/application/components/SharedStorageMetadataView.ts', L),
  H = je.i18n.getLocalizedString.bind(void 0, _o),
  me = class extends G {
    #t;
    #e = null;
    #o = 0;
    ...
    #a = 0;
    constructor(e, a) {
      (super(), (this.#t = e), this.classList.add('overflow-auto'), this.setStorageKey(a));
    }
    async #n() {
      (await this.#t.resetBudget(), await this.render());
    }
    getTitle() {
      return H(L.sharedStorage);
    }
    async renderReportContent() {
      let e = await this.#t.getMetadata();
      return (
        (this.#e = e?.creationTime ?? null),
        (this.#o = e?.length ?? 0),
        (this.#r = e?.bytesUsed ?? 0),
        (this.#a = e?.remainingBudget ?? 0),
        J`
      <style>${Nt}</style>
      ...
      ${this.value(J`<span class="entropy-budget">${this.#a}${this.#s()}</span>`)}`
      );
    }
    #i() {
      if (!this.#e) return J`${H(L.notYetCreated)}`;
      let e = new Date(1e3 * this.#e);
      return J`${e.toLocaleString()}`;
    }
    #s() {
      return J`
...
customElements.define('devtools-shared-storage-metadata-view', me);
var jt = {};
f(jt, { TrustTokensView: () => Je, i18nString: () => B });
import './../../../ui/kit/kit.js';
import './../../../ui/legacy/components/data_grid/data_grid.js';
import * as Xe from './../../../core/i18n/i18n.js';
import * as Ge from './../../../core/sdk/sdk.js';
import './../../../ui/components/buttons/buttons.js';
import * as fe from './../../../ui/legacy/legacy.js';
import * as Ye from './../../../ui/lit/lit.js';
import * as oe from './../../../ui/visual_logging/visual_logging.js';
var zt = `:host{padding:20px;height:100%;display:flex}.heading{font-size:15px}devtools-data-grid{margin-top:20px;& devtools-button{width:14px;height:14px}}devtools-icon{width:14px;height:14px}.no-tt-message{margin-top:20px}
/*# sourceURL=${import.meta.resolve('./trustTokensView.css')} */`;
var Go = 'https://developers.google.com/privacy-sandbox/protections/private-state-tokens',
  { html: ve } = Ye,
  E = {
    issuer: 'Issuer',
  ...
  Jo = Xe.i18n.registerUIStrings('panels/application/components/TrustTokensView.ts', E),
  B = Xe.i18n.getLocalizedString.bind(void 0, Jo),
  Xo = 1e3;
function Yo(t) {
...
var Qo = (t, e, a) => {
  ...
  Je = class extends fe.Widget.VBox {
    #t = 0;
    #e = [];
    #o;
    constructor(e, a = Qo) {
      (super(e, { useShadowDom: !0 }), (this.#o = a));
    }
    wasShown() {
      (super.wasShown(),
        this.requestUpdate(),
        (this.#t = setInterval(this.requestUpdate.bind(this), Xo)));
    }
    willHide() {
      (super.willHide(), clearInterval(this.#t), (this.#t = 0));
    }
    async performUpdate() {
      let e = Ge.TargetManager.TargetManager.instance().primaryPageTarget();
      if (!e) return;
      let { tokens: a } = await e.storageAgent().invoke_getTrustTokens();
      (a.sort((n, i) => n.issuerOrigin.localeCompare(i.issuerOrigin)),
        (this.#e = a),
        this.#o(
          { tokens: this.#e, deleteClickHandler: this.#r.bind(this) },
          void 0,
          this.contentElement,
        ));
    }
    #r(e) {
      Ge.TargetManager.TargetManager.instance()
        .primaryPageTarget()
        ?.storageAgent()
        .invoke_clearTrustTokens({ issuerOrigin: e });
    }
  };
function _e(t) {
  return t.replace(/\/$/, '');
...
export {
  tt as BackForwardCacheView,
  at as BounceTrackingMitigationsView,
  st as CrashReportContextGrid,
  ut as EndpointsGrid,
  pt as InterestGroupAccessGrid,
  wt as PermissionsPolicySection,
  xt as ProtocolHandlersView,
  It as ReportsGrid,
  Lt as ServiceWorkerRouterView,
  Ft as SharedStorageAccessGrid,
  Kt as SharedStorageMetadataView,
  Vt as StorageMetadataView,
  jt as TrustTokensView,
};
