...
function renderGridOrNoDataMessage(input) {
  ...
  return html`
    <div jslog=${VisualLogging.pane('trust-tokens')}>
      ...
      <devtools-icon
        name="info"
        title=${i18nString(UIStrings.allStoredTrustTokensAvailableIn)}
      ></devtools-icon>
                ...
                <tr>
                  ...
                  <td>
                    <devtools-button
                      ...
                      .title=${i18nString(UIStrings.deleteTrustTokens, {
                        PH1: removeTrailingSlash(token.issuerOrigin),
                      })}
                      .variant=${'icon' /* Buttons.Button.Variant.ICON */}
                      @click=${() =>
                        input.deleteClickHandler(removeTrailingSlash(token.issuerOrigin))}
                    ></devtools-button>
                  </td>
                </tr>
              `,
