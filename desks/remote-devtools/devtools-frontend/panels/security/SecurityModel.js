...
SDK.SDKModel.SDKModel.register(SecurityModel, {
...
export const SummaryMessages = {
  ['unknown' /* Protocol.Security.SecurityState.Unknown */]: i18nLazyString(
    UIStrings.theSecurityOfThisPageIsUnknown,
  ),
  ['insecure' /* Protocol.Security.SecurityState.Insecure */]: i18nLazyString(
    UIStrings.thisPageIsNotSecure,
  ),
  ['neutral' /* Protocol.Security.SecurityState.Neutral */]: i18nLazyString(
    UIStrings.thisPageIsNotSecure,
  ),
  ['secure' /* Protocol.Security.SecurityState.Secure */]: i18nLazyString(
    UIStrings.thisPageIsSecureValidHttps,
  ),
  ['insecure-broken' /* Protocol.Security.SecurityState.InsecureBroken */]: i18nLazyString(
    UIStrings.thisPageIsNotSecureBrokenHttps,
  ),
};
export class PageVisibleSecurityState {
  ...
  constructor(securityState, certificateSecurityState, safetyTipInfo, securityStateIssueIds) {
    ...
    this.certificateSecurityState = certificateSecurityState
      ? new CertificateSecurityState(certificateSecurityState)
      : null;
...
export class CertificateSecurityState {
  ...
  getKeyExchangeName() {
    if (this.keyExchangeGroup) {
      return this.keyExchange
        ? i18nString(UIStrings.keyExchangeWithGroup, {
  ...
  getCipherFullName() {
    return this.mac
      ? i18nString(UIStrings.cipherWithMAC, { PH1: this.cipher, PH2: this.mac })
      : this.cipher;
  }
}
class SafetyTipInfo {
...
class SecurityDispatcher {
  ...
  visibleSecurityStateChanged({ visibleSecurityState }) {
    ...
    this.model.dispatchEventToListeners(
