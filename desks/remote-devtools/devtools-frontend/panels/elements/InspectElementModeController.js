...
export class InspectElementModeController {
  ...
  constructor() {
    this.toggleSearchAction = UI.ActionRegistry.ActionRegistry.instance().getAction(
    ...
    SDK.TargetManager.TargetManager.instance().addModelListener(
      ...
      'InspectModeExited' /* SDK.OverlayModel.Events.EXITED_INSPECT_MODE */,
  ...
  inspectNode(node) {
    const returnToPanel = UI.Context.Context.instance().flavor(
    ...
    return ElementsPanel.instance().revealAndSelectNode(node, {
      showPanel: true,
      focusNode: true,
