...
const str_ = i18n.i18n.registerUIStrings(
  'panels/settings/FrameworkIgnoreListSettingsTab.ts',
  UIStrings,
);
...
export class FrameworkIgnoreListSettingsTab extends UI.Widget.VBox {
  ...
  constructor() {
    ...
    enableIgnoreListing.appendChild(
      SettingsUI.SettingsUI.createSettingCheckbox(
        i18nString(UIStrings.ignoreListing),
        enabledSetting,
      ),
    );
    UI.Tooltip.Tooltip.install(
      enableIgnoreListing,
      i18nString(UIStrings.enableIgnoreListingTooltip),
    );
    ...
    const ignoreListContentScripts = generalExclusionGroup
    ...
    const automaticallyIgnoreListContainer = generalExclusionGroup.createChild(
      'div',
      'ignore-list-option',
    );
    const automaticallyIgnoreList = automaticallyIgnoreListContainer.appendChild(
      SettingsUI.SettingsUI.createSettingCheckbox(
    ...
    automaticallyIgnoreLinkButton.addEventListener('click', () =>
    ...
    const ignoreListAnonymousScripts = generalExclusionGroup
      .createChild('div', 'ignore-list-option')
      .appendChild(
        SettingsUI.SettingsUI.createSettingCheckbox(
    ...
    const generalExclusionGroupCard = settingsContent.createChild(
      'devtools-card',
      'ignore-list-options',
    );
    ...
    const customExclusionGroupCard = settingsContent.createChild(
      'devtools-card',
      'ignore-list-options',
    );
  ...
  createEditor() {
    ...
    const pattern = editor.createInput(
      'pattern',
      'text',
      '/framework\\.js$',
