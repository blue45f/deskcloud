...
var w = (e, i) => {
  for (var t in i) $(e, t, { get: i[t], enumerable: !0 });
};
var C = {};
w(C, { SyncSection: () => f });
...
var n = {
    ...
    preferencesSyncDisabled:
      'You need to first enable saving `Chrome` settings in your `Google` account.',
  ...
  k = h.i18n.registerUIStrings('panels/settings/components/SyncSection.ts', n),
  s = h.i18n.getLocalizedString.bind(void 0, k),
  I = r.i18nTemplate.bind(void 0, k),
  {
    html: o,
    render: U,
    Directives: { ref: G },
...
function B(e) {
  if (
    ...
    e.activeSubscription.subscriptionStatus !== a.GdpClient.SubscriptionStatus.ENABLED
  )
    return s(n.gdpStandardPlan);
  switch (e.activeSubscription.subscriptionTier) {
    case a.GdpClient.SubscriptionTier.PREMIUM_ANNUAL:
    case a.GdpClient.SubscriptionTier.PREMIUM_MONTHLY:
      return s(n.gdpPremiumSubscription);
    case a.GdpClient.SubscriptionTier.PRO_ANNUAL:
    case a.GdpClient.SubscriptionTier.PRO_MONTHLY:
      return s(n.gdpProSubscription);
    default:
      return s(n.gdpUnknownSubscription);
  }
}
var D = (e, i, t) => {
    let l = () => {
        if (!e.syncInfo.accountEmail) return r.nothing;
        let g =
          e.warningType === 'SYNC_DISABLED' ? s(n.syncDisabled) : s(n.preferencesSyncDisabled);
        return o`
    ...
    `;
      ...
      `,
      E = () => {
        if (!e.isEligibleToCreateGdpProfile && !e.gdpProfile) return r.nothing;
        let g = a.GdpClient.isBadgesEnabled() && e.receiveBadgesSetting,
          v = () => o`
          ...
          <div class="gdp-profile-details-content">
            ...
            <div class="plan-details">
              ...
              ${
                g
                  ? o`
                <div class="setting-container" ${G((d) => {
                  i.highlightReceiveBadgesSetting = () => {
                    d && x.PanelUtils.highlightElement(d);
                  };
                })}>
                  <setting-checkbox class="setting-checkbox"
  ...
  f = class extends b.Widget.Widget {
    #e = { isSyncActive: !1 };
    #i;
    #t;
    #n = !1;
    ...
    constructor(i, t = D) {
      (super(i),
        (this.#o = t),
        (this.#t = p.Settings.Settings.instance().moduleSetting('receive-gdp-badges')),
        (this.#i = p.Settings.moduleSetting('sync-preferences')));
    }
    wasShown() {
      (super.wasShown(), this.requestUpdate());
    }
    set syncInfo(i) {
      ((this.#e = i), this.requestUpdate(), i.accountEmail && this.#r());
    }
    async highlightReceiveBadgesSetting() {
      (this.requestUpdate(), await this.updateComplete, this.#a.highlightReceiveBadgesSetting?.());
    }
    performUpdate() {
      let i = !this.#e.isSyncActive || !this.#e.arePreferencesSynced;
      this.#i?.setDisabled(i);
      let t;
      this.#e.isSyncActive
        ? this.#e.arePreferencesSynced || (t = 'PREFERENCES_SYNC_DISABLED')
        : (t = 'SYNC_DISABLED');
      let l = {
        syncInfo: this.#e,
        syncSetting: this.#i,
        receiveBadgesSetting: this.#t,
        gdpProfile: this.#s,
        isEligibleToCreateGdpProfile: a.GdpClient.isGdpProfilesAvailable() && this.#n,
        onSignUpClick: this.#c.bind(this),
        onReceiveBadgesSettingClick: this.#d.bind(this),
        onWarningClick: this.#l.bind(this),
        warningType: t,
      };
      this.#o(l, this.#a, this.contentElement);
    }
    #c() {
      S.GdpSignUpDialog.show({ onSuccess: this.#r.bind(this) });
    }
    #d(i) {
      let t = i.target;
      c.UserBadges.instance()
        .initialize()
        .then(() => {
          t.checked &&
            c.UserBadges.instance().recordAction(c.BadgeAction.RECEIVE_BADGES_SETTING_ENABLED);
        });
    }
    #l(i) {
      let t = this.#e.isSyncActive
        ? 'chrome://settings/syncSetup/advanced'
        : 'chrome://settings/syncSetup';
      (u.openInNewTab(t), i.consume());
    }
    async #r() {
      if (!a.GdpClient.isGdpProfilesAvailable()) return;
      let i = await a.GdpClient.GdpClient.instance().getProfile();
      i && ((this.#s = i.profile ?? void 0), (this.#n = i.isEligible), this.requestUpdate());
    }
  };
