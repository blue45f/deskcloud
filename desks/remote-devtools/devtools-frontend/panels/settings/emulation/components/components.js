...
var E = (m, e) => {
  for (var i in e) C(m, i, { get: e[i], enumerable: !0 });
};
var S = {};
E(S, {
  ALL_PROTOCOL_FORM_FACTORS: () => y,
  ClientHintsChangeEvent: () => h,
  ClientHintsSubmitEvent: () => x,
  UserAgentClientHintsForm: () => w,
});
...
import * as V from './../../../../ui/components/input/input.js';
import * as b from './../../../../ui/lit/lit.js';
import * as d from './../../../../ui/visual_logging/visual_logging.js';
import * as $ from './../utils/utils.js';
var k = `.root{color:var(--sys-color-on-surface);width:100%}.tree-title{font-weight:700;display:flex;align-items:center;& > [aria-controls="form-container"]{margin-left:var(--sys-size-2);padding-right:var(--sys-size-3);& > [name="triangle-right"],
...
var { html: u } = b,
  ...
  P = A.i18n.registerUIStrings(
    'panels/settings/emulation/components/UserAgentClientHintsForm.ts',
    t,
  ),
  r = A.i18n.getLocalizedString.bind(void 0, P),
  h = class m extends Event {
    static eventName = 'clienthintschange';
    constructor() {
      super(m.eventName);
    }
  },
  x = class m extends Event {
    static eventName = 'clienthintssubmit';
    detail;
    constructor(e) {
      (super(m.eventName), (this.detail = { value: e }));
    }
  },
  L = {
  ...
  w = class extends HTMLElement {
    ...
    #i = '';
    set value(e) {
      let { metaData: i = L, showMobileCheckbox: a = !1, showSubmitButton: n = !1 } = e;
      ((this.#e = { ...this.#e, ...i }), (this.#s = a), (this.#o = n), this.#t());
    }
    get value() {
      return { metaData: this.#e };
    }
    set disabled(e) {
      ((this.#a = e), (this.#r = !1), this.#t());
    }
    get disabled() {
      return this.#a;
    }
    ...
    #d = (e, i, a) => {
      let n = this.#e.brands?.map((s, o) => {
        if (o === i) {
          let { brand: l, version: p } = s;
          return a === 'brandName' ? { brand: e, version: p } : { brand: l, version: e };
        }
        return s;
      });
      ((this.#e = { ...this.#e, brands: n }), this.dispatchEvent(new h()), this.#t());
    };
    #c = (e, i, a) => {
      let n = this.#e.fullVersionList?.map((s, o) => {
        if (o === i) {
          let { brand: l, version: p } = s;
          return a === 'brandName' ? { brand: e, version: p } : { brand: l, version: e };
        }
      ...
      ((this.#e = { ...this.#e, fullVersionList: n }), this.dispatchEvent(new h()), this.#t());
    };
    #b = (e) => {
      let { brands: i = [] } = this.#e;
      (i.splice(e, 1),
        (this.#e = { ...this.#e, brands: i }),
        this.dispatchEvent(new h()),
        (this.#i = r(t.deletedBrand)),
        this.#t());
      let a = this.shadowRoot?.getElementById(`ua-brand-${e + 1}-input`);
      (a || (a = this.shadowRoot?.getElementById('add-brand-button')), a?.focus());
    };
    #g = (e) => {
      let { fullVersionList: i = [] } = this.#e;
      (i.splice(e, 1),
        (this.#e = { ...this.#e, fullVersionList: i }),
        this.dispatchEvent(new h()),
        (this.#i = r(t.deletedBrand)),
        this.#t());
      let a = this.shadowRoot?.getElementById(`fvl-brand-${e + 1}-input`);
      (a || (a = this.shadowRoot?.getElementById('add-fvl-brand-button')), a?.focus());
    };
    #u = () => {
      let { brands: e } = this.#e;
      ((this.#e = {
        ...this.#e,
        brands: [...(Array.isArray(e) ? e : []), { brand: '', version: '' }],
      }),
        this.dispatchEvent(new h()),
        (this.#i = r(t.addedBrand)),
        this.#t());
      let i = this.shadowRoot?.querySelectorAll('.ua-brand-name-input');
      if (i) {
        let a = Array.from(i).pop();
        a && a.focus();
      }
    };
    #v = (e) => {
      (e.code === 'Space' || e.code === 'Enter') && (e.preventDefault(), this.#u());
    };
    #h = () => {
      let { fullVersionList: e } = this.#e;
      ((this.#e = {
        ...this.#e,
        fullVersionList: [...(Array.isArray(e) ? e : []), { brand: '', version: '' }],
      }),
        this.dispatchEvent(new h()),
        (this.#i = r(t.addedBrand)),
        this.#t());
      let i = this.shadowRoot?.querySelectorAll('.fvl-brand-name-input');
      if (i) {
        let a = Array.from(i).pop();
        a && a.focus();
      }
    ...
    #$ = (e) => {
      (e.code === 'Space' || e.code === 'Enter') && (e.preventDefault(), this.#h());
    };
    #x = (e, i) => {
      let a = [...(this.#e.formFactors || [])];
      (i ? a.includes(e) || a.push(e) : (a = a.filter((n) => n !== e)),
        (this.#e = { ...this.#e, formFactors: a }),
        this.dispatchEvent(new h()),
        this.#t());
    };
    #n = (e, i) => {
      (e in this.#e && ((this.#e = { ...this.#e, [e]: i }), this.#t()),
        this.dispatchEvent(new h()));
    };
    #w = (e) => {
      (e.preventDefault(), this.#o && (this.dispatchEvent(new x(this.#e)), this.#t()));
    };
    #p(e, i, a, n) {
      return u`
    ...
    #F() {
      let { platform: e, platformVersion: i } = this.#e,
        a = (s) => {
    ...
    #y() {
      let { model: e, mobile: i } = this.#e,
        a = (o) => {
          let l = o.target.value;
          this.#n('model', l);
        },
        n = (o) => {
          let l = o.target.checked;
          this.#n('mobile', l);
        },
        s = this.#s
          ? u`
    ...
    #A() {
      let { brands: e = [{ brand: '', version: '' }] } = this.#e,
        i = e.map((a, n) => {
          let { brand: s, version: o } = a,
            l = () => {
              this.#b(n);
            },
            p = (c) => {
              (c.code === 'Space' || c.code === 'Enter') && (c.preventDefault(), l());
            },
            g = (c) => {
              let f = c.target.value;
              this.#d(f, n, 'brandName');
            },
            v = (c) => {
              let f = c.target.value;
              this.#d(f, n, 'brandVersion');
            };
          return u`
    ...
    #k() {
      let { fullVersionList: e = [{ brand: '', version: '' }] } = this.#e,
        i = e.map((a, n) => {
          let { brand: s, version: o } = a,
            l = () => {
              this.#g(n);
            ...
            g = (c) => {
              let f = c.target.value;
              this.#c(f, n, 'brandName');
            },
            v = (c) => {
              let f = c.target.value;
              this.#c(f, n, 'brandVersion');
            };
          return u`
        <div
    ...
    #L() {
      let e = y.map((i) => {
        let a = this.#e.formFactors?.includes(i) || !1,
          n = `formFactor${i}`,
          s = r(t[n]);
        return u`
    ...
    #t() {
      let { fullVersion: e, architecture: i } = this.#e,
        a = this.#A(),
        n = this.#k(),
        s = this.#p(
          r(t.fullBrowserVersion),
          r(t.fullBrowserVersionPlaceholder),
          e || '',
          'fullVersion',
        ),
        o = this.#L(),
        l = this.#F(),
        p = this.#p(r(t.architecture), r(t.architecturePlaceholder), i, 'architecture'),
        g = this.#y(),
        v = this.#o
          ? u`
      <devtools-button
    ...
    `;
      b.render(c, this.#f, { host: this });
    }
    validate = () => {
      for (let [e, i] of Object.entries(this.#e))
        if (e === 'brands' || e === 'fullVersionList') {
          if (
            !this.#e.brands?.every(({ brand: n, version: s }) => {
              let o = $.UserAgentMetadata.validateAsStructuredHeadersString(
                  n,
                  r(t.notRepresentable),
                ),
                l = $.UserAgentMetadata.validateAsStructuredHeadersString(s, r(t.notRepresentable));
              return o.valid && l.valid;
            })
          )
            return { valid: !1, errorMessage: r(t.notRepresentable) };
        } else if (e === 'formFactors') {
          let a = i;
          if (a)
            for (let n of a) {
              if (!y.includes(n))
                return {
                  valid: !1,
                  errorMessage: r(t.notRepresentable) + ` (Invalid form factor: ${n})`,
                };
              let s = $.UserAgentMetadata.validateAsStructuredHeadersString(
                n,
                r(t.notRepresentable),
              );
              if (!s.valid) return s;
          ...
          let a = $.UserAgentMetadata.validateAsStructuredHeadersString(i, r(t.notRepresentable));
          if (!a.valid) return a;
        }
      return { valid: !0 };
    };
  };
customElements.define('devtools-user-agent-client-hints-form', w);
export { S as UserAgentClientHintsForm };
