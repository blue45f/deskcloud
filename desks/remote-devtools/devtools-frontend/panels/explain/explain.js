...
var l = {
  ...
  N = H.i18n.registerUIStrings('panels/explain/components/ConsoleInsight.ts', l),
  d = H.i18n.getLocalizedString.bind(void 0, N),
  j = h.i18nTemplate.bind(void 0, N),
  { render: q, html: a, Directives: x } = h,
  { widget: B } = k.Widget,
  M = class i extends Event {
    static eventName = 'closeinsight';
    constructor() {
      super(i.eventName, { composed: !0, bubbles: !0 });
    }
  };
function U(i) {
  switch (i) {
    case I.PromptBuilder.SourceType.MESSAGE:
      return d(l.consoleMessage);
    case I.PromptBuilder.SourceType.STACKTRACE:
      return d(l.stackTrace);
    case I.PromptBuilder.SourceType.NETWORK_REQUEST:
      return d(l.networkRequest);
    case I.PromptBuilder.SourceType.RELATED_CODE:
      return d(l.relatedCode);
  }
}
var W = 'https://policies.google.com/terms',
  F = 'https://policies.google.com/privacy',
  K = 'https://support.google.com/legal/answer/13505487',
  V = 'https://goo.gle/devtools-console-messages-ai',
  Q = 'https://support.google.com/legal/troubleshooter/1114905?hl=en#ts=1115658%2C13380504',
  ...
  J = {
    ...
    tokenizer(i) {
      let e = i.match(/^\[\^(\d+)\]/);
      return e ? { type: 'citation', raw: e[0], linkText: Number(e[1]) } : !1;
    },
    renderer: () => '',
  };
function D(i) {
  return !!i.factualityMetadata?.facts.length;
}
var C = (i) => i.stopPropagation();
function X(i) {
  return a`<devtools-button
    @click=${i}
    class="search-button"
    .variant=${'outlined'}
    .jslogContext=${'search'}
...
function Z() {
  return a`<devtools-link href=${V} class="link" jslogcontext="learn-more">
    ${d(l.learnMore)}
  </devtools-link>`;
}
function ee(i, e, t, s) {
    ...
    <div class="insight-sources">
      <ul>
        ${x.repeat(
          ...
          (
            t,
          ) => a`<li><devtools-link class="link" title="${U(t.type)} ${d(l.opensInNewTab)}" href="data:text/plain;charset=utf-8,${encodeURIComponent(t.value)}" .jslogContext=${'source-' + t.type}>
        ...
        ${
          e
            ? a`<li class="source-disclaimer">
          <devtools-icon name="warning"></devtools-icon>
          ${d(l.reloadRecommendation)}</li>`
            : h.nothing
        }
      </ul>
    </div>`;
...
function se(
  i,
  {
    renderer: e,
    disableAnimations: t,
    areReferenceDetailsOpen: s,
    highlightedCitationIndex: r,
    callbacks: c,
  },
  o,
) {
...
function S(i) {
  return a`<div class="error">${i}</div>`;
}
function oe(i) {
  return a`
...
function ae() {
  return S(
    y.Runtime.hostConfig.isOffTheRecord ? d(l.notAvailableInIncognitoMode) : d(l.notLoggedIn),
  );
}
function _(i, e) {
  return a`<span>
...
function le(i) {
  return y.Runtime.hostConfig.isOffTheRecord
    ? h.nothing
    : a`
...
function w({ headerText: i, showIcon: e = !1, showSpinner: t = !1, onClose: s }, r) {
  return a`
    <header>
      ${e ? ge() : h.nothing}
      <div class="filler">
...
var he = (i, e, t) => {
    let { state: s, noLogging: r, callbacks: c } = i,
      { onClose: o, onDisclaimerSettingsLink: m } = c,
      v = `${p.section(s.type).track({ resize: !0 })}`,
      u = h.nothing,
      g = h.nothing,
      A = {},
      b;
    switch (s.type) {
      case 'loading':
        ((u = w({ headerText: d(l.generating), onClose: o }, e.headerRef)), (g = ie()));
        break;
      case 'insight':
        ((u = w({ headerText: d(l.insight), onClose: o, showSpinner: !s.completed }, e.headerRef)),
          (g = se(s, i, e)),
          (b = de(r, i.selectedRating, c)));
        break;
      case 'error':
        ((u = w({ headerText: d(l.error), onClose: o }, e.headerRef)),
          (g = S(d(l.errorBody))),
          (b = E(r, m)));
        break;
      case 'consent-reminder':
        ((u = w(
          { headerText: 'Understand console messages with AI', onClose: o, showIcon: !0 },
          e.headerRef,
        )),
          (A['reminder-container'] = !0),
          (g = oe(r)),
          (b = ce(c.onReminderSettingsLink, c.onConsentReminderConfirmed)));
        break;
      case 'setting-is-not-true':
        ((A['opt-in-teaser'] = !0), (g = re(c.onEnableInsightsInSettingsLink)));
        break;
      case 'not-logged-in':
      case 'sync-is-paused':
        ((u = w({ headerText: d(l.signInToUse), onClose: o }, e.headerRef)),
          (g = ae()),
          (b = le(c.onGoToSignIn)));
        break;
      case 'offline':
        ((u = w({ headerText: d(l.offlineHeader), onClose: o }, e.headerRef)),
          (g = S(d(l.offline))),
          (b = E(r, m)));
        break;
    }
    ...
    >
      <div class="animation-wrapper">
        ...
        ${
          b
            ? a`<footer jslog=${p.section('footer')}>
          ${b}
        </footer>`
            : h.nothing
        }
  ...
  R = class i extends k.Widget.Widget {
    static async create(e, t) {
      let s = await n.AidaClient.AidaClient.checkAccessPreconditions();
      return a`<devtools-widget class="devtools-console-insight" ${B((r) => new i(e, t, s, r))}>
    </devtools-widget>`;
    }
    disableAnimations = !1;
    #f;
    ...
    constructor(e, t, s, r, c = he) {
      (super(r),
        ...
        (this.#a = s),
        (this.#t = this.#$()),
        (this.#d = new P.MarkdownView.MarkdownInsightRenderer(this.#u.bind(this))),
        (this.#k = new z.Marked.Marked({ extensions: [J] })),
        (this.#e = this.#p()),
        (this.#h = this.#w.bind(this)),
        this.requestUpdate());
    }
    #u(e) {
      if (this.#e.type !== 'insight') return;
      let t = this.#r;
      ((this.#r = !0), (this.#n = e - 1), this.requestUpdate(), t && this.#x());
    }
    #x() {
      let e = this.#y[this.#n];
      e && (e.scrollIntoView({ behavior: 'auto' }), e.focus());
    }
    #p() {
      switch (this.#a) {
        case 'available': {
          let e = $.Settings.Settings.instance()
            .createSetting('console-insights-skip-reminder', !1, 'Session')
            .get();
          return { type: 'loading', consentOnboardingCompleted: this.#m().get() || e };
        }
        case 'no-account-email':
          return { type: 'not-logged-in' };
        case 'sync-is-paused':
          return { type: 'sync-is-paused' };
        case 'no-internet':
          return { type: 'offline' };
      }
    }
    #$() {
      try {
        return $.Settings.moduleSetting('console-insights-enabled');
      } catch {
        return;
      }
    }
    #m() {
      return $.Settings.Settings.instance().createLocalSetting(
        'console-insights-onboarding-finished',
        !1,
      );
    }
    wasShown() {
      (super.wasShown(), this.focus(), this.#t?.addChangeListener(this.#I, this));
      let e = y.Runtime.hostConfig.aidaAvailability?.blockedByAge === !0;
      (this.#e.type === 'loading' &&
        this.#t?.getIfNotDisabled() === !0 &&
        !e &&
        this.#e.consentOnboardingCompleted &&
        n.userMetrics.actionTaken(n.UserMetrics.Action.GeneratingInsightWithoutDisclaimer),
        n.AidaClient.HostConfigTracker.instance().addEventListener(
          'aidaAvailabilityChanged',
          this.#h,
        ),
        this.#w(),
        this.#e.type !== 'insight' && this.#e.type !== 'error' && (this.#e = this.#p()),
        this.#l());
    }
    willHide() {
      (super.willHide(),
        this.#t?.removeChangeListener(this.#I, this),
        n.AidaClient.HostConfigTracker.instance().removeEventListener(
          'aidaAvailabilityChanged',
          this.#h,
        ));
    }
    async #w() {
      let e = await n.AidaClient.AidaClient.checkAccessPreconditions();
      e !== this.#a && ((this.#a = e), (this.#e = this.#p()), this.#l());
    }
    #I() {
      (this.#t?.getIfNotDisabled() === !0 && this.#m().set(!0),
        this.#e.type === 'setting-is-not-true' &&
          this.#t?.getIfNotDisabled() === !0 &&
          (this.#i({ type: 'loading', consentOnboardingCompleted: !0 }),
          n.userMetrics.actionTaken(n.UserMetrics.Action.InsightsOptInTeaserConfirmedInSettings),
          this.#l()),
        this.#e.type === 'consent-reminder' &&
          this.#t?.getIfNotDisabled() === !1 &&
          (this.#i({ type: 'loading', consentOnboardingCompleted: !1 }),
          n.userMetrics.actionTaken(n.UserMetrics.Action.InsightsReminderTeaserAbortedInSettings),
          this.#l()));
    }
    #i(e) {
      ((this.#b = this.#e.type !== e.type), (this.#e = e), this.requestUpdate());
    }
    async #l() {
      if (this.#e.type !== 'loading') return;
      let e = y.Runtime.hostConfig.aidaAvailability?.blockedByAge === !0;
      if (this.#t?.getIfNotDisabled() !== !0 || e) {
        (this.#i({ type: 'setting-is-not-true' }),
          n.userMetrics.actionTaken(n.UserMetrics.Action.InsightsOptInTeaserShown));
        return;
      }
      if (!this.#e.consentOnboardingCompleted) {
        let { sources: t, isPageReloadRecommended: s } = await this.#o.buildPrompt();
        (this.#i({ type: 'consent-reminder', sources: t, isPageReloadRecommended: s }),
          n.userMetrics.actionTaken(n.UserMetrics.Action.InsightsReminderTeaserShown));
        return;
      }
      await this.#C();
    }
    #R() {
      (this.#e.type === 'consent-reminder' &&
        n.userMetrics.actionTaken(n.UserMetrics.Action.InsightsReminderTeaserCanceled),
        (this.#g = !0),
        this.requestUpdate());
    }
    #T() {
      if (this.#g) {
        this.contentElement.dispatchEvent(new M());
        return;
      }
      this.#b && this.#v.value?.focus();
    }
    #A() {
      this.#n !== -1 && ((this.#n = -1), this.requestUpdate());
    }
    #M(e) {
      if (this.#e.type !== 'insight') throw new Error('Unexpected state');
      if (this.#e.metadata?.rpcGlobalId === void 0) throw new Error('RPC Id not in metadata');
      if (this.#s !== void 0) return;
      ((this.#s = e),
        this.requestUpdate(),
        this.#s
          ? n.userMetrics.actionTaken(n.UserMetrics.Action.InsightRatedPositive)
          : n.userMetrics.actionTaken(n.UserMetrics.Action.InsightRatedNegative));
      let t = y.Runtime.hostConfig.aidaAvailability?.disallowLogging ?? !0;
      return this.#c.registerClientEvent({
        corresponding_aida_rpc_global_id: this.#e.metadata.rpcGlobalId,
        disable_user_content_logging: t,
        do_conversation_client_event: {
          user_feedback: { sentiment: this.#s ? 'POSITIVE' : 'NEGATIVE' },
        },
      });
    }
    #S() {
      n.InspectorFrontendHost.InspectorFrontendHostInstance.openInNewTab(Q);
    }
    #H() {
      let e = this.#o.getSearchQuery();
      n.InspectorFrontendHost.InspectorFrontendHostInstance.openSearchResultsInNewTab(e);
    }
    async #L() {
      (this.#m().set(!0),
        this.#i({ type: 'loading', consentOnboardingCompleted: !0 }),
        n.userMetrics.actionTaken(n.UserMetrics.Action.InsightsReminderTeaserConfirmed),
        await this.#C());
    }
    #U(e, t) {
      let s = [];
      if (!D(t) || !t.attributionMetadata)
        return { explanationWithCitations: e, directCitationUrls: s };
      let { attributionMetadata: r } = t,
        c = r.citations
          .filter((m) => m.sourceType === n.AidaClient.CitationSourceType.WORLD_FACTS)
          .sort((m, v) => (v.endIndex || 0) - (m.endIndex || 0)),
        o = e;
      for (let [m, v] of c.entries()) {
        let u = /[.,:;!?]*\s/g;
        u.lastIndex = v.endIndex || 0;
        let g = u.exec(o);
        g &&
          v.uri &&
          ((o = o.slice(0, g.index) + `[^${c.length - m}]` + o.slice(g.index)), s.push(v.uri));
      }
      return (s.reverse(), { explanationWithCitations: o, directCitationUrls: s });
    }
    #E(e) {
      for (let t of e)
        if (t.type === 'code') {
          let s = t.text.match(/\[\^\d+\]/g);
          if (((t.text = t.text.replace(/\[\^\d+\]/g, '')), s?.length)) {
            let r = s.map((c) => {
              let o = parseInt(c.slice(2, -1), 10);
              return { index: o, clickHandler: this.#u.bind(this, o) };
            });
            t.citations = r;
          }
        }
    ...
    #z(e, t) {
      if (!t.factualityMetadata?.facts.length) return [];
      let s =
          t.factualityMetadata.facts
            .filter((o) => o.sourceUri && !e.includes(o.sourceUri))
            .map((o) => o.sourceUri) || [],
        r =
          t.attributionMetadata?.citations
            .filter(
              (o) =>
                o.sourceType === n.AidaClient.CitationSourceType.TRAINING_DATA &&
                (o.uri || o.repository),
            )
            .map((o) => o.uri || `https://www.github.com/${o.repository}`) || [],
        c = [...new Set(r.filter((o) => !s.includes(o) && !e.includes(o)))];
      return (s.push(...c), s);
    }
    async #C() {
      try {
        for await (let {
          sources: e,
          isPageReloadRecommended: t,
          explanation: s,
          metadata: r,
          completed: c,
        } of this.#P()) {
          let { explanationWithCitations: o, directCitationUrls: m } = this.#U(s, r),
            v = this.#z(m, r),
            u = this.#O(o),
            g = u !== !1;
          (g && this.#E(u),
            this.#i({
              ...
              isPageReloadRecommended: t,
              completed: c,
              directCitationUrls: m,
              relatedUrls: v,
            }));
        }
        n.userMetrics.actionTaken(n.UserMetrics.Action.InsightGenerated);
      } catch (e) {
        (console.error('[ConsoleInsight] Error in #generateInsight:', e),
          n.userMetrics.actionTaken(n.UserMetrics.Action.InsightErrored),
          e.message === 'doAidaConversation timed out' && this.#e.type === 'insight'
            ? ((this.#e.timedOut = !0), this.#i({ ...this.#e, completed: !0, timedOut: !0 }))
            : this.#i({ type: 'error', error: e.message }));
      }
    }
    #O(e) {
      try {
        let t = this.#k.lexer(e);
        for (let s of t) this.#d.renderToken(s);
        return t;
      } catch {
        return (n.userMetrics.actionTaken(n.UserMetrics.Action.InsightErroredMarkdown), !1);
      }
    }
    async *#P() {
      let { prompt: e, sources: t, isPageReloadRecommended: s } = await this.#o.buildPrompt();
      try {
        for await (let r of this.#c.doConversation(
          n.AidaClient.AidaClient.buildConsoleInsightsRequest(e),
        ))
          yield { sources: t, isPageReloadRecommended: s, ...r };
      } catch (r) {
        throw (
          r.message === 'Server responded: permission denied'
            ? n.userMetrics.actionTaken(n.UserMetrics.Action.InsightErroredPermissionDenied)
            : r.message.startsWith('Cannot send request:')
              ? n.userMetrics.actionTaken(n.UserMetrics.Action.InsightErroredCannotSend)
              : r.message.startsWith('Request failed:')
                ? n.userMetrics.actionTaken(n.UserMetrics.Action.InsightErroredRequestFailed)
                : r.message.startsWith('Cannot parse chunk:')
                  ? n.userMetrics.actionTaken(n.UserMetrics.Action.InsightErroredCannotParseChunk)
                  : r.message === 'Unknown chunk result'
                    ? n.userMetrics.actionTaken(n.UserMetrics.Action.InsightErroredUnknownChunk)
                    : r.message.startsWith('Server responded:')
                      ? n.userMetrics.actionTaken(n.UserMetrics.Action.InsightErroredApi)
                      : n.userMetrics.actionTaken(n.UserMetrics.Action.InsightErroredOther),
          r
        );
      }
    }
    #N() {
      n.InspectorFrontendHost.InspectorFrontendHostInstance.openInNewTab(Y);
    }
    #V(e) {
      let t = e.target;
      t && ((this.#r = t.open), t.open || (this.#n = -1), this.requestUpdate());
    }
    #D() {
      k.ViewManager.ViewManager.instance().showView('chrome-ai');
    }
    #_() {
      (n.userMetrics.actionTaken(n.UserMetrics.Action.InsightsReminderTeaserSettingsLinkClicked),
        k.ViewManager.ViewManager.instance().showView('chrome-ai'));
    }
    #G() {
      (n.userMetrics.actionTaken(n.UserMetrics.Action.InsightsOptInTeaserSettingsLinkClicked),
        k.ViewManager.ViewManager.instance().showView('chrome-ai'));
    }
    performUpdate() {
      let e = {
          ...
          renderer: this.#d,
          citationClickHandler: this.#u.bind(this),
          selectedRating: this.#s,
          noLogging:
            y.Runtime.hostConfig.aidaAvailability?.enterprisePolicyValue ===
            y.Runtime.GenAiEnterprisePolicyValue.ALLOW_WITHOUT_LOGGING,
          areReferenceDetailsOpen: this.#r,
          highlightedCitationIndex: this.#n,
          callbacks: {
            onClose: this.#R.bind(this),
            onAnimationEnd: this.#T.bind(this),
            onCitationAnimationEnd: this.#A.bind(this),
            onSearch: this.#H.bind(this),
            onRating: this.#M.bind(this),
            onReport: this.#S.bind(this),
            onGoToSignIn: this.#N.bind(this),
            onConsentReminderConfirmed: this.#L.bind(this),
            onToggleReferenceDetails: this.#V.bind(this),
            onDisclaimerSettingsLink: this.#D.bind(this),
            onReminderSettingsLink: this.#_.bind(this),
            onEnableInsightsInSettingsLink: this.#G.bind(this),
            onReferencesOpen: this.#x.bind(this),
          },
        },
        t = { headerRef: this.#v, citationLinks: [] };
      (this.#f(e, t, this.contentElement), (this.#y = t.citationLinks));
    }
  };
import * as f from './../../core/host/host.js';
import * as T from './../console/console.js';
var G = class {
  handleAction(e, t) {
    switch (t) {
      ...
      case 'explain.console-message.hover': {
        let s = e.flavor(T.ConsoleViewMessage.ConsoleViewMessage);
        if (s) {
          t.startsWith('explain.console-message.context')
            ? f.userMetrics.actionTaken(f.UserMetrics.Action.InsightRequestedViaContextMenu)
            : t === 'explain.console-message.teaser'
              ? f.userMetrics.actionTaken(f.UserMetrics.Action.InsightRequestedViaTeaser)
              : t === 'explain.console-message.hover' &&
                f.userMetrics.actionTaken(f.UserMetrics.Action.InsightRequestedViaHoverButton);
          let r = new T.PromptBuilder.PromptBuilder(s),
            c = new f.AidaClient.AidaClient();
          return (
            R.create(r, c).then((o) => {
              s.setInsight(o);
            }),
...
export { G as ActionDelegate, M as CloseEvent, R as ConsoleInsight, he as DEFAULT_VIEW };
