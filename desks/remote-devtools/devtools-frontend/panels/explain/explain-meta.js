...
import * as r from './../console/console.js';
...
var i = {
  ...
  c = s.i18n.registerUIStrings('panels/explain/explain-meta.ts', i),
  t = s.i18n.getLazilyComputedLocalizedString.bind(void 0, c),
  o = s.i18n.getLocalizedString.bind(void 0, c),
  p = 'console-insights-enabled',
  f = [
    {
      actionId: 'explain.console-message.hover',
      title: t(i.explainThisMessage),
      configurableBindings: !1,
      contextTypes() {
        return [r.ConsoleViewMessage.ConsoleViewMessage];
      },
    },
    {
...
function h() {
  return !s.DevToolsLocale.DevToolsLocale.instance().locale.startsWith('en-');
}
function d(e) {
...
a.Settings.registerSettingExtension({
  ...
  settingName: p,
  settingType: 'boolean',
  title: t(i.enableConsoleInsights),
  defaultValue: !1,
  reloadRequired: !1,
  condition: (e) => u(e),
  disabledCondition: (e) => {
    let n = [];
    return (
      d(e) && n.push(o(i.geoRestricted)),
      g(e) && n.push(o(i.policyRestricted)),
      h() && n.push(o(i.wrongLocale)),
      n.length > 0 ? { disabled: !0, reasons: n } : { disabled: !1 }
    );
  },
});
for (let e of f)
  l.ActionRegistration.registerActionExtension({
    ...
    async loadActionDelegate() {
      let n = await import('./explain.js');
      return new n.ActionDelegate();
    },
    condition: (n) => u(n) && !g(n) && !d(n),
  });
