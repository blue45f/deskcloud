...
const GROUP_TO_TYPES = new Map([
  ...
  [
    ...
    ['Float 32-bit' /* ValueType.FLOAT32 */, 'Float 64-bit' /* ValueType.FLOAT64 */],
  ],
  [
    'Other' /* ValueTypeGroup.OTHER */,
    ['Pointer 32-bit' /* ValueType.POINTER32 */, 'Pointer 64-bit' /* ValueType.POINTER64 */],
  ],
]);
...
export const DEFAULT_VIEW = (input, _output, target) => {
  ...
  render(
    html`
      <style>
        ${valueInterpreterSettingsStyles}
      </style>
                ...
                return html`
                  <devtools-checkbox
                    ...
                    jslog=${VisualLogging.toggle()
                      .track({ change: true })
                      .context(Platform.StringUtilities.toKebabCase(type))}
                    }
