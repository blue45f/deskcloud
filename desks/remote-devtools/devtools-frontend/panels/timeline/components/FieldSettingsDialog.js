...
const str_ = i18n.i18n.registerUIStrings(
  'panels/timeline/components/FieldSettingsDialog.ts',
  UIStrings,
);
...
export class FieldSettingsDialog extends HTMLElement {
  ...
  #renderDisableButton() {
    const label = this.#configSetting.get().enabled
      ? i18nString(UIStrings.optOut)
            ...
            <div class="advanced-section-contents">
              ...
              <label class="url-override">
                <input
                  ...
                  jslog=${VisualLogging.toggle()
                    .track({ click: true })
                    .context('field-url-override-enabled')}
                />
              ...
              <input
                ...
                placeholder=${ifDefined(
                  this.#urlOverrideEnabled ? i18nString(UIStrings.url) : undefined,
                )}
              />
              ${this.#urlOverrideWarning
                ? html`<div class="warning" role="alert" aria-label=${this.#urlOverrideWarning}>
                    ${this.#urlOverrideWarning}
                  </div>`
                : nothing}
            </div>
