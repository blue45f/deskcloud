...
const str_ = i18n.i18n.registerUIStrings(
  'panels/timeline/components/IgnoreListSetting.ts',
  UIStrings,
);
...
export const DEFAULT_VIEW = (input, output, target) => {
    ...
    return html`
      <div class="regex-row">
        <devtools-checkbox
          ...
          .jslogContext=${'timeline.ignore-list-pattern'}
          >${regex.pattern}</devtools-checkbox
        >
        <devtools-button
  ...
  Lit.render(
    html`
      <style>
        ${ignoreListSettingStyles}
      </style>
      <devtools-button-dialog
        @contextmenu=${
          (e) =>
            e.stopPropagation() /* Prevent the event making its way to the TimelinePanel element which will cause the "Load Profile" context menu to appear. */
        }
        .data=${{
          openOnRender: false,
      ...
      >
        <div class="ignore-list-setting-content">
          <div class="ignore-list-setting-description">
            ${i18nString(UIStrings.ignoreListDescription)}
          </div>
