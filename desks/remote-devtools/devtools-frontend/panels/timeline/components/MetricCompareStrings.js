...
const str_ = i18n.i18n.registerUIStrings(
  'panels/timeline/components/MetricCompareStrings.ts',
  UIStrings,
);
...
export function renderDetailedCompareText(options) {
  ...
  if (localRating === 'good' && fieldRating === 'needs-improvement') {
    return uiI18n.getFormatLocalizedString(
      str_,
      UIStrings.goodNeedsImprovementDetailedCompare,
      values,
    );
  }
  ...
  if (localRating === 'needs-improvement' && fieldRating === 'good') {
    return uiI18n.getFormatLocalizedString(
      str_,
      UIStrings.needsImprovementGoodDetailedCompare,
      values,
    );
  }
  if (localRating === 'needs-improvement' && fieldRating === 'needs-improvement') {
    return uiI18n.getFormatLocalizedString(
      str_,
      UIStrings.needsImprovementNeedsImprovementDetailedCompare,
      values,
    );
  }
  if (localRating === 'needs-improvement' && fieldRating === 'poor') {
    return uiI18n.getFormatLocalizedString(
      str_,
      UIStrings.needsImprovementPoorDetailedCompare,
      values,
    );
  }
  ...
  if (localRating === 'poor' && fieldRating === 'needs-improvement') {
    return uiI18n.getFormatLocalizedString(
      str_,
      UIStrings.poorNeedsImprovementDetailedCompare,
      values,
    );
  }
