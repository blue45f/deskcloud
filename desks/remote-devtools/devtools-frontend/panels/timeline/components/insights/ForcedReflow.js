...
export class ForcedReflow extends BaseInsightComponent {
  ...
  renderContent() {
    ...
    // clang-format off
    return html` ${topLevelFunctionCallData
        ? html`
            <div class="insight-section">
              ${widget(Table, {
                data: {
                  insight: this,
                  headers: [
                    i18nString(UIStrings.topTimeConsumingFunctionCall),
                    i18nString(UIStrings.totalReflowTime),
                  ],
                  rows: [
                    {
                      values: [
                      ...
                      overlays: createOverlayForEvents(
