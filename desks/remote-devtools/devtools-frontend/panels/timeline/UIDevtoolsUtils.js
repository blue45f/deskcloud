...
export class UIDevtoolsUtils {
  ...
  static categorizeEvents() {
    ...
    eventStyles[type.NeedsBeginFrameChanged] = new TimelineRecordStyle(
      'NeedsBeginFrameChanged',
      drawing,
      true,
    );
    // Other Categories
    eventStyles[type.ThreadControllerImplRunTask] = new TimelineRecordStyle(
