...
var t = {
  ...
  g = a.i18n.registerUIStrings('panels/js_timeline/js_timeline-meta.ts', t),
  n = a.i18n.getLazilyComputedLocalizedString.bind(void 0, g),
  o;
async function r() {
  return (o || (o = await import('./../timeline/timeline.js')), o);
}
function l(e) {
  return o === void 0 ? [] : e(o);
}
i.ViewManager.registerViewExtension({
  location: 'panel',
  id: 'timeline',
  title: n(t.performance),
  commandPrompt: n(t.showPerformance),
  order: 66,
  hasToolbar: !1,
  isPreviewFeature: !0,
  async loadView(e) {
    let m = await r(),
      d = e.context.get(c.PageResourceLoader.PageResourceLoader);
    return m.TimelinePanel.TimelinePanel.instance({ forceNew: !0, resourceLoader: d });
  },
});
i.ActionRegistration.registerActionExtension({
  ...
  title: n(t.showRecentTimelineSessions),
  contextTypes() {
    return l((e) => [e.TimelinePanel.TimelinePanel]);
  },
  bindings: [
...
i.ActionRegistration.registerActionExtension({
  ...
  options: [
    { value: !0, title: n(t.record) },
    { value: !1, title: n(t.stop) },
  ],
  bindings: [
