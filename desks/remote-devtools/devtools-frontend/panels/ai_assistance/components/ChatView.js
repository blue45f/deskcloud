                  ...
                  <div class="header">
                    ...
                    ${AiAssistanceModel.AiUtils.isGeminiBranding()
                      ? html`
                          ...
                          <p class="cta">
                            ${lockedString(UIStringsNotTranslate.emptyStateTextGemini)}
                          </p>
                        `
...
export class ChatView extends HTMLElement {
  ...
  #messagesContainerResizeObserver = new ResizeObserver(() =>
    this.#handleMessagesContainerResize(),
  );
  /**
  ...
  #handleScroll = (ev) => {
    ...
    this.#pinScrollToBottom =
      ev.target.scrollTop + ev.target.clientHeight + SCROLL_ROUNDING_OFFSET >
  ...
  async #getSummary() {
    ...
    try {
      const summary = await this.#props.generateConversationSummary(
        this.#props.conversationMarkdown,
      );
