...
export function showDeviceInfo(response: ApiResponse) {
  ...
  console.log(
    '[showDeviceInfo] 디바이스 섹션 표시 완료, display:',
    appState.elements.deviceSection.style.display,
  );
}
...
export function showSessions() {
  ...
  console.log(
    ...
    appState.elements.sessionsSection.innerHTML.substring(0, 100),
  );
}
...
export function showTickets() {
  ...
  console.log(
    ...
    appState.elements.ticketsSection.innerHTML.substring(0, 100),
  );
}
