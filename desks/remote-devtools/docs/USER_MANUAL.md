...
| URL                               | 설명                                         |
| --------------------------------- | -------------------------------------------- |
| `http://localhost:8080`           | 홈 (SDK NPM 모듈 로드 데모 페이지)           |
| `http://localhost:8080/test`      | SDK 스크립트 태그 로드 테스트 페이지         |
| `http://localhost:8080/sessions`  | 녹화/라이브 세션 목록                        |
| `http://localhost:8080/dashboard` | 대시보드 (통계 및 트렌드 차트)               |
...
| 서비스        | URL                                          | 용도                                |
| ------------- | -------------------------------------------- | ----------------------------------- |
| 웹 클라이언트 | `http://localhost:8080`                      | 홈 (SDK 테스트 페이지)              |
| 세션 목록     | `http://localhost:8080/sessions`             | 녹화/라이브 세션 조회               |
| 대시보드      | `http://localhost:8080/dashboard`            | 통계 및 트렌드 차트                 |
...
1. `http://localhost:8080/sessions`에 접속합니다.
...
1. 세션 목록(`http://localhost:8080/sessions`)에서 녹화 세션을 선택합니다.
...
<script src="http://localhost:3001/sdk/index.umd.js" onload="handleSdkLoad()"></script>
```
...
> **참고**: 설명(description)은 별도로 입력하지 않습니다. 세션 데이터(디바이스 정보, 현재 URL, 녹화 링크 등)가 자동으로 Jira 티켓의 description 필드에 추가됩니다.
...
웹 브라우저에서 `http://localhost:8080/dashboard`에 접속합니다.

### 제공 정보

| 항목            | 설명                                                                                         |
| --------------- | -------------------------------------------------------------------------------------------- |
| 통계 카드 (6개) | 총 티켓 수, 오늘 티켓 수, 주간 평균 티켓, 총 녹화 세션 수, 오늘 녹화 세션 수, 주간 평균 세션 |
| 티켓 트렌드     | 기간별 티켓 생성 추이 (BarChart)                                                             |
| 세션 트렌드     | 기간별 녹화 세션 추이 (AreaChart)                                                            |
