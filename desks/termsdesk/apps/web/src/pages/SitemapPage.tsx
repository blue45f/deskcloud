...
const LINKS = [
  ...
  },
  {
    label: '공개 약관',
    to: '/p/:orgSlug/:slug',
    helper: '동적 URL 패턴으로 제공되는 공개/상세 경로',
  },
  {
    label: '전문가',
    to: '/experts',
  ...
  {
    label: '약관 상세',
    to: '/app/policies/:slug',
    helper: '로그인 후 사용하는 운영 콘솔 경로',
  },
  {
    label: '새 버전',
    to: '/app/policies/:slug/versions/new',
    helper: '로그인 후 사용하는 운영 콘솔 경로',
  },
  {
    label: '버전 상세',
    to: '/app/versions/:versionId',
    helper: '로그인 후 사용하는 운영 콘솔 경로',
  },
  {
    label: '버전 편집',
    to: '/app/versions/:versionId/edit',
    helper: '로그인 후 사용하는 운영 콘솔 경로',
  },
  {
    label: '동의 이력',
