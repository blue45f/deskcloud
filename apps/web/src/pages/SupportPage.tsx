...
function InquiryBoard() {
  ...
  // 목록 조회. set-state-in-effect 를 피하기 위해 상태 변경은 비동기 콜백에서만 한다.
  useEffect(() => {
...
/**
 * 문의(Inquiry) 게시판 — desk-platform 공개 API 로 문의를 등록하고 공개 목록을 노출한다.
 * 전화·이메일 대신 이 게시판으로 문의를 통합했다(가이드 §6).
 */
  ...
  return (
    <div className="min-h-screen bg-bg text-text">
      ...
      <main
        id="main-content"
        tabIndex={-1}
        className="mx-auto max-w-3xl space-y-6 px-4 py-8 outline-none sm:px-6"
      >
        <section className="rounded-lg border border-border bg-surface p-5">
          ...
          <p className="mt-2 max-w-2xl text-pretty text-text-muted">
            SearchDesk 에 대한 제휴·버그·의견·이용 문의를 남겨 주세요. 접수된 문의는 아래 게시판에
            공개로 표시되며, 운영자가 확인 후 상태를 업데이트합니다. 전화·이메일 대신 이 게시판으로
            문의를 통합했습니다.
          </p>
        </section>
        ...
        <section className="space-y-4">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-base font-semibold text-text">문의 남기기</h2>
          </div>
