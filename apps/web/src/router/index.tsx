...
const CHUNK_RETRY_KEY = 'communitydesk-chunk-retry'
        ...
        children: [
          {
            ...
            children: [
              ...
              { path: 'boards', lazy: lazyRetry(() => import('@/pages/BoardsPage')) },
